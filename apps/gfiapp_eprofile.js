  ...
  var init = function(w,h){
    ...
    var onlayeradd = function(){
      ...
      for(var j=0;j<layers.length;j++){
        ...
        gfiWindows[j].getWebMapJS().addListener("onupdatebbox",onupdatebbox_eprofile,true);
        gfiWindows[j].getWebMapJS().addListener("onloadingcomplete",onloadingcomplete_eprofile,true);
      }
      _this.resize(w,h);
    };
