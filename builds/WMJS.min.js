...
a};try{isDefined(c)&&(xml2jsonrequestURL=c)}catch(l){xml2jsonrequestURL=base+"/php/xml2jsonrequest.php?"}try{isDefined(requestProxy)}catch(l){requestProxy=base+"/php/MakeRequest.php?"}try{isDefined(scaleBarURL)}catch(l){scaleBarURL=base+"/php/makeScaleBar.php?"}var k,p,A=new WMJSBBOX,E=new WMJSBBOX,v=2,z=2,q=[],I=[],D="",T=0,g=this;g.renderer="WMJSCanvasBuffer";var N=!1,ka=!1,F=document.createElement("div"),u=document.createElement("div"),w=document.createElement("div"),ea=document.createElement("div"),
M=!0,t=new WMJSBBOX,B=new WMJSBBOX,R=new WMJSBBOX,sa=new WMJSBBOX,V=new WMJSBBOX,O=[];g.getLegendStore=function(){return legendImageStore};var J=[],ra=!1,ab="default",Ea=!1,Na="default",bb=!1,cb=!1,Oa=$('<div class="WMJSDivBuffer-loading"/>',{}),db=0,ca=0,fa=1,Ga,ta=0,W=0,Pa=0,Qa=0,Z=Array(3),Ra=Array(3);for(j=0;3>j;j++)Z[j]=new WMJSProjection,Ra[j]=new WMJSProjection;var eb=!0,C=new WMJSListener;this.getGraphingData=function(){return this.graphingData};this.setGraphingData=function(a){this.graphingData=
a};var Ha=function(l){a.id||(a.id="WebMapJSMapNo_"+WebMapJSMapNo);!1===ka&&(ka=!0,WebMapJSMapNo++);return a.id+"_"+l};this.enableInlineGetFeatureInfo=function(a){eb=a};this.closeAllGFIDialogs=function(){WMJSDialog.closeAllDialogs(U)};var U=[],fb=function(){enableConsoleDebugging&&console.log("onlegendready called");ga()},ua=[],Ia=0,va=!1,ga=function(a){if(!(2>O.length)){try{0==isDefined(a)&&(a=!1);if(1==va&&isDefined(fb)){1==C.addToCallback("onlegendready",fb)&&enableConsoleDebugging&&console.log("Suspending on onlegendready");
return}va=!0;if(1==M){if(ua.length!=q.length)a=!0;else for(var l=0;l<q.length;l++){var b=g.getLegendGraphicURLForLayer(q[l]);isDefined(b)&&ua[l]!==b&&(ua[l]=b,a=!0)}if(a){ua=[];for(l=0;l<q.length;l++)!1!==q[l].enabled&&(b=g.getLegendGraphicURLForLayer(q[l]),isDefined(b)&&(ua[l]=b,O[Ia].setSrc(l,b)));var c=Ia;Ia=1-Ia;try{O[c].load(function(){enableConsoleDebugging&&console.log("Legend buffer nr"+c);try{for(var a=0,l=0;l<O[c].layers.length;l++){O[c].layers[l].getElement();var b=O[c].layers[l].getElement()[0].height;
a<b&&(a=b)}O[c].display();O[1-c].hide()}catch(rb){console.error(rb)}va=!1;C.triggerEvent("onlegendready")})}catch(la){console.error(la),O[0].hide(),O[1].hide(),va=!1,C.triggerEvent("onlegendready")}return}}else O[0].hide(),O[1].hide()}catch(la){console.log(la)}va=!1;C.triggerEvent("onlegendready")}},Ta="",Ua="";this.setMessage=function(a){Ua=a&&""!==a?a:""};this.setTimeOffset=function(a){Ta=a&&""!==a?a:""};this.canvasErrors=[];this.getCapabilitiesJSON=function(a,b){WMJSGetCapabilities(a,!0,b,function(a){error(a);
...
this.draw(l)}}};new WMJSDebouncer;this.display=function(){J[fa].display(B,R);enableConsoleDebugging&&console.log("drawnBBOX.setBBOX(bbox)");V.setBBOX(t)};this.draw=function(a){g.isAnimating?enableConsoleDebugging&&console.log("ANIMATING: Skipping draw:"+a):g._draw(a)};this._draw=function(a){enableConsoleDebugging&&console.log("draw:"+a);enableConsoleDebugging&&console.log("drawnBBOX.setBBOX(bbox)");V.setBBOX(t);a:if(!(4>v||4>z)){C.triggerEvent("beforedraw");if(!1===g.isAnimating&&void 0!==a&&"object"===
...
(ia=pa=0,g.draw("flyZoomToBBOXTimerFunc")):(ia=pa=0,kb(B,jb))):ib.init(10,lb)},kb=function(a,b){1===ia?(jb.copy(b),pa=1):(za.copy(a),Aa.copy(b),ya=1,pa=0,0===ia&&(ia=1,lb()))},mb=new WMJSBBOX,Ba=new WMJSBBOX;this.mouseWheelEvent=function(a,b,c,d){a.stopPropagation();preventdefault_event(a);if(1!=xa){xa=1;var l=B.right-B.left,k=B.bottom-B.top;a=g.getGeoCoordFromPixelCoord({x:G,y:H},V);d=(a.x-B.left)/l;c=(a.y-B.top)/k;if(0>b){l*=-.15;var f=-.15*k}else l*=.1,f=.1*k;b=B.left+l;k=B.top+f;l=B.right-l;f=
B.bottom-f;d=d*(l-b)+b-a.x;a=c*(f-k)+k-a.y;b-=d;l-=d;k-=a;f-=a;mb.copy(B);Ba.left=b;Ba.bottom=f;Ba.right=l;Ba.top=k;xa=0;kb(mb,Ba)}};var P;this.pinchStart=function(a,c,k){b=k.pointers[0].clientX;f=k.pointers[0].clientY;d=k.pointers[1].clientX;e=k.pointers[1].clientY;P=t.clone();X=0;xa=da=1};this.pinchMove=function(a,c,k){X=0;pinchMove1={x:k.pointers[0].clientX,y:k.pointers[0].clientY};pinchMove2={x:k.pointers[1].clientX,y:k.pointers[1].clientY};a=pinchMove2.x-pinchMove1.x;c=d-b;k=pinchMove2.y-pinchMove1.y;
var l=e-f;0==c&&(c=1);0==l&&(l=1);a*a>k*k?(a/=c,c=b-pinchMove1.x/a,t.right=((v-pinchMove1.x)/a+b)/v*(P.right-P.left)+P.left,t.left=c/v*(P.right-P.left)+P.left,a=(P.right-P.left)/(P.top-P.bottom),c=(t.top+t.bottom)/2,a=(t.left-t.right)/2/a,t.bottom=c+a,t.top=c-a):(a=k/l,c=f-pinchMove1.y/a,t.bottom=((z-pinchMove1.y)/a+f)/z*(P.bottom-P.top)+P.top,t.top=c/z*(P.bottom-P.top)+P.top,a=(P.right-P.left)/(P.top-P.bottom),c=(t.right+t.left)/2,a*=(t.bottom-t.top)/2,t.left=c+a,t.right=c-a);na(t)};this.pinchEnd=
...
nb(a.dimensions[c].name)),b=b+("="+URLEncode(l));if(l==WMJSDateOutSideRange||l==WMJSDateTooEarlyString||l==WMJSDateTooLateString)throw WMJSDateOutSideRange;}return b},G=0,H=0,K=-1E4,L=-1E4,aa=1E4,ba=1E4,da=0,X=0,Q="pan";this.getMapMode=function(){return Q};this.getWMSMetaDataRequestURL=function(a){var b=a.service,b=b+("&SERVICE=WMS&REQUEST=GetMetaData&VERSION="+a.version),b=b+("&LAYER="+URLEncode(a.name)),b=b+"&FORMAT=text/html";try{b+="&"+wa(a)}catch(ma){return}debug("<a target='_blank' href='"+
...
parseFloat(b),a=g.getGeoCoordFromPixelCoord({x:w.exactX,y:w.exactY},c),w.geoPosX=a.x,w.geoPosY=a.y,w.style.left=w.x-5+"px",w.style.top=w.y-7+"px")};this.isMapPinVisible=function(){return"none"==w.style.display?!1:!0};this.showMapPin=function(){w.innerHTML="<img src='"+mapPinImageSrc+"'>";w.style.display=""};this.hideMapPin=function(){w.style.display="none"};this.setMapModeGetInfo=function(){Q="info";k.css("cursor","default")};this.setMapModeZoomBoxIn=function(a){Q="zoom";k.css("cursor","default")};
this.setMapModeZoomOut=function(a){Q="zoomout";k.css("cursor","default")};this.setMapModePan=function(a){Q="pan";k.css("cursor","default")};this.setMapModePoint=function(a,b){Q="point";k.css("cursor","url(webmapjs/img/aero_pen.cur), default")};var Ca;this.setMapModeNone=function(a){Q="none";k.css("cursor","default")};this.getMouseCoordinatesForDocument=function(b){if(isDefined(b.changedTouches))return{x:parseInt(b.changedTouches[0].screenX),y:parseInt(b.changedTouches[0].screenY)};var c=$(a).parent().offset(),
...
c=g.getGeoCoordFromPixelCoord(c),u.bbox.left=b.x,u.bbox.top=b.y,u.bbox.right=c.x,u.bbox.bottom=c.y,g.showBoundingBox(u.bbox),C.triggerEvent("bboxchanged",{map:g,bbox:u.bbox}));return}S=!1;k.css("cursor",ob)}if(-1==(0>H|0>G|G>v|H>z?-1:0)){try{C.triggerEvent("onmousemove",[void 0,void 0]),g.updateMouseCursorCoordinates(void 0)}catch(Sa){console.log(Sa)}aa=G;ba=H;0!=qa&&(1==X&&"zoomout"==Q&&g.zoomOut(),X=0,1==da&&pb(aa,ba))}else{if(1==X&&!(3>Math.abs(K-G)&&3>Math.abs(L-H))){c=G;b=H;if(0==da){if("pan"==
Q){ia&&g.setBBOX(ha);ia=pa=0;ib.stop();k.css("cursor","move");var d=parseInt(c),l=parseInt(b);w.oldx=w.exactX;w.oldy=w.exactY;for(var f=0;f<U.length;f++)U[f].origX=U[f].x,U[f].origY=U[f].y;qa=1;enableConsoleDebugging&&console.log("updateBBOX.setBBOX(drawnBBOX)");B.setBBOX(V);Da=g.getGeoCoordFromPixelCoord({x:d,y:l},t)}"zoom"==Q&&(k.css("cursor","crosshair"),Ma=1);da=1}"pan"==Q&&0!=qa&&(c=parseInt(c),b=parseInt(b),0>G||0>H||G>parseInt(a.clientWidth)||H>parseInt(a.clientHeight)?qb(c,b):(c=g.getGeoCoordFromPixelCoord({x:c,
y:b},B),b=c.x-Da.x,c=c.y-Da.y,B.left-=b,B.bottom-=c,B.right-=b,B.top-=c,na(B)));"zoom"==Q&&0!=Ma&&(c=G-K,b=H-L,0>c&&0>b?k.css("cursor","not-allowed"):k.css("cursor","crosshair"),h=b,F.style.display="",0>c?(c=-c,F.style.left=G+"px"):F.style.left=K+"px",0>h?(h=-h,F.style.top=H+"px"):F.style.top=L+"px",F.style.width=c+"px",F.style.height=h+"px")}C.triggerEvent("onmousemove",[G,H]);g.updateMouseCursorCoordinates({x:G,y:H})}};this.mouseUp=function(a,b,c){aa=a;ba=b;if(0===da&&0===(0>ba|0>aa|aa>v|ba>z?-1:
0))for(a=C.triggerEvent("beforemouseup",{mouseX:a,mouseY:b,mouseDown:!1,event:c}),b=0;b<a.length;b++)if(!1===a[b]){X=0;return}if(1==X){"zoomout"==Q&&g.zoomOut();if(0==da&&3>Math.abs(K-aa)&&3>Math.abs(L-ba))if(isDefined(c)&&C.triggerEvent("mouseclicked",{map:g,x:aa,y:ba,shiftKeyPressed:1==c.shiftKey}),1==eb){if(0==U.length){var d=WMJSDialog.createDialog({show:showDialog,x:aa,y:ba,autoDestroy:!1},k,g);U.push(d)}else d=U[0];0==d.hasBeenDragged&&(1==d.moveToMouseCursor?d.setXY(aa,ba):d.setXY(5,45));d.on("hide",
function(a,b){d.hasBeenDragged=!1});d.setLoading();d.show();g.addListener("ongetfeatureinfoready",function(a){d.setHTML(g.getGetFeatureInfoObjectAsHTML(a))},!0);g.setMapPin(K,L);g.showMapPin();C.triggerEvent("beforegetfeatureinfo");g.getFeatureInfo(K,L)}else g.setMapPin(K,L),g.showMapPin();C.triggerEvent("mouseup",{map:g,x:aa,y:ba})}X=0;1==da&&pb(aa,ba)};var pb=function(a,b){if(0!=da){da=0;"pan"==Q&&qb(a,b);if("zoom"==Q){b=aa-K;var c=ba-L;k.css("cursor","default");0!=Ma&&(Ma=0,F.style.display="none",
...
". Using default bbox instead.")}g.zoomTo(E);g.draw("zoomTolayer")};this.setPreviousExtent=function(){Pa=1;W++;W>=ta&&(W=ta-1);g.setProjection(Z[W].srs,Z[W].bbox);g.draw("setPreviousExtent")};this.setNextExtent=function(){Qa=1;W--;0>W&&(W=0);g.setProjection(Z[W].srs,Z[W].bbox);g.draw("setNextExtent")};this.setBBOX=function(a,b,c,d){enableConsoleDebugging&&console.log("setBBOX");t.setBBOX(a,b,c,d);A.setBBOX(t);if("GFI:TIME_ELEVATION"!==p){var k=v/z;if((t.right-t.left)/(t.top-t.bottom)>k){var f=(t.top+
t.bottom)/2,k=(t.left-t.right)/2/k;t.bottom=f+k;t.top=f-k}else f=(t.right+t.left)/2,k*=(t.bottom-t.top)/2,t.left=f+k,t.right=f-k}B.setBBOX(t);V.setBBOX(t);if(0==Qa&&0==Pa){if(0!=W){for(j=0;j<=W;j++)Ra[j]=Z[j];for(j=0;j<=W;j++)Z[j]=Ra[W-j];W=0}for(j=2;0<j;j--)Z[j].bbox.setBBOX(Z[j-1].bbox),Z[j].srs=Z[j-1].srs;Z[0].bbox.setBBOX(t);Z[0].srs=p;ta++;3<ta&&(ta=3)}Pa=Qa=0;if(!0===t.equals(a,b,c,d))return!1;C.triggerEvent("aftersetbbox",g);return!0};this.zoomOut=function(){var a=(A.right-A.left)/6;this.zoomTo(new WMJSBBOX(A.left-
a,A.bottom-a,A.right+a,A.top+a));g.draw("zoomOut")};this.zoomIn=function(a){var b=(A.left-A.right)/8;if(0==isDefined(a))a=1;else if(0==a)return;b*=a;this.zoomTo(new WMJSBBOX(A.left-b,A.bottom-b,A.right+b,A.top+b));g.draw("zoomIn")};this.searchForLocation=function(a){g.WCJSSearchRequest(a)};this.displayLegendInMap=function(a){M=a;g.repositionLegendGraphic()};this.showBoundingBox=function(a,b){isDefined(a)&&(u.bbox=a,u.style.display="",u.displayed=!0);!0===u.displayed&&(a=t,isDefined(b)&&(a=b),b=this.getPixelCoordFromGeoCoord({x:u.bbox.left,
...
for(c=0;c<g.canvasErrors.length;c++)g.canvasErrors[c].linkedInfo?a.fillText("Layer with title "+g.canvasErrors[c].linkedInfo.layer.title+" failed to load"+(g.canvasErrors[c].linkedInfo.message?", "+g.canvasErrors[c].linkedInfo.message:""),b+5,11+15*c):a.fillText("Layer failed to load.",b+5,11+15*c);g.canvasErrors=[]}""!==Ta&&(a.font="20px Helvetica",d(a,Ta,v/2-70,z-26,20));""!==Ua&&(a.font="15px Helvetica",d(a,Ua,v/2-70,2,15));if(!0===Wa&&(b=function(){var a=1E-7,b=v/(B.right-B.left);if(!(0>=b)){var c=
...
b.clear=function(){b.init()};b.getSrc=function(){return this.srcToLoad};b.hasError=function(){return k};b.load=function(){k=!1;1==n?A(b,!1):(r=!0,this.srcToLoad?!1===this.srcToLoad.startsWith("http")&&!1===this.srcToLoad.startsWith("//")?(console.log("Source does not start with http"),A(b,!0)):this.srcToLoad==m?A(b,!1):(E.load(function(){A(b,!1)}),E.error(function(a){A(b,!0)}),f?E.attr("src",this.srcToLoad+"&"+Math.random()):E.attr("src",this.srcToLoad)):(console.log("Source not set"),A(b,!0)))};
var A=function(a,d){k=d;r=!1;n=!0;m=this.srcToLoad;isDefined(c)&&c(b)};b.setOpacity=function(a){p=parseFloat(a);E.css("opacity",p)};b.getOpacity=function(a){return p};b.setPosition=function(a,b){E.css({top:parseInt(b)+"px",left:parseInt(a)+"px",position:"absolute"})};b.setSize=function(a,b){a=parseInt(a);b=parseInt(b);0===a||0===b||isNaN(a)||isNaN(b)||(E.width(parseInt(a)+"px"),E.height(parseInt(b)+"px"))};b.setZIndex=function(a){E.zIndex=a};b.getElement=function(){return E};var E=$(document.createElement("img"));
...
function(b,d){var e=[];if(b&&!d)console.log("skipping WMJSCanvasBuffer:display because newbbox is undefined");else{f.hidden=!1;m.globalAlpha=1;"legendbuffer"===c&&m.clearRect(0,0,n,r);"imagebuffer"===c&&(m.beginPath(),m.rect(0,0,n,r),m.fillStyle="white",m.fill(),a.triggerEvent("beforecanvasstartdraw",m));if(b){var k=A({x:d.left,y:d.top},b);var p=A({x:d.right,y:d.bottom},b)}for(var g=d=0;g<f.layerstodisplay.length;g++)if(f.layerstodisplay[g].setSize(n,r),!1===f.layerstodisplay[g].hasError()){var q=
...
0;c<a.length;c++)if(0==b.webmapjs.isThisRequestLoaded(a[c]))return!1;return!0}();b.webmapjs.setDimension("time",c);b.webmapjs.resumeEvent("ondimchange");b.webmapjs.resumeEvent("ondimupdate");return a},B=function(a){if(!b.webmapjs)return!1;var c=b.webmapjs.getDimension("time");if(!isDefined(c))return!1;c=c.currentValue;b.webmapjs.suspendEvent("ondimchange");b.webmapjs.suspendEvent("ondimupdate");b.webmapjs.setDimension("time",a);a=[];var d=b.webmapjs.getWMSRequests();if(0==d.length)a=!1;else for(var e=
...
((b=a.animationList[a.currentAnimationStep])?(a.setDimension(b.name,b.value,!1),c.triggerEvent("ondimchange"),c.triggerEvent("onnextanimationstep",a),a._pdraw(),a.animateBusy=!1):error("No animation step for "+a.currentAnimationStep));b=a.currentAnimationStep+1;b>=a.animationList.length&&(b=0);var d=!1,k=0,p=a.animationList[b];a.setDimension(p.name,p.value,!1);a.animationList[b].requests=a.getWMSRequests();p=a.animationList[a.currentAnimationStep];a.setDimension(p.name,p.value,!1);for(p=0;p<a.animationList[b].requests.length;p++){var A=
a.animationList[b].requests[p];(A=a.getImageStore().getImageForSrc(A))&&A.isLoaded()?k++:f=0}k==a.animationList[b].requests.length&&(d=!0);d&&(a.currentAnimationStep=b)}}};a.isAnimatingLoopRunning=!1;e.checkAnimation=function(){if(0==a.isAnimating)a.isAnimatingLoopRunning=!1;else{a.animationTimer||(a.animationTimer=new WMJSTimer);if(!1===a.mouseHoverAnimationBox){var b=d.getNumImagesLoading();if(4>b){var c=a.animationList.length;if(0<a.animationList.length)for(var e=0;e<c;e++){for(var f=e+a.currentAnimationStep;0>
f;)f+=a.animationList.length;for(;f>=a.animationList.length;)f-=a.animationList.length;0>f&&(f=0);if(0<=f){var A=a.animationList[f];a.setDimension(A.name,A.value,!1);a.animationList[f].requests=a.getWMSRequests();A=a.animationList[a.currentAnimationStep];a.setDimension(A.name,A.value,!1);a.animationList[f].imagesInPrefetch=a.prefetch(a.animationList[f].requests);b+=a.animationList[f].imagesInPrefetch.length;if(3<b)break}}}}0==a.isAnimatingLoopRunning&&(a.isAnimatingLoopRunning=!0,m())}};a.stopAnimating=
