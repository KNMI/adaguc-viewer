...
(t=n.origY);m=z*E+C;var K=t-z*E,F=m-C,T=t-K;(function(e){var m=n.home,r=n.tileServerType;e<n.minLevel&&(e=n.minLevel);e>n.maxLevel&&(e=n.maxLevel);var q=Math.pow(2,e),w=F/(z/q*E),u=T/(z/q*E),q=parseInt(Math.round((a.left-C)/F*w/1+.5)),Q=parseInt(Math.round((a.right-C)/F*w/1+.5)),p=parseInt(Math.round(u-(a.bottom-K)/T*u+.5)),D=parseInt(Math.round(u-(a.top-K)/T*u+.5)),ca=function(a,b,c){a=z/Math.pow(2,a);return{x:b*a+C,y:t-c*a}},qa=function(a,b,c,e){e=e*(a.y-b.top)/(b.bottom-b.top);return{x:parseFloat(c*
(a.x-b.left)/(b.right-b.left)),y:parseFloat(e)}},L=function(a,e,d,f){var k,n,q,z;q=ca(e,d*E,f*E);z=ca(e,(d+1)*E,(f+1)*E);k=q.x;n=q.y;q=z.x;z=z.y;k=qa({x:k,y:n},c,g,b);q=qa({x:q,y:z},c,g,b);n=void 0;"osm"===r&&(n=m+e+"/"+d+"/"+f+".png");if("arcgisonline"===r||"wmst"===r)n=m+e+"/"+f+"/"+d;e=l.getImage(n);!1===e.isLoaded()&&!1===e.hasError()&&!1===e.isLoading()&&e.load();if(e.isLoaded())try{a.drawImage(e.getElement()[0],parseInt(k.x),parseInt(k.y),parseInt(q.x-k.x)+1,parseInt(q.y-k.y)+1)}catch(L){}};
if("EPSG:4326"===f||"EPSG:4258"===f)w*=2;1>D&&(D=1);D>u&&(D=u);1>q&&(q=1);q>w&&(q=w);1>p&&(p=1);p>u&&(p=u);1>Q&&(Q=1);Q>w&&(Q=w);if(!(10<p-D||10<Q-q))for(w=D-1;w<p;w++)for(u=q-1;u<Q;u++)L(d,e,u,w)})(parseInt(Math.log(Math.abs(m-C)/((a.right-a.left)/g*E))/Math.log(2)))}else console.error("Tiled layer with name "+e+" not found")}else console.error("layerName not defined")},WMJSTileRendererTileSettings={arcGisCanvas:{"EPSG:3857":{home:"http://services.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Light_Gray_Base/MapServer/tile/",
...
v+="LAYERS="+URLEncode(a.name)+"&";v+="WIDTH="+z+"&";v+="HEIGHT="+C+"&";v+=k.getBBOXandProjString(a);v+="STYLES="+URLEncode(a.currentStyle)+"&";v+="FORMAT="+a.format+"&";v=!0===a.transparent?v+"TRANSPARENT=TRUE&":v+"TRANSPARENT=FALSE&";try{v+=ra(a)}catch(c){return}return v+=a.wmsextensions.url}}function r(){n.mousedown(k.mouseDownEvent);n.mousewheel(k.mouseWheelEvent);attach_event(document,"mouseup",k.mouseUpEvent);attach_event(document,"mousemove",k.mouseMoveEvent);if(k.isTouchDevice()){k.enableInlineGetFeatureInfo(!1);
...
ba=document.createElement("div"),Q=!0,p=new WMJSBBOX,D=new WMJSBBOX,ca=new WMJSBBOX,qa=new WMJSBBOX,L=new WMJSBBOX,S=[];k.getLegendStore=function(){return legendImageStore};var J=[],pa=!1,Wa="default",Ca=!1,Ja="default",Xa=!1,Ka=$('<div class="WMJSDivBuffer-loading"/>',{}),Ya=0,ea=0,ga=1,Da,sa=0,V=0,Ma=0,Na=0,X=Array(3),Oa=Array(3);for(j=0;3>j;j++)X[j]=new WMJSProjection,Oa[j]=new WMJSProjection;var Za=!0,B=new WMJSListener;this.getGraphingData=function(){return this.graphingData};this.setGraphingData=
function(a){this.graphingData=a};var ha=function(da){a.id||(a.id="WebMapJSMapNo_"+WebMapJSMapNo,WebMapJSMapNo++);return a.id+"_"+da};this.enableInlineGetFeatureInfo=function(a){Za=a};this.closeAllGFIDialogs=function(){WMJSDialog.closeAllDialogs(U)};var U=[],$a=function(){enableConsoleDebugging&&console.log("onlegendready called");ia()},ta=[],Ea=0,ua=!1,ia=function(a){if(!(2>S.length)){try{0==isDefined(a)&&(a=!1);if(1==ua&&isDefined($a)){1==B.addToCallback("onlegendready",$a)&&enableConsoleDebugging&&
console.log("Suspending on onlegendready");return}ua=!0;if(1==Q){if(ta.length!=t.length)a=!0;else for(var b=0;b<t.length;b++){var c=k.getLegendGraphicURLForLayer(t[b]);isDefined(c)&&ta[b]!==c&&(ta[b]=c,a=!0)}if(a){ta=[];for(b=0;b<t.length;b++)!1!==t[b].enabled&&(c=k.getLegendGraphicURLForLayer(t[b]),isDefined(c)&&(ta[b]=c,S[Ea].setSrc(b,c)));var e=Ea;Ea=1-Ea;try{S[e].load(function(){enableConsoleDebugging&&console.log("Legend buffer nr"+e);try{for(var a=0,da=0;da<S[e].layers.length;da++){S[e].layers[da].getElement();
var b=S[e].layers[da].getElement()[0].height;a<b&&(a=b)}S[e].display();S[1-e].hide()}catch(v){console.error(v)}ua=!1;B.triggerEvent("onlegendready")})}catch(d){console.error(d),S[0].hide(),S[1].hide(),ua=!1,B.triggerEvent("onlegendready")}return}}else S[0].hide(),S[1].hide()}catch(d){console.log(d)}ua=!1;B.triggerEvent("onlegendready")}},Pa="",Qa="";this.setMessage=function(a){Qa=a&&""!==a?a:""};this.setTimeOffset=function(a){Pa=a&&""!==a?a:""};this.getCapabilitiesJSON=function(a,b){WMJSGetCapabilities(a,
...
this.getLayers=function(){for(var a=[],b=0;b<t.length;b++)a.push(t[t.length-b-1]);return a};this.setLayer=function(a,b){return k.addLayer(a,b,a)};this.setActive=function(a){Xa=a};this.setActiveLayer=function(a){Da=a;ia();B.triggerEvent("onchangeactivelayer")};this.calculateNumBaseLayers=function(){T=0;if(F)for(var a=0;a<F.length;a++)F[a].enabled&&0==F[a].keepOnTop&&T++};this.enableLayer=function(a){a.enabled=!0;k.calculateNumBaseLayers();k.rebuildMapDimensions();ia(!0)};this.disableLayer=function(a){a.enabled=
!1;k.calculateNumBaseLayers();k.rebuildMapDimensions();ia(!0)};this.toggleLayer=function(a){a.enabled=1==a.enabled?!1:!0;k.calculateNumBaseLayers();k.rebuildMapDimensions();ia(!0)};this.displayLayer=function(a,b){a.enabled=b;k.calculateNumBaseLayers();k.rebuildMapDimensions();ia(!0)};this.removeAllLayers=function(){for(var a=0;a<t.length;++a)t[a].setAutoUpdate(!1);t=[];K=[];B.triggerEvent("onlayeradd")};this.deleteLayer=function(a){if(!(0>=t.length)){a.setAutoUpdate(!1);a=m(a);if(0<=a){for(var b=
a;b<t.length-1;b++)t[b]=t[b+1];t.length--;Da=void 0;0<=a&&a<t.length?(k.rebuildMapDimensions(),k.setActiveLayer(t[a])):0<t.length&&(k.rebuildMapDimensions(),k.setActiveLayer(t[t.length-1]))}B.triggerEvent("onlayerchange");k.rebuildMapDimensions()}};this.moveLayerDown=function(a){var b=m(a);if(0<b){a=t[b-1];var c=t[b];a&&c&&(t[b]=a,t[b-1]=c)}else try{error("moveLayerDown: layer '"+a.name+"' not found.")}catch(e){error("moveLayerDown: layer invalid.")}};this.moveLayerUp=function(a){var b=m(a);if(b<
...
height:C}};this.getWidth=function(){return z};this.getHeight=function(){return C};this.repositionLegendGraphic=function(a){Q?ia(a):(S[0].hide(),S[1].hide())};this.resizeHeight=this.resizeWidth=-1;var Ra=!1,kb=new WMJSTimer;this.setSize=function(a,b){enableConsoleDebugging&&console.log("setSize",a,b);4>parseInt(a)||4>parseInt(b)?console.log("Skipping setSize",a,b):(this.resizeWidth=parseInt(a),this.resizeHeight=parseInt(b),!1===Ra?(Ra=!0,k._setSize(k.resizeWidth,k.resizeHeight)):kb.init(200,function(){Ra=
!1;k._setSize(k.resizeWidth,k.resizeHeight);k.draw("resizeTimer")}))};this._setSize=function(b,c){if(b&&c&&!(4>parseInt(b)||4>parseInt(c))){enableConsoleDebugging&&console.log("setSize("+b+","+c+")");var e=this.getProjection();z=parseInt(b);C=parseInt(c);if(4>z||isNaN(z))z=4;if(4>C||isNaN(C))C=4;e.srs&&e.bbox||(error("this.setSize: Setting default projection (EPSG:4326 with (-180,-90,180,90)"),e.srs="EPSG:4326",e.bbox.left=-180,e.bbox.bottom=-90,e.bbox.right=180,e.bbox.top=90,k.setProjection(e.srs,
e.bbox));n.css({width:z,height:C});a.style.width=z+"px";a.style.height=C+"px";k.setBBOX(u);k.repositionMapPin();k.showBoundingBox();1<J.length&&(J[0].resize(k.getWidth(),k.getHeight()),J[1].resize(k.getWidth(),k.getHeight()));1<S.length&&(S[0].resize(k.getWidth(),k.getHeight()),S[1].resize(k.getWidth(),k.getHeight()));k.repositionLegendGraphic(!0);J[ga]&&J[ga].display();B.triggerEvent("onresize",[z,C])}};this.getBBOXandProjString=function(a){var b="";if(a.version==WMSVersion.version100||a.version==
WMSVersion.version111)b+="SRS="+URLEncode(q)+"&",b+="BBOX="+p.left+","+p.bottom+","+p.right+","+p.top+"&";a.version==WMSVersion.version130&&(b+="CRS="+URLEncode(q)+"&",b="EPSG:4326"==q&&0==a.wms130bboxcompatibilitymode?b+("BBOX="+p.bottom+","+p.left+","+p.top+","+p.right+"&"):b+("BBOX="+p.left+","+p.bottom+","+p.right+","+p.top+"&"));return b};this.isTouchDevice=function(){return"undefined"!==typeof window.ontouchstart};this.getDimensionRequestString=function(a){return ra(a)};this.dateToISO8601=function(a){function b(a,
c){var e=a+"",da=c-e.length,v,d="";for(v=0;v<da;v++)d+="0"+d;return d+e}return b(a.getUTCFullYear(),4)+"-"+b(a.getUTCMonth()+1,2)+"-"+b(a.getUTCDate(),2)+"T"+b(a.getUTCHours(),2)+":"+b(a.getUTCMinutes(),2)+":"+b(a.getUTCSeconds(),2)+"Z"};this.abort=function(){B.triggerEvent("onmapready");fa=!1;B.triggerEvent("onloadingcomplete")};this.isBusy=function(){return fa||0==J[0].ready||0==J[1].ready?!0:!1};this.getLegendGraphicURLForLayer=function(a){if(a){var b=a.legendGraphic;if(b){b+="&layers="+URLEncode(a.name)+
"&";try{1==a.legendIsDimensionDependant&&(b+=k.getDimensionRequestString(a)+"&")}catch(c){return}return b=b+"&transparent=true&width=90&height=250&"+a.wmsextensions.url}}};var Sa=!0;this.showScaleBar=function(){Sa=!0;console.log("todo showScaleBar")};this.hideScaleBar=function(){Sa=!1;console.log("todo hideScaleBar")};this.getMaxNumberOfAnimations=function(){return maxAnimationSteps};this.drawAutomatic=function(a,b){if(0!==t.length){for(var c=a.format("YYYY-MM-DDTHH:mm:ss"),e=[],d=0;moment(c)<b&&
1E3>d;){d++;for(var f=null,k=t.length-1;0<=k;k--){var g=t[k].getDimension("time");g&&(g=g.getNextClosestValue(c))&&"date too early"!==g&&(null===f||moment(g)<moment(f))&&(f=g)}if(null===f)break;e.push({name:"time",value:f});c=f}if(0<e.length)e.pop(),this.draw(e);else if(c=t[0].getDimension("time")){e=c.size();f=Math.min(c.size(),100);d=[];for(f=e-f;f<e;++f)d.push({name:c.name,value:c.getValueForIndex(f)});this.draw(d)}}};new WMJSDebouncer;this.display=function(){J[ga].display(D,ca);enableConsoleDebugging&&
console.log("drawnBBOX.setBBOX(bbox)");L.setBBOX(p)};this.draw=function(a){k.isAnimating?enableConsoleDebugging&&console.log("ANIMATING: Skipping draw:"+a):k._draw(a)};this._draw=function(a){enableConsoleDebugging&&console.log("draw:"+a);enableConsoleDebugging&&console.log("drawnBBOX.setBBOX(bbox)");L.setBBOX(p);a:if(4>z||4>C)console.log("map too small, skipping");else{B.triggerEvent("beforedraw");if(!1===k.isAnimating&&void 0!==a&&"object"===typeof a&&0<a.length){if(a.length>maxAnimationSteps){alert("Too many animations given, max is "+
maxAnimationSteps);k.draw("self");break a}k.isAnimating=!0;B.triggerEvent("onstartanimation",k);k.currentAnimationStep=0;k.animationList=[];k.mouseHoverAnimationBox=!1;for(var b=0;b<a.length;b++){var c={name:a[b].name,value:a[b].value};k.setDimension(a[b].name,a[b].value,!1);c.requests=k.getWMSRequests();k.animationList.push(c)}k.setDimension(k.animationList[k.currentAnimationStep].name,k.animationList[k.currentAnimationStep].value,!1);ab.checkAnimation()}k._pdraw()}};var lb=function(){debug("--\x3e onmapready event called");
...
if(a.isLoading())return 1};this.mouseHoverAnimationBox=!1;this._pdraw=function(){if(0!=Ya)if(fa)1==B.addToCallback("onmapready",lb)&&debug("Suspending on onmapready");else{enableConsoleDebugging&&console.log("loadLayers");var a,b=0;T=0;if(F)for(var c=0;c<F.length;c++)F[c].enabled&&!1===F[c].keepOnTop&&(!F[c].type||"twms"!==F[c].type)&&(T++,a=e(F[c]))&&(J[ea].setSrc(b,a,k.getWidth(),k.getHeight()),J[ea].setOpacity(b,F[c].opacity),b++);for(c=c=0;c<k.getNumLayers();c++)t[c].service&&t[c].enabled&&(a=
e(t[c],t[c].dimensions))&&(J[ea].setSrc(b,a),J[ea].setOpacity(b,t[c].opacity),t[c].image=J[ea].layers[b],b++);if(F)for(c=0;c<F.length;c++)F[c].enabled&&1==F[c].keepOnTop&&(a=e(F[c]))&&(J[ea].setSrc(b,a),J[ea].setOpacity(b,F[c].opacity),b++);k.flipBuffers();B.triggerEvent("ondrawready",k);ia()}};var ab,ka=function(a){if(0!=J.length){var b=p;isDefined(a)&&(b=a);D.copy(b);J[ga].setBBOX(D,ca);J[ga].mapbbox=D;k.showBoundingBox(A.bbox,D);B.triggerEvent("onupdatebbox",D)}},bb=new WMJSTimer;k.flipBuffers=
function(){enableConsoleDebugging&&console.log("flipBuffers");var a=ga,b=ea;B.triggerEvent("onmapstartloading");fa=!0;bb.init(500,function(){Ka.show()});qa.setBBOX(p);J[b]&&J[b].load(function(){enableConsoleDebugging&&console.log("flipBuffers loadcomplete");try{J[a].srs=q,J[b].bbox=p.clone(),J[b].srs=q,enableConsoleDebugging&&console.log("loadedBBOX.setBBOX(bbox)"),ca.setBBOX(qa),enableConsoleDebugging&&console.log("-----------------------"),J[b].display(D,ca),w.oldx=w.exactX,w.oldy=w.exactY,J[a].hide(),
ga=b,ea=a}catch(c){console.log(c)}fa=!1;B.triggerEvent("onmaploadingcomplete",k);B.triggerEvent("onloadingcomplete",k);B.triggerEvent("onmapready",k);Ka.hide();bb.stop()})};k.getBackBufferCanvasContext=function(){return J[ea].getCanvasContext()};k.getFrontBufferCanvasContext=function(){return J[ga].getCanvasContext()};k.redrawBuffer=function(){J[ga].display();enableConsoleDebugging&&console.log("drawnBBOX.setBBOX(bbox)");L.setBBOX(p)};this.addBaseLayers=function(a){if(a){T=0;a=toArray(a);F.push(a);
for(j=0;j<F.length;j++)1==F.keepOnTop&&T++;B.triggerEvent("onlayeradd")}else F=void 0};this.setBaseLayers=function(a){if(a){T=0;F=a;for(j=0;j<F.length;j++)1==F.keepOnTop&&T++;B.triggerEvent("onlayerchange")}else F=void 0};this.getBaseLayers=function(){return F};this.getNumLayers=function(){return t.length};this.getBaseElement=function(){return n};var va=0;new WMJSTimer;var la,mb=new WMJSDebouncer,ma=0,wa=new WMJSBBOX,xa=new WMJSBBOX,cb=new WMJSBBOX,ya=0,za=0,eb=function(){ma=la/5;var a=1-ma,a=new WMJSBBOX(wa.left*
a+xa.left*ma,wa.bottom*a+xa.bottom*ma,wa.right*a+xa.right*ma,wa.top*a+xa.top*ma);ka(a);la+=1;5<la?(la=1,k.setBBOX(a),k.display(),0===za?(ya=za=0,k.draw("flyZoomToBBOXTimerFunc")):(ya=za=0,db(D,cb))):mb.init(30,eb)},db=function(a,b){1===ya?(cb.copy(b),za=1):(wa.copy(a),xa.copy(b),la=1,za=0,0===ya&&(ya=1,eb()))},fb=new WMJSBBOX,Aa=new WMJSBBOX;this.mouseWheelEvent=function(a,b,c,e){if(1!=va){va=1;var d=D.right-D.left,f=D.bottom-D.top;a=k.getGeoCoordFromPixelCoord({x:H,y:I},L);e=(a.x-D.left)/d;c=(a.y-
D.top)/f;var g;0>b?(d*=-.35,g=-.35*f):(d*=.25,g=.25*f);b=D.left+d;f=D.top+g;d=D.right-d;g=D.bottom-g;e=e*(d-b)+b-a.x;a=c*(g-f)+f-a.y;b-=e;d-=e;f-=a;g-=a;fb.copy(D);Aa.left=b;Aa.bottom=g;Aa.right=d;Aa.top=f;va=0;db(fb,Aa)}};var O;this.pinchStart=function(a,c,e){b=e.pointers[0].clientX;d=e.pointers[0].clientY;f=e.pointers[1].clientX;g=e.pointers[1].clientY;O=p.clone();W=0;va=aa=1};this.pinchMove=function(a,c,e){W=0;pinchMove1={x:e.pointers[0].clientX,y:e.pointers[0].clientY};pinchMove2={x:e.pointers[1].clientX,
y:e.pointers[1].clientY};a=pinchMove2.x-pinchMove1.x;c=f-b;e=pinchMove2.y-pinchMove1.y;var La=g-d;0==c&&(c=1);0==La&&(La=1);a*a>e*e?(a/=c,c=b-pinchMove1.x/a,p.right=((z-pinchMove1.x)/a+b)/z*(O.right-O.left)+O.left,p.left=c/z*(O.right-O.left)+O.left,a=(O.right-O.left)/(O.top-O.bottom),c=(p.top+p.bottom)/2,a=(p.left-p.right)/2/a,p.bottom=c+a,p.top=c-a):(a=e/La,c=d-pinchMove1.y/a,p.bottom=((C-pinchMove1.y)/a+d)/C*(O.bottom-O.top)+O.top,p.top=c/C*(O.bottom-O.top)+O.top,a=(O.right-O.left)/(O.top-O.bottom),
c=(p.right+p.left)/2,a*=(p.bottom-p.top)/2,p.left=c+a,p.right=c-a);ka(p)};this.pinchEnd=function(a,b,c){va=aa=W=0;k.zoomTo(p);k.draw("pinchEnd")};k.destroy=function(){k.stopAnimating();for(var a=t.length-1;0<=a;a--)t[a].setAutoUpdate(!1);console.log("Detaching...");n.off("mousedown");n.off("mousewheel");del_event(document,"mouseup",k.mouseUpEvent);del_event(document,"mousemove",k.mouseMoveEvent)};var ra=function(a){a=a.dimensions;for(var b="",c=0;c<a.length;c++){var e;e=a[c].name;e="TIME"==e.toUpperCase()?
e:"ELEVATION"==e.toUpperCase()?e:"DIM_"+e;b+="&"+e;b+="="+URLEncode(a[c].currentValue);if(a[c].currentValue==WMJSDateOutSideRange||a[c].currentValue==WMJSDateTooEarlyString||a[c].currentValue==WMJSDateTooLateString)throw WMJSDateOutSideRange;}return b},H=0,I=0,M=-1E4,N=-1E4,Y=1E4,Z=1E4,aa=0,W=0,P="pan";this.getMapMode=function(){return P};this.getWMSMetaDataRequestURL=function(a){var b=a.service,b=b+("&SERVICE=WMS&REQUEST=GetMetaData&VERSION="+a.version),b=b+("&LAYER="+URLEncode(a.name)),b=b+"&FORMAT=text/html";
try{b+="&"+ra(a)}catch(c){return}debug("<a target='_blank' href='"+b+"'>"+b+"</a>",!1);return b};var ja=0,Ta=[],Ua=function(a,b){this.layer=a;this.data=b},nb=function(a,b,c,e,d){e+="&GRAPHSTYLE="+d;e+="&"+k.getBBOXandProjString(a);e+="&LAYERS="+URLEncode(a.name);e+="WIDTH="+z;e+="&HEIGHT="+C;e+="&X="+b;e+="&Y="+c;e+="&FORMAT=image/png";e+="&INFO_FORMAT=text/html";e+="&STYLES=";try{e+="&"+ra(a)}catch(f){return}debug("<a target='_blank' href='"+e+"'>"+e+"</a>",!1);return e};this.getWMSGetFeatureInfoRequestURL=
...
try{e+="&"+ra(a)}catch(f){return}debug("<a target='_blank' href='"+e+"'>"+e+"</a>",!1);return e};var Fa=function(a,b){ja--;var c;c=b?1==b.queryable?new Ua(b,a):new Ua(b,"not queryable"):new Ua(b,"Query failed...");Ta.push(c);0>=ja&&(ja=0,B.triggerEvent("ongetfeatureinfoready",Ta))},ob=function(){debug("resuming on ongetpointinfoready");k.getPointInfo(M,N)},Ga=!1;this.getPointInfo=function(a,b){if(Ga)debug("suspending on ongetpointinfoready"),k.addListener("ongetpointinfoready",ob,!1);else{Ga=!0;B.triggerEvent("beforegetpointinfo");
var c=k.getGraphingData();if(void 0==c)error("getPointInfo getGraphingData is undefined"),Ga=!1;else{debug("getPointInfo("+a+","+b+") "+c.layer.name);var e=nb(c.layer,a,b,c.service,c.style);debug("GetPointInfo: "+e);var d=new Image;d.loadEvent=function(){Ga=!1;var a={};a.url=e;a.layer=c.layer;a.img=d;B.triggerEvent("ongetpointinfoready",a)};l(d);d.src=e}}};var pb=function(){debug("resuming on ongetfeatureinfoready");B.triggerEvent("beforegetfeatureinfo");k.getFeatureInfo(M,N)};this.getFeatureInfo=
function(a,b){if(0<ja)debug("suspending on ongetfeatureinfoready"),k.addListener("ongetfeatureinfoready",pb,!1);else{debug("GetFeatureInfo:");Ta=[];for(var c=ja=0;c<t.length;c++){var e=t[t.length-c-1];e.getFeatureInfoUrl="";e.service&&e.enabled&&1==e.queryable&&(e.getFeatureInfoUrl=k.getWMSGetFeatureInfoRequestURL(e,a,b),isDefined(e.getFeatureInfoUrl)?ja++:e.getFeatureInfoUrl="")}0==ja&&B.triggerEvent("ongetfeatureinfoready",["No layers to query"]);for(c=0;c<t.length;c++)if(e=t[t.length-c-1],""!=
...
"none"};this.setMapModeGetInfo=function(){P="info";n.css("cursor","default")};this.setMapModeZoomBoxIn=function(a){P="zoom";n.css("cursor","default")};this.setMapModeZoomOut=function(a){P="zoomout";n.css("cursor","default")};this.setMapModePan=function(a){P="pan";n.css("cursor","default")};this.setMapModePoint=function(a,b){P="point";n.css("cursor","url(webmapjs/img/aero_pen.cur), default")};var Ba;this.setMapModeNone=function(a){P="none";n.css("cursor","default")};this.getMouseCoordinatesForDocument=
...
void 0==d&&(d=getClick_Y(b));return{x:e-c.left,y:d-c.top}};this.mouseDown=function(a,b,c){var e=!1;c&&1==c.shiftKey&&(e=!0);M=a;N=b;W=1;if(0===aa&&0===(0>N|0>M|M>z|N>C?-1:0))for(a=B.triggerEvent("beforemousedown",{mouseX:a,mouseY:b,mouseDown:!0,event:c}),b=0;b<a.length;b++)if(!1===a[b])return;e?(void 0==Ba&&(Ba=P),P="zoom"):void 0!=Ba&&(P=Ba,Ba=void 0);B.triggerEvent("mousedown",{map:k,x:M,y:N});"info"==P?(debug("GetFeatureInfo"),k.setMapPin(M,N),k.showMapPin(),B.triggerEvent("beforegetfeatureinfo",
{map:k,x:M,y:N}),k.getFeatureInfo(M,N)):"point"==P&&(k.setMapPin(M,N),k.showMapPin(),k.getPointInfo(M,N))};var gb=!1,R=!1,Ha,Va;this.updateMouseCursorCoordinates=function(a){Va=a;Ha=k.getGeoCoordFromPixelCoord(a);k.display("updateMouseCursorCoordinates")};this.mouseDownEvent=function(a){preventdefault_event(a);var b=k.getMouseCoordinatesForDocument(a);pa&&30>b.y||k.mouseDown(b.x,b.y,a)};this.mouseMoveEvent=function(a){preventdefault_event(a);var b=k.getMouseCoordinatesForDocument(a);0===W&&0<=b.y&&
30>b.y&&0<=b.x&&b.x<=z?!1===pa&&(pa=!0,Wa=Ja,Ca=!0,k.setCursor("pointer"),k.draw("mouseMoveEvent")):!0===pa&&(Ca=pa=!1,k.setCursor(Wa),k.draw("mouseMoveEvent"));k.mouseMove(b.x,b.y,a)};this.mouseUpEvent=function(a){preventdefault_event(a);var b=k.getMouseCoordinatesForDocument(a);k.mouseUp(b.x,b.y,a)};this.mouseMove=function(b,c){H=b;I=c;if(0===aa)for(var e=B.triggerEvent("beforemousemove",{mouseX:H,mouseY:I,mouseDown:1===W?!0:!1}),d=0;d<e.length;d++)if(!1===e[d])return;if(1==A.displayed&&0==na){var e=
k.getPixelCoordFromGeoCoord({x:A.bbox.left,y:A.bbox.top}),d=k.getPixelCoordFromGeoCoord({x:A.bbox.right,y:A.bbox.bottom}),f=!1;0==W&&(!1===R&&(gb=n.css("cursor")),6>Math.abs(H-e.x)&&I>e.y&&I<d.y&&(f=!0,n.css("cursor","col-resize"),R="left"),6>Math.abs(I-e.y)&&H>e.x&&H<d.x&&(f=!0,n.css("cursor","row-resize"),R="top"),6>Math.abs(H-d.x)&&I>e.y&&I<d.y&&(f=!0,n.css("cursor","col-resize"),R="right"),6>Math.abs(I-d.y)&&H>e.x&&H<d.x&&(f=!0,n.css("cursor","row-resize"),R="bottom"),6>Math.abs(H-e.x)&&6>Math.abs(I-
...
H,d.y=I),"bottomright"==R&&(d.x=H,d.y=I),e=k.getGeoCoordFromPixelCoord(e),d=k.getGeoCoordFromPixelCoord(d),A.bbox.left=e.x,A.bbox.top=e.y,A.bbox.right=d.x,A.bbox.bottom=d.y,k.showBoundingBox(A.bbox),B.triggerEvent("bboxchanged",{map:k,bbox:A.bbox}));return}R=!1;n.css("cursor",gb)}if(-1==(0>I|0>H|H>z|I>C?-1:0)){try{B.triggerEvent("onmousemove",[void 0,void 0]),k.updateMouseCursorCoordinates(void 0)}catch(g){console.log(g)}Y=H;Z=I;0!=na&&(1==W&&"zoomout"==P&&k.zoomOut(),W=0,1==aa&&hb(Y,Z))}else{if(1==
W&&!(3>Math.abs(M-H)&&3>Math.abs(N-I))){d=H;e=I;if(0==aa){if("pan"==P){n.css("cursor","move");var f=parseInt(d),m=parseInt(e);w.oldx=w.exactX;w.oldy=w.exactY;for(var l=0;l<U.length;l++)U[l].origX=U[l].x,U[l].origY=U[l].y;na=1;enableConsoleDebugging&&console.log("updateBBOX.setBBOX(drawnBBOX)");D.setBBOX(L);oa=k.getGeoCoordFromPixelCoord({x:f,y:m},L)}"zoom"==P&&(n.css("cursor","crosshair"),Ia=1);aa=1}"pan"==P&&0!=na&&(f=parseInt(d),m=parseInt(e),0>H||0>I||H>parseInt(a.style.width)||I>parseInt(a.style.height)?
ib(f,m):(m=k.getGeoCoordFromPixelCoord({x:f,y:m},L),f=m.x-oa.x,m=m.y-oa.y,k.setMapPin(w.oldx+f/(p.right-p.left)*z,w.oldy+m/(p.bottom-p.top)*C),D.left=L.left-f,D.bottom=L.bottom-m,D.right=L.right-f,D.top=L.top-m,ka(D)));"zoom"==P&&0!=Ia&&(d=H-M,e=I-N,0>d&&0>e?n.css("cursor","not-allowed"):n.css("cursor","crosshair"),h=e,G.style.display="",0>d?(d=-d,G.style.left=H+"px"):G.style.left=M+"px",0>h?(h=-h,G.style.top=I+"px"):G.style.top=N+"px",G.style.width=d+"px",G.style.height=h+"px")}B.triggerEvent("onmousemove",
[H,I]);k.updateMouseCursorCoordinates({x:H,y:I})}};this.mouseUp=function(a,b,e){Y=a;Z=b;if(0===aa&&0===(0>Z|0>Y|Y>z|Z>C?-1:0))for(a=B.triggerEvent("beforemouseup",{mouseX:a,mouseY:b,mouseDown:!1,event:e}),b=0;b<a.length;b++)if(!1===a[b]){W=0;return}if(1==W){"zoomout"==P&&k.zoomOut();if(0==aa&&3>Math.abs(M-Y)&&3>Math.abs(N-Z)&&(isDefined(e)&&B.triggerEvent("mouseclicked",{map:k,x:Y,y:Z,shiftKeyPressed:1==e.shiftKey}),1==Za)){var c;0==U.length?(c=WMJSDialog.createDialog({x:Y,y:Z,autoDestroy:!1},n,k),
U.push(c)):c=U[0];0==c.hasBeenDragged&&(1==c.moveToMouseCursor?c.setXY(Y,Z):c.setXY(5,35));c.on("hide",function(a,b){c.hasBeenDragged=!1});c.setLoading();c.show();k.addListener("ongetfeatureinfoready",function(a){c.setHTML(k.getGetFeatureInfoObjectAsHTML(a))},!0);k.setMapPin(M,N);k.showMapPin();B.triggerEvent("beforegetfeatureinfo");k.getFeatureInfo(M,N)}B.triggerEvent("mouseup",{map:k,x:Y,y:Z})}W=0;1==aa&&hb(Y,Z)};var hb=function(a,b){if(0!=aa){aa=0;"pan"==P&&ib(a,b);if("zoom"==P){var c=a,e=b,c=
Y-M,e=Z-N;n.css("cursor","default");if(0!=Ia&&(Ia=0,G.style.display="none",!(0>c&&0>e))){var d=new WMJSBBOX;0>c?(d.left=M+c,d.right=M):(d.left=M,d.right=M+c);0>e?(d.top=N+e,d.bottom=N):(d.top=N,d.bottom=N+e);c=k.pixelCoordinatesToXY({x:d.left,y:d.bottom});e=k.pixelCoordinatesToXY({x:d.right,y:d.top});d.left=c.x;d.bottom=c.y;d.right=e.x;d.top=e.y;k.zoomTo(d);k.draw("mapZoomEnd")}}B.triggerEvent("mapdragend",{map:k,x:Y,y:Z})}},na=0,oa,ib=function(a,b){n.css("cursor","default");var c=parseInt(a),e=parseInt(b);
if(0!=na){na=0;var d=k.getGeoCoordFromPixelCoord({x:c,y:e},L),f=d.x-oa.x,d=d.y-oa.y;oa=k.getGeoCoordFromPixelCoord({x:c,y:e},L);k.setMapPin(w.oldx+f/(p.right-p.left)*z,w.oldy+d/(p.bottom-p.top)*C);D.left=L.left-f;D.bottom=L.bottom-d;D.right=L.right-f;D.top=L.top-d;ka(D);k.zoomTo(D);k.draw("mapPanEnd")}},Ia=0;this.setCursor=function(a){Ja=a?a:"default";n.css("cursor",Ja)};this.zoomTo=function(a){enableConsoleDebugging&&console.log("zoomTo");var b=!1;a=new WMJSBBOX(a);try{var c=(u.left-u.right)/(u.bottom-
u.top)}catch(e){b=!0}isNaN(c)&&(b=!0);1==b&&(error("Invalid bbox: setting ratio to 1"),c=1);0>c&&(c=-c);c>z/C?(b=(a.top+a.bottom)/2,c=(a.left-a.right)/2/c,a.bottom=b+c,a.top=b-c):(b=(a.right+a.left)/2,c*=(a.bottom-a.top)/2,a.left=b+c,a.right=b-c);k.setBBOX(a);ka(p);L.setBBOX(p);a=k.getPixelCoordFromGeoCoord({x:w.geoPosX,y:w.geoPosY});k.setMapPin(a.x,a.y);for(a=0;a<U.length;a++)k.getPixelCoordFromGeoCoord({x:U[a].geoPosX,y:U[a].geoPosY}),0==U[a].hasBeenDragged&&1==U[a].moveToMouseCursor&&U[a].setXY(U[a].origX+
x,U[a].origY+y)};this.pixelCoordinatesToXY=function(a){return k.getGeoCoordFromPixelCoord(a)};this.getGeoCoordFromPixelCoord=function(a,b){var c=p;b&&(c=b);if(isDefined(a)){try{var e=a.x/z*(c.right-c.left)+c.left,d=a.y/C*(c.bottom-c.top)+c.top}catch(f){return}return{x:e,y:d}}};this.proj4={};this.proj4.srs="empty";this.proj4.projection=void 0;var jb=new Proj4js.Proj("EPSG:4326");this.getPixelCoordFromLatLong=function(a){var b=new Proj4js.Point;try{b.x=parseFloat(a.x),b.y=parseFloat(a.y),k.proj4.srs==
q&&isDefined(this.proj4.projection)||(k.proj4.projection=new Proj4js.Proj(q),k.proj4.srs=q),Proj4js.transform(jb,k.proj4.projection,b)}catch(c){alert(debug("error in getPixelCoordFromLatLong "+c));return}return k.getPixelCoordFromGeoCoord(b)};this.WCJSSearchRequest=function(a){function b(a,c,e){error(I18n.geonames_api_call_failed.text)}function c(a){if(0===$(a).length){var b=geoNamesURL.replace("{searchTerm}",searchDef).replace("{username}",defaultUsernameSearch);k.WCJSSearchRequestGeoNames(b)}else b=
...
this.setLayerOpacity=function(a,b){if(a){a.opacity=b;var c=T;for(j=0;j<k.getNumLayers();j++)if(t[j].service&&t[j].enabled){if(a==t[j]){k.setBufferImageOpacity(ea,c,b);break}c++}}};this.zoomToLayer=function(a){var b=a;b||(b=Da);if(b){for(var c=0;c<b.projectionProperties.length;c++)if(b.projectionProperties[c].srs==q){a=b.projectionProperties[c].bbox.right-b.projectionProperties[c].bbox.left;var e=b.projectionProperties[c].bbox.top-b.projectionProperties[c].bbox.bottom,b=b.projectionProperties[c].bbox.clone();
b.left-=a/100;b.right+=a/100;b.bottom-=e/100;b.top+=e/100;k.zoomTo(b);k.draw("zoomTolayer");return}error("Unable to find the correct bbox with current map projection "+q+" for layer "+b.title+". Using default bbox instead.")}k.zoomTo(E);k.draw("zoomTolayer")};this.setPreviousExtent=function(){Ma=1;V++;V>=sa&&(V=sa-1);k.setProjection(X[V].srs,X[V].bbox);k.draw("setPreviousExtent")};this.setNextExtent=function(){Na=1;V--;0>V&&(V=0);k.setProjection(X[V].srs,X[V].bbox);k.draw("setNextExtent")};this.setBBOX=
function(a,b,c,e){enableConsoleDebugging&&console.log("setBBOX");p.setBBOX(a,b,c,e);u.setBBOX(p);if("GFI:TIME_ELEVATION"!==q){var d=z/C;if((p.right-p.left)/(p.top-p.bottom)>d){var f=(p.top+p.bottom)/2,d=(p.left-p.right)/2/d;p.bottom=f+d;p.top=f-d}else f=(p.right+p.left)/2,d*=(p.bottom-p.top)/2,p.left=f+d,p.right=f-d}D.setBBOX(p);L.setBBOX(p);if(0==Na&&0==Ma){if(0!=V){for(j=0;j<=V;j++)Oa[j]=X[j];for(j=0;j<=V;j++)X[j]=Oa[V-j];V=0}for(j=2;0<j;j--)X[j].bbox.setBBOX(X[j-1].bbox),X[j].srs=X[j-1].srs;X[0].bbox.setBBOX(p);
X[0].srs=q;sa++;3<sa&&(sa=3)}Ma=Na=0;if(!0===p.equals(a,b,c,e))return!1;B.triggerEvent("aftersetbbox",k);return!0};this.zoomOut=function(){var a=(u.right-u.left)/6;this.zoomTo(new WMJSBBOX(u.left-a,u.bottom-a,u.right+a,u.top+a));k.draw("zoomOut")};this.zoomIn=function(a){var b=(u.left-u.right)/8;if(0==isDefined(a))a=1;else if(0==a)return;b*=a;this.zoomTo(new WMJSBBOX(u.left-b,u.bottom-b,u.right+b,u.top+b));k.draw("zoomIn")};this.searchForLocation=function(a){k.WCJSSearchRequest(a)};this.displayLegendInMap=
...
" />",{mousedown:function(a){a.stopPropagation();preventdefault_event(a)}}).appendTo(n),jQuery("<button/>",{id:ha("searchboxbutton"),mousedown:function(a){a.stopPropagation()},click:function(){var a=$("#searchtextfield").attr("value");k.searchForLocation(a)}}).addClass("webmapjs_locationbutton").appendTo(n),$("#searchtextfield").keypress(function(a){if(13==a.which)return a=$("#searchtextfield").attr("value"),k.searchForLocation(a),!1}));$("#"+ha("buttonzoomout")).click(function(a){a.stopPropagation()});
$("#"+ha("buttonzoomin")).iconbutton({text:!1,icons:{primary:"wmjs-icon-zoomin"}});$("#"+ha("buttonzoomhome")).iconbutton({text:!1,icons:{primary:"wmjs-icon-zoomhome"}});$("#"+ha("buttonzoombox")).iconbutton({text:!1,icons:{primary:"wmjs-icon-zoombox"}});$("#"+ha("buttondragmap")).iconbutton({text:!1,icons:{primary:"wmjs-icon-dragpan-activated"}});$("#"+ha("buttonzoomout")).iconbutton({text:!1,icons:{primary:"wmjs-icon-zoomout"}});r();p.left=-180;p.bottom=-90;p.right=180;p.top=90;q="EPSG:4326";k.setSize(a.style.width,
a.style.height);for(b=0;2>b;b++){var c=new WMJSCanvasBuffer(B,"imagebuffer",getMapImageStore,k.getWidth(),k.getHeight());getMapImageStore.addLoadEventCallback(c.imageLoadComplete);n.append(c.getBuffer());J.push(c)}for(b=0;2>b;b++)c=new WMJSCanvasBuffer(B,"legendbuffer",legendImageStore,k.getWidth(),k.getHeight()),legendImageStore.addLoadEventCallback(c.imageLoadComplete),n.append(c.getBuffer()),S.push(c);B.addToCallback("display",k.display,!0);B.addToCallback("draw",function(){console.log("draw event triggered externally, skipping")},
!0);ab=new WMJSAnimate(k);bgMapImageStore.addLoadEventCallback(function(a){k.draw("bgMapImageStore loaded")});k.addListener("beforecanvasstartdraw",function(a){if(F)for(var b=0;b<F.length;b++)!F[b].enabled||!1!==F[b].keepOnTop||F[b].type&&"twms"!==F[b].type||WMJSTileRenderer(p,D,q,z,C,a,bgMapImageStore,WMJSTileRendererTileSettings,F[b].name)},!0);var e=function(a,b,c,e,d){a.textBaseline="top";a.fillStyle="#FFF";a.globalAlpha=.75;var f=a.measureText(b).width;a.fillRect(c-8,e-8,f+16,parseInt(d)+14);
a.fillStyle="#444";a.globalAlpha=1;a.fillText(b,c,e+2)};k.addListener("beforecanvasdisplay",function(a){a.beginPath();a.rect(0,0,z,30);!1===Xa?(a.globalAlpha=Ca?.9:.4,a.fillStyle=Ca?"#017daf":"#EEE"):(a.globalAlpha=1,a.fillStyle="#017daf");a.fill();a.globalAlpha=1;""!==Pa&&(a.font="20px Helvetica",e(a,Pa,z/2-70,C-26,20));""!==Qa&&(a.font="15px Helvetica",e(a,Qa,z/2-70,2,15));if(!0===Sa){var b=function(){var a=0,b=1E-7,c=z/(D.right-D.left);if(!(0>=c)){var e=25/c,a=0;do{b*=10;a=e/b;if(0===a)return;
a=25/a}while(25>a);do{b/=2;a=e/b;if(0===a)return;a=25/a}while(25<a);do{b*=1.2;a=e/b;if(0===a)return;a=25/a}while(25>a);e=Math.pow(10,Math.round(Math.log10(b)+.5)-1);b=Math.round(b/e);2.5>b&&(b=2.5);2.5<b&&7.5>b&&(b=5);7.5<b&&(b=10);b*=e;a=25/c/b;return{width:parseInt(25/a),mapunits:b}}}();if(b){var c=C-25.5;a.beginPath();a.lineWidth=2.5;a.fillStyle="#000";a.strokeStyle="#000";a.font="9px Helvetica";a.textBaseline="middle";for(var d=0;2>d;d++)a.moveTo(7.5,21-d+c),a.lineTo(2*b.width+8.5,21-d+c);d=parseInt(Math.round(b.width/
5));a.lineWidth=.5;for(var f=1;5>f;f++)a.moveTo(7.5+d*f,21+c),a.lineTo(7.5+d*f,16+c);a.lineWidth=1;a.moveTo(7.5,21+c);a.lineTo(7.5,14+c);a.moveTo(7.5+b.width,21+c);a.lineTo(7.5+b.width,14+c);a.moveTo(2*b.width+8.5,21+c);a.lineTo(2*b.width+8.5,14+c);d="";"EPSG:3411"===q&&(d="meter");"EPSG:3412"===q&&(d="meter");"EPSG:3575"===q&&(d="meter");"EPSG:4326"===q&&(d="degrees");"EPSG:28992"===q&&(d="meter");"EPSG:32661"===q&&(d="meter");"EPSG:3857"===q&&(d="meter");"EPSG:900913"===q&&(d="meter");"EPSG:102100"===
q&&(d="meter");"meter"===d&&1E3<b.mapunits&&(b.mapunits/=1E3,d="km");a.fillText("0",4.5,12+c);f=b.mapunits.toPrecision()+"";a.fillText(f,7.5+b.width-2.5*f.length+0,12+c);f=(2*b.mapunits).toPrecision()+"";a.fillText(f,7.5+2*b.width-2.5*f.length+0,12+c);a.fillText(d,2*b.width+17.5,18+c);a.stroke()}}a.font="10px Helvetica";a.textBaseline="middle";isDefined(Ha)&&(c=1/Math.pow(10,parseInt(Math.log((p.right-p.left)/z)/Math.log(10))-2),1>c&&(c=1),a.fillStyle="#000000",b=Math.round(Ha.x*c)/c,c=Math.round(Ha.y*
c)/c,d="","EPSG:3857"===q&&(d="meter"),a.fillText("CoordXY: ("+b+", "+c+") "+d,5,C-50));isDefined(Va)&&(b=k.getLatLongFromPixelCoord(Va),isDefined(b)&&(a.fillStyle="#000000",c=Math.round(100*b.x)/100,a.fillText("Lat/Lon: ("+(Math.round(100*b.y)/100).toFixed(2)+", "+c.toFixed(2)+")  degrees",5,C-38)));a.fillStyle="#000000";a.fillText("Map projection: "+q,5,C-26)},!0);Ya=1})();ka(p)};WMJSEmptyLayerName="empty_layer";WMJSEmptyLayerTitle="empty layer";
...
2,w=e-G-2;l.beginPath();l.fillStyle="#FFFFFF";l.lineWidth=.3;l.globalAlpha=.5;l.strokeStyle="#000000";l.rect(parseInt(A)+.5,parseInt(w)+.5,E,G);l.fill();l.stroke();l.globalAlpha=1;l.drawImage(k,A,w)}else b?(E=parseInt(g.x+.5),G=parseInt(g.y+.5),A=parseInt(n.x-g.x+.5),w=parseInt(n.y-g.y+.5),A===parseInt(l.canvas.width)&&w===parseInt(l.canvas.height)?l.drawImage(k,E,G):l.drawImage(k,E,G,A,w)):l.drawImage(k,0,0,m,e)}l.globalAlpha=1;"imagebuffer"===c&&a.triggerEvent("beforecanvasdisplay",l);d.canvas.show();
