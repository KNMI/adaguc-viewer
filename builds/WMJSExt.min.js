...
$jscomp.polyfill("WeakMap",function(e){function p(){if(!e||!Object.seal)return!1;try{var ca=Object.seal({}),ea=Object.seal({}),X=new e([[ca,2],[ea,3]]);if(2!=X.get(ca)||3!=X.get(ea))return!1;X.delete(ca);X.set(ea,4);return!X.has(ca)&&4==X.get(ea)}catch(ka){return!1}}function z(){}function F(ca){var ea=typeof ca;return"object"===ea&&null!==ca||"function"===ea}function I(ca){if(!$jscomp.owns(ca,N)){var ea=new z;$jscomp.defineProperty(ca,N,{value:ea})}}function ja(ca){if(!$jscomp.ISOLATE_POLYFILLS){var ea=
Object[ca];ea&&(Object[ca]=function(X){if(X instanceof z)return X;Object.isExtensible(X)&&I(X);return ea(X)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(e&&$jscomp.ES6_CONFORMANCE)return e}else if(p())return e;var N="$jscomp_hidden_"+Math.random();ja("freeze");ja("preventExtensions");ja("seal");var U=0,aa=function(ca){this.id_=(U+=Math.random()+1).toString();if(ca){ca=$jscomp.makeIterator(ca);for(var ea;!(ea=ca.next()).done;)ea=ea.value,this.set(ea[0],ea[1])}};aa.prototype.set=function(ca,
...
aa).entry};F.prototype.get=function(aa){return(aa=I(this,aa).entry)&&aa.value};F.prototype.entries=function(){return ja(this,function(aa){return[aa.key,aa.value]})};F.prototype.keys=function(){return ja(this,function(aa){return aa.key})};F.prototype.values=function(){return ja(this,function(aa){return aa.value})};F.prototype.forEach=function(aa,ca){for(var ea=this.entries(),X;!(X=ea.next()).done;)X=X.value,aa.call(ca,X[1],X[0],this)};F.prototype[Symbol.iterator]=F.prototype.entries;var I=function(aa,
ca){var ea=ca&&typeof ca;"object"==ea||"function"==ea?z.has(ca)?ea=z.get(ca):(ea=""+ ++U,z.set(ca,ea)):ea="p_"+ca;var X=aa.data_[ea];if(X&&$jscomp.owns(aa.data_,ea))for(aa=0;aa<X.length;aa++){var ka=X[aa];if(ca!==ca&&ka.key!==ka.key||ca===ka.key)return{id:ea,list:X,index:aa,entry:ka}}return{id:ea,list:X,index:-1,entry:void 0}},ja=function(aa,ca){var ea=aa.head_;return $jscomp.iteratorPrototype(function(){if(ea){for(;ea.head!=aa.head_;)ea=ea.previous;for(;ea.next!=ea.head;)return ea=ea.next,{done:!1,
value:ca(ea)};ea=null}return{done:!0,value:void 0}})},N=function(){var aa={};return aa.previous=aa.next=aa.head=aa},U=0;return F},"es6","es3");
$jscomp.polyfill("Set",function(e){function p(){if($jscomp.ASSUME_NO_NATIVE_SET||!e||"function"!=typeof e||!e.prototype.entries||"function"!=typeof Object.seal)return!1;try{var F=Object.seal({x:4}),I=new e($jscomp.makeIterator([F]));if(!I.has(F)||1!=I.size||I.add(F)!=I||1!=I.size||I.add({x:4})!=I||2!=I.size)return!1;var ja=I.entries(),N=ja.next();if(N.done||N.value[0]!=F||N.value[1]!=F)return!1;N=ja.next();return N.done||N.value[0]==F||4!=N.value[0].x||N.value[1]!=N.value[0]?!1:ja.next().done}catch(U){return!1}}
...
$jscomp.polyfill("Promise",function(e){function p(){this.batch_=null}function z(N){return N instanceof I?N:new I(function(U,aa){U(N)})}if(e&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return e;p.prototype.asyncExecute=function(N){if(null==this.batch_){this.batch_=[];var U=this;this.asyncExecuteFunction(function(){U.executeBatch_()})}this.batch_.push(N)};
var F=$jscomp.global.setTimeout;p.prototype.asyncExecuteFunction=function(N){F(N,0)};p.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var N=this.batch_;this.batch_=[];for(var U=0;U<N.length;++U){var aa=N[U];N[U]=null;try{aa()}catch(ca){this.asyncThrow_(ca)}}}this.batch_=null};p.prototype.asyncThrow_=function(N){this.asyncExecuteFunction(function(){throw N;})};var I=function(N){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var U=
this.createResolveAndReject_();try{N(U.resolve,U.reject)}catch(aa){U.reject(aa)}};I.prototype.createResolveAndReject_=function(){function N(ca){return function(ea){aa||(aa=!0,ca.call(U,ea))}}var U=this,aa=!1;return{resolve:N(this.resolveTo_),reject:N(this.reject_)}};I.prototype.resolveTo_=function(N){if(N===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(N instanceof I)this.settleSameAsPromise_(N);else{a:switch(typeof N){case "object":var U=null!=N;break a;case "function":U=
!0;break a;default:U=!1}U?this.resolveToNonPromiseObj_(N):this.fulfill_(N)}};I.prototype.resolveToNonPromiseObj_=function(N){var U=void 0;try{U=N.then}catch(aa){this.reject_(aa);return}"function"==typeof U?this.settleSameAsThenable_(U,N):this.fulfill_(N)};I.prototype.reject_=function(N){this.settle_(2,N)};I.prototype.fulfill_=function(N){this.settle_(1,N)};I.prototype.settle_=function(N,U){if(0!=this.state_)throw Error("Cannot settle("+N+", "+U+"): Promise already settled in state"+this.state_);this.state_=
N;this.result_=U;2===this.state_&&this.scheduleUnhandledRejectionCheck_();this.executeOnSettledCallbacks_()};I.prototype.scheduleUnhandledRejectionCheck_=function(){var N=this;F(function(){if(N.notifyUnhandledRejection_()){var U=$jscomp.global.console;"undefined"!==typeof U&&U.error(N.result_)}},1)};I.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var N=$jscomp.global.CustomEvent,U=$jscomp.global.Event,aa=$jscomp.global.dispatchEvent;if("undefined"===typeof aa)return!0;
"function"===typeof N?N=new N("unhandledrejection",{cancelable:!0}):"function"===typeof U?N=new U("unhandledrejection",{cancelable:!0}):(N=$jscomp.global.document.createEvent("CustomEvent"),N.initCustomEvent("unhandledrejection",!1,!0,N));N.promise=this;N.reason=this.result_;return aa(N)};I.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var N=0;N<this.onSettledCallbacks_.length;++N)ja.asyncExecute(this.onSettledCallbacks_[N]);this.onSettledCallbacks_=null}};
var ja=new p;I.prototype.settleSameAsPromise_=function(N){var U=this.createResolveAndReject_();N.callWhenSettled_(U.resolve,U.reject)};I.prototype.settleSameAsThenable_=function(N,U){var aa=this.createResolveAndReject_();try{N.call(U,aa.resolve,aa.reject)}catch(ca){aa.reject(ca)}};I.prototype.then=function(N,U){function aa(ka,za){return"function"==typeof ka?function(ya){try{ca(ka(ya))}catch(ua){ea(ua)}}:za}var ca,ea,X=new I(function(ka,za){ca=ka;ea=za});this.callWhenSettled_(aa(N,ca),aa(U,ea));return X};
I.prototype.catch=function(N){return this.then(void 0,N)};I.prototype.callWhenSettled_=function(N,U){function aa(){switch(ca.state_){case 1:N(ca.result_);break;case 2:U(ca.result_);break;default:throw Error("Unexpected state: "+ca.state_);}}var ca=this;null==this.onSettledCallbacks_?ja.asyncExecute(aa):this.onSettledCallbacks_.push(aa);this.isRejectionHandled_=!0};I.resolve=z;I.reject=function(N){return new I(function(U,aa){aa(N)})};I.race=function(N){return new I(function(U,aa){for(var ca=$jscomp.makeIterator(N),
ea=ca.next();!ea.done;ea=ca.next())z(ea.value).callWhenSettled_(U,aa)})};I.all=function(N){var U=$jscomp.makeIterator(N),aa=U.next();return aa.done?z([]):new I(function(ca,ea){function X(ya){return function(ua){ka[ya]=ua;za--;0==za&&ca(ka)}}var ka=[],za=0;do ka.push(void 0),za++,z(aa.value).callWhenSettled_(X(ka.length-1),ea),aa=U.next();while(!aa.done)})};return I},"es6","es3");
...
0,p.dimensionValueLabel.setValueText(WMJSDateTooEarlyString);else if(I==WMJSDateTooLateString)p.currentIndex=p.dimension.size()-1,p.dimensionValueLabel.setValueText(WMJSDateTooLateString);else if(p.currentIndex=this.dimension.getIndexForValue(I),-1!=p.currentIndex)p.dimensionValueLabel.setValueText(p.getValue());else{var ja=parseISO8601DateToDate(I),N=parseISO8601DateToDate(p.dimension.get(0)),U=parseISO8601DateToDate(p.dimension.get(p.dimension.size()-1));ja.getTime()<N.getTime()?(p.dimensionValueLabel.setValueText(WMJSDateTooEarlyString),
p.layer.setDimension(p.dimension.name,WMJSDateTooEarlyString),p.currentIndex=0):ja.getTime()>U.getTime()?(p.dimensionValueLabel.setValueText(WMJSDateTooLateString),p.layer.setDimension(p.dimension.name,WMJSDateTooLateString),p.currentIndex=p.dimension.size()-1):(p.dimensionValueLabel.setValueText(WMJSDateOutSideRange),p.layer.setDimension(p.dimension.name,WMJSDateOutSideRange))}}catch(aa){p.dimensionValueLabel.setValueText(WMJSDateOutSideRange),p.layer.setDimension(p.dimension.name,WMJSDateOutSideRange),
p.currentIndex=0}p.dimSlider.suspendEvents();p.dimSlider.setValue(p.currentIndex,!1);p.dimSlider.resumeEvents()};p.checkReferenceTime=function(I){for(var ja=-1,N=-1,U=0;U<p.dimensionPanels.length;U++){var aa=p.layer.getDimension(p.dimensionPanels[U].dimension.name);"time"==aa.name&&"ISO8601"==aa.units&&(N=U);"reference_time"==aa.name&&"ISO8601"==aa.units&&(ja=U)}p.dimSlider.suspendEvents();if(-1!=N&&-1!=ja&&(U=p.layer.getDimension(p.dimensionPanels[N].dimension.name),aa=p.layer.getDimension(p.dimensionPanels[ja].dimension.name),
U.getValue()<aa.getValue()))if(p.dimensionPanels[ja].dimension.name==I.name){I=U.getValue();do I=U.get(U.getIndexForValue(I)+1);while(I<aa.getValue());p.dimensionPanels[N].dimSlider.setValue(U.getIndexForValue(I),!1)}else if(p.dimensionPanels[N].dimension.name==I.name){I=aa.getValue();do I=aa.get(aa.getIndexForValue(I)-1);while(I>aa.getValue());p.dimensionPanels[ja].dimSlider.setValue(aa.getIndexForValue(I),!1)}p.dimSlider.resumeEvents()};p.sliderChanged=function(I){try{p.layer.parentMaps[0].stopAnimating()}catch(ja){}p.currentIndex=
...
function(p,z){if(0!=isDefined(this.WMJSLayer.service)&&0!=this.WMJSLayer.service.length){e.setLoading("Reading GetCapabilities ...");for(var F=[],I=0;I<e.WMJSLayer.dimensions.length;I++)F.push(this.WMJSLayer.dimensions[I].clone());e.dimensionPanels=[];e.dimUpdate=function(){for(var N=0;N<e.dimensionPanels.length;N++){var U=e.WMJSLayer.getDimension(e.dimensionPanels[N].dimension.name);e.dimensionPanels[N].setValue(U.getValue())}};e.setDimension=function(N,U){var aa=e.getDimensionPanel(N);isDefined(aa)?
(e.WMJSLayer.setDimension(N,U),aa.setValue(U)):error("WMJSExtLayerPanel::Dimension "+N+" not found")};e.getDimensionPanel=function(N){for(var U=0;U<e.dimensionPanels.length;U++)if(e.dimensionPanels[U].dimension.name===N)return e.dimensionPanels[U]};var ja=function(N){var U=N;N.message&&(U=N.message);e.setLoading(!1);N="Unable to parse layer "+e.WMJSLayer.name+"\n"+U;e.WMJSLayer.hasError=!0;error(N)};I=function(N){if(void 0!=e.WMJSLayer.parentMaps[0])if(e.WMJSLayer!=N)isDefined(N)&&ja("WMJSExtLayerPanel internal error:\n"+
N),z&&z(e),e.afterlayerready&&e.afterlayerready(e);else if(e.WMJSLayer.hasError){e.setLoading(!1);e.productButton.setText(e.WMJSLayer.path+e.WMJSLayer.title);e.styleButton.setText("");var U=e.WMJSLayer.lastError;isDefined(U)||(U="An error occurred connecting to WMS server");e.setTitle(U);error(U);N=new WMJSTimer;U=U.replaceAll("\n","<br/>");N.init(10,function(){Ext.Msg.alert(I18n.unable_to_connect_server.text,I18n.unable_to_connect_server.text+"<br/><br/>"+U)});z&&z(e);e.afterlayerready&&e.afterlayerready(e)}else{e.WMJSLayer.getLayerRelative(function(X,
ka,za){e.productButton.setText("("+(ka+1)+"/"+za+") "+e.WMJSLayer.title)},function(X){e.productButton.setText(e.WMJSLayer.path+e.WMJSLayer.title)});e.setStyleText(e.WMJSLayer.getStyleObject(e.WMJSLayer.currentStyle));e.dimensionPanels=[];e.dimensionPanelContainer.removeAll();var aa="";for(N=0;N<e.WMJSLayer.dimensions.length;N++){for(var ca=0;ca<F.length;ca++)F[ca].name==e.WMJSLayer.dimensions[N].name&&(e.WMJSLayer.dimensions[N].currentValue=F[ca].currentValue);ca=Ext.create("WMJSExtDimensionPanel",
...
e.WMJSLayer.parentMaps[0].rebuildMapDimensions();0==e.dimCallBackAdded&&(e.WMJSLayer.parentMaps[0].addListener("ondimchange",e.dimUpdate,!0),e.dimCallBackAdded=!0);try{e.styleButton.loadStyles()}catch(X){}var ea=!1;isDefined(e.name)&&0<e.name.length&&(ea=!0);e.setTitle("Layer "+e.WMJSLayer.name);if(!1===ea){if(1==e.autoChooseLayer){e.autoChooseLayer=!1;e.WMJSLayer.autoSelectLayer(function(X){e.setLayer(X.name);e.WMJSLayer.zoomToLayer();ea=!0});return}e.productButton.showService()}e.WMJSLayer.WMJSService?
...
I18n.title.text+"</i></td><td> "+e.WMJSLayer.WMJSService.title+"</td></tr><tr><td><i>"+I18n.service.text+"</i></td><td>"+e.WMJSLayer.WMJSService.onlineresource+"</td></tr><tr><td><i>"+I18n.abstract.text+"</i></td><td>"+e.WMJSLayer.WMJSService.abstract+"</td></tr></table></span>"):e.layerAbstractPanel.update("...");N=function(){var X=e.WMJSLayer.parentMaps[0].getLegendGraphicURLForLayer(e.WMJSLayer),ka=e.WMJSLayer.parentMaps[0].getLegendStore();if(e.layerLegendPanel.getEl()){var za=$(e.layerLegendPanel.getEl().dom).find("canvas")[0].getContext("2d");
(X=ka.getImageForSrc(X))?(za.rect(0,0,90,250),za.fillStyle="white",za.fill(),za.drawImage(X.getElement()[0],0,0)):(za.rect(0,0,90,250),za.fillStyle="gray",za.fill())}};e.WMJSLayer.parentMaps[0].getListener().addToCallback("onlegendready",N,!0);N()}};try{if(e.WMJSLayer.parseLayer(I,p,"LayerPanel::parseLayer",xml2jsonrequestURL),!0===p)try{console.log("clearing cache"),e.WMJSLayer&&e.WMJSLayer.parentMaps&&0<e.WMJSLayer.parentMaps.length&&(e.WMJSLayer.parentMaps[0].clearImageStore(),e.WMJSLayer.parentMaps[0].loadLegendInline(!0))}catch(N){console.error(N)}}catch(N){ja(N)}}};
...
z.baselayer.name&&(I=z.baselayer.service,ja=z.baselayer.name);z.url=I+"service=WMS&request=GetMap&styles=&width=160&height=120&format=image/png";z.url+="&layers="+ja;z.url+="&version=1.1.1";z.url+="&bbox="+F[0]+","+F[1]+","+F[2]+","+F[3];z.url+="&srs="+z.srs;return z},listeners:{itemclick:function(z,F){e(F)}}})]});this.superclass.initComponent.apply(this,arguments)}});Ext.define("webmapjsext.WMJSExt.AnimationPanel",{extend:"Ext.panel.Panel",alias:"WMJSExtAnimationPanel",requires:["Ext.form.field.ComboBox","Ext.form.field.Picker","Ext.form.field.Trigger","Ext.layout.container.Form"],initComponent:function(){var e=this,p=Ext.create("Ext.data.Store",{fields:[{type:"string",name:"name"},{type:"string",name:"title"},{type:"object",name:"wmjslayer"}]}),z=Ext.create("Ext.data.Store",{fields:[{type:"string",name:"name"},{type:"object",name:"wmjsdimension"}]}),F=function(){var U=
e.mappanel.webMapJS.getLayers();p.removeAll();for(var aa=0;aa<U.length;aa++)p.add({name:U[aa].service+U[aa].name,title:U[aa].title,wmjslayer:U[aa]})},I=function(U){if(isDefined(U)){e.selectedLayer=U;var aa=e.getComponent("dimensionpanel").getComponent("dimensioncombobox");aa.disable();z.removeAll();for(var ca=0;ca<U.dimensions.length;ca++)z.add({name:U.dimensions[ca].name,wmjsdimension:U.dimensions[ca]});0<z.getCount()&&(aa.setValue(z.getAt(0).get("name")),ja(z.getAt(0).get("wmjsdimension")),aa.enable())}},
ja=function(U){isDefined(U)&&(e.getComponent("dimensionvaluespanel").getComponent("dimensioncurrentvalue").setValue(U.getValue()),e.dimension=U)},N=function(){isDefined(e.dimensionName)&&isDefined(e.currentValue)&&(e.mappanel.webMapJS.stopAnimating(),e.mappanel.webMapJS.setDimension(e.dimensionName,e.currentValue),e.mappanel.webMapJS.draw("AnimationPanel::stop"))};Ext.apply(this,{border:!1,frame:!0,items:[{xtype:"panel",itemId:"layerpanel",layout:"border",frame:!0,border:!1,margin:3,height:36,items:[{margin:3,
xtype:"combobox",itemId:"layercombo",region:"center",fieldLabel:I18n.select_layer.text,labelWidth:110,displayField:"title",valuefield:"name",store:p,queryMode:"local",listeners:{select:{fn:function(U,aa){U=aa[0].get("wmjslayer");I(U)}}}},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",handler:function(){F()}}]},{xtype:"panel",itemId:"dimensionpanel",layout:"fit",frame:!0,border:!1,margin:3,height:36,items:[{margin:3,xtype:"combobox",itemId:"dimensioncombobox",region:"center",fieldLabel:I18n.select_dimension.text,
labelWidth:110,disabled:!0,store:z,displayField:"name",valuefield:"name",queryMode:"local",listeners:{select:{fn:function(U,aa){ja(aa[0].get("wmjsdimension"))}}}}]},{xtype:"panel",itemId:"dimensionvaluespanel",frame:!0,border:!1,margin:3,layout:"border",height:36,items:[{xtype:"label",text:I18n.start_at.text+":",width:110,region:"west",margin:3},{itemId:"dimensioncurrentvalue",xtype:"textfield",region:"center",frame:!1,border:!1,margin:3},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",
...
{xtype:"numberfield",itemId:"delaynumberfield",region:"center",value:300}]}],buttons:[{text:I18n.stop.text,handler:N},{text:I18n.start.text,handler:function(){var U=e.getComponent("dimensionvaluespanel").getComponent("dimensioncurrentvalue").getValue(),aa=e.getComponent("numberofstepspanel").getComponent("numberofstepsnumberfield").getValue(),ca=e.getComponent("delaypanel").getComponent("delaynumberfield").getValue();U=e.dimension.getIndexForValue(U);var ea=e.mappanel.webMapJS.getMaxNumberOfAnimations();
aa>ea&&(aa=ea,e.getComponent("numberofstepspanel").getComponent("numberofstepsnumberfield").setValue(aa));aa--;0>aa&&(aa=0);aa=U+aa;aa>=e.dimension.size()&&(ea=e.dimension.size()-(aa+1),U+=ea,aa+=ea);0>U&&(U=0);0>aa&&(aa=0);for(ea=[];U<aa+1;U++)ea.push({name:e.dimension.name,value:e.dimension.getValueForIndex(U)});0==e.mappanel.webMapJS.isAnimating&&(e.dimensionName=e.dimension.name,e.currentValue=e.dimension.currentValue);e.mappanel.webMapJS.setAnimationDelay(ca);e.mappanel.webMapJS.draw(ea)}}],
...
Na.height);ya()}}}}),U=Ext.create("Ext.data.Store",{fields:["title","format"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),aa=Ext.create("Ext.grid.Panel",{border:!1,store:U,columns:[{text:I18n.format.text,dataIndex:"format"},{text:I18n.title.text,dataIndex:"title",flex:1}],listeners:{select:{fn:function(ua,Ba){F=Ba.get("format");ya()}}}});e.onReady=function(){N.setLoading(!1);for(var ua=this.coverages[0],Ba=0;Ba<ua.supportedProjections.length;Ba++){var Na=ua.supportedProjections[Ba].srs;
try{Na=epsgDescriptionLookup[ua.supportedProjections[Ba].srs]}catch(Sa){}isDefined(Na)||(Na=ua.supportedProjections[Ba].srs);ja.add({title:Na,srs:ua.supportedProjections[Ba].srs,bbox:ua.supportedProjections[Ba].bbox})}Ba=ja.find("srs",ua.nativeCRS);-1==Ba&&(Ba=ja.find("srs","EPSG:4326"));-1==Ba&&(Ba=0);N.getView().select(Ba);ja.add({title:"Viewer window projection and area",srs:this.srs,bbox:this.bbox});ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").setValue(ua.width);
ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").setValue(ua.height);Na=ca.getComponent("column3").getComponent("dimensionPanel");for(Ba=0;Ba<ua.dimensions.length;Ba++)Na.add({xtype:"textfield",fieldLabel:ua.dimensions[Ba].name,value:ua.dimensions[Ba].currentValue,labelWidth:40,padding:"30",width:200,itemId:"dimtextfield_"+ua.dimensions[Ba].name,listeners:{change:{fn:function(){ya()}}}});for(Ba=0;Ba<ua.formats.length;Ba++){Na=ua.formats[Ba];
var Ga=ua.formats[Ba].toUpperCase();try{Na=formatDescriptionLookup[Ga]}catch(Sa){}isDefined(Na)||(Na=ua.formats[Ba]);U.add({title:Na,format:ua.formats[Ba]});"AAIGRID"==Ga&&aa.getView().select(Ba)}ya();za.update('<table style="margin:5px;"><tr><td><b>Coverage:</b></td><td>'+ua.name+"</td></tr><tr><td><b>Title:</b></td><td>"+ua.title+"</td></tr><tr><td><b>Description:</b></td><td>"+ua["abstract"]+"</td></tr></table>")};Ext.create("Ext.panel.Panel",{region:"west",border:!0,width:100});var ca=Ext.create("Ext.panel.Panel",
...
itemId:"bboxtop",labelWidth:20,padding:"30 5 5 130",width:180,listeners:{change:{fn:function(){ya()}}}},{xtype:"panel",itemId:"bbox",border:!1,layout:"hbox",items:[{xtype:"textfield",fieldLabel:I18n.west.text,itemId:"bboxwest",labelWidth:30,padding:"15 0 0 15",width:180,listeners:{change:{fn:function(){ya()}}}},{xtype:"textfield",fieldLabel:I18n.east.text,itemId:"bboxeast",labelWidth:30,padding:"15 0 0 15",width:180,listeners:{change:{fn:function(){ya()}}}}]},{xtype:"textfield",fieldLabel:I18n.south.text,
itemId:"bboxbottom",labelWidth:40,padding:"15 5 5 110",width:200,listeners:{change:{fn:function(){ya()}}}}]},{xtype:"panel",region:"south",height:"50%",title:"Grid properties",split:!0,autoScroll:!0,itemId:"gridproperties",items:{xtype:"fieldcontainer",itemId:"field",items:[{xtype:"radiofield",boxLabel:"Cell size",name:"resolution",checked:!0,itemId:"radioselectcellsize",padding:"15 15 15 15",handler:function(ua,Ba){!0===Ba&&(ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").disable(),
ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").disable(),ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").enable(),ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").enable());ya()}},{xtype:"textfield",fieldLabel:"X resolution",padding:"0 0 0 40",itemId:"xresolution",width:170,listeners:{change:{fn:function(){ya()}}}},{xtype:"textfield",
fieldLabel:"Y resolution",padding:"0 0 0 40",itemId:"yresolution",width:170,listeners:{change:{fn:function(){ya()}}}},{xtype:"radiofield",boxLabel:"Raster size",name:"resolution",padding:15,handler:function(ua,Ba){!0===Ba&&(ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").enable(),ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").enable(),ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").disable(),
ca.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").disable())}},{xtype:"textfield",fieldLabel:"Raster Width",padding:"0 0 0 40",disabled:!0,itemId:"rasterwidth",width:170,listeners:{change:{fn:function(){ya()}}}},{xtype:"textfield",fieldLabel:"Raster Height",padding:"0 0 0 40",disabled:!0,itemId:"rasterheight",width:170,listeners:{change:{fn:function(){ya()}}}}]}}]},{itemId:"column3",xtype:"panel",layout:"border",border:!1,split:!0,flex:1,items:[{xtype:"panel",
region:"center",height:"50%",itemId:"dimensionPanel",title:I18n.dimensions.text,autoScroll:!0},{xtype:"panel",split:!0,autoScroll:!0,region:"south",height:"50%",title:I18n.formats.text,items:[aa]}]}]}),ea=Ext.create("Ext.panel.Panel",{layout:"border",region:"center",border:!0,width:300,items:[ca]}),X=Ext.create("Ext.panel.Panel",{border:!1,padding:20}),ka=Ext.create("Ext.panel.Panel",{title:"GetCoverage request link",region:"south",border:!0,height:100,layout:"fit",items:[X]}),za=Ext.create("Ext.panel.Panel",
{region:"north",border:!1,height:80,frame:!1});Ext.apply(this,{layout:"border",padding:0,frame:!1,border:!0,items:[ea,za,ka]});N.setLoading(!0);var ya=function(){var ua=e.coverages[0].service;ua=WMJScheckURL(ua);var Ba=e.coverages[0].name,Na=ca.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxwest").getValue()+","+ca.getComponent("column2").getComponent("areaPanel").getComponent("bboxbottom").getValue()+","+ca.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxeast").getValue()+
...
var X=WMJSExtApplications[p.applicationSettings.name];X?(p.applicationSettings.app=new X($("#webmapjs_customapplication"),mainWebmapJS.webMapJS),p.applicationSettings.app.enable(p.width,mainWebmapJS.webMapJS.getHeight()-24)):alert("Application with name "+p.applicationSettings.name+" not registered")}},hide:{fn:function(){p.applicationSettings.app&&(p.applicationSettings.app.disable(),p.applicationSettings.app=void 0);mainWebmapJS.webMapJS.enableInlineGetFeatureInfo(!0);mainWebmapJS.webMapJS.removeListener("mouseclicked")}},
resize:{fn:function(){p.applicationSettings.app&&p.applicationSettings.app.resize(p.width,mainWebmapJS.webMapJS.getHeight())}}},setApplication:function(X){p.applicationSettings=X}});e=Ext.create("Ext.panel.Panel",{region:"center",layout:"border",split:!0,frame:!1,border:!1,margin:0,items:[mainWebmapJS,p]});var z=function(X){console.log(X.slot);var ka=createNewLayerPanel(mainWebmapJS.webMapJS,{service:X.service,name:X.layer,style:X.style,opacity:X.opacity,ready:function(za,ya){var ua=X.srs,Ba=X.bbox,
Na=X.baselayername,Ga=X.baselayerservice;ua&&!Ba?ya.setProjection(za.getProjection(ua)):ua&&Ba&&ya.setProjection({srs:ua,bbox:Ba});Na&&Ga?(mainWebmapJS.baseLayer.setService(Ga),mainWebmapJS.baseLayer.name=Na,mainWebmapJS.baseLayer.parseLayer(function(){ya.draw("dataPanelClicked::parseLayer")},void 0,"WMJSExtMain::dataPanelClicked")):ya.draw("dataPanelClicked");isDefined(ka)&&isDefined(X.ready)&&(X.ready(ka,ya),1==ka.WMJSLayer.hasError&&ka.close())}});return ka},F,I=new Console;Ext.create("Ext.panel.Panel",
...
handler:function(){Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:z,webMapJS:mainWebmapJS.webMapJS}).showCustomWMSWindow()}},{text:I18n.undo_zoom_pan_action.text,iconCls:"button_undo",handler:function(){mainWebmapJS.webMapJS.setPreviousExtent()}},{text:I18n.redo_zoom_pan_action.text,iconCls:"button_redo",handler:function(){mainWebmapJS.webMapJS.setNextExtent()}},{text:I18n.abort_loading.text,iconCls:"button_stoploading",handler:function(){mainWebmapJS.webMapJS.abort()}}];try{isDefined(getFeatureInfoApplications)}catch(X){getFeatureInfoApplications=
[]}for(var N={},U=0;U<getFeatureInfoApplications.length;N={$jscomp$loop$prop$location$77$262:N.$jscomp$loop$prop$location$77$262},U++)N.$jscomp$loop$prop$location$77$262=getFeatureInfoApplications[U],ja.push({text:getFeatureInfoApplications[U].name,iconCls:getFeatureInfoApplications[U].iconCls,location:getFeatureInfoApplications[U].location,handler:function(X){return function(){console.log(X.$jscomp$loop$prop$location$77$262);p.setApplication(X.$jscomp$loop$prop$location$77$262);p.hide();p.show()}}(N)}),
...
versionInfo+I18n.about_adaguc_more_information.text}}).show()}});U=Ext.create("Ext.panel.Panel",{header:!1,title:" ",frame:!1,border:0,split:!1,id:"layerlistpanel",tooltip:I18n.layers.tooltip,overflowY:"auto",bodyCls:"layerlistbg",iconCls:"button_layers32",bbar:[{scale:"small",tooltip:I18n.add_new_layer.tooltip,iconCls:"layer_logos button_layerlist_layernew",handler:function(){createNewLayerPanel(mainWebmapJS.webMapJS,{service:""})}},{iconCls:"button_duplicate",tooltip:I18n.clone_this_layer.tooltip,
handler:function(){var X=getSelectedLayer();isDefined(X)&&X.duplicateLayer()}},{xtype:"button",tooltip:I18n.remove_this_layer.tooltip,iconCls:"button_layerlist_layerdelete",handler:function(X,ka){removeLayer()}},{xtype:"button",tooltip:I18n.move_layer_up.tooltip,iconCls:"button_layerlist_layerup",handler:function(X,ka){X=getSelectedLayer();isDefined(X)&&X.moveUp()}},{xtype:"button",tooltip:I18n.move_layer_down.tooltip,iconCls:"button_layerlist_layerdown",handler:function(X,ka){X=getSelectedLayer();
isDefined(X)&&X.moveDown()}},{xtype:"tbfill"},{iconCls:"button_settings_icon",tooltip:I18n.settings_and_options.tooltip,menu:{xtype:"menu",items:ja}}]});N=Ext.create("webmapjsext.WMJSExt.MapTypeSelector",{maptypeclicked:function(X){mainWebmapJS.webMapJS.setProjection({bbox:X.get("bbox"),srs:X.get("srs")});(X=X.get("baselayer"))&&X.service&&X.name&&(X.enabled=!0,mainWebmapJS.baseLayer.setService(X.service),mainWebmapJS.baseLayer.name=X.name,mainWebmapJS.baseLayer.enabled=!0,isDefined(X.transparent)&&
(mainWebmapJS.baseLayer.transparent=X.transparent),mainWebmapJS.baseLayer.parseLayer(function(){mainWebmapJS.webMapJS.draw("maptypeclicked")},void 0,"WMJSExtMain::maptypeclicked"))},webmapjsext:mainWebmapJS});var aa=Ext.create("webmapjsext.WMJSExt.BaseMapSelector",{webmapjsext:mainWebmapJS});N={id:"viewportwestpanel",width:320,region:"west",layout:"border",collapsible:!0,animCollapse:!0,border:!0,split:!0,header:!1,autoScroll:!1,frame:!0,items:[{layout:"fit",border:!1,autoScroll:!1,region:"center",
xtype:"tabpanel",scale:"large",cls:"LayersAndMapsTab",items:[U,N,aa,timeselectorPanel]}],tbar:[{scale:"large",text:"Add",tooltip:I18n.add_layers.tooltip,iconCls:"button_adddata32",handler:function(){dataChooserConfiguration=dataChooserConfigurationAdd;Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:z,webMapJS:mainWebmapJS.webMapJS}).show()}}]};for(U=0;U<dataChooser.length;U++)0!==dataChooser[U].dataChooserConfiguration.length&&(N.tbar.push({scale:"large",text:dataChooser[U].title,tooltip:I18n.add_layers.tooltip,
iconCls:"button_adddata32",ind:U,handler:function(){dataChooserConfiguration=dataChooser[this.ind].dataChooserConfiguration;Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:z,webMapJS:mainWebmapJS.webMapJS}).show()}}),N.width+=30);for(U=0;U<folderChooser.length;U++)0!==folderChooser[U].dataChooserConfigurationFolder.length&&(N.tbar.push({scale:"large",text:folderChooser[U].title,tooltip:I18n.add_layers.tooltip,iconCls:"folder_adddata32",ind:U,handler:function(){dataChooserConfigurationFolder=
folderChooser[this.ind].dataChooserConfigurationFolder;Ext.create("webmapjsext.WMJSExt.FolderPanel",{dataPanelClicked:z,webMapJS:mainWebmapJS.webMapJS}).show()}}),N.width+=30);N.tbar.push({iconCls:"button_settings32",tooltip:I18n.settings_and_options.tooltip,scale:"large",menu:{xtype:"menu",items:ja}});var ca=Ext.create("Ext.Viewport",{layout:"border",items:[N,e],renderTo:Ext.getBody(),listeners:{resize:{fn:function(){try{var X=viewportwestpanelwindow.y+viewportwestpanelwindow.height;X>ca.height&&
(X=ca.height-70,70>X&&(X=70));viewportwestpanelwindow.setSize(viewportwestpanelwindow.width,X)}catch(ka){}}}}}),ea=function(X){var ka=!0,za=!1;isDefined(X.collapse)&&"1"==X.collapse&&Ext.getCmp("viewportwestpanel").collapse();isDefined(X.zoomtolayer)&&"1"==X.zoomtolayer&&(ka=!0);isDefined(X.srs)&&isDefined(X.bbox)&&mainWebmapJS.webMapJS.setProjection({srs:X.srs,bbox:X.bbox});if(isDefined(X.service)){clearLayers(mainWebmapJS.webMapJS);var ya=URLDecode(X.service).split(","),ua=[""];isDefined(X.layer)?
ua=URLDecode(X.layer).split(","):1==ka&&(za=!0);isDefined(X.selected);for(var Ba=ua.length,Na=0;Na<ua.length;Na++)try{var Ga=ua[ua.length-1-Na].split("$"),Sa=Ga+"",db=!0,ab="",ib=1,lb=ya[0]+"";6==Ga.length&&(Sa=Ga[0],db=Ga[2],ab=Ga[3],ib=Ga[4],isDefined(db)&&("true"===db&&(db=!0),"false"===db&&(db=!1)),lb=ya[Ga[5]]);createNewLayerPanel(mainWebmapJS.webMapJS,{service:lb,name:Sa,style:ab,enabled:db,opacity:ib,ready:function(tb,Gb){Ba--;if(0==Ba){if(isDefined(X.dims))for(var Wb=X.dims.split(","),Ab=
0;Ab<Wb.length;Ab++){var nc=Wb[Ab].split("$");2==nc.length&&mainWebmapJS.webMapJS.setDimension(nc[0],nc[1])}1==ka&&tb.WMJSLayer.zoomToLayer();Gb.draw("index.html::numlayers=0")}},autoChooseLayer:za})}catch(tb){error("Unable to parse layer nr "+Na)}if(isDefined(X.baselayers)){ya=X.baselayers.split("$");za=[];for(Na=ua=0;Na<ya.length;Na++){Ga=!1;for(Sa=0;Sa<mapTypeConfiguration.length;Sa++)if(mapTypeConfiguration[Sa].baselayer.name==ya[Na]){mapTypeConfiguration[Sa].baselayer.enabled=!0;za.push(mapTypeConfiguration[Sa].baselayer);
Ga=!0;ua++;break}if(!Ga)for(Sa=0;Sa<baseLayerConfiguration.length;Sa++)if(baseLayerConfiguration[Sa].name==ya[Na]){baseLayerConfiguration[Sa].enabled=!0;za.push(baseLayerConfiguration[Sa]);Ga=!0;ua++;break}Ga||error("Warning: unable to find baselayer "+ya[Na])}for(Na=0;Na<baseLayerConfiguration.length;Na++)0==baseLayerConfiguration[Na].enabled?za.push(baseLayerConfiguration[Na]):0==ua&&za.push(baseLayerConfiguration[Na]);baseLayers=[];for(Na=0;Na<za.length;Na++)ya=new WMJSLayer(za[Na]),0==Na&&(mainWebmapJS.baseLayer=
ya),baseLayers.push(ya);0<baseLayers.length&&mainWebmapJS.webMapJS.setBaseLayers(baseLayers)}}X&&X.autowms&&(autowmsURL=X.autowms+"",-1===autowmsURL.indexOf("?")&&(autowmsURL+="?"),window.setTimeout(function(){p.setApplication(getFeatureInfoApplications.filter(function(tb){return"AutoWMS"===tb.name})[0]);p.hide();p.show()},100));X&&X.wms&&(console.log("wms found",X.wms),createNewLayerPanel(mainWebmapJS.webMapJS,{service:X.wms}))};0==window.location.hash.length&&ea(getUrlVars());checkIfHashTagChanged(function(X,
ka){if(0<=X.indexOf("addlayer('")){if(ka=X.substring(X.indexOf("addlayer('")+10,X.indexOf("',")),X=X.substring(X.indexOf(",'")+2,X.indexOf("')")),ka&&X){for(var za=!1,ya=mainWebmapJS.webMapJS.getLayers(),ua=0;ua<ya.length;ua++)if(ya[ua].service==ka&&ya[ua].name==X){za=!0;break}0==za&&(isDefined(hashLocationNotfiyAddLayer),firstTimeOpening=!0,createNewLayerPanel(mainWebmapJS.webMapJS,{service:ka,name:X,zoomtolayer:!1,notifyadded:!0}))}}else 0<=X.indexOf("positionmappinbylatlon(")?(debug(X),ka=X.substring(23,
X.indexOf(")")),debug(ka),ka=ka.split(","),debug(ka[0]+" "+ka[1]),mainWebmapJS.webMapJS.positionMapPinByLatLon({x:parseFloat(ka[0]),y:parseFloat(ka[1])})):0<=X.indexOf("refreshlayers")?updateLayers():ea(ka)});getFeatureInfoApplications.open&&p.show()});var gfiapp_d3c3=function(e,p){var z=function(ea,X){$("#"+X).empty();$("#"+X).append("<div style='height=240px;border=2px solid blue;' class='chart'>a</div>");$("#"+X).append("<div style='height=40px;border=2px solid red;' class='controls gfiapp_d3c3_export_to_csv_button'>b</div>");var ka=$("#"+X).find(".chart");X=$("#"+X).find(".controls");ka.html("graph");X.button({label:"Export to CSV"}).click(function(){console.log("Export to CSV");for(var za="",ya=ea.datatoplot,ua=0;ua<ya[0].length;ua++){for(var Ba=
0;Ba<ya.length;Ba++)0<Ba&&(za+=";"),za+=JSON.stringify(ya[Ba][ua]);za+="\n\r"}ya=document.createElement("a");ya.setAttribute("download","export.csv");ya.setAttribute("href",encodeURI("data:text/csv;charset=utf-8,"+za));console.log("Clicking link");document.body.appendChild(ya);ya.click();ya.remove()});c3.generate({bindto:ka.get(0),data:{x:"x",x_format:"%Y%m%d",columns:ea.datatoplot,types:{x:"area"}},axis:{x:{type:"timeseries",tick:{format:ea.timeFormat}},y:{label:ea.ylabel}},zoom:{enabled:!0},subchart:{show:!1}})},
F=function(ea,X){return ea>X?1:ea<X?-1:0},I=function(ea,X){var ka;for(ka=0;ka<X.length;ka++)try{if(X[ka].getTime()===ea.getTime())return ka}catch(za){}return-1},ja=function(ea,X){var ka=1;"string"!=typeof ea[0].dims&&(ka=ea[0].dims.length);for(var za=[],ya=function(Ga,Sa,db){var ab=["x"];Ga=[Sa.name+" "+Ga];for(var ib in db){Sa=d3.time.format("%Y-%m-%dT%H:%M:%SZ").parse(ib);var lb=parseFloat(db[ib]);ab.push(Sa);Ga.push(lb)}za.push({date:ab,value:Ga})},ua=function(Ga,Sa,db,ab){if(1==ka)ya("",Sa,db);
else if(Ga+2<ka)for(d in db)ua(Ga+1,Sa,db[d],ab+"["+d+"]");else for(d in db)ya("["+d+"]",Sa,db[d])},Ba=0;Ba<ea.length;Ba++)ua(0,ea[Ba],ea[Ba].data,"");Ba=function(Ga){for(var Sa=[],db=Ga.length,ab=0;ab<db;ab++)for(var ib=Ga[ab].date,lb=1;lb<ib.length;lb++){var tb=ib[lb],Gb=I(tb,Sa);-1==Gb&&Sa.push(tb)}Sa.sort(F);Sa.unshift("x");ib=[];for(lb=0;lb<db;lb++)ib.push([]);for(ab=0;ab<db;ab++)for(ib[ab].push(Ga[ab].value[0]),lb=1;lb<Sa.length;lb++)Gb=I(Sa[lb],Ga[ab].date),Gb==lb?(tb=Ga[ab].value[Gb],"nodata"==
tb&&(tb=NaN),ib[ab].push(parseFloat(tb))):ib[ab].push(NaN);Ga=[];Ga.push(Sa);for(ab=0;ab<db;ab++)Ga.push(ib[ab]);return Ga}(za);var Na=ea[0].name;ea[0].units&&(Na+=" in "+ea[0].units);z({datatoplot:Ba,ylabel:Na,timeFormat:"%Y-%m-%d %H:%M"},X)},N=function(ea,X){console.log(ea);ea.includes("time=")&&(i=ea.indexOf("time="),mURL0=ea.slice(0,i+5),mURLF=ea.slice(i+5,ea.length),ea=mURL0+"/"+mURLF);$.ajax({type:"GET",url:ea+"&JSONP=?",dataType:"jsonp",cache:!1,success:function(ka){try{ja(ka,X)}catch(za){$("#"+
X).html("Sorry! An error occurred while parsing JSON data: ["+za+"]")}},error:function(ka,za,ya){$("#"+X).html("Sorry! An error occurred while receiving JSON data from the server: ["+ya+"]");console.log("Error "+ya)}})},U=!0,aa=[];aa.set=!1;var ca=function(ea){if(0!=U){aa.x=ea.x;aa.y=ea.y;aa.set=!0;var X=p.getLatLongFromPixelCoord({x:ea.x,y:ea.y});$("#chart").html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');var ka=p.getLayers();if(isDefined(ka)){X="timeseries graph for location ["+Math.round(100*
X.x)/100+","+Math.round(100*X.y)/100+"]<br/>";$("#chart").empty();for(var za=0;za<ka.length;za++){var ya=p.getWMSGetFeatureInfoRequestURL(ka[za],ea.x,ea.y);ya=composeUrlObjectFromURL(ya);var ua=ya.location+"?";for(key in ya.kvp){var Ba=ya.kvp[key];"info_format"==key&&(Ba="application/json");"time"==key&&(Ba="1000-01-01T00:00:00Z/3000-01-01T00:00:00Z");"dim_member"==key&&(Ba="*");"dim_ensemble_member"==key&&(Ba="*");"dim_percentile"==key&&(Ba="*");ua+=key+"="+URLEncode(Ba)+"&"}$("#chart").append("<div class='chartstyle' id='chart"+
za+"'></div>");$("#chart"+za).html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');N(ua,"chart"+za)}$("#info").html(X)}else $("#info").html("No valid data received:<br/>"+data)}};p.addListener("mouseclicked",ca,!0);this.enable=function(){e.html('<div id="info"></div><div id="chart" class="gfiapp_d3c3"></div>');$("#info").html("Click on the map to create a timeseries graph.");console.log("init");p.enableInlineGetFeatureInfo(!1);U=!0};this.disable=function(){U=!1;p.enableInlineGetFeatureInfo(!0);
aa.set=!1};this.resize=function(ea,X){console.log("w="+ea);$("#chart").width(ea);aa.set&&ca(aa)};this.enable()};try{WMJSExtApplications["Time series mode"]=gfiapp_d3c3}catch(e){};(function(e,p){"object"===typeof exports&&"undefined"!==typeof module?p(exports):"function"===typeof define&&define.amd?define(["exports"],p):(e="undefined"!==typeof globalThis?globalThis:e||self,p(e.s3=e.s3||{}))})(this,function(e){function p(a,b){return a<b?-1:a>b?1:a>=b?0:NaN}function z(a){function b(g,h,m,l){null==m&&(m=0);null==l&&(l=g.length);for(;m<l;){var n=m+l>>>1;0>f(g[n],h)?m=n+1:l=n}return m}var c=a,f=a;1===a.length&&(c=function(g,h){return a(g)-h},f=F(a));return{left:b,center:function(g,
...
$jscomp.makeIterator(a);for(f=h.next();!f.done;f=h.next())f=f.value,null!=(f=b(f,++g,a))&&(f=+f)>=f&&++c}return c}function U(a){return a.length|0}function aa(a){return!(0<a)}function ca(a){return"object"!==typeof a||"length"in a?a:Array.from(a)}function ea(a){return function(b){return a.apply(null,$jscomp.arrayFromIterable(b))}}function X(a,b){var c=0,f,g=0,h=0;if(void 0===b)for(a=$jscomp.makeIterator(a),f=a.next();!f.done;f=a.next())b=f.value,null!=b&&(b=+b)>=b&&(f=b-g,g+=f/++c,h+=f*(b-g));else{var m=
-1,l=$jscomp.makeIterator(a);for(f=l.next();!f.done;f=l.next()){var n=f.value;null!=(n=b(n,++m,a))&&(n=+n)>=n&&(f=n-g,g+=f/++c,h+=f*(n-g))}}if(1<c)return h/(c-1)}function ka(a,b){return(a=X(a,b))?Math.sqrt(a):a}function za(a,b){var c,f;if(void 0===b){a=$jscomp.makeIterator(a);for(var g=a.next();!g.done;g=a.next())b=g.value,null!=b&&(void 0===c?b>=b&&(c=f=b):(c>b&&(c=b),f<b&&(f=b)))}else{var h=-1,m=$jscomp.makeIterator(a);for(g=m.next();!g.done;g=m.next())g=g.value,null!=(g=b(g,++h,a))&&(void 0===
c?g>=g&&(c=f=g):(c>g&&(c=g),f<g&&(f=g)))}return[c,f]}function ya(a,b){var c=a._intern;a=a._key;a=a(b);return c.has(a)?c.get(a):b}function ua(a,b){var c=a._intern;a=a._key;a=a(b);if(c.has(a))return c.get(a);c.set(a,b);return b}function Ba(a,b){var c=a._intern;a=a._key;a=a(b);c.has(a)&&(b=c.get(b),c.delete(a));return b}function Na(a){return null!==a&&"object"===typeof a?a.valueOf():a}function Ga(a){return a}function Sa(a,b){for(var c=[],f=1;f<arguments.length;++f)c[f-1]=arguments[f];return ib(a,Ga,
Ga,c)}function db(a,b,c){for(var f=[],g=2;g<arguments.length;++g)f[g-2]=arguments[g];return ib(a,Ga,b,f)}function ab(a){if(1!==a.length)throw Error("duplicate key");return a[0]}function ib(a,b,c,f){return function l(h,m){if(m>=f.length)return c(h);for(var n=new Wc,x=f[m++],C=-1,t=$jscomp.makeIterator(h),u=t.next();!u.done;u=t.next()){u=u.value;var v=x(u,++C,h),y=n.get(v);y?y.push(u):n.set(v,[u])}h=$jscomp.makeIterator(n);for(x=h.next();!x.done;x=h.next())C=$jscomp.makeIterator(x.value),x=C.next().value,
C=C.next().value,n.set(x,l(C,m));return b(n)}(a,0)}function lb(a,b){return Array.from(b,function(c){return a[c]})}function tb(a,b){for(var c=[],f=1;f<arguments.length;++f)c[f-1]=arguments[f];var g=c;if("function"!==typeof a[Symbol.iterator])throw new TypeError("values is not iterable");a=Array.from(a);c=$jscomp.makeIterator(g).next().value;var h=void 0===c?p:c;return 1===h.length||1<g.length?(c=Uint32Array.from(a,function(m,l){return l}),1<g.length?(g=g.map(function(m){return a.map(m)}),c.sort(function(m,
l){for(var n=$jscomp.makeIterator(g),x=n.next();!x.done;x=n.next())if(x=x.value,x=p(x[m],x[l]))return x})):(h=a.map(h),c.sort(function(m,l){return p(h[m],h[l])})),lb(a,c)):a.sort(h)}function Gb(a){return function(){return a}}function Wb(a,b,c){var f,g=-1,h;b=+b;a=+a;c=+c;if(a===b&&0<c)return[a];if(f=b<a){var m=a;a=b;b=m}if(0===(h=Ab(a,b,c))||!isFinite(h))return[];if(0<h)for(c=Math.round(a/h),m=Math.round(b/h),c*h<a&&++c,m*h>b&&--m,a=Array(m=m-c+1);++g<m;)a[g]=(c+g)*h;else for(h=-h,c=Math.round(a*
h),m=Math.round(b*h),c/h<a&&++c,m/h>b&&--m,a=Array(m=m-c+1);++g<m;)a[g]=(c+g)/h;f&&a.reverse();return a}function Ab(a,b,c){b=(b-a)/Math.max(0,c);a=Math.floor(Math.log(b)/Math.LN10);b/=Math.pow(10,a);return 0<=a?(b>=Fg?10:b>=Gg?5:b>=Hg?2:1)*Math.pow(10,a):-Math.pow(10,-a)/(b>=Fg?10:b>=Gg?5:b>=Hg?2:1)}function nc(a,b,c){var f=Math.abs(b-a)/Math.max(0,c);c=Math.pow(10,Math.floor(Math.log(f)/Math.LN10));f/=c;f>=Fg?c*=10:f>=Gg?c*=5:f>=Hg&&(c*=2);return b<a?-c:c}function hj(a,b,c){for(var f;;){var g=Ab(a,
b,c);if(g===f||0===g||!isFinite(g))return[a,b];0<g?(a=Math.floor(a/g)*g,b=Math.ceil(b/g)*g):0>g&&(a=Math.ceil(a*g)/g,b=Math.floor(b*g)/g);f=g}}function Ig(a){return Math.ceil(Math.log(N(a))/Math.LN2)+1}function ij(){function a(g){Array.isArray(g)||(g=Array.from(g));var h,m=g.length,l=Array(m);for(h=0;h<m;++h)l[h]=b(g[h],h,g);var n=c(l),x=n[0];n=n[1];var C=f(l,x,n);if(!Array.isArray(C)){h=n;var t=+C;c===za&&(n=$jscomp.makeIterator(hj(x,n,t)),x=n.next().value,n=n.next().value);C=Wb(x,n,t);C[C.length-
1]>=n&&(h>=n&&c===za?(h=Ab(x,n,t),isFinite(h)&&(0<h?n=(Math.floor(n/h)+1)*h:0>h&&(n=(Math.ceil(n*-h)+1)/-h))):C.pop())}for(t=C.length;C[0]<=x;)C.shift(),--t;for(;C[t-1]>n;)C.pop(),--t;var u=Array(t+1);for(h=0;h<=t;++h){var v=u[h]=[];v.x0=0<h?C[h-1]:x;v.x1=h<t?C[h]:n}for(h=0;h<m;++h)v=l[h],x<=v&&v<=n&&u[Jc(C,v,0,t)].push(g[h]);return u}var b=Ga,c=za,f=Ig;a.value=function(g){return arguments.length?(b="function"===typeof g?g:Gb(g),a):b};a.domain=function(g){return arguments.length?(c="function"===typeof g?
g:Gb([g[0],g[1]]),a):c};a.thresholds=function(g){return arguments.length?(f="function"===typeof g?g:Array.isArray(g)?Gb(lp.call(g)):Gb(g),a):f};return a}function Pe(a,b){var c;if(void 0===b){a=$jscomp.makeIterator(a);for(var f=a.next();!f.done;f=a.next())b=f.value,null!=b&&(c<b||void 0===c&&b>=b)&&(c=b)}else{var g=-1,h=$jscomp.makeIterator(a);for(f=h.next();!f.done;f=h.next())f=f.value,null!=(f=b(f,++g,a))&&(c<f||void 0===c&&f>=f)&&(c=f)}return c}function Qe(a,b){var c;if(void 0===b){a=$jscomp.makeIterator(a);
...
y=y.transition(v),fa=fa.transition(v),R=R.transition(v),P=P.transition(v).attr("opacity",1E-6).attr("transform",function(S){return isFinite(S=D(S))?u(S+x):this.getAttribute("transform")}),W.attr("opacity",1E-6).attr("transform",function(S){var ma=this.parentNode.__axis;return u((ma&&isFinite(ma=ma(S))?ma:D(S))+x)}));P.remove();M.attr("d",4===a||2===a?l?"M"+C*l+","+B+"H"+x+"V"+w+"H"+C*l:"M"+x+","+B+"V"+w:l?"M"+B+","+C*l+"V"+x+"H"+w+"V"+C*l:"M"+B+","+x+"H"+w);y.attr("opacity",1).attr("transform",function(S){return u(D(S)+
...
[document.documentElement]):new Hb([[a]],Sg)}function zj(){return new Tg}function Tg(){this._="@"+(++tq).toString(36)}function Aj(a){for(var b;b=a.sourceEvent;)a=b;return a}function Zb(a,b){a=Aj(a);void 0===b&&(b=a.currentTarget);if(b){var c=b.ownerSVGElement||b;if(c.createSVGPoint)return c=c.createSVGPoint(),c.x=a.clientX,c.y=a.clientY,c=c.matrixTransform(b.getScreenCTM().inverse()),[c.x,c.y];if(b.getBoundingClientRect)return c=b.getBoundingClientRect(),[a.clientX-c.left-b.clientLeft,a.clientY-c.top-
...
function Cj(){return this.rgb().formatRgb()}function Lc(a){var b,c;a=(a+"").trim().toLowerCase();return(b=yq.exec(a))?(c=b[1].length,b=parseInt(b[1],16),6===c?Dj(b):3===c?new Eb(b>>8&15|b>>4&240,b>>4&15|b&240,(b&15)<<4|b&15,1):8===c?Ye(b>>24&255,b>>16&255,b>>8&255,(b&255)/255):4===c?Ye(b>>12&15|b>>8&240,b>>8&15|b>>4&240,b>>4&15|b&240,((b&15)<<4|b&15)/255):null):(b=zq.exec(a))?new Eb(b[1],b[2],b[3],1):(b=Aq.exec(a))?new Eb(255*b[1]/100,255*b[2]/100,255*b[3]/100,1):(b=Bq.exec(a))?Ye(b[1],b[2],b[3],
b[4]):(b=Cq.exec(a))?Ye(255*b[1]/100,255*b[2]/100,255*b[3]/100,b[4]):(b=Dq.exec(a))?Ej(b[1],b[2]/100,b[3]/100,1):(b=Eq.exec(a))?Ej(b[1],b[2]/100,b[3]/100,b[4]):Fj.hasOwnProperty(a)?Dj(Fj[a]):"transparent"===a?new Eb(NaN,NaN,NaN,0):null}function Dj(a){return new Eb(a>>16&255,a>>8&255,a&255,1)}function Ye(a,b,c,f){0>=f&&(a=b=c=NaN);return new Eb(a,b,c,f)}function Vg(a){a instanceof Kc||(a=Lc(a));if(!a)return new Eb;a=a.rgb();return new Eb(a.r,a.g,a.b,a.opacity)}function td(a,b,c,f){return 1===arguments.length?
Vg(a):new Eb(a,b,c,null==f?1:f)}function Eb(a,b,c,f){this.r=+a;this.g=+b;this.b=+c;this.opacity=+f}function Gj(){return"#"+Wg(this.r)+Wg(this.g)+Wg(this.b)}function Hj(){var a=this.opacity;a=isNaN(a)?1:Math.max(0,Math.min(1,a));return(1===a?"rgb(":"rgba(")+Math.max(0,Math.min(255,Math.round(this.r)||0))+", "+Math.max(0,Math.min(255,Math.round(this.g)||0))+", "+Math.max(0,Math.min(255,Math.round(this.b)||0))+(1===a?")":", "+a+")")}function Wg(a){a=Math.max(0,Math.min(255,Math.round(a)||0));return(16>
...
b,c,f){return 1===arguments.length?Ij(a):new pc(a,b,c,null==f?1:f)}function pc(a,b,c,f){this.h=+a;this.s=+b;this.l=+c;this.opacity=+f}function Xg(a,b,c){return 255*(60>a?b+(c-b)*a/60:180>a?c:240>a?b+(c-b)*(240-a)/60:b)}function Jj(a){if(a instanceof ic)return new ic(a.l,a.a,a.b,a.opacity);if(a instanceof qc)return Kj(a);a instanceof Eb||(a=Vg(a));var b=Yg(a.r),c=Yg(a.g),f=Yg(a.b),g=Zg(.2225045*b+.7168786*c+.0606169*f);if(b===c&&c===f)var h=b=g;else h=Zg((.4360747*b+.3850649*c+.1430804*f)/.96422),
b=Zg((.0139322*b+.0971045*c+.7141733*f)/.82521);return new ic(116*g-16,500*(h-g),200*(g-b),a.opacity)}function $e(a,b,c,f){return 1===arguments.length?Jj(a):new ic(a,b,c,null==f?1:f)}function ic(a,b,c,f){this.l=+a;this.a=+b;this.b=+c;this.opacity=+f}function Zg(a){return a>Fq?Math.pow(a,1/3):a/Lj+Mj}function $g(a){return a>ud?a*a*a:Lj*(a-Mj)}function ah(a){return 255*(.0031308>=a?12.92*a:1.055*Math.pow(a,1/2.4)-.055)}function Yg(a){return.04045>=(a/=255)?a/12.92:Math.pow((a+.055)/1.055,2.4)}function Nj(a){if(a instanceof
qc)return new qc(a.h,a.c,a.l,a.opacity);a instanceof ic||(a=Jj(a));if(0===a.a&&0===a.b)return new qc(NaN,0<a.l&&100>a.l?0:NaN,a.l,a.opacity);var b=Math.atan2(a.b,a.a)*Oj;return new qc(0>b?b+360:b,Math.sqrt(a.a*a.a+a.b*a.b),a.l,a.opacity)}function af(a,b,c,f){return 1===arguments.length?Nj(a):new qc(a,b,c,null==f?1:f)}function qc(a,b,c,f){this.h=+a;this.c=+b;this.l=+c;this.opacity=+f}function Kj(a){if(isNaN(a.h))return new ic(a.l,0,0,a.opacity);var b=a.h*Pj;return new ic(a.l,Math.cos(b)*a.c,Math.sin(b)*
a.c,a.opacity)}function jc(a,b,c,f){if(1===arguments.length){var g=a;if(g instanceof $c)g=new $c(g.h,g.s,g.l,g.opacity);else{g instanceof Eb||(g=Vg(g));var h=g.g/255,m=g.b/255,l=(Qj*m+g.r/255*-1.7884503806-3.5172982438*h)/(Qj+-1.7884503806-3.5172982438);m-=l;var n=(1.97294*(h-l)- -.29227*m)/-.90649;m=(h=Math.sqrt(n*n+m*m)/(1.97294*l*(1-l)))?Math.atan2(n,m)*Oj-120:NaN;g=new $c(0>m?m+360:m,h,l,g.opacity)}}else g=new $c(a,b,c,null==f?1:f);return g}function $c(a,b,c,f){this.h=+a;this.s=+b;this.l=+c;this.opacity=
...
Math.pow(a,c),b=Math.pow(b,c)-a,c=1/c,function(f){return Math.pow(a+f*b,c)}}function bf(a,b){var c=b-a;return c?Uj(a,180<c||-180>c?c-360*Math.round(c/360):c):cf(isNaN(a)?b:a)}function Hq(a){return 1===(a=+a)?Bb:function(b,c){return c-b?Gq(b,c,a):cf(isNaN(b)?c:b)}}function Bb(a,b){var c=b-a;return c?Uj(a,c):cf(isNaN(a)?b:a)}function Vj(a){return function(b){var c=b.length,f=Array(c),g=Array(c),h=Array(c),m;for(m=0;m<c;++m){var l=td(b[m]);f[m]=l.r||0;g[m]=l.g||0;h[m]=l.b||0}f=a(f);g=a(g);h=a(h);l.opacity=
...
new Date;return a=+a,b=+b,function(f){return c.setTime(a*(1-f)+b*f),c}}function cc(a,b){return a=+a,b=+b,function(c){return a*(1-c)+b*c}}function Zj(a,b){var c={},f={},g;if(null===a||"object"!==typeof a)a={};if(null===b||"object"!==typeof b)b={};for(g in b)g in a?c[g]=Mc(a[g],b[g]):f[g]=b[g];return function(h){for(g in c)f[g]=c[g](h);return f}}function Iq(a){return function(){return a}}function Jq(a){return function(b){return a(b)+""}}function ch(a,b){var c=dh.lastIndex=eh.lastIndex=0,f,g,h,m=-1,
l=[],n=[];a+="";for(b+="";(f=dh.exec(a))&&(g=eh.exec(b));)(h=g.index)>c&&(h=b.slice(c,h),l[m]?l[m]+=h:l[++m]=h),(f=f[0])===(g=g[0])?l[m]?l[m]+=g:l[++m]=g:(l[++m]=null,n.push({i:m,x:cc(f,g)})),c=eh.lastIndex;c<b.length&&(h=b.slice(c),l[m]?l[m]+=h:l[++m]=h);return 2>l.length?n[0]?Jq(n[0].x):Iq(b):(b=n.length,function(x){for(var C=0,t;C<b;++C)l[(t=n[C]).i]=t.x(x);return l.join("")})}function Mc(a,b){var c=typeof b,f;return null==b||"boolean"===c?cf(b):("number"===c?cc:"string"===c?(f=Lc(b))?(b=f,de):
ch:b instanceof Lc?de:b instanceof Date?Yj:Wj(b)?bh:Array.isArray(b)?Xj:"function"!==typeof b.valueOf&&"function"!==typeof b.toString||isNaN(b)?Zj:cc)(a,b)}function df(a,b){return a=+a,b=+b,function(c){return Math.round(a*(1-c)+b*c)}}function ak(a,b,c,f,g,h){var m,l,n;if(m=Math.sqrt(a*a+b*b))a/=m,b/=m;if(n=a*c+b*f)c-=a*n,f-=b*n;if(l=Math.sqrt(c*c+f*f))c/=l,f/=l,n/=l;a*f<b*c&&(a=-a,b=-b,n=-n,m=-m);return{translateX:g,translateY:h,rotate:Math.atan2(b,a)*bk,skewX:Math.atan(n)*bk,scaleX:m,scaleY:l}}function ck(a,
b,c,f){function g(x){return x.length?x.pop()+" ":""}function h(x,C,t,u,v,y){x!==t||C!==u?(v=v.push("translate(",null,b,null,c),y.push({i:v-4,x:cc(x,t)},{i:v-2,x:cc(C,u)})):(t||u)&&v.push("translate("+t+b+u+c)}function m(x,C,t,u){x!==C?(180<x-C?C+=360:180<C-x&&(x+=360),u.push({i:t.push(g(t)+"rotate(",null,f)-2,x:cc(x,C)})):C&&t.push(g(t)+"rotate("+C+f)}function l(x,C,t,u){x!==C?u.push({i:t.push(g(t)+"skewX(",null,f)-2,x:cc(x,C)}):C&&t.push(g(t)+"skewX("+C+f)}function n(x,C,t,u,v,y){x!==t||C!==u?(v=
v.push(g(v)+"scale(",null,",",null,")"),y.push({i:v-4,x:cc(x,t)},{i:v-2,x:cc(C,u)})):1===t&&1===u||v.push(g(v)+"scale("+t+","+u+")")}return function(x,C){var t=[],u=[];x=a(x);C=a(C);h(x.translateX,x.translateY,C.translateX,C.translateY,t,u);m(x.rotate,C.rotate,t,u);l(x.skewX,C.skewX,t,u);n(x.scaleX,x.scaleY,C.scaleX,C.scaleY,t,u);x=C=null;return function(v){for(var y=-1,q=u.length,r;++y<q;)t[(r=u[y]).i]=r.x(v);return t.join("")}}}function dk(a){return((a=Math.exp(a))+1/a)/2}function ek(a){return function(b,
c){var f=a((b=Ze(b)).h,(c=Ze(c)).h),g=Bb(b.s,c.s),h=Bb(b.l,c.l),m=Bb(b.opacity,c.opacity);return function(l){b.h=f(l);b.s=g(l);b.l=h(l);b.opacity=m(l);return b+""}}}function fk(a){return function(b,c){var f=a((b=af(b)).h,(c=af(c)).h),g=Bb(b.c,c.c),h=Bb(b.l,c.l),m=Bb(b.opacity,c.opacity);return function(l){b.h=f(l);b.c=g(l);b.l=h(l);b.opacity=m(l);return b+""}}}function gk(a){return function f(c){function g(h,m){var l=a((h=jc(h)).h,(m=jc(m)).h),n=Bb(h.s,m.s),x=Bb(h.l,m.l),C=Bb(h.opacity,m.opacity);
...
c=h;h=0;for(var m=f.length;h<m;++h)if(f[h].name===b){f=f.slice();f.splice(h,1);break}}g.tween=f}}function Qq(a,b,c){var f,g;if("function"!==typeof c)throw Error();return function(){var h=rc(this,a),m=h.tween;if(m!==f){g=(f=m).slice();m={name:b,value:c};for(var l=0,n=g.length;l<n;++l)if(g[l].name===b){g[l]=m;break}l===n&&g.push(m)}h.tween=g}}function ih(a,b,c){var f=a._id;a.each(function(){var g=rc(this,f);(g.value||(g.value={}))[b]=c.apply(this,arguments)});return function(g){return kc(g,f).value[b]}}
function lk(a,b){var c;return("number"===typeof b?cc:b instanceof Lc?de:(c=Lc(b))?(b=c,de):ch)(a,b)}function Rq(a){return function(){this.removeAttribute(a)}}function Sq(a){return function(){this.removeAttributeNS(a.space,a.local)}}function Tq(a,b,c){var f,g=c+"",h;return function(){var m=this.getAttribute(a);return m===g?null:m===f?h:h=b(f=m,c)}}function Uq(a,b,c){var f,g=c+"",h;return function(){var m=this.getAttributeNS(a.space,a.local);return m===g?null:m===f?h:h=b(f=m,c)}}function Vq(a,b,c){var f,
...
D.clean?new g(r,w,B):D}function g(r,w,B){this.that=r;this.args=w;this.state=r.__brush;this.active=0;this.clean=B}function h(r){function w(O){for(var Y=$jscomp.makeIterator(O.changedTouches||[O]),oa=Y.next();!oa.done;oa=Y.next()){oa=oa.value;for(var Z=$jscomp.makeIterator(E),ta=Z.next();!ta.done;ta=Z.next())ta=ta.value,ta.identifier===oa.identifier&&(ta.cur=Zb(oa,P))}!k||A||G||1!==E.length||(Y=E[0],uk(Y.cur[0]-Y[0])>uk(Y.cur[1]-Y[1])?G=!0:A=!0);Y=$jscomp.makeIterator(E);for(oa=Y.next();!oa.done;oa=
Y.next())oa=oa.value,oa.cur&&(oa[0]=oa.cur[0],oa[1]=oa.cur[1]);Ua=!0;O.preventDefault();O.stopImmediatePropagation();B(O)}function B(O){var Y=E[0],oa=Y.point0;Da=Y[0]-oa[0];Ka=Y[1]-oa[1];switch(fa){case oh:case vk:R&&(Da=Jb(Ha-pa,Kb(L-V,Da)),H=pa+Da,T=V+Da);S&&(Ka=Jb(Ea-Pa,Kb(Aa-Ia,Ka)),K=Pa+Ka,Q=Ia+Ka);break;case wd:E[1]?(R&&(H=Jb(Ha,Kb(L,E[0][0])),T=Jb(Ha,Kb(L,E[1][0])),R=1),S&&(K=Jb(Ea,Kb(Aa,E[0][1])),Q=Jb(Ea,Kb(Aa,E[1][1])),S=1)):(0>R?(Da=Jb(Ha-pa,Kb(L-pa,Da)),H=pa+Da,T=V):0<R&&(Da=Jb(Ha-V,Kb(L-
V,Da)),H=pa,T=V+Da),0>S?(Ka=Jb(Ea-Pa,Kb(Aa-Pa,Ka)),K=Pa+Ka,Q=Ia):0<S&&(Ka=Jb(Ea-Ia,Kb(Aa-Ia,Ka)),K=Pa,Q=Ia+Ka));break;case xd:R&&(H=Jb(Ha,Kb(L,pa-Da*R)),T=Jb(Ha,Kb(L,V+Da*R))),S&&(K=Jb(Ea,Kb(Aa,Pa-Ka*S)),Q=Jb(Ea,Kb(Aa,Ia+Ka*S)))}T<H&&(R*=-1,Y=pa,pa=V,V=Y,Y=H,H=T,T=Y,W in wk&&da.attr("cursor",Ac[W=wk[W]]));Q<K&&(S*=-1,Y=Pa,Pa=Ia,Ia=Y,Y=K,K=Q,Q=Y,W in xk&&da.attr("cursor",Ac[W=xk[W]]));ma.selection&&(qa=ma.selection);A&&(H=qa[0][0],T=qa[1][0]);G&&(K=qa[0][1],Q=qa[1][1]);if(qa[0][0]!==H||qa[0][1]!==
K||qa[1][0]!==T||qa[1][1]!==Q)ma.selection=[[H,K],[T,Q]],c.call(P),na.brush(O,fa.name)}function D(O){O.stopImmediatePropagation();if(O.touches){if(O.touches.length)return;q&&clearTimeout(q);q=setTimeout(function(){q=null},500)}else Xe(O.view,Ua),ra.on("keydown.brush keyup.brush mousemove.brush mouseup.brush",null);ba.attr("pointer-events","all");da.attr("cursor",Ac.overlay);ma.selection&&(qa=ma.selection);if(qa[0][0]===qa[1][0]||qa[0][1]===qa[1][1])ma.selection=null,c.call(P);na.end(O,fa.name)}function J(O){switch(O.keyCode){case 16:k=
R&&S;break;case 18:fa===wd&&(R&&(V=T-Da*R,pa=H+Da*R),S&&(Ia=Q-Ka*S,Pa=K+Ka*S),fa=xd,B());break;case 32:if(fa===wd||fa===xd)0>R?V=T-Da:0<R&&(pa=H-Da),0>S?Ia=Q-Ka:0<S&&(Pa=K-Ka),fa=oh,da.attr("cursor",Ac.selection),B();break;default:return}O.preventDefault();O.stopImmediatePropagation()}function M(O){switch(O.keyCode){case 16:k&&(A=G=k=!1,B());break;case 18:fa===xd&&(0>R?V=T:0<R&&(pa=H),0>S?Ia=Q:0<S&&(Pa=K),fa=wd,B());break;case 32:fa===oh&&(O.altKey?(R&&(V=T-Da*R,pa=H+Da*R),S&&(Ia=Q-Ka*S,Pa=K+Ka*S),
fa=xd):(0>R?V=T:0<R&&(pa=H),0>S?Ia=Q:0<S&&(Pa=K),fa=wd),da.attr("cursor",Ac[W]),B());break;default:return}O.preventDefault();O.stopImmediatePropagation()}if((!q||r.touches)&&C.apply(this,arguments)){var P=this,W=r.target.__data__.type,fa="selection"===(u&&r.metaKey?W="overlay":W)?vk:u&&r.altKey?xd:wd,R=a===lf?null:Cr[W],S=a===mf?null:Dr[W],ma=mh(P),ia=ma.extent,qa=ma.selection,Ha=ia[0][0],pa,Ea=ia[0][1],Pa,L=ia[1][0],V,Aa=ia[1][1],Ia,Da=0,Ka=0,Ua,k=R&&S&&u&&r.shiftKey,A,G,E=Array.from(r.touches||
[r],function(O){var Y=O.identifier;O=Zb(O,P);O.point0=O.slice();O.identifier=Y;return O});"overlay"===W?(qa&&(Ua=!0),ia=[E[0],E[1]||E[0]],ma.selection=qa=[[pa=a===lf?Ha:Kb(ia[0][0],ia[1][0]),Pa=a===mf?Ea:Kb(ia[0][1],ia[1][1])],[V=a===lf?L:Jb(ia[0][0],ia[1][0]),Ia=a===mf?Aa:Jb(ia[0][1],ia[1][1])]],1<E.length&&B()):(pa=qa[0][0],Pa=qa[0][1],V=qa[1][0],Ia=qa[1][1]);var H=pa;var K=Pa;var T=V;var Q=Ia;var ba=Ib(P).attr("pointer-events","none"),da=ba.selectAll(".overlay").attr("cursor",Ac[W]);bd(P);var na=
...
(n="function"===typeof C?C:cd(+C),b):n};b.source=function(C){return arguments.length?(c=C,b):c};b.target=function(C){return arguments.length?(f=C,b):f};b.context=function(C){return arguments.length?(x=null==C?null:C,b):x};return b}function Mr(a,b){return a-b}function Nr(){}function Dk(){function a(n){var x=m(n);if(Array.isArray(x))x=x.slice().sort(Mr);else{var C=za(n),t=C[0];C=C[1];x=nc(t,C,x);x=oc(Math.floor(t/x)*x,Math.floor(C/x)*x,x)}return x.map(function(u){return b(n,u)})}function b(n,x){var C=
[],t=[];c(n,x,function(u){l(u,n,x);for(var v=0,y=u.length,q=u[y-1][1]*u[0][0]-u[y-1][0]*u[0][1];++v<y;)q+=u[v-1][1]*u[v][0]-u[v-1][0]*u[v][1];0<q?C.push([u]):t.push(u)});t.forEach(function(u){for(var v=0,y=C.length,q;v<y;++v){a:{var r=(q=C[v])[0];for(var w=u,B=-1,D=w.length;++B<D;){b:{var J=r;for(var M=w[B],P=M[0],W=M[1],fa=-1,R=0,S=J.length,ma=S-1;R<S;ma=R++){var ia=J[R],qa=ia[0],Ha=ia[1],pa=J[ma];ma=pa[0];var Ea=pa[1],Pa,L=ia;ia=pa;pa=M;if(Pa=(ia[0]-L[0])*(pa[1]-L[1])===(pa[0]-L[0])*(ia[1]-L[1]))L=
L[Pa=+(L[0]===ia[0])],pa=pa[Pa],ia=ia[Pa],Pa=L<=pa&&pa<=ia||ia<=pa&&pa<=L;if(Pa){J=0;break b}Ha>W!==Ea>W&&P<(ma-qa)*(W-Ha)/(Ea-Ha)+qa&&(fa=-fa)}J=fa}if(J){r=J;break a}}r=0}if(-1!==r){q.push(u);break}}});return{type:"MultiPolygon",value:x,coordinates:C}}function c(n,x,C){function t(J){var M=[J[0][0]+q,J[0][1]+y];J=[J[1][0]+q,J[1][1]+y];var P=2*M[0]+M[1]*(g+1)*4,W=2*J[0]+J[1]*(g+1)*4,fa,R;(fa=v[P])?(R=u[W])?(delete v[fa.end],delete u[R.start],fa===R?(fa.ring.push(J),C(fa.ring)):u[fa.start]=v[R.end]=
...
2).join("0")}function Ok(a){return a}function Pk(a){function b(C){function t(S){var ma=P,ia=W,qa,Ha;if("c"===M)ia=fa(S)+ia,S="";else{S=+S;var pa=0>S||0>1/S;S=isNaN(S)?x:fa(Math.abs(S),D);if(J){var Ea=S.length,Pa=1,L=-1;a:for(;Pa<Ea;++Pa)switch(S[Pa]){case ".":L=qa=Pa;break;case "0":0===L&&(L=Pa);qa=Pa;break;default:if(!+S[Pa])break a;0<L&&(L=0)}S=0<L?S.slice(0,L)+S.slice(qa+1):S}pa&&0===+S&&"+"!==y&&(pa=!1);ma=(pa?"("===y?y:n:"-"===y||"("===y?"":y)+ma;ia=("s"===M?Qk[8+Rk/3]:"")+ia+(pa&&"("===y?")":
"");if(R)for(pa=-1,qa=S.length;++pa<qa;)if(Ha=S.charCodeAt(pa),48>Ha||57<Ha){ia=(46===Ha?h+S.slice(pa+1):S.slice(pa))+ia;S=S.slice(0,pa);break}}B&&!r&&(S=c(S,Infinity));Ha=ma.length+S.length+ia.length;pa=Ha<w?Array(w-Ha+1).join(u):"";B&&r&&(S=c(pa+S,pa.length?w-ia.length:Infinity),pa="");switch(v){case "<":S=ma+S+ia+pa;break;case "=":S=ma+pa+S+ia;break;case "^":S=pa.slice(0,Ha=pa.length>>1)+ma+S+ia+pa.slice(Ha);break;default:S=pa+ma+S+ia}return m(S)}C=ne(C);var u=C.fill,v=C.align,y=C.sign,q=C.symbol,
...
Pk(a);e.format=uf.format;e.formatPrefix=uf.formatPrefix;return uf}function Vk(a){return Math.max(0,-Bd(Math.abs(a)))}function Wk(a,b){return Math.max(0,3*Math.max(-8,Math.min(8,Math.floor(Bd(b)/3)))-Bd(Math.abs(a)))}function Xk(a,b){a=Math.abs(a);b=Math.abs(b)-a;return Math.max(0,Bd(b)-Bd(a))+1}function Yk(a){return 1<a?0:-1>a?bb:Math.acos(a)}function Pb(a){return 1<a?nb:-1>a?-nb:Math.asin(a)}function Zk(a){return(a=Ma(a/2))*a}function pb(){}function vf(a,b){if(a&&$k.hasOwnProperty(a.type))$k[a.type](a,
b)}function Ah(a,b,c){var f=-1;c=a.length-c;for(b.lineStart();++f<c;){var g=a[f];b.point(g[0],g[1],g[2])}b.lineEnd()}function al(a,b){var c=-1,f=a.length;for(b.polygonStart();++c<f;)Ah(a[c],b,1);b.polygonEnd()}function lc(a,b){if(a&&bl.hasOwnProperty(a.type))bl[a.type](a,b);else vf(a,b)}function ms(){tc.point=ns}function os(){cl(dl,el)}function ns(a,b){tc.point=cl;dl=a;el=b;a*=Ta;b*=Ta;Bh=a;Ch=Qa(b=b/2+wf);Dh=Ma(b)}function cl(a,b){a*=Ta;b*=Ta;b=b/2+wf;var c=a-Bh,f=0<=c?1:-1,g=f*c;c=Qa(b);b=Ma(b);
var h=Dh*b,m=Ch*c+h*Qa(g);f=h*f*Ma(g);xf.add(Qb(f,m));Bh=a;Ch=c;Dh=b}function yf(a){return[Qb(a[1],a[0]),Pb(a[2])]}function dd(a){var b=a[0];a=a[1];var c=Qa(a);return[c*Qa(b),c*Ma(b),Ma(a)]}function zf(a,b){return a[0]*b[0]+a[1]*b[1]+a[2]*b[2]}function Cd(a,b){return[a[1]*b[2]-a[2]*b[1],a[2]*b[0]-a[0]*b[2],a[0]*b[1]-a[1]*b[0]]}function Eh(a,b){a[0]+=b[0];a[1]+=b[1];a[2]+=b[2]}function Af(a,b){return[a[0]*b,a[1]*b,a[2]*b]}function Bf(a){var b=Cb(a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);a[0]/=b;a[1]/=b;a[2]/=
b}function Fh(a,b){Qc.push(Cc=[qb=a,rb=a]);b<Yb&&(Yb=b);b>$b&&($b=b)}function fl(a,b){var c=dd([a*Ta,b*Ta]);if(Dd){var f=Cd(Dd,c);f=Cd([f[1],-f[0],0],f);Bf(f);f=yf(f);var g=a-ed,h=0<g?1:-1,m=f[0]*jb*h;g=180<eb(g);g^(h*ed<m&&m<h*a)?(f=f[1]*jb,f>$b&&($b=f)):(m=(m+360)%360-180,g^(h*ed<m&&m<h*a))?(f=-f[1]*jb,f<Yb&&(Yb=f)):(b<Yb&&(Yb=b),b>$b&&($b=b));g?a<ed?ac(qb,a)>ac(qb,rb)&&(rb=a):ac(a,rb)>ac(qb,rb)&&(qb=a):rb>=qb?(a<qb&&(qb=a),a>rb&&(rb=a)):a>ed?ac(qb,a)>ac(qb,rb)&&(rb=a):ac(a,rb)>ac(qb,rb)&&(qb=a)}else Qc.push(Cc=
[qb=a,rb=a]);b<Yb&&(Yb=b);b>$b&&($b=b);Dd=c;ed=a}function gl(){Dc.point=fl}function hl(){Cc[0]=qb;Cc[1]=rb;Dc.point=Fh;Dd=null}function il(a,b){if(Dd){var c=a-ed;oe.add(180<eb(c)?c+(0<c?360:-360):c)}else jl=a,kl=b;tc.point(a,b);fl(a,b)}function ps(){tc.lineStart()}function qs(){il(jl,kl);tc.lineEnd();1E-6<eb(oe)&&(qb=-(rb=180));Cc[0]=qb;Cc[1]=rb;Dd=null}function ac(a,b){return 0>(b-=a)?b+360:b}function rs(a,b){return a[0]-b[0]}function ll(a,b){return a[0]<=a[1]?a[0]<=b&&b<=a[1]:b<a[0]||a[1]<b}function Gh(a,
b){a*=Ta;b*=Ta;var c=Qa(b);pe(c*Qa(a),c*Ma(a),Ma(b))}function pe(a,b,c){++qe;Cf+=(a-Cf)/qe;Df+=(b-Df)/qe;Ef+=(c-Ef)/qe}function ml(){mc.point=ss}function ss(a,b){a*=Ta;b*=Ta;var c=Qa(b);Rb=c*Qa(a);Sb=c*Ma(a);Tb=Ma(b);mc.point=ts;pe(Rb,Sb,Tb)}function ts(a,b){a*=Ta;b*=Ta;var c=Qa(b),f=c*Qa(a);a=c*Ma(a);b=Ma(b);var g=Qb(Cb((g=Sb*b-Tb*a)*g+(g=Tb*f-Rb*b)*g+(g=Rb*a-Sb*f)*g),Rb*f+Sb*a+Tb*b);Ff+=g;Gf+=g*(Rb+(Rb=f));Hf+=g*(Sb+(Sb=a));If+=g*(Tb+(Tb=b));pe(Rb,Sb,Tb)}function nl(){mc.point=Gh}function us(){mc.point=
vs}function ws(){ol(pl,ql);mc.point=Gh}function vs(a,b){pl=a;ql=b;a*=Ta;b*=Ta;mc.point=ol;var c=Qa(b);Rb=c*Qa(a);Sb=c*Ma(a);Tb=Ma(b);pe(Rb,Sb,Tb)}function ol(a,b){a*=Ta;b*=Ta;var c=Qa(b),f=c*Qa(a);a=c*Ma(a);b=Ma(b);c=Sb*b-Tb*a;var g=Tb*f-Rb*b,h=Rb*a-Sb*f,m=Hh(c,g,h),l=Pb(m);m=m&&-l/m;Ih.add(m*c);Jh.add(m*g);Kh.add(m*h);Ff+=l;Gf+=l*(Rb+(Rb=f));Hf+=l*(Sb+(Sb=a));If+=l*(Tb+(Tb=b));pe(Rb,Sb,Tb)}function Ed(a){return function(){return a}}function Lh(a,b){function c(f,g){return f=a(f,g),b(f[0],f[1])}a.invert&&
b.invert&&(c.invert=function(f,g){return f=b.invert(f,g),f&&a.invert(f[0],f[1])});return c}function Mh(a,b){return[eb(a)>bb?a+Math.round(-a/Ub)*Ub:a,b]}function Nh(a,b,c){return(a%=Ub)?b||c?Lh(rl(a),sl(b,c)):rl(a):b||c?sl(b,c):Mh}function tl(a){return function(b,c){return b+=a,[b>bb?b-Ub:b<-bb?b+Ub:b,c]}}function rl(a){var b=tl(a);b.invert=tl(-a);return b}function sl(a,b){function c(l,n){var x=Qa(n),C=Qa(l)*x;l=Ma(l)*x;n=Ma(n);x=n*f+C*g;return[Qb(l*h-x*m,C*f-n*g),Pb(x*h+l*m)]}var f=Qa(a),g=Ma(a),
h=Qa(b),m=Ma(b);c.invert=function(l,n){var x=Qa(n),C=Qa(l)*x;l=Ma(l)*x;n=Ma(n);x=n*h-l*m;return[Qb(l*h+n*m,C*f+x*g),Pb(x*f-C*g)]};return c}function ul(a){function b(c){c=a(c[0]*Ta,c[1]*Ta);return c[0]*=jb,c[1]*=jb,c}a=Nh(a[0]*Ta,a[1]*Ta,2<a.length?a[2]*Ta:0);b.invert=function(c){c=a.invert(c[0]*Ta,c[1]*Ta);return c[0]*=jb,c[1]*=jb,c};return b}function vl(a,b,c,f,g,h){if(c){var m=Qa(b),l=Ma(b);c*=f;if(null==g)g=b+f*Ub,h=b-c/2;else if(g=wl(m,g),h=wl(m,h),0<f?g<h:g>h)g+=f*Ub;for(;0<f?g>h:g<h;g-=c)b=
yf([m,-l*Qa(g),-l*Ma(g)]),a.point(b[0],b[1])}}function wl(a,b){b=dd(b);b[0]-=a;Bf(b);a=Yk(-b[1]);return((0>-b[2]?-a:a)+Ub-1E-6)%Ub}function xl(){var a=[],b;return{point:function(c,f,g){b.push([c,f,g])},lineStart:function(){a.push(b=[])},lineEnd:pb,rejoin:function(){1<a.length&&a.push(a.pop().concat(a.shift()))},result:function(){var c=a;a=[];b=null;return c}}}function Jf(a,b){return 1E-6>eb(a[0]-b[0])&&1E-6>eb(a[1]-b[1])}function Kf(a,b,c,f){this.x=a;this.z=b;this.o=c;this.e=f;this.v=!1;this.n=this.p=
...
do{x.v=x.o.v=!0;if(x.e){if(C)for(l=0,a=b.length;l<a;++l)g.point((n=b[l])[0],n[1]);else f(x.x,x.n.x,1,g);x=x.n}else{if(C)for(b=x.p.z,l=b.length-1;0<=l;--l)g.point((n=b[l])[0],n[1]);else f(x.x,x.p.x,-1,g);x=x.p}x=x.o;b=x.z;C=!C}while(!x.v);g.lineEnd()}}}function zl(a){if(b=a.length){for(var b,c=0,f=a[0],g;++c<b;)f.n=g=a[c],g.p=f,f=g;f.n=g=a[0];g.p=f}}function Oh(a){return eb(a[0])<=bb?a[0]:dc(a[0])*((eb(a[0])+bb)%Ub-bb)}function Al(a,b){var c=Oh(b);b=b[1];var f=Ma(b),g=[Ma(c),-Qa(c),0],h=0,m=0,l=new ub;
1===f?b=nb+1E-6:-1===f&&(b=-nb-1E-6);f=0;for(var n=a.length;f<n;++f)if(C=(x=a[f]).length){var x,C,t=x[C-1],u=Oh(t),v=t[1]/2+wf,y=Ma(v),q=Qa(v);for(v=0;v<C;++v,u=w,y=B,q=D,t=r){var r=x[v],w=Oh(r);D=r[1]/2+wf;var B=Ma(D),D=Qa(D),J=w-u,M=0<=J?1:-1,P=M*J,W=P>bb;y*=B;l.add(Qb(y*M*Ma(P),q*D+y*Qa(P)));h+=W?J+M*Ub:J;W^u>=c^w>=c&&(t=Cd(dd(t),dd(r)),Bf(t),u=Cd(g,t),Bf(u),u=(W^0<=J?-1:1)*Pb(u[2]),b>u||b===u&&(t[0]||t[1]))&&(m+=W^0<=J?1:-1)}}return(-1E-6>h||1E-6>h&&-1E-12>l)^m&1}function Bl(a,b,c,f){return function(g){function h(J,
...
a.length}function ys(a,b){return(0>(a=a.x)[0]?a[1]-nb-1E-6:nb-a[1])-(0>(b=b.x)[0]?b[1]-nb-1E-6:nb-b[1])}function Cl(a){function b(n,x){return Qa(n)*Qa(x)>g}function c(n,x,C){var t=dd(n),u=dd(x),v=[1,0,0];u=Cd(t,u);var y=zf(u,u);t=u[0];var q=y-t*t;if(!q)return!C&&n;y=g*y/q;q=-g*t/q;t=Cd(v,u);v=Af(v,y);u=Af(u,q);Eh(v,u);u=zf(v,t);y=zf(t,t);q=u*u-y*(zf(v,v)-1);if(!(0>q)){var r=Cb(q);q=Af(t,(-u-r)/y);Eh(q,v);q=yf(q);if(!C)return q;C=n[0];var w=x[0];n=n[1];x=x[1];if(w<C){var B=C;C=w;w=B}var D=w-C,J=1E-6>
eb(D-bb);!J&&x<n&&(B=n,n=x,x=B);if(J||1E-6>D?J?0<n+x^q[1]<(1E-6>eb(q[0]-C)?n:x):n<=q[1]&&q[1]<=x:D>bb^(C<=q[0]&&q[0]<=w))return x=Af(t,(-u+r)/y),Eh(x,v),[q,yf(x)]}}function f(n,x){var C=m?a:bb-a,t=0;n<-C?t|=1:n>C&&(t|=2);x<-C?t|=4:x>C&&(t|=8);return t}var g=Qa(a),h=6*Ta,m=0<g,l=1E-6<eb(g);return Bl(b,function(n){var x,C,t,u,v;return{lineStart:function(){u=t=!1;v=1},point:function(y,q){var r=[y,q],w=b(y,q);q=m?w?0:f(y,q):w?f(y+(0>y?bb:-bb),q):0;!x&&(u=t=w)&&n.lineStart();w!==t&&(y=c(x,r),!y||Jf(x,
...
x)},m?[0,-a]:[-bb,a-bb])}function zs(a,b,c,f,g,h){var m=a[0],l=a[1],n=0,x=1,C=b[0]-m,t=b[1]-l;c-=m;if(C||!(0<c)){c/=C;if(0>C){if(c<n)return;c<x&&(x=c)}else if(0<C){if(c>x)return;c>n&&(n=c)}c=g-m;if(C||!(0>c)){c/=C;if(0>C){if(c>x)return;c>n&&(n=c)}else if(0<C){if(c<n)return;c<x&&(x=c)}c=f-l;if(t||!(0<c)){c/=t;if(0>t){if(c<n)return;c<x&&(x=c)}else if(0<t){if(c>x)return;c>n&&(n=c)}c=h-l;if(t||!(0>c)){c/=t;if(0>t){if(c>x)return;c>n&&(n=c)}else if(0<t){if(c<n)return;c<x&&(x=c)}0<n&&(a[0]=m+n*C,a[1]=l+
n*t);1>x&&(b[0]=m+x*C,b[1]=l+x*t);return!0}}}}}function Lf(a,b,c,f){function g(n,x,C,t){var u=0,v=0;if(null==n||(u=h(n,C))!==(v=h(x,C))||0>l(n,x)^0<C){do t.point(0===u||3===u?a:c,1<u?f:b);while((u=(u+C+4)%4)!==v)}else t.point(x[0],x[1])}function h(n,x){return 1E-6>eb(n[0]-a)?0<x?0:3:1E-6>eb(n[0]-c)?0<x?2:1:1E-6>eb(n[1]-b)?0<x?1:0:0<x?3:2}function m(n,x){return l(n.x,x.x)}function l(n,x){var C=h(n,1),t=h(x,1);return C!==t?C-t:0===C?x[1]-n[1]:1===C?n[0]-x[0]:2===C?n[1]-x[1]:x[0]-n[0]}return function(n){function x(R,
S){a<=R&&R<=c&&b<=S&&S<=f&&t.point(R,S)}function C(R,S){var ma=a<=R&&R<=c&&b<=S&&S<=f;y&&q.push([R,S]);if(P)r=R,w=S,B=ma,P=!1,ma&&(t.lineStart(),t.point(R,S));else if(ma&&M)t.point(R,S);else{var ia=[D=Math.max(-1E9,Math.min(1E9,D)),J=Math.max(-1E9,Math.min(1E9,J))],qa=[R=Math.max(-1E9,Math.min(1E9,R)),S=Math.max(-1E9,Math.min(1E9,S))];zs(ia,qa,a,b,c,f)?(M||(t.lineStart(),t.point(ia[0],ia[1])),t.point(qa[0],qa[1]),ma||t.lineEnd(),W=!1):ma&&(t.lineStart(),t.point(R,S),W=!1)}D=R;J=S;M=ma}var t=n,u=xl(),
v,y,q,r,w,B,D,J,M,P,W,fa={point:x,lineStart:function(){fa.point=C;y&&y.push(q=[]);P=!0;M=!1;D=J=NaN},lineEnd:function(){v&&(C(r,w),B&&M&&u.rejoin(),v.push(u.result()));fa.point=x;M&&t.lineEnd()},polygonStart:function(){t=u;v=[];y=[];W=!0},polygonEnd:function(){for(var R,S=R=0,ma=y.length;S<ma;++S){var ia=y[S],qa=1,Ha=ia.length,pa=ia[0],Ea=pa[0];for(pa=pa[1];qa<Ha;++qa){var Pa=Ea;var L=pa;pa=ia[qa];Ea=pa[0];pa=pa[1];L<=f?pa>f&&(Ea-Pa)*(f-L)>(pa-L)*(a-Pa)&&++R:pa<=f&&(Ea-Pa)*(f-L)<(pa-L)*(a-Pa)&&--R}}S=
W&&R;ma=(v=Kg(v)).length;if(S||ma)n.polygonStart(),S&&(n.lineStart(),g(null,null,1,n),n.lineEnd()),ma&&yl(v,m,R,g,n),n.polygonEnd();t=n;v=y=q=null}};return fa}}function As(){Fd.point=Fd.lineEnd=pb}function Bs(a,b){a*=Ta;b*=Ta;Ph=a;Mf=Ma(b);Nf=Qa(b);Fd.point=Cs}function Cs(a,b){a*=Ta;b*=Ta;var c=Ma(b);b=Qa(b);var f=eb(a-Ph),g=Qa(f);f=Ma(f);f*=b;var h=Nf*c-Mf*b*g;g=Mf*c+Nf*b*g;Qh.add(Qb(Cb(f*f+h*h),g));Ph=a;Mf=c;Nf=b}function Dl(a){Qh=new ub;lc(a,Fd);return+Qh}function re(a,b){Rh[0]=a;Rh[1]=b;return Dl(Ds)}
...
-80.000001],[180,80.000001]])}function Fs(){Ec.point=Gs}function Gs(a,b){Ec.point=Ll;Ml=Sh=a;Nl=Th=b}function Ll(a,b){Uh.add(Th*a-Sh*b);Sh=a;Th=b}function Hs(){Ll(Ml,Nl)}function fd(a,b){Vh+=a;Wh+=b;++se}function Ol(){ec.point=Is}function Is(a,b){ec.point=Js;fd(uc=a,vc=b)}function Js(a,b){var c=a-uc,f=b-vc;c=Cb(c*c+f*f);Qf+=c*(uc+a)/2;Rf+=c*(vc+b)/2;Gd+=c;fd(uc=a,vc=b)}function Pl(){ec.point=fd}function Ks(){ec.point=Ls}function Ms(){Ql(Rl,Sl)}function Ls(a,b){ec.point=Ql;fd(Rl=uc=a,Sl=vc=b)}function Ql(a,
b){var c=a-uc,f=b-vc;c=Cb(c*c+f*f);Qf+=c*(uc+a)/2;Rf+=c*(vc+b)/2;Gd+=c;c=vc*a-uc*b;Xh+=c*(uc+a);Yh+=c*(vc+b);te+=3*c;fd(uc=a,vc=b)}function Tl(a){this._context=a}function Ns(a,b){ue.point=Ul;Vl=ve=a;Wl=we=b}function Ul(a,b){ve-=a;we-=b;Zh.add(Cb(ve*ve+we*we));ve=a;we=b}function Xl(){this._string=[]}function Yl(a){return"m0,"+a+"a"+a+","+a+" 0 1,1 0,"+-2*a+"a"+a+","+a+" 0 1,1 0,"+2*a+"z"}function xe(a){return function(b){var c=new $h,f;for(f in a)c[f]=a[f];c.stream=b;return c}}function $h(){}function ai(a,
b,c){var f=a.clipExtent&&a.clipExtent();a.scale(150).translate([0,0]);null!=f&&a.clipExtent(null);lc(c,a.stream(Sf));b(Sf.result());null!=f&&a.clipExtent(f);return a}function Hd(a,b,c){return ai(a,function(f){var g=b[1][0]-b[0][0],h=b[1][1]-b[0][1],m=Math.min(g/(f[1][0]-f[0][0]),h/(f[1][1]-f[0][1]));g=+b[0][0]+(g-m*(f[1][0]+f[0][0]))/2;f=+b[0][1]+(h-m*(f[1][1]+f[0][1]))/2;a.scale(150*m).translate([g,f])},c)}function bi(a,b,c){return ai(a,function(f){var g=+b,h=g/(f[1][0]-f[0][0]);g=(g-h*(f[1][0]+
f[0][0]))/2;f=-h*f[0][1];a.scale(150*h).translate([g,f])},c)}function ci(a,b,c){return ai(a,function(f){var g=+b,h=g/(f[1][1]-f[0][1]),m=-h*f[0][0];f=(g-h*(f[1][1]+f[0][1]))/2;a.scale(150*h).translate([m,f])},c)}function Zl(a){return xe({point:function(b,c){b=a(b,c);this.stream.point(b[0],b[1])}})}function $l(a,b){function c(f,g,h,m,l,n,x,C,t,u,v,y,q,r){var w=x-f,B=C-g,D=w*w+B*B;if(D>4*b&&q--){var J=m+u,M=l+v,P=n+y,W=Cb(J*J+M*M+P*P),fa=Pb(P/=W),R=1E-6>eb(eb(P)-1)||1E-6>eb(h-t)?(h+t)/2:Qb(M,J),S=a(R,
fa);fa=S[0];S=S[1];var ma=fa-f,ia=S-g,qa=B*ma-w*ia;if(qa*qa/D>b||.3<eb((w*ma+B*ia)/D-.5)||m*u+l*v+n*y<Os)c(f,g,h,m,l,n,fa,S,R,J/=W,M/=W,P,q,r),r.point(fa,S),c(fa,S,R,J,M,P,x,C,t,u,v,y,q,r)}}return function(f){function g(fa,R){fa=a(fa,R);f.point(fa[0],fa[1])}function h(){B=NaN;W.point=m;f.lineStart()}function m(fa,R){var S=dd([fa,R]);R=a(fa,R);c(B,D,w,J,M,P,B=R[0],D=R[1],w=fa,J=S[0],M=S[1],P=S[2],16,f);f.point(B,D)}function l(){W.point=g;f.lineEnd()}function n(){h();W.point=x;W.lineEnd=C}function x(fa,
...
pa[1],r,w,q);y=Nh(t,u,v);ma=Lh(h,pa);ia=Lh(y,ma);pa=ma;S=+R?$l(pa,R):Zl(pa);return g()}function g(){qa=Ha=null;return b}var h,m=150,l=480,n=250,x=0,C=0,t=0,u=0,v=0,y,q=0,r=1,w=1,B=null,D=ei,J=null,M,P,W,fa=ye,R=.5,S,ma,ia,qa,Ha;b.stream=function(pa){return qa&&Ha===pa?qa:qa=Rs(Ps(y)(D(S(fa(Ha=pa)))))};b.preclip=function(pa){return arguments.length?(D=pa,B=void 0,g()):D};b.postclip=function(pa){return arguments.length?(fa=pa,J=M=P=W=null,g()):fa};b.clipAngle=function(pa){return arguments.length?(D=
...
u=pa[1]%360*Ta,v=2<pa.length?pa[2]%360*Ta:0,f()):[t*jb,u*jb,v*jb]};b.angle=function(pa){return arguments.length?(q=pa%360*Ta,f()):q*jb};b.reflectX=function(pa){return arguments.length?(r=pa?-1:1,f()):0>r};b.reflectY=function(pa){return arguments.length?(w=pa?-1:1,f()):0>w};b.precision=function(pa){if(arguments.length){var Ea=ma;var Pa=R=pa*pa;Ea=(S=+Pa?$l(Ea,Pa):Zl(Ea),g())}else Ea=Cb(R);return Ea};b.fitExtent=function(pa,Ea){return Hd(b,pa,Ea)};b.fitSize=function(pa,Ea){return Hd(b,[[0,0],pa],Ea)};
b.fitWidth=function(pa,Ea){return bi(b,pa,Ea)};b.fitHeight=function(pa,Ea){return ci(b,pa,Ea)};return function(){h=a.apply(this,arguments);b.invert=h.invert&&c;return f()}}function fi(a){var b=0,c=bb/3,f=di(a);a=f(b,c);a.parallels=function(g){return arguments.length?f(b=g[0]*Ta,c=g[1]*Ta):[b*jb,c*jb]};return a}function Ss(a){function b(f,g){return[f*c,Ma(g)/c]}var c=Qa(a);b.invert=function(f,g){return[f/c,Pb(g*c)]};return b}function bm(a,b){function c(l,n){n=Cb(h-2*g*Ma(n))/g;return[n*Ma(l*=g),m-
n*Qa(l)]}var f=Ma(a),g=(f+Ma(b))/2;if(1E-6>eb(g))return Ss(a);var h=1+f*(2*g-f),m=Cb(h)/g;c.invert=function(l,n){n=m-n;var x=Qb(l,eb(n))*dc(n);0>n*g&&(x-=bb*dc(l)*dc(n));return[x/g,Pb((h-(l*l+n*n)*g*g)/(2*g))]};return c}function Tf(){return fi(bm).scale(155.424).center([0,33.6442])}function cm(){return Tf().parallels([29.5,45.5]).scale(1070).translate([480,250]).rotate([96,0]).center([-.6,38.7])}function Ts(a){var b=a.length;return{point:function(c,f){for(var g=-1;++g<b;)a[g].point(c,f)},sphere:function(){for(var c=
-1;++c<b;)a[c].sphere()},lineStart:function(){for(var c=-1;++c<b;)a[c].lineStart()},lineEnd:function(){for(var c=-1;++c<b;)a[c].lineEnd()},polygonStart:function(){for(var c=-1;++c<b;)a[c].polygonStart()},polygonEnd:function(){for(var c=-1;++c<b;)a[c].polygonEnd()}}}function dm(a){return function(b,c){var f=Qa(b),g=Qa(c);f=a(f*g);return Infinity===f?[2,0]:[f*g*Ma(b),f*Ma(c)]}}function ze(a){return function(b,c){var f=Cb(b*b+c*c),g=a(f),h=Ma(g);g=Qa(g);return[Qb(b*h,f*g),Pb(f&&c*h/f)]}}function Ae(a,
b){return[a,Uf(Id((nb+b)/2))]}function em(a){function b(){var t=bb*g(),u=c(ul(c.rotate()).invert([0,0]));return m(null==l?[[u[0]-t,u[1]-t],[u[0]+t,u[1]+t]]:a===Ae?[[Math.max(u[0]-t,l),n],[Math.min(u[0]+t,x),C]]:[[l,Math.max(u[1]-t,n)],[x,Math.min(u[1]+t,C)]])}var c=wc(a),f=c.center,g=c.scale,h=c.translate,m=c.clipExtent,l=null,n,x,C;c.scale=function(t){return arguments.length?(g(t),b()):g()};c.translate=function(t){return arguments.length?(h(t),b()):h()};c.center=function(t){return arguments.length?
(f(t),b()):f()};c.clipExtent=function(t){return arguments.length?(null==t?l=n=x=C=null:(l=+t[0][0],n=+t[0][1],x=+t[1][0],C=+t[1][1]),b()):null==l?null:[[l,n],[x,C]]};return b()}function fm(a,b){function c(m,l){0<h?l<-nb+1E-6&&(l=-nb+1E-6):l>nb-1E-6&&(l=nb-1E-6);l=h/gi(Id((nb+l)/2),g);return[l*Ma(g*m),h-l*Qa(g*m)]}var f=Qa(a),g=a===b?Ma(a):Uf(f/Qa(b))/Uf(Id((nb+b)/2)/Id((nb+a)/2)),h=f*gi(Id((nb+a)/2),g)/g;if(!g)return Ae;c.invert=function(m,l){l=h-l;var n=dc(g)*Cb(m*m+l*l),x=Qb(m,eb(l))*dc(l);0>l*
g&&(x-=bb*dc(m)*dc(l));return[x/g,2*Jd(gi(h/n,1/g))-nb]};return c}function Be(a,b){return[a,b]}function gm(a,b){function c(m,l){l=h-l;m*=g;return[l*Ma(m),h-l*Qa(m)]}var f=Qa(a),g=a===b?Ma(a):(f-Qa(b))/(b-a),h=f/g+a;if(1E-6>eb(g))return Be;c.invert=function(m,l){l=h-l;var n=Qb(m,eb(l))*dc(l);0>l*g&&(n-=bb*dc(m)*dc(l));return[n/g,h-dc(g)*Cb(m*m+l*l)]};return c}function hi(a,b){b=Pb(Vf*Ma(b));var c=b*b,f=c*c*c;return[a*Qa(b)/(Vf*(1.340264+3*-.081106*c+f*(7*8.93E-4+.034164*c))),b*(1.340264+-.081106*c+
...
f.length);n!==yb&&(n=kt(c[0],c[u-1]));x=2<u?mt:lt;C=t=null;return b}function b(u){return null==u||isNaN(u=+u)?l:(C||(C=x(c.map(h),f,g)))(h(n(u)))}var c=wm,f=wm,g=Mc,h,m,l,n=yb,x,C,t;b.invert=function(u){return n(m((t||(t=x(f,c.map(h),cc)))(u)))};b.domain=function(u){return arguments.length?(c=Array.from(u,ag),a()):c.slice()};b.range=function(u){return arguments.length?(f=Array.from(u),a()):f.slice()};b.rangeRound=function(u){return f=Array.from(u),g=df,a()};b.clamp=function(u){return arguments.length?
(n=u?!0:yb,a()):n!==yb};b.interpolate=function(u){return arguments.length?(g=u,a()):g};b.unknown=function(u){return arguments.length?(l=u,b):l};return function(u,v){h=u;m=v;return a()}}function xm(a,b,c,f){c=nc(a,b,c);var g;f=ne(null==f?",f":f);switch(f.type){case "s":return a=Math.max(Math.abs(a),Math.abs(b)),null!=f.precision||isNaN(g=Wk(c,a))||(f.precision=g),e.formatPrefix(f,a);case "":case "e":case "g":case "p":case "r":null!=f.precision||isNaN(g=Xk(c,Math.max(Math.abs(a),Math.abs(b))))||(f.precision=
g-("e"===f.type));break;case "f":case "%":null!=f.precision||isNaN(g=Vk(c))||(f.precision=g-2*("%"===f.type))}return e.format(f)}function Rc(a){var b=a.domain;a.ticks=function(c){var f=b();return Wb(f[0],f[f.length-1],null==c?10:c)};a.tickFormat=function(c,f){var g=b();return xm(g[0],g[g.length-1],null==c?10:c,f)};a.nice=function(c){null==c&&(c=10);var f=b(),g=0,h=f.length-1,m=f[g],l=f[h],n=10;if(l<m){var x=m;m=l;l=x;x=g;g=h;h=x}for(;0<n--;){x=Ab(m,l,c);if(x===C)return f[g]=m,f[h]=l,b(f);if(0<x)m=
Math.floor(m/x)*x,l=Math.ceil(l/x)*x;else if(0>x)m=Math.ceil(m*x)/x,l=Math.floor(l*x)/x;else break;var C=x}return a};return a}function ym(){var a=Md()(yb,yb);a.copy=function(){return Ee(a,ym())};fc.apply(a,arguments);return Rc(a)}function zm(a){function b(f){return null==f||isNaN(f=+f)?c:f}var c;b.invert=b;b.domain=b.range=function(f){return arguments.length?(a=Array.from(f,ag),b):a.slice()};b.unknown=function(f){return arguments.length?(c=f,b):c};b.copy=function(){return zm(a).unknown(c)};a=arguments.length?
...
1)&&u-t<v){t=Math.floor(t);u=Math.ceil(u);if(0<x)for(;t<=u;++t){var q=1;for(l=m(t);q<g;++q){var r=l*q;if(!(r<x)){if(r>n)break;y.push(r)}}}else for(;t<=u;++t)for(q=g-1,l=m(t);1<=q;--q)if(r=l*q,!(r<x)){if(r>n)break;y.push(r)}2*y.length<v&&(y=Wb(x,n,v))}else y=Wb(t,u,Math.min(u-t,v)).map(m);return C?y.reverse():y};c.tickFormat=function(l,n){null==n&&(n=10===g?".0e":",");"function"!==typeof n&&(n=e.format(n));if(Infinity===l)return n;null==l&&(l=10);var x=Math.max(1,g*l/c.ticks().length);return function(C){var t=
C/m(Math.round(h(C)));t*g<g-.5&&(t*=g);return t<=x?n(C):""}};c.nice=function(){return f(Am(f(),{floor:function(l){return m(Math.floor(h(l)))},ceil:function(l){return m(Math.ceil(h(l)))}}))};return c}function Em(){var a=wi(Md()).domain([1,10]);a.copy=function(){return Ee(a,Em()).base(a.base())};fc.apply(a,arguments);return a}function Fm(a){return function(b){return Math.sign(b)*Math.log1p(Math.abs(b/a))}}function Gm(a){return function(b){return Math.sign(b)*Math.expm1(Math.abs(b))*a}}function xi(a){var b=
1,c=a(Fm(b),Gm(b));c.constant=function(f){return arguments.length?a(Fm(b=+f),Gm(b)):b};return Rc(c)}function Hm(){var a=xi(Md());a.copy=function(){return Ee(a,Hm()).constant(a.constant())};return fc.apply(a,arguments)}function Im(a){return function(b){return 0>b?-Math.pow(-b,a):Math.pow(b,a)}}function st(a){return 0>a?-Math.sqrt(-a):Math.sqrt(a)}function tt(a){return 0>a?-a*a:a*a}function yi(a){var b=a(yb,yb),c=1;b.exponent=function(f){return arguments.length?(c=+f,1===c?a(yb,yb):.5===c?a(st,tt):
a(Im(c),Im(1/c))):c};return Rc(b)}function zi(){var a=yi(Md());a.copy=function(){return Ee(a,zi()).exponent(a.exponent())};fc.apply(a,arguments);return a}function Jm(a){return Math.sign(a)*a*a}function Km(){function a(h){h=b(h);h=Math.sign(h)*Math.sqrt(Math.abs(h));return isNaN(h)?g:f?Math.round(h):h}var b=Md()(yb,yb),c=[0,1],f=!1,g;a.invert=function(h){return b.invert(Jm(h))};a.domain=function(h){return arguments.length?(b.domain(h),a):b.domain()};a.range=function(h){return arguments.length?(b.range((c=
Array.from(h,ag)).map(Jm)),a):c.slice()};a.rangeRound=function(h){return a.range(h).round(!0)};a.round=function(h){return arguments.length?(f=!!h,a):f};a.clamp=function(h){return arguments.length?(b.clamp(h),a):b.clamp()};a.unknown=function(h){return arguments.length?(g=h,a):g};a.copy=function(){return Km(b.domain(),c).round(f).clamp(b.clamp()).unknown(g)};fc.apply(a,arguments);return Rc(a)}function Lm(){function a(){var m=0,l=Math.max(1,f.length);for(g=Array(l-1);++m<l;)g[m-1]=jj(c,m/l);return b}
...
Ci})}function id(a){return zb(function(b){b.setUTCDate(b.getUTCDate()-(b.getUTCDay()+7-a)%7);b.setUTCHours(0,0,0,0)},function(b,c){b.setUTCDate(b.getUTCDate()+7*c)},function(b,c){return(c-b)/Ci})}function Om(a,b,c,f,g,h){function m(n,x,C){var t=Math.abs(x-n)/C,u=z(function(v){v=$jscomp.makeIterator(v);v.next();v.next();return v.next().value}).right(l,t);if(u===l.length)return a.every(nc(n/Di,x/Di,C));if(0===u)return Nd.every(Math.max(nc(n,x,C),1));x=$jscomp.makeIterator(l[t/l[u-1][2]<l[u][2]/t?u-
...
new Date(-1,a.m,a.d,a.H,a.M,a.S,a.L);b.setFullYear(a.y);return b}return new Date(a.y,a.m,a.d,a.H,a.M,a.S,a.L)}function Fi(a){if(0<=a.y&&100>a.y){var b=new Date(Date.UTC(-1,a.m,a.d,a.H,a.M,a.S,a.L));b.setUTCFullYear(a.y);return b}return new Date(Date.UTC(a.y,a.m,a.d,a.H,a.M,a.S,a.L))}function Fe(a,b,c){return{y:a,m:b,d:c,H:0,M:0,S:0,L:0}}function Qm(a){function b(R,S){return function(ma){var ia=[],qa=-1,Ha=0,pa=R.length,Ea,Pa;for(ma instanceof Date||(ma=new Date(+ma));++qa<pa;)if(37===R.charCodeAt(qa)){ia.push(R.slice(Ha,
qa));null!=(Ha=Rm[Ea=R.charAt(++qa)])?Ea=R.charAt(++qa):Ha="e"===Ea?" ":"0";if(Pa=S[Ea])Ea=Pa(ma,Ha);ia.push(Ea);Ha=qa+1}ia.push(R.slice(Ha,qa));return ia.join("")}}function c(R,S){return function(ma){var ia=Fe(1900,void 0,1);if(f(ia,R,ma+="",0)!=ma.length)return null;if("Q"in ia)return new Date(ia.Q);if("s"in ia)return new Date(1E3*ia.s+("L"in ia?ia.L:0));!S||"Z"in ia||(ia.Z=0);"p"in ia&&(ia.H=ia.H%12+12*ia.p);void 0===ia.m&&(ia.m="q"in ia?ia.q:0);if("V"in ia){if(1>ia.V||53<ia.V)return null;"w"in
ia||(ia.w=1);if("Z"in ia){ma=Fi(Fe(ia.y,0,1));var qa=ma.getUTCDay();ma=4<qa||0===qa?Ge.ceil(ma):Ge(ma);ma=Od.offset(ma,7*(ia.V-1));ia.y=ma.getUTCFullYear();ia.m=ma.getUTCMonth();ia.d=ma.getUTCDate()+(ia.w+6)%7}else ma=Ei(Fe(ia.y,0,1)),qa=ma.getDay(),ma=4<qa||0===qa?He.ceil(ma):He(ma),ma=Pd.offset(ma,7*(ia.V-1)),ia.y=ma.getFullYear(),ia.m=ma.getMonth(),ia.d=ma.getDate()+(ia.w+6)%7}else if("W"in ia||"U"in ia)"w"in ia||(ia.w="u"in ia?ia.u%7:"W"in ia?1:0),qa="Z"in ia?Fi(Fe(ia.y,0,1)).getUTCDay():Ei(Fe(ia.y,
0,1)).getDay(),ia.m=0,ia.d="W"in ia?(ia.w+6)%7+7*ia.W-(qa+5)%7:ia.w+7*ia.U-(qa+6)%7;return"Z"in ia?(ia.H+=ia.Z/100|0,ia.M+=ia.Z%100,Fi(ia)):Ei(ia)}}function f(R,S,ma,ia){for(var qa=0,Ha=S.length,pa=ma.length,Ea;qa<Ha;){if(ia>=pa)return-1;Ea=S.charCodeAt(qa++);if(37===Ea){if(Ea=S.charAt(qa++),Ea=fa[Ea in Rm?S.charAt(qa++):Ea],!Ea||0>(ia=Ea(R,ma,ia)))return-1}else if(Ea!=ma.charCodeAt(ia++))return-1}return ia}var g=a.dateTime,h=a.date,m=a.time,l=a.periods,n=a.days,x=a.shortDays,C=a.months,t=a.shortMonths,
...
b:function(R){return t[R.getUTCMonth()]},B:function(R){return C[R.getUTCMonth()]},c:null,d:Xm,e:Xm,f:Lt,g:Mt,G:Nt,H:Ot,I:Pt,j:Qt,L:Ym,m:Rt,M:St,p:function(R){return l[+(12<=R.getUTCHours())]},q:function(R){return 1+~~(R.getUTCMonth()/3)},Q:Um,s:Vm,S:Tt,u:Ut,U:Vt,V:Wt,w:Xt,W:Yt,x:null,X:null,y:Zt,Y:$t,Z:au,"%":Wm},fa={a:function(R,S,ma){return(S=r.exec(S.slice(ma)))?(R.w=w.get(S[0].toLowerCase()),ma+S[0].length):-1},A:function(R,S,ma){return(S=y.exec(S.slice(ma)))?(R.w=q.get(S[0].toLowerCase()),ma+
S[0].length):-1},b:function(R,S,ma){return(S=J.exec(S.slice(ma)))?(R.m=M.get(S[0].toLowerCase()),ma+S[0].length):-1},B:function(R,S,ma){return(S=B.exec(S.slice(ma)))?(R.m=D.get(S[0].toLowerCase()),ma+S[0].length):-1},c:function(R,S,ma){return f(R,g,S,ma)},d:Zm,e:Zm,f:bu,g:$m,G:an,H:bn,I:bn,j:cu,L:du,m:eu,M:fu,p:function(R,S,ma){return(S=u.exec(S.slice(ma)))?(R.p=v.get(S[0].toLowerCase()),ma+S[0].length):-1},q:gu,Q:hu,s:iu,S:ju,u:ku,U:lu,V:mu,w:nu,W:ou,x:function(R,S,ma){return f(R,h,S,ma)},X:function(R,
S,ma){return f(R,m,S,ma)},y:$m,Y:an,Z:pu,"%":qu};P.x=b(h,P);P.X=b(m,P);P.c=b(g,P);W.x=b(h,W);W.X=b(m,W);W.c=b(g,W);return{format:function(R){var S=b(R+="",P);S.toString=function(){return R};return S},parse:function(R){var S=c(R+="",!1);S.toString=function(){return R};return S},utcFormat:function(R){var S=b(R+="",W);S.toString=function(){return R};return S},utcParse:function(R){var S=c(R+="",!0);S.toString=function(){return R};return S}}}function fb(a,b,c){var f=0>a?"-":"";a=(f?-a:a)+"";var g=a.length;
return f+(g<c?Array(c-g+1).join(b)+a:a)}function ru(a){return a.replace(su,"\\$&")}function Ie(a){return new RegExp("^(?:"+a.map(ru).join("|")+")","i")}function Je(a){return new Map(a.map(function(b,c){return[b.toLowerCase(),c]}))}function nu(a,b,c){return(b=Db.exec(b.slice(c,c+1)))?(a.w=+b[0],c+b[0].length):-1}function ku(a,b,c){return(b=Db.exec(b.slice(c,c+1)))?(a.u=+b[0],c+b[0].length):-1}function lu(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?(a.U=+b[0],c+b[0].length):-1}function mu(a,b,c){return(b=
Db.exec(b.slice(c,c+2)))?(a.V=+b[0],c+b[0].length):-1}function ou(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?(a.W=+b[0],c+b[0].length):-1}function an(a,b,c){return(b=Db.exec(b.slice(c,c+4)))?(a.y=+b[0],c+b[0].length):-1}function $m(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?(a.y=+b[0]+(68<+b[0]?1900:2E3),c+b[0].length):-1}function pu(a,b,c){return(b=/^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(b.slice(c,c+6)))?(a.Z=b[1]?0:-(b[2]+(b[3]||"00")),c+b[0].length):-1}function gu(a,b,c){return(b=Db.exec(b.slice(c,c+1)))?
(a.q=3*b[0]-3,c+b[0].length):-1}function eu(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?(a.m=b[0]-1,c+b[0].length):-1}function Zm(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?(a.d=+b[0],c+b[0].length):-1}function cu(a,b,c){return(b=Db.exec(b.slice(c,c+3)))?(a.m=0,a.d=+b[0],c+b[0].length):-1}function bn(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?(a.H=+b[0],c+b[0].length):-1}function fu(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?(a.M=+b[0],c+b[0].length):-1}function ju(a,b,c){return(b=Db.exec(b.slice(c,c+2)))?
(a.S=+b[0],c+b[0].length):-1}function du(a,b,c){return(b=Db.exec(b.slice(c,c+3)))?(a.L=+b[0],c+b[0].length):-1}function bu(a,b,c){return(b=Db.exec(b.slice(c,c+6)))?(a.L=Math.floor(b[0]/1E3),c+b[0].length):-1}function qu(a,b,c){return(a=tu.exec(b.slice(c,c+1)))?c+a[0].length:-1}function hu(a,b,c){return(b=Db.exec(b.slice(c)))?(a.Q=+b[0],c+b[0].length):-1}function iu(a,b,c){return(b=Db.exec(b.slice(c)))?(a.s=+b[0],c+b[0].length):-1}function Sm(a,b){return fb(a.getDate(),b,2)}function xt(a,b){return fb(a.getHours(),
...
ya(this,a))};Wc.prototype.has=function(a){return Map.prototype.has.call(this,ya(this,a))};Wc.prototype.set=function(a,b){return Map.prototype.set.call(this,ua(this,a),b)};Wc.prototype.delete=function(a){return Map.prototype.delete.call(this,Ba(this,a))};var Ne=function(a,b){b=void 0===b?Na:b;var c=$jscomp.construct(Set,[],this.constructor);Object.defineProperties(c,{_intern:{value:new Map},_key:{value:b}});if(null!=a)for(a=$jscomp.makeIterator(a),b=a.next();!b.done;b=a.next())c.add(b.value);return c};
$jscomp.inherits(Ne,Set);Ne.prototype.has=function(a){return Set.prototype.has.call(this,ya(this,a))};Ne.prototype.add=function(a){return Set.prototype.add.call(this,ua(this,a))};Ne.prototype.delete=function(a){return Set.prototype.delete.call(this,Ba(this,a))};var lp=Array.prototype.slice,Fg=Math.sqrt(50),Gg=Math.sqrt(10),Hg=Math.sqrt(2),Xu=oj(Math.random),Lg=Array.prototype.slice,wp={value:function(){}};Se.prototype=Xc.prototype={constructor:Se,on:function(a,b){var c=this._,f=vp(a+"",c),g,h=-1,
...
this._names.indexOf(a);0<=a&&(this._names.splice(a,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(a){return 0<=this._names.indexOf(a)}};var Sg=[null],cb={};Hb.prototype=Zc.prototype=(cb.constructor=Hb,cb.select=function(a){"function"!==typeof a&&(a=Ue(a));for(var b=this._groups,c=b.length,f=Array(c),g=0;g<c;++g)for(var h=b[g],m=h.length,l=f[g]=Array(m),n,x,C=0;C<m;++C)(n=h[C])&&(x=a.call(n,n.__data__,C,h))&&("__data__"in n&&(x.__data__=n.__data__),l[C]=x);return new Hb(f,
this._parents)},cb.selectAll=function(a){a="function"===typeof a?Bp(a):Og(a);for(var b=this._groups,c=b.length,f=[],g=[],h=0;h<c;++h)for(var m=b[h],l=m.length,n,x=0;x<l;++x)if(n=m[x])f.push(a.call(n,n.__data__,x,m)),g.push(n);return new Hb(f,g)},cb.selectChild=function(a){return this.select(null==a?Ep:Cp("function"===typeof a?a:sj(a)))},cb.selectChildren=function(a){return this.selectAll(null==a?Fp:Gp("function"===typeof a?a:sj(a)))},cb.filter=function(a){"function"!==typeof a&&(a=Pg(a));for(var b=
this._groups,c=b.length,f=Array(c),g=0;g<c;++g)for(var h=b[g],m=h.length,l=f[g]=[],n,x=0;x<m;++x)(n=h[x])&&a.call(n,n.__data__,x,h)&&l.push(n);return new Hb(f,this._parents)},cb.data=function(a,b){if(!arguments.length)return Array.from(this,Lp);var c=b?Kp:Jp,f=this._parents,g=this._groups;"function"!==typeof a&&(a=Ip(a));for(var h=g.length,m=Array(h),l=Array(h),n=Array(h),x=0;x<h;++x){var C=f[x],t=g[x],u=t.length,v=Ng(a.call(C,C&&C.__data__,x,f)),y=v.length,q=l[x]=Array(y),r=m[x]=Array(y);u=n[x]=
Array(u);c(C,t,q,r,u,v,b);for(t=C=0;C<y;++C)if(v=q[C]){for(C>=t&&(t=C+1);!(u=r[t])&&++t<y;);v._next=u||null}}m=new Hb(m,f);m._enter=l;m._exit=n;return m},cb.enter=function(){return new Hb(this._enter||this._groups.map(tj),this._parents)},cb.exit=function(){return new Hb(this._exit||this._groups.map(tj),this._parents)},cb.join=function(a,b,c){var f=this.enter(),g=this,h=this.exit();f="function"===typeof a?a(f):f.append(a+"");null!=b&&(g=b(g));null==c?h.remove():c(h);return f&&g?f.merge(g).order():
g},cb.merge=function(a){if(!(a instanceof Hb))throw Error("invalid merge");var b=this._groups;a=a._groups;for(var c=b.length,f=Math.min(c,a.length),g=Array(c),h=0;h<f;++h)for(var m=b[h],l=a[h],n=m.length,x=g[h]=Array(n),C,t=0;t<n;++t)if(C=m[t]||l[t])x[t]=C;for(;h<c;++h)g[h]=b[h];return new Hb(g,this._parents)},cb.selection=function(){return this},cb.order=function(){for(var a=this._groups,b=-1,c=a.length;++b<c;)for(var f=a[b],g=f.length-1,h=f[g],m;0<=--g;)if(m=f[g])h&&m.compareDocumentPosition(h)^
4&&h.parentNode.insertBefore(m,h),h=m;return this},cb.sort=function(a){function b(t,u){return t&&u?a(t.__data__,u.__data__):!t-!u}a||(a=Mp);for(var c=this._groups,f=c.length,g=Array(f),h=0;h<f;++h){for(var m=c[h],l=m.length,n=g[h]=Array(l),x,C=0;C<l;++C)if(x=m[C])n[C]=x;n.sort(b)}return(new Hb(g,this._parents)).order()},cb.call=function(){var a=arguments[0];arguments[0]=this;a.apply(null,arguments);return this},cb.nodes=function(){return Array.from(this)},cb.node=function(){for(var a=this._groups,
b=0,c=a.length;b<c;++b)for(var f=a[b],g=0,h=f.length;g<h;++g){var m=f[g];if(m)return m}return null},cb.size=function(){for(var a=0,b=$jscomp.makeIterator(this),c=b.next();!c.done;c=b.next())++a;return a},cb.empty=function(){return!this.node()},cb.each=function(a){for(var b=this._groups,c=0,f=b.length;c<f;++c)for(var g=b[c],h=0,m=g.length,l;h<m;++h)(l=g[h])&&a.call(l,l.__data__,h,g);return this},cb.attr=function(a,b){var c=be(a);if(2>arguments.length){var f=this.node();return c.local?f.getAttributeNS(c.space,
c.local):f.getAttribute(c)}return this.each((null==b?c.local?Op:Np:"function"===typeof b?c.local?Sp:Rp:c.local?Qp:Pp)(c,b))},cb.style=function(a,b,c){return 1<arguments.length?this.each((null==b?Tp:"function"===typeof b?Vp:Up)(a,b,null==c?"":c)):Yc(this.node(),a)},cb.property=function(a,b){return 1<arguments.length?this.each((null==b?Wp:"function"===typeof b?Yp:Xp)(a,b)):this.node()[a]},cb.classed=function(a,b){var c=(a+"").trim().split(/^|\s+/);if(2>arguments.length){for(var f=Rg(this.node()),g=
-1,h=c.length;++g<h;)if(!f.contains(c[g]))return!1;return!0}return this.each(("function"===typeof b?aq:b?Zp:$p)(c,b))},cb.text=function(a){return arguments.length?this.each(null==a?bq:("function"===typeof a?dq:cq)(a)):this.node().textContent},cb.html=function(a){return arguments.length?this.each(null==a?eq:("function"===typeof a?gq:fq)(a)):this.node().innerHTML},cb.raise=function(){return this.each(hq)},cb.lower=function(){return this.each(iq)},cb.append=function(a){var b="function"===typeof a?a:
Te(a);return this.select(function(){return this.appendChild(b.apply(this,arguments))})},cb.insert=function(a,b){var c="function"===typeof a?a:Te(a),f=null==b?jq:"function"===typeof b?b:Ue(b);return this.select(function(){return this.insertBefore(c.apply(this,arguments),f.apply(this,arguments)||null)})},cb.remove=function(){return this.each(kq)},cb.clone=function(a){return this.select(a?mq:lq)},cb.datum=function(a){return arguments.length?this.property("__data__",a):this.node().__data__},cb.on=function(a,
b,c){var f=oq(a+""),g=f.length,h;if(2>arguments.length){var m=this.node().__on;if(m)for(var l=0,n=m.length,x;l<n;++l){var C=0;for(x=m[l];C<g;++C)if((h=f[C]).type===x.type&&h.name===x.name)return x.value}}else{m=b?qq:pq;for(C=0;C<g;++C)this.each(m(f[C],b,c));return this}},cb.dispatch=function(a,b){return this.each(("function"===typeof b?sq:rq)(a,b))},cb[Symbol.iterator]=yj,cb);var tq=0;Tg.prototype=zj.prototype={constructor:Tg,get:function(a){for(var b=this._;!(b in a);)if(!(a=a.parentNode))return;
...
return this.tween(f,sr(c))},hb.remove=function(){return this.on("end.remove",ir(this._id))},hb.tween=function(c,f){var g=this._id;c+="";if(2>arguments.length){g=kc(this.node(),g).tween;for(var h=0,m=g.length,l;h<m;++h)if((l=g[h]).name===c)return l.value;return null}return this.each((null==f?Pq:Qq)(g,c,f))},hb.delay=function(c){var f=this._id;return arguments.length?this.each(("function"===typeof c?ar:br)(f,c)):kc(this.node(),f).delay},hb.duration=function(c){var f=this._id;return arguments.length?
this.each(("function"===typeof c?cr:dr)(f,c)):kc(this.node(),f).duration},hb.ease=function(c){var f=this._id;return arguments.length?this.each(er(f,c)):kc(this.node(),f).ease},hb.easeVarying=function(c){if("function"!==typeof c)throw Error();return this.each(fr(this._id,c))},hb.end=function(){var c,f,g=this,h=g._id,m=g.size();return new Promise(function(l,n){var x={value:n},C={value:function(){0===--m&&l()}};g.each(function(){var t=rc(this,h),u=t.on;u!==c&&(f=(c=u).copy(),f._.cancel.push(x),f._.interrupt.push(x),
...
1,D=Infinity,J=Infinity,M=-Infinity,P=-Infinity,W=0;W<B;W++){var fa=v[2*W];t=v[2*W+1];fa<D&&(D=fa);t<J&&(J=t);fa>M&&(M=fa);t>P&&(P=t);this._ids[W]=W}M=(D+M)/2;J=(J+P)/2;D=Infinity;for(P=0;P<B;P++)if(W=vh(M,J,v[2*P],v[2*P+1]),W<D){var R=P;D=W}J=v[2*R];P=v[2*R+1];D=Infinity;for(M=0;M<B;M++)if(M!==R&&(W=vh(J,P,v[2*M],v[2*M+1]),W<D&&0<W)){var S=M;D=W}D=v[2*S];M=v[2*S+1];t=Infinity;for(W=0;W<B;W++)if(W!==R&&W!==S){fa=D-J;var ma=M-P;u=v[2*W]-J;var ia=v[2*W+1]-P,qa=fa*fa+ma*ma,Ha=u*u+ia*ia,pa=.5/(fa*ia-
ma*u);ma=(ia*qa-ma*Ha)*pa;fa=(fa*Ha-u*qa)*pa;fa=ma*ma+fa*fa;if(fa<t){var Ea=W;t=fa}}W=v[2*Ea];fa=v[2*Ea+1];if(Infinity===t){for(q=0;q<B;q++)this._dists[q]=v[2*q]-v[0]||v[2*q+1]-v[1];Ad(this._ids,this._dists,0,B-1);q=new Uint32Array(B);y=v=0;for(r=-Infinity;y<B;y++)w=this._ids[y],this._dists[w]>r&&(q[v++]=w,r=this._dists[w]);this.hull=q.subarray(0,v);this.triangles=new Uint32Array(0);this.halfedges=new Uint32Array(0)}else{of(J,P,D,M,W,fa)&&(t=S,u=D,qa=M,S=Ea,D=W,M=fa,Ea=t,W=u,fa=qa);u=D-J;t=M-P;qa=
W-J;ia=fa-P;Ha=u*u+t*t;pa=qa*qa+ia*ia;ma=.5/(u*ia-t*qa);t=J+(ia*Ha-t*pa)*ma;u=P+(u*pa-qa*Ha)*ma;this._cx=t;this._cy=u;for(qa=0;qa<B;qa++)this._dists[qa]=vh(v[2*qa],v[2*qa+1],t,u);Ad(this._ids,this._dists,0,B-1);this._hullStart=R;B=3;q[R]=y[Ea]=S;q[S]=y[R]=Ea;q[Ea]=y[S]=R;r[R]=0;r[S]=1;r[Ea]=2;w.fill(-1);w[this._hashKey(J,P)]=R;w[this._hashKey(D,M)]=S;w[this._hashKey(W,fa)]=Ea;this.trianglesLen=0;this._addTriangle(R,S,Ea,-1,-1,-1);J=0;for(D=P=void 0;J<this._ids.length;J++)if(M=this._ids[J],W=v[2*M],
fa=v[2*M+1],!(0<J&&Math.abs(W-P)<=Xn&&Math.abs(fa-D)<=Xn)&&(P=W,D=fa,M!==R&&M!==S&&M!==Ea)){u=t=0;for(qa=this._hashKey(W,fa);u<this._hashSize&&(t=w[(qa+u)%this._hashSize],-1===t||t===q[t]);u++);u=t=y[t];for(qa=void 0;qa=q[u],!of(W,fa,v[2*u],v[2*u+1],v[2*qa],v[2*qa+1]);)if(u=qa,u===t){u=-1;break}if(-1!==u){Ha=this._addTriangle(u,M,q[u],-1,-1,r[u]);r[M]=this._legalize(Ha+2);r[u]=Ha;B++;for(pa=q[u];qa=q[pa],of(W,fa,v[2*pa],v[2*pa+1],v[2*qa],v[2*qa+1]);)Ha=this._addTriangle(pa,M,qa,r[M],-1,r[pa]),r[M]=
this._legalize(Ha+2),q[pa]=pa,B--,pa=qa;if(u===t)for(;qa=y[u],of(W,fa,v[2*qa],v[2*qa+1],v[2*u],v[2*u+1]);)Ha=this._addTriangle(qa,M,u,-1,r[u],r[qa]),this._legalize(Ha+2),r[qa]=Ha,q[u]=u,B--,u=qa;this._hullStart=y[M]=u;q[u]=y[pa]=M;q[M]=pa;w[this._hashKey(W,fa)]=M;w[this._hashKey(v[2*u],v[2*u+1])]=u}}this.hull=new Uint32Array(B);v=0;for(y=this._hullStart;v<B;v++)this.hull[v]=y,y=q[y];this.triangles=this._triangles.subarray(0,this.trianglesLen);this.halfedges=this._halfedges.subarray(0,this.trianglesLen)}};
Ic.prototype._hashKey=function(t,u){var v=Math;t-=this._cx;u-=this._cy;t/=Math.abs(t)+Math.abs(u);return v.floor.call(v,(0<u?3-t:1+t)/4*this._hashSize)%this._hashSize};Ic.prototype._legalize=function(t){for(var u=this._triangles,v=this._halfedges,y=this.coords,q=0,r;;){var w=v[t],B=t-t%3;r=B+(t+2)%3;if(-1===w){if(0===q)break;t=rg[--q]}else{var D=w-w%3,J=D+(w+2)%3,M=u[r],P=u[t],W=u[B+(t+1)%3];B=u[J];var fa=y[2*B],R=y[2*B+1],S=y[2*M]-fa,ma=y[2*M+1]-R,ia=y[2*P]-fa;P=y[2*P+1]-R;fa=y[2*W]-fa;W=y[2*W+1]-
R;R=ia*ia+P*P;var qa=fa*fa+W*W;if(0>S*(P*qa-R*W)-ma*(ia*qa-R*fa)+(S*S+ma*ma)*(ia*W-P*fa)){u[t]=B;u[w]=M;M=v[J];if(-1===M){B=this._hullStart;do{if(this._hullTri[B]===J){this._hullTri[B]=t;break}B=this._hullPrev[B]}while(B!==this._hullStart)}this._link(t,M);this._link(w,v[r]);this._link(r,J);r=D+(w+1)%3;q<rg.length&&(rg[q++]=r)}else{if(0===q)break;t=rg[--q]}}}return r};Ic.prototype._link=function(t,u){this._halfedges[t]=u;-1!==u&&(this._halfedges[u]=t)};Ic.prototype._addTriangle=function(t,u,v,y,q,
r){var w=this.trianglesLen;this._triangles[w]=t;this._triangles[w+1]=u;this._triangles[w+2]=v;this._link(w,y);this._link(w+1,q);this._link(w+2,r);this.trianglesLen+=3;return w};var bc=function(){this._x0=this._y0=this._x1=this._y1=null;this._=""};bc.prototype.moveTo=function(t,u){this._+="M"+(this._x0=this._x1=+t)+","+(this._y0=this._y1=+u)};bc.prototype.closePath=function(){null!==this._x1&&(this._x1=this._x0,this._y1=this._y0,this._+="Z")};bc.prototype.lineTo=function(t,u){this._+="L"+(this._x1=
+t)+","+(this._y1=+u)};bc.prototype.arc=function(t,u,v){t=+t;u=+u;v=+v;var y=t+v,q=u;if(0>v)throw Error("negative radius");if(null===this._x1)this._+="M"+y+","+q;else if(1E-6<Math.abs(this._x1-y)||1E-6<Math.abs(this._y1-q))this._+="L"+y+","+q;v&&(this._+="A"+v+","+v+",0,1,1,"+(t-v)+","+u+"A"+v+","+v+",0,1,1,"+(this._x1=y)+","+(this._y1=q))};bc.prototype.rect=function(t,u,v,y){this._+="M"+(this._x0=this._x1=+t)+","+(this._y0=this._y1=+u)+"h"+ +v+"v"+ +y+"h"+-v+"Z"};bc.prototype.value=function(){return this._||
...
J=u[J+1];var W=u[P],fa=u[P+1];P=u[M]-D;var R=u[M+1]-J;M=W-D;var S=fa-J,ma=P*P+R*R,ia=M*M+S*S,qa=2*(P*S-R*M);qa?1E-8>Math.abs(qa)?(D=(D+W)/2,J=(J+fa)/2):(W=1/qa,D+=(S*ma-R*ia)*W,J+=(P*ia-M*ma)*W):(D=(D+W)/2-1E8*S,J=(J+fa)/2+1E8*M);q[w]=D;q[w+1]=J}y=v[v.length-1];r=4*y;B=u[2*y];J=u[2*y+1];t.fill(0);for(P=0;P<v.length;++P)y=v[P],q=r,w=B,D=J,r=4*y,B=u[2*y],J=u[2*y+1],t[q+2]=t[r]=D-J,t[q+3]=t[r+1]=B-w};vb.prototype.render=function(t){var u=null==t?t=new bc:void 0,v=this.delaunay,y=v.halfedges,q=v.inedges;
v=v.hull;var r=this.circumcenters,w=this.vectors;if(1>=v.length)return null;for(var B=0,D=y.length;B<D;++B){var J=y[B];if(!(J<B)){var M=2*Math.floor(B/3);J=2*Math.floor(J/3);this._renderSegment(r[M],r[M+1],r[J],r[J+1],t)}}y=v[v.length-1];for(B=0;B<v.length;++B)J=y,y=v[B],M=2*Math.floor(q[y]/3),D=r[M],M=r[M+1],J*=4,(J=this._project(D,M,w[J+2],w[J+3]))&&this._renderSegment(D,M,J[0],J[1],t);return u&&u.value()};vb.prototype.renderBounds=function(t){var u=null==t?t=new bc:void 0;t.rect(this.xmin,this.ymin,
this.xmax-this.xmin,this.ymax-this.ymin);return u&&u.value()};vb.prototype.renderCell=function(t,u){var v=null==u?u=new bc:void 0;t=this._clip(t);if(null!==t&&t.length){u.moveTo(t[0],t[1]);for(var y=t.length;t[0]===t[y-2]&&t[1]===t[y-1]&&1<y;)y-=2;for(var q=2;q<y;q+=2)t[q]===t[q-2]&&t[q+1]===t[q-1]||u.lineTo(t[q],t[q+1]);u.closePath();return v&&v.value()}};vb.prototype.cellPolygons=function u(){var v=this,y,q,r,w,B,D;return $jscomp.generator.createGenerator(u,function(J){switch(J.nextAddress){case 1:y=
...
function q(y){var r=this,w,B,D,J,M,P,W,fa,R,S,ma,ia;return $jscomp.generator.createGenerator(q,function(qa){switch(qa.nextAddress){case 1:w=r;B=w.inedges;D=w.hull;J=w._hullIndex;M=w.halfedges;P=w.triangles;W=w.collinear;if(!W){qa.jumpTo(2);break}fa=W.indexOf(y);if(!(0<fa)){qa.jumpTo(3);break}return qa.yield(W[fa-1],3);case 3:if(!(fa<W.length-1)){qa.jumpTo(5);break}return qa.yield(W[fa+1],5);case 5:return qa.return();case 2:R=B[y];if(-1===R)return qa.return();S=R;ma=-1;case 7:return qa.yield(ma=P[S],
10);case 10:S=2===S%3?S-2:S+1;if(P[S]!==y)return qa.return();S=M[S];if(-1!==S){qa.jumpTo(9);break}ia=D[(J[y]+1)%D.length];if(ia===ma){qa.jumpTo(12);break}return qa.yield(ia,12);case 12:return qa.return();case 9:S!==R?qa.jumpTo(7):qa.jumpToEnd()}})};Lb.prototype.find=function(y,q,r){r=void 0===r?0:r;if((y=+y,y!==y)||(q=+q,q!==q))return-1;for(var w=r,B;0<=(B=this._step(r,y,q))&&B!==r&&B!==w;)r=B;return B};Lb.prototype._step=function(y,q,r){var w=this.inedges,B=this.hull,D=this._hullIndex,J=this.halfedges,
M=this.triangles,P=this.points;if(-1===w[y]||!P.length)return(y+1)%(P.length>>1);var W=y,fa=Yd(q-P[2*y],2)+Yd(r-P[2*y+1],2),R=w=w[y];do{var S=M[R],ma=Yd(q-P[2*S],2)+Yd(r-P[2*S+1],2);ma<fa&&(fa=ma,W=S);R=2===R%3?R-2:R+1;if(M[R]!==y)break;R=J[R];if(-1===R){R=B[(D[y]+1)%B.length];if(R!==S&&Yd(q-P[2*R],2)+Yd(r-P[2*R+1],2)<fa)return R;break}}while(R!==w);return W};Lb.prototype.render=function(y){for(var q=null==y?y=new bc:void 0,r=this.points,w=this.halfedges,B=this.triangles,D=0,J=w.length;D<J;++D){var M=
w[D];if(!(M<D)){var P=2*B[D];M=2*B[M];y.moveTo(r[P],r[P+1]);y.lineTo(r[M],r[M+1])}}this.renderHull(y);return q&&q.value()};Lb.prototype.renderPoints=function(y,q){q=void 0===q?2:q;for(var r=null==y?y=new bc:void 0,w=this.points,B=0,D=w.length;B<D;B+=2){var J=w[B],M=w[B+1];y.moveTo(J+q,M);y.arc(J,M,q,0,ov)}return r&&r.value()};Lb.prototype.renderHull=function(y){var q=null==y?y=new bc:void 0,r=this.hull,w=this.points,B=2*r[0],D=r.length;y.moveTo(w[B],w[B+1]);for(B=1;B<D;++B){var J=2*r[B];y.lineTo(w[J],
w[J+1])}y.closePath();return q&&q.value()};Lb.prototype.hullPolygon=function(){var y=new md;this.renderHull(y);return y.value()};Lb.prototype.renderTriangle=function(y,q){var r=null==q?q=new bc:void 0,w=this.points,B=this.triangles,D=2*B[y*=3],J=2*B[y+1];y=2*B[y+2];q.moveTo(w[D],w[D+1]);q.lineTo(w[J],w[J+1]);q.lineTo(w[y],w[y+1]);q.closePath();return r&&r.value()};Lb.prototype.trianglePolygons=function q(){var r=this,w,B,D,J;return $jscomp.generator.createGenerator(q,function(M){1==M.nextAddress&&
...
(new Date("2019-07-01T00:00")).getHours(),Cv=Jk(Yn),Dv=Jk(Zn),Ev=yh("application/xml"),Fv=yh("text/html"),Gv=yh("image/svg+xml"),Vb=rf.prototype=zh.prototype;Vb.copy=function(){var q=new zh(this._x,this._y,this._x0,this._y0,this._x1,this._y1),r=this._root,w,B;if(!r)return q;if(!r.length)return q._root=Lk(r),q;for(w=[{source:r,target:q._root=Array(4)}];r=w.pop();)for(var D=0;4>D;++D)if(B=r.source[D])B.length?w.push({source:B,target:r.target[D]=Array(4)}):r.target[D]=Lk(B);return q};Vb.add=function(q){var r=
+this._x.call(null,q),w=+this._y.call(null,q);return Kk(this.cover(r,w),r,w,q)};Vb.addAll=function(q){var r,w,B=q.length,D,J,M=Array(B),P=Array(B),W=Infinity,fa=Infinity,R=-Infinity,S=-Infinity;for(w=0;w<B;++w)isNaN(D=+this._x.call(null,r=q[w]))||isNaN(J=+this._y.call(null,r))||(M[w]=D,P[w]=J,D<W&&(W=D),D>R&&(R=D),J<fa&&(fa=J),J>S&&(S=J));if(W>R||fa>S)return this;this.cover(W,fa).cover(R,S);for(w=0;w<B;++w)Kk(this,M[w],P[w],q[w]);return this};Vb.cover=function(q,r){if(isNaN(q=+q)||isNaN(r=+r))return this;
var w=this._x0,B=this._y0,D=this._x1,J=this._y1;if(isNaN(w))D=(w=Math.floor(q))+1,J=(B=Math.floor(r))+1;else{for(var M=D-w||1,P=this._root,W,fa;w>q||q>=D||B>r||r>=J;)switch(fa=(r<B)<<1|q<w,W=Array(4),W[fa]=P,P=W,M*=2,fa){case 0:D=w+M;J=B+M;break;case 1:w=D-M;J=B+M;break;case 2:D=w+M;B=J-M;break;case 3:w=D-M,B=J-M}this._root&&this._root.length&&(this._root=P)}this._x0=w;this._y0=B;this._x1=D;this._y1=J;return this};Vb.data=function(){var q=[];this.visit(function(r){if(!r.length){do q.push(r.data);
while(r=r.next)}});return q};Vb.extent=function(q){return arguments.length?this.cover(+q[0][0],+q[0][1]).cover(+q[1][0],+q[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]};Vb.find=function(q,r,w){var B=this._x0,D=this._y0,J,M,P,W,fa=this._x1,R=this._y1,S=[],ma=this._root,ia;ma&&S.push(new Ob(ma,B,D,fa,R));null==w?w=Infinity:(B=q-w,D=r-w,fa=q+w,R=r+w,w*=w);for(;ia=S.pop();)if(!(!(ma=ia.node)||(J=ia.x0)>fa||(M=ia.y0)>R||(P=ia.x1)<B||(W=ia.y1)<D))if(ma.length){ia=(J+P)/2;var qa=
(M+W)/2;S.push(new Ob(ma[3],ia,qa,P,W),new Ob(ma[2],J,qa,ia,W),new Ob(ma[1],ia,M,P,qa),new Ob(ma[0],J,M,ia,qa));if(ma=(r>=qa)<<1|q>=ia)ia=S[S.length-1],S[S.length-1]=S[S.length-1-ma],S[S.length-1-ma]=ia}else if(ia=q-+this._x.call(null,ma.data),qa=r-+this._y.call(null,ma.data),ia=ia*ia+qa*qa,ia<w){var Ha=Math.sqrt(w=ia);B=q-Ha;D=r-Ha;fa=q+Ha;R=r+Ha;Ha=ma.data}return Ha};Vb.remove=function(q){if(isNaN(W=+this._x.call(null,q))||isNaN(fa=+this._y.call(null,q)))return this;var r,w=this._root,B,D=this._x0,
J=this._y0,M=this._x1,P=this._y1,W,fa,R,S,ma,ia;if(!w)return this;if(w.length)for(;;){(ma=W>=(R=(D+M)/2))?D=R:M=R;(ia=fa>=(S=(J+P)/2))?J=S:P=S;if(!(r=w,w=w[ma|=ia<<1]))return this;if(!w.length)break;if(r[ma+1&3]||r[ma+2&3]||r[ma+3&3]){var qa=r;var Ha=ma}}for(;w.data!==q;)if(!(B=w,w=w.next))return this;(q=w.next)&&delete w.next;if(B)return q?B.next=q:delete B.next,this;if(!r)return this._root=q,this;q?r[ma]=q:delete r[ma];(w=r[0]||r[1]||r[2]||r[3])&&w===(r[3]||r[2]||r[1]||r[0])&&!w.length&&(qa?qa[Ha]=
w:this._root=w);return this};Vb.removeAll=function(q){for(var r=0,w=q.length;r<w;++r)this.remove(q[r]);return this};Vb.root=function(){return this._root};Vb.size=function(){var q=0;this.visit(function(r){if(!r.length){do++q;while(r=r.next)}});return q};Vb.visit=function(q){var r=[],w,B=this._root,D,J,M,P;for(B&&r.push(new Ob(B,this._x0,this._y0,this._x1,this._y1));w=r.pop();)if(!q(B=w.node,J=w.x0,M=w.y0,P=w.x1,w=w.y1)&&B.length){var W=(J+P)/2,fa=(M+w)/2;(D=B[3])&&r.push(new Ob(D,W,fa,P,w));(D=B[2])&&
r.push(new Ob(D,J,fa,W,w));(D=B[1])&&r.push(new Ob(D,W,M,P,fa));(D=B[0])&&r.push(new Ob(D,J,M,W,fa))}return this};Vb.visitAfter=function(q){var r=[],w=[],B;for(this._root&&r.push(new Ob(this._root,this._x0,this._y0,this._x1,this._y1));B=r.pop();){var D=B.node;if(D.length){var J,M=B.x0,P=B.y0,W=B.x1,fa=B.y1,R=(M+W)/2,S=(P+fa)/2;(J=D[0])&&r.push(new Ob(J,M,P,R,S));(J=D[1])&&r.push(new Ob(J,R,P,W,S));(J=D[2])&&r.push(new Ob(J,M,S,R,fa));(J=D[3])&&r.push(new Ob(J,R,S,W,fa))}w.push(B)}for(;B=w.pop();)q(B.node,
B.x0,B.y0,B.x1,B.y1);return this};Vb.x=function(q){return arguments.length?(this._x=q,this):this._x};Vb.y=function(q){return arguments.length?(this._y=q,this):this._y};var Hv=Math.PI*(3-Math.sqrt(5)),ls=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;ne.prototype=tf.prototype;tf.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(void 0===this.width?"":Math.max(1,this.width|0))+(this.comma?",":"")+(void 0===this.precision?
...
r)}},xf=new ub,sg=new ub,dl,el,Bh,Ch,Dh,tc={point:pb,lineStart:pb,lineEnd:pb,polygonStart:function(){xf=new ub;tc.lineStart=ms;tc.lineEnd=os},polygonEnd:function(){var q=+xf;sg.add(0>q?Ub+q:q);this.lineStart=this.lineEnd=this.point=pb},sphere:function(){sg.add(Ub)}},qb,Yb,rb,$b,ed,jl,kl,Dd,oe,Qc,Cc,Dc={point:Fh,lineStart:gl,lineEnd:hl,polygonStart:function(){Dc.point=il;Dc.lineStart=ps;Dc.lineEnd=qs;oe=new ub;tc.polygonStart()},polygonEnd:function(){tc.polygonEnd();Dc.point=Fh;Dc.lineStart=gl;Dc.lineEnd=
hl;0>xf?(qb=-(rb=180),Yb=-($b=90)):1E-6<oe?$b=90:-1E-6>oe&&(Yb=-90);Cc[0]=qb;Cc[1]=rb},sphere:function(){qb=-(rb=180);Yb=-($b=90)}},qe,Ff,Cf,Df,Ef,Gf,Hf,If,Ih,Jh,Kh,pl,ql,Rb,Sb,Tb,mc={sphere:pb,point:Gh,lineStart:ml,lineEnd:nl,polygonStart:function(){mc.lineStart=us;mc.lineEnd=ws},polygonEnd:function(){mc.lineStart=ml;mc.lineEnd=nl}};Mh.invert=Mh;var ei=Bl(function(){return!0},function(q){var r=NaN,w=NaN,B=NaN,D;return{lineStart:function(){q.lineStart();D=1},point:function(J,M){var P=0<J?bb:-bb,W=
eb(J-r);if(1E-6>eb(W-bb))q.point(r,w=0<(w+M)/2?nb:-nb),q.point(B,w),q.lineEnd(),q.lineStart(),q.point(P,w),q.point(J,w),D=0;else if(B!==P&&W>=bb){1E-6>eb(r-B)&&(r-=1E-6*B);1E-6>eb(J-P)&&(J-=1E-6*P);W=r;var fa=w,R=J,S,ma,ia=Ma(W-R);w=1E-6<eb(ia)?Jd((Ma(fa)*(ma=Qa(M))*Ma(R)-Ma(M)*(S=Qa(fa))*Ma(W))/(S*ma*ia)):(fa+M)/2;q.point(B,w);q.lineEnd();q.lineStart();q.point(P,w);D=0}q.point(r=J,w=M);B=P},lineEnd:function(){q.lineEnd();r=w=NaN},clean:function(){return 2-D}}},function(q,r,w,B){null==q?(w*=nb,B.point(-bb,
w),B.point(0,w),B.point(bb,w),B.point(bb,0),B.point(bb,-w),B.point(0,-w),B.point(-bb,-w),B.point(-bb,0),B.point(-bb,w)):1E-6<eb(q[0]-r[0])?(q=q[0]<r[0]?bb:-bb,w=w*q/2,B.point(-q,w),B.point(0,w),B.point(q,w)):B.point(r[0],r[1])},[-bb,-nb]),Qh,Ph,Mf,Nf,Fd={sphere:pb,point:pb,lineStart:function(){Fd.point=Bs;Fd.lineEnd=As},lineEnd:pb,polygonStart:pb,polygonEnd:pb},Rh=[null,null],Ds={type:"LineString",coordinates:Rh},ao={Feature:function(q,r){return Of(q.geometry,r)},FeatureCollection:function(q,r){q=
...
r){q=q.coordinates;for(var w=-1,B=q.length;++w<B;)if(Gl(q[w],r))return!0;return!1},GeometryCollection:function(q,r){q=q.geometries;for(var w=-1,B=q.length;++w<B;)if(Of(q[w],r))return!0;return!1}},ye=function(q){return q},Xi=new ub,Uh=new ub,Ml,Nl,Sh,Th,Ec={point:pb,lineStart:pb,lineEnd:pb,polygonStart:function(){Ec.lineStart=Fs;Ec.lineEnd=Hs},polygonEnd:function(){Ec.lineStart=Ec.lineEnd=Ec.point=pb;Xi.add(eb(Uh));Uh=new ub},result:function(){var q=Xi/2;Xi=new ub;return q}},Zd=Infinity,tg=Zd,Oe=-Zd,
ug=Oe,Sf={point:function(q,r){q<Zd&&(Zd=q);q>Oe&&(Oe=q);r<tg&&(tg=r);r>ug&&(ug=r)},lineStart:pb,lineEnd:pb,polygonStart:pb,polygonEnd:pb,result:function(){var q=[[Zd,tg],[Oe,ug]];Oe=ug=-(tg=Zd=Infinity);return q}},Vh=0,Wh=0,se=0,Qf=0,Rf=0,Gd=0,Xh=0,Yh=0,te=0,Rl,Sl,uc,vc,ec={point:fd,lineStart:Ol,lineEnd:Pl,polygonStart:function(){ec.lineStart=Ks;ec.lineEnd=Ms},polygonEnd:function(){ec.point=fd;ec.lineStart=Ol;ec.lineEnd=Pl},result:function(){var q=te?[Xh/te,Yh/te]:Gd?[Qf/Gd,Rf/Gd]:se?[Vh/se,Wh/se]:
...
r)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};var Os=Qa(30*Ta),Rs=xe({point:function(q,r){this.stream.point(q*Ta,r*Ta)}}),Zi=dm(function(q){return Cb(2/(1+q))});Zi.invert=ze(function(q){return 2*Pb(q/2)});var $i=dm(function(q){return(q=Yk(q))&&q/Ma(q)});$i.invert=ze(function(q){return q});Ae.invert=function(q,r){return[q,
2*Jd($n(r))-nb]};Be.invert=Be;var Vf=Cb(3)/2;hi.invert=function(q,r){for(var w=r,B=w*w,D=B*B*B,J=0,M;12>J&&!(M=w*(1.340264+-.081106*B+D*(8.93E-4+.003796*B))-r,B=1.340264+3*-.081106*B+D*(7*8.93E-4+.034164*B),w-=M/=B,B=w*w,D=B*B*B,1E-12>eb(M));++J);return[Vf*q*(1.340264+3*-.081106*B+D*(7*8.93E-4+.034164*B))/Qa(w),Pb(Ma(w)/Vf)]};ii.invert=ze(Jd);ji.invert=function(q,r){var w=r,B=25;do{var D=w*w;var J=D*D;w-=J=(w*(1.007226+D*(.015085+J*(-.044475+.028874*D-.005916*J)))-r)/(1.007226+D*(.045255+J*(-.311325+
.259866*D-.005916*11*J)))}while(1E-6<eb(J)&&0<--B);return[q/(.8707+(D=w*w)*(-.131979+D*(-.013791+D*D*D*(.003971-.001529*D)))),w]};ki.invert=ze(Pb);li.invert=ze(function(q){return 2*Jd(q)});mi.invert=function(q,r){return[-r,2*Jd($n(q))-nb]};var Mb={};Kd.prototype=ni.prototype=(Mb.constructor=Kd,Mb.count=function(){return this.eachAfter(Zs)},Mb.each=function(q,r){for(var w=-1,B=$jscomp.makeIterator(this),D=B.next();!D.done;D=B.next())q.call(r,D.value,++w,this);return this},Mb.eachAfter=function(q,r){for(var w,
...
1)};return B}(co),Jv=function B(w){function D(J,M,P,W,fa){if((R=J._squarify)&&R.ratio===w)for(var R,S,ma,ia=-1,qa,Ha=R.length,pa=J.value;++ia<Ha;){J=R[ia];S=J.children;ma=J.value=0;for(qa=S.length;ma<qa;++ma)J.value+=S[ma].value;J.dice?De(J,M,P,W,pa?P+=(fa-P)*J.value/pa:fa):$f(J,M,P,pa?M+=(W-M)*J.value/pa:W,fa);pa-=J.value}else J._squarify=R=tm(w,J,M,P,W,fa),R.ratio=w}D.ratio=function(J){return B(1<(J=+J)?J:1)};return D}(co),Fb=Math.random,Kv=function D(B){function J(M,P){M=null==M?0:+M;P=null==P?
1:+P;1===arguments.length?(P=M,M=0):P-=M;return function(){return B()*P+M}}J.source=D;return J}(Fb),Lv=function J(D){function M(P,W){2>arguments.length&&(W=P,P=0);P=Math.floor(P);W=Math.floor(W)-P;return function(){return Math.floor(D()*W+P)}}M.source=J;return M}(Fb),aj=function M(J){function P(W,fa){var R,S;W=null==W?0:+W;fa=null==fa?1:+fa;return function(){if(null!=R){var ma=R;R=null}else{do R=2*J()-1,ma=2*J()-1,S=R*R+ma*ma;while(!S||1<S)}return W+fa*ma*Math.sqrt(-2*Math.log(S)/S)}}P.source=M;return P}(Fb),
Mv=function P(M){function W(){var R=fa.apply(this,arguments);return function(){return Math.exp(R())}}var fa=aj.source(M);W.source=P;return W}(Fb),fo=function W(P){function fa(R){return 0>=(R=+R)?function(){return 0}:function(){for(var S=0,ma=R;1<ma;--ma)S+=P();return S+ma*P()}}fa.source=W;return fa}(Fb),Nv=function fa(W){function R(ma){if(0===(ma=+ma))return W;var ia=S(ma);return function(){return ia()/ma}}var S=fo.source(W);R.source=fa;return R}(Fb),Ov=function R(fa){function S(ma){return function(){return-Math.log1p(-fa())/
ma}}S.source=R;return S}(Fb),Pv=function S(R){function ma(ia){if(0>(ia=+ia))throw new RangeError("invalid alpha");ia=1/-ia;return function(){return Math.pow(1-R(),ia)}}ma.source=S;return ma}(Fb),Qv=function ma(S){function ia(qa){if(0>(qa=+qa)||1<qa)throw new RangeError("invalid p");return function(){return Math.floor(S()+qa)}}ia.source=ma;return ia}(Fb),go=function ia(ma){function qa(Ha){if(0>(Ha=+Ha)||1<Ha)throw new RangeError("invalid p");if(0===Ha)return function(){return Infinity};if(1===Ha)return function(){return 1};
Ha=Math.log1p(-Ha);return function(){return 1+Math.floor(Math.log1p(-ma())/Ha)}}qa.source=ia;return qa}(Fb),bj=function qa(ia){function Ha(Ea,Pa){if(0>(Ea=+Ea))throw new RangeError("invalid k");if(0===Ea)return function(){return 0};Pa=null==Pa?1:+Pa;if(1===Ea)return function(){return-Math.log1p(-ia())*Pa};var L=(1>Ea?Ea+1:Ea)-1/3,V=1/(3*Math.sqrt(L)),Aa=1>Ea?function(){return Math.pow(ia(),1/Ea)}:function(){return 1};return function(){do{do var Ia=pa(),Da=1+V*Ia;while(0>=Da);Da*=Da*Da;var Ka=1-ia()}while(Ka>=
1-.0331*Ia*Ia*Ia*Ia&&Math.log(Ka)>=.5*Ia*Ia+L*(1-Da+Math.log(Da)));return L*Da*Aa()*Pa}}var pa=aj.source(ia)();Ha.source=qa;return Ha}(Fb),ho=function Ha(qa){function pa(Pa,L){var V=Ea(Pa),Aa=Ea(L);return function(){var Ia=V();return 0===Ia?0:Ia/(Ia+Aa())}}var Ea=bj.source(qa);pa.source=Ha;return pa}(Fb),io=function pa(Ha){function Ea(V,Aa){V=+V;return 1<=(Aa=+Aa)?function(){return V}:0>=Aa?function(){return 0}:function(){for(var Ia=0,Da=V,Ka=Aa;16<Da*Ka&&16<Da*(1-Ka);){var Ua=Math.floor((Da+1)*Ka),
k=L(Ua,Da-Ua+1)();k<=Ka?(Ia+=Ua,Da-=Ua,Ka=(Ka-k)/(1-k)):(Da=Ua-1,Ka/=k)}Ua=.5>Ka;Ka=Pa(Ua?Ka:1-Ka);k=Ka();for(var A=0;k<=Da;++A)k+=Ka();return Ia+(Ua?A:Da-A)}}var Pa=go.source(Ha),L=ho.source(Ha);Ea.source=pa;return Ea}(Fb),Rv=function Ea(pa){function Pa(L,V,Aa){if(0===(L=+L))var Ia=function(Da){return-Math.log(Da)};else L=1/L,Ia=function(Da){return Math.pow(Da,L)};V=null==V?0:+V;Aa=null==Aa?1:+Aa;return function(){return V+Aa*Ia(-Math.log1p(-pa()))}}Pa.source=Ea;return Pa}(Fb),Sv=function Pa(Ea){function L(V,
Aa){V=null==V?0:+V;Aa=null==Aa?1:+Aa;return function(){return V+Aa*Math.tan(Math.PI*Ea())}}L.source=Pa;return L}(Fb),Tv=function L(Pa){function V(Aa,Ia){Aa=null==Aa?0:+Aa;Ia=null==Ia?1:+Ia;return function(){var Da=Pa();return Aa+Ia*Math.log(Da/(1-Da))}}V.source=L;return V}(Fb),Uv=function V(L){function Aa(Ka){return function(){for(var Ua=0,k=Ka;16<k;){var A=Math.floor(.875*k),G=Ia(A)();if(G>k)return Ua+Da(A-1,k/G)();Ua+=A;k-=G}A=-Math.log1p(-L());for(G=0;A<=k;++G)A-=Math.log1p(-L());return Ua+G}}
var Ia=bj.source(L),Da=io.source(L);Aa.source=V;return Aa}(Fb),jo=1/4294967296,ti=Symbol("implicit"),wm=[0,1],Ai=new Date,Bi=new Date,Nd=zb(function(){},function(L,V){L.setTime(+L+V)},function(L,V){return V-L});Nd.every=function(L){L=Math.floor(L);return isFinite(L)&&0<L?1<L?zb(function(V){V.setTime(Math.floor(V/L)*L)},function(V,Aa){V.setTime(+V+Aa*L)},function(V,Aa){return(Aa-V)/L}):Nd:null};var ko=Nd.range,Ci=6048E5,Pm=2592E6,Di=31536E6,Gc=zb(function(L){L.setTime(L-L.getMilliseconds())},function(L,
V){L.setTime(+L+1E3*V)},function(L,V){return(V-L)/1E3},function(L){return L.getUTCSeconds()}),lo=Gc.range,vg=zb(function(L){L.setTime(L-L.getMilliseconds()-1E3*L.getSeconds())},function(L,V){L.setTime(+L+6E4*V)},function(L,V){return(V-L)/6E4},function(L){return L.getMinutes()}),Vv=vg.range,wg=zb(function(L){L.setTime(L-L.getMilliseconds()-1E3*L.getSeconds()-6E4*L.getMinutes())},function(L,V){L.setTime(+L+36E5*V)},function(L,V){return(V-L)/36E5},function(L){return L.getHours()}),Wv=wg.range,Pd=zb(function(L){return L.setHours(0,
0,0,0)},function(L,V){return L.setDate(L.getDate()+V)},function(L,V){return(V-L-6E4*(V.getTimezoneOffset()-L.getTimezoneOffset()))/864E5},function(L){return L.getDate()-1}),Xv=Pd.range,Qd=hd(0),He=hd(1),mo=hd(2),no=hd(3),jd=hd(4),oo=hd(5),po=hd(6),qo=Qd.range,Yv=He.range,Zv=mo.range,$v=no.range,aw=jd.range,bw=oo.range,cw=po.range,xg=zb(function(L){L.setDate(1);L.setHours(0,0,0,0)},function(L,V){L.setMonth(L.getMonth()+V)},function(L,V){return V.getMonth()-L.getMonth()+12*(V.getFullYear()-L.getFullYear())},
function(L){return L.getMonth()}),dw=xg.range,xc=zb(function(L){L.setMonth(0,1);L.setHours(0,0,0,0)},function(L,V){L.setFullYear(L.getFullYear()+V)},function(L,V){return V.getFullYear()-L.getFullYear()},function(L){return L.getFullYear()});xc.every=function(L){return isFinite(L=Math.floor(L))&&0<L?zb(function(V){V.setFullYear(Math.floor(V.getFullYear()/L)*L);V.setMonth(0,1);V.setHours(0,0,0,0)},function(V,Aa){V.setFullYear(V.getFullYear()+Aa*L)}):null};var ew=xc.range,yg=zb(function(L){L.setUTCSeconds(0,
0)},function(L,V){L.setTime(+L+6E4*V)},function(L,V){return(V-L)/6E4},function(L){return L.getUTCMinutes()}),fw=yg.range,zg=zb(function(L){L.setUTCMinutes(0,0,0)},function(L,V){L.setTime(+L+36E5*V)},function(L,V){return(V-L)/36E5},function(L){return L.getUTCHours()}),gw=zg.range,Od=zb(function(L){L.setUTCHours(0,0,0,0)},function(L,V){L.setUTCDate(L.getUTCDate()+V)},function(L,V){return(V-L)/864E5},function(L){return L.getUTCDate()-1}),hw=Od.range,Rd=id(0),Ge=id(1),ro=id(2),so=id(3),kd=id(4),to=id(5),
uo=id(6),vo=Rd.range,iw=Ge.range,jw=ro.range,kw=so.range,lw=kd.range,mw=to.range,nw=uo.range,Ag=zb(function(L){L.setUTCDate(1);L.setUTCHours(0,0,0,0)},function(L,V){L.setUTCMonth(L.getUTCMonth()+V)},function(L,V){return V.getUTCMonth()-L.getUTCMonth()+12*(V.getUTCFullYear()-L.getUTCFullYear())},function(L){return L.getUTCMonth()}),ow=Ag.range,yc=zb(function(L){L.setUTCMonth(0,1);L.setUTCHours(0,0,0,0)},function(L,V){L.setUTCFullYear(L.getUTCFullYear()+V)},function(L,V){return V.getUTCFullYear()-L.getUTCFullYear()},
function(L){return L.getUTCFullYear()});yc.every=function(L){return isFinite(L=Math.floor(L))&&0<L?zb(function(V){V.setUTCFullYear(Math.floor(V.getUTCFullYear()/L)*L);V.setUTCMonth(0,1);V.setUTCHours(0,0,0,0)},function(V,Aa){V.setUTCFullYear(V.getUTCFullYear()+Aa*L)}):null};var pw=yc.range,wo=$jscomp.makeIterator(Om(yc,Ag,Rd,Od,zg,yg)),xo=wo.next().value,yo=wo.next().value,zo=$jscomp.makeIterator(Om(xc,xg,Qd,Pd,wg,vg)),Ao=zo.next().value,Bo=zo.next().value,Rm={"-":"",_:" ",0:"0"},Db=/^\s*\d+/,tu=
...
"fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181d99000d","fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181da50f1567000d").map(Za),ax=kb(ap),bp=Array(3).concat("fee6cefdae6be6550d","feeddefdbe85fd8d3cd94701","feeddefdbe85fd8d3ce6550da63603","feeddefdd0a2fdae6bfd8d3ce6550da63603","feeddefdd0a2fdae6bfd8d3cf16913d948018c2d04","fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d948018c2d04","fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d94801a636037f2704").map(Za),bx=kb(bp),cx=qg(jc(300,.5,0),jc(-240,.5,1)),dx=qg(jc(-100,.75,.35),jc(80,
1.5,.8)),ex=qg(jc(260,.75,.35),jc(80,1.5,.8)),Bg=jc(),Cg=td(),fx=Math.PI/3,gx=2*Math.PI/3,hx=dg(Za("")),
...
cp=Math.abs,Nb=Math.atan2,pd=Math.cos,Du=Math.max,cj=Math.min,zc=Math.sin,Td=Math.sqrt,Uc=Math.PI,eg=Uc/2,Vc=2*Uc,Iu=Array.prototype.slice;on.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){(this._line||0!==this._line&&1===this._point)&&this._context.closePath();this._line=1-this._line},point:function(L,V){L=+L;V=+V;switch(this._point){case 0:this._point=1;this._line?this._context.lineTo(L,V):this._context.moveTo(L,
V);break;case 1:this._point=2;default:this._context.lineTo(L,V)}}};var sn=Mi(hg);qn.prototype={areaStart:function(){this._curve.areaStart()},areaEnd:function(){this._curve.areaEnd()},lineStart:function(){this._curve.lineStart()},lineEnd:function(){this._curve.lineEnd()},point:function(L,V){this._curve.point(V*Math.sin(L),V*-Math.cos(L))}};var dj={draw:function(L,V){V=Math.sqrt(V/Uc);L.moveTo(V,0);L.arc(0,0,V,0,Vc)}},dp={draw:function(L,V){V=Math.sqrt(V/5)/2;L.moveTo(-3*V,-V);L.lineTo(-V,-V);L.lineTo(-V,
-3*V);L.lineTo(V,-3*V);L.lineTo(V,-V);L.lineTo(3*V,-V);L.lineTo(3*V,V);L.lineTo(V,V);L.lineTo(V,3*V);L.lineTo(-V,3*V);L.lineTo(-V,V);L.lineTo(-3*V,V);L.closePath()}},ep=Math.sqrt(1/3),lx=2*ep,fp={draw:function(L,V){V=Math.sqrt(V/lx);var Aa=V*ep;L.moveTo(0,-V);L.lineTo(Aa,0);L.lineTo(0,V);L.lineTo(-Aa,0);L.closePath()}},gp=Math.sin(Uc/10)/Math.sin(7*Uc/10),mx=Math.sin(Vc/10)*gp,nx=-Math.cos(Vc/10)*gp,hp={draw:function(L,V){V=Math.sqrt(.8908130915292852*V);var Aa=mx*V,Ia=nx*V;L.moveTo(0,-V);L.lineTo(Aa,
Ia);for(var Da=1;5>Da;++Da){var Ka=Vc*Da/5,Ua=Math.cos(Ka);Ka=Math.sin(Ka);L.lineTo(Ka*V,-Ua*V);L.lineTo(Ua*Aa-Ka*Ia,Ka*Aa+Ua*Ia)}L.closePath()}},ip={draw:function(L,V){V=Math.sqrt(V);var Aa=-V/2;L.rect(Aa,Aa,V,V)}},ej=Math.sqrt(3),jp={draw:function(L,V){V=-Math.sqrt(V/(3*ej));L.moveTo(0,2*V);L.lineTo(-ej*V,-V);L.lineTo(ej*V,-V);L.closePath()}},gc=Math.sqrt(3)/2,fj=1/Math.sqrt(12),ox=3*(fj/2+1),kp={draw:function(L,V){var Aa=Math.sqrt(V/ox);V=Aa/2;var Ia=Aa*fj;Aa=Aa*fj+Aa;var Da=-V;L.moveTo(V,Ia);
L.lineTo(V,Aa);L.lineTo(Da,Aa);L.lineTo(-.5*V-gc*Ia,gc*V+-.5*Ia);L.lineTo(-.5*V-gc*Aa,gc*V+-.5*Aa);L.lineTo(-.5*Da-gc*Aa,gc*Da+-.5*Aa);L.lineTo(-.5*V+gc*Ia,-.5*Ia-gc*V);L.lineTo(-.5*V+gc*Aa,-.5*Aa-gc*V);L.lineTo(-.5*Da+gc*Aa,-.5*Aa-gc*Da);L.closePath()}},px=[dj,dp,fp,ip,hp,jp,kp];jg.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN;this._point=0},lineEnd:function(){switch(this._point){case 3:ig(this,this._x1,
this._y1);case 2:this._context.lineTo(this._x1,this._y1)}(this._line||0!==this._line&&1===this._point)&&this._context.closePath();this._line=1-this._line},point:function(L,V){L=+L;V=+V;switch(this._point){case 0:this._point=1;this._line?this._context.lineTo(L,V):this._context.moveTo(L,V);break;case 1:this._point=2;break;case 2:this._point=3,this._context.lineTo((5*this._x0+this._x1)/6,(5*this._y0+this._y1)/6);default:ig(this,L,V)}this._x0=this._x1;this._x1=L;this._y0=this._y1;this._y1=V}};un.prototype=
...
this._y3),this.point(this._x4,this._y4)}},point:function(L,V){L=+L;V=+V;switch(this._point){case 0:this._point=1;this._x2=L;this._y2=V;break;case 1:this._point=2;this._x3=L;this._y3=V;break;case 2:this._point=3;this._x4=L;this._y4=V;this._context.moveTo((this._x0+4*this._x1+L)/6,(this._y0+4*this._y1+V)/6);break;default:ig(this,L,V)}this._x0=this._x1;this._x1=L;this._y0=this._y1;this._y1=V}};vn.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=
this._x1=this._y0=this._y1=NaN;this._point=0},lineEnd:function(){(this._line||0!==this._line&&3===this._point)&&this._context.closePath();this._line=1-this._line},point:function(L,V){L=+L;V=+V;switch(this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3;var Aa=(this._x0+4*this._x1+L)/6,Ia=(this._y0+4*this._y1+V)/6;this._line?this._context.lineTo(Aa,Ia):this._context.moveTo(Aa,Ia);break;case 3:this._point=4;default:ig(this,L,V)}this._x0=this._x1;this._x1=L;this._y0=
this._y1;this._y1=V}};var qd=function(L,V){this._context=L;this._x=V};qd.prototype.areaStart=function(){this._line=0};qd.prototype.areaEnd=function(){this._line=NaN};qd.prototype.lineStart=function(){this._point=0};qd.prototype.lineEnd=function(){(this._line||0!==this._line&&1===this._point)&&this._context.closePath();this._line=1-this._line};qd.prototype.point=function(L,V){L=+L;V=+V;switch(this._point){case 0:this._point=1;this._line?this._context.lineTo(L,V):this._context.moveTo(L,V);break;case 1:this._point=
2;default:this._x?this._context.bezierCurveTo(this._x0=(this._x0+L)/2,this._y0,this._x0,V,L,V):this._context.bezierCurveTo(this._x0,this._y0=(this._y0+V)/2,L,this._y0,L,V)}this._x0=L;this._y0=V};wn.prototype={lineStart:function(){this._x=[];this._y=[];this._basis.lineStart()},lineEnd:function(){var L=this._x,V=this._y,Aa=L.length-1;if(0<Aa)for(var Ia=L[0],Da=V[0],Ka=L[Aa]-Ia,Ua=V[Aa]-Da,k=-1,A;++k<=Aa;)A=k/Aa,this._basis.point(this._beta*L[k]+(1-this._beta)*(Ia+A*Ka),this._beta*V[k]+(1-this._beta)*
(Da+A*Ua));this._x=this._y=null;this._basis.lineEnd()},point:function(L,V){this._x.push(+L);this._y.push(+V)}};var qx=function Aa(V){function Ia(Da){return 1===V?new jg(Da):new wn(Da,V)}Ia.beta=function(Da){return Aa(+Da)};return Ia}(.85);Oi.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN;this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);
break;case 3:kg(this,this._x1,this._y1)}(this._line||0!==this._line&&1===this._point)&&this._context.closePath();this._line=1-this._line},point:function(V,Aa){V=+V;Aa=+Aa;switch(this._point){case 0:this._point=1;this._line?this._context.lineTo(V,Aa):this._context.moveTo(V,Aa);break;case 1:this._point=2;this._x1=V;this._y1=Aa;break;case 2:this._point=3;default:kg(this,V,Aa)}this._x0=this._x1;this._x1=this._x2;this._x2=V;this._y0=this._y1;this._y1=this._y2;this._y2=Aa}};var rx=function Ia(Aa){function Da(Ka){return new Oi(Ka,
Aa)}Da.tension=function(Ka){return Ia(+Ka)};return Da}(0);Pi.prototype={areaStart:Tc,areaEnd:Tc,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=this._y2=this._y3=this._y4=this._y5=NaN;this._point=0},lineEnd:function(){switch(this._point){case 1:this._context.moveTo(this._x3,this._y3);this._context.closePath();break;case 2:this._context.lineTo(this._x3,this._y3);this._context.closePath();break;case 3:this.point(this._x3,this._y3),this.point(this._x4,this._y4),
this.point(this._x5,this._y5)}},point:function(Aa,Ia){Aa=+Aa;Ia=+Ia;switch(this._point){case 0:this._point=1;this._x3=Aa;this._y3=Ia;break;case 1:this._point=2;this._context.moveTo(this._x4=Aa,this._y4=Ia);break;case 2:this._point=3;this._x5=Aa;this._y5=Ia;break;default:kg(this,Aa,Ia)}this._x0=this._x1;this._x1=this._x2;this._x2=Aa;this._y0=this._y1;this._y1=this._y2;this._y2=Ia}};var sx=function Da(Ia){function Ka(Ua){return new Pi(Ua,Ia)}Ka.tension=function(Ua){return Da(+Ua)};return Ka}(0);Qi.prototype=
{areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN;this._point=0},lineEnd:function(){(this._line||0!==this._line&&3===this._point)&&this._context.closePath();this._line=1-this._line},point:function(Ia,Da){Ia=+Ia;Da=+Da;switch(this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3;this._line?this._context.lineTo(this._x2,this._y2):this._context.moveTo(this._x2,this._y2);
break;case 3:this._point=4;default:kg(this,Ia,Da)}this._x0=this._x1;this._x1=this._x2;this._x2=Ia;this._y0=this._y1;this._y1=this._y2;this._y2=Da}};var tx=function Ka(Da){function Ua(k){return new Qi(k,Da)}Ua.tension=function(k){return Ka(+k)};return Ua}(0);xn.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN;this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=
0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);break;case 3:this.point(this._x2,this._y2)}(this._line||0!==this._line&&1===this._point)&&this._context.closePath();this._line=1-this._line},point:function(Da,Ka){Da=+Da;Ka=+Ka;if(this._point){var Ua=this._x2-Da,k=this._y2-Ka;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(Ua*Ua+k*k,this._alpha))}switch(this._point){case 0:this._point=1;this._line?this._context.lineTo(Da,Ka):this._context.moveTo(Da,Ka);break;case 1:this._point=
2;break;case 2:this._point=3;default:Ri(this,Da,Ka)}this._l01_a=this._l12_a;this._l12_a=this._l23_a;this._l01_2a=this._l12_2a;this._l12_2a=this._l23_2a;this._x0=this._x1;this._x1=this._x2;this._x2=Da;this._y0=this._y1;this._y1=this._y2;this._y2=Ka}};var ux=function Ua(Ka){function k(A){return Ka?new xn(A,Ka):new Oi(A,0)}k.alpha=function(A){return Ua(+A)};return k}(.5);yn.prototype={areaStart:Tc,areaEnd:Tc,lineStart:function(){this._x0=this._x1=this._x2=this._x3=this._x4=this._x5=this._y0=this._y1=
this._y2=this._y3=this._y4=this._y5=NaN;this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){switch(this._point){case 1:this._context.moveTo(this._x3,this._y3);this._context.closePath();break;case 2:this._context.lineTo(this._x3,this._y3);this._context.closePath();break;case 3:this.point(this._x3,this._y3),this.point(this._x4,this._y4),this.point(this._x5,this._y5)}},point:function(Ka,Ua){Ka=+Ka;Ua=+Ua;if(this._point){var k=this._x2-Ka,A=this._y2-
Ua;this._l23_a=Math.sqrt(this._l23_2a=Math.pow(k*k+A*A,this._alpha))}switch(this._point){case 0:this._point=1;this._x3=Ka;this._y3=Ua;break;case 1:this._point=2;this._context.moveTo(this._x4=Ka,this._y4=Ua);break;case 2:this._point=3;this._x5=Ka;this._y5=Ua;break;default:Ri(this,Ka,Ua)}this._l01_a=this._l12_a;this._l12_a=this._l23_a;this._l01_2a=this._l12_2a;this._l12_2a=this._l23_2a;this._x0=this._x1;this._x1=this._x2;this._x2=Ka;this._y0=this._y1;this._y1=this._y2;this._y2=Ua}};var vx=function k(Ua){function A(G){return Ua?
...
this.x+","+this.y+") scale("+this.k+")"}};var ng=new Hc(1,0,0);Kn.prototype=Hc.prototype;e.Adder=ub;e.Delaunay=Lb;e.FormatSpecifier=tf;e.InternMap=Wc;e.InternSet=Ne;e.Voronoi=vb;e.active=function(k,A){var G=k.__transition,E,H;if(G)for(H in A=null==A?null:A+"",G)if(1<(E=G[H]).state&&E.name===A)return new sc([[k]],lv,A,+H);return null};e.arc=function(){function k(){var da,na=+A.apply(this,arguments),ra=+G.apply(this,arguments),O=K.apply(this,arguments)-eg,Y=T.apply(this,arguments)-eg,oa=cp(Y-O),Z=Y>
O;ba||(ba=da=Oc());if(ra<na){var ta=ra;ra=na;na=ta}if(1E-12<ra)if(oa>Vc-1E-12)ba.moveTo(ra*pd(O),ra*zc(O)),ba.arc(0,0,ra,O,Y,!Z),1E-12<na&&(ba.moveTo(na*pd(Y),na*zc(Y)),ba.arc(0,0,na,Y,O,Z));else{var ha=O,va=Y;ta=O;var wa=Y,la=oa,Ca=oa,La=Q.apply(this,arguments)/2,Ra=1E-12<La&&(H?+H.apply(this,arguments):Td(na*na+ra*ra)),$a=cj(cp(ra-na)/2,+E.apply(this,arguments)),Wa=$a,mb=$a;if(1E-12<Ra){var ob=nn(Ra/na*zc(La));La=nn(Ra/ra*zc(La));1E-12<(la-=2*ob)?(ob*=Z?1:-1,ta+=ob,wa-=ob):(la=0,ta=wa=(O+Y)/2);
1E-12<(Ca-=2*La)?(La*=Z?1:-1,ha+=La,va-=La):(Ca=0,ha=va=(O+Y)/2)}O=ra*pd(ha);Y=ra*zc(ha);ob=na*pd(wa);La=na*zc(wa);if(1E-12<$a){var sa=ra*pd(va),Oa=ra*zc(va),xa=na*pd(ta),Ja=na*zc(ta);if(oa=oa<Uc){var Fa=xa-O;oa=Ja-Y;Ra=ob-sa;var Ya=La-Oa,Va=Ya*Fa-Ra*oa;1E-12>Va*Va?Fa=void 0:(Va=(Ra*(Y-Oa)-Ya*(O-sa))/Va,Fa=[O+Va*Fa,Y+Va*oa]);oa=Fa}oa&&(Wa=O-Fa[0],mb=Y-Fa[1],oa=sa-Fa[0],Ra=Oa-Fa[1],Wa=(Wa*oa+mb*Ra)/(Td(Wa*Wa+mb*mb)*Td(oa*oa+Ra*Ra)),mb=1/zc((1<Wa?0:-1>Wa?Uc:Math.acos(Wa))/2),Fa=Td(Fa[0]*Fa[0]+Fa[1]*
Fa[1]),Wa=cj($a,(na-Fa)/(mb-1)),mb=cj($a,(ra-Fa)/(mb+1)))}1E-12<Ca?1E-12<mb?(ha=fg(xa,Ja,O,Y,ra,mb,Z),va=fg(sa,Oa,ob,La,ra,mb,Z),ba.moveTo(ha.cx+ha.x01,ha.cy+ha.y01),mb<$a?ba.arc(ha.cx,ha.cy,mb,Nb(ha.y01,ha.x01),Nb(va.y01,va.x01),!Z):(ba.arc(ha.cx,ha.cy,mb,Nb(ha.y01,ha.x01),Nb(ha.y11,ha.x11),!Z),ba.arc(0,0,ra,Nb(ha.cy+ha.y11,ha.cx+ha.x11),Nb(va.cy+va.y11,va.cx+va.x11),!Z),ba.arc(va.cx,va.cy,mb,Nb(va.y11,va.x11),Nb(va.y01,va.x01),!Z))):(ba.moveTo(O,Y),ba.arc(0,0,ra,ha,va,!Z)):ba.moveTo(O,Y);1E-12<
na&&1E-12<la?1E-12<Wa?(ha=fg(ob,La,sa,Oa,na,-Wa,Z),va=fg(O,Y,xa,Ja,na,-Wa,Z),ba.lineTo(ha.cx+ha.x01,ha.cy+ha.y01),Wa<$a?ba.arc(ha.cx,ha.cy,Wa,Nb(ha.y01,ha.x01),Nb(va.y01,va.x01),!Z):(ba.arc(ha.cx,ha.cy,Wa,Nb(ha.y01,ha.x01),Nb(ha.y11,ha.x11),!Z),ba.arc(0,0,na,Nb(ha.cy+ha.y11,ha.cx+ha.x11),Nb(va.cy+va.y11,va.cx+va.x11),Z),ba.arc(va.cx,va.cy,Wa,Nb(va.y11,va.x11),Nb(va.y01,va.x01),!Z))):ba.arc(0,0,na,wa,ta,Z):ba.lineTo(ob,La)}else ba.moveTo(0,0);ba.closePath();if(da)return ba=null,da+""||null}var A=yu,
...
function(){return rh(!1,!0)};e.cluster=function(){function k(K){var T,Q=0;K.eachAfter(function(O){var Y=O.children;if(Y){var oa=Y.reduce(Vs,0)/Y.length;O.x=oa;O.y=1+Y.reduce(Ws,0)}else O.x=T?Q+=A(O,T):0,O.y=0,T=O});var ba=Xs(K),da=Ys(K),na=ba.x-A(ba,da)/2,ra=da.x+A(da,ba)/2;return K.eachAfter(H?function(O){O.x=(O.x-K.x)*G;O.y=(K.y-O.y)*E}:function(O){O.x=(O.x-na)/(ra-na)*G;O.y=(1-(K.y?O.y/K.y:1))*E})}var A=Us,G=1,E=1,H=!1;k.separation=function(K){return arguments.length?(A=K,k):A};k.size=function(K){return arguments.length?
(H=!1,G=+K[0],E=+K[1],k):H?null:[G,E]};k.nodeSize=function(K){return arguments.length?(H=!0,G=+K[0],E=+K[1],k):H?[G,E]:null};return k};e.color=Lc;e.contourDensity=function(){function k(ha){var va=new Float32Array(oa*Z),wa=new Float32Array(oa*Z);ha.forEach(function(la,Ca,La){var Ra=+T(la,Ca,La)+Y>>O,$a=+Q(la,Ca,La)+Y>>O;la=+ba(la,Ca,La);0<=Ra&&Ra<oa&&0<=$a&&$a<Z&&(va[Ra+$a*oa]+=la)});th({width:oa,height:Z,data:va},{width:oa,height:Z,data:wa},ra>>O);uh({width:oa,height:Z,data:wa},{width:oa,height:Z,
data:va},ra>>O);th({width:oa,height:Z,data:va},{width:oa,height:Z,data:wa},ra>>O);uh({width:oa,height:Z,data:wa},{width:oa,height:Z,data:va},ra>>O);th({width:oa,height:Z,data:va},{width:oa,height:Z,data:wa},ra>>O);uh({width:oa,height:Z,data:wa},{width:oa,height:Z,data:va},ra>>O);ha=ta(va);Array.isArray(ha)||(wa=Pe(va),ha=nc(0,wa,ha),ha=oc(0,Math.floor(wa/ha)*ha,ha),ha.shift());return Dk().thresholds(ha).size([oa,Z])(va).map(A)}function A(ha){ha.value*=Math.pow(2,-2*O);ha.coordinates.forEach(G);return ha}
function G(ha){ha.forEach(E)}function E(ha){ha.forEach(H)}function H(ha){ha[0]=ha[0]*Math.pow(2,O)-Y;ha[1]=ha[1]*Math.pow(2,O)-Y}function K(){Y=3*ra;oa=da+2*Y>>O;Z=na+2*Y>>O;return k}var T=Or,Q=Pr,ba=Qr,da=960,na=500,ra=20,O=2,Y=3*ra,oa=da+2*Y>>O,Z=na+2*Y>>O,ta=Pc(20);k.x=function(ha){return arguments.length?(T="function"===typeof ha?ha:Pc(+ha),k):T};k.y=function(ha){return arguments.length?(Q="function"===typeof ha?ha:Pc(+ha),k):Q};k.weight=function(ha){return arguments.length?(ba="function"===typeof ha?
ha:Pc(+ha),k):ba};k.size=function(ha){if(!arguments.length)return[da,na];var va=+ha[0],wa=+ha[1];if(!(0<=va&&0<=wa))throw Error("invalid size");return da=va,na=wa,K()};k.cellSize=function(ha){if(!arguments.length)return 1<<O;if(!(1<=(ha=+ha)))throw Error("invalid cell size");return O=Math.floor(Math.log(ha)/Math.LN2),K()};k.thresholds=function(ha){return arguments.length?(ta="function"===typeof ha?ha:Array.isArray(ha)?Pc(Ek.call(ha)):Pc(ha),k):ta};k.bandwidth=function(ha){if(!arguments.length)return Math.sqrt(ra*
(ra+1));if(!(0<=(ha=+ha)))throw Error("invalid bandwidth");return ra=Math.round((Math.sqrt(4*ha*ha+1)-1)/2),K()};return k};e.contours=Dk;e.count=N;e.create=function(k){return Ib(Te(k).call(document.documentElement))};e.creator=Te;e.cross=function(k){for(var A=[],G=0;G<arguments.length;++G)A[G-0]=arguments[G];var E=A;A="function"===typeof E[E.length-1]&&ea(E.pop());E=E.map(ca);G=E.map(U);var H=E.length-1,K=Array(H+1).fill(0),T=[];if(0>H||G.some(aa))return T;for(;;){T.push(K.map(function(ba,da){return E[da][ba]}));
for(var Q=H;++K[Q]===G[Q];){if(0===Q)return A?T.map(A):T;K[Q--]=0}}};e.csv=Cv;e.csvFormat=qv;e.csvFormatBody=rv;e.csvFormatRow=tv;e.csvFormatRows=sv;e.csvFormatValue=uv;e.csvParse=Yn;e.csvParseRows=pv;e.cubehelix=jc;e.cumsum=function(k,A){var G=0,E=0;return Float64Array.from(k,void 0===A?function(H){return G+=+H||0}:function(H){return G+=+A(H,E++,k)||0})};e.curveBasis=function(k){return new jg(k)};e.curveBasisClosed=function(k){return new un(k)};e.curveBasisOpen=function(k){return new vn(k)};e.curveBumpX=
...
function(k){return new mg(k,1)};e.curveStepBefore=function(k){return new mg(k,0)};e.descending=function(k,A){return A<k?-1:A>k?1:A>=k?0:NaN};e.deviation=ka;e.difference=function(k,A){for(var G=[],E=1;E<arguments.length;++E)G[E-1]=arguments[E];k=new Set(k);G=$jscomp.makeIterator(G);for(E=G.next();!E.done;E=G.next()){E=$jscomp.makeIterator(E.value);for(var H=E.next();!H.done;H=E.next())k.delete(H.value)}return k};e.disjoint=function(k,A){var G=A[Symbol.iterator]();A=new Set;var E={};k=$jscomp.makeIterator(k);
...
e.dispatch=Xc;e.drag=function(){function k(la){la.on("mousedown.drag",A).filter(ra).on("touchstart.drag",H).on("touchmove.drag",K).on("touchend.drag touchcancel.drag",T).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function A(la,Ca){!va&&ba.call(this,la,Ca)&&(Ca=Q(this,da.call(this,la,Ca),la,Ca,"mouse"))&&(Ib(la.view).on("mousemove.drag",G,!0).on("mouseup.drag",E,!0),We(la.view),la.stopImmediatePropagation(),ha=!1,Z=la.clientX,ta=la.clientY,Ca("start",la))}function G(la){rd(la);
if(!ha){var Ca=la.clientX-Z,La=la.clientY-ta;ha=Ca*Ca+La*La>wa}O.mouse("drag",la)}function E(la){Ib(la.view).on("mousemove.drag mouseup.drag",null);Xe(la.view,ha);rd(la);O.mouse("end",la)}function H(la,Ca){if(ba.call(this,la,Ca)){var La=la.changedTouches,Ra=da.call(this,la,Ca),$a=La.length,Wa,mb;for(Wa=0;Wa<$a;++Wa)if(mb=Q(this,Ra,la,Ca,La[Wa].identifier,La[Wa]))la.stopImmediatePropagation(),mb("start",la,La[Wa])}}function K(la){var Ca=la.changedTouches,La=Ca.length,Ra,$a;for(Ra=0;Ra<La;++Ra)if($a=
O[Ca[Ra].identifier])rd(la),$a("drag",la,Ca[Ra])}function T(la){var Ca=la.changedTouches,La=Ca.length,Ra,$a;va&&clearTimeout(va);va=setTimeout(function(){va=null},500);for(Ra=0;Ra<La;++Ra)if($a=O[Ca[Ra].identifier])la.stopImmediatePropagation(),$a("end",la,Ca[Ra])}function Q(la,Ca,La,Ra,$a,Wa){var mb=Y.copy(),ob=Zb(Wa||La,Ca),sa;if(null!=(sa=na.call(la,new Ug("beforestart",{sourceEvent:La,target:k,identifier:$a,active:oa,x:ob[0],y:ob[1],dx:0,dy:0,dispatch:mb}),Ra))){var Oa=sa.x-ob[0]||0;var xa=sa.y-
ob[1]||0;return function gb(Fa,Ya,Va){var wb=ob;switch(Fa){case "start":O[$a]=gb;var sb=oa++;break;case "end":delete O[$a],--oa;case "drag":ob=Zb(Va||Ya,Ca),sb=oa}mb.call(Fa,la,new Ug(Fa,{sourceEvent:Ya,subject:sa,target:k,identifier:$a,active:sb,x:ob[0]+Oa,y:ob[1]+xa,dx:ob[0]-wb[0],dy:ob[1]-wb[1],dispatch:mb}),Ra)}}}var ba=uq,da=vq,na=wq,ra=xq,O={},Y=Xc("start","drag","end"),oa=0,Z,ta,ha,va,wa=0;k.filter=function(la){return arguments.length?(ba="function"===typeof la?la:og(!!la),k):ba};k.container=
function(la){return arguments.length?(da="function"===typeof la?la:og(la),k):da};k.subject=function(la){return arguments.length?(na="function"===typeof la?la:og(la),k):na};k.touchable=function(la){return arguments.length?(ra="function"===typeof la?la:og(!!la),k):ra};k.on=function(){var la=Y.on.apply(Y,arguments);return la===Y?k:la};k.clickDistance=function(la){return arguments.length?(wa=(la=+la)*la,k):Math.sqrt(wa)};return k};e.dragDisable=We;e.dragEnable=Xe;e.dsv=function(k,A,G,E){3===arguments.length&&
...
G.y=function(K){return arguments.length?(A=+K,G):A};G.strength=function(K){return arguments.length?(H=+K,G):H};return G};e.forceCollide=function(k){function A(){function da(wa,la,Ca,La,Ra){var $a=wa.data;wa=wa.r;var Wa=ta+wa;if($a)$a.index>Y.index&&(la=oa-$a.x-$a.vx,Ca=Z-$a.y-$a.vy,La=la*la+Ca*Ca,La<Wa*Wa&&(0===la&&(la=1E-6*(T()-.5),La+=la*la),0===Ca&&(Ca=1E-6*(T()-.5),La+=Ca*Ca),La=(Wa-(La=Math.sqrt(La)))/La*Q,Y.vx+=(la*=La)*(Wa=(wa*=wa)/(ha+wa)),Y.vy+=(Ca*=La)*Wa,$a.vx-=la*(Wa=1-Wa),$a.vy-=Ca*Wa));
else return la>oa+Wa||La<oa-Wa||Ca>Z+Wa||Ra<Z-Wa}for(var na,ra=H.length,O,Y,oa,Z,ta,ha,va=0;va<ba;++va)for(O=rf(H,ds,es).visitAfter(G),na=0;na<ra;++na)Y=H[na],ta=K[Y.index],ha=ta*ta,oa=Y.x+Y.vx,Z=Y.y+Y.vy,O.visit(da)}function G(da){if(da.data)return da.r=K[da.data.index];for(var na=da.r=0;4>na;++na)da[na]&&da[na].r>da.r&&(da.r=da[na].r)}function E(){if(H){var da,na=H.length;K=Array(na);for(da=0;da<na;++da){var ra=H[da];K[ra.index]=+k(ra,da,H)}}}var H,K,T,Q=1,ba=1;"function"!==typeof k&&(k=xb(null==
k?1:+k));A.initialize=function(da,na){H=da;T=na;E()};A.iterations=function(da){return arguments.length?(ba=+da,A):ba};A.strength=function(da){return arguments.length?(Q=+da,A):Q};A.radius=function(da){return arguments.length?(k="function"===typeof da?da:xb(+da),E(),A):k};return A};e.forceLink=function(k){function A(Z){for(var ta=0,ha=k.length;ta<oa;++ta)for(var va=0,wa,la,Ca,La,Ra;va<ha;++va)wa=k[va],la=wa.source,wa=wa.target,Ca=wa.x+wa.vx-la.x-la.vx||1E-6*(Y()-.5),La=wa.y+wa.vy-la.y-la.vy||1E-6*
(Y()-.5),Ra=Math.sqrt(Ca*Ca+La*La),Ra=(Ra-da[va])/Ra*Z*Q[va],Ca*=Ra,La*=Ra,wa.vx-=Ca*(Ra=O[va]),wa.vy-=La*Ra,la.vx+=Ca*(Ra=1-Ra),la.vy+=La*Ra}function G(){if(na){var Z=na.length,ta=k.length,ha=new Map(na.map(function(wa,la){return[K(wa,la,na),wa]}));var va=0;for(ra=Array(Z);va<ta;++va)Z=k[va],Z.index=va,"object"!==typeof Z.source&&(Z.source=Mk(ha,Z.source)),"object"!==typeof Z.target&&(Z.target=Mk(ha,Z.target)),ra[Z.source.index]=(ra[Z.source.index]||0)+1,ra[Z.target.index]=(ra[Z.target.index]||0)+
1;va=0;for(O=Array(ta);va<ta;++va)Z=k[va],O[va]=ra[Z.source.index]/(ra[Z.source.index]+ra[Z.target.index]);Q=Array(ta);E();da=Array(ta);H()}}function E(){if(na)for(var Z=0,ta=k.length;Z<ta;++Z)Q[Z]=+T(k[Z],Z,k)}function H(){if(na)for(var Z=0,ta=k.length;Z<ta;++Z)da[Z]=+ba(k[Z],Z,k)}var K=fs,T=function(Z){return 1/Math.min(ra[Z.source.index],ra[Z.target.index])},Q,ba=xb(30),da,na,ra,O,Y,oa=1;null==k&&(k=[]);A.initialize=function(Z,ta){na=Z;Y=ta;G()};A.links=function(Z){return arguments.length?(k=Z,
G(),A):k};A.id=function(Z){return arguments.length?(K=Z,A):K};A.iterations=function(Z){return arguments.length?(oa=+Z,A):oa};A.strength=function(Z){return arguments.length?(T="function"===typeof Z?Z:xb(+Z),E(),A):T};A.distance=function(Z){return arguments.length?(ba="function"===typeof Z?Z:xb(+Z),H(),A):ba};return A};e.forceManyBody=function(){function k(Y){var oa=H.length,Z=rf(H,hs,is).visitAfter(G);Q=Y;for(Y=0;Y<oa;++Y)K=H[Y],Z.visit(E)}function A(){if(H){var Y,oa=H.length;da=Array(oa);for(Y=0;Y<
oa;++Y){var Z=H[Y];da[Z.index]=+ba(Z,Y,H)}}}function G(Y){var oa=0,Z,ta,ha=0,va,wa,la;if(Y.length){for(va=wa=la=0;4>la;++la)(Z=Y[la])&&(ta=Math.abs(Z.value))&&(oa+=Z.value,ha+=ta,va+=ta*Z.x,wa+=ta*Z.y);Y.x=va/ha;Y.y=wa/ha}else{Z=Y;Z.x=Z.data.x;Z.y=Z.data.y;do oa+=da[Z.data.index];while(Z=Z.next)}Y.value=oa}function E(Y,oa,Z,ta){if(!Y.value)return!0;Z=Y.x-K.x;var ha=Y.y-K.y;oa=ta-oa;ta=Z*Z+ha*ha;if(oa*oa/O<ta)return ta<ra&&(0===Z&&(Z=1E-6*(T()-.5),ta+=Z*Z),0===ha&&(ha=1E-6*(T()-.5),ta+=ha*ha),ta<na&&
(ta=Math.sqrt(na*ta)),K.vx+=Z*Y.value*Q/ta,K.vy+=ha*Y.value*Q/ta),!0;if(!(Y.length||ta>=ra)){if(Y.data!==K||Y.next)0===Z&&(Z=1E-6*(T()-.5),ta+=Z*Z),0===ha&&(ha=1E-6*(T()-.5),ta+=ha*ha),ta<na&&(ta=Math.sqrt(na*ta));do Y.data!==K&&(oa=da[Y.data.index]*Q/ta,K.vx+=Z*oa,K.vy+=ha*oa);while(Y=Y.next)}}var H,K,T,Q,ba=xb(-30),da,na=1,ra=Infinity,O=.81;k.initialize=function(Y,oa){H=Y;T=oa;A()};k.strength=function(Y){return arguments.length?(ba="function"===typeof Y?Y:xb(+Y),A(),k):ba};k.distanceMin=function(Y){return arguments.length?
(na=Y*Y,k):Math.sqrt(na)};k.distanceMax=function(Y){return arguments.length?(ra=Y*Y,k):Math.sqrt(ra)};k.theta=function(Y){return arguments.length?(O=Y*Y,k):Math.sqrt(O)};return k};e.forceRadial=function(k,A,G){function E(da){for(var na=0,ra=K.length;na<ra;++na){var O=K[na],Y=O.x-A||1E-6,oa=O.y-G||1E-6,Z=Math.sqrt(Y*Y+oa*oa);Z=(ba[na]-Z)*Q[na]*da/Z;O.vx+=Y*Z;O.vy+=oa*Z}}function H(){if(K){var da,na=K.length;Q=Array(na);ba=Array(na);for(da=0;da<na;++da)ba[da]=+k(K[da],da,K),Q[da]=isNaN(ba[da])?0:+T(K[da],
da,K)}}var K,T=xb(.1),Q,ba;"function"!==typeof k&&(k=xb(+k));null==A&&(A=0);null==G&&(G=0);E.initialize=function(da){K=da;H()};E.strength=function(da){return arguments.length?(T="function"===typeof da?da:xb(+da),H(),E):T};E.radius=function(da){return arguments.length?(k="function"===typeof da?da:xb(+da),H(),E):k};E.x=function(da){return arguments.length?(A=+da,E):A};E.y=function(da){return arguments.length?(G=+da,E):G};return E};e.forceSimulation=function(k){function A(){G();Y.call("tick",K);T<Q&&
(O.stop(),Y.call("end",K))}function G(Z){var ta,ha=k.length;void 0===Z&&(Z=1);for(var va=0;va<Z;++va)for(T+=(da-T)*ba,ra.forEach(function(la){la(T)}),ta=0;ta<ha;++ta){var wa=k[ta];null==wa.fx?wa.x+=wa.vx*=na:(wa.x=wa.fx,wa.vx=0);null==wa.fy?wa.y+=wa.vy*=na:(wa.y=wa.fy,wa.vy=0)}return K}function E(){for(var Z=0,ta=k.length,ha;Z<ta;++Z){ha=k[Z];ha.index=Z;null!=ha.fx&&(ha.x=ha.fx);null!=ha.fy&&(ha.y=ha.fy);if(isNaN(ha.x)||isNaN(ha.y)){var va=10*Math.sqrt(.5+Z),wa=Z*Hv;ha.x=va*Math.cos(wa);ha.y=va*Math.sin(wa)}if(isNaN(ha.vx)||
isNaN(ha.vy))ha.vx=ha.vy=0}}function H(Z){Z.initialize&&Z.initialize(k,oa);return Z}var K,T=1,Q=.001,ba=1-Math.pow(Q,1/300),da=0,na=.6,ra=new Map,O=ff(A),Y=Xc("tick","end"),oa=gs();null==k&&(k=[]);E();return K={tick:G,restart:function(){return O.restart(A),K},stop:function(){return O.stop(),K},nodes:function(Z){return arguments.length?(k=Z,E(),ra.forEach(H),K):k},alpha:function(Z){return arguments.length?(T=+Z,K):T},alphaMin:function(Z){return arguments.length?(Q=+Z,K):Q},alphaDecay:function(Z){return arguments.length?
(ba=+Z,K):+ba},alphaTarget:function(Z){return arguments.length?(da=+Z,K):da},velocityDecay:function(Z){return arguments.length?(na=1-Z,K):1-na},randomSource:function(Z){return arguments.length?(oa=Z,ra.forEach(H),K):oa},force:function(Z,ta){return 1<arguments.length?(null==ta?ra.delete(Z):ra.set(Z,H(ta)),K):ra.get(Z)},find:function(Z,ta,ha){var va,wa=k.length;ha=null==ha?Infinity:ha*ha;for(va=0;va<wa;++va){var la=k[va];var Ca=Z-la.x;var La=ta-la.y;Ca=Ca*Ca+La*La;if(Ca<ha){var Ra=la;ha=Ca}}return Ra},
on:function(Z,ta){return 1<arguments.length?(Y.on(Z,ta),K):Y.on(Z)}}};e.forceX=function(k){function A(Q){for(var ba=0,da=H.length,na;ba<da;++ba)na=H[ba],na.vx+=(T[ba]-na.x)*K[ba]*Q}function G(){if(H){var Q,ba=H.length;K=Array(ba);T=Array(ba);for(Q=0;Q<ba;++Q)K[Q]=isNaN(T[Q]=+k(H[Q],Q,H))?0:+E(H[Q],Q,H)}}var E=xb(.1),H,K,T;"function"!==typeof k&&(k=xb(null==k?0:+k));A.initialize=function(Q){H=Q;G()};A.strength=function(Q){return arguments.length?(E="function"===typeof Q?Q:xb(+Q),G(),A):E};A.x=function(Q){return arguments.length?
...
(k="function"===typeof Q?Q:xb(+Q),G(),A):k};return A};e.formatDefaultLocale=Uk;e.formatLocale=Pk;e.formatSpecifier=ne;e.fsum=function(k,A){var G=new ub;if(void 0===A){k=$jscomp.makeIterator(k);for(var E=k.next();!E.done;E=k.next())A=E.value,(A=+A)&&G.add(A)}else{var H=-1,K=$jscomp.makeIterator(k);for(E=K.next();!E.done;E=K.next())E=E.value,(E=+A(E,++H,k))&&G.add(E)}return+G};e.geoAlbers=cm;e.geoAlbersUsa=function(){function k(O){var Y=O[0];O=O[1];return na=null,(K.point(Y,O),na)||(Q.point(Y,O),na)||
(da.point(Y,O),na)}function A(){G=E=null;return k}var G,E,H=cm(),K,T=Tf().rotate([154,0]).center([-2,58.5]).parallels([55,65]),Q,ba=Tf().rotate([157,0]).center([-3,19.9]).parallels([8,18]),da,na,ra={point:function(O,Y){na=[O,Y]}};k.invert=function(O){var Y=H.scale(),oa=H.translate(),Z=(O[0]-oa[0])/Y;Y=(O[1]-oa[1])/Y;return(.12<=Y&&.234>Y&&-.425<=Z&&-.214>Z?T:.166<=Y&&.234>Y&&-.214<=Z&&-.115>Z?ba:H).invert(O)};k.stream=function(O){return G&&E===O?G:G=Ts([H.stream(E=O),T.stream(O),ba.stream(O)])};k.precision=
function(O){if(!arguments.length)return H.precision();H.precision(O);T.precision(O);ba.precision(O);return A()};k.scale=function(O){if(!arguments.length)return H.scale();H.scale(O);T.scale(.35*O);ba.scale(O);return k.translate(H.translate())};k.translate=function(O){if(!arguments.length)return H.translate();var Y=H.scale(),oa=+O[0],Z=+O[1];K=H.translate(O).clipExtent([[oa-.455*Y,Z-.238*Y],[oa+.455*Y,Z+.238*Y]]).stream(ra);Q=T.translate([oa-.307*Y,Z+.201*Y]).clipExtent([[oa-.425*Y+1E-6,Z+.12*Y+1E-6],
[oa-.214*Y-1E-6,Z+.234*Y-1E-6]]).stream(ra);da=ba.translate([oa-.205*Y,Z+.212*Y]).clipExtent([[oa-.214*Y+1E-6,Z+.166*Y+1E-6],[oa-.115*Y-1E-6,Z+.234*Y-1E-6]]).stream(ra);return A()};k.fitExtent=function(O,Y){return Hd(k,O,Y)};k.fitSize=function(O,Y){return Hd(k,[[0,0],O],Y)};k.fitWidth=function(O,Y){return bi(k,O,Y)};k.fitHeight=function(O,Y){return ci(k,O,Y)};return k.scale(1070)};e.geoArea=function(k){sg=new ub;lc(k,tc);return 2*sg};e.geoAzimuthalEqualArea=function(){return wc(Zi).scale(124.75).clipAngle(179.999)};
e.geoAzimuthalEqualAreaRaw=Zi;e.geoAzimuthalEquidistant=function(){return wc($i).scale(79.4188).clipAngle(179.999)};e.geoAzimuthalEquidistantRaw=$i;e.geoBounds=function(k){var A,G,E;$b=rb=-(qb=Yb=Infinity);Qc=[];lc(k,Dc);if(A=Qc.length){Qc.sort(rs);k=1;var H=Qc[0];for(G=[H];k<A;++k){var K=Qc[k];ll(H,K[0])||ll(H,K[1])?(ac(H[0],K[1])>ac(H[0],H[1])&&(H[1]=K[1]),ac(K[0],H[1])>ac(H[0],H[1])&&(H[0]=K[0])):G.push(H=K)}var T=-Infinity;A=G.length-1;k=0;for(H=G[A];k<=A;H=K,++k)K=G[k],(E=ac(H[1],K[0]))>T&&(T=
E,qb=K[0],rb=H[1])}Qc=Cc=null;return Infinity===qb||Infinity===Yb?[[NaN,NaN],[NaN,NaN]]:[[qb,Yb],[rb,$b]]};e.geoCentroid=function(k){qe=Ff=Cf=Df=Ef=Gf=Hf=If=0;Ih=new ub;Jh=new ub;Kh=new ub;lc(k,mc);k=+Ih;var A=+Jh,G=+Kh,E=Hh(k,A,G);return 1E-12>E&&(k=Gf,A=Hf,G=If,1E-6>Ff&&(k=Cf,A=Df,G=Ef),E=Hh(k,A,G),1E-12>E)?[NaN,NaN]:[Qb(A,k)*jb,Pb(G/E)*jb]};e.geoCircle=function(){function k(){var Q=A.apply(this,arguments),ba=G.apply(this,arguments)*Ta,da=E.apply(this,arguments)*Ta;H=[];K=Nh(-Q[0]*Ta,-Q[1]*Ta,0).invert;
...
gm;e.geoContains=function(k,A){return(k&&ao.hasOwnProperty(k.type)?ao[k.type]:Of)(k,A)};e.geoDistance=re;e.geoEqualEarth=function(){return wc(hi).scale(177.158)};e.geoEqualEarthRaw=hi;e.geoEquirectangular=function(){return wc(Be).scale(152.63)};e.geoEquirectangularRaw=Be;e.geoGnomonic=function(){return wc(ii).scale(144.049).clipAngle(60)};e.geoGnomonicRaw=ii;e.geoGraticule=Kl;e.geoGraticule10=function(){return Kl()()};e.geoIdentity=function(){function k(){oa=G*K;Z=G*T;va=wa=null;return A}function A(la){var Ca=
la[0]*oa;la=la[1]*Z;if(Q){var La=la*ba-Ca*da;Ca=Ca*ba+la*da;la=La}return[Ca+E,la+H]}var G=1,E=0,H=0,K=1,T=1,Q=0,ba,da,na=null,ra,O,Y,oa=1,Z=1,ta=xe({point:function(la,Ca){la=A([la,Ca]);this.stream.point(la[0],la[1])}}),ha=ye,va,wa;A.invert=function(la){var Ca=la[0]-E;la=la[1]-H;if(Q){var La=la*ba+Ca*da;Ca=Ca*ba-la*da;la=La}return[Ca/oa,la/Z]};A.stream=function(la){return va&&wa===la?va:va=ta(ha(wa=la))};A.postclip=function(la){return arguments.length?(ha=la,na=ra=O=Y=null,k()):ha};A.clipExtent=function(la){return arguments.length?
(ha=null==la?(na=ra=O=Y=null,ye):Lf(na=+la[0][0],ra=+la[0][1],O=+la[1][0],Y=+la[1][1]),k()):null==na?null:[[na,ra],[O,Y]]};A.scale=function(la){return arguments.length?(G=+la,k()):G};A.translate=function(la){return arguments.length?(E=+la[0],H=+la[1],k()):[E,H]};A.angle=function(la){return arguments.length?(Q=la%360*Ta,da=Ma(Q),ba=Qa(Q),k()):Q*jb};A.reflectX=function(la){return arguments.length?(K=la?-1:1,k()):0>K};A.reflectY=function(la){return arguments.length?(T=la?-1:1,k()):0>T};A.fitExtent=function(la,
Ca){return Hd(A,la,Ca)};A.fitSize=function(la,Ca){return Hd(A,[[0,0],la],Ca)};A.fitWidth=function(la,Ca){return bi(A,la,Ca)};A.fitHeight=function(la,Ca){return ci(A,la,Ca)};return A};e.geoInterpolate=function(k,A){var G=k[0]*Ta,E=k[1]*Ta;k=A[0]*Ta;A=A[1]*Ta;var H=Qa(E),K=Ma(E),T=Qa(A),Q=Ma(A),ba=H*Qa(G),da=H*Ma(G),na=T*Qa(k),ra=T*Ma(k),O=2*Pb(Cb(Zk(A-E)+H*T*Zk(k-G))),Y=Ma(O);k=O?function(oa){var Z=Ma(oa*=O)/Y,ta=Ma(O-oa)/Y;oa=ta*ba+Z*na;var ha=ta*da+Z*ra;Z=ta*K+Z*Q;return[Qb(ha,oa)*jb,Qb(Z,Cb(oa*
oa+ha*ha))*jb]}:function(){return[G*jb,E*jb]};k.distance=O;return k};e.geoLength=Dl;e.geoMercator=function(){return em(Ae).scale(961/Ub)};e.geoMercatorRaw=Ae;e.geoNaturalEarth1=function(){return wc(ji).scale(175.295)};e.geoNaturalEarth1Raw=ji;e.geoOrthographic=function(){return wc(ki).scale(249.5).clipAngle(90.000001)};e.geoOrthographicRaw=ki;e.geoPath=function(k,A){function G(T){T&&("function"===typeof E&&K.pointRadius(+E.apply(this,arguments)),lc(T,H(K)));return K.result()}var E=4.5,H,K;G.area=
function(T){lc(T,H(Ec));return Ec.result()};G.measure=function(T){lc(T,H(ue));return ue.result()};G.bounds=function(T){lc(T,H(Sf));return Sf.result()};G.centroid=function(T){lc(T,H(ec));return ec.result()};G.projection=function(T){return arguments.length?(H=null==T?(k=null,ye):(k=T).stream,G):k};G.context=function(T){if(!arguments.length)return A;K=null==T?(A=null,new Xl):new Tl(A=T);"function"!==typeof E&&K.pointRadius(E);return G};G.pointRadius=function(T){if(!arguments.length)return E;E="function"===
typeof T?T:(K.pointRadius(+T),+T);return G};return G.projection(k).context(A)};e.geoProjection=wc;e.geoProjectionMutator=di;e.geoRotation=ul;e.geoStereographic=function(){return wc(li).scale(250).clipAngle(142)};e.geoStereographicRaw=li;e.geoStream=lc;e.geoTransform=function(k){return{stream:xe(k)}};e.geoTransverseMercator=function(){var k=em(mi),A=k.center,G=k.rotate;k.center=function(E){return arguments.length?A([-E[1],E[0]]):(E=A(),[E[1],-E[0]])};k.rotate=function(E){return arguments.length?G([E[0],
E[1],2<E.length?E[2]+90:90]):(E=G(),[E[0],E[1],E[2]-90])};return G([0,0,90]).scale(159.155)};e.geoTransverseMercatorRaw=mi;e.gray=function(k,A){return new ic(k,0,0,null==A?1:A)};e.greatest=function(k,A){A=void 0===A?p:A;var G=!1;if(1===A.length){k=$jscomp.makeIterator(k);for(var E=k.next();!E.done;E=k.next()){E=E.value;var H=A(E);if(G?0<p(H,T):0===p(H,H)){var K=E;var T=H;G=!0}}}else for(T=$jscomp.makeIterator(k),k=T.next();!k.done;k=T.next())if(k=k.value,G?0<A(k,K):0===A(k,k))K=k,G=!0;return K};e.greatestIndex=
function(k,A){A=void 0===A?p:A;if(1===A.length)return kj(k,A);var G=-1,E=-1;k=$jscomp.makeIterator(k);for(var H=k.next();!H.done;H=k.next())if(H=H.value,++E,0>G?0===A(H,H):0<A(H,K)){var K=H;G=E}return G};e.group=Sa;e.groupSort=function(k,A,G){return(1===A.length?tb(db(k,A,G),function(E,H){var K=$jscomp.makeIterator(E);E=K.next().value;K=K.next().value;var T=$jscomp.makeIterator(H);H=T.next().value;T=T.next().value;return p(K,T)||p(E,H)}):tb(Sa(k,G),function(E,H){var K=$jscomp.makeIterator(E);E=K.next().value;
K=K.next().value;var T=$jscomp.makeIterator(H);H=T.next().value;T=T.next().value;return A(K,T)||p(E,H)})).map(function(E){return $jscomp.makeIterator(E).next().value})};e.groups=function(k,A){for(var G=[],E=1;E<arguments.length;++E)G[E-1]=arguments[E];return ib(k,Array.from,Ga,G)};e.hcl=af;e.hierarchy=ni;e.histogram=ij;e.hsl=Ze;e.html=Fv;e.image=function(k,A){return new Promise(function(G,E){var H=new Image,K;for(K in A)H[K]=A[K];H.onerror=E;H.onload=function(){G(H)};H.src=k})};e.index=function(k,
A){for(var G=[],E=1;E<arguments.length;++E)G[E-1]=arguments[E];return ib(k,Ga,ab,G)};e.indexes=function(k,A){for(var G=[],E=1;E<arguments.length;++E)G[E-1]=arguments[E];return ib(k,Array.from,ab,G)};e.interpolate=Mc;e.interpolateArray=function(k,A){return(Wj(A)?bh:Xj)(k,A)};e.interpolateBasis=Sj;e.interpolateBasisClosed=Tj;e.interpolateBlues=Xw;e.interpolateBrBG=Cw;e.interpolateBuGn=Lw;e.interpolateBuPu=Mw;e.interpolateCividis=function(k){k=Math.max(0,Math.min(1,k));return"rgb("+Math.max(0,Math.min(255,
...
ba.y0=na;ba.x1=ra;ba.y1=O}}var G=1,E=1,H=0,K=!1;k.round=function(T){return arguments.length?(K=!!T,k):K};k.size=function(T){return arguments.length?(G=+T[0],E=+T[1],k):[G,E]};k.padding=function(T){return arguments.length?(H=+T,k):H};return k};e.path=Oc;e.permute=lb;e.pie=function(){function k(Q){var ba,da=(Q=gg(Q)).length;var na=0;var ra=Array(da),O=Array(da),Y=+H.apply(this,arguments);var oa=Math.min(Vc,Math.max(-Vc,K.apply(this,arguments)-Y));var Z=Math.min(Math.abs(oa)/da,T.apply(this,arguments)),
ta=Z*(0>oa?-1:1),ha;for(ba=0;ba<da;++ba)0<(ha=O[ra[ba]=ba]=+A(Q[ba],ba,Q))&&(na+=ha);null!=G?ra.sort(function(wa,la){return G(O[wa],O[la])}):null!=E&&ra.sort(function(wa,la){return E(Q[wa],Q[la])});ba=0;for(oa=na?(oa-da*ta)/na:0;ba<da;++ba,Y=va){na=ra[ba];ha=O[na];var va=Y+(0<ha?ha*oa:0)+ta;O[na]={data:Q[na],index:ba,value:ha,startAngle:Y,endAngle:va,padAngle:Z}}return O}var A=Fu,G=Eu,E=null,H=Xa(0),K=Xa(Vc),T=Xa(0);k.value=function(Q){return arguments.length?(A="function"===typeof Q?Q:Xa(+Q),k):
A};k.sortValues=function(Q){return arguments.length?(G=Q,E=null,k):G};k.sort=function(Q){return arguments.length?(E=Q,G=null,k):E};k.startAngle=function(Q){return arguments.length?(H="function"===typeof Q?Q:Xa(+Q),k):H};k.endAngle=function(Q){return arguments.length?(K="function"===typeof Q?Q:Xa(+Q),k):K};k.padAngle=function(Q){return arguments.length?(T="function"===typeof Q?Q:Xa(+Q),k):T};return k};e.piecewise=hk;e.pointRadial=Le;e.pointer=Zb;e.pointers=function(k,A){k.target&&(k=Aj(k),void 0===
A&&(A=k.currentTarget),k=k.touches||[k]);return Array.from(k,function(G){return Zb(G,A)})};e.polygonArea=function(k){for(var A=-1,G=k.length,E,H=k[G-1],K=0;++A<G;)E=H,H=k[A],K+=E[1]*H[0]-E[0]*H[1];return K/2};e.polygonCentroid=function(k){for(var A=-1,G=k.length,E=0,H=0,K,T=k[G-1],Q,ba=0;++A<G;)K=T,T=k[A],ba+=Q=K[0]*T[1]-T[0]*K[1],E+=(K[0]+T[0])*Q,H+=(K[1]+T[1])*Q;return ba*=3,[E/ba,H/ba]};e.polygonContains=function(k,A){var G=k.length,E=k[G-1],H=A[0];A=A[1];for(var K=E[0],T=E[1],Q,ba=!1,da=0;da<
...
var Q=T.done;G=T.value;if(Q)return;++K}for(;function(){var ba=E.next();Q=ba.done;H=ba.value;return ba}(),!Q;)G=A(G,H,++K,k);return G};e.reverse=function(k){if("function"!==typeof k[Symbol.iterator])throw new TypeError("values is not iterable");return Array.from(k).reverse()};e.rgb=td;e.ribbon=function(){return Bk()};e.ribbonArrow=function(){return Bk(Kr)};e.rollup=db;e.rollups=function(k,A,G){for(var E=[],H=2;H<arguments.length;++H)E[H-2]=arguments[H];return ib(k,Array.from,A,E)};e.scaleBand=ui;e.scaleDiverging=
...
ra=na[E][1]||0;na=(ra-(na[E-1][1]||0))/2;for(var O=0;O<Q;++O){var Y=k[A[O]];na+=(Y[E][1]||0)-(Y[E-1][1]||0)}ba+=ra;da+=na*ra}H[E-1][1]+=H[E-1][0]=G;ba&&(G-=da/ba)}H[E-1][1]+=H[E-1][0]=G;Ud(k,A)}};e.stackOrderAppearance=Hn;e.stackOrderAscending=In;e.stackOrderDescending=function(k){return In(k).reverse()};e.stackOrderInsideOut=function(k){var A=k.length,G=k.map(Jn),E=Hn(k),H=0,K=0,T=[],Q=[];for(k=0;k<A;++k){var ba=E[k];H<K?(H+=G[ba],T.push(ba)):(K+=G[ba],Q.push(ba))}return Q.reverse().concat(T)};e.stackOrderNone=
...
var O=na}if(!O)throw Error("no root");O.parent=Iv;O.eachBefore(function(Y){Y.depth=Y.parent.depth+1;--K}).eachBefore(im);O.parent=null;if(0<K)throw Error("cycle");return O}var A=dt,G=et;k.id=function(E){return arguments.length?(A=Yf(E),k):A};k.parentId=function(E){return arguments.length?(G=Yf(E),k):G};return k};e.style=Yc;e.subset=function(k,A){return qj(A,k)};e.sum=function(k,A){var G=0;if(void 0===A){k=$jscomp.makeIterator(k);for(var E=k.next();!E.done;E=k.next())if(A=E.value,A=+A)G+=A}else{var H=
...
typeof H?H:Xa(+H),G):A};G.context=function(H){return arguments.length?(E=null==H?null:H,G):E};return G};e.symbolCircle=dj;e.symbolCross=dp;e.symbolDiamond=fp;e.symbolSquare=ip;e.symbolStar=hp;e.symbolTriangle=jp;e.symbolWye=kp;e.symbols=px;e.text=qf;e.thresholdFreedmanDiaconis=function(k,A,G){return Math.ceil((G-A)/(2*(ae(k,.75)-ae(k,.25))*Math.pow(N(k),-1/3)))};e.thresholdScott=function(k,A,G){return Math.ceil((G-A)/(3.5*ka(k)*Math.pow(N(k),-1/3)))};e.thresholdSturges=Ig;e.tickFormat=xm;e.tickIncrement=
Ab;e.tickStep=nc;e.ticks=Wb;e.timeDay=Pd;e.timeDays=Xv;e.timeFormatDefaultLocale=en;e.timeFormatLocale=Qm;e.timeFriday=oo;e.timeFridays=bw;e.timeHour=wg;e.timeHours=Wv;e.timeInterval=zb;e.timeMillisecond=Nd;e.timeMilliseconds=ko;e.timeMinute=vg;e.timeMinutes=Vv;e.timeMonday=He;e.timeMondays=Yv;e.timeMonth=xg;e.timeMonths=dw;e.timeSaturday=po;e.timeSaturdays=cw;e.timeSecond=Gc;e.timeSeconds=lo;e.timeSunday=Qd;e.timeSundays=qo;e.timeThursday=jd;e.timeThursdays=aw;e.timeTickInterval=Bo;e.timeTicks=Ao;
e.timeTuesday=mo;e.timeTuesdays=Zv;e.timeWednesday=no;e.timeWednesdays=$v;e.timeWeek=Qd;e.timeWeeks=qo;e.timeYear=xc;e.timeYears=ew;e.timeout=gh;e.timer=ff;e.timerFlush=jk;e.transition=nk;e.transpose=pj;e.tree=function(){function k(ba){var da=gt(ba);da.eachAfter(A);da.parent.m=-da.z;da.eachBefore(G);if(Q)ba.eachBefore(E);else{var na=ba,ra=ba,O=ba;ba.eachBefore(function(ta){ta.x<na.x&&(na=ta);ta.x>ra.x&&(ra=ta);ta.depth>O.depth&&(O=ta)});da=na===ra?1:H(na,ra)/2;var Y=da-na.x,oa=K/(ra.x+da+Y),Z=T/(O.depth||
1);ba.eachBefore(function(ta){ta.x=(ta.x+Y)*oa;ta.y=ta.depth*Z})}return ba}function A(ba){var da=ba.children,na=ba.parent.children,ra=ba.i?na[ba.i-1]:null;if(da){for(var O=0,Y=0,oa=ba.children,Z=oa.length,ta;0<=--Z;)ta=oa[Z],ta.z+=O,ta.m+=O,O+=ta.s+(Y+=ta.c);da=(da[0].z+da[da.length-1].z)/2;ra?(ba.z=ra.z+H(ba._,ra._),ba.m=ba.z-da):ba.z=da}else ra&&(ba.z=ra.z+H(ba._,ra._));da=ba.parent;na=ba.parent.A||na[0];if(ra){Y=O=ba;oa=O.parent.children[0];Z=O.m;ta=Y.m;for(var ha=ra.m,va=oa.m,wa;ra=ri(ra),O=qi(O),
ra&&O;){oa=qi(oa);Y=ri(Y);Y.a=ba;wa=ra.z+ha-O.z-Z+H(ra._,O._);if(0<wa){var la=ra.a.parent===ba.parent?ra.a:na,Ca=ba,La=wa,Ra=La/(Ca.i-la.i);Ca.c-=Ra;Ca.s+=La;la.c+=Ra;Ca.z+=La;Ca.m+=La;Z+=wa;ta+=wa}ha+=ra.m;Z+=O.m;va+=oa.m;ta+=Y.m}ra&&!ri(Y)&&(Y.t=ra,Y.m+=ha-ta);O&&!qi(oa)&&(oa.t=O,oa.m+=Z-va,na=ba)}da.A=na}function G(ba){ba._.x=ba.z+ba.parent.m;ba.m+=ba.parent.m}function E(ba){ba.x*=K;ba.y=ba.depth*T}var H=ft,K=1,T=1,Q=null;k.separation=function(ba){return arguments.length?(H=ba,k):H};k.size=function(ba){return arguments.length?
(Q=!1,K=+ba[0],T=+ba[1],k):Q?null:[K,T]};k.nodeSize=function(ba){return arguments.length?(Q=!0,K=+ba[0],T=+ba[1],k):Q?[K,T]:null};return k};e.treemap=function(){function k(O){O.x0=O.y0=0;O.x1=H;O.y1=K;O.eachBefore(A);T=[0];E&&O.eachBefore(sm);return O}function A(O){var Y=T[O.depth],oa=O.x0+Y,Z=O.y0+Y,ta=O.x1-Y,ha=O.y1-Y;ta<oa&&(oa=ta=(oa+ta)/2);ha<Z&&(Z=ha=(Z+ha)/2);O.x0=oa;O.y0=Z;O.x1=ta;O.y1=ha;O.children&&(Y=T[O.depth+1]=Q(O)/2,oa+=ra(O)-Y,Z+=ba(O)-Y,ta-=da(O)-Y,ha-=na(O)-Y,ta<oa&&(oa=ta=(oa+ta)/
2),ha<Z&&(Z=ha=(Z+ha)/2),G(O,oa,Z,ta,ha))}var G=eo,E=!1,H=1,K=1,T=[0],Q=gd,ba=gd,da=gd,na=gd,ra=gd;k.round=function(O){return arguments.length?(E=!!O,k):E};k.size=function(O){return arguments.length?(H=+O[0],K=+O[1],k):[H,K]};k.tile=function(O){return arguments.length?(G=Yf(O),k):G};k.padding=function(O){return arguments.length?k.paddingInner(O).paddingOuter(O):k.paddingInner()};k.paddingInner=function(O){return arguments.length?(Q="function"===typeof O?O:Ld(+O),k):Q};k.paddingOuter=function(O){return arguments.length?
...
O,Y,oa,Z,ta,ha){if(ra>=O-1)ra=T[ra],ra.x0=oa,ra.y0=Z,ra.x1=ta,ra.y1=ha;else{for(var va=na[ra],wa=Y/2+va,la=ra+1,Ca=O-1;la<Ca;){var La=la+Ca>>>1;na[La]<wa?la=La+1:Ca=La}wa-na[la-1]<na[la]-wa&&ra+1<la&&--la;va=na[la]-va;wa=Y-va;ta-oa>ha-Z?(Y=Y?(oa*wa+ta*va)/Y:ta,K(ra,la,va,oa,Z,Y,ha),K(la,O,wa,Y,Z,ta,ha)):(Y=Y?(Z*wa+ha*va)/Y:ha,K(ra,la,va,oa,Z,ta,Y),K(la,O,wa,oa,Y,ta,ha))}}var T=k.children,Q,ba=T.length,da,na=Array(ba+1);for(na[0]=da=Q=0;Q<ba;++Q)na[Q+1]=da+=T[Q].value;K(0,ba,k.value,A,G,E,H)};e.treemapDice=
...
pw;e.variance=X;e.version="6.7.0";e.window=Qg;e.xml=Ev;e.zip=function(){return pj(arguments)};e.zoom=function(){function k(sa){sa.property("__zoom",Ln).on("wheel.zoom",Q).on("mousedown.zoom",ba).on("dblclick.zoom",da).filter(ha).on("touchstart.zoom",na).on("touchmove.zoom",ra).on("touchend.zoom touchcancel.zoom",O).style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function A(sa,Oa){Oa=Math.max(va[0],Math.min(va[1],Oa));return Oa===sa.k?sa:new Hc(Oa,sa.x,sa.y)}function G(sa,Oa,xa){var Ja=Oa[0]-
xa[0]*sa.k;Oa=Oa[1]-xa[1]*sa.k;return Ja===sa.x&&Oa===sa.y?sa:new Hc(sa.k,Ja,Oa)}function E(sa){return[(+sa[0][0]+ +sa[1][0])/2,(+sa[0][1]+ +sa[1][1])/2]}function H(sa,Oa,xa,Ja){sa.on("start.zoom",function(){K(this,arguments).event(Ja).start()}).on("interrupt.zoom end.zoom",function(){K(this,arguments).event(Ja).end()}).tween("zoom",function(){var Fa=arguments,Ya=K(this,Fa).event(Ja),Va=oa.apply(this,Fa),gb=null==xa?E(Va):"function"===typeof xa?xa.apply(this,Fa):xa,wb=Math.max(Va[1][0]-Va[0][0],Va[1][1]-
Va[0][1]);Va=this.__zoom;var sb="function"===typeof Oa?Oa.apply(this,Fa):Oa,Eg=Ca(Va.invert(gb).concat(wb/Va.k),sb.invert(gb).concat(wb/sb.k));return function(hc){if(1===hc)hc=sb;else{hc=Eg(hc);var gj=wb/hc[2];hc=new Hc(gj,gb[0]-hc[0]*gj,gb[1]-hc[1]*gj)}Ya.zoom(null,hc)}})}function K(sa,Oa,xa){return!xa&&sa.__zooming||new T(sa,Oa)}function T(sa,Oa){this.that=sa;this.args=Oa;this.active=0;this.sourceEvent=null;this.extent=oa.apply(sa,Oa);this.taps=0}function Q(sa,Oa){for(var xa=[],Ja=1;Ja<arguments.length;++Ja)xa[Ja-
1]=arguments[Ja];if(Y.apply(this,arguments)){var Fa=K(this,xa).event(sa);xa=this.__zoom;Ja=Math.max(va[0],Math.min(va[1],xa.k*Math.pow(2,ta.apply(this,arguments))));var Ya=Zb(sa);if(Fa.wheel){if(Fa.mouse[0][0]!==Ya[0]||Fa.mouse[0][1]!==Ya[1])Fa.mouse[1]=xa.invert(Fa.mouse[0]=Ya);clearTimeout(Fa.wheel)}else{if(xa.k===Ja)return;Fa.mouse=[Ya,xa.invert(Ya)];bd(this);Fa.start()}Me(sa);Fa.wheel=setTimeout(function(){Fa.wheel=null;Fa.end()},150);Fa.zoom("mouse",Z(G(A(xa,Ja),Fa.mouse[0],Fa.mouse[1]),Fa.extent,
wa))}}function ba(sa,Oa){for(var xa=[],Ja=1;Ja<arguments.length;++Ja)xa[Ja-1]=arguments[Ja];if(!Wa&&Y.apply(this,arguments)){var Fa=K(this,xa,!0).event(sa),Ya=Ib(sa.view).on("mousemove.zoom",function(sb){Me(sb);if(!Fa.moved){var Eg=sb.clientX-gb,hc=sb.clientY-wb;Fa.moved=Eg*Eg+hc*hc>mb}Fa.event(sb).zoom("mouse",Z(G(Fa.that.__zoom,Fa.mouse[0]=Zb(sb,Va),Fa.mouse[1]),Fa.extent,wa))},!0).on("mouseup.zoom",function(sb){Ya.on("mousemove.zoom mouseup.zoom",null);Xe(sb.view,Fa.moved);Me(sb);Fa.event(sb).end()},
!0);xa=Zb(sa,Va);var Va=sa.currentTarget,gb=sa.clientX,wb=sa.clientY;We(sa.view);sa.stopImmediatePropagation();Fa.mouse=[xa,this.__zoom.invert(xa)];bd(this);Fa.start()}}function da(sa,Oa){for(var xa=[],Ja=1;Ja<arguments.length;++Ja)xa[Ja-1]=arguments[Ja];if(Y.apply(this,arguments)){var Fa=this.__zoom;Ja=Zb(sa.changedTouches?sa.changedTouches[0]:sa,this);var Ya=Fa.invert(Ja);xa=Z(G(A(Fa,Fa.k*(sa.shiftKey?.5:2)),Ja,Ya),oa.apply(this,xa),wa);Me(sa);0<la?Ib(this).transition().duration(la).call(H,xa,Ja,
sa):Ib(this).call(k.transform,xa,Ja,sa)}}function na(sa,Oa){for(var xa=[],Ja=1;Ja<arguments.length;++Ja)xa[Ja-1]=arguments[Ja];if(Y.apply(this,arguments)){Ja=sa.touches;var Fa=Ja.length;xa=K(this,xa,sa.changedTouches.length===Fa).event(sa);var Ya;sa.stopImmediatePropagation();for(Ya=0;Ya<Fa;++Ya){var Va=Ja[Ya];var gb=Zb(Va,this);gb=[gb,this.__zoom.invert(gb),Va.identifier];if(xa.touch0)xa.touch1||xa.touch0[2]===gb[2]||(xa.touch1=gb,xa.taps=0);else{xa.touch0=gb;var wb=!0;xa.taps=1+!!Ra}}Ra&&(Ra=clearTimeout(Ra));
wb&&(2>xa.taps&&($a=gb[0],Ra=setTimeout(function(){Ra=null},500)),bd(this),xa.start())}}function ra(sa,Oa){for(var xa=[],Ja=1;Ja<arguments.length;++Ja)xa[Ja-1]=arguments[Ja];if(this.__zooming){xa=K(this,xa).event(sa);var Fa=sa.changedTouches,Ya=Fa.length,Va;Me(sa);for(Va=0;Va<Ya;++Va){Ja=Fa[Va];var gb=Zb(Ja,this);xa.touch0&&xa.touch0[2]===Ja.identifier?xa.touch0[0]=gb:xa.touch1&&xa.touch1[2]===Ja.identifier&&(xa.touch1[0]=gb)}Ja=xa.that.__zoom;if(xa.touch1){gb=xa.touch0[0];Fa=xa.touch0[1];Va=xa.touch1[0];
Ya=xa.touch1[1];var wb=(wb=Va[0]-gb[0])*wb+(wb=Va[1]-gb[1])*wb;var sb=(sb=Ya[0]-Fa[0])*sb+(sb=Ya[1]-Fa[1])*sb;Ja=A(Ja,Math.sqrt(wb/sb));gb=[(gb[0]+Va[0])/2,(gb[1]+Va[1])/2];wb=[(Fa[0]+Ya[0])/2,(Fa[1]+Ya[1])/2]}else if(xa.touch0)gb=xa.touch0[0],wb=xa.touch0[1];else return;xa.zoom("touch",Z(G(Ja,gb,wb),xa.extent,wa))}}function O(sa,Oa){for(var xa=[],Ja=1;Ja<arguments.length;++Ja)xa[Ja-1]=arguments[Ja];if(this.__zooming){xa=K(this,xa).event(sa);Ja=sa.changedTouches;var Fa=Ja.length,Ya;sa.stopImmediatePropagation();
Wa&&clearTimeout(Wa);Wa=setTimeout(function(){Wa=null},500);for(Ya=0;Ya<Fa;++Ya){var Va=Ja[Ya];xa.touch0&&xa.touch0[2]===Va.identifier?delete xa.touch0:xa.touch1&&xa.touch1[2]===Va.identifier&&delete xa.touch1}xa.touch1&&!xa.touch0&&(xa.touch0=xa.touch1,delete xa.touch1);xa.touch0?xa.touch0[1]=this.__zoom.invert(xa.touch0[0]):(xa.end(),2===xa.taps&&(Va=Zb(Va,this),Math.hypot($a[0]-Va[0],$a[1]-Va[1])<ob&&(Va=Ib(this).on("dblclick.zoom"))&&Va.apply(this,arguments)))}}var Y=Qu,oa=Ru,Z=Uu,ta=Su,ha=Tu,
va=[0,Infinity],wa=[[-Infinity,-Infinity],[Infinity,Infinity]],la=250,Ca=Qn,La=Xc("start","zoom","end"),Ra,$a,Wa,mb=0,ob=10;k.transform=function(sa,Oa,xa,Ja){var Fa=sa.selection?sa.selection():sa;Fa.property("__zoom",Ln);sa!==Fa?H(sa,Oa,xa,Ja):Fa.interrupt().each(function(){K(this,arguments).event(Ja).start().zoom(null,"function"===typeof Oa?Oa.apply(this,arguments):Oa).end()})};k.scaleBy=function(sa,Oa,xa,Ja){k.scaleTo(sa,function(){var Fa=this.__zoom.k,Ya="function"===typeof Oa?Oa.apply(this,arguments):
Oa;return Fa*Ya},xa,Ja)};k.scaleTo=function(sa,Oa,xa,Ja){k.transform(sa,function(){var Fa=oa.apply(this,arguments),Ya=this.__zoom,Va=null==xa?E(Fa):"function"===typeof xa?xa.apply(this,arguments):xa,gb=Ya.invert(Va),wb="function"===typeof Oa?Oa.apply(this,arguments):Oa;return Z(G(A(Ya,wb),Va,gb),Fa,wa)},xa,Ja)};k.translateBy=function(sa,Oa,xa,Ja){k.transform(sa,function(){return Z(this.__zoom.translate("function"===typeof Oa?Oa.apply(this,arguments):Oa,"function"===typeof xa?xa.apply(this,arguments):
xa),oa.apply(this,arguments),wa)},null,Ja)};k.translateTo=function(sa,Oa,xa,Ja,Fa){k.transform(sa,function(){var Ya=oa.apply(this,arguments),Va=this.__zoom,gb=null==Ja?E(Ya):"function"===typeof Ja?Ja.apply(this,arguments):Ja;return Z(ng.translate(gb[0],gb[1]).scale(Va.k).translate("function"===typeof Oa?-Oa.apply(this,arguments):-Oa,"function"===typeof xa?-xa.apply(this,arguments):-xa),Ya,wa)},Ja,Fa)};T.prototype={event:function(sa){sa&&(this.sourceEvent=sa);return this},start:function(){1===++this.active&&
(this.that.__zooming=this,this.emit("start"));return this},zoom:function(sa,Oa){this.mouse&&"mouse"!==sa&&(this.mouse[1]=Oa.invert(this.mouse[0]));this.touch0&&"touch"!==sa&&(this.touch0[1]=Oa.invert(this.touch0[0]));this.touch1&&"touch"!==sa&&(this.touch1[1]=Oa.invert(this.touch1[0]));this.that.__zoom=Oa;this.emit("zoom");return this},end:function(){0===--this.active&&(delete this.that.__zooming,this.emit("end"));return this},emit:function(sa){var Oa=Ib(this.that).datum();La.call(sa,this.that,new Pu(sa,
{sourceEvent:this.sourceEvent,target:k,type:sa,transform:this.that.__zoom,dispatch:La}),Oa)}};k.wheelDelta=function(sa){return arguments.length?(ta="function"===typeof sa?sa:Dg(+sa),k):ta};k.filter=function(sa){return arguments.length?(Y="function"===typeof sa?sa:Dg(!!sa),k):Y};k.touchable=function(sa){return arguments.length?(ha="function"===typeof sa?sa:Dg(!!sa),k):ha};k.extent=function(sa){return arguments.length?(oa="function"===typeof sa?sa:Dg([[+sa[0][0],+sa[0][1]],[+sa[1][0],+sa[1][1]]]),k):
oa};k.scaleExtent=function(sa){return arguments.length?(va[0]=+sa[0],va[1]=+sa[1],k):[va[0],va[1]]};k.translateExtent=function(sa){return arguments.length?(wa[0][0]=+sa[0][0],wa[1][0]=+sa[1][0],wa[0][1]=+sa[0][1],wa[1][1]=+sa[1][1],k):[[wa[0][0],wa[0][1]],[wa[1][0],wa[1][1]]]};k.constrain=function(sa){return arguments.length?(Z=sa,k):Z};k.duration=function(sa){return arguments.length?(la=+sa,k):la};k.interpolate=function(sa){return arguments.length?(Ca=sa,k):Ca};k.on=function(){var sa=La.on.apply(La,
arguments);return sa===La?k:sa};k.clickDistance=function(sa){return arguments.length?(mb=(sa=+sa)*sa,k):Math.sqrt(mb)};k.tapDistance=function(sa){return arguments.length?(ob=+sa,k):ob};return k};e.zoomIdentity=ng;e.zoomTransform=Kn;Object.defineProperty(e,"__esModule",{value:!0})});var WMSVersion={version100:"1.0.0",version111:"1.1.1",version130:"1.3.0"},htmlTab="",tddjs=function(e,p){var z=!0,F=[],I=F.set=!1,ja=null,N=function(U){ca="";I&&(ja.close(),I=!1);document.getElementById("info").innerHTML=ca;if(0!=z){F.x=U.x;F.y=U.y;F.set=!0;var aa=p.getLatLongFromPixelCoord({x:U.x,y:U.y});U=p.getLayers();if(isDefined(U)){info=p.getLayers().getFeatureInfoUrl;var ca="";0==p.layers.length&&(ca="No layer: Load a valid sounding layer.",document.getElementById("info").innerHTML=ca);U=[];
for(var ea=0;ea<p.layers.length;ea++)p.layers[p.layers.length-ea-1].service.includes("TEMP")&&U.push(p.layers[p.layers.length-ea-1]);ea=null;for(var X in U)ea=U[X],null!=ea&&""!==ea.getFeatureInfoUrl?!1===ea.queryable?p.featureInfoRequestReady("Layer is not queryable.",ea):(ca='<img src="./img/ajax-loader.gif" alt="Loading..."/>',document.getElementById("info").innerHTML=ca,getJSONdata(ea,p,F.x,F.y,"text/plain",function(ka){null!=ka?null!=ka.data?(ja=window.open("sondTemp.html","Sondeo",'itemId="sond",toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=1040,height=600'),
ja.myvar=ka,I=!0,ca="Profile for location ["+Math.round(100*aa.x)/100+","+Math.round(100*aa.y)/100+"]",ca+=" - Station:"+ka.meta.name+"<br/>",document.getElementById("info").innerHTML="",document.getElementById("info").innerHTML=ca,document.getElementById("table").innerHTML="",document.getElementById("table").innerHTML=htmlTab):(ca="Profile for location ["+Math.round(100*aa.x)/100+","+Math.round(100*aa.y)/100+"]",ca+=" - Station:"+ka.meta.name+"<br/>",document.getElementById("info").innerHTML="",
document.getElementById("info").innerHTML=ca,document.getElementById("table").innerHTML="",htmlTab+="</TABLE>",document.getElementById("table").innerHTML=htmlTab,console.log(htmlTab)):(ca="No valid data",document.getElementById("info").innerHTML=ca)})):(ca="Wrong layer: Load a valid sounding layer.",document.getElementById("info").innerHTML=ca)}else $("#info").html("No valid data received:<br/>"+data)}};p.addListener("mouseclicked",N,!0);this.enable=function(){console.log("ALTO",e.document.height);
e.html('<div id="info"></div><div id="table" style="height:100px;overflow-y: auto;"></div>');$("#info").html("Click on the map to load a profile.");p.enableInlineGetFeatureInfo(!1);z=!0};this.disable=function(){z=!1;p.enableInlineGetFeatureInfo(!0);F.set=!1;I&&(ja.close(),I=!1)};this.resize=function(U,aa){$("#mitdd").width(U);F.set&&N(F)};this.enable()};try{WMJSExtApplications.Sondeo=tddjs}catch(e){}
...
function MakeHTTPRequest(e,p,z,F){function I(U){errorfunction?errorfunction(U,pointer):p(void 0,pointer)}function ja(){!1===z?(e=F+"REQUEST="+URLEncode(e),MakeHTTPRequest(e,p,errorfunction,pointer,!0,F)):I("status("+N.status+") to "+e)}e=-1===e.indexOf("?")?e+"?":e+"&";e+="rand="+Math.random();z||(z=!1);try{var N=createXHR();N.open("GET",e,!0);N.onreadystatechange=function(){if(4===N.readyState)if(200===N.status){try{var U=N.responseText}catch(aa){I("Exception occured:"+aa);return}void 0===U||""===
U?I("request returned no data"):p(null,N.response)}else window.alert("ALLI"),ja()};N.send(null)}catch(U){window.alert("AQUI"),ja()}}
function getJSONdata(e,p,z,F,I,ja){document.getElementById("info").innerHTML="Procesando<br>";document.getElementById("table").innerHTML="";var N=WMJScheckURL(e.service);N+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+e.version;N+="&LAYERS="+URLEncode(e.name);e.name.split(",");I=N;N+="&QUERY_LAYERS=p,z,t,td,windSpd,windDir,eVSS&INFO_FORMAT=application/json";I+="&QUERY_LAYERS=station_name,ps,alt,station_cname&INFO_FORMAT=application/json";var U="&"+getBBOXandProjString(e,p);U+="WIDTH="+p.width;U+=
"&HEIGHT="+p.height;if(e.version===WMSVersion.version100||e.version===WMSVersion.version111)U=U+("&X="+z)+("&Y="+F);e.version===WMSVersion.version130&&(U=U+("&I="+z)+("&J="+F));U+="&FORMAT=image/gif&STYLES=";try{U+="&"+p._getMapDimURL(e),N+=U,I+=U}catch(ca){callback(null,void 0)}debug('<a target="_blank" href="'+N+'">'+N+"</a>",!1);var aa=e.service+"&SERVICE=WMS&REQUEST=GetMetaData&VERSION="+e.version;aa+="&LAYERS="+URLEncode(e.name);aa+="&LAYER=station_name";aa+="&FORMAT=application/json";getMeta(I,
function(ca){null!=ca?getData(aa,ca,N,function(ea){ja({meta:ca,data:ea})}):(console.log("no valid data"),ja(null))})}function WMJScheckURL(e){if(!isDefined(e))return"?";e=e.trim();-1===e.indexOf("?")&&(e+="?");return e}function isDefined(e){return"undefined"===typeof e?!1:!0}
...
function getMeta(e,p){MakeHTTPRequest(e,function(z,F){if(null!=z)console.error(z);else{z=[];try{var I=JSON.parse(F),ja=I[0].point.coords;ja=ja.split(",");var N=parseFloat(ja[0]),U=parseFloat(ja[1]),aa=Object.keys(I[1].data),ca=aa.toString();ca=ca.split("T");var ea=ca[0].replaceAll("-","");ea=parseInt(ea);var X=parseInt(ca[1].substring(0,2)),ka=I[1].data[aa];if("nodata"!=ka){ka+=" "+I[5].data[aa];aa=Object.keys(I[2].data);var za=I[2].data[aa];za/=100;aa=Object.keys(I[3].data);var ya=I[3].data[aa];
ya=parseFloat(ya);isNaN(ya)&&(ya=0);z={model:"OBSERVACION",index:ka,date:ea,run:X,step:0,lon:N,lat:U,ps:za,zs:ya,name:ka};p(z)}else p(null)}catch(ua){console.log(ua),p(null)}}})}
function getData(e,p,z,F){htmlTab="<TABLE BORDER>";htmlTab+="<TR> <TD>Nivel</TD> <TD>P</TD> <TD>Z</TD> <TD>T</TD> <TD>TD</TD> <TD>WD</TD> <TD>WS</TD> </TR>";getLevels(e,p,function(I){null==I&&(window.errorMessage("No hay niveles!"),F(null));var ja=parseInt(I),N=Math.floor(ja/100);ja%=100;for(var U=0,aa=0,ca=[],ea=0;ea<N;ea++)aa=U+99,ca.push(z+"&DIM_lev="+U+"/"+aa),U=aa+1;ca.push(z+"&DIM_lev="+U+"/"+(U+ja));ca=ca.reverse();var X=[];getDataN(ca,I,p,X,function(ka){null==ka&&(window.errorMessage("No hay niveles!"),
F(null));if(0==X.length)window.alert("El sondeo no tiene datos validos para este diagrama"),F(null);else{ka=parseFloat(X[X.length-1].p);var za=parseFloat(X[0].p);850>=za?(window.alert("El primer nivel esta demasiado alto! - P0: "+za+"hpa\n\n El primer nivel debe ser mayor de 850hPa"),F(null)):300<ka?(window.alert("Ultimo nivel demasiado bajo! - Pn: "+ka+"hpa\n\n El ultimo nivel debe ser menor de 300hPa"),F(null)):(htmlTab+="</TABLE>",F(X))}})})}
function getDataN(e,p,z,F,I){if(0!=e.length){var ja=e.pop(),N=ja.indexOf("lev");N=ja.slice(N);var U=N.indexOf("=")+1,aa=N.indexOf("/"),ca=N.slice(U,aa);document.getElementById("info").innerHTML+="Procesando niviles "+ca+" a "+(parseInt(ca)+99)+" de "+p+"<br>";MakeHTTPRequest(ja,function(ea,X){if(null!=ea)console.error(ea);else if(!X.includes("ServiceException")){ea=z.zs;var ka=JSON.parse(X);Object.keys(ka[0].data);X=ka[0].data;var za=ka[1].data,ya=ka[2].data,ua=ka[3].data,Ba=ka[4].data,Na=ka[5].data;
ka=ka[6].data;var Ga=parseInt(ca);isDefined(X[Ga])||(Ga+=1);Ga=Object.keys(X[Ga]);var Sa=F.length,db;for(db in X){var ab=X[db],ib=za[db],lb=ya[db],tb=ua[db],Gb=Ba[db],Wb=Na[db],Ab=ka[db];Ab=Ab[Ga];Ab=parseFloat(Ab);ab=ab[Ga];ab=parseFloat(ab);if(99999999999<ab||1E4>ab){e=[];break}ab/=100;1E3<p&2E4>Ab||(ib=parseFloat(ib[Ga]),isNaN(ib)||ib<ea||(lb=parseFloat(lb[Ga]),isNaN(lb)?console.log(db,"NIVEL SIGW"):(lb-=273.15,tb=parseFloat(tb[Ga])-273.15,-273.15>tb||(Gb=parseFloat(Gb[Ga]),Ab=Wb=parseFloat(Wb[Ga]),
0>Ab||(Wb*=Math.PI/180,Wb%=2*Math.PI,htmlTab+="<TR><TD>"+Sa+"</TD> <TD>"+ab+"</TD> <TD>"+ib+"</TD> <TD>"+lb.toFixed(2)+"</TD> <TD>"+tb.toFixed(2)+"</TD> <TD>"+Ab.toFixed(0)+"</TD> <TD>"+Gb.toFixed(2)+"</TD></TR>",ab={n:Sa,p:ab,z:ib,t:lb,td:tb,wD:Wb,wS:Gb},Sa+=1,F.push(ab))))))}}getDataN(e,p,z,F,I)})}else I(F)}var wsond=function(e){};var gfiapp_point_interest=function(e,p){var z=this,F=[],I=!0,ja=function(N,U){var aa=null,ca=null,ea=null;setflags=function(){aa&&ca&&ea?(lon=aa,lat=ca,name=ea,fullUrl=knmiFlagURL+"file="+pointInterestFileName+"&location="+lon+","+lat+"&name="+name,$.ajax({type:"GET",url:fullUrl,success:function(ka){"OK"===ka.status?(ka=Ext.getCmp("webmapjs_add_point_interest"),ka.getEl().dom.style.background="#BCED91",p.getImageStore().clear(),p.draw("draw")):(ka=Ext.getCmp("webmapjs_add_point_interest"),ka.getEl().dom.style.background=
"#FF4040")},dataType:"jsonp",contentType:"application/jsonp",jsonpCallback:"resultSetFlag",crossDomain:!0})):(ea||$("#webmapjs_point_interest_name").css("border","2px solid red"),aa||$("#webmapjs_point_interest_lon").css("border","2px solid red"),ca||$("#webmapjs_point_interest_lat").css("border","2px solid red"))};delete_flag=function(){Ext.MessageBox.show({title:I18n.delete_title_confirm.text,msg:I18n.are_you_sure.text,buttons:Ext.MessageBox.YESNO,icon:Ext.MessageBox.WARNING,fn:function(ka){"yes"==
ka&&(name=$(".webmapjs_label_selected_point_interest").text(),fullUrl=knmiFlagURL+"file="+pointInterestFileName+"&name="+name,$.ajax({type:"GET",url:fullUrl,success:function(za){Ext.getCmp("webmapjs_delete_point_interest").getEl().dom.style.background="#BCED91";p.getImageStore().clear();p.draw()},dataType:"jsonp",contentType:"application/jsonp",jsonpCallback:"resultSetFlag",crossDomain:!0}))}})};e.html("<label class='webmapjs_label_point_interest' for='webmapjs_div_point_interest'>"+I18n.add_point_interest_abstract.text+
...
tooltip:I18n.delete_selected_flag_tooltip.tooltip,renderTo:"webmapjs_div_selected_point_interest",cls:"webmapjs_button_delete_point_interest",handler:function(){delete_flag()}});$("#webmapjs_point_interest_name, #webmapjs_point_interest_lon, #webmapjs_point_interest_lat").keypress(function(ka){if(13==ka.which)return setflags(),!1});var X=function(){var ka=e.find(".gfiapp_point_interest");ka.empty();for(var za=p.getLayers(),ya=0;ya<za.length;ya++){var ua=za[ya],Ba=jQuery("<div />",{css:{margin:8}});
ka.append(Ba);Ba.html("LAYER "+ua.service)}z.resize(N,U)};X();p.addListener("onlayeradd",X,!0);p.addListener("mouseclicked",function(ka){if(0!=I){var za=p.getLatLongFromPixelCoord({x:ka.x,y:ka.y});aa=za.x;ca=za.y;$("#webmapjs_point_interest_lon").val(za.x.toFixed(5));$("#webmapjs_point_interest_lat").val(za.y.toFixed(5));$("#webmapjs_point_interest_lon, #webmapjs_point_interest_lat").css("border","1px solid grey");za=p.getLayers();ka=p.getWMSGetFeatureInfoRequestURL(za[0],ka.x,ka.y).replace("&INFO_FORMAT=text/html",
"&INFO_FORMAT=application/json")+"&JSONP=featureInfoCallback";$.ajax({dataType:"jsonp",jsonpCallback:"featureInfoCallback",type:"GET",cache:!1,url:ka,success:function(ya){ya[1]&&"nodata"!==ya[1].data?($(".webmapjs_label_selected_point_interest").text(ya[1].data),$(".webmapjs_button_delete_point_interest").css("display","inline")):($(".webmapjs_label_selected_point_interest").text(I18n.default_selected_flag.text),$(".webmapjs_button_delete_point_interest").css("display","none"))},error:function(ya,
ua,Ba){debug(ua+", "+Ba)}})}},!0);$("#webmapjs_point_interest_name").on("input",function(ka){onChangeEvents("name",ka)});$("#webmapjs_point_interest_lon").on("input",function(ka){onChangeEvents("lon",ka);changeMapPin()});$("#webmapjs_point_interest_lat").on("input",function(ka){onChangeEvents("lat",ka);changeMapPin()});this.onChangeEvents=function(ka,za){var ya=Ext.getCmp("webmapjs_add_point_interest");ya.getEl().dom.style.background="";ya=Ext.getCmp("webmapjs_delete_point_interest");ya.getEl().dom.style.background=
"";switch(ka){case "name":ea=za.target.value;break;case "lon":aa=za.target.value;break;case "lat":ca=za.target.value}$("#webmapjs_point_interest_"+ka).css("border","1px solid grey")};this.changeMapPin=function(){p.positionMapPinByLatLon({x:aa,y:ca})};p.enableInlineGetFeatureInfo(!1)};this.enable=function(N,U){ja(N,U);I=!0};this.disable=function(){I=!1;p.enableInlineGetFeatureInfo(!0)};this.resize=function(N,U){for(var aa=0;aa<F.length;aa++)F[aa].setSize(N,U/F.length);for(aa=0;aa<F.length;aa++);};
z.enable()};WMJSExtApplications["Points of interest"]=gfiapp_point_interest;var gfiapp_eprofile=function(e,p){var z=this,F=[],I=function(ja,N){e.html('<div id="info"></div><div class="gfiapp_eprofile">bla</div>');var U=function(ea,X){X=X.id;for(var ka=0;ka<F.length;ka++){var za=F[ka].getWebMapJS();za.suspendEvent("onupdatebbox");ka!=X&&0==ea.equals(F[ka].getWebMapJS().getProjection().bbox)&&(za.zoomTo(ea),F[ka].updateBBOX(ea));za.resumeEvent("onupdatebbox")}},aa=function(ea,X){ea=X.id;for(X=0;X<F.length;X++){var ka=F[X].getWebMapJS();ka.suspendEvent("onupdatebbox");ka.suspendEvent("onloadingcomplete");
X!=ea&&ka.draw();ka.resumeEvent("onloadingcomplete");ka.resumeEvent("onupdatebbox")}},ca=function(){var ea=e.find(".gfiapp_eprofile");ea.empty();for(var X=p.getLayers(),ka=0;ka<X.length;ka++){var za=X[ka],ya=jQuery("<div />",{css:{margin:8}});ea.append(ya);F[ka]=new GFITimeElevationWindow(ya);F[ka].getWebMapJS().addLayer(za);F[ka].getWebMapJS().getListener().id=ka;F[ka].getWebMapJS().addListener("onupdatebbox",U,!0);F[ka].getWebMapJS().addListener("onloadingcomplete",aa,!0)}z.resize(ja,N)};ca();p.addListener("ondimchange",
function(){var ea=F[0].getWebMapJS(),X=ea.getProjection().bbox.clone();ea=ea.getProjection().bbox.right-ea.getProjection().bbox.left;var ka=(new Date(p.getDimension("time").currentValue)).getTime();X.left=ka;X.right=ka+ea;for(ea=0;ea<F.length;ea++)F[ea].getWebMapJS().zoomTo(X)},!0);p.addListener("onlayeradd",ca,!0);console.log(F[0]);F[0].getWebMapJS().addListener("onloadingcomplete",function(){var ea=F[0].getWebMapJS().getProjection().bbox.clone();$("#info").html("Displaying dates "+p.dateToISO8601(new Date(ea.left))+
" till "+p.dateToISO8601(new Date(ea.right)))},!0);p.enableInlineGetFeatureInfo(!1)};this.enable=function(ja,N){I(ja,N)};this.disable=function(){p.enableInlineGetFeatureInfo(!0)};this.resize=function(ja,N){for(var U=0;U<F.length;U++)F[U].setSize(ja,N/F.length);for(U=0;U<F.length;U++);};z.enable()};WMJSExtApplications.EProfile=gfiapp_eprofile;var autowms_app=function(e,p){initWMJS();e.addClass("autowms_app_container");var z="https://geoservices.knmi.nl/autowms?";try{z=autowmsURL}catch(X){}var F={},I=[],ja=function(X){var ka=aa();e.html(ka+JSON.stringify(X));$(".autowms_app_fileitem_return").attr("onclick","").click(function(za){I=[];ea("")});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(za){var ya=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){ea(ya)},
100)})},N=function(X){var ka=X.name;return X.leaf?"<span class='autowms_app_fileitem' name='"+X.name+"'>&#128451;&nbsp;"+ka+"</span>":"<span class='autowms_app_fileitem autowms_app_diritem' name='"+X.name+"'>&#128448;&nbsp;"+ka+"</span>"},U=function(X,ka){var za="<span class='autowms_app_layeritem' title='Click to add to viewer' name='"+X.name+"'><span class='autowms_app_layeritem_text'>Layer "+X.text+" - ("+X.name+")</span>";return za+="<span class='autowms_app_layeritem_image'><img src=\""+(ka+
"&service=WMS&request=getmap&format=image/png&layers="+X.name+"&width=400&CRS=EPSG:4326&STYLES=&EXCEPTIONS=INIMAGE&showlegend=true&"+Math.random())+'" /></span></span>'},aa=function(X,ka){return"<span class='autowms_app_currentpath'>AutoWMS link: <span class='autowms_app_request_container'><input class='autowms_app_request_input' type=\"text\" value=\""+z+"\"></input>  <span class='autowms_app_request_button'>-></span></span><hr/><span class='autowms_app_currentpath'>Current folder: ./"+(ka+'</span><span class="autowms_app_fileitem_header"><span class="autowms_app_fileitem_return">&#128193;&nbsp;<b>../ (&#8679;)</b></span><span class="autowms_app_fileitem_refresh" name="')+
(ka+'">&#8635;&nbsp;<b>Refresh</b></span></span>')},ca=function(X,ka){e.html("... working ... ");var za=WMJSGetServiceFromStore(ka,xml2jsonrequestURL);za.getLayerObjectsFlat(function(ya){var ua=""+aa(X,ka);ua+="<span class='autowms_app_serviceabstract'><b>"+za.title.replace(/!/g,"<br/>")+"</b><hr/>"+za.abstract.replace(/!/g,"<br/>");if(ka&&(ua+='<hr/>WMS: <a target="_blank" href="'+ka+'&service=WMS&request=GetCapabilities">'+ka+"</a>",1<ka.split("?").length)){var Ba=new WMJSKVP(ka.split("?")[1]),
Na=ka.split("?")[0].replace("adagucserver","adagucopendap/");Na=Na.replace(/([^:]\/)\/+/g,"$1");Ba.source&&(Na+=Ba.source);Ba.dataset&&(Na+=Ba.dataset+"/");ua=ua+('<hr/>OpenDAP: <span class=\'autowms_app_opendaplinks\'><a target="_blank" href="'+Na+'">'+Na+'</a><a target="_blank" href="')+(Na+'.das">DAS</a><a target="_blank" href="')+(Na+'.dds">DDS</a></span>')}ua+="</span>";e.html("... working ... ");F={};for(Ba=0;Ba<ya.length;Ba++)ua+=U(ya[Ba],ka),F[ya[Ba].name]=ya[Ba];e.html(ua);$(".autowms_app_layeritem").attr("onclick",
"").click(function(Ga){Ga=F[$(this).attr("name")];window.location.hash="addlayer('"+ka+"','"+Ga.name+"')"});$(".autowms_app_fileitem_return").attr("onclick","").click(function(Ga){ea(I.pop())});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(Ga){var Sa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){ca(X,Sa)},100)});$(".autowms_app_request_button").attr("onclick","").click(function(Ga){ea("")});$(".autowms_app_request_input").keyup(function(Ga){13==
Ga.keyCode&&ea("")})},function(ya){ya=aa();ya=ya+"<span class='autowms_app_error_container'><span class='autowms_app_error_container_header'>Unable to get WMS GetCapabilities</span><a target='_blank' href=\""+(ka+'service=WMS&request=GetCapabilities">'+ka+"</a>");e.html(ya+"</span>");$(".autowms_app_fileitem_return").attr("onclick","").click(function(ua){I=[];ea("")})},!0)},ea=function(X){X&&"undefined"!==X||(X="");var ka=$(".autowms_app_request_input").first().val();ka&&0<ka.length&&(z=ka.trim().split("?")[0],
z.endsWith("?")||(z+="?"));var za=function(ua){if(ua.error)e.html("Error from server: "+ua.error);else{F={};I[I.length-1]!==X&&I.push(X);var Ba=aa(ua,X);e.html("... working ... ");ua.result.sort(function(Ga,Sa){if(Ga.name<=Sa.name)return-1;if(Ga.name>Sa.name)return 1;if(Ga.name==Sa.name)return 0});for(var Na=0;Na<ua.result.length;Na++)Ba+=N(ua.result[Na]),F[ua.result[Na].name]=ua.result[Na];e.html(Ba);$(".autowms_app_fileitem_return").attr("onclick","").click(function(Ga){I.pop();ea(I[I.length-1])});
$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(Ga){var Sa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){ea(Sa)},100)});$(".autowms_app_fileitem").attr("onclick","").click(function(Ga){Ga=F[$(this).attr("name")];!1===Ga.leaf?ea(Ga.path):ca(ua,Ga.adaguc)});$(".autowms_app_request_button").attr("onclick","").click(function(Ga){ea("")});$(".autowms_app_request_input").keyup(function(Ga){13==Ga.keyCode&&ea("")})}},
ya=z+"request=getfiles&path="+X;e.html('... Reading <a href="'+ya+'">'+ya+"</a> ... ");try{$.ajax({contentType:"application/json",crossDomain:!0,type:"GET",url:ya,success:za,error:function(ua){console.error("Request failed without jsonp, trying jsonp");za({result:[]});$.ajax({dataType:"jsonp",contentType:"application/jsonp",crossDomain:!0,type:"GET",url:ya,success:za,error:function(Ba){ja("Unable to do ajax call")}})}})}catch(ua){console.error(ua),ja(ua)}};this.enable=function(){e.html("<div>Initializing...</div>");
ea("")};this.disable=function(){};this.resize=function(X,ka){}};try{WMJSExtApplications.AutoWMS=autowms_app}catch(e){};
