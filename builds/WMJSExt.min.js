...
$jscomp.polyfill("Promise",function(c){function n(){this.batch_=null}function x(L){return L instanceof w?L:new w(function(P,H){P(L)})}if(c&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return c;n.prototype.asyncExecute=function(L){if(null==this.batch_){this.batch_=[];var P=this;this.asyncExecuteFunction(function(){P.executeBatch_()})}this.batch_.push(L)};
var y=$jscomp.global.setTimeout;n.prototype.asyncExecuteFunction=function(L){y(L,0)};n.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var L=this.batch_;this.batch_=[];for(var P=0;P<L.length;++P){var H=L[P];L[P]=null;try{H()}catch(T){this.asyncThrow_(T)}}}this.batch_=null};n.prototype.asyncThrow_=function(L){this.asyncExecuteFunction(function(){throw L;})};var w=function(L){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var P=this.createResolveAndReject_();
try{L(P.resolve,P.reject)}catch(H){P.reject(H)}};w.prototype.createResolveAndReject_=function(){function L(T){return function(R){H||(H=!0,T.call(P,R))}}var P=this,H=!1;return{resolve:L(this.resolveTo_),reject:L(this.reject_)}};w.prototype.resolveTo_=function(L){if(L===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(L instanceof w)this.settleSameAsPromise_(L);else{a:switch(typeof L){case "object":var P=null!=L;break a;case "function":P=!0;break a;default:P=!1}P?this.resolveToNonPromiseObj_(L):
this.fulfill_(L)}};w.prototype.resolveToNonPromiseObj_=function(L){var P=void 0;try{P=L.then}catch(H){this.reject_(H);return}"function"==typeof P?this.settleSameAsThenable_(P,L):this.fulfill_(L)};w.prototype.reject_=function(L){this.settle_(2,L)};w.prototype.fulfill_=function(L){this.settle_(1,L)};w.prototype.settle_=function(L,P){if(0!=this.state_)throw Error("Cannot settle("+L+", "+P+"): Promise already settled in state"+this.state_);this.state_=L;this.result_=P;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};w.prototype.scheduleUnhandledRejectionCheck_=function(){var L=this;y(function(){if(L.notifyUnhandledRejection_()){var P=$jscomp.global.console;"undefined"!==typeof P&&P.error(L.result_)}},1)};w.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var L=$jscomp.global.CustomEvent,P=$jscomp.global.Event,H=$jscomp.global.dispatchEvent;if("undefined"===typeof H)return!0;"function"===typeof L?L=new L("unhandledrejection",{cancelable:!0}):
"function"===typeof P?L=new P("unhandledrejection",{cancelable:!0}):(L=$jscomp.global.document.createEvent("CustomEvent"),L.initCustomEvent("unhandledrejection",!1,!0,L));L.promise=this;L.reason=this.result_;return H(L)};w.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var L=0;L<this.onSettledCallbacks_.length;++L)S.asyncExecute(this.onSettledCallbacks_[L]);this.onSettledCallbacks_=null}};var S=new n;w.prototype.settleSameAsPromise_=function(L){var P=this.createResolveAndReject_();
L.callWhenSettled_(P.resolve,P.reject)};w.prototype.settleSameAsThenable_=function(L,P){var H=this.createResolveAndReject_();try{L.call(P,H.resolve,H.reject)}catch(T){H.reject(T)}};w.prototype.then=function(L,P){function H(ba,ia){return"function"==typeof ba?function(la){try{T(ba(la))}catch(ma){R(ma)}}:ia}var T,R,O=new w(function(ba,ia){T=ba;R=ia});this.callWhenSettled_(H(L,T),H(P,R));return O};w.prototype.catch=function(L){return this.then(void 0,L)};w.prototype.callWhenSettled_=function(L,P){function H(){switch(T.state_){case 1:L(T.result_);
break;case 2:P(T.result_);break;default:throw Error("Unexpected state: "+T.state_);}}var T=this;null==this.onSettledCallbacks_?S.asyncExecute(H):this.onSettledCallbacks_.push(H);this.isRejectionHandled_=!0};w.resolve=x;w.reject=function(L){return new w(function(P,H){H(L)})};w.race=function(L){return new w(function(P,H){for(var T=$jscomp.makeIterator(L),R=T.next();!R.done;R=T.next())x(R.value).callWhenSettled_(P,H)})};w.all=function(L){var P=$jscomp.makeIterator(L),H=P.next();return H.done?x([]):new w(function(T,
R){function O(la){return function(ma){ba[la]=ma;ia--;0==ia&&T(ba)}}var ba=[],ia=0;do ba.push(void 0),ia++,x(H.value).callWhenSettled_(O(ba.length-1),R),H=P.next();while(!H.done)})};return w},"es6","es3");$jscomp.polyfill("Object.is",function(c){return c?c:function(n,x){return n===x?0!==n||1/n===1/x:n!==n&&x!==x}},"es6","es3");
...
function(O){if(O instanceof x)return O;Object.isExtensible(O)&&w(O);return R(O)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(c&&$jscomp.ES6_CONFORMANCE)return c}else if(n())return c;var L="$jscomp_hidden_"+Math.random();S("freeze");S("preventExtensions");S("seal");var P=0,H=function(T){this.id_=(P+=Math.random()+1).toString();if(T){T=$jscomp.makeIterator(T);for(var R;!(R=T.next()).done;)R=R.value,this.set(R[0],R[1])}};H.prototype.set=function(T,R){if(!y(T))throw Error("Invalid WeakMap key");
w(T);if(!$jscomp.owns(T,L))throw Error("WeakMap key fail: "+T);T[L][this.id_]=R;return this};H.prototype.get=function(T){return y(T)&&$jscomp.owns(T,L)?T[L][this.id_]:void 0};H.prototype.has=function(T){return y(T)&&$jscomp.owns(T,L)&&$jscomp.owns(T[L],this.id_)};H.prototype.delete=function(T){return y(T)&&$jscomp.owns(T,L)&&$jscomp.owns(T[L],this.id_)?delete T[L][this.id_]:!1};return H},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(c){function n(){if($jscomp.ASSUME_NO_NATIVE_MAP||!c||"function"!=typeof c||!c.prototype.entries||"function"!=typeof Object.seal)return!1;try{var H=Object.seal({x:4}),T=new c($jscomp.makeIterator([[H,"s"]]));if("s"!=T.get(H)||1!=T.size||T.get({x:4})||T.set({x:4},"t")!=T||2!=T.size)return!1;var R=T.entries(),O=R.next();if(O.done||O.value[0]!=H||"s"!=O.value[1])return!1;O=R.next();return O.done||4!=O.value[0].x||"t"!=O.value[1]||!R.next().done?!1:!0}catch(ba){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(c&&$jscomp.ES6_CONFORMANCE)return c}else if(n())return c;var x=new WeakMap,y=function(H){this.data_={};this.head_=L();this.size=0;if(H){H=$jscomp.makeIterator(H);for(var T;!(T=H.next()).done;)T=T.value,this.set(T[0],T[1])}};y.prototype.set=function(H,T){H=0===H?0:H;var R=w(this,H);R.list||(R.list=this.data_[R.id]=[]);R.entry?R.entry.value=T:(R.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:H,value:T},R.list.push(R.entry),
this.head_.previous.next=R.entry,this.head_.previous=R.entry,this.size++);return this};y.prototype.delete=function(H){H=w(this,H);return H.entry&&H.list?(H.list.splice(H.index,1),H.list.length||delete this.data_[H.id],H.entry.previous.next=H.entry.next,H.entry.next.previous=H.entry.previous,H.entry.head=null,this.size--,!0):!1};y.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=L();this.size=0};y.prototype.has=function(H){return!!w(this,H).entry};y.prototype.get=function(H){return(H=
w(this,H).entry)&&H.value};y.prototype.entries=function(){return S(this,function(H){return[H.key,H.value]})};y.prototype.keys=function(){return S(this,function(H){return H.key})};y.prototype.values=function(){return S(this,function(H){return H.value})};y.prototype.forEach=function(H,T){for(var R=this.entries(),O;!(O=R.next()).done;)O=O.value,H.call(T,O[1],O[0],this)};y.prototype[Symbol.iterator]=y.prototype.entries;var w=function(H,T){var R=T&&typeof T;"object"==R||"function"==R?x.has(T)?R=x.get(T):
(R=""+ ++P,x.set(T,R)):R="p_"+T;var O=H.data_[R];if(O&&$jscomp.owns(H.data_,R))for(H=0;H<O.length;H++){var ba=O[H];if(T!==T&&ba.key!==ba.key||T===ba.key)return{id:R,list:O,index:H,entry:ba}}return{id:R,list:O,index:-1,entry:void 0}},S=function(H,T){var R=H.head_;return $jscomp.iteratorPrototype(function(){if(R){for(;R.head!=H.head_;)R=R.previous;for(;R.next!=R.head;)return R=R.next,{done:!1,value:T(R)};R=null}return{done:!0,value:void 0}})},L=function(){var H={};return H.previous=H.next=H.head=H},
...
n.layer.setDimension(n.dimension.name,WMJSDateTooLateString),n.currentIndex=n.dimension.size()-1):(console.log(" O AQUI",w),n.dimensionValueLabel.setValueText(WMJSDateOutSideRange),n.layer.setDimension(n.dimension.name,WMJSDateOutSideRange))}}catch(H){n.dimensionValueLabel.setValueText(WMJSDateOutSideRange),n.layer.setDimension(n.dimension.name,WMJSDateOutSideRange),n.currentIndex=0,console.log("CATCH")}n.dimSlider.suspendEvents();n.dimSlider.setValue(n.currentIndex,!1);n.dimSlider.resumeEvents()};
n.checkReferenceTime=function(w){for(var S=w=-1,L=0;L<n.dimensionPanels.length;L++){var P=n.layer.getDimension(n.dimensionPanels[L].dimension.name);"time"==P.name&&"ISO8601"==P.units&&(S=L);"reference_time"==P.name&&"ISO8601"==P.units&&(w=L);"forecast_reference_time"==P.name&&"ISO8601"==P.units&&(w=L)}n.dimSlider.suspendEvents();if(-1!=S&&-1!=w){var H=n.layer.getDimension(n.dimensionPanels[S].dimension.name),T=n.layer.getDimension(n.dimensionPanels[w].dimension.name);H.getValue()<T.getValue()&&(console.log("time should be increased:  "+
H.getValue()+"<"+T.getValue()),w=T.getValue(),n.dimensionPanels[S].dimSlider.setValue(H.getIndexForValue(w)+1,!1));w=this.Parent.WMJSLayer.parentMaps[0].getBBOX();L="&BBOX="+w.left+","+w.bottom+","+w.right+","+w.top;w=this.Parent.WMJSLayer.service+"service=WMS&REQUEST=GetMap&FORMAT=image/png";w=w+"&layers="+this.Parent.WMJSLayer.name;w=w+"&WIDTH=870&HEIGHT=919&CRS=EPSG%3A3857"+L+"&FORMAT=image/png&TRANSPARENT=TRUE&";for(L=0;L<this.Parent.WMJSLayer.dimensions.length;L++)"time"==this.Parent.WMJSLayer.dimensions[L].name&&
(w=w+"&time="+this.Parent.WMJSLayer.dimensions[L].currentValue),this.Parent.WMJSLayer.dimensions[L].name.includes("reference_time")&&(w=w+"&DIM_forecast_reference_time="+this.Parent.WMJSLayer.dimensions[L].currentValue);try{fetch(w).then(function(R){if(200==R.status)console.log("OK");else if(T.getValue()!=H.getValue()){R=(new Date(T.getValue())).getTime();var O=(new Date(T.defaultValue)).getTime();R=(new Date(H.defaultValue)).getTime()-(O-R);R=(new Date(R)).toISOString();n.layer.setDimension(H.name,
...
name:c.name,style:c.style,opacity:c.opacity,transparent:c.transparent,enabled:c.enabled,updatetime:c.updatetime});c.reload=function(y){y=c.getDimensionPanel("time").dimension;var w=void 0,S=void 0;w=c.getDimensionPanel("forecast_reference_time");c.getDimensionPanel("time");isDefined(w)&&(w=w.dimension,S=w.currentValue);var L=y.dimMaxValue;y=c.WMJSLayer.service+"&service=WMS&request=GetCapabilities";var P=new ol.format.WMSCapabilities,H=function(T,R){console.log("Reload ON");isDefined(R)?console.log("Update for Reference_Time",
...
R,S),S!=R&&c.parseLayer(!0,H(O,R))):(console.log("TIME",ba,L,O),L!=ba&&c.parseLayer(!0,H(O,void 0)))}}})}catch(T){console.log(e)}};c.getUpdateTime=function(y){return"PT1D"==y?216E5:"PT12H"==y?108E5:"PT6H"==y?72E5:"PT3H"==y?36E5:"PT1H30M"==y?18E5:"PT1H"==y?12E5:"PT30M"==y?6E5:"PT15M"==y?3E5:"PT10M"==y?18E4:"PT5M"==y?12E4:"PT3M"==y||"PT1M"==y?6E4:null};c.getUpdateStatus=function(){return n};c.setUpdateStatus=function(y){n=y};c.opacitySliderChanged=function(y){c.WMJSLayer&&(c.WMJSLayer.setOpacity(y/
...
"3px solid #777"}catch(y){}c.selected=!1};c.setOpacity=function(y){c.opacitySlider.setValue(100*y);c.opacity=100*y};c.dimCallBackAdded=!1;c.dimensionPanels=[];c.parseLayer=function(y,w){if(0!=isDefined(this.WMJSLayer.service)&&0!=this.WMJSLayer.service.length){c.setLoading("Reading GetCapabilities ...");for(var S=[],L=0;L<c.WMJSLayer.dimensions.length;L++)S.push(this.WMJSLayer.dimensions[L].clone());c.dimensionPanels=[];c.dimUpdate=function(){for(var H=0;H<c.dimensionPanels.length;H++){var T=c.WMJSLayer.getDimension(c.dimensionPanels[H].dimension.name);
c.dimensionPanels[H].setValue(T.getValue())}};c.setDimension=function(H,T){var R=c.getDimensionPanel(H);isDefined(R)?(c.WMJSLayer.setDimension(H,T),R.setValue(T)):error("WMJSExtLayerPanel::Dimension "+H+" not found")};c.getDimensionPanel=function(H){for(var T=0;T<c.dimensionPanels.length;T++)if(c.dimensionPanels[T].dimension.name===H)return c.dimensionPanels[T]};var P=function(H){var T=H;H.message&&(T=H.message);c.setLoading(!1);H="Unable to parse layer "+c.WMJSLayer.name+"\n"+T;c.WMJSLayer.hasError=
!0;error(H)};L=function(H){if(void 0!=c.WMJSLayer.parentMaps[0])if(c.WMJSLayer!=H)isDefined(H)&&P("WMJSExtLayerPanel internal error:\n"+H),w&&w(c),c.afterlayerready&&c.afterlayerready(c);else if(c.WMJSLayer.hasError){c.setLoading(!1);c.productButton.setText(c.WMJSLayer.path+c.WMJSLayer.title);c.styleButton.setText("");var T=c.WMJSLayer.lastError;isDefined(T)||(T="An error occurred connecting to WMS server");c.setTitle(T);error(T);H=new WMJSTimer;T=T.replaceAll("\n","<br/>");H.init(10,function(){Ext.Msg.alert(I18n.unable_to_connect_server.text,
I18n.unable_to_connect_server.text+"<br/><br/>"+T)});w&&w(c);c.afterlayerready&&c.afterlayerready(c)}else{c.WMJSLayer.getLayerRelative(function(la,ma,ua){c.productButton.setText("("+(ma+1)+"/"+ua+") "+c.WMJSLayer.title)},function(la){c.productButton.setText(c.WMJSLayer.path+c.WMJSLayer.title)});c.setStyleText(c.WMJSLayer.getStyleObject(c.WMJSLayer.currentStyle));c.dimensionPanels=[];c.dimensionPanelContainer.removeAll();var R=sync_layer,O="";for(H=0;H<c.WMJSLayer.dimensions.length;H++){for(var ba=
0;ba<S.length;ba++)S[ba].name==c.WMJSLayer.dimensions[H].name&&(c.WMJSLayer.setDimension(S[ba].name,S[ba].defaultValue),"time"==S[ba].name&&(R=S[ba].linked));ba=Ext.create("WMJSExtDimensionPanel",{dimension:c.WMJSLayer.dimensions[H],layer:c.WMJSLayer,dimensionPanels:c.dimensionPanels,Linked:R,Parent:c});c.dimensionPanels.push(ba);c.dimensionPanelContainer.add(ba);0<O.length&&(O+=", ");O+=c.WMJSLayer.dimensions[H].name}c.afterlayerready&&(w&&w(c),c.afterlayerready(c));for(H=0;H<c.WMJSLayer.dimensions.length;H++)R=
c.WMJSLayer.parentMaps[0].getDimension(c.WMJSLayer.dimensions[H].name),isDefined(R)&&c.WMJSLayer.dimensions[H].setClosestValue(R.defaultValue);c.setLoading(!1);for(H=0;H<c.WMJSLayer.dimensions.length;H++)R=c.WMJSLayer.parentMaps[0].getDimension(c.WMJSLayer.dimensions[H].name),c.dimensionPanels[H].setValue(c.WMJSLayer.dimensions[H].defaultValue),isDefined(R)&&R.defaultValue!=c.WMJSLayer.dimensions[H].defaultValue&&c.WMJSLayer.parentMaps[0].addListener("ondimchange",c.dimUpdate,!0),c.dimensionPanels[H].sliderChanged(c.WMJSLayer.dimensions[H].getIndexForValue(c.WMJSLayer.dimensions[H].defaultValue));
...
I18n.title.text+"</i></td><td> "+c.WMJSLayer.WMJSService.title+"</td></tr><tr><td><i>"+I18n.service.text+"</i></td><td>"+c.WMJSLayer.WMJSService.onlineresource+"</td></tr><tr><td><i>"+I18n.abstract.text+"</i></td><td>"+c.WMJSLayer.WMJSService.abstract+"</td></tr></table></span>"):c.layerAbstractPanel.update("...");H=function(){var la=c.WMJSLayer.parentMaps[0].getLegendGraphicURLForLayer(c.WMJSLayer),ma=c.WMJSLayer.parentMaps[0].getLegendStore();if(c.layerLegendPanel.getEl()){var ua=$(c.layerLegendPanel.getEl().dom).find("canvas")[0].getContext("2d");
(la=ma.getImageForSrc(la))?(ua.rect(0,0,90,250),ua.fillStyle="white",ua.fill(),ua.drawImage(la.getElement()[0],0,0)):(ua.rect(0,0,90,250),ua.fillStyle="gray",ua.fill())}};c.WMJSLayer.parentMaps[0].getListener().addToCallback("onlegendready",H,!0);H();void 0==c.updatetime&&(console.log("TIME UNDEFINED"),H=864E5,void 0!=c.WMJSLayer.getDimension("time")&&(H=c.WMJSLayer.getDimension("time").values,H=getUpdateTime(H.slice(H.lastIndexOf("/")+1))),console.log("PT",H),c.updatetime=H);null==x&&(console.log("Pongo el timer"),
x=setInterval(c.reload,c.updatetime,c.updatetime),console.log(x,c.updatetime))}};try{if(c.WMJSLayer.parseLayer(L,y,"LayerPanel::parseLayer",xml2jsonrequestURL),!0===y)try{console.log("clearing cache"),c.WMJSLayer&&c.WMJSLayer.parentMaps&&0<c.WMJSLayer.parentMaps.length&&(c.WMJSLayer.parentMaps[0].clearImageStore(),c.WMJSLayer.parentMaps[0].loadLegendInline(!0))}catch(H){console.error(H)}}catch(H){P(H)}}};c.duplicateLayer=function(){createNewLayerPanel(c.parentWebMapJS,c.WMJSLayer)};c.productButton=
...
c.mappanel.webMapJS.getLayers();n.removeAll();for(var H=0;H<P.length;H++)n.add({name:P[H].service+P[H].name,title:P[H].title,wmjslayer:P[H]})},w=function(P){if(isDefined(P)){c.selectedLayer=P;var H=c.getComponent("dimensionpanel").getComponent("dimensioncombobox");H.disable();x.removeAll();for(var T=0;T<P.dimensions.length;T++)x.add({name:P.dimensions[T].name,wmjsdimension:P.dimensions[T]});0<x.getCount()&&(H.setValue(x.getAt(0).get("name")),S(x.getAt(0).get("wmjsdimension")),H.enable())}},S=function(P){isDefined(P)&&
...
itemId:"layercombo",region:"center",fieldLabel:I18n.select_layer.text,labelWidth:110,displayField:"title",valuefield:"name",store:n,queryMode:"local",listeners:{select:{fn:function(P,H){P=H[0].get("wmjslayer");w(P)}}}},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",handler:function(){y()}}]},{xtype:"panel",itemId:"dimensionpanel",layout:"fit",frame:!0,border:!1,margin:3,height:36,items:[{margin:3,xtype:"combobox",itemId:"dimensioncombobox",region:"center",fieldLabel:I18n.select_dimension.text,
labelWidth:110,disabled:!0,store:x,displayField:"name",valuefield:"name",queryMode:"local",listeners:{select:{fn:function(P,H){S(H[0].get("wmjsdimension"))}}}}]},{xtype:"panel",itemId:"dimensionvaluespanel",frame:!0,border:!1,margin:3,layout:"border",height:36,items:[{xtype:"label",text:I18n.start_at.text+":",width:110,region:"west",margin:3},{itemId:"dimensioncurrentvalue",xtype:"textfield",region:"center",frame:!1,border:!1,margin:3},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",
...
Da.height);la()}}}}),P=Ext.create("Ext.data.Store",{fields:["title","format"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),H=Ext.create("Ext.grid.Panel",{border:!1,store:P,columns:[{text:I18n.format.text,dataIndex:"format"},{text:I18n.title.text,dataIndex:"title",flex:1}],listeners:{select:{fn:function(ma,ua){y=ua.get("format");la()}}}});c.onReady=function(){L.setLoading(!1);for(var ma=this.coverages[0],ua=0;ua<ma.supportedProjections.length;ua++){var Da=ma.supportedProjections[ua].srs;
...
var va=ma.formats[ua].toUpperCase();try{Da=formatDescriptionLookup[va]}catch(Fa){}isDefined(Da)||(Da=ma.formats[ua]);P.add({title:Da,format:ma.formats[ua]});"AAIGRID"==va&&H.getView().select(ua)}la();ia.update('<table style="margin:5px;"><tr><td><b>Coverage:</b></td><td>'+ma.name+"</td></tr><tr><td><b>Title:</b></td><td>"+ma.title+"</td></tr><tr><td><b>Description:</b></td><td>"+ma["abstract"]+"</td></tr></table>")};Ext.create("Ext.panel.Panel",{region:"west",border:!0,width:100});var T=Ext.create("Ext.panel.Panel",
...
region:"center",height:"50%",itemId:"dimensionPanel",title:I18n.dimensions.text,autoScroll:!0},{xtype:"panel",split:!0,autoScroll:!0,region:"south",height:"50%",title:I18n.formats.text,items:[H]}]}]}),R=Ext.create("Ext.panel.Panel",{layout:"border",region:"center",border:!0,width:300,items:[T]}),O=Ext.create("Ext.panel.Panel",{border:!1,padding:20}),ba=Ext.create("Ext.panel.Panel",{title:"GetCoverage request link",region:"south",border:!0,height:100,layout:"fit",items:[O]}),ia=Ext.create("Ext.panel.Panel",
...
95;c.timer.init(100,c.fadeOut)})}},show:{fn:function(){c.getEl().dom.style.opacity=1;c.opacity=100}}}});this.callParent(arguments)}});initWMJS();var error=function(c){console.error(c)},debug=function(c){console.log(c)},versionInfo="ADAGUC viewer version AEMET 1.2.3",mainWebmapJS;function decimalFormatter(c,n){c=parseInt(c)+"";n=parseInt(n)-c.length;var x,y="";for(x=0;x<n;x++)y+="0";return y+c}
...
var S=void 0;isDefined(n.opacity)&&0<(""+n.opacity).length&&(S=n.opacity);var L=void 0;isDefined(n.enabled)&&(L=n.enabled);var P=void 0;isDefined(n.autoChooseLayer)&&(P=n.autoChooseLayer);var H=void 0;isDefined(n.updatetime)&&(H=n.updatetime);isDefined(L)||(L=!0);var T=Ext.getCmp("layerlistpanel");T.removeLayer=removeLayer;x=Ext.create("webmapjsext.WMJSExt.LayerPanel",{parentPanelList:T,title:y,service:x,name:y,style:w,opacity:S,updatetime:H,enabled:L,autoChooseLayer:P,parentWebMapJS:c,afterlayerready:function(R){1!=
...
ia+"]")}},error:function(ba,ia,la){$("#"+O).html("Sorry! An error occurred while receiving JSON data from the server: ["+la+"]");console.log("Error "+la)}})},P=!0,H=[];H.set=!1;var T=function(R){if(0!=P){H.x=R.x;H.y=R.y;H.set=!0;var O=n.getLatLongFromPixelCoord({x:R.x,y:R.y});$("#chart").html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');var ba=n.getLayers();if(isDefined(ba)){O="timeseries graph for location ["+Math.round(100*O.x)/100+","+Math.round(100*O.y)/100+"]<br/>";$("#chart").empty();
...
L(ma,"chart"+ia)}$("#info").html(O)}else $("#info").html("No valid data received:<br/>"+data)}};n.addListener("mouseclicked",T,!0);this.enable=function(){c.html('<div id="info"></div><div id="chart" class="gfiapp_d3c3"></div>');$("#info").html("Click on the map to create a timeseries graph.");console.log("init");n.enableInlineGetFeatureInfo(!1);P=!0};this.disable=function(){P=!1;n.enableInlineGetFeatureInfo(!0);H.set=!1};this.resize=function(R,O){console.log("w="+R);$("#chart").width(R);H.set&&T(H)};
...
a+",0)"}function hf(a){return"translate(0,"+a+")"}function ch(a){return function(b){return+a(b)}}function wp(a,b){b=Math.max(0,a.bandwidth()-2*b)/2;a.round()&&(b=Math.round(b));return function(f){return+a(f)+b}}function xp(){return!this.__axis}function jf(a,b){function f(z){var C=null==h?b.ticks?b.ticks.apply(b,g):b.domain():h,r=null==k?b.tickFormat?b.tickFormat.apply(b,g):gf:k,t=Math.max(p,0)+q,A=b.range(),E=+A[0]+B;A=+A[A.length-1]+B;var G=(b.bandwidth?wp:ch)(b.copy(),B),M=z.selection?z.selection():
...
C=C.transition(z),ka=ka.transition(z),Y=Y.transition(z),W=W.transition(z).attr("opacity",1E-6).attr("transform",function(Z){return isFinite(Z=G(Z))?v(Z+B):this.getAttribute("transform")}),da.attr("opacity",1E-6).attr("transform",function(Z){var qa=this.parentNode.__axis;return v((qa&&isFinite(qa=qa(Z))?qa:G(Z))+B)}));W.remove();U.attr("d",4===a||2===a?m?"M"+F*m+","+E+"H"+B+"V"+A+"H"+F*m:"M"+B+","+E+"V"+A:m?"M"+E+","+F*m+"V"+B+"H"+A+"V"+F*m:"M"+E+","+B+"H"+A);C.attr("opacity",1).attr("transform",function(Z){return v(G(Z)+
...
null).attr("x",function(E){return"e"===E.type[E.type.length-1]?A[1][0]-C/2:A[0][0]-C/2}).attr("y",function(E){return"s"===E.type[0]?A[1][1]-C/2:A[0][1]-C/2}).attr("width",function(E){return"n"===E.type||"s"===E.type?A[1][0]-A[0][0]+C:C}).attr("height",function(E){return"e"===E.type||"w"===E.type?A[1][1]-A[0][1]+C:C})):t.selectAll(".selection,.handle").style("display","none").attr("x",null).attr("y",null).attr("width",null).attr("height",null)}function g(t,A,E){var G=t.__brush.emitter;return!G||E&&
G.clean?new h(t,A,E):G}function h(t,A,E){this.that=t;this.args=A;this.state=t.__brush;this.active=0;this.clean=E}function k(t){function A(V){for(var ea=$jscomp.makeIterator(V.changedTouches||[V]),sa=ea.next();!sa.done;sa=ea.next()){sa=sa.value;for(var fa=$jscomp.makeIterator(I),za=fa.next();!za.done;za=fa.next())za=za.value,za.identifier===sa.identifier&&(za.cur=bc(sa,W))}!l||D||J||1!==I.length||(ea=I[0],Dk(ea.cur[0]-ea[0])>Dk(ea.cur[1]-ea[1])?J=!0:D=!0);ea=$jscomp.makeIterator(I);for(sa=ea.next();!sa.done;sa=
...
Lb(W).attr("pointer-events","none"),ja=ha.selectAll(".overlay").attr("cursor",Gc[da]);nd(W);var ra=g(W,arguments,!0).beforestart();if(t.touches)ra.moved=A,ra.ended=G;else{var xa=Lb(t.view).on("mousemove.brush",A,!0).on("mouseup.brush",G,!0);if(v)xa.on("keydown.brush",M,!0).on("keyup.brush",U,!0);of(t.view)}f.call(W);ra.start(t,ka.name)}}function p(t){g(this,arguments).moved(t)}function m(t){g(this,arguments).ended(t)}function q(){var t=this.__brush||{selection:null};t.extent=Eh(B.apply(this,arguments));
t.dim=a;return t}var B=Dr,F=Cr,u=Er,v=!0,z=id("start","brush","end"),C=6,r;b.move=function(t,A){t.tween?t.on("start.brush",function(E){g(this,arguments).beforestart().start(E)}).on("interrupt.brush end.brush",function(E){g(this,arguments).end(E)}).tween("brush",function(){function E(Y){M.selection=1===Y&&null===da?null:ka(Y);f.call(G);U.brush()}var G=this,M=G.__brush,U=g(G,arguments),W=M.selection,da=a.input("function"===typeof A?A.apply(this,arguments):A,M.extent),ka=Uc(W,da);return null!==W&&null!==
da?E:E(1)}):t.each(function(){var E=arguments,G=this.__brush,M=a.input("function"===typeof A?A.apply(this,E):A,G.extent);E=g(this,E).beforestart();nd(this);G.selection=null===M?null:M;f.call(this);E.start().brush().end()})};b.clear=function(t){b.move(t,null)};h.prototype={beforestart:function(){1===++this.active&&(this.state.emitter=this,this.starting=!0);return this},start:function(t,A){this.starting?(this.starting=!1,this.emit("start",t,A)):this.emit("brush",t);return this},brush:function(t,A){this.emit("brush",
t,A);return this},end:function(t,A){0===--this.active&&(delete this.state.emitter,this.emit("end",t,A));return this},emit:function(t,A,E){var G=Lb(this.that).datum();z.call(t,this.that,new Br(t,{sourceEvent:A,target:b,selection:a.output(this.state.selection),mode:E,dispatch:z}),G)}};b.extent=function(t){return arguments.length?(B="function"===typeof t?t:Ih(Eh(t)),b):B};b.filter=function(t){return arguments.length?(F="function"===typeof t?t:Ih(!!t),b):F};b.touchable=function(t){return arguments.length?
...
W?m[~W*q+U.$jscomp$loop$prop$i$177$341]:m[U.$jscomp$loop$prop$i$177$341*q+W]}}(t));k&&E.sort(function(U){return function(W,da){return k(0>W?-m[~W*q+U.$jscomp$loop$prop$i$177$341]:m[U.$jscomp$loop$prop$i$177$341*q+W],0>da?-m[~da*q+U.$jscomp$loop$prop$i$177$341]:m[U.$jscomp$loop$prop$i$177$341*q+da])}}(t));E=$jscomp.makeIterator(E);for(var G=E.next();!G.done;G=E.next())G=G.value,0>G?(u[~G*q+t.$jscomp$loop$prop$i$177$341]||(u[~G*q+t.$jscomp$loop$prop$i$177$341]={source:null,target:null})).target={index:t.$jscomp$loop$prop$i$177$341,
startAngle:r,endAngle:r+=m[~G*q+t.$jscomp$loop$prop$i$177$341]*z,value:m[~G*q+t.$jscomp$loop$prop$i$177$341]}:(u[t.$jscomp$loop$prop$i$177$341*q+G]||(u[t.$jscomp$loop$prop$i$177$341*q+G]={source:null,target:null})).source={index:t.$jscomp$loop$prop$i$177$341,startAngle:r,endAngle:r+=m[t.$jscomp$loop$prop$i$177$341*q+G]*z,value:m[t.$jscomp$loop$prop$i$177$341*q+G]}}else for(E=Jh(0,q).filter(function(U){return function(W){return m[U.$jscomp$loop$prop$i$177$341*q+W]||m[W*q+U.$jscomp$loop$prop$i$177$341]}}(t)),
k&&E.sort(function(U){return function(W,da){return k(m[U.$jscomp$loop$prop$i$177$341*q+W],m[U.$jscomp$loop$prop$i$177$341*q+da])}}(t)),E=$jscomp.makeIterator(E),G=E.next();!G.done;G=E.next()){var M=G.value;G=void 0;t.$jscomp$loop$prop$i$177$341<M?(G=u[t.$jscomp$loop$prop$i$177$341*q+M]||(u[t.$jscomp$loop$prop$i$177$341*q+M]={source:null,target:null}),G.source={index:t.$jscomp$loop$prop$i$177$341,startAngle:r,endAngle:r+=m[t.$jscomp$loop$prop$i$177$341*q+M]*z,value:m[t.$jscomp$loop$prop$i$177$341*
q+M]}):(G=u[M*q+t.$jscomp$loop$prop$i$177$341]||(u[M*q+t.$jscomp$loop$prop$i$177$341]={source:null,target:null}),G.target={index:t.$jscomp$loop$prop$i$177$341,startAngle:r,endAngle:r+=m[t.$jscomp$loop$prop$i$177$341*q+M]*z,value:m[t.$jscomp$loop$prop$i$177$341*q+M]},t.$jscomp$loop$prop$i$177$341===M&&(G.source=G.target));G.source&&G.target&&G.source.value<G.target.value&&(M=G.source,G.source=G.target,G.target=M)}v[t.$jscomp$loop$prop$i$177$341]={index:t.$jscomp$loop$prop$i$177$341,startAngle:A,endAngle:r,
...
u=F[0];F=F[1];B=sb(u,F,B);B=Zb(Math.floor(u/B)*B,Math.floor(F/B)*B,B)}return B.map(function(v){return b(q,v)})}function b(q,B){var F=[],u=[];f(q,B,function(v){m(v,q,B);for(var z=0,C=v.length,r=v[C-1][1]*v[0][0]-v[C-1][0]*v[0][1];++z<C;)r+=v[z-1][1]*v[z][0]-v[z-1][0]*v[z][1];0<r?F.push([v]):u.push(v)});u.forEach(function(v){for(var z=0,C=F.length,r;z<C;++z){a:{var t=(r=F[z])[0];for(var A=v,E=-1,G=A.length;++E<G;){b:{var M=t;for(var U=A[E],W=U[0],da=U[1],ka=-1,Y=0,Z=M.length,qa=Z-1;Y<Z;qa=Y++){var oa=
...
ring:[U,M]}}var v=[],z=[],C;var r=C=-1;var t=q[0]>=B;for(Hc[t<<1].forEach(u);++r<h-1;){var A=t;t=q[r+1]>=B;Hc[A|t<<1].forEach(u)}for(Hc[t<<0].forEach(u);++C<k-1;){r=-1;t=q[C*h+h]>=B;var E=q[C*h]>=B;for(Hc[t<<1|E<<2].forEach(u);++r<h-1;){A=t;t=q[C*h+h+r+1]>=B;var G=E;E=q[C*h+r+1]>=B;Hc[A|t<<1|E<<2|G<<3].forEach(u)}Hc[t|E<<3].forEach(u)}r=-1;E=q[C*h]>=B;for(Hc[E<<2].forEach(u);++r<h-1;)G=E,E=q[C*h+r+1]>=B,Hc[E<<2|G<<3].forEach(u);Hc[E<<3].forEach(u)}function g(q,B,F){q.forEach(function(u){var v=u[0],
...
++v);return m.slice(G+1,E-1).replace(/""/g,'"')}for(;v<u;){if(10===(M=m.charCodeAt(E=v++)))t=!0;else if(13===M)t=!0,10===m.charCodeAt(v)&&++v;else if(M!==p)continue;return m.slice(G,E)}return r=!0,m.slice(G,u)}var F=[],u=m.length,v=0,z=0,C,r=0>=u,t=!1;10===m.charCodeAt(u-1)&&--u;for(13===m.charCodeAt(u-1)&&--u;(C=B())!==Qh;){for(var A=[];C!==Rk&&C!==Qh;)A.push(C),C=B();q&&null==(A=q(A,z++))||F.push(A)}return F}function f(m,q){return m.map(function(B){return q.map(function(F){return h(B[F])}).join(a)})}
...
b){b=Kf(a,b);if(!b)return a+"";a=b[0];b=b[1];return 0>b?"0."+Array(-b).join("0")+a:a.length>b+1?a.slice(0,b+1)+"."+a.slice(b+1):a+Array(b-a.length+2).join("0")}function Xk(a){return a}function Yk(a){function b(F){function u(Z){var qa=W,oa=da,wa,La;if("c"===U)oa=ka(Z)+oa,Z="";else{Z=+Z;var ta=0>Z||0>1/Z;Z=isNaN(Z)?B:ka(Math.abs(Z),G);if(M){var Ia=Z.length,Ta=1,Q=-1;a:for(;Ta<Ia;++Ta)switch(Z[Ta]){case ".":Q=wa=Ta;break;case "0":0===Q&&(Q=Ta);wa=Ta;break;default:if(!+Z[Ta])break a;0<Q&&(Q=0)}Z=0<Q?
...
case "^":Z=ta.slice(0,La=ta.length>>1)+qa+Z+oa+ta.slice(La);break;default:Z=ta+qa+Z+oa}return p(Z)}F=Ce(F);var v=F.fill,z=F.align,C=F.sign,r=F.symbol,t=F.zero,A=F.width,E=F.comma,G=F.precision,M=F.trim,U=F.type;"n"===U?(E=!0,U="g"):al[U]||(void 0===G&&(G=12),M=!0,U="g");if(t||"0"===v&&"="===z)t=!0,v="0",z="=";var W="$"===r?g:"#"===r&&/[boxX]/.test(U)?"0"+U.toLowerCase():"",da="$"===r?h:/[%p]/.test(U)?m:"",ka=al[U],Y=/[defgprs%]/.test(U);G=void 0===G?6:/[gprs]/.test(U)?Math.max(1,Math.min(21,G)):Math.max(0,
...
g,g=h;g.n=h=a[0];h.p=g}}function gi(a){return ib(a[0])<=gb?a[0]:gc(a[0])*((ib(a[0])+gb)%Xb-gb)}function Kl(a,b){var f=gi(b);b=b[1];var g=Ra(b),h=[Ra(f),-Ua(f),0],k=0,p=0,m=new yb;1===g?b=qb+1E-6:-1===g&&(b=-qb-1E-6);g=0;for(var q=a.length;g<q;++g)if(F=(B=a[g]).length){var B,F,u=B[F-1],v=gi(u),z=u[1]/2+Of,C=Ra(z),r=Ua(z);for(z=0;z<F;++z,v=A,C=E,r=G,u=t){var t=B[z],A=gi(t);G=t[1]/2+Of;var E=Ra(G),G=Ua(G),M=A-v,U=0<=M?1:-1,W=U*M,da=W>gb;C*=E;m.add(Tb(C*U*Ra(W),r*G+C*Ua(W)));k+=da?M+U*Xb:M;da^v>=f^A>=
f&&(u=Rd(pd(u),pd(t)),Tf(u),v=Rd(h,u),Tf(v),v=(da^0<=M?-1:1)*Sb(v[2]),b>v||b===v&&(u[0]||u[1]))&&(p+=da^0<=M?1:-1)}}return(-1E-6>k||1E-6>k&&-1E-12>m)^p&1}function Ll(a,b,f,g){return function(h){function k(M,U){a(M,U)&&h.point(M,U)}function p(M,U){v.point(M,U)}function m(){G.point=p;v.lineStart()}function q(){G.point=k;v.lineEnd()}function B(M,U){E.push([M,U]);C.point(M,U)}function F(){C.lineStart();E=[]}function u(){B(E[0][0],E[0][1]);C.lineEnd();var M=C.clean(),U=z.result(),W=U.length,da;E.pop();
t.push(E);E=null;if(W)if(M&1){if(W=U[0],0<(U=W.length-1)){r||(h.polygonStart(),r=!0);h.lineStart();for(M=0;M<U;++M)h.point((da=W[M])[0],da[1]);h.lineEnd()}}else 1<W&&M&2&&U.push(U.pop().concat(U.shift())),A.push(U.filter(Bs))}var v=b(h),z=Hl(),C=b(z),r=!1,t,A,E,G={point:k,lineStart:m,lineEnd:q,polygonStart:function(){G.point=B;G.lineStart=F;G.lineEnd=u;A=[];t=[]},polygonEnd:function(){G.point=k;G.lineStart=m;G.lineEnd=q;A=hd(A);var M=Kl(t,g);A.length?(r||(h.polygonStart(),r=!0),Il(A,Cs,M,f,h)):M&&
...
C=h*C/r;r=-h*u/r;u=Rd(z,v);z=Sf(z,C);v=Sf(v,r);Xh(z,v);v=Rf(z,u);C=Rf(u,u);r=v*v-C*(Rf(z,z)-1);if(!(0>r)){var t=Gb(r);r=Sf(u,(-v-t)/C);Xh(r,z);r=Qf(r);if(!F)return r;F=q[0];var A=B[0];q=q[1];B=B[1];if(A<F){var E=F;F=A;A=E}var G=A-F,M=1E-6>ib(G-gb);!M&&B<q&&(E=q,q=B,B=E);if(M||1E-6>G?M?0<q+B^r[1]<(1E-6>ib(r[0]-F)?q:B):q<=r[1]&&r[1]<=B:G>gb^(F<=r[0]&&r[0]<=A))return B=Sf(u,(-v+t)/C),Xh(B,z),[r,Qf(B)]}}function g(q,B){var F=p?a:gb-a,u=0;q<-F?u|=1:q>F&&(u|=2);B<-F?u|=4:B>F&&(u|=8);return u}var h=Ua(a),
...
0:3:1E-6>ib(q[0]-f)?0<B?2:1:1E-6>ib(q[1]-b)?0<B?1:0:0<B?3:2}function p(q,B){return m(q.x,B.x)}function m(q,B){var F=k(q,1),u=k(B,1);return F!==u?F-u:0===F?B[1]-q[1]:1===F?q[0]-B[0]:2===F?q[1]-B[1]:B[0]-q[0]}return function(q){function B(Y,Z){a<=Y&&Y<=f&&b<=Z&&Z<=g&&u.point(Y,Z)}function F(Y,Z){var qa=a<=Y&&Y<=f&&b<=Z&&Z<=g;C&&r.push([Y,Z]);if(W)t=Y,A=Z,E=qa,W=!1,qa&&(u.lineStart(),u.point(Y,Z));else if(qa&&U)u.point(Y,Z);else{var oa=[G=Math.max(-1E9,Math.min(1E9,G)),M=Math.max(-1E9,Math.min(1E9,M))],
wa=[Y=Math.max(-1E9,Math.min(1E9,Y)),Z=Math.max(-1E9,Math.min(1E9,Z))];Ds(oa,wa,a,b,f,g)?(U||(u.lineStart(),u.point(oa[0],oa[1])),u.point(wa[0],wa[1]),qa||u.lineEnd(),da=!1):qa&&(u.lineStart(),u.point(Y,Z),da=!1)}G=Y;M=Z;U=qa}var u=q,v=Hl(),z,C,r,t,A,E,G,M,U,W,da,ka={point:B,lineStart:function(){ka.point=F;C&&C.push(r=[]);W=!0;U=!1;G=M=NaN},lineEnd:function(){z&&(F(t,A),E&&U&&v.rejoin(),z.push(v.result()));ka.point=B;U&&u.lineEnd()},polygonStart:function(){u=v;z=[];C=[];da=!0},polygonEnd:function(){for(var Y,
...
F,f,F).filter(function(G){return 1E-6<ib(G%v)}).map(C)).concat(Zb(gg(m/u)*u,p,u).filter(function(G){return 1E-6<ib(G%z)}).map(r))}var f,g,h,k,p,m,q,B,F=10,u=F,v=90,z=360,C,r,t,A,E=2.5;a.lines=function(){return b().map(function(G){return{type:"LineString",coordinates:G}})};a.outline=function(){return{type:"Polygon",coordinates:[t(k).concat(A(q).slice(1),t(h).reverse().slice(1),A(B).reverse().slice(1))]}};a.extent=function(G){return arguments.length?a.extentMajor(G).extentMinor(G):a.extentMinor()};
a.extentMajor=function(G){if(!arguments.length)return[[k,B],[h,q]];k=+G[0][0];h=+G[1][0];B=+G[0][1];q=+G[1][1];k>h&&(G=k,k=h,h=G);B>q&&(G=B,B=q,q=G);return a.precision(E)};a.extentMinor=function(G){if(!arguments.length)return[[g,m],[f,p]];g=+G[0][0];f=+G[1][0];m=+G[0][1];p=+G[1][1];g>f&&(G=g,g=f,f=G);m>p&&(G=m,m=p,p=G);return a.precision(E)};a.step=function(G){return arguments.length?a.stepMajor(G).stepMinor(G):a.stepMinor()};a.stepMajor=function(G){if(!arguments.length)return[v,z];v=+G[0];z=+G[1];
return a};a.stepMinor=function(G){if(!arguments.length)return[F,u];F=+G[0];u=+G[1];return a};a.precision=function(G){if(!arguments.length)return E;E=+G;C=Sl(m,p,90);r=Tl(g,f,E);t=Sl(B,q,90);A=Tl(k,h,E);return a};return a.extentMajor([[-180,-89.999999],[180,89.999999]]).extentMinor([[-180,-80.000001],[180,80.000001]])}function Js(){Kc.point=Ks}function Ks(a,b){Kc.point=Vl;Wl=ki=a;Xl=li=b}function Vl(a,b){mi.add(li*a-ki*b);ki=a;li=b}function Ls(){Vl(Wl,Xl)}function rd(a,b){ni+=a;oi+=b;++He}function Yl(){hc.point=
...
f){b=a(b,f);this.stream.point(b[0],b[1])}})}function jm(a,b){function f(g,h,k,p,m,q,B,F,u,v,z,C,r,t){var A=B-g,E=F-h,G=A*A+E*E;if(G>4*b&&r--){var M=p+v,U=m+z,W=q+C,da=Gb(M*M+U*U+W*W),ka=Sb(W/=da),Y=1E-6>ib(ib(W)-1)||1E-6>ib(k-u)?(k+u)/2:Tb(U,M),Z=a(Y,ka);ka=Z[0];Z=Z[1];var qa=ka-g,oa=Z-h,wa=E*qa-A*oa;if(wa*wa/G>b||.3<ib((A*qa+E*oa)/G-.5)||p*v+m*z+q*C<Ss)f(g,h,k,p,m,q,ka,Z,Y,M/=da,U/=da,W,r,t),t.point(ka,Z),f(ka,Z,Y,M,U,W,B,F,u,v,z,C,r,t)}}return function(g){function h(ka,Y){ka=a(ka,Y);g.point(ka[0],
ka[1])}function k(){E=NaN;da.point=p;g.lineStart()}function p(ka,Y){var Z=pd([ka,Y]);Y=a(ka,Y);f(E,G,A,M,U,W,E=Y[0],G=Y[1],A=ka,M=Z[0],U=Z[1],W=Z[2],16,g);g.point(E,G)}function m(){da.point=h;g.lineEnd()}function q(){k();da.point=B;da.lineEnd=F}function B(ka,Y){p(u=ka,Y);v=E;z=G;C=M;r=U;t=W;da.point=p}function F(){f(E,G,A,M,U,W,v,z,u,C,r,t,16,g);da.lineEnd=m;m()}var u,v,z,C,r,t,A,E,G,M,U,W,da={point:h,lineStart:k,lineEnd:m,polygonStart:function(){g.polygonStart();da.lineStart=q},polygonEnd:function(){g.polygonEnd();
...
function zc(a){return wi(function(){return a})()}function wi(a){function b(ta){return oa(ta[0]*Xa,ta[1]*Xa)}function f(ta){return(ta=oa.invert(ta[0],ta[1]))&&[ta[0]*nb,ta[1]*nb]}function g(){var ta=km(p,0,0,t,A,r).apply(null,k(B,F));ta=km(p,m-ta[0],q-ta[1],t,A,r);C=fi(u,v,z);qa=di(k,ta);oa=di(C,qa);ta=qa;Z=+Y?jm(ta,Y):im(ta);return h()}function h(){wa=La=null;return b}var k,p=150,m=480,q=250,B=0,F=0,u=0,v=0,z=0,C,r=0,t=1,A=1,E=null,G=xi,M=null,U,W,da,ka=Ne,Y=.5,Z,qa,oa,wa,La;b.stream=function(ta){return wa&&
La===ta?wa:wa=Vs(Ts(C)(G(Z(ka(La=ta)))))};b.preclip=function(ta){return arguments.length?(G=ta,E=void 0,h()):G};b.postclip=function(ta){return arguments.length?(ka=ta,M=U=W=da=null,h()):ka};b.clipAngle=function(ta){return arguments.length?(G=+ta?Ml(E=ta*Xa):(E=null,xi),h()):E*nb};b.clipExtent=function(ta){return arguments.length?(ka=null==ta?(M=U=W=da=null,Ne):cg(M=+ta[0][0],U=+ta[0][1],W=+ta[1][0],da=+ta[1][1]),h()):null==M?null:[[M,U],[W,da]]};b.scale=function(ta){return arguments.length?(p=+ta,
...
b,f,g,h,k){for(var p=[],m=b.children,q,B,F=q=0,u=m.length,v,z=b.value,C,r,t,A,E,G;q<u;){b=h-f;v=k-g;do C=m[F++].value;while(!C&&F<u);r=t=C;G=Math.max(v/b,b/v)/(z*a);A=C*C*G;for(E=Math.max(t/A,A/r);F<u;++F){C+=B=m[F].value;B<r&&(r=B);B>t&&(t=B);A=C*C*G;A=Math.max(t/A,A/r);if(A>E){C-=B;break}E=A}p.push(q={value:C,dice:b<v,children:m.slice(q,F)});q.dice?Se(q,f,g,h,z?g+=v*C/z:k):rg(q,f,g,z?f+=b*C/z:h,k);z-=C;q=F}return p}function lt(a,b,f){return(b[0]-a[0])*(f[1]-a[1])-(b[1]-a[1])*(f[0]-a[0])}function mt(a,
...
qa.charCodeAt(oa++))return-1}return oa}var h=a.dateTime,k=a.date,p=a.time,m=a.periods,q=a.days,B=a.shortDays,F=a.months,u=a.shortMonths,v=Xe(m),z=Ye(m),C=Xe(q),r=Ye(q),t=Xe(B),A=Ye(B),E=Xe(F),G=Ye(F),M=Xe(u),U=Ye(u),W={a:function(Y){return B[Y.getDay()]},A:function(Y){return q[Y.getDay()]},b:function(Y){return u[Y.getMonth()]},B:function(Y){return F[Y.getMonth()]},c:null,d:bn,e:bn,f:yt,g:zt,G:At,H:Bt,I:Ct,j:Dt,L:cn,m:Et,M:Ft,p:function(Y){return m[+(12<=Y.getHours())]},q:function(Y){return 1+~~(Y.getMonth()/
...
function Bu(a){return a instanceof Date?+a:+new Date(+a)}function Zi(a,b,f,g,h,k,p,m,q,B){function F(W){return(q(W)<W?C:m(W)<W?r:p(W)<W?t:k(W)<W?A:g(W)<W?h(W)<W?E:G:f(W)<W?M:U)(W)}var u=ae()(Cb,Cb),v=u.invert,z=u.domain,C=B(".%L"),r=B(":%S"),t=B("%I:%M"),A=B("%I %p"),E=B("%a %d"),G=B("%b %d"),M=B("%B"),U=B("%Y");u.invert=function(W){return new Date(v(W))};u.domain=function(W){return arguments.length?z(Array.from(W,Bu)):z().map(Au)};u.ticks=function(W){var da=z();return a(da[0],da[da.length-1],null==
...
Math.sqrt(C);q=(m*m-u*u+h*C)/(2*u*g*t);m=(m*m-u*u-h*C)/(2*m*g*t);var A=Math.log(Math.sqrt(q*q+1)-q);r=(Math.log(Math.sqrt(m*m+1)-m)-A)/f;m=function(E){E*=r;var G=mk(A),M=f*E+A;var U=((M=Math.exp(2*M))-1)/(M+1);var W=A;M=((W=Math.exp(W))-1/W)/2;U=u/(g*t)*(G*U-M);return[B+U*v,F+U*z,u*G/mk(f*E+A)]}}m.duration=1E3*r*f/Math.SQRT2;return m}p.rho=function(m){m=Math.max(.001,+m);var q=m*m;return k(m,q,q*q)};return p}(Math.SQRT2,2,4),cv=nk(uf),dv=nk(Fb),ev=ok(uf),fv=ok(Fb),gv=pk(uf),Ig=pk(Fb),Kd=0,we=0,ye=
...
(v/=le);C.amplitude=function(t){return z(t,v*le)};C.period=function(t){return z(u,t)};return C}(1,.3),ov={time:null,delay:0,duration:250,ease:Ch};kd.prototype.interrupt=function(u){return this.each(function(){nd(this,u)})};kd.prototype.transition=function(u){var v;if(u instanceof vc){var z=u._id;u=u._name}else z=++ao,(v=ov).time=te(),u=null==u?null:u+"";for(var C=this._groups,r=C.length,t=0;t<r;++t)for(var A=C[t],E=A.length,G,M=0;M<E;++M)if(G=A[M]){var U=G,W=u,da=z,ka=M,Y=A,Z;if(!(Z=v))for(Z=void 0;!(Z=
G.__transition)||!(Z=Z[z]);)if(!(G=G.parentNode))throw Error("transition "+z+" not found");Bf(U,W,da,ka,Y,Z)}return new vc(C,this._parents,u,z)};var pv=[null],Ih=function(u){return function(){return u}},Ek={name:"drag"},Hh={name:"space"},Ld={name:"handle"},Md={name:"center"},mj=Math,Dk=mj.abs,Mb=mj.max,Nb=mj.min,Ef={name:"x",handles:["w","e"].map(Ae),input:function(u,v){return null==u?null:[[+u[0],v[0][1]],[+u[1],v[1][1]]]},output:function(u){return u&&[u[0][0],u[1][0]]}},Df={name:"y",handles:["n",
...
v){this._+="L"+(this._x1=+u)+","+(this._y1=+v)},quadraticCurveTo:function(u,v,z,C){this._+="Q"+ +u+","+ +v+","+(this._x1=+z)+","+(this._y1=+C)},bezierCurveTo:function(u,v,z,C,r,t){this._+="C"+ +u+","+ +v+","+ +z+","+ +C+","+(this._x1=+r)+","+(this._y1=+t)},arcTo:function(u,v,z,C,r){u=+u;v=+v;z=+z;C=+C;r=+r;var t=this._x1,A=this._y1,E=z-u,G=C-v,M=t-u,U=A-v,W=M*M+U*U;if(0>r)throw Error("negative radius: "+r);if(null===this._x1)this._+="M"+(this._x1=u)+","+(this._y1=v);else if(1E-6<W)if(1E-6<Math.abs(U*
E-G*M)&&r){z-=t;C-=A;var da=E*E+G*G;A=Math.sqrt(da);t=Math.sqrt(W);W=r*Math.tan((nj-Math.acos((da+W-(z*z+C*C))/(2*A*t)))/2);t=W/t;W/=A;1E-6<Math.abs(t-1)&&(this._+="L"+(u+t*M)+","+(v+t*U));this._+="A"+r+","+r+",0,0,"+ +(U*z>M*C)+","+(this._x1=u+W*E)+","+(this._y1=v+W*G)}else this._+="L"+(this._x1=u)+","+(this._y1=v)},arc:function(u,v,z,C,r,t){u=+u;v=+v;z=+z;t=!!t;var A=z*Math.cos(C),E=z*Math.sin(C),G=u+A,M=v+E,U=1^t;C=t?C-r:r-C;if(0>z)throw Error("negative radius: "+z);if(null===this._x1)this._+=
"M"+G+","+M;else if(1E-6<Math.abs(this._x1-G)||1E-6<Math.abs(this._y1-M))this._+="L"+G+","+M;z&&(0>C&&(C=C%oj+oj),C>rv?this._+="A"+z+","+z+",0,1,"+U+","+(u-A)+","+(v-E)+"A"+z+","+z+",0,1,"+U+","+(this._x1=G)+","+(this._y1=M):1E-6<C&&(this._+="A"+z+","+z+",0,"+ +(C>=nj)+","+U+","+(this._x1=u+z*Math.cos(r))+","+(this._y1=v+z*Math.sin(r))))},rect:function(u,v,z,C){this._+="M"+(this._x0=this._x1=+u)+","+(this._y0=this._y1=+v)+"h"+ +z+"v"+ +C+"h"+-z+"Z"},toString:function(){return this._}};var Or=Array.prototype.slice,
...
u[t];r[2*t]=v(A);r[2*t+1]=z(A)}return new Oc(r)};Oc.prototype.update=function(){for(var u,v,z=this.coords,C=this._hullPrev,r=this._hullNext,t=this._hullTri,A=this._hullHash,E=z.length>>1,G=Infinity,M=Infinity,U=-Infinity,W=-Infinity,da=0;da<E;da++){var ka=z[2*da];u=z[2*da+1];ka<G&&(G=ka);u<M&&(M=u);ka>U&&(U=ka);u>W&&(W=u);this._ids[da]=da}U=(G+U)/2;M=(M+W)/2;G=Infinity;for(W=0;W<E;W++)if(da=Oh(U,M,z[2*W],z[2*W+1]),da<G){var Y=W;G=da}M=z[2*Y];W=z[2*Y+1];G=Infinity;for(U=0;U<E;U++)if(U!==Y&&(da=Oh(M,
W,z[2*U],z[2*U+1]),da<G&&0<da)){var Z=U;G=da}G=z[2*Z];U=z[2*Z+1];u=Infinity;for(da=0;da<E;da++)if(da!==Y&&da!==Z){ka=G-M;var qa=U-W;v=z[2*da]-M;var oa=z[2*da+1]-W,wa=ka*ka+qa*qa,La=v*v+oa*oa,ta=.5/(ka*oa-qa*v);qa=(oa*wa-qa*La)*ta;ka=(ka*La-v*wa)*ta;ka=qa*qa+ka*ka;if(ka<u){var Ia=da;u=ka}}da=z[2*Ia];ka=z[2*Ia+1];if(Infinity===u){for(r=0;r<E;r++)this._dists[r]=z[2*r]-z[0]||z[2*r+1]-z[1];Pd(this._ids,this._dists,0,E-1);r=new Uint32Array(E);C=z=0;for(t=-Infinity;C<E;C++)A=this._ids[C],this._dists[A]>
t&&(r[z++]=A,t=this._dists[A]);this.hull=r.subarray(0,z);this.triangles=new Uint32Array(0);this.halfedges=new Uint32Array(0)}else{Gf(M,W,G,U,da,ka)&&(u=Z,v=G,wa=U,Z=Ia,G=da,U=ka,Ia=u,da=v,ka=wa);v=G-M;u=U-W;wa=da-M;oa=ka-W;La=v*v+u*u;ta=wa*wa+oa*oa;qa=.5/(v*oa-u*wa);u=M+(oa*La-u*ta)*qa;v=W+(v*ta-wa*La)*qa;this._cx=u;this._cy=v;for(wa=0;wa<E;wa++)this._dists[wa]=Oh(z[2*wa],z[2*wa+1],u,v);Pd(this._ids,this._dists,0,E-1);this._hullStart=Y;E=3;r[Y]=C[Ia]=Z;r[Z]=C[Y]=Ia;r[Ia]=C[Z]=Y;t[Y]=0;t[Z]=1;t[Ia]=
2;A.fill(-1);A[this._hashKey(M,W)]=Y;A[this._hashKey(G,U)]=Z;A[this._hashKey(da,ka)]=Ia;this.trianglesLen=0;this._addTriangle(Y,Z,Ia,-1,-1,-1);M=0;for(G=W=void 0;M<this._ids.length;M++)if(U=this._ids[M],da=z[2*U],ka=z[2*U+1],!(0<M&&Math.abs(da-W)<=ho&&Math.abs(ka-G)<=ho)&&(W=da,G=ka,U!==Y&&U!==Z&&U!==Ia)){v=u=0;for(wa=this._hashKey(da,ka);v<this._hashSize&&(u=A[(wa+v)%this._hashSize],-1===u||u===r[u]);v++);v=u=C[u];for(wa=void 0;wa=r[v],!Gf(da,ka,z[2*v],z[2*v+1],z[2*wa],z[2*wa+1]);)if(v=wa,v===u){v=
...
z[u],E=u-u%3;t=E+(u+2)%3;if(-1===A){if(0===r)break;u=Jg[--r]}else{var G=A-A%3,M=G+(A+2)%3,U=v[t],W=v[u],da=v[E+(u+1)%3];E=v[M];var ka=C[2*E],Y=C[2*E+1],Z=C[2*U]-ka,qa=C[2*U+1]-Y,oa=C[2*W]-ka;W=C[2*W+1]-Y;ka=C[2*da]-ka;da=C[2*da+1]-Y;Y=oa*oa+W*W;var wa=ka*ka+da*da;if(0>Z*(W*wa-Y*da)-qa*(oa*wa-Y*ka)+(Z*Z+qa*qa)*(oa*da-W*ka)){v[u]=E;v[A]=U;U=z[M];if(-1===U){E=this._hullStart;do{if(this._hullTri[E]===M){this._hullTri[E]=u;break}E=this._hullPrev[E]}while(E!==this._hullStart)}this._link(u,U);this._link(A,
z[t]);this._link(t,M);t=G+(A+1)%3;r<Jg.length&&(Jg[r++]=t)}else{if(0===r)break;u=Jg[--r]}}}return t};Oc.prototype._link=function(u,v){this._halfedges[u]=v;-1!==v&&(this._halfedges[v]=u)};Oc.prototype._addTriangle=function(u,v,z,C,r,t){var A=this.trianglesLen;this._triangles[A]=u;this._triangles[A+1]=v;this._triangles[A+2]=z;this._link(A,C);this._link(A+1,r);this._link(A+2,t);this.trianglesLen+=3;return A};var ec=function(){this._x0=this._y0=this._x1=this._y1=null;this._=""};ec.prototype.moveTo=function(u,
...
function(){var u=this.delaunay,v=u.points,z=u.hull,C=u.triangles;u=this.vectors;for(var r=this.circumcenters=this._circumcenters.subarray(0,C.length/3*2),t=0,A=0,E=C.length,G,M;t<E;t+=3,A+=2){M=2*C[t];var U=2*C[t+1],W=2*C[t+2];G=v[M];M=v[M+1];var da=v[W],ka=v[W+1];W=v[U]-G;var Y=v[U+1]-M;U=da-G;var Z=ka-M,qa=W*W+Y*Y,oa=U*U+Z*Z,wa=2*(W*Z-Y*U);wa?1E-8>Math.abs(wa)?(G=(G+da)/2,M=(M+ka)/2):(da=1/wa,G+=(Z*qa-Y*oa)*da,M+=(W*oa-U*qa)*da):(G=(G+da)/2-1E8*Z,M=(M+ka)/2+1E8*U);r[A]=G;r[A+1]=M}C=z[z.length-1];
t=4*C;E=v[2*C];M=v[2*C+1];u.fill(0);for(W=0;W<z.length;++W)C=z[W],r=t,A=E,G=M,t=4*C,E=v[2*C],M=v[2*C+1],u[r+2]=u[t]=G-M,u[r+3]=u[t+1]=E-A};zb.prototype.render=function(u){var v=null==u?u=new ec:void 0,z=this.delaunay,C=z.halfedges,r=z.inedges;z=z.hull;var t=this.circumcenters,A=this.vectors;if(1>=z.length)return null;for(var E=0,G=C.length;E<G;++E){var M=C[E];if(!(M<E)){var U=2*Math.floor(E/3);M=2*Math.floor(M/3);this._renderSegment(t[U],t[U+1],t[M],t[M+1],u)}}C=z[z.length-1];for(E=0;E<z.length;++E)M=
C,C=z[E],U=2*Math.floor(r[C]/3),G=t[U],U=t[U+1],M*=4,(M=this._project(G,U,A[M+2],A[M+3]))&&this._renderSegment(G,U,M[0],M[1],u);return v&&v.value()};zb.prototype.renderBounds=function(u){var v=null==u?u=new ec:void 0;u.rect(this.xmin,this.ymin,this.xmax-this.xmin,this.ymax-this.ymin);return v&&v.value()};zb.prototype.renderCell=function(u,v){var z=null==v?v=new ec:void 0;u=this._clip(u);if(null!==u&&u.length){v.moveTo(u[0],u[1]);for(var C=u.length;u[0]===u[C-2]&&u[1]===u[C-1]&&1<C;)C-=2;for(var r=
2;r<C;r+=2)u[r]===u[r-2]&&u[r+1]===u[r-1]||v.lineTo(u[r],u[r+1]);v.closePath();return z&&z.value()}};zb.prototype.cellPolygons=function v(){var z=this,C,r,t,A,E,G;return $jscomp.generator.createGenerator(v,function(M){switch(M.nextAddress){case 1:C=z,r=C.delaunay,t=r.points,A=0,E=t.length/2;case 2:if(!(A<E)){M.jumpTo(0);break}G=z.cellPolygon(A);if(!G){M.jumpTo(3);break}G.index=A;return M.yield(G,6);case 6:case 3:++A,M.jumpTo(2)}})};zb.prototype.cellPolygon=function(v){var z=new yd;this.renderCell(v,
z);return z.value()};zb.prototype._renderSegment=function(v,z,C,r,t){var A=this._regioncode(v,z),E=this._regioncode(C,r);if(0===A&&0===E)t.moveTo(v,z),t.lineTo(C,r);else if(v=this._clipSegment(v,z,C,r,A,E))t.moveTo(v[0],v[1]),t.lineTo(v[2],v[3])};zb.prototype.contains=function(v,z,C){return(z=+z,z!==z)||(C=+C,C!==C)?!1:this.delaunay._step(v,z,C)===v};zb.prototype.neighbors=function C(z){var r=this,t,A,E,G,M,U,W,da,ka;return $jscomp.generator.createGenerator(C,function(Y){switch(Y.nextAddress){case 1:t=
r._clip(z);if(!t){Y.jumpTo(0);break}A=$jscomp.makeIterator(r.delaunay.neighbors(z));E=A.next();case 3:if(E.done){Y.jumpTo(0);break}G=E.value;M=r._clip(G);if(!M){Y.jumpTo(4);break}U=0;W=t.length;case 9:if(!(U<W)){Y.jumpTo(4);break}da=0;ka=M.length;case 10:if(!(da<ka)){U+=2;Y.jumpTo(9);break}if(t[U]!=M[da]||t[U+1]!=M[da+1]||t[(U+2)%W]!=M[(da+ka-2)%ka]||t[(U+3)%W]!=M[(da+ka-1)%ka]){Y.jumpTo(11);break}return Y.yield(G,14);case 14:Y.jumpTo(4);break;case 11:da+=2;Y.jumpTo(10);break;case 4:E=A.next(),Y.jumpTo(3)}})};
zb.prototype._cell=function(z){var C=this.circumcenters,r=this.delaunay,t=r.halfedges,A=r.triangles;r=r.inedges[z];if(-1===r)return null;var E=[],G=r;do{var M=Math.floor(G/3);E.push(C[2*M],C[2*M+1]);G=2===G%3?G-2:G+1;if(A[G]!==z)break;G=t[G]}while(G!==r&&-1!==G);return E};zb.prototype._clip=function(z){if(0===z&&1===this.delaunay.hull.length)return[this.xmax,this.ymin,this.xmax,this.ymax,this.xmin,this.ymax,this.xmin,this.ymin];var C=this._cell(z);if(null===C)return null;var r=this.vectors,t=4*z;
return r[t]||r[t+1]?this._clipInfinite(z,C,r[t],r[t+1],r[t+2],r[t+3]):this._clipFinite(z,C)};zb.prototype._clipFinite=function(z,C){for(var r=C.length,t=null,A,E,G=C[r-2],M=C[r-1],U,W=this._regioncode(G,M),da,ka,Y=0;Y<r;Y+=2)if(A=G,E=M,G=C[Y],M=C[Y+1],U=W,W=this._regioncode(G,M),0===U&&0===W)ka=0,t?t.push(G,M):t=[G,M];else{if(0===U){if(null===(A=this._clipSegment(A,E,G,M,U,W)))continue;E=$jscomp.makeIterator(A);E.next();E.next();A=E.next().value;U=E.next().value}else{if(null===(A=this._clipSegment(G,
...
this.xmin,this.ymax,this.xmin,this.ymin];return t};zb.prototype._clipSegment=function(z,C,r,t,A,E){for(;;){if(0===A&&0===E)return[z,C,r,t];if(A&E)return null;var G=A||E;if(G&8){G=z+(r-z)*(this.ymax-C)/(t-C);var M=this.ymax}else G&4?(G=z+(r-z)*(this.ymin-C)/(t-C),M=this.ymin):G&2?(M=C+(t-C)*(this.xmax-z)/(r-z),G=this.xmax):(M=C+(t-C)*(this.xmin-z)/(r-z),G=this.xmin);A?(z=G,C=M,A=this._regioncode(z,C)):(r=G,t=M,E=this._regioncode(r,t))}};zb.prototype._clipInfinite=function(z,C,r,t,A,E){C=Array.from(C);
var G;(G=this._project(C[0],C[1],r,t))&&C.unshift(G[0],G[1]);(G=this._project(C[C.length-2],C[C.length-1],A,E))&&C.push(G[0],G[1]);if(C=this._clipFinite(z,C))for(r=0,t=C.length,E=this._edgecode(C[t-2],C[t-1]);r<t;r+=2)A=E,E=this._edgecode(C[r],C[r+1]),A&&E&&(r=this._edge(z,A,E,C,r),t=C.length);else this.contains(z,(this.xmin+this.xmax)/2,(this.ymin+this.ymax)/2)&&(C=[this.xmin,this.ymin,this.xmax,this.ymin,this.xmax,this.ymax,this.xmin,this.ymax]);return C};zb.prototype._edge=function(z,C,r,t,A){for(;C!==
r;){var E=void 0,G=void 0;switch(C){case 5:C=4;continue;case 4:C=6;E=this.xmax;G=this.ymin;break;case 6:C=2;continue;case 2:C=10;E=this.xmax;G=this.ymax;break;case 10:C=8;continue;case 8:C=9;E=this.xmin;G=this.ymax;break;case 9:C=1;continue;case 1:C=5,E=this.xmin,G=this.ymin}t[A]===E&&t[A+1]===G||!this.contains(z,E,G)||(t.splice(A,0,E,G),A+=2)}if(4<t.length)for(z=0;z<t.length;z+=2)if(C=(z+2)%t.length,r=(z+4)%t.length,t[z]===t[C]&&t[C]===t[r]||t[z+1]===t[C+1]&&t[C+1]===t[r+1])t.splice(C,2),z-=2;return A};
zb.prototype._project=function(z,C,r,t){var A=Infinity,E;if(0>t){if(C<=this.ymin)return null;if((E=(this.ymin-C)/t)<A){var G=this.ymin;var M=z+(A=E)*r}}else if(0<t){if(C>=this.ymax)return null;(E=(this.ymax-C)/t)<A&&(G=this.ymax,M=z+(A=E)*r)}if(0<r){if(z>=this.xmax)return null;(E=(this.xmax-z)/r)<A&&(M=this.xmax,G=C+E*t)}else if(0>r){if(z<=this.xmin)return null;(E=(this.xmin-z)/r)<A&&(M=this.xmin,G=C+E*t)}return[M,G]};zb.prototype._edgecode=function(z,C){return(z===this.xmin?1:z===this.xmax?2:0)|
(C===this.ymin?4:C===this.ymax?8:0)};zb.prototype._regioncode=function(z,C){return(z<this.xmin?1:z>this.xmax?2:0)|(C<this.ymin?4:C>this.ymax?8:0)};var sv=2*Math.PI,me=Math.pow,Ob=function(z){this._delaunator=new Oc(z);this.inedges=new Int32Array(z.length/2);this._hullIndex=new Int32Array(z.length/2);this.points=this._delaunator.coords;this._init()};Ob.from=function(z,C,r,t){C=void 0===C?Wr:C;r=void 0===r?Xr:r;if("length"in z){for(var A=z.length,E=new Float64Array(2*A),G=0;G<A;++G){var M=z[G];E[2*
G]=C.call(t,M,G,z);E[2*G+1]=r.call(t,M,G,z)}z=E}else z=Float64Array.from(Ok(z,C,r,t));return new Ob(z)};Ob.prototype.update=function(){this._delaunator.update();this._init();return this};Ob.prototype._init=function(){var z=this._delaunator,C=this.points;if(z.hull&&2<z.hull.length&&Yr(z)){this.collinear=Int32Array.from({length:C.length/2},function(W,da){return da}).sort(function(W,da){return C[2*W]-C[2*da]||C[2*W+1]-C[2*da+1]});z=this.collinear[0];var r=this.collinear[this.collinear.length-1];z=[C[2*
z],C[2*z+1],C[2*r],C[2*r+1]];z=1E-8*Math.hypot(z[3]-z[1],z[2]-z[0]);r=0;for(var t=C.length/2;r<t;++r){var A=Zr(C[2*r],C[2*r+1],z);C[2*r]=A[0];C[2*r+1]=A[1]}this._delaunator=new Oc(C)}else delete this.collinear;A=this.halfedges=this._delaunator.halfedges;z=this.hull=this._delaunator.hull;var E=this.triangles=this._delaunator.triangles;r=this.inedges.fill(-1);t=this._hullIndex.fill(-1);for(var G=0,M=A.length;G<M;++G){var U=E[2===G%3?G-2:G+1];if(-1===A[G]||-1===r[U])r[U]=G}A=0;for(E=z.length;A<E;++A)t[z[A]]=
A;2>=z.length&&0<z.length&&(this.triangles=(new Int32Array(3)).fill(-1),this.halfedges=(new Int32Array(3)).fill(-1),this.triangles[0]=z[0],this.triangles[1]=z[1],this.triangles[2]=z[1],r[z[0]]=1,2===z.length&&(r[z[1]]=0))};Ob.prototype.voronoi=function(z){return new zb(this,z)};Ob.prototype.neighbors=function r(C){var t=this,A,E,G,M,U,W,da,ka,Y,Z,qa,oa;return $jscomp.generator.createGenerator(r,function(wa){switch(wa.nextAddress){case 1:A=t;E=A.inedges;G=A.hull;M=A._hullIndex;U=A.halfedges;W=A.triangles;
...
case 9:Z!==Y?wa.jumpTo(7):wa.jumpToEnd()}})};Ob.prototype.find=function(C,r,t){t=void 0===t?0:t;if((C=+C,C!==C)||(r=+r,r!==r))return-1;for(var A=t,E;0<=(E=this._step(t,C,r))&&E!==t&&E!==A;)t=E;return E};Ob.prototype._step=function(C,r,t){var A=this.inedges,E=this.hull,G=this._hullIndex,M=this.halfedges,U=this.triangles,W=this.points;if(-1===A[C]||!W.length)return(C+1)%(W.length>>1);var da=C,ka=me(r-W[2*C],2)+me(t-W[2*C+1],2),Y=A=A[C];do{var Z=U[Y],qa=me(r-W[2*Z],2)+me(t-W[2*Z+1],2);qa<ka&&(ka=qa,
da=Z);Y=2===Y%3?Y-2:Y+1;if(U[Y]!==C)break;Y=M[Y];if(-1===Y){Y=E[(G[C]+1)%E.length];if(Y!==Z&&me(r-W[2*Y],2)+me(t-W[2*Y+1],2)<ka)return Y;break}}while(Y!==A);return da};Ob.prototype.render=function(C){for(var r=null==C?C=new ec:void 0,t=this.points,A=this.halfedges,E=this.triangles,G=0,M=A.length;G<M;++G){var U=A[G];if(!(U<G)){var W=2*E[G];U=2*E[U];C.moveTo(t[W],t[W+1]);C.lineTo(t[U],t[U+1])}}this.renderHull(C);return r&&r.value()};Ob.prototype.renderPoints=function(C,r){r=void 0===r?2:r;for(var t=
null==C?C=new ec:void 0,A=this.points,E=0,G=A.length;E<G;E+=2){var M=A[E],U=A[E+1];C.moveTo(M+r,U);C.arc(M,U,r,0,sv)}return t&&t.value()};Ob.prototype.renderHull=function(C){var r=null==C?C=new ec:void 0,t=this.hull,A=this.points,E=2*t[0],G=t.length;C.moveTo(A[E],A[E+1]);for(E=1;E<G;++E){var M=2*t[E];C.lineTo(A[M],A[M+1])}C.closePath();return r&&r.value()};Ob.prototype.hullPolygon=function(){var C=new yd;this.renderHull(C);return C.value()};Ob.prototype.renderTriangle=function(C,r){var t=null==r?
r=new ec:void 0,A=this.points,E=this.triangles,G=2*E[C*=3],M=2*E[C+1];C=2*E[C+2];r.moveTo(A[G],A[G+1]);r.lineTo(A[M],A[M+1]);r.lineTo(A[C],A[C+1]);r.closePath();return t&&t.value()};Ob.prototype.trianglePolygons=function r(){var t=this,A,E,G,M;return $jscomp.generator.createGenerator(r,function(U){1==U.nextAddress&&(A=t,E=A.triangles,G=0,M=E.length/3);if(3!=U.nextAddress)return G<M?U.yield(t.trianglePolygon(G),3):U.jumpTo(0);++G;return U.jumpTo(2)})};Ob.prototype.trianglePolygon=function(r){var t=
...
Yb.copy=function(){var r=new Sh(this._x,this._y,this._x0,this._y0,this._x1,this._y1),t=this._root,A,E;if(!t)return r;if(!t.length)return r._root=Uk(t),r;for(A=[{source:t,target:r._root=Array(4)}];t=A.pop();)for(var G=0;4>G;++G)if(E=t.source[G])E.length?A.push({source:E,target:t.target[G]=Array(4)}):t.target[G]=Uk(E);return r};Yb.add=function(r){var t=+this._x.call(null,r),A=+this._y.call(null,r);return Tk(this.cover(t,A),t,A,r)};Yb.addAll=function(r){var t,A,E=r.length,G,M,U=Array(E),W=Array(E),da=
Infinity,ka=Infinity,Y=-Infinity,Z=-Infinity;for(A=0;A<E;++A)isNaN(G=+this._x.call(null,t=r[A]))||isNaN(M=+this._y.call(null,t))||(U[A]=G,W[A]=M,G<da&&(da=G),G>Y&&(Y=G),M<ka&&(ka=M),M>Z&&(Z=M));if(da>Y||ka>Z)return this;this.cover(da,ka).cover(Y,Z);for(A=0;A<E;++A)Tk(this,U[A],W[A],r[A]);return this};Yb.cover=function(r,t){if(isNaN(r=+r)||isNaN(t=+t))return this;var A=this._x0,E=this._y0,G=this._x1,M=this._y1;if(isNaN(A))G=(A=Math.floor(r))+1,M=(E=Math.floor(t))+1;else{for(var U=G-A||1,W=this._root,
da,ka;A>r||r>=G||E>t||t>=M;)switch(ka=(t<E)<<1|r<A,da=Array(4),da[ka]=W,W=da,U*=2,ka){case 0:G=A+U;M=E+U;break;case 1:A=G-U;M=E+U;break;case 2:G=A+U;E=M-U;break;case 3:A=G-U,E=M-U}this._root&&this._root.length&&(this._root=W)}this._x0=A;this._y0=E;this._x1=G;this._y1=M;return this};Yb.data=function(){var r=[];this.visit(function(t){if(!t.length){do r.push(t.data);while(t=t.next)}});return r};Yb.extent=function(r){return arguments.length?this.cover(+r[0][0],+r[0][1]).cover(+r[1][0],+r[1][1]):isNaN(this._x0)?
void 0:[[this._x0,this._y0],[this._x1,this._y1]]};Yb.find=function(r,t,A){var E=this._x0,G=this._y0,M,U,W,da,ka=this._x1,Y=this._y1,Z=[],qa=this._root,oa;qa&&Z.push(new Rb(qa,E,G,ka,Y));null==A?A=Infinity:(E=r-A,G=t-A,ka=r+A,Y=t+A,A*=A);for(;oa=Z.pop();)if(!(!(qa=oa.node)||(M=oa.x0)>ka||(U=oa.y0)>Y||(W=oa.x1)<E||(da=oa.y1)<G))if(qa.length){oa=(M+W)/2;var wa=(U+da)/2;Z.push(new Rb(qa[3],oa,wa,W,da),new Rb(qa[2],M,wa,oa,da),new Rb(qa[1],oa,U,W,wa),new Rb(qa[0],M,U,oa,wa));if(qa=(t>=wa)<<1|r>=oa)oa=
Z[Z.length-1],Z[Z.length-1]=Z[Z.length-1-qa],Z[Z.length-1-qa]=oa}else if(oa=r-+this._x.call(null,qa.data),wa=t-+this._y.call(null,qa.data),oa=oa*oa+wa*wa,oa<A){var La=Math.sqrt(A=oa);E=r-La;G=t-La;ka=r+La;Y=t+La;La=qa.data}return La};Yb.remove=function(r){if(isNaN(da=+this._x.call(null,r))||isNaN(ka=+this._y.call(null,r)))return this;var t,A=this._root,E,G=this._x0,M=this._y0,U=this._x1,W=this._y1,da,ka,Y,Z,qa,oa;if(!A)return this;if(A.length)for(;;){(qa=da>=(Y=(G+U)/2))?G=Y:U=Y;(oa=ka>=(Z=(M+W)/
...
Yb.size=function(){var r=0;this.visit(function(t){if(!t.length){do++r;while(t=t.next)}});return r};Yb.visit=function(r){var t=[],A,E=this._root,G,M,U,W;for(E&&t.push(new Rb(E,this._x0,this._y0,this._x1,this._y1));A=t.pop();)if(!r(E=A.node,M=A.x0,U=A.y0,W=A.x1,A=A.y1)&&E.length){var da=(M+W)/2,ka=(U+A)/2;(G=E[3])&&t.push(new Rb(G,da,ka,W,A));(G=E[2])&&t.push(new Rb(G,M,ka,da,A));(G=E[1])&&t.push(new Rb(G,da,U,W,ka));(G=E[0])&&t.push(new Rb(G,M,U,da,ka))}return this};Yb.visitAfter=function(r){var t=
[],A=[],E;for(this._root&&t.push(new Rb(this._root,this._x0,this._y0,this._x1,this._y1));E=t.pop();){var G=E.node;if(G.length){var M,U=E.x0,W=E.y0,da=E.x1,ka=E.y1,Y=(U+da)/2,Z=(W+ka)/2;(M=G[0])&&t.push(new Rb(M,U,W,Y,Z));(M=G[1])&&t.push(new Rb(M,Y,W,da,Z));(M=G[2])&&t.push(new Rb(M,U,Z,Y,ka));(M=G[3])&&t.push(new Rb(M,Y,Z,da,ka))}A.push(E)}for(;E=A.pop();)r(E.node,E.x0,E.y0,E.x1,E.y1);return this};Yb.x=function(r){return arguments.length?(this._x=r,this):this._x};Yb.y=function(r){return arguments.length?
...
ci,zl,Al,Ub,Vb,Wb,pc={sphere:tb,point:Zh,lineStart:wl,lineEnd:xl,polygonStart:function(){pc.lineStart=ys;pc.lineEnd=As},polygonEnd:function(){pc.lineStart=wl;pc.lineEnd=xl}};ei.invert=ei;var xi=Ll(function(){return!0},function(r){var t=NaN,A=NaN,E=NaN,G;return{lineStart:function(){r.lineStart();G=1},point:function(M,U){var W=0<M?gb:-gb,da=ib(M-t);if(1E-6>ib(da-gb))r.point(t,A=0<(A+U)/2?qb:-qb),r.point(E,A),r.lineEnd(),r.lineStart(),r.point(W,A),r.point(M,A),G=0;else if(E!==W&&da>=gb){1E-6>ib(t-E)&&
(t-=1E-6*E);1E-6>ib(M-W)&&(M-=1E-6*W);da=t;var ka=A,Y=M,Z,qa,oa=Ra(da-Y);A=1E-6<ib(oa)?Yd((Ra(ka)*(qa=Ua(U))*Ra(Y)-Ra(U)*(Z=Ua(ka))*Ra(da))/(Z*qa*oa)):(ka+U)/2;r.point(E,A);r.lineEnd();r.lineStart();r.point(W,A);G=0}r.point(t=M,A=U);E=W},lineEnd:function(){r.lineEnd();t=A=NaN},clean:function(){return 2-G}}},function(r,t,A,E){null==r?(A*=qb,E.point(-gb,A),E.point(0,A),E.point(gb,A),E.point(gb,0),E.point(gb,-A),E.point(0,-A),E.point(-gb,-A),E.point(-gb,0),E.point(-gb,A)):1E-6<ib(r[0]-t[0])?(r=r[0]<
...
polygonEnd:function(){this.stream.polygonEnd()}};var Ss=Ua(30*Xa),Vs=Me({point:function(r,t){this.stream.point(r*Xa,t*Xa)}}),rj=nm(function(r){return Gb(2/(1+r))});rj.invert=Oe(function(r){return 2*Sb(r/2)});var sj=nm(function(r){return(r=gl(r))&&r/Ra(r)});sj.invert=Oe(function(r){return r});Pe.invert=function(r,t){return[r,2*Yd(ko(t))-qb]};Qe.invert=Qe;var mg=Gb(3)/2;Ai.invert=function(r,t){for(var A=t,E=A*A,G=E*E*E,M=0,U;12>M&&!(U=A*(1.340264+-.081106*E+G*(8.93E-4+.003796*E))-t,E=1.340264+3*-.081106*
E+G*(7*8.93E-4+.034164*E),A-=U/=E,E=A*A,G=E*E*E,1E-12>ib(U));++M);return[mg*r*(1.340264+3*-.081106*E+G*(7*8.93E-4+.034164*E))/Ua(A),Sb(Ra(A)/mg)]};Bi.invert=Oe(Yd);Ci.invert=function(r,t){var A=t,E=25;do{var G=A*A;var M=G*G;A-=M=(A*(1.007226+G*(.015085+M*(-.044475+.028874*G-.005916*M)))-t)/(1.007226+G*(.045255+M*(-.311325+.259866*G-.005916*11*M)))}while(1E-6<ib(M)&&0<--E);return[r/(.8707+(G=A*A)*(-.131979+G*(-.013791+G*G*G*(.003971-.001529*G)))),A]};Di.invert=Oe(Sb);Ei.invert=Oe(function(r){return 2*
Yd(r)});Fi.invert=function(r,t){return[-t,2*Yd(ko(r))-qb]};var Pb={};Zd.prototype=Gi.prototype=(Pb.constructor=Zd,Pb.count=function(){return this.eachAfter(ct)},Pb.each=function(r,t){for(var A=-1,E=$jscomp.makeIterator(this),G=E.next();!G.done;G=E.next())r.call(t,G.value,++A,this);return this},Pb.eachAfter=function(r,t){for(var A,E=[this],G=[],M,U,W=-1;A=E.pop();)if(G.push(A),A=A.children)for(M=0,U=A.length;M<U;++M)E.push(A[M]);for(;A=G.pop();)r.call(t,A,++W,this);return this},Pb.eachBefore=function(r,
t){for(var A,E=[this],G,M=-1;A=E.pop();)if(r.call(t,A,++M,this),A=A.children)for(G=A.length-1;0<=G;--G)E.push(A[G]);return this},Pb.find=function(r,t){for(var A=-1,E=$jscomp.makeIterator(this),G=E.next();!G.done;G=E.next())if(G=G.value,r.call(t,G,++A,this))return G},Pb.sum=function(r){return this.eachAfter(function(t){for(var A=+r(t.data)||0,E=t.children,G=E&&E.length;0<=--G;)A+=E[G].value;t.value=A})},Pb.sort=function(r){return this.eachBefore(function(t){t.children&&t.children.sort(r)})},Pb.path=
function(r){var t=this;var A=t;var E=r;if(A!==E){var G=A.ancestors(),M=E.ancestors(),U=null;A=G.pop();for(E=M.pop();A===E;)U=A,A=G.pop(),E=M.pop();A=U}for(E=[t];t!==A;)t=t.parent,E.push(t);for(t=E.length;r!==A;)E.splice(t,0,r),r=r.parent;return E},Pb.ancestors=function(){for(var r=this,t=[r];r=r.parent;)t.push(r);return t},Pb.descendants=function(){return Array.from(this)},Pb.leaves=function(){var r=[];this.eachBefore(function(t){t.children||r.push(t)});return r},Pb.links=function(){var r=this,t=
[];r.each(function(A){A!==r&&t.push({source:A.parent,target:A})});return t},Pb.copy=function(){return Gi(this).eachBefore(ft)},Pb[Symbol.iterator]=rm,Pb);var Mv={depth:-1},mo={};qg.prototype=Object.create(Zd.prototype);var no=(1+Math.sqrt(5))/2,oo=function A(t){function E(G,M,U,W,da){Dm(t,G,M,U,W,da)}E.ratio=function(G){return A(1<(G=+G)?G:1)};return E}(no),Nv=function E(A){function G(M,U,W,da,ka){if((Y=M._squarify)&&Y.ratio===A)for(var Y,Z,qa,oa=-1,wa,La=Y.length,ta=M.value;++oa<La;){M=Y[oa];Z=M.children;
qa=M.value=0;for(wa=Z.length;qa<wa;++qa)M.value+=Z[qa].value;M.dice?Se(M,U,W,da,ta?W+=(ka-W)*M.value/ta:ka):rg(M,U,W,ta?U+=(da-U)*M.value/ta:da,ka);ta-=M.value}else M._squarify=Y=Dm(A,M,U,W,da,ka),Y.ratio=A}G.ratio=function(M){return E(1<(M=+M)?M:1)};return G}(no),Jb=Math.random,Ov=function G(E){function M(U,W){U=null==U?0:+U;W=null==W?1:+W;1===arguments.length?(W=U,U=0):W-=U;return function(){return E()*W+U}}M.source=G;return M}(Jb),Pv=function M(G){function U(W,da){2>arguments.length&&(da=W,W=0);
W=Math.floor(W);da=Math.floor(da)-W;return function(){return Math.floor(G()*da+W)}}U.source=M;return U}(Jb),tj=function U(M){function W(da,ka){var Y,Z;da=null==da?0:+da;ka=null==ka?1:+ka;return function(){if(null!=Y){var qa=Y;Y=null}else{do Y=2*M()-1,qa=2*M()-1,Z=Y*Y+qa*qa;while(!Z||1<Z)}return da+ka*qa*Math.sqrt(-2*Math.log(Z)/Z)}}W.source=U;return W}(Jb),Qv=function W(U){function da(){var Y=ka.apply(this,arguments);return function(){return Math.exp(Y())}}var ka=tj.source(U);da.source=W;return da}(Jb),
...
document.getElementById("info").innerHTML=ba);Da={};for(va in ia){console.log(va,ia.length);if(ia[va].service.includes("HARMONIE")||ia[va].service.includes("ECMWF")||ia[va].service.includes("TEMP")||ia[va].service.includes("KRR")||ia[va].service.includes("KRF")||"sond_station"==ia[va].name)console.log("MYLAYER_TEXT",ia[va].name),Da.$jscomp$loop$prop$myLayer$343=ia[va],getJSONdata(Da.$jscomp$loop$prop$myLayer$343,n,y.x,y.y,"text/plain",function(Ma){return function(Ka){if(null!=Ka){if(console.log(Ka),
null!=Ka.data){document.getElementById("load").innerHTML="";var Va=Ka.meta;if(Ma.$jscomp$loop$prop$myLayer$343.service.includes("TEMP")||"sond_station"==Ma.$jscomp$loop$prop$myLayer$343.name)Va="Station";else if(Ma.$jscomp$loop$prop$myLayer$343.service.includes("ECMWF")||Ma.$jscomp$loop$prop$myLayer$343.service.includes("HARMONIE")){var Ya=Ma.$jscomp$loop$prop$myLayer$343.service.split("=")[1];Ya=Ya.replace("&","");Va.model=Ya;Va.name=Ya;Va="MODEL"}else Va="SAT-PROFILE";var ab=L;L++;Ya=window.open(ab,
"SOND"+ab,'itemId="sonda'+ab+'",toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=1040,height=600');Ya.myvar=Ka;var mb=Ya.document;mb.write(js);mb.close();w.push([Ya,"SOND"+ab]);mb=Va+" : "+Ka.meta.name;mb+="Profile for location ["+Math.round(100*R.x)/100+","+Math.round(100*R.y)/100+"]";ab='<div id="SOND'+ab+'"class="sonding">Profile for location ['+Math.round(100*R.x)/100+","+Math.round(100*R.y)/100+"]";ab+=" - "+Va+" : "+Ka.meta.name+"</div>";Ya.document.title=mb;document.getElementById("info").innerHTML+=
ab}}else document.getElementById("load").innerHTML="",window.alert("SOND: No valid data")}}(Da));Da={$jscomp$loop$prop$myLayer$343:Da.$jscomp$loop$prop$myLayer$343}}Fa.jumpToEnd()})};n.addListener("mouseclicked",P,!0);var H=function(){c.html('<div id="load"></div><div id="info"></div><div id="table"></div>');$("#info").html("Click on the map to load a profile.<br/> A Sounding,ECMWF Model or IASI-KRR/F layer loaded is necessary");document.getElementById("info").addEventListener("click",function(T){T=
T.target.getAttribute("id");console.log(T);for(var R=0;R<w.length;R++)if(w[R][1]==T&&!w[R][0].closed){w[R][0].focus();break}},!1);isDefined(S)&&null!=S||(S=window.setInterval(function(){for(var T=0;T<w.length;T++)if(w[T][0].closed){var R=document.getElementById(w[T][1]);console.log(R);w.splice(T,1);R.remove();0==w.length&&$("#info").html("Click on the map to load a profile.<br/> A Sounding,ECMWF Model or IASI-KRR/F layer loaded is necessary")}},1E3),console.log(S));n.enableInlineGetFeatureInfo(!1)};
this.enable=function(){H();x=!0};this.disable=function(){x=!1;n.enableInlineGetFeatureInfo(!0);y.set=!1;for(var T=0;T<w.length;T++)console.log("CLOSE"),w[T].close();window.clearInterval(S);w=[];L=0};this.resize=function(T,R){$("#mitdd").width(T);y.set&&P(y)};this.enable()};try{WMJSExtApplications.Sondeo=tddjs,WMJSExtApplications.VertProfiles=tddjs}catch(c){}
...
function getJSONdata(c,n,x,y,w,S){var L=c.service.split("=")[1];L=L.replace("&","");document.getElementById("load").innerHTML+="Procesando<br>";document.getElementById("load").innerHTML+='<img src="./img/ajax-loader.gif" alt="Loading..."/>';document.getElementById("table").innerHTML="";var P=WMJScheckURL(c.service);P+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;P+="&LAYERS="+URLEncode(c.name);c.name.split(",");var H=P;w="";L.includes("ECMWF")&&(H+="&QUERY_LAYERS=mean_sea_level_pressure&INFO_FORMAT=application/json",
P+="&QUERY_LAYERS=geopotential_height,temperature,relative_humidity,wind_barbs_vectors&INFO_FORMAT=application/json");L.includes("TEMP")&&(P+="&QUERY_LAYERS=p,z,t,td,windSpd,windDir,eVSS&INFO_FORMAT=application/json",H+="&QUERY_LAYERS=station_name,ps,alt,station_cname&INFO_FORMAT=application/json");if(L.includes("KRR")||L.includes("KRF"))P+="&QUERY_LAYERS=air_temperature,dew_point_temperature&INFO_FORMAT=application/json",H+="&QUERY_LAYERS=surface_air_pressure,surface_air_temperature,surface_dew_point_temperature&INFO_FORMAT=application/json";
L.includes("HARMONIE")&&(H+="&QUERY_LAYERS=medium_sea_level_pressure&INFO_FORMAT=application/json",P+="&QUERY_LAYERS=geopotential_height,air_temperature,relative_humidity,wind_barbs_vectors&INFO_FORMAT=application/json");w+="&"+getBBOXandProjString(c,n);w+="WIDTH="+n.width;w+="&HEIGHT="+n.height;if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)w=w+("&X="+x)+("&Y="+y);c.version===WMSVersion.version130&&(w=w+("&I="+x)+("&J="+y));w+="&FORMAT=image/gif&STYLES=";try{w+="&"+n._getMapDimURL(c),
P+=w,H+=w}catch(R){S(null,void 0)}debug('<a target="_blank" href="'+P+'">'+P+"</a>",!1);var T=c.service+"&SERVICE=WMS&REQUEST=getCapabilities&VERSION="+c.version;getMeta(H,function(R){if(null!=R)if(console.log("META",R),H.includes("TEMP"))getData(T,R,P,function(O){null!=O?S({meta:R,data:O}):S(null)});else if(H.includes("KRR")||H.includes("KRF"))getData_IASI(T,R,P,function(O){null!=O?S({meta:R,data:O}):S(null)});else{if(H.includes("ECMWF")||H.includes("HARMONIE"))req_list=[],getAllLevels(T,function(O){if(null==
O)window.errorMessage("No hay niveles!"),S(null);else{O=O.split(",");for(var ba=0;ba<O.length;ba++)req_list.push(P+"&elevation="+O[ba]);req_list.reverse();R.model=L;getDataN_Model(req_list,[],0,function(ia){null!=ia?S({meta:R,data:ia}):S(null)})}})}else S(null)})}function WMJScheckURL(c){if(!isDefined(c))return"?";c=c.trim();-1===c.indexOf("?")&&(c+="?");return c}function isDefined(c){return"undefined"===typeof c?!1:!0}
...
function getMeta(c,n){console.log("REQ META",c);MakeHTTPRequest_s(c,function(x,y){if(null!=x)console.error(x);else{x=[];try{var w=JSON.parse(y),S=w[0].point.coords;S=S.split(",");var L=parseFloat(S[0]),P=parseFloat(S[1]);for(y=0;y<w.length;y++){var H=Object.keys(w[y].data).toString();if(H.includes("T")&&H.includes("-")&&H.includes(":"))break}if(c.includes("ECMWF")||c.includes("HARMONIE")){var T=H;var R=(new Date(T)).getTime();var O=w[0].data[H];H=Object.keys(O).toString();ff=(new Date(H)).getTime();
var ba=(ff-R)/36E5;H=Object.keys(O).toString()}var ia=c.includes("ECMWF")||c.includes("HARMONIE")?T.toString():H.toString();ia=ia.split("T");var la=ia[0].replaceAll("-","");la=parseInt(la);var ma=parseInt(ia[1].substring(0,2));T="OBSERVACION";if(c.includes("KRR")||c.includes("KRF")){ma=ia[1].substring(0,5);var ua="IASI-KRR/F";var Da="";T="SAT-PROFILE"}c.includes("ECMWF")&&(ua="ECMWF",Da="",T="MODEL");c.includes("HARMONIE")&&(ua="HARMONIE",Da="",T="MODEL");for(ia=0;ia<w.length;ia++){console.log(w[ia].standard_name);
if("station_name_backup"==w[ia].name){if(isDefined(ua))continue;ua=w[ia].data[H]}if("ps"==w[ia].name){if(isDefined(va))continue;var va=w[ia].data[H]/100;isNaN(va)&&(va=w[ia].data[0]/100)}if("air_pressure_at_mean_sea_level"==w[ia].standard_name||"medium_sea_level_pressure"==w[ia].standard_name){if(isDefined(va))continue;va=parseFloat(O[H]);isNaN(va)&&(va=parseFloat(O[H]))}if("surface_air_pressure"==w[ia].name){if(isDefined(va))continue;va=w[ia].data[H]/100;isNaN(va)&&(va=w[ia].data[0]/100)}if("surface_air_temperature"==
w[ia].standard_name){if(isDefined(Fa))continue;var Fa=isDefined(w[ia].data[2])?w[ia].data[2][H]-273.15:w[ia].data[H]-273.15;isNaN(Fa)&&(Fa=w[ia].data[2][H]-273.15)}if("surface_dew_point_temperature"==w[ia].standard_name){if(isDefined(Ma))continue;var Ma=isDefined(w[ia].data[2])?w[ia].data[2][H]-273.15:w[ia].data[H]-273.15;isNaN(Ma)&&(Ma=w[ia].data[2][H]-273.15)}if("alt"==w[ia].name){if(isDefined(Ka))continue;var Ka=parseFloat(w[ia].data[H]);isNaN(Ka)&&(Ka=parseFloat(w[ia].data[0]))}"station_cname_backup"!=
w[ia].name||isDefined(Da)||(Da=w[ia].data[H])}if(isDefined(ua)&&"nodata"!=ua){isNaN(Ka)&&(Ka=0);x={model:T,index:ua,date:la,run:ma,step:0,lon:L,lat:P,ps:va,zs:Ka,name:ua+" "+Da,ts:Fa,tds:Ma};if(c.includes("ECMWF")||c.includes("HARMONIE"))x={model:"ECMWF",index:"MODEL",date:la,run:ma,step:ba,lon:L,lat:P,ps:va,zs:0,name:"MODEL"};n(x)}else n(null)}catch(Va){n(null)}}})}
function getDataN_Model(c,n,x,y){0<c.length?(rml=c.pop(),$("#tableinfo").html(""),$("#table").html(""),$("#tableM").html(""),$("#tableS").html(""),MakeHTTPRequest_s(rml,function(w,S){if(null!=w)console.error(w);else{var L=JSON.parse(S),P=Object.keys(L[0].data)[0],H=Object.keys(L[0].data[P])[0],T=Object.keys(L[0].data[P][H])[0];w=parseFloat(L[0].data[P][H][T]);S=parseFloat(L[1].data[P][H][T]);var R=parseFloat(L[2].data[P][H][T]),O=-1*parseFloat(L[3].data[P][H][T]);L=-1*parseFloat(L[4].data[P][H][T]);
H=parseFloat(H);n.push({n:x,p:H,z:w,t:S,RH:R,u:L,v:O});n.sort(function(ba,ia){return ba.p-ia.p})}x++;getDataN_Model(c,n,x,y)})):y(n)}
function getData_IASI(c,n,x,y){getAllLevels(c,function(w){w=w.split(",");for(var S=[],L=0;L<w.length;L++){var P=parseFloat(w[L])/100;100<=P&&P<=parseFloat(n.ps)&&S.push(w[L])}w=x+"&elevation="+S[0]+"/"+S[S.length-1];var H=[],T={n:0,p:n.ps,z:0,t:n.ts,td:n.tds,wD:NaN,wS:NaN};H.push(T);$("#tableinfo").html("");$("#table").html("");$("#tableM").html("");$("#tableS").html("");MakeHTTPRequest_s(w,function(R,O){if(null!=R)console.error(R);else{if(!O.includes("ServiceException")){R=JSON.parse(O);R=$jscomp.makeIterator(R);
for(O=R.next();!O.done;O=R.next()){T=O.value;console.log(T);if("air_temperature"==T.standard_name)var ba=T.data;if("dew_point_temperature"==T.standard_name)var ia=T.data}for(var la in S){ind=S[la];R=parseFloat(ind)/100;var ma=Object.keys(ba[ind]);O=parseFloat(ba[ind][ma]);O-=273.15;ma=parseFloat(ia[ind][ma]);ma-=273.15;H.push({n:la,p:R,z:NaN,t:O,td:ma,wD:NaN,wS:NaN})}}y(H)}})})}
function getData(c,n,x,y){getLevels(c,function(w){console.log("LEV",w);null==w&&(window.errorMessage("No hay niveles!"),y(null));var S=parseInt(w);console.log("LEVEL",S);var L=Math.floor(S/100);S%=100;for(var P=0,H=0,T=[],R=0;R<L;R++)H=P+99,T.push(x+"&elevation="+P+"/"+H),P=H+1;T.push(x+"&elevation="+P+"/"+(P+S));T=T.reverse();var O=[];getDataN(T,w,n,O,function(ba){null==ba&&(window.errorMessage("No hay niveles!"),y(null));if(0==O.length)window.alert("El sondeo no tiene datos validos para este diagrama"),
...
function createXHR(){try{return new XMLHttpRequest}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(c){}try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(c){}return!1}
function MakeHTTPRequest(c,n,x,y){function w(P){errorfunction?errorfunction(P,pointer):n(void 0,pointer)}function S(){!1===x?(c=y+"REQUEST="+URLEncode(c),MakeHTTPRequest(c,n,errorfunction,pointer,!0,y)):w("status("+L.status+") to "+c)}c=-1===c.indexOf("?")?c+"?":c+"&";c+="rand="+Math.random();x||(x=!1);try{var L=createXHR();L.open("GET",c,!0);L.onreadystatechange=function(){if(4===L.readyState)if(200===L.status){try{var P=L.responseText}catch(H){w("Exception occured:"+H);return}void 0===P||""===P?
w("request returned no data"):n(null,L.response)}else S()};L.send(null)}catch(P){S()}}
function getCells(c,n,x,y,w){var S=c.name;S.includes("2D")&&getJSONdata2D(c,n,x,y,"text/plain",function(L){document.getElementById("info").innerHTML="";if(null!=L){var P=L.ANA,H=L.RAYOS,T=L.MOV;L="<br>CENTROIDE 2D <b>"+(P.ID+"</b> : ["+P.LATCEN+","+P.LONCEN+"]");var R="<TABLE BORDER><TR> <TD>ID</TD> <TD>NUPIX</TD> <TD>ZMAX</TD> <TD>ZMED</TD> <TD>RADIOE</TD> <TD>ECTOP</TD> <TD>VIL</TD> </TR><TR><TD><b>"+(P.ID+"</b></TD> <TD>"+P.NUPIX+"</TD> <TD>"+P.ZMAX+"</TD> <TD>"+P.ZMED+"</TD> <TD>"+P.RADIOE+"</TD> <TD>"+
P.ECTOP+"</TD> <TD>"+P.VIL+"</TD></TR>");R+="</TABLE>";var O="<div><p><b>RAYOS TOTALES:</b>"+H.RAY+"<br>";O+="<b>POSITIVOS:</b>"+H.POS+"<br>";O+="<b>NEGATIVOS:</b>"+H.NEG+"<br>";O+="<b>INTRANUBE:</b>"+H.INT+"<br>";O+="<b>LATCENR:</b>"+H.LATCENR+"<b> LONCENR:</b>"+H.LONCENR+"<br>";O+="<b>DISTMAX:</b>"+H.DISTMAX+"<b> DISTMED:</b>"+H.DISTMED+"<b> RAYOS/KM2:</b>"+H["RY/KM"]+"<br></p>";O+="</div>";H="<div><p><b>MOVIMIENTO:</b> V(Km/h):"+T.VKMH+" DIRN:"+T.DIRN+"</p></div>";T="";isDefined(P.ADV)&&(T="<div><p><b>ADVERSIDAD: </b>"+
P.ADV+"</p></div>");w(L+(R+O+H+T))}else L="<br>"+(S+" Wrong point!!! <b>"),w(L)});S.includes("3D")&&getJSONdata3D(c,n,x,y,"text/plain",function(L){document.getElementById("info").innerHTML="";if(null!=L){var P=L.ANA,H=L.GRANIZO;L=L.MOV;var T="CENTROIDE 3D <b>"+P.ID+"</b> : ["+P.LATCEN+","+P.LONCEN+"]";var R="<TABLE BORDER><TR> <TD>ID</TD> <TD>ZMAX</TD> <TD>ESPE</TD> <TD>ECTOP</TD> <TD>DVIL</TD> <TD>DVGR</TD> <TD>HB45</TD> <TD>HBAS</TD> <TD>DVCE</TD> </TR><TR><TD><b>"+(P.ID+"</b></TD> <TD>"+P.ZMAX+
"</TD> <TD>"+P.ESPE+"</TD> <TD>"+P.ECTOP+"</TD> <TD>"+P.DVIL+"</TD> <TD>"+P.DVGR+"</TD> <TD>"+P.HB45+"</TD> <TD>"+P.HBAS+"</TD> <TD>"+P.DVCE+"</TD></TR>");R+="</TABLE>";var O=H.GRA,ba="color:#00FF00";"g"==O&&(ba="color:#AAAA00");"G"==O&&(ba="color:#FF0000");O="<div><p><b>GRANIZO:</b><b style="+ba+">"+O+"</b><br><b>ORG-PER:</b>"+(H.ORG+"<br>");O+="<b>PGR:</b>"+H.PGR+"<br>";O+="<b>TAM(mm):</b>"+H.TAM+"<br>";O+="</p></div>";H=parseInt(P.ADV);ba="color:#00FF00";var ia="Sin Pot. Adv.";1==H&&(ba="color:#AAAA00",
ia="Alto Pot. Adv.");2==H&&(ba="color:#FF0000",ia="Muy alto Pot. Adv");P="<div><p><b>ADVERSIDAD: </b><b style="+ba+">"+ia+"</b><br><b>CELULA 2D: </b>"+(parseInt(P.N2D)+"<br>");T+=R+("<div><p><b>MOVIMIENTO:</b></br><b>V(Km/h):</b>"+(L.VKMH+"<b> DIRN:</b>"+L.DIRN+"</p></div>"))+O+(P+"</p></div></br>")}else T="<br>"+(S+" wrong point!!!<b>");w(T)})}
...
L+("&X="+x)+("&Y="+y);c.version===WMSVersion.version130&&(L=L+("&I="+x)+("&J="+y));L+="&FORMAT=image/gif&STYLES=";try{L+="&"+n._getMapDimURL(c),w+=L}catch(P){S(null)}MakeHTTPRequest(w,function(P,H){if(null!=P)console.error(P),S(null);else{P=JSON.parse(H);var T;for(T in P){H=P[T];if("RADIOE"==H.name&&(!isDefined(R)||"nodata"==R[Object.keys(R)]))var R=H.data;if("NUPIX"==H.name)var O=H.data;if("LATCEN"==H.name)var ba=H.data;if("LONCEN"==H.name)var ia=H.data;if("ECTOP"==H.name)var la=H.data;if("VIL"==
H.name)var ma=H.data;if("id"==H.name&&(!isDefined(ua)||"nodata"==ua[Object.keys(ua)]||"nan"==ua[Object.keys(ua)]))var ua=H.data;if("ZMAX"==H.name&&(!isDefined(Da)||"nodata"==Da[Object.keys(Da)]||isNaN(parseFloat(Da[Object.keys(Da)]))))var Da=H.data;if("ZMED"==H.name)var va=H.data;if("ADV"==H.name)var Fa=H.data;if("RAY"==H.name)var Ma=H.data;if("POS"==H.name)var Ka=H.data;if("NEG"==H.name)var Va=H.data;if("RAYo"==H.name)var Ya=H.data;if("DISTMAX"==H.name)var ab=H.data;if("DISTME"==H.name)var mb=H.data;
if("RY/K"==H.name)var Eb=H.data;if("LATCENR"==H.name)var vb=H.data;if("LONCENR"==H.name)var sb=H.data;if("DIRN"==H.name)var Pc=H.data;if("V(KMH)"==H.name)var Dc=H.data}try{var ed=R[Object.keys(R)],Ec=O[Object.keys(O)];if(isDefined(ba))var Fc=ba[Object.keys(ba)];if(isDefined(ia))var Rc=ia[Object.keys(ia)];if(isDefined(la))var qc=la[Object.keys(la)];if(isDefined(ma))var rc=ma[Object.keys(ma)];var fd=Da[Object.keys(Da)],gd=va[Object.keys(va)],Dd=Ma[Object.keys(Ma)],hd=Ka[Object.keys(Ka)],Ed=Va[Object.keys(Va)],
...
L+("&X="+x)+("&Y="+y);c.version===WMSVersion.version130&&(L=L+("&I="+x)+("&J="+y));L+="&FORMAT=image/gif&STYLES=";try{L+="&"+n._getMapDimURL(c),w+=L}catch(P){S(null)}MakeHTTPRequest(w,function(P,H){if(null!=P)console.error(P),S(null);else{P=JSON.parse(H);var T;for(T in P){H=P[T];if("ID_backup"==H.name)var R=H.data;if("LATCEN"==H.name)var O=H.data;if("LONCEN"==H.name)var ba=H.data;if("DVCE"==H.name)var ia=H.data;if("DVGR"==H.name)var la=H.data;if("ECTOP"==H.name)var ma=H.data;if("ESPE"==H.name&&(!isDefined(ua)||
"nodata"==ua[Object.keys(ua)]))var ua=H.data;if("GRA"==H.name)var Da=H.data;if("HB45"==H.name)var va=H.data;if("HBAS"==H.name)var Fa=H.data;if("DVIL"==H.name&&(!isDefined(Ma)||"nodata"==Ma[Object.keys(Ma)]))var Ma=H.data;if("ZMAX"==H.name&&(!isDefined(Ka)||"nodata"==Ka[Object.keys(Ka)]||Ka[Object.keys(Ka)]==R[Object.keys(R)]))var Ka=H.data;if("ADV"==H.name)var Va=H.data;if("NUM2D"==H.name)var Ya=H.data;if("ORG-PER"==H.name)var ab=H.data;if("PGR"==H.name)var mb=H.data;if("TAM(mm)"==H.name)var Eb=H.data;
if("DIRN"==H.name)var vb=H.data;if("V(KMH)"==H.name)var sb=H.data}try{var Pc=O[Object.keys(O)],Dc=ba[Object.keys(ba)],ed=ia[Object.keys(ia)],Ec=la[Object.keys(la)],Fc=ma[Object.keys(ma)],Rc=ua[Object.keys(ua)];ia="0";isDefined(Da)&&(ia=Da[Object.keys(Da)]);var qc=va[Object.keys(va)],rc=Fa[Object.keys(Fa)],fd=Ma[Object.keys(Ma)],gd=Ka[Object.keys(Ka)];Ma="0";isDefined(Ya)&&(Ma=Ya[Object.keys(Ya)]);Ya="0";isDefined(ab)&&(Ya=ab[Object.keys(ab)]);var Dd=mb[Object.keys(mb)],hd=Eb[Object.keys(Eb)],Ed=vb[Object.keys(vb)],
...
L[S[1]]]);for(var H=0;H<x.length;H++)P.push(L[x[H]]);isDefined(P[1])&&y.push(P)}c='<table id="my-table">';for(x=0;x<y.length;x++){0===x&&(c+="<thead>");c+="<tr>";w=y[x];S=n[x];for(L=0;L<w.length;L++)0===x?(c+="<th>",c+=w[L],c+="</th>"):(c=0===L?c+('<td style="cursor:pointer;color:#00f" onclick="getnum('+S[0]+","+S[1]+')">'):c+"<td>",c+=w[L],c+="</td>");0===x?(c+="</tr>",c+="</thead>",c+="<tbody>"):c+="</tr>"}c+="</tbody></table>";1==y.length&&(c="<b>NO CELLS</b></br>");return c};var gfiapp_point_interest=function(c,n){var x=this,y=[],w=!0,S=function(L,P){var H=null,T=null,R=null;setflags=function(){H&&T&&R?(lon=H,lat=T,name=R,fullUrl=knmiFlagURL+"file="+pointInterestFileName+"&location="+lon+","+lat+"&name="+name,$.ajax({type:"GET",url:fullUrl,success:function(ba){"OK"===ba.status?(ba=Ext.getCmp("webmapjs_add_point_interest"),ba.getEl().dom.style.background="#BCED91",n.getImageStore().clear(),n.draw("draw")):(ba=Ext.getCmp("webmapjs_add_point_interest"),ba.getEl().dom.style.background=
"#FF4040")},dataType:"jsonp",contentType:"application/jsonp",jsonpCallback:"resultSetFlag",crossDomain:!0})):(R||$("#webmapjs_point_interest_name").css("border","2px solid red"),H||$("#webmapjs_point_interest_lon").css("border","2px solid red"),T||$("#webmapjs_point_interest_lat").css("border","2px solid red"))};delete_flag=function(){Ext.MessageBox.show({title:I18n.delete_title_confirm.text,msg:I18n.are_you_sure.text,buttons:Ext.MessageBox.YESNO,icon:Ext.MessageBox.WARNING,fn:function(ba){"yes"==
...
{},S=[],L=[],P=function(la){var ma=O();c.html(ma+JSON.stringify(la));$(".autowms_app_fileitem_return").attr("onclick","").click(function(ua){ia("")})},H=function(la,ma,ua){console.log("FOLD",ma);$.ajax({url:la,dataType:"text",success:function(Da){lines=Da.split("\n");for(var va=Da=!1,Fa=0;Fa<lines.length;Fa++)line=lines[Fa],line.includes("BEGIN "+ma)&&(Da=!0),line.includes("END")&&(Da=!1),line.includes("<Layer")&&(va=!0),line.includes("</Layer")&&(va=!1),Da&&va&&line.includes("<Name>")&&(nombre=line.substring(line.indexOf(">")+
