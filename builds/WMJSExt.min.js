var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,b){a.raw=b;return a};$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var e=a.length,f=0;f<e;f++){var p=a[f];if(b.call(c,p,f,a))return{i:f,v:p}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;
...
$jscomp.polyfillIsolated=function(a,b,c,e){var f=a.split(".");a=1===f.length;e=f[0];e=!a&&e in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var p=0;p<f.length-1;p++){var l=f[p];if(!(l in e))return;e=e[l]}f=f[f.length-1];c=$jscomp.IS_SYMBOL_NATIVE&&"es6"===c?e[f]:null;b=b(c);null!=b&&(a?$jscomp.defineProperty($jscomp.polyfills,f,{configurable:!0,writable:!0,value:b}):b!==c&&(void 0===$jscomp.propertyToPolyfillSymbol[f]&&($jscomp.propertyToPolyfillSymbol[f]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(f):
...
$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.checkStringArgs=function(a,b,c){if(null==a)throw new TypeError("The 'this' value for String.prototype."+c+" must not be null or undefined");if(b instanceof RegExp)throw new TypeError("First argument to String.prototype."+c+" must not be a regular expression");return a+""};
...
0,b.dimensionValueLabel.setValueText(WMJSDateTooEarlyString);else if(f==WMJSDateTooLateString)b.currentIndex=b.dimension.size()-1,b.dimensionValueLabel.setValueText(WMJSDateTooLateString);else if(b.currentIndex=this.dimension.getIndexForValue(f),-1!=b.currentIndex)b.dimensionValueLabel.setValueText(b.getValue());else{var p=parseISO8601DateToDate(f),l=parseISO8601DateToDate(b.dimension.get(0)),h=parseISO8601DateToDate(b.dimension.get(b.dimension.size()-1));p.getTime()<l.getTime()?(b.dimensionValueLabel.setValueText(WMJSDateTooEarlyString),
b.layer.setDimension(b.dimension.name,WMJSDateTooEarlyString),b.currentIndex=0):p.getTime()>h.getTime()?(b.dimensionValueLabel.setValueText(WMJSDateTooLateString),b.layer.setDimension(b.dimension.name,WMJSDateTooLateString),b.currentIndex=b.dimension.size()-1):(b.dimensionValueLabel.setValueText(WMJSDateOutSideRange),b.layer.setDimension(b.dimension.name,WMJSDateOutSideRange))}}catch(m){b.dimensionValueLabel.setValueText(WMJSDateOutSideRange),b.layer.setDimension(b.dimension.name,WMJSDateOutSideRange),
b.currentIndex=0}b.dimSlider.suspendEvents();b.dimSlider.setValue(b.currentIndex,!1);b.dimSlider.resumeEvents()};b.checkReferenceTime=function(f){for(var p=-1,l=-1,h=0;h<b.dimensionPanels.length;h++){var m=b.layer.getDimension(b.dimensionPanels[h].dimension.name);"time"==m.name&&"ISO8601"==m.units&&(l=h);"reference_time"==m.name&&"ISO8601"==m.units&&(p=h)}b.dimSlider.suspendEvents();if(-1!=l&&-1!=p&&(h=b.layer.getDimension(b.dimensionPanels[l].dimension.name),m=b.layer.getDimension(b.dimensionPanels[p].dimension.name),
h.getValue()<m.getValue()))if(b.dimensionPanels[p].dimension.name==f.name){f=h.getValue();do f=h.get(h.getIndexForValue(f)+1);while(f<m.getValue());b.dimensionPanels[l].dimSlider.setValue(h.getIndexForValue(f),!1)}else if(b.dimensionPanels[l].dimension.name==f.name){f=m.getValue();do f=m.get(m.getIndexForValue(f)-1);while(f>m.getValue());b.dimensionPanels[p].dimSlider.setValue(m.getIndexForValue(f),!1)}b.dimSlider.resumeEvents()};b.sliderChanged=function(f){try{b.layer.parentMaps[0].stopAnimating()}catch(p){}b.currentIndex=
...
{title:"180 Minutes",name:"PT3H"},{title:"360 Minutes",name:"PT6H"},{title:"Daily",name:"P1D"}]}),e=Ext.create("Ext.form.ComboBox",{fieldLabel:"Choose duration",store:e,queryMode:"local",displayField:"title",valueField:"name",region:"center",listeners:{select:function(f,p){b.timeRangeDuration=p[0].get("name");f=b.dimension.getValue();try{f=b.layer.parentMaps[0].getDimension(b.dimension.name).currentValue}catch(l){}-1!=f.indexOf("/")&&(f=f.split("/")[0]);b.dimension.setTimeRangeDuration(b.timeRangeDuration);
...
{text:I18n.embed.text,tooltip:"Embed layer view",handler:function(){e.window.hide();e.layerpanel.add(Ext.create("webmapjsext.WMJSExt.ServicePanel",{title:I18n.layers.text,header:!0,collapsible:!0,service:e.layerpanel.WMJSLayer.service,name:e.layerpanel.WMJSLayer.name,border:2,itemclick:function(f,p,l){e.layerpanel.setLayer(p,l)}}))}},{scale:"small",tooltip:I18n.add_new_layer.tooltip,iconCls:"layer_logos button_layerlist_layernew",handler:function(){Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:function(f){e.layerpanel.service=
f.service;e.layerpanel.name=f.layer;e.layerpanel.WMJSLayer.service=e.layerpanel.service;e.layerpanel.WMJSLayer.name=e.layerpanel.name;e.layerpanel.parseLayer(!0,function(p,l){isDefined(f.ready)&&f.ready(b,e.layerpanel.parentWebMapJS)});return b},webMapJS:e.layerpanel.parentWebMapJS}).show()}}]});e.window.refresh=function(){e.servicePanel.buildTreeFromNodes(!0)};return e.window}}});var webmapjsext_WMJSExt_LayerPanel_ServicePanelManager,getServicePanelManager=function(){webmapjsext_WMJSExt_LayerPanel_ServicePanelManager||(webmapjsext_WMJSExt_LayerPanel_ServicePanelManager=Ext.create("webmapjsext.WMJSExt.ServicePanelManager",{}));return webmapjsext_WMJSExt_LayerPanel_ServicePanelManager};
...
b);a.opacity=100*b};a.dimCallBackAdded=!1;a.dimensionPanels=[];a.parseLayer=function(b,c){if(0!=isDefined(this.WMJSLayer.service)&&0!=this.WMJSLayer.service.length){a.setLoading("Reading GetCapabilities ...");for(var e=[],f=0;f<a.WMJSLayer.dimensions.length;f++)e.push(this.WMJSLayer.dimensions[f].clone());a.dimensionPanels=[];a.dimUpdate=function(){for(var l=0;l<a.dimensionPanels.length;l++){var h=a.WMJSLayer.getDimension(a.dimensionPanels[l].dimension.name);a.dimensionPanels[l].setValue(h.getValue())}};
a.setDimension=function(l,h){var m=a.getDimensionPanel(l);isDefined(m)?(a.WMJSLayer.setDimension(l,h),m.setValue(h)):error("WMJSExtLayerPanel::Dimension "+l+" not found")};a.getDimensionPanel=function(l){for(var h=0;h<a.dimensionPanels.length;h++)if(a.dimensionPanels[h].dimension.name===l)return a.dimensionPanels[h]};var p=function(l){var h=l;l.message&&(h=l.message);a.setLoading(!1);l="Unable to parse layer "+a.WMJSLayer.name+"\n"+h;a.WMJSLayer.hasError=!0;error(l)};f=function(l){if(void 0!=a.WMJSLayer.parentMaps[0])if(a.WMJSLayer!=
l)isDefined(l)&&p("WMJSExtLayerPanel internal error:\n"+l),c&&c(a),a.afterlayerready&&a.afterlayerready(a);else if(a.WMJSLayer.hasError){a.setLoading(!1);a.productButton.setText(a.WMJSLayer.path+a.WMJSLayer.title);a.styleButton.setText("");var h=a.WMJSLayer.lastError;isDefined(h)||(h="An error occurred connecting to WMS server");a.setTitle(h);error(h);l=new WMJSTimer;h=h.replaceAll("\n","<br/>");l.init(10,function(){Ext.Msg.alert(I18n.unable_to_connect_server.text,I18n.unable_to_connect_server.text+
"<br/><br/>"+h)});c&&c(a);a.afterlayerready&&a.afterlayerready(a)}else{a.WMJSLayer.getLayerRelative(function(g,k,v){a.productButton.setText("("+(k+1)+"/"+v+") "+a.WMJSLayer.title)},function(g){a.productButton.setText(a.WMJSLayer.path+a.WMJSLayer.title)});a.setStyleText(a.WMJSLayer.getStyleObject(a.WMJSLayer.currentStyle));a.dimensionPanels=[];a.dimensionPanelContainer.removeAll();var m="";for(l=0;l<a.WMJSLayer.dimensions.length;l++){for(var u=0;u<e.length;u++)e[u].name==a.WMJSLayer.dimensions[l].name&&
(a.WMJSLayer.dimensions[l].currentValue=e[u].currentValue);u=Ext.create("WMJSExtDimensionPanel",{dimension:a.WMJSLayer.dimensions[l],layer:a.WMJSLayer,dimensionPanels:a.dimensionPanels});a.dimensionPanels.push(u);a.dimensionPanelContainer.add(u);0<m.length&&(m+=", ");m+=a.WMJSLayer.dimensions[l].name}a.afterlayerready&&(c&&c(a),a.afterlayerready(a));a.setLoading(!1);for(l=0;l<a.WMJSLayer.dimensions.length;l++)m=a.WMJSLayer.parentMaps[0].getDimension(a.WMJSLayer.dimensions[l].name),isDefined(m)&&a.WMJSLayer.dimensions[l].setClosestValue(m.currentValue);
for(l=0;l<a.WMJSLayer.dimensions.length;l++)a.dimensionPanels[l].setValue(a.WMJSLayer.dimensions[l].currentValue);a.WMJSLayer.parentMaps[0].rebuildMapDimensions();0==a.dimCallBackAdded&&(a.WMJSLayer.parentMaps[0].addListener("ondimchange",a.dimUpdate,!0),a.dimCallBackAdded=!0);try{a.styleButton.loadStyles()}catch(g){}var q=!1;isDefined(a.name)&&0<a.name.length&&(q=!0);a.setTitle("Layer "+a.WMJSLayer.name);if(!1===q){if(1==a.autoChooseLayer){a.autoChooseLayer=!1;a.WMJSLayer.autoSelectLayer(function(g){a.setLayer(g.name);
...
I18n.service.text+"</b><table class='adagucviewer_wmsjsext_layerpanel_abstract'><tr><td><i>"+I18n.title.text+"</i></td><td> "+a.WMJSLayer.WMJSService.title+"</td></tr><tr><td><i>"+I18n.service.text+"</i></td><td>"+a.WMJSLayer.WMJSService.onlineresource+"</td></tr><tr><td><i>"+I18n.abstract.text+"</i></td><td>"+a.WMJSLayer.WMJSService.abstract+"</td></tr></table></span>"):a.layerAbstractPanel.update("...");l=function(){var g=a.WMJSLayer.parentMaps[0].getLegendGraphicURLForLayer(a.WMJSLayer),k=a.WMJSLayer.parentMaps[0].getLegendStore();
if(a.layerLegendPanel.getEl()){var v=$(a.layerLegendPanel.getEl().dom).find("canvas")[0].getContext("2d");(g=k.getImageForSrc(g))?(v.rect(0,0,90,250),v.fillStyle="white",v.fill(),v.drawImage(g.getElement()[0],0,0)):(v.rect(0,0,90,250),v.fillStyle="gray",v.fill())}};a.WMJSLayer.parentMaps[0].getListener().addToCallback("onlegendready",l,!0);l()}};try{if(a.WMJSLayer.parseLayer(f,b,"LayerPanel::parseLayer",xml2jsonrequestURL),!0===b)try{console.log("clearing cache"),a.WMJSLayer&&a.WMJSLayer.parentMaps&&
0<a.WMJSLayer.parentMaps.length&&(a.WMJSLayer.parentMaps[0].clearImageStore(),a.WMJSLayer.parentMaps[0].loadLegendInline(!0))}catch(l){console.error(l)}}catch(l){p(l)}}};a.duplicateLayer=function(){createNewLayerPanel(a.parentWebMapJS,a.WMJSLayer)};a.productButton=Ext.create("Ext.button.Button",{text:I18n.please_select_product.text,textAlign:"left",iconAlign:"right",iconCls:"button_combobox",tooltip:I18n.select_layer_product_from_service.tooltip,handler:function(b){void 0==a.service||0==a.service.length?
...
listeners:{itemclick:function(e,f){a.dataPanelClicked({title:f.get("title"),thumbnail:f.get("thumbnail"),service:f.get("service"),layer:f.get("layer"),srs:f.get("srs"),bbox:f.get("bbox"),style:f.get("style"),baselayerservice:f.get("baselayerservice"),baselayername:f.get("baselayername"),opacity:f.get("opacity")});a.close()}}})});webmapjsext.WMJSExt.DataPanel.superclass.initComponent.apply(this,arguments)}});var defaultBaselayer={service:"http://geoservices.knmi.nl/cgi-bin/worldmaps.cgi?",name:"world_line"};
...
{text:I18n.title.text,dataIndex:"title",flex:2},{text:I18n.layer.text,dataIndex:"name",flex:1},{text:I18n.type.text,dataIndex:"type"}],columnLines:!0,iconCls:"icon-grid"}),listeners:{show:{fn:function(){for(var c=[],e=a.webMapJS.getBaseLayers(),f=0;f<e.length;f++){var p=e[f].title;0==f&&(p="Default base layer");c.push({title:p,layer:e[f],name:e[f].name,enabled:e[f].enabled,type:1==e[f].keepOnTop?"overlay":"baselayer"})}b.loadRawData(c)}}}});this.superclass.initComponent.apply(this,arguments)}});defaultBaselayer={service:"http://geoservices.knmi.nl/cgi-bin/worldmaps.cgi?",name:"world_line"};
...
a.mappanel.webMapJS.getLayers();b.removeAll();for(var m=0;m<h.length;m++)b.add({name:h[m].service+h[m].name,title:h[m].title,wmjslayer:h[m]})},f=function(h){if(isDefined(h)){a.selectedLayer=h;var m=a.getComponent("dimensionpanel").getComponent("dimensioncombobox");m.disable();c.removeAll();for(var u=0;u<h.dimensions.length;u++)c.add({name:h.dimensions[u].name,wmjsdimension:h.dimensions[u]});0<c.getCount()&&(m.setValue(c.getAt(0).get("name")),p(c.getAt(0).get("wmjsdimension")),m.enable())}},p=function(h){isDefined(h)&&
(a.getComponent("dimensionvaluespanel").getComponent("dimensioncurrentvalue").setValue(h.getValue()),a.dimension=h)},l=function(){isDefined(a.dimensionName)&&isDefined(a.currentValue)&&(a.mappanel.webMapJS.stopAnimating(),a.mappanel.webMapJS.setDimension(a.dimensionName,a.currentValue),a.mappanel.webMapJS.draw("AnimationPanel::stop"))};Ext.apply(this,{border:!1,frame:!0,items:[{xtype:"panel",itemId:"layerpanel",layout:"border",frame:!0,border:!1,margin:3,height:36,items:[{margin:3,xtype:"combobox",
itemId:"layercombo",region:"center",fieldLabel:I18n.select_layer.text,labelWidth:110,displayField:"title",valuefield:"name",store:b,queryMode:"local",listeners:{select:{fn:function(h,m){h=m[0].get("wmjslayer");f(h)}}}},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",handler:function(){e()}}]},{xtype:"panel",itemId:"dimensionpanel",layout:"fit",frame:!0,border:!1,margin:3,height:36,items:[{margin:3,xtype:"combobox",itemId:"dimensioncombobox",region:"center",fieldLabel:I18n.select_dimension.text,
labelWidth:110,disabled:!0,store:c,displayField:"name",valuefield:"name",queryMode:"local",listeners:{select:{fn:function(h,m){p(m[0].get("wmjsdimension"))}}}}]},{xtype:"panel",itemId:"dimensionvaluespanel",frame:!0,border:!1,margin:3,layout:"border",height:36,items:[{xtype:"label",text:I18n.start_at.text+":",width:110,region:"west",margin:3},{itemId:"dimensioncurrentvalue",xtype:"textfield",region:"center",frame:!1,border:!1,margin:3},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",
...
{xtype:"numberfield",itemId:"delaynumberfield",region:"center",value:300}]}],buttons:[{text:I18n.stop.text,handler:l},{text:I18n.start.text,handler:function(){var h=a.getComponent("dimensionvaluespanel").getComponent("dimensioncurrentvalue").getValue(),m=a.getComponent("numberofstepspanel").getComponent("numberofstepsnumberfield").getValue(),u=a.getComponent("delaypanel").getComponent("delaynumberfield").getValue();h=a.dimension.getIndexForValue(h);var q=a.mappanel.webMapJS.getMaxNumberOfAnimations();
m>q&&(m=q,a.getComponent("numberofstepspanel").getComponent("numberofstepsnumberfield").setValue(m));m--;0>m&&(m=0);m=h+m;m>=a.dimension.size()&&(q=a.dimension.size()-(m+1),h+=q,m+=q);0>h&&(h=0);0>m&&(m=0);for(q=[];h<m+1;h++)q.push({name:a.dimension.name,value:a.dimension.getValueForIndex(h)});0==a.mappanel.webMapJS.isAnimating&&(a.dimensionName=a.dimension.name,a.currentValue=a.dimension.currentValue);a.mappanel.webMapJS.setAnimationDelay(u);a.mappanel.webMapJS.draw(q)}}],listeners:{afterrender:{fn:function(){e();
...
w.height);t()}}}}),h=Ext.create("Ext.data.Store",{fields:["title","format"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),m=Ext.create("Ext.grid.Panel",{border:!1,store:h,columns:[{text:I18n.format.text,dataIndex:"format"},{text:I18n.title.text,dataIndex:"title",flex:1}],listeners:{select:{fn:function(n,r){e=r.get("format");t()}}}});a.onReady=function(){l.setLoading(!1);for(var n=this.coverages[0],r=0;r<n.supportedProjections.length;r++){var w=n.supportedProjections[r].srs;
try{w=epsgDescriptionLookup[n.supportedProjections[r].srs]}catch(y){}isDefined(w)||(w=n.supportedProjections[r].srs);p.add({title:w,srs:n.supportedProjections[r].srs,bbox:n.supportedProjections[r].bbox})}r=p.find("srs",n.nativeCRS);-1==r&&(r=p.find("srs","EPSG:4326"));-1==r&&(r=0);l.getView().select(r);p.add({title:"Viewer window projection and area",srs:this.srs,bbox:this.bbox});u.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").setValue(n.width);
u.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").setValue(n.height);w=u.getComponent("column3").getComponent("dimensionPanel");for(r=0;r<n.dimensions.length;r++)w.add({xtype:"textfield",fieldLabel:n.dimensions[r].name,value:n.dimensions[r].currentValue,labelWidth:40,padding:"30",width:200,itemId:"dimtextfield_"+n.dimensions[r].name,listeners:{change:{fn:function(){t()}}}});for(r=0;r<n.formats.length;r++){w=n.formats[r];var x=n.formats[r].toUpperCase();
try{w=formatDescriptionLookup[x]}catch(y){}isDefined(w)||(w=n.formats[r]);h.add({title:w,format:n.formats[r]});"AAIGRID"==x&&m.getView().select(r)}t();v.update('<table style="margin:5px;"><tr><td><b>Coverage:</b></td><td>'+n.name+"</td></tr><tr><td><b>Title:</b></td><td>"+n.title+"</td></tr><tr><td><b>Description:</b></td><td>"+n["abstract"]+"</td></tr></table>")};Ext.create("Ext.panel.Panel",{region:"west",border:!0,width:100});var u=Ext.create("Ext.panel.Panel",{region:"center",border:!1,layout:{type:"hbox",
...
split:!0,autoScroll:!0,region:"south",height:"50%",title:I18n.formats.text,items:[m]}]}]}),q=Ext.create("Ext.panel.Panel",{layout:"border",region:"center",border:!0,width:300,items:[u]}),g=Ext.create("Ext.panel.Panel",{border:!1,padding:20}),k=Ext.create("Ext.panel.Panel",{title:"GetCoverage request link",region:"south",border:!0,height:100,layout:"fit",items:[g]}),v=Ext.create("Ext.panel.Panel",{region:"north",border:!1,height:80,frame:!1});Ext.apply(this,{layout:"border",padding:0,frame:!1,border:!0,
...
var g=WMJSExtApplications[b.applicationSettings.name];g?(console.log("Opening APP with these",b.applicationSettings),b.applicationSettings.app=new g($("#webmapjs_customapplication"),mainWebmapJS.webMapJS,b.applicationSettings),b.applicationSettings.app.enable(b.width,mainWebmapJS.webMapJS.getHeight()-24)):alert("Application with name "+b.applicationSettings.name+" not registered")}},hide:{fn:function(){b.applicationSettings.app&&(b.applicationSettings.app.disable(),b.applicationSettings.app=void 0);
mainWebmapJS.webMapJS.enableInlineGetFeatureInfo(!0);mainWebmapJS.webMapJS.removeListener("mouseclicked")}},resize:{fn:function(){b.applicationSettings&&b.applicationSettings.app&&b.applicationSettings.app.resize(b.width,mainWebmapJS.webMapJS.getHeight())}}},setApplication:function(g){b.applicationSettings=g}});a=Ext.create("Ext.panel.Panel",{region:"center",layout:"border",split:!0,frame:!1,border:!1,margin:0,items:[mainWebmapJS,b]});var c=function(g){var k=createNewLayerPanel(mainWebmapJS.webMapJS,
{service:g.service,name:g.layer,style:g.style,opacity:g.opacity,ready:function(v,t){var n=g.srs,r=g.bbox,w=g.baselayername,x=g.baselayerservice;n&&!r?t.setProjection(v.getProjection(n)):n&&r&&t.setProjection({srs:n,bbox:r});w&&x?(mainWebmapJS.baseLayer.setService(x),mainWebmapJS.baseLayer.name=w,mainWebmapJS.baseLayer.parseLayer(function(){t.draw("dataPanelClicked::parseLayer")},void 0,"WMJSExtMain::dataPanelClicked")):t.draw("dataPanelClicked");isDefined(k)&&isDefined(g.ready)&&(g.ready(k,t),1==
k.WMJSLayer.hasError&&k.close())}});return k},e,f=new Console;Ext.create("Ext.panel.Panel",{html:'<div id="debuginfodiv"></div>',layout:"fit",listeners:{afterrender:{fn:function(){f.setElement(document.getElementById("debuginfodiv"))}}}});var p=[{text:I18n.show_time_selection_window.text,iconCls:"button_settings_icon",handler:function(){timeselectorWindow.show()}},{text:I18n.create_animation.text+"&hellip;",iconCls:"button_settings_icon",handler:function(){Ext.create("Ext.window.Window",{title:I18n.create_animation.text,
width:460,height:300,layout:"form",autoDestroy:!0,closeAction:"destroy",autoScroll:!0,collapsible:!0,items:[Ext.create("webmapjsext.WMJSExt.AnimationPanel",{mappanel:mainWebmapJS})]}).show()}},{text:I18n.create_link.text,iconCls:"button_makeLink",handler:function(){e=Ext.create("Ext.window.Window",{title:I18n.create_permanent_links.text,width:800,height:260,layout:"fit",autoDestroy:!0,closeAction:"destroy",autoScroll:!0,modal:!1,items:[Ext.create("webmapjsext.WMJSExt.PermaLinkPanel",{mappanel:mainWebmapJS})]});
e.show()}},{text:I18n.add_custom_wms_service.text,iconCls:"button_layerlist_layernew",handler:function(){Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:c,webMapJS:mainWebmapJS.webMapJS}).showCustomWMSWindow()}},{text:I18n.undo_zoom_pan_action.text,iconCls:"button_undo",handler:function(){mainWebmapJS.webMapJS.setPreviousExtent()}},{text:I18n.redo_zoom_pan_action.text,iconCls:"button_redo",handler:function(){mainWebmapJS.webMapJS.setNextExtent()}},{text:I18n.abort_loading.text,iconCls:"button_stoploading",
handler:function(){mainWebmapJS.webMapJS.abort()}}];try{isDefined(getFeatureInfoApplications)}catch(g){getFeatureInfoApplications=[]}for(var l={},h=0;h<getFeatureInfoApplications.length;l={$jscomp$loop$prop$location$9$16:l.$jscomp$loop$prop$location$9$16},h++)l.$jscomp$loop$prop$location$9$16=getFeatureInfoApplications[h],p.push({text:getFeatureInfoApplications[h].name,iconCls:getFeatureInfoApplications[h].iconCls,location:l.$jscomp$loop$prop$location$9$16,handler:function(g){return function(){b.setApplication(g.$jscomp$loop$prop$location$9$16);
b.hide();b.show()}}(l)}),getFeatureInfoApplications.open&&l.$jscomp$loop$prop$location$9$16.name===getFeatureInfoApplications.open&&b.setApplication(l.$jscomp$loop$prop$location$9$16);p.push({text:I18n.about_the_adaguc_viewer.text,iconCls:"button_info",tooltip:I18n.about_the_adaguc_viewer.tooltip,handler:function(){Ext.create("Ext.window.Window",{title:I18n.about_adaguc.text,height:200,width:400,modal:!0,layout:"fit",items:{xtype:"panel",html:'<div class="about_adaguc" style="position:absolute;top:0px;left:0px;height:100px;width:520px;"/><div style="position:absolute;top:100px;padding:10px;margin:10px;">'+
...
xtype:"tabpanel",scale:"large",cls:"LayersAndMapsTab",items:[l,h,m,timeselectorPanel]}],tbar:[{scale:"large",text:I18n.add_layers.text,tooltip:I18n.add_layers.tooltip,iconCls:"button_adddata32",handler:function(){Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:c,webMapJS:mainWebmapJS.webMapJS}).show()}},{iconCls:"button_settings32",tooltip:I18n.settings_and_options.tooltip,scale:"large",menu:{xtype:"menu",items:p}}]},a],renderTo:Ext.getBody(),listeners:{resize:{fn:function(){try{var g=
viewportwestpanelwindow.y+viewportwestpanelwindow.height;g>u.height&&(g=u.height-70,70>g&&(g=70));viewportwestpanelwindow.setSize(viewportwestpanelwindow.width,g)}catch(k){}}}}}),q=function(g){console.log("checkIfClassicADAGUCStateIsGiven",g);var k=!1,v=!1;isDefined(g.collapse)&&"1"==g.collapse&&Ext.getCmp("viewportwestpanel").collapse();isDefined(g.zoomtolayer)&&"1"==g.zoomtolayer&&(k=!0);isDefined(g.srs)&&isDefined(g.bbox)&&mainWebmapJS.webMapJS.setProjection({srs:g.srs,bbox:g.bbox});if(isDefined(g.service)){clearLayers(mainWebmapJS.webMapJS);
var t=URLDecode(g.service).split(","),n=[""];isDefined(g.layer)?n=URLDecode(g.layer).split(","):1==k&&(v=!0);isDefined(g.selected);for(var r=n.length,w=0;w<n.length;w++)try{var x=n[n.length-1-w].split("$"),y=x+"",A=!0,z="",C=1,B=t[0]+"";6==x.length&&(y=x[0],A=x[2],z=x[3],C=x[4],isDefined(A)&&("true"===A&&(A=!0),"false"===A&&(A=!1)),B=t[x[5]]);createNewLayerPanel(mainWebmapJS.webMapJS,{service:B,name:y,style:z,enabled:A,opacity:C,ready:function(D,E){r--;if(0==r){if(isDefined(g.dims))for(var H=g.dims.split(","),
F=0;F<H.length;F++){var G=H[F].split("$");2==G.length&&mainWebmapJS.webMapJS.setDimension(G[0],G[1])}1==k&&D.WMJSLayer.zoomToLayer();E.draw("index.html::numlayers=0")}},autoChooseLayer:v})}catch(D){error("Unable to parse layer nr "+w)}if(isDefined(g.baselayers)){t=g.baselayers.split("$");v=[];for(w=n=0;w<t.length;w++){x=!1;for(y=0;y<mapTypeConfiguration.length;y++)if(mapTypeConfiguration[y].baselayer.name==t[w]){mapTypeConfiguration[y].baselayer.enabled=!0;v.push(mapTypeConfiguration[y].baselayer);
x=!0;n++;break}if(!x)for(y=0;y<baseLayerConfiguration.length;y++)if(baseLayerConfiguration[y].name==t[w]){baseLayerConfiguration[y].enabled=!0;v.push(baseLayerConfiguration[y]);x=!0;n++;break}x||error("Warning: unable to find baselayer "+t[w])}for(w=0;w<baseLayerConfiguration.length;w++)0==baseLayerConfiguration[w].enabled?v.push(baseLayerConfiguration[w]):0==n&&v.push(baseLayerConfiguration[w]);baseLayers=[];for(w=0;w<v.length;w++)t=new WMJSLayer(v[w]),0==w&&(mainWebmapJS.baseLayer=t),baseLayers.push(t);
0<baseLayers.length&&mainWebmapJS.webMapJS.setBaseLayers(baseLayers)}}g&&g.autowms&&(autowmsURL=g.autowms,b.setApplication({name:"AutoWMS",iconCls:"button_getfeatureinfo"}),b.hide(),b.show())};0==window.location.hash.length&&q(getUrlVars());checkIfHashTagChanged(function(g,k){if(0<=g.indexOf("addlayer('")){if(k=g.substring(g.indexOf("addlayer('")+10,g.indexOf("',")),g=g.substring(g.indexOf(",'")+2,g.indexOf("')")),k&&g){for(var v=!1,t=mainWebmapJS.webMapJS.getLayers(),n=0;n<t.length;n++)if(t[n].service==
k&&t[n].name==g){v=!0;break}0==v&&(isDefined(hashLocationNotfiyAddLayer),firstTimeOpening=!0,createNewLayerPanel(mainWebmapJS.webMapJS,{service:k,name:g,zoomtolayer:!1,notifyadded:!0}))}}else 0<=g.indexOf("positionmappinbylatlon(")?(debug(g),k=g.substring(23,g.indexOf(")")),debug(k),k=k.split(","),debug(k[0]+" "+k[1]),mainWebmapJS.webMapJS.positionMapPinByLatLon({x:parseFloat(k[0]),y:parseFloat(k[1])})):0<=g.indexOf("refreshlayers")?updateLayers():q(k)});getFeatureInfoApplications.open&&b.show()});var gfiapp_d3c3=function(a,b){var c=function(q,g){$("#"+g).empty();$("#"+g).append("<div style='height=240px;border=2px solid blue;' class='chart'>a</div>");$("#"+g).append("<div style='height=40px;border=2px solid red;' class='controls gfiapp_d3c3_export_to_csv_button'>b</div>");var k=$("#"+g).find(".chart");g=$("#"+g).find(".controls");k.html("graph");g.button({label:"Export to CSV"}).click(function(){console.log("Export to CSV");for(var v="",t=q.datatoplot,n=0;n<t[0].length;n++){for(var r=0;r<
t.length;r++)0<r&&(v+=";"),v+=JSON.stringify(t[r][n]);v+="\n\r"}t=document.createElement("a");t.setAttribute("download","export.csv");t.setAttribute("href",encodeURI("data:text/csv;charset=utf-8,"+v));console.log("Clicking link");document.body.appendChild(t);t.click();t.remove()});c3.generate({bindto:k.get(0),data:{x:"x",x_format:"%Y%m%d",columns:q.datatoplot,types:{x:"area"}},axis:{x:{type:"timeseries",tick:{format:q.timeFormat}},y:{label:q.ylabel}},zoom:{enabled:!0},subchart:{show:!1}})},e=function(q,
g){return q>g?1:q<g?-1:0},f=function(q,g){var k;for(k=0;k<g.length;k++)try{if(g[k].getTime()===q.getTime())return k}catch(v){}return-1},p=function(q,g){var k=1;"string"!=typeof q[0].dims&&(k=q[0].dims.length);for(var v=[],t=function(x,y,A){var z=["x"];x=[y.name+" "+x];for(var C in A){y=d3.time.format("%Y-%m-%dT%H:%M:%SZ").parse(C);var B=parseFloat(A[C]);z.push(y);x.push(B)}v.push({date:z,value:x})},n=function(x,y,A,z){if(1==k)t("",y,A);else if(x+2<k)for(d in A)n(x+1,y,A[d],z+"["+d+"]");else for(d in A)t("["+
d+"]",y,A[d])},r=0;r<q.length;r++)n(0,q[r],q[r].data,"");r=function(x){for(var y=[],A=x.length,z=0;z<A;z++)for(var C=x[z].date,B=1;B<C.length;B++){var D=C[B],E=f(D,y);-1==E&&y.push(D)}y.sort(e);y.unshift("x");C=[];for(B=0;B<A;B++)C.push([]);for(z=0;z<A;z++)for(C[z].push(x[z].value[0]),B=1;B<y.length;B++)E=f(y[B],x[z].date),E==B?(D=x[z].value[E],"nodata"==D&&(D=NaN),C[z].push(parseFloat(D))):C[z].push(NaN);x=[];x.push(y);for(z=0;z<A;z++)x.push(C[z]);return x}(v);var w=q[0].name;q[0].units&&(w+=" in "+
q[0].units);c({datatoplot:r,ylabel:w,timeFormat:"%Y-%m-%d %H:%M"},g)},l=function(q,g){$.ajax({type:"GET",url:q+"&JSONP=?",dataType:"jsonp",cache:!1,success:function(k){try{p(k,g)}catch(v){$("#"+g).html("Sorry! An error occurred while parsing JSON data: ["+v+"]")}},error:function(k,v,t){$("#"+g).html("Sorry! An error occurred while receiving JSON data from the server: ["+t+"]");console.log("Error "+t)}})},h=!0,m=[];m.set=!1;var u=function(q){if(0!=h){m.x=q.x;m.y=q.y;m.set=!0;var g=b.getLatLongFromPixelCoord({x:q.x,
y:q.y});$("#chart").html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');var k=b.getLayers();if(isDefined(k)){g="timeseries graph for location ["+Math.round(100*g.x)/100+","+Math.round(100*g.y)/100+"]<br/>";$("#chart").empty();for(var v=0;v<k.length;v++){var t=b.getWMSGetFeatureInfoRequestURL(k[v],q.x,q.y);t=composeUrlObjectFromURL(t);var n=t.location+"?";for(key in t.kvp){var r=t.kvp[key];"info_format"==key&&(r="application/json");"time"==key&&(r="1000-01-01T00:00:00Z/3000-01-01T00:00:00Z");
"dim_member"==key&&(r="*");"dim_ensemble_member"==key&&(r="*");"dim_percentile"==key&&(r="*");n+=key+"="+URLEncode(r)+"&"}$("#chart").append("<div class='chartstyle' id='chart"+v+"'></div>");$("#chart"+v).html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');l(n,"chart"+v)}$("#info").html(g)}else $("#info").html("No valid data received:<br/>"+data)}};b.addListener("mouseclicked",u,!0);this.enable=function(){a.html('<div id="info"></div><div id="chart" class="gfiapp_d3c3"></div>');$("#info").html("Click on the map to create a timeseries graph.");
...
tooltip:I18n.delete_selected_flag_tooltip.tooltip,renderTo:"webmapjs_div_selected_point_interest",cls:"webmapjs_button_delete_point_interest",handler:function(){delete_flag()}});$("#webmapjs_point_interest_name, #webmapjs_point_interest_lon, #webmapjs_point_interest_lat").keypress(function(k){if(13==k.which)return setflags(),!1});var g=function(){var k=a.find(".gfiapp_point_interest");k.empty();for(var v=b.getLayers(),t=0;t<v.length;t++){var n=v[t],r=jQuery("<div />",{css:{margin:8}});k.append(r);
r.html("LAYER "+n.service)}c.resize(l,h)};g();b.addListener("onlayeradd",g,!0);b.addListener("mouseclicked",function(k){if(0!=f){var v=b.getLatLongFromPixelCoord({x:k.x,y:k.y});m=v.x;u=v.y;$("#webmapjs_point_interest_lon").val(v.x.toFixed(5));$("#webmapjs_point_interest_lat").val(v.y.toFixed(5));$("#webmapjs_point_interest_lon, #webmapjs_point_interest_lat").css("border","1px solid grey");v=b.getLayers();k=b.getWMSGetFeatureInfoRequestURL(v[0],k.x,k.y).replace("&INFO_FORMAT=text/html","&INFO_FORMAT=application/json")+
"&JSONP=featureInfoCallback";$.ajax({dataType:"jsonp",jsonpCallback:"featureInfoCallback",type:"GET",cache:!1,url:k,success:function(t){t[1]&&"nodata"!==t[1].data?($(".webmapjs_label_selected_point_interest").text(t[1].data),$(".webmapjs_button_delete_point_interest").css("display","inline")):($(".webmapjs_label_selected_point_interest").text(I18n.default_selected_flag.text),$(".webmapjs_button_delete_point_interest").css("display","none"))},error:function(t,n,r){debug(n+", "+r)}})}},!0);$("#webmapjs_point_interest_name").on("input",
function(k){onChangeEvents("name",k)});$("#webmapjs_point_interest_lon").on("input",function(k){onChangeEvents("lon",k);changeMapPin()});$("#webmapjs_point_interest_lat").on("input",function(k){onChangeEvents("lat",k);changeMapPin()});this.onChangeEvents=function(k,v){var t=Ext.getCmp("webmapjs_add_point_interest");t.getEl().dom.style.background="";t=Ext.getCmp("webmapjs_delete_point_interest");t.getEl().dom.style.background="";switch(k){case "name":q=v.target.value;break;case "lon":m=v.target.value;
break;case "lat":u=v.target.value}$("#webmapjs_point_interest_"+k).css("border","1px solid grey")};this.changeMapPin=function(){b.positionMapPinByLatLon({x:m,y:u})};b.enableInlineGetFeatureInfo(!1)};this.enable=function(l,h){p(l,h);f=!0};this.disable=function(){f=!1;b.enableInlineGetFeatureInfo(!0)};this.resize=function(l,h){for(var m=0;m<e.length;m++)e[m].setSize(l,h/e.length);for(m=0;m<e.length;m++);};c.enable()};WMJSExtApplications["Points of interest"]=gfiapp_point_interest;var gfiapp_eprofile=function(a,b){var c=this,e=[],f=function(p,l){a.html('<div id="info"></div><div class="gfiapp_eprofile">bla</div>');var h=function(q,g){g=g.id;for(var k=0;k<e.length;k++){var v=e[k].getWebMapJS();v.suspendEvent("onupdatebbox");k!=g&&0==q.equals(e[k].getWebMapJS().getProjection().bbox)&&(v.zoomTo(q),e[k].updateBBOX(q));v.resumeEvent("onupdatebbox")}},m=function(q,g){q=g.id;for(g=0;g<e.length;g++){var k=e[g].getWebMapJS();k.suspendEvent("onupdatebbox");k.suspendEvent("onloadingcomplete");
g!=q&&k.draw();k.resumeEvent("onloadingcomplete");k.resumeEvent("onupdatebbox")}},u=function(){var q=a.find(".gfiapp_eprofile");q.empty();for(var g=b.getLayers(),k=0;k<g.length;k++){var v=g[k],t=jQuery("<div />",{css:{margin:8}});q.append(t);e[k]=new GFITimeElevationWindow(t);e[k].getWebMapJS().addLayer(v);e[k].getWebMapJS().getListener().id=k;e[k].getWebMapJS().addListener("onupdatebbox",h,!0);e[k].getWebMapJS().addListener("onloadingcomplete",m,!0)}c.resize(p,l)};u();b.addListener("ondimchange",
function(){var q=e[0].getWebMapJS(),g=q.getProjection().bbox.clone();q=q.getProjection().bbox.right-q.getProjection().bbox.left;var k=(new Date(b.getDimension("time").currentValue)).getTime();g.left=k;g.right=k+q;for(q=0;q<e.length;q++)e[q].getWebMapJS().zoomTo(g)},!0);b.addListener("onlayeradd",u,!0);e[0].getWebMapJS().addListener("onloadingcomplete",function(){var q=e[0].getWebMapJS().getProjection().bbox.clone();$("#info").html("Displaying dates "+b.dateToISO8601(new Date(q.left))+" till "+b.dateToISO8601(new Date(q.right)))},
!0);b.enableInlineGetFeatureInfo(!1)};this.enable=function(p,l){f(p,l)};this.disable=function(){b.enableInlineGetFeatureInfo(!0)};this.resize=function(p,l){for(var h=0;h<e.length;h++)e[h].setSize(p,l/e.length);for(h=0;h<e.length;h++);};c.enable()};WMJSExtApplications.EProfile=gfiapp_eprofile;var autowms_app=function(a,b){initWMJS();a.addClass("autowms_app_container");var c="http://localhost:8090//adaguc-services/autowms?";try{c=autowmsURL}catch(g){}var e={},f=[],p=function(g){var k=m();a.html(k+JSON.stringify(g));$(".autowms_app_fileitem_return").attr("onclick","").click(function(v){f=[];q("")});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(v){var t=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){q(t)},
100)})},l=function(g){var k=g.name;return g.leaf?"<span class='autowms_app_fileitem' name='"+g.name+"'>&#128451;&nbsp;"+k+"</span>":"<span class='autowms_app_fileitem autowms_app_diritem' name='"+g.name+"'>&#128448;&nbsp;"+k+"</span>"},h=function(g,k){var v="<span class='autowms_app_layeritem' title='Click to add to viewer' name='"+g.name+"'><span class='autowms_app_layeritem_text'>Layer "+g.text+" - ("+g.name+")</span>";return v+="<span class='autowms_app_layeritem_image'><img src=\""+(k+"&service=WMS&request=getmap&format=image/png&layers="+
g.name+"&width=400&CRS=EPSG:4326&STYLES=&EXCEPTIONS=INIMAGE&showlegend=true&"+Math.random())+'" /></span></span>'},m=function(g,k){return"<span class='autowms_app_currentpath'>AutoWMS link: <span class='autowms_app_request_container'><input class='autowms_app_request_input' type=\"text\" value=\""+c+"\"></input>  <span class='autowms_app_request_button'>-></span></span><hr/><span class='autowms_app_currentpath'>Current folder: ./"+(k+'</span><span class="autowms_app_fileitem_header"><span class="autowms_app_fileitem_return">&#128193;&nbsp;<b>../ (&#8679;)</b></span><span class="autowms_app_fileitem_refresh" name="')+
(k+'">&#8635;&nbsp;<b>Refresh</b></span></span>')},u=function(g,k){a.html("... working ... ");var v=WMJSGetServiceFromStore(k,xml2jsonrequestURL);v.getLayerObjectsFlat(function(t){var n=""+m(g,k);n+="<span class='autowms_app_serviceabstract'><b>"+v.title.replace(/!/g,"<br/>")+"</b><hr/>"+v.abstract.replace(/!/g,"<br/>");if(k&&(n+='<hr/>WMS: <a target="_blank" href="'+k+'&service=WMS&request=GetCapabilities">'+k+"</a>",1<k.split("?").length)){var r=new WMJSKVP(k.split("?")[1]),w=k.split("?")[0].replace("adagucserver",
"adagucopendap/");w=w.replace(/([^:]\/)\/+/g,"$1");r.source&&(w+=r.source);r.dataset&&(w+=r.dataset+"/");n=n+('<hr/>OpenDAP: <span class=\'autowms_app_opendaplinks\'><a target="_blank" href="'+w+'">'+w+'</a><a target="_blank" href="')+(w+'.das">DAS</a><a target="_blank" href="')+(w+'.dds">DDS</a></span>')}n+="</span>";a.html("... working ... ");e={};for(r=0;r<t.length;r++)n+=h(t[r],k),e[t[r].name]=t[r];a.html(n);$(".autowms_app_layeritem").attr("onclick","").click(function(x){x=e[$(this).attr("name")];
window.location.hash="addlayer('"+k+"','"+x.name+"')"});$(".autowms_app_fileitem_return").attr("onclick","").click(function(x){q(f.pop())});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(x){var y=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){u(g,y)},100)});$(".autowms_app_request_button").attr("onclick","").click(function(x){q("")});$(".autowms_app_request_input").keyup(function(x){13==x.keyCode&&q("")})},
function(t){t=m();t=t+"<span class='autowms_app_error_container'><span class='autowms_app_error_container_header'>Unable to get WMS GetCapabilities</span><a target='_blank' href=\""+(k+'service=WMS&request=GetCapabilities">'+k+"</a>");a.html(t+"</span>");$(".autowms_app_fileitem_return").attr("onclick","").click(function(n){f=[];q("")})},!0)},q=function(g){g&&"undefined"!==g||(g="");var k=$(".autowms_app_request_input").first().val();k&&0<k.length&&(c=k.trim().split("?")[0],c.endsWith("?")||(c+="?"));
var v=function(n){if(n.error)a.html("Error from server: "+n.error);else{e={};f[f.length-1]!==g&&f.push(g);var r=m(n,g);a.html("... working ... ");n.result.sort(function(x,y){if(x.leaf===y.leaf)return 0;if(!0===x.leaf)return 1;if(!0===y.leaf)return-1});for(var w=0;w<n.result.length;w++)r+=l(n.result[w]),e[n.result[w].name]=n.result[w];a.html(r);$(".autowms_app_fileitem_return").attr("onclick","").click(function(x){f.pop();q(f[f.length-1])});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(x){var y=
$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){q(y)},100)});$(".autowms_app_fileitem").attr("onclick","").click(function(x){x=e[$(this).attr("name")];!1===x.leaf?q(x.path):u(n,x.adaguc)});$(".autowms_app_request_button").attr("onclick","").click(function(x){q("")});$(".autowms_app_request_input").keyup(function(x){13==x.keyCode&&q("")})}},t=c+"request=getfiles&path="+g;a.html('... Reading <a href="'+t+'">'+t+"</a> ... ");try{$.ajax({contentType:"application/json",
crossDomain:!0,type:"GET",url:t,success:v,error:function(n){console.error("Request failed without jsonp, trying jsonp");v({result:[]});$.ajax({dataType:"jsonp",contentType:"application/jsonp",crossDomain:!0,type:"GET",url:t,success:v,error:function(r){p("Unable to do ajax call")}})}})}catch(n){console.error(n),p(n)}};this.enable=function(){a.html("<div>Initializing...</div>");q("")};this.disable=function(){};this.resize=function(g,k){}};try{WMJSExtApplications.AutoWMS=autowms_app}catch(a){};
