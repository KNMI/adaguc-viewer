...
$jscomp.polyfillIsolated=function(c,n,w,x){var A=c.split(".");c=1===A.length;x=A[0];x=!c&&x in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var Q=0;Q<A.length-1;Q++){var L=A[Q];if(!(L in x))return;x=x[L]}A=A[A.length-1];w=$jscomp.IS_SYMBOL_NATIVE&&"es6"===w?x[A]:null;n=n(w);null!=n&&(c?$jscomp.defineProperty($jscomp.polyfills,A,{configurable:!0,writable:!0,value:n}):n!==w&&(void 0===$jscomp.propertyToPolyfillSymbol[A]&&(w=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[A]=$jscomp.IS_SYMBOL_NATIVE?
...
$jscomp.polyfill("Symbol",function(c){if(c)return c;var n=function(Q,L){this.$jscomp$symbol$id_=Q;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:L})};n.prototype.toString=function(){return this.$jscomp$symbol$id_};var w="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",x=0,A=function(Q){if(this instanceof A)throw new TypeError("Symbol is not a constructor");return new n(w+(Q||"")+"_"+x++,Q)};return A},"es6","es3");
...
$jscomp.asyncExecutePromiseGenerator=function(c){function n(x){return c.next(x)}function w(x){return c.throw(x)}return new Promise(function(x,A){function Q(L){L.done?x(L.value):Promise.resolve(L.value).then(n,w).then(Q,A)}Q(c.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(c){return $jscomp.asyncExecutePromiseGenerator(c())};$jscomp.asyncExecutePromiseGeneratorProgram=function(c){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(c)))};
...
$jscomp.polyfill("Promise",function(c){function n(){this.batch_=null}function w(L){return L instanceof A?L:new A(function(P,I){P(L)})}if(c&&(!($jscomp.FORCE_POLYFILL_PROMISE||$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION&&"undefined"===typeof $jscomp.global.PromiseRejectionEvent)||!$jscomp.global.Promise||-1===$jscomp.global.Promise.toString().indexOf("[native code]")))return c;n.prototype.asyncExecute=function(L){if(null==this.batch_){this.batch_=[];var P=this;this.asyncExecuteFunction(function(){P.executeBatch_()})}this.batch_.push(L)};
var x=$jscomp.global.setTimeout;n.prototype.asyncExecuteFunction=function(L){x(L,0)};n.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var L=this.batch_;this.batch_=[];for(var P=0;P<L.length;++P){var I=L[P];L[P]=null;try{I()}catch(U){this.asyncThrow_(U)}}}this.batch_=null};n.prototype.asyncThrow_=function(L){this.asyncExecuteFunction(function(){throw L;})};var A=function(L){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var P=this.createResolveAndReject_();
try{L(P.resolve,P.reject)}catch(I){P.reject(I)}};A.prototype.createResolveAndReject_=function(){function L(U){return function(T){I||(I=!0,U.call(P,T))}}var P=this,I=!1;return{resolve:L(this.resolveTo_),reject:L(this.reject_)}};A.prototype.resolveTo_=function(L){if(L===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(L instanceof A)this.settleSameAsPromise_(L);else{a:switch(typeof L){case "object":var P=null!=L;break a;case "function":P=!0;break a;default:P=!1}P?this.resolveToNonPromiseObj_(L):
this.fulfill_(L)}};A.prototype.resolveToNonPromiseObj_=function(L){var P=void 0;try{P=L.then}catch(I){this.reject_(I);return}"function"==typeof P?this.settleSameAsThenable_(P,L):this.fulfill_(L)};A.prototype.reject_=function(L){this.settle_(2,L)};A.prototype.fulfill_=function(L){this.settle_(1,L)};A.prototype.settle_=function(L,P){if(0!=this.state_)throw Error("Cannot settle("+L+", "+P+"): Promise already settled in state"+this.state_);this.state_=L;this.result_=P;2===this.state_&&this.scheduleUnhandledRejectionCheck_();
this.executeOnSettledCallbacks_()};A.prototype.scheduleUnhandledRejectionCheck_=function(){var L=this;x(function(){if(L.notifyUnhandledRejection_()){var P=$jscomp.global.console;"undefined"!==typeof P&&P.error(L.result_)}},1)};A.prototype.notifyUnhandledRejection_=function(){if(this.isRejectionHandled_)return!1;var L=$jscomp.global.CustomEvent,P=$jscomp.global.Event,I=$jscomp.global.dispatchEvent;if("undefined"===typeof I)return!0;"function"===typeof L?L=new L("unhandledrejection",{cancelable:!0}):
"function"===typeof P?L=new P("unhandledrejection",{cancelable:!0}):(L=$jscomp.global.document.createEvent("CustomEvent"),L.initCustomEvent("unhandledrejection",!1,!0,L));L.promise=this;L.reason=this.result_;return I(L)};A.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var L=0;L<this.onSettledCallbacks_.length;++L)Q.asyncExecute(this.onSettledCallbacks_[L]);this.onSettledCallbacks_=null}};var Q=new n;A.prototype.settleSameAsPromise_=function(L){var P=this.createResolveAndReject_();
L.callWhenSettled_(P.resolve,P.reject)};A.prototype.settleSameAsThenable_=function(L,P){var I=this.createResolveAndReject_();try{L.call(P,I.resolve,I.reject)}catch(U){I.reject(U)}};A.prototype.then=function(L,P){function I(ba,ia){return"function"==typeof ba?function(la){try{U(ba(la))}catch(ma){T(ma)}}:ia}var U,T,O=new A(function(ba,ia){U=ba;T=ia});this.callWhenSettled_(I(L,U),I(P,T));return O};A.prototype.catch=function(L){return this.then(void 0,L)};A.prototype.callWhenSettled_=function(L,P){function I(){switch(U.state_){case 1:L(U.result_);
break;case 2:P(U.result_);break;default:throw Error("Unexpected state: "+U.state_);}}var U=this;null==this.onSettledCallbacks_?Q.asyncExecute(I):this.onSettledCallbacks_.push(I);this.isRejectionHandled_=!0};A.resolve=w;A.reject=function(L){return new A(function(P,I){I(L)})};A.race=function(L){return new A(function(P,I){for(var U=$jscomp.makeIterator(L),T=U.next();!T.done;T=U.next())w(T.value).callWhenSettled_(P,I)})};A.all=function(L){var P=$jscomp.makeIterator(L),I=P.next();return I.done?w([]):new A(function(U,
T){function O(la){return function(ma){ba[la]=ma;ia--;0==ia&&U(ba)}}var ba=[],ia=0;do ba.push(void 0),ia++,w(I.value).callWhenSettled_(O(ba.length-1),T),I=P.next();while(!I.done)})};return A},"es6","es3");$jscomp.polyfill("Object.is",function(c){return c?c:function(n,w){return n===w?0!==n||1/n===1/w:n!==n&&w!==w}},"es6","es3");
$jscomp.polyfill("Array.prototype.includes",function(c){return c?c:function(n,w){var x=this;x instanceof String&&(x=String(x));var A=x.length;w=w||0;for(0>w&&(w=Math.max(w+A,0));w<A;w++){var Q=x[w];if(Q===n||Object.is(Q,n))return!0}return!1}},"es7","es3");
...
$jscomp.iteratorFromArray=function(c,n){c instanceof String&&(c+="");var w=0,x=!1,A={next:function(){if(!x&&w<c.length){var Q=w++;return{value:n(Q,c[Q]),done:!1}}x=!0;return{done:!0,value:void 0}}};A[Symbol.iterator]=function(){return A};return A};$jscomp.polyfill("Array.prototype.values",function(c){return c?c:function(){return $jscomp.iteratorFromArray(this,function(n,w){return w})}},"es8","es3");
$jscomp.findInternal=function(c,n,w){c instanceof String&&(c=String(c));for(var x=c.length,A=0;A<x;A++){var Q=c[A];if(n.call(w,Q,A,c))return{i:A,v:Q}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(c){return c?c:function(n,w){return $jscomp.findInternal(this,n,w).v}},"es6","es3");
...
$jscomp.polyfill("Float64Array.prototype.fill",$jscomp.typedArrayFill,"es6","es5");$jscomp.polyfill("Array.from",function(c){return c?c:function(n,w,x){w=null!=w?w:function(P){return P};var A=[],Q="undefined"!=typeof Symbol&&Symbol.iterator&&n[Symbol.iterator];if("function"==typeof Q){n=Q.call(n);for(var L=0;!(Q=n.next()).done;)A.push(w.call(x,Q.value,L++))}else for(Q=n.length,L=0;L<Q;L++)A.push(w.call(x,n[L],L));return A}},"es6","es3");
...
$jscomp.polyfill("WeakMap",function(c){function n(){if(!c||!Object.seal)return!1;try{var U=Object.seal({}),T=Object.seal({}),O=new c([[U,2],[T,3]]);if(2!=O.get(U)||3!=O.get(T))return!1;O.delete(U);O.set(T,4);return!O.has(U)&&4==O.get(T)}catch(ba){return!1}}function w(){}function x(U){var T=typeof U;return"object"===T&&null!==U||"function"===T}function A(U){if(!$jscomp.owns(U,L)){var T=new w;$jscomp.defineProperty(U,L,{value:T})}}function Q(U){if(!$jscomp.ISOLATE_POLYFILLS){var T=Object[U];T&&(Object[U]=
function(O){if(O instanceof w)return O;Object.isExtensible(O)&&A(O);return T(O)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(c&&$jscomp.ES6_CONFORMANCE)return c}else if(n())return c;var L="$jscomp_hidden_"+Math.random();Q("freeze");Q("preventExtensions");Q("seal");var P=0,I=function(U){this.id_=(P+=Math.random()+1).toString();if(U){U=$jscomp.makeIterator(U);for(var T;!(T=U.next()).done;)T=T.value,this.set(T[0],T[1])}};I.prototype.set=function(U,T){if(!x(U))throw Error("Invalid WeakMap key");
A(U);if(!$jscomp.owns(U,L))throw Error("WeakMap key fail: "+U);U[L][this.id_]=T;return this};I.prototype.get=function(U){return x(U)&&$jscomp.owns(U,L)?U[L][this.id_]:void 0};I.prototype.has=function(U){return x(U)&&$jscomp.owns(U,L)&&$jscomp.owns(U[L],this.id_)};I.prototype.delete=function(U){return x(U)&&$jscomp.owns(U,L)&&$jscomp.owns(U[L],this.id_)?delete U[L][this.id_]:!1};return I},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(c){function n(){if($jscomp.ASSUME_NO_NATIVE_MAP||!c||"function"!=typeof c||!c.prototype.entries||"function"!=typeof Object.seal)return!1;try{var I=Object.seal({x:4}),U=new c($jscomp.makeIterator([[I,"s"]]));if("s"!=U.get(I)||1!=U.size||U.get({x:4})||U.set({x:4},"t")!=U||2!=U.size)return!1;var T=U.entries(),O=T.next();if(O.done||O.value[0]!=I||"s"!=O.value[1])return!1;O=T.next();return O.done||4!=O.value[0].x||"t"!=O.value[1]||!T.next().done?!1:!0}catch(ba){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(c&&$jscomp.ES6_CONFORMANCE)return c}else if(n())return c;var w=new WeakMap,x=function(I){this.data_={};this.head_=L();this.size=0;if(I){I=$jscomp.makeIterator(I);for(var U;!(U=I.next()).done;)U=U.value,this.set(U[0],U[1])}};x.prototype.set=function(I,U){I=0===I?0:I;var T=A(this,I);T.list||(T.list=this.data_[T.id]=[]);T.entry?T.entry.value=U:(T.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:I,value:U},T.list.push(T.entry),
this.head_.previous.next=T.entry,this.head_.previous=T.entry,this.size++);return this};x.prototype.delete=function(I){I=A(this,I);return I.entry&&I.list?(I.list.splice(I.index,1),I.list.length||delete this.data_[I.id],I.entry.previous.next=I.entry.next,I.entry.next.previous=I.entry.previous,I.entry.head=null,this.size--,!0):!1};x.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=L();this.size=0};x.prototype.has=function(I){return!!A(this,I).entry};x.prototype.get=function(I){return(I=
A(this,I).entry)&&I.value};x.prototype.entries=function(){return Q(this,function(I){return[I.key,I.value]})};x.prototype.keys=function(){return Q(this,function(I){return I.key})};x.prototype.values=function(){return Q(this,function(I){return I.value})};x.prototype.forEach=function(I,U){for(var T=this.entries(),O;!(O=T.next()).done;)O=O.value,I.call(U,O[1],O[0],this)};x.prototype[Symbol.iterator]=x.prototype.entries;var A=function(I,U){var T=U&&typeof U;"object"==T||"function"==T?w.has(U)?T=w.get(U):
(T=""+ ++P,w.set(U,T)):T="p_"+U;var O=I.data_[T];if(O&&$jscomp.owns(I.data_,T))for(I=0;I<O.length;I++){var ba=O[I];if(U!==U&&ba.key!==ba.key||U===ba.key)return{id:T,list:O,index:I,entry:ba}}return{id:T,list:O,index:-1,entry:void 0}},Q=function(I,U){var T=I.head_;return $jscomp.iteratorPrototype(function(){if(T){for(;T.head!=I.head_;)T=T.previous;for(;T.next!=T.head;)return T=T.next,{done:!1,value:U(T)};T=null}return{done:!0,value:void 0}})},L=function(){var I={};return I.previous=I.next=I.head=I},
P=0;return x},"es6","es3");
$jscomp.polyfill("Set",function(c){function n(){if($jscomp.ASSUME_NO_NATIVE_SET||!c||"function"!=typeof c||!c.prototype.entries||"function"!=typeof Object.seal)return!1;try{var x=Object.seal({x:4}),A=new c($jscomp.makeIterator([x]));if(!A.has(x)||1!=A.size||A.add(x)!=A||1!=A.size||A.add({x:4})!=A||2!=A.size)return!1;var Q=A.entries(),L=Q.next();if(L.done||L.value[0]!=x||L.value[1]!=x)return!1;L=Q.next();return L.done||L.value[0]==x||4!=L.value[0].x||L.value[1]!=L.value[0]?!1:Q.next().done}catch(P){return!1}}
...
function(x){return this.map_.has(x)};w.prototype.entries=function(){return this.map_.entries()};w.prototype.values=function(){return this.map_.values()};w.prototype.keys=w.prototype.values;w.prototype[Symbol.iterator]=w.prototype.values;w.prototype.forEach=function(x,A){var Q=this;this.map_.forEach(function(L){return x.call(A,L,L,Q)})};return w},"es6","es3");
...
$jscomp.polyfill("Math.hypot",function(c){return c?c:function(n){if(2>arguments.length)return arguments.length?Math.abs(arguments[0]):0;var w,x,A;for(w=A=0;w<arguments.length;w++)A=Math.max(A,Math.abs(arguments[w]));if(1E100<A||1E-100>A){if(!A)return A;for(w=x=0;w<arguments.length;w++){var Q=Number(arguments[w])/A;x+=Q*Q}return Math.sqrt(x)*A}for(w=x=0;w<arguments.length;w++)Q=Number(arguments[w]),x+=Q*Q;return Math.sqrt(x)}},"es6","es3");
$jscomp.polyfill("Math.sign",function(c){return c?c:function(n){n=Number(n);return 0===n||isNaN(n)?n:0<n?1:-1}},"es6","es3");$jscomp.polyfill("Math.log1p",function(c){return c?c:function(n){n=Number(n);if(.25>n&&-.25<n){for(var w=n,x=1,A=n,Q=0,L=1;Q!=A;)w*=n,L*=-1,A=(Q=A)+L*w/++x;return A}return Math.log(1+n)}},"es6","es3");$jscomp.polyfill("Math.log10",function(c){return c?c:function(n){return Math.log(n)/Math.LN10}},"es6","es3");
$jscomp.polyfill("Math.log2",function(c){return c?c:function(n){return Math.log(n)/Math.LN2}},"es6","es3");$jscomp.polyfill("Math.expm1",function(c){return c?c:function(n){n=Number(n);if(.25>n&&-.25<n){for(var w=n,x=1,A=n,Q=0;Q!=A;)w*=n/++x,A=(Q=A)+w;return A}return Math.exp(n)-1}},"es6","es3");$jscomp.polyfill("Array.prototype.keys",function(c){return c?c:function(){return $jscomp.iteratorFromArray(this,function(n){return n})}},"es6","es3");
...
w+" failed")}n.dimSlider=Ext.create("Ext.slider.Single",{width:50,useTips:!1,region:"center",value:w,minValue:0,maxValue:n.dimension.size()-1,increment:1,listeners:{drag:{fn:function(A){n.sliderChanged(A.getValue())}},change:{fn:function(A){n.sliderChanged(A.getValue())}}}});n.dimCheck=Ext.create("Ext.form.Checkbox",{margin:"0 0 0 0",bodyStyle:{"background-color":"white"},frame:!1,border:!1,plain:!0,checked:n.dimension.linked,handler:function(A,Q){console.log("CHECKBOX",x[1].disabled);x[1].setDisabled(!Q);
n.dimension.linked=Q}});n.setValue=function(A){if(A!==n.currentValue||n.dimension.size()!==n.currentSize)return n._setValue(A)};n._setValue=function(A){n.currentValue=A;n.currentSize=n.dimension.size();try{if(A==WMJSDateTooEarlyString)n.currentIndex=0,n.dimensionValueLabel.setValueText(WMJSDateTooEarlyString);else if(A==WMJSDateTooLateString)n.currentIndex=n.dimension.size()-1,n.dimensionValueLabel.setValueText(WMJSDateTooLateString);else if(n.currentIndex=this.dimension.getIndexForValue(A),-1!=n.currentIndex)n.dimensionValueLabel.setValueText(n.getValue());
else{var Q=parseISO8601DateToDate(A),L=parseISO8601DateToDate(n.dimension.get(0)),P=parseISO8601DateToDate(n.dimension.get(n.dimension.size()-1));Q.getTime()<L.getTime()?(console.log("SOY YO",WMJSDateTooEarlyString),n.dimensionValueLabel.setValueText(WMJSDateTooEarlyString),n.layer.setDimension(n.dimension.name,WMJSDateTooEarlyString),n.currentIndex=0):Q.getTime()>P.getTime()?(console.log(" o AQUI",A),n.dimensionValueLabel.setValueText(WMJSDateTooLateString),n.layer.setDimension(n.dimension.name,
WMJSDateTooLateString),n.currentIndex=n.dimension.size()-1):(console.log(" O AQUI",A),n.dimensionValueLabel.setValueText(WMJSDateOutSideRange),n.layer.setDimension(n.dimension.name,WMJSDateOutSideRange))}}catch(I){n.dimensionValueLabel.setValueText(WMJSDateOutSideRange),n.layer.setDimension(n.dimension.name,WMJSDateOutSideRange),n.currentIndex=0}n.dimSlider.suspendEvents();n.dimSlider.setValue(n.currentIndex,!1);n.dimSlider.resumeEvents()};n.checkReferenceTime=function(A){var Q=-1;A=-1;for(var L=
0;L<n.dimensionPanels.length;L++){var P=n.layer.getDimension(n.dimensionPanels[L].dimension.name);"time"==P.name&&"ISO8601"==P.units&&(A=L);"reference_time"==P.name&&"ISO8601"==P.units&&(Q=L);"forecast_reference_time"==P.name&&"ISO8601"==P.units&&(Q=L)}n.dimSlider.suspendEvents();-1!=A&&-1!=Q&&(L=n.layer.getDimension(n.dimensionPanels[A].dimension.name),Q=n.layer.getDimension(n.dimensionPanels[Q].dimension.name),L.getValue()<Q.getValue()&&(console.log("time should be increased:  "+L.getValue()+"<"+
Q.getValue()),Q=Q.getValue(),n.dimensionPanels[A].dimSlider.setValue(L.getIndexForValue(Q)+1,!1)));n.dimSlider.resumeEvents()};n.sliderChanged=function(A){var Q=n.Parent.getUpdateStatus();n.Parent.setUpdateStatus(!1);try{n.layer.parentMaps[0].stopAnimating()}catch(L){n.Parent.setUpdateStatus(Q)}n.currentIndex=A;n.dimensionValueLabel.setValueText(n.getValue());n.layer.setDimension(n.dimension.name,n.getValue());isDefined(n.dateTimeWindow)&&n.dateTimeWindow.setDimension(this.dimension);n.checkReferenceTime(n.dimension);
...
name:"PT6H"},{title:"Daily",name:"P1D"}]}),w=Ext.create("Ext.form.ComboBox",{fieldLabel:"Choose duration",store:w,queryMode:"local",displayField:"title",valueField:"name",region:"center",listeners:{select:function(A,Q){n.timeRangeDuration=Q[0].get("name");A=n.dimension.getValue();try{A=n.layer.parentMaps[0].getDimension(n.dimension.name).currentValue}catch(L){}-1!=A.indexOf("/")&&(A=A.split("/")[0]);n.dimension.setTimeRangeDuration(n.timeRangeDuration);n.dimSlider.setMaxValue(n.dimension.size()-1);
...
c;x.servicePanel=Ext.create("webmapjsext.WMJSExt.ServicePanel",{header:!1,constrain:!0,autoDestroy:!1,height:400,service:x.layerpanel.WMJSLayer.service,name:x.layerpanel.WMJSLayer.name,border:0,itemclick:function(A,Q){x.layerpanel.setLayer(Q)}});x.window=Ext.create("webmapjsext.WMJSExt.WindowFader",{title:I18n.layers.text,autoDestroy:!1,closeAction:"hide",autoScroll:!0,floating:!0,animate:!0,constrain:!0,width:500,items:[x.servicePanel],bbar:[{iconCls:"button_refresh",handler:function(){x.window.refresh()}},
{text:I18n.embed.text,tooltip:"Embed layer view",handler:function(){x.window.hide();x.layerpanel.add(Ext.create("webmapjsext.WMJSExt.ServicePanel",{title:I18n.layers.text,header:!0,collapsible:!0,service:x.layerpanel.WMJSLayer.service,name:x.layerpanel.WMJSLayer.name,border:2,itemclick:function(A,Q,L){x.layerpanel.setLayer(Q,L)}}))}},{scale:"small",tooltip:I18n.add_new_layer.tooltip,iconCls:"layer_logos button_layerlist_layernew",handler:function(){Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:function(A){x.layerpanel.service=
A.service;x.layerpanel.name=A.layer;x.layerpanel.WMJSLayer.service=x.layerpanel.service;x.layerpanel.WMJSLayer.name=x.layerpanel.name;x.layerpanel.parseLayer(!0,function(Q,L){isDefined(A.ready)&&A.ready(n,x.layerpanel.parentWebMapJS)});return n},webMapJS:x.layerpanel.parentWebMapJS}).show()}}]});x.window.refresh=function(){x.servicePanel.buildTreeFromNodes(!0)};return x.window}}});var webmapjsext_WMJSExt_LayerPanel_ServicePanelManager,getServicePanelManager=function(){webmapjsext_WMJSExt_LayerPanel_ServicePanelManager||(webmapjsext_WMJSExt_LayerPanel_ServicePanelManager=Ext.create("webmapjsext.WMJSExt.ServicePanelManager",{}));return webmapjsext_WMJSExt_LayerPanel_ServicePanelManager};
...
name:c.name,style:c.style,opacity:c.opacity,transparent:c.transparent,enabled:c.enabled,updatetime:c.updatetime});c.reload=function(x){x=c.getDimensionPanel("time").dimension;var A=void 0,Q=void 0;A=c.getDimensionPanel("forecast_reference_time");c.getDimensionPanel("time");isDefined(A)&&(A=A.dimension,Q=A.currentValue);var L=x.dimMaxValue;x=c.WMJSLayer.service+"&service=WMS&request=GetCapabilities";var P=new ol.format.WMSCapabilities,I=function(U,T){console.log("Reload ON");isDefined(T)?console.log("Update for Reference_Time",
new Date):isDefined(U)};if(!x.includes("files")&&n)try{fetch(x).then(function(U){return U.text()}).then(function(U){U=P.read(U).Capability.Layer.Layer;U=$jscomp.makeIterator(U);for(var T=U.next();!T.done;T=U.next()){var O=T.value;if(O.Name==c.name){var ba=void 0;T=void 0;O=$jscomp.makeIterator(O.Dimension);for(var ia=O.next();!ia.done;ia=O.next())ia=ia.value,"time"==ia.name&&(ba=ia),"forecast_reference_time"==ia.name&&(T=ia);O=ba.default;ba=ba.values.split("/")[1];isDefined(T)?(T=T.default,console.log("REF",
T,Q),Q!=T&&c.parseLayer(!0,I(O,T))):(console.log("TIME",ba,L,O),L!=ba&&c.parseLayer(!0,I(O,void 0)))}}})}catch(U){console.log(e)}};c.getUpdateTime=function(x){return"PT1D"==x?216E5:"PT12H"==x?108E5:"PT6H"==x?72E5:"PT3H"==x?36E5:"PT1H30M"==x?18E5:"PT1H"==x?12E5:"PT30M"==x?6E5:"PT15M"==x?3E5:"PT10M"==x?18E4:"PT5M"==x?12E4:"PT3M"==x||"PT1M"==x?6E4:null};c.getUpdateStatus=function(){return n};c.setUpdateStatus=function(x){n=x};c.opacitySliderChanged=function(x){c.WMJSLayer&&(c.WMJSLayer.setOpacity(x/
...
Ext.create("Ext.button.Button",{xtype:"button",tooltip:I18n.auto_update_layer.tooltip,iconCls:!0===n?"button_update_on":"button_update_off",handler:function(x,A){n=!n;0==n?this.setIconCls("button_update_off"):(this.setIconCls("button_update_on"),c.reload());c.WMJSLayer.draw("LayerPanel::HideShow")}});c.select=function(){for(var x=c.parentPanelList.items,A=0;A<x.getCount();A++)x.get(A).unselect();try{c.getEl().dom.style.border="3px solid #8080FF"}catch(Q){}c.selected=!0};c.unselect=function(){try{c.getEl().dom.style.border=
"3px solid #777"}catch(x){}c.selected=!1};c.setOpacity=function(x){c.opacitySlider.setValue(100*x);c.opacity=100*x};c.dimCallBackAdded=!1;c.dimensionPanels=[];c.parseLayer=function(x,A){if(0!=isDefined(this.WMJSLayer.service)&&0!=this.WMJSLayer.service.length){c.setLoading("Reading GetCapabilities ...");for(var Q=[],L=0;L<c.WMJSLayer.dimensions.length;L++)Q.push(this.WMJSLayer.dimensions[L].clone());c.dimensionPanels=[];c.dimUpdate=function(){for(var I=0;I<c.dimensionPanels.length;I++){var U=c.WMJSLayer.getDimension(c.dimensionPanels[I].dimension.name);
c.dimensionPanels[I].setValue(U.getValue())}};c.setDimension=function(I,U){var T=c.getDimensionPanel(I);isDefined(T)?(c.WMJSLayer.setDimension(I,U),T.setValue(U)):error("WMJSExtLayerPanel::Dimension "+I+" not found")};c.getDimensionPanel=function(I){for(var U=0;U<c.dimensionPanels.length;U++)if(c.dimensionPanels[U].dimension.name===I)return c.dimensionPanels[U]};var P=function(I){var U=I;I.message&&(U=I.message);c.setLoading(!1);I="Unable to parse layer "+c.WMJSLayer.name+"\n"+U;c.WMJSLayer.hasError=
...
I18n.unable_to_connect_server.text+"<br/><br/>"+U)});A&&A(c);c.afterlayerready&&c.afterlayerready(c)}else{c.WMJSLayer.getLayerRelative(function(la,ma,ua){c.productButton.setText("("+(ma+1)+"/"+ua+") "+c.WMJSLayer.title)},function(la){c.productButton.setText(c.WMJSLayer.path+c.WMJSLayer.title)});c.setStyleText(c.WMJSLayer.getStyleObject(c.WMJSLayer.currentStyle));c.dimensionPanels=[];c.dimensionPanelContainer.removeAll();var T=sync_layer,O="";for(I=0;I<c.WMJSLayer.dimensions.length;I++){for(var ba=
0;ba<Q.length;ba++)Q[ba].name==c.WMJSLayer.dimensions[I].name&&(c.WMJSLayer.setDimension(Q[ba].name,Q[ba].defaultValue),"time"==Q[ba].name&&(T=Q[ba].linked));ba=Ext.create("WMJSExtDimensionPanel",{dimension:c.WMJSLayer.dimensions[I],layer:c.WMJSLayer,dimensionPanels:c.dimensionPanels,Linked:T,Parent:c});c.dimensionPanels.push(ba);c.dimensionPanelContainer.add(ba);0<O.length&&(O+=", ");O+=c.WMJSLayer.dimensions[I].name}c.afterlayerready&&(A&&A(c),c.afterlayerready(c));for(I=0;I<c.WMJSLayer.dimensions.length;I++)T=
c.WMJSLayer.parentMaps[0].getDimension(c.WMJSLayer.dimensions[I].name),isDefined(T)&&c.WMJSLayer.dimensions[I].setClosestValue(T.defaultValue);c.setLoading(!1);for(I=0;I<c.WMJSLayer.dimensions.length;I++)T=c.WMJSLayer.parentMaps[0].getDimension(c.WMJSLayer.dimensions[I].name),c.dimensionPanels[I].setValue(c.WMJSLayer.dimensions[I].defaultValue),isDefined(T)&&T.defaultValue!=c.WMJSLayer.dimensions[I].defaultValue&&c.WMJSLayer.parentMaps[0].addListener("ondimchange",c.dimUpdate,!0),c.dimensionPanels[I].sliderChanged(c.WMJSLayer.dimensions[I].getIndexForValue(c.WMJSLayer.dimensions[I].defaultValue));
...
I18n.title.text+"</i></td><td> "+c.WMJSLayer.WMJSService.title+"</td></tr><tr><td><i>"+I18n.service.text+"</i></td><td>"+c.WMJSLayer.WMJSService.onlineresource+"</td></tr><tr><td><i>"+I18n.abstract.text+"</i></td><td>"+c.WMJSLayer.WMJSService.abstract+"</td></tr></table></span>"):c.layerAbstractPanel.update("...");I=function(){var la=c.WMJSLayer.parentMaps[0].getLegendGraphicURLForLayer(c.WMJSLayer),ma=c.WMJSLayer.parentMaps[0].getLegendStore();if(c.layerLegendPanel.getEl()){var ua=$(c.layerLegendPanel.getEl().dom).find("canvas")[0].getContext("2d");
...
w=setInterval(c.reload,c.updatetime,c.updatetime),console.log(w,c.updatetime))}};try{if(c.WMJSLayer.parseLayer(L,x,"LayerPanel::parseLayer",xml2jsonrequestURL),!0===x)try{console.log("clearing cache"),c.WMJSLayer&&c.WMJSLayer.parentMaps&&0<c.WMJSLayer.parentMaps.length&&(c.WMJSLayer.parentMaps[0].clearImageStore(),c.WMJSLayer.parentMaps[0].loadLegendInline(!0))}catch(I){console.error(I)}}catch(I){P(I)}}};c.duplicateLayer=function(){createNewLayerPanel(c.parentWebMapJS,c.WMJSLayer)};c.productButton=
Ext.create("Ext.button.Button",{text:I18n.please_select_product.text,textAlign:"left",iconAlign:"right",iconCls:"button_combobox",tooltip:I18n.select_layer_product_from_service.tooltip,handler:function(x){void 0==c.service||0==c.service.length?Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:function(A){c.service=A.service;c.name=A.layer;c.WMJSLayer.service=c.service;c.WMJSLayer.name=c.name;c.parseLayer(!0,function(Q,L){isDefined(A.ready)&&A.ready(c,c.parentWebMapJS)},!0);return c},webMapJS:c.parentWebMapJS}).show():
...
name:c.WMJSLayer.name,border:2,itemclick:function(x,A,Q){c.setLayer(A,Q)}});c.layerInfoPanelContainer=Ext.create("Ext.panel.Panel",{border:!1,frame:!1,height:35,padding:"3 3 3 3",layout:"border",items:[{xtype:"panel",region:"center",layout:"fit",border:!1,frame:!1,items:[c.productButton]},{style:{borderColor:"#EEE",borderStyle:"solid",borderWidth:"0px",backgroundColor:"#FFF"},xtype:"panel",region:"east",itemId:"layerinfo",width:40,layout:"hbox",border:!1,frame:!1,padding:"0 0 0 0",items:[{xtype:"button",
...
x=c.WMJSLayer.getDimension("time"),void 0==x)alert(I18n.no_time_dimension_in_layer.text);else{!1===c.WMJSLayer.getDimension("time").linked&&(c.WMJSLayer.getDimension("time").linked=!0,c.parseLayer(!1,void 0));for(var A=[],Q=x.size(),L=void 0,P=0;P<c.WMJSLayer.dimensions.length;P++)c.WMJSLayer.dimensions[P].name.includes("reference_time")&&(L=c.WMJSLayer.dimensions[P]);isDefined(L)?(refMaxValue=L.currentValue,P=x.getIndexForValue(refMaxValue)):P=Q-24;L=Q;var I=x.getIndexForValue(x.currentValue);I=
L-1-I;P-=I;L-=I;0>P&&(L+=-P,P=0);0>L&&(L=0);P>Q-1&&(P=Q-1);for(L>Q&&(L=Q);P<L;P++)A.push({name:x.name,value:x.getValueForIndex(P)});c.WMJSLayer.parentMaps[0].draw(A)}}};c.moveUp=function(){var x=c.up("panel"),A=x.items.indexOf(c);0<A&&(x.move(A,A-1),c.WMJSLayer.moveUp())};c.moveDown=function(){var x=c.up("panel"),A=x.items.indexOf(c);A<x.items.length-1&&(x.move(A,A+1),c.WMJSLayer.moveDown())};c.layerLegendPanel=Ext.create("Ext.panel.Panel",{xtype:"panel",region:"west",html:"<canvas width=90 height=250></canvas>",
...
A){c.propertiesPanel||(c.propertiesPanel=Ext.create("Ext.window.Window",{title:I18n.properties_for.text+c.WMJSLayer.title,width:600,autoDestroy:!1,closeAction:"hide",layout:"fit",items:[Ext.create("WMJSExtLayerPropertiesPanel",{header:!1,WMJSLayerObject:c.WMJSLayer,border:0,itemclick:function(Q,L){}})]}));c.propertiesPanel.showAt(x.getPosition())}},{iconCls:"button_refresh",tooltip:I18n.reload_this_layer.tooltip,handler:function(){isDefined(c.servicePanelWindow)&&c.servicePanelWindow.refresh(!0);
...
{text:I18n.title.text,dataIndex:"title",flex:2},{text:I18n.layer.text,dataIndex:"name",flex:1},{text:I18n.type.text,dataIndex:"type"}],columnLines:!0,iconCls:"icon-grid"}),listeners:{show:{fn:function(){for(var w=[],x=c.webMapJS.getBaseLayers(),A=0;A<x.length;A++){var Q=x[A].title;0==A&&(Q="Default base layer");w.push({title:Q,layer:x[A],name:x[A].name,enabled:x[A].enabled,type:1==x[A].keepOnTop?"overlay":"baselayer"})}n.loadRawData(w)}}}});this.superclass.initComponent.apply(this,arguments)}});defaultBaselayer={service:"https://geoservices.knmi.nl/wms?DATASET=baselayers&",name:"countryborders"};
...
trackOver:!0,overItemCls:"x-item-over",itemSelector:"div.thumb-wrap",emptyText:"No images to display",prepareData:function(w){var x=[w.bbox[0],w.bbox[1],w.bbox[2],w.bbox[3]];if(1.375<(w.bbox[2]-w.bbox[0])/(w.bbox[3]-w.bbox[1])){var A=(w.bbox[2]-w.bbox[0])/1.375;A=(A-(w.bbox[3]-w.bbox[1]))/2;x[1]=w.bbox[1]-A;x[3]=w.bbox[3]+A}else A=1.375*(w.bbox[3]-w.bbox[1]),A=(A-(w.bbox[2]-w.bbox[0]))/2,x[0]=w.bbox[0]-A,x[2]=w.bbox[2]+A;A=defaultBaselayer.service;var Q=defaultBaselayer.name;w.baselayer.service&&
w.baselayer.name&&(A=w.baselayer.service,Q=w.baselayer.name);w.url=A+"service=WMS&request=GetMap&styles=&width=160&height=120&format=image/png";w.url+="&layers="+Q;w.url+="&version=1.1.1";w.url+="&bbox="+x[0]+","+x[1]+","+x[2]+","+x[3];w.url+="&srs="+w.srs;return w},listeners:{itemclick:function(w,x){c(x)}}})]});this.superclass.initComponent.apply(this,arguments)}});Ext.define("webmapjsext.WMJSExt.AnimationPanel",{extend:"Ext.panel.Panel",alias:"WMJSExtAnimationPanel",requires:["Ext.form.field.ComboBox","Ext.form.field.Picker","Ext.form.field.Trigger","Ext.layout.container.Form"],initComponent:function(){var c=this,n=Ext.create("Ext.data.Store",{fields:[{type:"string",name:"name"},{type:"string",name:"title"},{type:"object",name:"wmjslayer"}]}),w=Ext.create("Ext.data.Store",{fields:[{type:"string",name:"name"},{type:"object",name:"wmjsdimension"}]}),x=function(){var P=
c.mappanel.webMapJS.getLayers();n.removeAll();for(var I=0;I<P.length;I++)n.add({name:P[I].service+P[I].name,title:P[I].title,wmjslayer:P[I]})},A=function(P){if(isDefined(P)){c.selectedLayer=P;var I=c.getComponent("dimensionpanel").getComponent("dimensioncombobox");I.disable();w.removeAll();for(var U=0;U<P.dimensions.length;U++)w.add({name:P.dimensions[U].name,wmjsdimension:P.dimensions[U]});0<w.getCount()&&(I.setValue(w.getAt(0).get("name")),Q(w.getAt(0).get("wmjsdimension")),I.enable())}},Q=function(P){isDefined(P)&&
...
itemId:"layercombo",region:"center",fieldLabel:I18n.select_layer.text,labelWidth:110,displayField:"title",valuefield:"name",store:n,queryMode:"local",listeners:{select:{fn:function(P,I){P=I[0].get("wmjslayer");A(P)}}}},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",handler:function(){x()}}]},{xtype:"panel",itemId:"dimensionpanel",layout:"fit",frame:!0,border:!1,margin:3,height:36,items:[{margin:3,xtype:"combobox",itemId:"dimensioncombobox",region:"center",fieldLabel:I18n.select_dimension.text,
labelWidth:110,disabled:!0,store:w,displayField:"name",valuefield:"name",queryMode:"local",listeners:{select:{fn:function(P,I){Q(I[0].get("wmjsdimension"))}}}}]},{xtype:"panel",itemId:"dimensionvaluespanel",frame:!0,border:!1,margin:3,layout:"border",height:36,items:[{xtype:"label",text:I18n.start_at.text+":",width:110,region:"west",margin:3},{itemId:"dimensioncurrentvalue",xtype:"textfield",region:"center",frame:!1,border:!1,margin:3},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",
...
Q=Ext.create("Ext.data.Store",{fields:["title","srs","bbox"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),L=Ext.create("Ext.grid.Panel",{border:!1,store:Q,columns:[{text:"Title",dataIndex:"title",flex:1},{text:"ESPG Code",dataIndex:"srs"}],listeners:{select:{fn:function(ma,ua){ma=ua.get("bbox");w=ua.get("srs");A=ma;U.getComponent("column2").getComponent("areaPanel").getComponent("bboxtop").setValue(ma.split(",")[3]);U.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxwest").setValue(ma.split(",")[0]);
U.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxeast").setValue(ma.split(",")[2]);U.getComponent("column2").getComponent("areaPanel").getComponent("bboxbottom").setValue(ma.split(",")[1]);ua=Math.abs(A.split(",")[2]-A.split(",")[0]);ma=Math.abs(A.split(",")[3]-A.split(",")[1]);var Da=c.coverages[0];U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").setValue(ua/Da.width);U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").setValue(ma/
Da.height);la()}}}}),P=Ext.create("Ext.data.Store",{fields:["title","format"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),I=Ext.create("Ext.grid.Panel",{border:!1,store:P,columns:[{text:I18n.format.text,dataIndex:"format"},{text:I18n.title.text,dataIndex:"title",flex:1}],listeners:{select:{fn:function(ma,ua){x=ua.get("format");la()}}}});c.onReady=function(){L.setLoading(!1);for(var ma=this.coverages[0],ua=0;ua<ma.supportedProjections.length;ua++){var Da=ma.supportedProjections[ua].srs;
try{Da=epsgDescriptionLookup[ma.supportedProjections[ua].srs]}catch(Fa){}isDefined(Da)||(Da=ma.supportedProjections[ua].srs);Q.add({title:Da,srs:ma.supportedProjections[ua].srs,bbox:ma.supportedProjections[ua].bbox})}ua=Q.find("srs",ma.nativeCRS);-1==ua&&(ua=Q.find("srs","EPSG:4326"));-1==ua&&(ua=0);L.getView().select(ua);Q.add({title:"Viewer window projection and area",srs:this.srs,bbox:this.bbox});U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").setValue(ma.width);
U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").setValue(ma.height);Da=U.getComponent("column3").getComponent("dimensionPanel");for(ua=0;ua<ma.dimensions.length;ua++)Da.add({xtype:"textfield",fieldLabel:ma.dimensions[ua].name,value:ma.dimensions[ua].currentValue,labelWidth:40,padding:"30",width:200,itemId:"dimtextfield_"+ma.dimensions[ua].name,listeners:{change:{fn:function(){la()}}}});for(ua=0;ua<ma.formats.length;ua++){Da=ma.formats[ua];
var va=ma.formats[ua].toUpperCase();try{Da=formatDescriptionLookup[va]}catch(Fa){}isDefined(Da)||(Da=ma.formats[ua]);P.add({title:Da,format:ma.formats[ua]});"AAIGRID"==va&&I.getView().select(ua)}la();ia.update('<table style="margin:5px;"><tr><td><b>Coverage:</b></td><td>'+ma.name+"</td></tr><tr><td><b>Title:</b></td><td>"+ma.title+"</td></tr><tr><td><b>Description:</b></td><td>"+ma["abstract"]+"</td></tr></table>")};Ext.create("Ext.panel.Panel",{region:"west",border:!0,width:100});var U=Ext.create("Ext.panel.Panel",
...
region:"center",height:"50%",itemId:"dimensionPanel",title:I18n.dimensions.text,autoScroll:!0},{xtype:"panel",split:!0,autoScroll:!0,region:"south",height:"50%",title:I18n.formats.text,items:[I]}]}]}),T=Ext.create("Ext.panel.Panel",{layout:"border",region:"center",border:!0,width:300,items:[U]}),O=Ext.create("Ext.panel.Panel",{border:!1,padding:20}),ba=Ext.create("Ext.panel.Panel",{title:"GetCoverage request link",region:"south",border:!0,height:100,layout:"fit",items:[O]}),ia=Ext.create("Ext.panel.Panel",
{region:"north",border:!1,height:80,frame:!1});Ext.apply(this,{layout:"border",padding:0,frame:!1,border:!0,items:[T,ia,ba]});L.setLoading(!0);var la=function(){var ma=c.coverages[0].service;ma=WMJScheckURL(ma);var ua=c.coverages[0].name,Da=U.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxwest").getValue()+","+U.getComponent("column2").getComponent("areaPanel").getComponent("bboxbottom").getValue()+","+U.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxeast").getValue()+
","+U.getComponent("column2").getComponent("areaPanel").getComponent("bboxtop").getValue();-1==ma.indexOf("?")?ma+="?":"&"!=ma.charAt(ma.length-1)&&(ma+="&");ma=ma+"SERVICE=WCS&REQUEST=GetCoverage&COVERAGE="+ua+"&CRS="+URLEncode(w)+"&FORMAT="+x+"&BBOX="+Da;1==U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("radioselectcellsize").getValue()?(ma+="&RESX="+U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").getValue(),
ma+="&RESY="+U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").getValue()):(ma+="&WIDTH="+U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").getValue(),ma+="&HEIGHT="+U.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").getValue());for(ua=0;ua<c.coverages[0].dimensions.length;ua++)try{var va=U.getComponent("column3").getComponent("dimensionPanel").getComponent("dimtextfield_"+
c.coverages[0].dimensions[ua].name).getValue(),Fa=c.coverages[0].dimensions[ua].name;Fa=Fa.toUpperCase();"ELEVATION"!=Fa&&"TIME"!=Fa&&(Fa="DIM_"+Fa);ma+="&"+Fa+"="+va}catch(Ma){}O.update('<a target="_blank" href="'+ma+'">'+ma+"</a>");return w};WCJSRequest(c.coverages[0].service,c.coverages[0].name,function(ma){c.coverages[0]=parseDescribeCoverage(ma,n);c.onReady()},function(ma){alert("failed:\n "+ma)});webmapjsext.WMJSExt.WCSPanel.superclass.initComponent.apply(this,arguments)}});Ext.define("webmapjsext.WMJSExt.WindowFader",{extend:"Ext.window.Window",alias:"WMJSExtWindowFader",requires:[],initComponent:function(){var c=this;c.timer=new WMJSTimer;c.fadeOut=function(){100!=c.opacity&&(0<c.opacity?(c.timer.init(50,c.fadeOut),c.opacity-=(100-c.opacity)/10+.5,c.getEl().dom.style.opacity=c.opacity/100):c.close())};Ext.apply(this,{listeners:{render:{fn:function(){c.el.on("mouseenter",function(){c.getEl().dom.style.opacity="1";c.opacity=100});c.el.on("mouseleave",function(){c.opacity=
95;c.timer.init(100,c.fadeOut)})}},show:{fn:function(){c.getEl().dom.style.opacity=1;c.opacity=100}}}});this.callParent(arguments)}});initWMJS();var error=function(c){console.error(c)},debug=function(c){console.log(c)},versionInfo="ADAGUC viewer version AEMET 1.2.2",mainWebmapJS;function decimalFormatter(c,n){c=parseInt(c)+"";n=parseInt(n)-c.length;var w,x="";for(w=0;w<n;w++)x+="0";return x+c}
function Console(c){function n(A){A=(A+"").replace(/&/g,"&amp;");A=A.replace(/</g,"&lt;");A=A.replace(/>/g,"&gt;");A=A.replace(/"/g,"&quot;");return A=A.replace(/\n/g,"<br>")}var w=c,x="";this.println=function(A,Q){x=0==Q?x+("<p class='stdoutmessage'>"+A+"</p>"):x+("<p class='stdoutmessage'>"+n(A)+"</p>");isDefined(w)&&(w.innerHTML=x,w.scrollTop=w.scrollHeight);17824<x.length&&(x=x.substring(x.length-13368))};this.errprintln=function(A,Q){x=0==Q?x+("<p class='stderrmessage'>"+A+"</p>"):x+("<p class='stderrmessage'>"+
n(A)+"</p>");isDefined(w)&&(w.innerHTML=x,w.scrollTop=w.scrollHeight)};this.cls=function(){x="";isDefined(w)&&(w.innerHTML=x)};this.setSize=function(A,Q){isDefined(w)&&(w.scrollTop=w.scrollHeight,w.style.width=A+"px",w.style.height=Q+"px",w.width=A+"px",w.height=Q+"px")};this.setElement=function(A){w=A;initWMJS();isDefined(w)&&(w.style.overflow="scroll",w.style.display="inline-block",w.style.position="absolute",w.style.width="100%",w.style.height="100%",w.style.font="normal 12px courier",w.noWrap=
...
var Q=void 0;isDefined(n.opacity)&&0<(""+n.opacity).length&&(Q=n.opacity);var L=void 0;isDefined(n.enabled)&&(L=n.enabled);var P=void 0;isDefined(n.autoChooseLayer)&&(P=n.autoChooseLayer);var I=void 0;isDefined(n.updatetime)&&(I=n.updatetime);isDefined(L)||(L=!0);var U=Ext.getCmp("layerlistpanel");U.removeLayer=removeLayer;w=Ext.create("webmapjsext.WMJSExt.LayerPanel",{parentPanelList:U,title:x,service:w,name:x,style:A,opacity:Q,updatetime:I,enabled:L,autoChooseLayer:P,parentWebMapJS:c,afterlayerready:function(T){1!=
T.layerAddedToWebMapJS&&(T.WMJSLayer.enabled=this.enabled,T.layerAddedToWebMapJS=!0);if(n.ready)n.ready(T,c),n.ready=void 0;else{1==n.zoomtolayer&&(n.zoomtolayer=!1,c.setProjection(T.WMJSLayer.getProjection("EPSG:4326")));var O=864E5;void 0!=T.WMJSLayer.getDimension("time")&&(O=T.WMJSLayer.getDimension("time").values,O=getUpdateTime(O.slice(O.lastIndexOf("/")+1)));T.updatetime=O;c.draw("createNewLayerPanel");1==n.notifyadded&&(n.notifyadded=!1)}}});w.WMJSLayer.enabled=!1;c.addLayer(w.WMJSLayer);U.insert(0,
...
isDefined(ba)&&isDefined(O.ready)&&(O.ready(ba,la),1==ba.WMJSLayer.hasError&&ba.close())}});return ba},Q,L=new Console;Ext.create("Ext.panel.Panel",{html:'<div id="debuginfodiv"></div>',layout:"fit",listeners:{afterrender:{fn:function(){L.setElement(document.getElementById("debuginfodiv"))}}}});n=[{text:I18n.show_time_selection_window.text,iconCls:"button_settings_icon",handler:function(){timeselectorWindow.show()}},{text:I18n.create_animation.text+"&hellip;",iconCls:"button_settings_icon",handler:function(){Ext.create("Ext.window.Window",
{title:I18n.create_animation.text,width:460,height:300,layout:"form",autoDestroy:!0,closeAction:"destroy",autoScroll:!0,collapsible:!0,items:[Ext.create("webmapjsext.WMJSExt.AnimationPanel",{mappanel:mainWebmapJS})]}).show()}},{text:I18n.create_link.text,iconCls:"button_makeLink",handler:function(){Q=Ext.create("Ext.window.Window",{title:I18n.create_permanent_links.text,width:800,height:260,layout:"fit",autoDestroy:!0,closeAction:"destroy",autoScroll:!0,modal:!1,items:[Ext.create("webmapjsext.WMJSExt.PermaLinkPanel",
{mappanel:mainWebmapJS})]});Q.show()}},{text:I18n.add_custom_wms_service.text,iconCls:"button_layerlist_layernew",handler:function(){Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:A,webMapJS:mainWebmapJS.webMapJS}).showCustomWMSWindow()}},{text:I18n.undo_zoom_pan_action.text,iconCls:"button_undo",handler:function(){mainWebmapJS.webMapJS.setPreviousExtent()}},{text:I18n.redo_zoom_pan_action.text,iconCls:"button_redo",handler:function(){mainWebmapJS.webMapJS.setNextExtent()}},{text:I18n.abort_loading.text,
iconCls:"button_stoploading",handler:function(){mainWebmapJS.webMapJS.abort()}}];try{isDefined(getFeatureInfoApplications)}catch(O){getFeatureInfoApplications=[]}var P={};for(w=0;w<getFeatureInfoApplications.length;P={$jscomp$loop$prop$location$106$328:P.$jscomp$loop$prop$location$106$328},w++)P.$jscomp$loop$prop$location$106$328=getFeatureInfoApplications[w],n.push({text:getFeatureInfoApplications[w].name,iconCls:getFeatureInfoApplications[w].iconCls,location:getFeatureInfoApplications[w].location,
handler:function(O){return function(){console.log(O.$jscomp$loop$prop$location$106$328);x.setApplication(O.$jscomp$loop$prop$location$106$328);x.hide();x.show()}}(P)}),getFeatureInfoApplications.open&&P.$jscomp$loop$prop$location$106$328.name===getFeatureInfoApplications.open&&x.setApplication(P.$jscomp$loop$prop$location$106$328);n.push({text:I18n.about_the_adaguc_viewer.text,iconCls:"button_info",tooltip:I18n.about_the_adaguc_viewer.tooltip,handler:function(){Ext.create("Ext.window.Window",{title:I18n.about_adaguc.text,
height:200,width:400,modal:!0,layout:"fit",items:{xtype:"panel",html:'<div class="about_adaguc" style="position:absolute;top:0px;left:0px;height:100px;width:520px;"/><div style="position:absolute;top:100px;padding:10px;margin:10px;"><A HREF=VERSION>'+versionInfo+"</A>"+I18n.about_adaguc_more_information.text}}).show()}});w=Ext.create("Ext.panel.Panel",{header:!1,title:" ",frame:!1,border:0,split:!1,id:"layerlistpanel",tooltip:I18n.layers.tooltip,overflowY:"auto",bodyCls:"layerlistbg",iconCls:"button_layers32",
...
P={id:"viewportwestpanel",width:320,region:"west",layout:"border",collapsible:!0,animCollapse:!0,border:!0,split:!0,header:!1,autoScroll:!1,frame:!0,items:[{layout:"fit",border:!1,autoScroll:!1,region:"center",xtype:"tabpanel",scale:"large",cls:"LayersAndMapsTab",items:[w,P,I,timeselectorPanel]}],tbar:[{scale:"large",text:"Add",tooltip:I18n.add_layers.tooltip,iconCls:"button_adddata32",handler:function(){dataChooserConfiguration=dataChooserConfigurationAdd;Ext.create("webmapjsext.WMJSExt.DataPanel",
{dataPanelClicked:A,webMapJS:mainWebmapJS.webMapJS}).show()}}]};for(w=0;w<dataChooser.length;w++)0!==dataChooser[w].dataChooserConfiguration.length&&(P.tbar.push({scale:"large",text:dataChooser[w].title,tooltip:I18n.add_layers.tooltip,iconCls:"button_adddata32",ind:w,handler:function(){dataChooserConfiguration=dataChooser[this.ind].dataChooserConfiguration;Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:A,webMapJS:mainWebmapJS.webMapJS}).show()}}),P.width+=30);for(w=0;w<folderChooser.length;w++)0!==
folderChooser[w].dataChooserConfigurationFolder.length&&(P.tbar.push({scale:"large",text:folderChooser[w].title,tooltip:I18n.add_layers.tooltip,iconCls:"folder_adddata32",ind:w,handler:function(){dataChooserConfigurationFolder=folderChooser[this.ind].dataChooserConfigurationFolder;Ext.create("webmapjsext.WMJSExt.FolderPanel",{dataPanelClicked:A,webMapJS:mainWebmapJS.webMapJS}).show()}}),P.width+=30);P.tbar.push({iconCls:"button_settings32",tooltip:I18n.settings_and_options.tooltip,scale:"large",menu:{xtype:"menu",
items:n}});var U=Ext.create("Ext.Viewport",{layout:"border",items:[P,c],renderTo:Ext.getBody(),listeners:{resize:{fn:function(){try{var O=viewportwestpanelwindow.y+viewportwestpanelwindow.height;O>U.height&&(O=U.height-70,70>O&&(O=70));viewportwestpanelwindow.setSize(viewportwestpanelwindow.width,O)}catch(ba){}}}}}),T=function(O){var ba=!0,ia=!1;isDefined(O.collapse)&&"1"==O.collapse&&Ext.getCmp("viewportwestpanel").collapse();isDefined(O.zoomtolayer)&&"1"==O.zoomtolayer&&(ba=!0);isDefined(O.srs)&&
...
ab.name})[0]);x.hide();x.show()},100));O&&O.wms&&(console.log("wms found",O.wms),createNewLayerPanel(mainWebmapJS.webMapJS,{service:O.wms}))};0==window.location.hash.length&&T(getUrlVars());checkIfHashTagChanged(function(O,ba){if(0<=O.indexOf("addlayer('")){if(ba=O.substring(O.indexOf("addlayer('")+10,O.indexOf("',")),O=O.substring(O.indexOf(",'")+2,O.indexOf("')")),ba&&O){for(var ia=!1,la=mainWebmapJS.webMapJS.getLayers(),ma=0;ma<la.length;ma++)if(la[ma].service==ba&&la[ma].name==O){ia=!0;break}0==
ia&&(isDefined(hashLocationNotfiyAddLayer),firstTimeOpening=!0,createNewLayerPanel(mainWebmapJS.webMapJS,{service:ba,name:O,zoomtolayer:!1,notifyadded:!0}))}}else 0<=O.indexOf("positionmappinbylatlon(")?(debug(O),ba=O.substring(23,O.indexOf(")")),debug(ba),ba=ba.split(","),debug(ba[0]+" "+ba[1]),mainWebmapJS.webMapJS.positionMapPinByLatLon({x:parseFloat(ba[0]),y:parseFloat(ba[1])})):0<=O.indexOf("refreshlayers")?updateLayers():T(ba)});getFeatureInfoApplications.open&&x.show()});var gfiapp_d3c3=function(c,n){var w=function(T,O){$("#"+O).empty();$("#"+O).append("<div style='height=240px;border=2px solid blue;' class='chart'>a</div>");$("#"+O).append("<div style='height=40px;border=2px solid red;' class='controls gfiapp_d3c3_export_to_csv_button'>b</div>");var ba=$("#"+O).find(".chart");O=$("#"+O).find(".controls");ba.html("graph");O.button({label:"Export to CSV"}).click(function(){console.log("Export to CSV");for(var ia="",la=T.datatoplot,ma=0;ma<la[0].length;ma++){for(var ua=
0;ua<la.length;ua++)0<ua&&(ia+=";"),ia+=JSON.stringify(la[ua][ma]);ia+="\n\r"}la=document.createElement("a");la.setAttribute("download","export.csv");la.setAttribute("href",encodeURI("data:text/csv;charset=utf-8,"+ia));console.log("Clicking link");document.body.appendChild(la);la.click();la.remove()});c3.generate({bindto:ba.get(0),data:{x:"x",x_format:"%Y%m%d",columns:T.datatoplot,types:{x:"area"}},axis:{x:{type:"timeseries",tick:{format:T.timeFormat}},y:{label:T.ylabel}},zoom:{enabled:!0},subchart:{show:!1}})},
x=function(T,O){return T>O?1:T<O?-1:0},A=function(T,O){var ba;for(ba=0;ba<O.length;ba++)try{if(O[ba].getTime()===T.getTime())return ba}catch(ia){}return-1},Q=function(T,O){var ba=1;"string"!=typeof T[0].dims&&(ba=T[0].dims.length);for(var ia=[],la=function(va,Fa,Ma){var Ka=["x"];va=[Fa.name+" "+va];for(var Va in Ma){Fa=d3.time.format("%Y-%m-%dT%H:%M:%SZ").parse(Va);var Ya=parseFloat(Ma[Va]);Ka.push(Fa);va.push(Ya)}ia.push({date:Ka,value:va})},ma=function(va,Fa,Ma,Ka){if(1==ba)la("",Fa,Ma);else if(va+
2<ba)for(d in Ma)ma(va+1,Fa,Ma[d],Ka+"["+d+"]");else for(d in Ma)la("["+d+"]",Fa,Ma[d])},ua=0;ua<T.length;ua++)ma(0,T[ua],T[ua].data,"");ua=function(va){for(var Fa=[],Ma=va.length,Ka=0;Ka<Ma;Ka++)for(var Va=va[Ka].date,Ya=1;Ya<Va.length;Ya++){var ab=Va[Ya],mb=A(ab,Fa);-1==mb&&Fa.push(ab)}Fa.sort(x);Fa.unshift("x");Va=[];for(Ya=0;Ya<Ma;Ya++)Va.push([]);for(Ka=0;Ka<Ma;Ka++)for(Va[Ka].push(va[Ka].value[0]),Ya=1;Ya<Fa.length;Ya++)mb=A(Fa[Ya],va[Ka].date),mb==Ya?(ab=va[Ka].value[mb],"nodata"==ab&&(ab=
NaN),Va[Ka].push(parseFloat(ab))):Va[Ka].push(NaN);va=[];va.push(Fa);for(Ka=0;Ka<Ma;Ka++)va.push(Va[Ka]);return va}(ia);var Da=T[0].name;T[0].units&&(Da+=" in "+T[0].units);w({datatoplot:ua,ylabel:Da,timeFormat:"%Y-%m-%d %H:%M"},O)},L=function(T,O){console.log(T);T.includes("time=")&&(i=T.indexOf("time="),mURL0=T.slice(0,i+5),mURLF=T.slice(i+5,T.length),T=mURL0+"/"+mURLF);$.ajax({type:"GET",url:T+"&JSONP=?",dataType:"jsonp",cache:!1,success:function(ba){try{Q(ba,O)}catch(ia){$("#"+O).html("Sorry! An error occurred while parsing JSON data: ["+
ia+"]")}},error:function(ba,ia,la){$("#"+O).html("Sorry! An error occurred while receiving JSON data from the server: ["+la+"]");console.log("Error "+la)}})},P=!0,I=[];I.set=!1;var U=function(T){if(0!=P){I.x=T.x;I.y=T.y;I.set=!0;var O=n.getLatLongFromPixelCoord({x:T.x,y:T.y});$("#chart").html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');var ba=n.getLayers();if(isDefined(ba)){O="timeseries graph for location ["+Math.round(100*O.x)/100+","+Math.round(100*O.y)/100+"]<br/>";$("#chart").empty();
for(var ia=0;ia<ba.length;ia++){var la=n.getWMSGetFeatureInfoRequestURL(ba[ia],T.x,T.y);la=composeUrlObjectFromURL(la);var ma=la.location+"?";for(key in la.kvp){var ua=la.kvp[key];"info_format"==key&&(ua="application/json");"time"==key&&(ua="1000-01-01T00:00:00Z/3000-01-01T00:00:00Z");"dim_member"==key&&(ua="*");"dim_ensemble_member"==key&&(ua="*");"dim_percentile"==key&&(ua="*");ma+=key+"="+URLEncode(ua)+"&"}$("#chart").append("<div class='chartstyle' id='chart"+ia+"'></div>");$("#chart"+ia).html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');
L(ma,"chart"+ia)}$("#info").html(O)}else $("#info").html("No valid data received:<br/>"+data)}};n.addListener("mouseclicked",U,!0);this.enable=function(){c.html('<div id="info"></div><div id="chart" class="gfiapp_d3c3"></div>');$("#info").html("Click on the map to create a timeseries graph.");console.log("init");n.enableInlineGetFeatureInfo(!1);P=!0};this.disable=function(){P=!1;n.enableInlineGetFeatureInfo(!0);I.set=!1};this.resize=function(T,O){console.log("w="+T);$("#chart").width(T);I.set&&U(I)};
...
k,p,m){null==p&&(p=0);null==m&&(m=h.length);m=b(h,k,p,m-1);return m>p&&f(h[m-1],k)>-f(h[m],k)?m-1:m},right:function(h,k,p,m){null==p&&(p=0);null==m&&(m=h.length);for(;p<m;){var q=p+m>>>1;0<g(h[q],k)?m=q:p=q+1}return p}}}function x(a){return function(b,f){return n(a(b),f)}}function A(a){return null===a?NaN:+a}function Q(a,b){var f,g,h,k,p,m;return $jscomp.generator.createGenerator(Q,function(q){switch(q.nextAddress){case 1:if(void 0===b){q.jumpTo(2);break}f=-1;g=$jscomp.makeIterator(a);h=g.next();
...
$jscomp.makeIterator(a);for(g=k.next();!g.done;g=k.next())g=g.value,null!=(g=b(g,++h,a))&&(g=+g)>=g&&++f}return f}function P(a){return a.length|0}function I(a){return!(0<a)}function U(a){return"object"!==typeof a||"length"in a?a:Array.from(a)}function T(a){return function(b){return a.apply(null,$jscomp.arrayFromIterable(b))}}function O(a,b){var f=0,g,h=0,k=0;if(void 0===b)for(a=$jscomp.makeIterator(a),g=a.next();!g.done;g=a.next())b=g.value,null!=b&&(b=+b)>=b&&(g=b-h,h+=g/++f,k+=g*(b-h));else{var p=
...
va,f)}function Ma(a,b,f){for(var g=[],h=2;h<arguments.length;++h)g[h-2]=arguments[h];return Va(a,va,b,g)}function Ka(a){if(1!==a.length)throw Error("duplicate key");return a[0]}function Va(a,b,f,g){return function m(k,p){if(p>=g.length)return f(k);for(var q=new dd,B=g[p++],F=-1,u=$jscomp.makeIterator(k),v=u.next();!v.done;v=u.next()){v=v.value;var y=B(v,++F,k),C=q.get(y);C?C.push(v):q.set(y,[v])}k=$jscomp.makeIterator(q);for(B=k.next();!B.done;B=k.next())F=$jscomp.makeIterator(B.value),B=F.next().value,
...
1]>=q&&(k>=q&&f===ia?(k=vb(B,q,u),isFinite(k)&&(0<k?q=(Math.floor(q/k)+1)*k:0>k&&(q=(Math.ceil(q*-k)+1)/-k))):F.pop())}for(u=F.length;F[0]<=B;)F.shift(),--u;for(;F[u-1]>q;)F.pop(),--u;var v=Array(u+1);for(k=0;k<=u;++k){var y=v[k]=[];y.x0=0<k?F[k-1]:B;y.x1=k<u?F[k]:q}for(k=0;k<p;++k)y=m[k],B<=y&&y<=q&&v[Qc(F,y,0,u)].push(h[k]);return v}var b=va,f=ia,g=Dc;a.value=function(h){return arguments.length?(b="function"===typeof h?h:mb(h),a):b};a.domain=function(h){return arguments.length?(f="function"===typeof h?
...
y,S=M.selectAll(".domain").data([null]);C=M.selectAll(".tick").data(C,b).order();var W=C.exit(),da=C.enter().append("g").attr("class","tick"),ka=C.select("line"),Y=C.select("text");S=S.merge(S.enter().insert("path",".tick").attr("class","domain").attr("stroke","currentColor"));C=C.merge(da);ka=ka.merge(da.append("line").attr("stroke","currentColor").attr(u+"2",F*p));Y=Y.merge(da.append("text").attr("fill","currentColor").attr(u,F*t).attr("dy",1===a?"0em":3===a?"0.71em":"0.32em"));y!==M&&(S=S.transition(y),
C=C.transition(y),ka=ka.transition(y),Y=Y.transition(y),W=W.transition(y).attr("opacity",1E-6).attr("transform",function(Z){return isFinite(Z=G(Z))?v(Z+B):this.getAttribute("transform")}),da.attr("opacity",1E-6).attr("transform",function(Z){var qa=this.parentNode.__axis;return v((qa&&isFinite(qa=qa(Z))?qa:G(Z))+B)}));W.remove();S.attr("d",4===a||2===a?m?"M"+F*m+","+E+"H"+B+"V"+z+"H"+F*m:"M"+B+","+E+"V"+z:m?"M"+E+","+F*m+"V"+B+"H"+z+"V"+F*m:"M"+E+","+B+"H"+z);C.attr("opacity",1).attr("transform",function(Z){return v(G(Z)+
...
ea.next())sa=sa.value,sa.cur&&(sa[0]=sa.cur[0],sa[1]=sa.cur[1]);Za=!0;V.preventDefault();V.stopImmediatePropagation();E(V)}function E(V){var ea=H[0],sa=ea.point0;Ha=ea[0]-sa[0];Pa=ea[1]-sa[1];switch(ka){case Hh:case Ek:Y&&(Ha=Mb(La-ta,Nb(R-ca,Ha)),K=ta+Ha,aa=ca+Ha);Z&&(Pa=Mb(Ia-Ta,Nb(Ea-Na,Pa)),N=Ta+Pa,X=Na+Pa);break;case Ld:H[1]?(Y&&(K=Mb(La,Nb(R,H[0][0])),aa=Mb(La,Nb(R,H[1][0])),Y=1),Z&&(N=Mb(Ia,Nb(Ea,H[0][1])),X=Mb(Ia,Nb(Ea,H[1][1])),Z=1)):(0>Y?(Ha=Mb(La-ta,Nb(R-ta,Ha)),K=ta+Ha,aa=ca):0<Y&&(Ha=
Mb(La-ca,Nb(R-ca,Ha)),K=ta,aa=ca+Ha),0>Z?(Pa=Mb(Ia-Ta,Nb(Ea-Ta,Pa)),N=Ta+Pa,X=Na):0<Z&&(Pa=Mb(Ia-Na,Nb(Ea-Na,Pa)),N=Ta,X=Na+Pa));break;case Md:Y&&(K=Mb(La,Nb(R,ta-Ha*Y)),aa=Mb(La,Nb(R,ca+Ha*Y))),Z&&(N=Mb(Ia,Nb(Ea,Ta-Pa*Z)),X=Mb(Ia,Nb(Ea,Na+Pa*Z)))}aa<K&&(Y*=-1,ea=ta,ta=ca,ca=ea,ea=K,K=aa,aa=ea,da in Fk&&ja.attr("cursor",Gc[da=Fk[da]]));X<N&&(Z*=-1,ea=Ta,Ta=Na,Na=ea,ea=N,N=X,X=ea,da in Gk&&ja.attr("cursor",Gc[da=Gk[da]]));qa.selection&&(wa=qa.selection);D&&(K=wa[0][0],aa=wa[1][0]);J&&(N=wa[0][1],X=
wa[1][1]);if(wa[0][0]!==K||wa[0][1]!==N||wa[1][0]!==aa||wa[1][1]!==X)qa.selection=[[K,N],[aa,X]],f.call(W),ra.brush(V,ka.name)}function G(V){V.stopImmediatePropagation();if(V.touches){if(V.touches.length)return;r&&clearTimeout(r);r=setTimeout(function(){r=null},500)}else pf(V.view,Za),xa.on("keydown.brush keyup.brush mousemove.brush mouseup.brush",null);ha.attr("pointer-events","all");ja.attr("cursor",Gc.overlay);qa.selection&&(wa=qa.selection);if(wa[0][0]===wa[1][0]||wa[0][1]===wa[1][1])qa.selection=
null,f.call(W);ra.end(V,ka.name)}function M(V){switch(V.keyCode){case 16:l=Y&&Z;break;case 18:ka===Ld&&(Y&&(ca=aa-Ha*Y,ta=K+Ha*Y),Z&&(Na=X-Pa*Z,Ta=N+Pa*Z),ka=Md,E());break;case 32:if(ka===Ld||ka===Md)0>Y?ca=aa-Ha:0<Y&&(ta=K-Ha),0>Z?Na=X-Pa:0<Z&&(Ta=N-Pa),ka=Hh,ja.attr("cursor",Gc.selection),E();break;default:return}V.preventDefault();V.stopImmediatePropagation()}function S(V){switch(V.keyCode){case 16:l&&(D=J=l=!1,E());break;case 18:ka===Md&&(0>Y?ca=aa:0<Y&&(ta=K),0>Z?Na=X:0<Z&&(Ta=N),ka=Ld,E());
...
R=oa[1][0],ca,Ea=oa[1][1],Na,Ha=0,Pa=0,Za,l=Y&&Z&&v&&t.shiftKey,D,J,H=Array.from(t.touches||[t],function(V){var ea=V.identifier;V=bc(V,W);V.point0=V.slice();V.identifier=ea;return V});"overlay"===da?(wa&&(Za=!0),oa=[H[0],H[1]||H[0]],qa.selection=wa=[[ta=a===Df?La:Nb(oa[0][0],oa[1][0]),Ta=a===Ef?Ia:Nb(oa[0][1],oa[1][1])],[ca=a===Df?R:Mb(oa[0][0],oa[1][0]),Na=a===Ef?Ea:Mb(oa[0][1],oa[1][1])]],1<H.length&&E()):(ta=wa[0][0],Ta=wa[0][1],ca=wa[1][0],Na=wa[1][1]);var K=ta;var N=Ta;var aa=ca;var X=Na;var ha=
Lb(W).attr("pointer-events","none"),ja=ha.selectAll(".overlay").attr("cursor",Gc[da]);nd(W);var ra=g(W,arguments,!0).beforestart();if(t.touches)ra.moved=z,ra.ended=G;else{var xa=Lb(t.view).on("mousemove.brush",z,!0).on("mouseup.brush",G,!0);if(v)xa.on("keydown.brush",M,!0).on("keyup.brush",S,!0);of(t.view)}f.call(W);ra.start(t,ka.name)}}function p(t){g(this,arguments).moved(t)}function m(t){g(this,arguments).ended(t)}function q(){var t=this.__brush||{selection:null};t.extent=Eh(B.apply(this,arguments));
t.dim=a;return t}var B=Dr,F=Cr,u=Er,v=!0,y=id("start","brush","end"),C=6,r;b.move=function(t,z){t.tween?t.on("start.brush",function(E){g(this,arguments).beforestart().start(E)}).on("interrupt.brush end.brush",function(E){g(this,arguments).end(E)}).tween("brush",function(){function E(Y){M.selection=1===Y&&null===da?null:ka(Y);f.call(G);S.brush()}var G=this,M=G.__brush,S=g(G,arguments),W=M.selection,da=a.input("function"===typeof z?z.apply(this,arguments):z,M.extent),ka=Uc(W,da);return null!==W&&null!==
...
v=Array(q),y=0,C;m=Float64Array.from({length:q*q},b?function(S,W){return m[W%q][W/q|0]}:function(S,W){return m[W/q|0][W%q]});for(C=0;C<q;++C){for(var r=0,t=0;t<q;++t)r+=m[C*q+t]+a*m[t*q+C];y+=B[C]=r}C=(y=Hk(0,Ik-g*q)/y)?g:Ik/q;r=0;h&&F.sort(function(S,W){return h(B[S],B[W])});t={};F=$jscomp.makeIterator(F);for(var z=F.next();!z.done;t={$jscomp$loop$prop$i$175$339:t.$jscomp$loop$prop$i$175$339},z=F.next()){t.$jscomp$loop$prop$i$175$339=z.value;z=r;if(a){var E=Jh(~q+1,q).filter(function(S){return function(W){return 0>
W?m[~W*q+S.$jscomp$loop$prop$i$175$339]:m[S.$jscomp$loop$prop$i$175$339*q+W]}}(t));k&&E.sort(function(S){return function(W,da){return k(0>W?-m[~W*q+S.$jscomp$loop$prop$i$175$339]:m[S.$jscomp$loop$prop$i$175$339*q+W],0>da?-m[~da*q+S.$jscomp$loop$prop$i$175$339]:m[S.$jscomp$loop$prop$i$175$339*q+da])}}(t));E=$jscomp.makeIterator(E);for(var G=E.next();!G.done;G=E.next())G=G.value,0>G?(u[~G*q+t.$jscomp$loop$prop$i$175$339]||(u[~G*q+t.$jscomp$loop$prop$i$175$339]={source:null,target:null})).target={index:t.$jscomp$loop$prop$i$175$339,
startAngle:r,endAngle:r+=m[~G*q+t.$jscomp$loop$prop$i$175$339]*y,value:m[~G*q+t.$jscomp$loop$prop$i$175$339]}:(u[t.$jscomp$loop$prop$i$175$339*q+G]||(u[t.$jscomp$loop$prop$i$175$339*q+G]={source:null,target:null})).source={index:t.$jscomp$loop$prop$i$175$339,startAngle:r,endAngle:r+=m[t.$jscomp$loop$prop$i$175$339*q+G]*y,value:m[t.$jscomp$loop$prop$i$175$339*q+G]}}else for(E=Jh(0,q).filter(function(S){return function(W){return m[S.$jscomp$loop$prop$i$175$339*q+W]||m[W*q+S.$jscomp$loop$prop$i$175$339]}}(t)),
k&&E.sort(function(S){return function(W,da){return k(m[S.$jscomp$loop$prop$i$175$339*q+W],m[S.$jscomp$loop$prop$i$175$339*q+da])}}(t)),E=$jscomp.makeIterator(E),G=E.next();!G.done;G=E.next()){var M=G.value;G=void 0;t.$jscomp$loop$prop$i$175$339<M?(G=u[t.$jscomp$loop$prop$i$175$339*q+M]||(u[t.$jscomp$loop$prop$i$175$339*q+M]={source:null,target:null}),G.source={index:t.$jscomp$loop$prop$i$175$339,startAngle:r,endAngle:r+=m[t.$jscomp$loop$prop$i$175$339*q+M]*y,value:m[t.$jscomp$loop$prop$i$175$339*
...
u=F[0];F=F[1];B=sb(u,F,B);B=Zb(Math.floor(u/B)*B,Math.floor(F/B)*B,B)}return B.map(function(v){return b(q,v)})}function b(q,B){var F=[],u=[];f(q,B,function(v){m(v,q,B);for(var y=0,C=v.length,r=v[C-1][1]*v[0][0]-v[C-1][0]*v[0][1];++y<C;)r+=v[y-1][1]*v[y][0]-v[y-1][0]*v[y][1];0<r?F.push([v]):u.push(v)});u.forEach(function(v){for(var y=0,C=F.length,r;y<C;++y){a:{var t=(r=F[y])[0];for(var z=v,E=-1,G=z.length;++E<G;){b:{var M=t;for(var S=z[E],W=S[0],da=S[1],ka=-1,Y=0,Z=M.length,qa=Z-1;Y<Z;qa=Y++){var oa=
M[Y],wa=oa[0],La=oa[1],ta=M[qa];qa=ta[0];var Ia=ta[1],Ta,R=oa;oa=ta;ta=S;if(Ta=(oa[0]-R[0])*(ta[1]-R[1])===(ta[0]-R[0])*(oa[1]-R[1]))R=R[Ta=+(R[0]===oa[0])],ta=ta[Ta],oa=oa[Ta],Ta=R<=ta&&ta<=oa||oa<=ta&&ta<=R;if(Ta){M=0;break b}La>da!==Ia>da&&W<(qa-wa)*(da-La)/(Ia-La)+wa&&(ka=-ka)}M=ka}if(M){t=M;break a}}t=0}if(-1!==t){r.push(v);break}}});return{type:"MultiPolygon",value:B,coordinates:F}}function f(q,B,F){function u(M){var S=[M[0][0]+r,M[0][1]+C];M=[M[1][0]+r,M[1][1]+C];var W=2*S[0]+S[1]*(h+1)*4,
da=2*M[0]+M[1]*(h+1)*4,ka,Y;(ka=y[W])?(Y=v[da])?(delete y[ka.end],delete v[Y.start],ka===Y?(ka.ring.push(M),F(ka.ring)):v[ka.start]=y[Y.end]={start:ka.start,end:Y.end,ring:ka.ring.concat(Y.ring)}):(delete y[ka.end],ka.ring.push(M),y[ka.end=da]=ka):(ka=v[da])?(Y=y[W])?(delete v[ka.start],delete y[Y.end],ka===Y?(ka.ring.push(M),F(ka.ring)):v[Y.start]=y[ka.end]={start:Y.start,end:ka.end,ring:Y.ring.concat(ka.ring)}):(delete v[ka.start],ka.ring.unshift(S),v[ka.start=W]=ka):v[W]=y[da]={start:W,end:da,
ring:[S,M]}}var v=[],y=[],C;var r=C=-1;var t=q[0]>=B;for(Hc[t<<1].forEach(u);++r<h-1;){var z=t;t=q[r+1]>=B;Hc[z|t<<1].forEach(u)}for(Hc[t<<0].forEach(u);++C<k-1;){r=-1;t=q[C*h+h]>=B;var E=q[C*h]>=B;for(Hc[t<<1|E<<2].forEach(u);++r<h-1;){z=t;t=q[C*h+h+r+1]>=B;var G=E;E=q[C*h+r+1]>=B;Hc[z|t<<1|E<<2|G<<3].forEach(u)}Hc[t|E<<3].forEach(u)}r=-1;E=q[C*h]>=B;for(Hc[E<<2].forEach(u);++r<h-1;)G=E,E=q[C*h+r+1]>=B,Hc[E<<2|G<<3].forEach(u);Hc[E<<3].forEach(u)}function g(q,B,F){q.forEach(function(u){var v=u[0],
...
b){b=Kf(a,b);if(!b)return a+"";a=b[0];b=b[1];return 0>b?"0."+Array(-b).join("0")+a:a.length>b+1?a.slice(0,b+1)+"."+a.slice(b+1):a+Array(b-a.length+2).join("0")}function Xk(a){return a}function Yk(a){function b(F){function u(Z){var qa=W,oa=da,wa,La;if("c"===S)oa=ka(Z)+oa,Z="";else{Z=+Z;var ta=0>Z||0>1/Z;Z=isNaN(Z)?B:ka(Math.abs(Z),G);if(M){var Ia=Z.length,Ta=1,R=-1;a:for(;Ta<Ia;++Ta)switch(Z[Ta]){case ".":R=wa=Ta;break;case "0":0===R&&(R=Ta);wa=Ta;break;default:if(!+Z[Ta])break a;0<R&&(R=0)}Z=0<R?
Z.slice(0,R)+Z.slice(wa+1):Z}ta&&0===+Z&&"+"!==C&&(ta=!1);qa=(ta?"("===C?C:q:"-"===C||"("===C?"":C)+qa;oa=("s"===S?Zk[8+$k/3]:"")+oa+(ta&&"("===C?")":"");if(Y)for(ta=-1,wa=Z.length;++ta<wa;)if(La=Z.charCodeAt(ta),48>La||57<La){oa=(46===La?k+Z.slice(ta+1):Z.slice(ta))+oa;Z=Z.slice(0,ta);break}}E&&!t&&(Z=f(Z,Infinity));La=qa.length+Z.length+oa.length;ta=La<z?Array(z-La+1).join(v):"";E&&t&&(Z=f(ta+Z,ta.length?z-oa.length:Infinity),ta="");switch(y){case "<":Z=qa+Z+oa+ta;break;case "=":Z=qa+ta+Z+oa;break;
case "^":Z=ta.slice(0,La=ta.length>>1)+qa+Z+oa+ta.slice(La);break;default:Z=ta+qa+Z+oa}return p(Z)}F=Ce(F);var v=F.fill,y=F.align,C=F.sign,r=F.symbol,t=F.zero,z=F.width,E=F.comma,G=F.precision,M=F.trim,S=F.type;"n"===S?(E=!0,S="g"):al[S]||(void 0===G&&(G=12),M=!0,S="g");if(t||"0"===v&&"="===y)t=!0,v="0",y="=";var W="$"===r?g:"#"===r&&/[boxX]/.test(S)?"0"+S.toLowerCase():"",da="$"===r?h:/[%p]/.test(S)?m:"",ka=al[S],Y=/[defgprs%]/.test(S);G=void 0===G?6:/[gprs]/.test(S)?Math.max(1,Math.min(21,G)):Math.max(0,
...
0:3:1E-6>ib(q[0]-f)?0<B?2:1:1E-6>ib(q[1]-b)?0<B?1:0:0<B?3:2}function p(q,B){return m(q.x,B.x)}function m(q,B){var F=k(q,1),u=k(B,1);return F!==u?F-u:0===F?B[1]-q[1]:1===F?q[0]-B[0]:2===F?q[1]-B[1]:B[0]-q[0]}return function(q){function B(Y,Z){a<=Y&&Y<=f&&b<=Z&&Z<=g&&u.point(Y,Z)}function F(Y,Z){var qa=a<=Y&&Y<=f&&b<=Z&&Z<=g;C&&r.push([Y,Z]);if(W)t=Y,z=Z,E=qa,W=!1,qa&&(u.lineStart(),u.point(Y,Z));else if(qa&&S)u.point(Y,Z);else{var oa=[G=Math.max(-1E9,Math.min(1E9,G)),M=Math.max(-1E9,Math.min(1E9,M))],
wa=[Y=Math.max(-1E9,Math.min(1E9,Y)),Z=Math.max(-1E9,Math.min(1E9,Z))];Ds(oa,wa,a,b,f,g)?(S||(u.lineStart(),u.point(oa[0],oa[1])),u.point(wa[0],wa[1]),qa||u.lineEnd(),da=!1):qa&&(u.lineStart(),u.point(Y,Z),da=!1)}G=Y;M=Z;S=qa}var u=q,v=Hl(),y,C,r,t,z,E,G,M,S,W,da,ka={point:B,lineStart:function(){ka.point=F;C&&C.push(r=[]);W=!0;S=!1;G=M=NaN},lineEnd:function(){y&&(F(t,z),E&&S&&v.rejoin(),y.push(v.result()));ka.point=B;S&&u.lineEnd()},polygonStart:function(){u=v;y=[];C=[];da=!0},polygonEnd:function(){for(var Y,
Z=Y=0,qa=C.length;Z<qa;++Z){var oa=C[Z],wa=1,La=oa.length,ta=oa[0],Ia=ta[0];for(ta=ta[1];wa<La;++wa){var Ta=Ia;var R=ta;ta=oa[wa];Ia=ta[0];ta=ta[1];R<=g?ta>g&&(Ia-Ta)*(g-R)>(ta-R)*(a-Ta)&&++Y:ta<=g&&(Ia-Ta)*(g-R)<(ta-R)*(a-Ta)&&--Y}}Z=da&&Y;qa=(y=hd(y)).length;if(Z||qa)q.polygonStart(),Z&&(q.lineStart(),h(null,null,1,q),q.lineEnd()),qa&&Il(y,p,Y,h,q),q.polygonEnd();u=q;y=C=r=null}};return ka}}function Es(){Ud.point=Ud.lineEnd=tb}function Fs(a,b){a*=Xa;b*=Xa;hi=a;dg=Ra(b);eg=Ua(b);Ud.point=Gs}function Gs(a,
...
f){b=a(b,f);this.stream.point(b[0],b[1])}})}function jm(a,b){function f(g,h,k,p,m,q,B,F,u,v,y,C,r,t){var z=B-g,E=F-h,G=z*z+E*E;if(G>4*b&&r--){var M=p+v,S=m+y,W=q+C,da=Gb(M*M+S*S+W*W),ka=Sb(W/=da),Y=1E-6>ib(ib(W)-1)||1E-6>ib(k-u)?(k+u)/2:Tb(S,M),Z=a(Y,ka);ka=Z[0];Z=Z[1];var qa=ka-g,oa=Z-h,wa=E*qa-z*oa;if(wa*wa/G>b||.3<ib((z*qa+E*oa)/G-.5)||p*v+m*y+q*C<Ss)f(g,h,k,p,m,q,ka,Z,Y,M/=da,S/=da,W,r,t),t.point(ka,Z),f(ka,Z,Y,M,S,W,B,F,u,v,y,C,r,t)}}return function(g){function h(ka,Y){ka=a(ka,Y);g.point(ka[0],
ka[1])}function k(){E=NaN;da.point=p;g.lineStart()}function p(ka,Y){var Z=pd([ka,Y]);Y=a(ka,Y);f(E,G,z,M,S,W,E=Y[0],G=Y[1],z=ka,M=Z[0],S=Z[1],W=Z[2],16,g);g.point(E,G)}function m(){da.point=h;g.lineEnd()}function q(){k();da.point=B;da.lineEnd=F}function B(ka,Y){p(u=ka,Y);v=E;y=G;C=M;r=S;t=W;da.point=p}function F(){f(E,G,z,M,S,W,v,y,u,C,r,t,16,g);da.lineEnd=m;m()}var u,v,y,C,r,t,z,E,G,M,S,W,da={point:h,lineStart:k,lineEnd:m,polygonStart:function(){g.polygonStart();da.lineStart=q},polygonEnd:function(){g.polygonEnd();
...
function zc(a){return wi(function(){return a})()}function wi(a){function b(ta){return oa(ta[0]*Xa,ta[1]*Xa)}function f(ta){return(ta=oa.invert(ta[0],ta[1]))&&[ta[0]*nb,ta[1]*nb]}function g(){var ta=km(p,0,0,t,z,r).apply(null,k(B,F));ta=km(p,m-ta[0],q-ta[1],t,z,r);C=fi(u,v,y);qa=di(k,ta);oa=di(C,qa);ta=qa;Z=+Y?jm(ta,Y):im(ta);return h()}function h(){wa=La=null;return b}var k,p=150,m=480,q=250,B=0,F=0,u=0,v=0,y=0,C,r=0,t=1,z=1,E=null,G=xi,M=null,S,W,da,ka=Ne,Y=.5,Z,qa,oa,wa,La;b.stream=function(ta){return wa&&
La===ta?wa:wa=Vs(Ts(C)(G(Z(ka(La=ta)))))};b.preclip=function(ta){return arguments.length?(G=ta,E=void 0,h()):G};b.postclip=function(ta){return arguments.length?(ka=ta,M=S=W=da=null,h()):ka};b.clipAngle=function(ta){return arguments.length?(G=+ta?Ml(E=ta*Xa):(E=null,xi),h()):E*nb};b.clipExtent=function(ta){return arguments.length?(ka=null==ta?(M=S=W=da=null,Ne):cg(M=+ta[0][0],S=+ta[0][1],W=+ta[1][0],da=+ta[1][1]),h()):null==M?null:[[M,S],[W,da]]};b.scale=function(ta){return arguments.length?(p=+ta,
...
qa.charCodeAt(oa++))return-1}return oa}var h=a.dateTime,k=a.date,p=a.time,m=a.periods,q=a.days,B=a.shortDays,F=a.months,u=a.shortMonths,v=Xe(m),y=Ye(m),C=Xe(q),r=Ye(q),t=Xe(B),z=Ye(B),E=Xe(F),G=Ye(F),M=Xe(u),S=Ye(u),W={a:function(Y){return B[Y.getDay()]},A:function(Y){return q[Y.getDay()]},b:function(Y){return u[Y.getMonth()]},B:function(Y){return F[Y.getMonth()]},c:null,d:bn,e:bn,f:yt,g:zt,G:At,H:Bt,I:Ct,j:Dt,L:cn,m:Et,M:Ft,p:function(Y){return m[+(12<=Y.getHours())]},q:function(Y){return 1+~~(Y.getMonth()/
...
function Bu(a){return a instanceof Date?+a:+new Date(+a)}function Zi(a,b,f,g,h,k,p,m,q,B){function F(W){return(q(W)<W?C:m(W)<W?r:p(W)<W?t:k(W)<W?z:g(W)<W?h(W)<W?E:G:f(W)<W?M:S)(W)}var u=ae()(Cb,Cb),v=u.invert,y=u.domain,C=B(".%L"),r=B(":%S"),t=B("%I:%M"),z=B("%I %p"),E=B("%a %d"),G=B("%b %d"),M=B("%B"),S=B("%Y");u.invert=function(W){return new Date(v(W))};u.domain=function(W){return arguments.length?y(Array.from(W,Bu)):y().map(Au)};u.ticks=function(W){var da=y();return a(da[0],da[da.length-1],null==
...
Math.sqrt(C);q=(m*m-u*u+h*C)/(2*u*g*t);m=(m*m-u*u-h*C)/(2*m*g*t);var z=Math.log(Math.sqrt(q*q+1)-q);r=(Math.log(Math.sqrt(m*m+1)-m)-z)/f;m=function(E){E*=r;var G=mk(z),M=f*E+z;var S=((M=Math.exp(2*M))-1)/(M+1);var W=z;M=((W=Math.exp(W))-1/W)/2;S=u/(g*t)*(G*S-M);return[B+S*v,F+S*y,u*G/mk(f*E+z)]}}m.duration=1E3*r*f/Math.SQRT2;return m}p.rho=function(m){m=Math.max(.001,+m);var q=m*m;return k(m,q,q*q)};return p}(Math.SQRT2,2,4),cv=nk(uf),dv=nk(Fb),ev=ok(uf),fv=ok(Fb),gv=pk(uf),Ig=pk(Fb),Kd=0,we=0,ye=
...
(v/=le);C.amplitude=function(t){return y(t,v*le)};C.period=function(t){return y(u,t)};return C}(1,.3),ov={time:null,delay:0,duration:250,ease:Ch};kd.prototype.interrupt=function(u){return this.each(function(){nd(this,u)})};kd.prototype.transition=function(u){var v;if(u instanceof vc){var y=u._id;u=u._name}else y=++ao,(v=ov).time=te(),u=null==u?null:u+"";for(var C=this._groups,r=C.length,t=0;t<r;++t)for(var z=C[t],E=z.length,G,M=0;M<E;++M)if(G=z[M]){var S=G,W=u,da=y,ka=M,Y=z,Z;if(!(Z=v))for(Z=void 0;!(Z=
G.__transition)||!(Z=Z[y]);)if(!(G=G.parentNode))throw Error("transition "+y+" not found");Bf(S,W,da,ka,Y,Z)}return new vc(C,this._parents,u,y)};var pv=[null],Ih=function(u){return function(){return u}},Ek={name:"drag"},Hh={name:"space"},Ld={name:"handle"},Md={name:"center"},mj=Math,Dk=mj.abs,Mb=mj.max,Nb=mj.min,Ef={name:"x",handles:["w","e"].map(Ae),input:function(u,v){return null==u?null:[[+u[0],v[0][1]],[+u[1],v[1][1]]]},output:function(u){return u&&[u[0][0],u[1][0]]}},Df={name:"y",handles:["n",
...
v){this._+="L"+(this._x1=+u)+","+(this._y1=+v)},quadraticCurveTo:function(u,v,y,C){this._+="Q"+ +u+","+ +v+","+(this._x1=+y)+","+(this._y1=+C)},bezierCurveTo:function(u,v,y,C,r,t){this._+="C"+ +u+","+ +v+","+ +y+","+ +C+","+(this._x1=+r)+","+(this._y1=+t)},arcTo:function(u,v,y,C,r){u=+u;v=+v;y=+y;C=+C;r=+r;var t=this._x1,z=this._y1,E=y-u,G=C-v,M=t-u,S=z-v,W=M*M+S*S;if(0>r)throw Error("negative radius: "+r);if(null===this._x1)this._+="M"+(this._x1=u)+","+(this._y1=v);else if(1E-6<W)if(1E-6<Math.abs(S*
E-G*M)&&r){y-=t;C-=z;var da=E*E+G*G;z=Math.sqrt(da);t=Math.sqrt(W);W=r*Math.tan((nj-Math.acos((da+W-(y*y+C*C))/(2*z*t)))/2);t=W/t;W/=z;1E-6<Math.abs(t-1)&&(this._+="L"+(u+t*M)+","+(v+t*S));this._+="A"+r+","+r+",0,0,"+ +(S*y>M*C)+","+(this._x1=u+W*E)+","+(this._y1=v+W*G)}else this._+="L"+(this._x1=u)+","+(this._y1=v)},arc:function(u,v,y,C,r,t){u=+u;v=+v;y=+y;t=!!t;var z=y*Math.cos(C),E=y*Math.sin(C),G=u+z,M=v+E,S=1^t;C=t?C-r:r-C;if(0>y)throw Error("negative radius: "+y);if(null===this._x1)this._+=
"M"+G+","+M;else if(1E-6<Math.abs(this._x1-G)||1E-6<Math.abs(this._y1-M))this._+="L"+G+","+M;y&&(0>C&&(C=C%oj+oj),C>rv?this._+="A"+y+","+y+",0,1,"+S+","+(u-z)+","+(v-E)+"A"+y+","+y+",0,1,"+S+","+(this._x1=G)+","+(this._y1=M):1E-6<C&&(this._+="A"+y+","+y+",0,"+ +(C>=nj)+","+S+","+(this._x1=u+y*Math.cos(r))+","+(this._y1=v+y*Math.sin(r))))},rect:function(u,v,y,C){this._+="M"+(this._x0=this._x1=+u)+","+(this._y0=this._y1=+v)+"h"+ +y+"v"+ +C+"h"+-y+"Z"},toString:function(){return this._}};var Or=Array.prototype.slice,
...
u[t];r[2*t]=v(z);r[2*t+1]=y(z)}return new Oc(r)};Oc.prototype.update=function(){for(var u,v,y=this.coords,C=this._hullPrev,r=this._hullNext,t=this._hullTri,z=this._hullHash,E=y.length>>1,G=Infinity,M=Infinity,S=-Infinity,W=-Infinity,da=0;da<E;da++){var ka=y[2*da];u=y[2*da+1];ka<G&&(G=ka);u<M&&(M=u);ka>S&&(S=ka);u>W&&(W=u);this._ids[da]=da}S=(G+S)/2;M=(M+W)/2;G=Infinity;for(W=0;W<E;W++)if(da=Oh(S,M,y[2*W],y[2*W+1]),da<G){var Y=W;G=da}M=y[2*Y];W=y[2*Y+1];G=Infinity;for(S=0;S<E;S++)if(S!==Y&&(da=Oh(M,
W,y[2*S],y[2*S+1]),da<G&&0<da)){var Z=S;G=da}G=y[2*Z];S=y[2*Z+1];u=Infinity;for(da=0;da<E;da++)if(da!==Y&&da!==Z){ka=G-M;var qa=S-W;v=y[2*da]-M;var oa=y[2*da+1]-W,wa=ka*ka+qa*qa,La=v*v+oa*oa,ta=.5/(ka*oa-qa*v);qa=(oa*wa-qa*La)*ta;ka=(ka*La-v*wa)*ta;ka=qa*qa+ka*ka;if(ka<u){var Ia=da;u=ka}}da=y[2*Ia];ka=y[2*Ia+1];if(Infinity===u){for(r=0;r<E;r++)this._dists[r]=y[2*r]-y[0]||y[2*r+1]-y[1];Pd(this._ids,this._dists,0,E-1);r=new Uint32Array(E);C=y=0;for(t=-Infinity;C<E;C++)z=this._ids[C],this._dists[z]>
t&&(r[y++]=z,t=this._dists[z]);this.hull=r.subarray(0,y);this.triangles=new Uint32Array(0);this.halfedges=new Uint32Array(0)}else{Gf(M,W,G,S,da,ka)&&(u=Z,v=G,wa=S,Z=Ia,G=da,S=ka,Ia=u,da=v,ka=wa);v=G-M;u=S-W;wa=da-M;oa=ka-W;La=v*v+u*u;ta=wa*wa+oa*oa;qa=.5/(v*oa-u*wa);u=M+(oa*La-u*ta)*qa;v=W+(v*ta-wa*La)*qa;this._cx=u;this._cy=v;for(wa=0;wa<E;wa++)this._dists[wa]=Oh(y[2*wa],y[2*wa+1],u,v);Pd(this._ids,this._dists,0,E-1);this._hullStart=Y;E=3;r[Y]=C[Ia]=Z;r[Z]=C[Y]=Ia;r[Ia]=C[Z]=Y;t[Y]=0;t[Z]=1;t[Ia]=
2;z.fill(-1);z[this._hashKey(M,W)]=Y;z[this._hashKey(G,S)]=Z;z[this._hashKey(da,ka)]=Ia;this.trianglesLen=0;this._addTriangle(Y,Z,Ia,-1,-1,-1);M=0;for(G=W=void 0;M<this._ids.length;M++)if(S=this._ids[M],da=y[2*S],ka=y[2*S+1],!(0<M&&Math.abs(da-W)<=ho&&Math.abs(ka-G)<=ho)&&(W=da,G=ka,S!==Y&&S!==Z&&S!==Ia)){v=u=0;for(wa=this._hashKey(da,ka);v<this._hashSize&&(u=z[(wa+v)%this._hashSize],-1===u||u===r[u]);v++);v=u=C[u];for(wa=void 0;wa=r[v],!Gf(da,ka,y[2*v],y[2*v+1],y[2*wa],y[2*wa+1]);)if(v=wa,v===u){v=
-1;break}if(-1!==v){La=this._addTriangle(v,S,r[v],-1,-1,t[v]);t[S]=this._legalize(La+2);t[v]=La;E++;for(ta=r[v];wa=r[ta],Gf(da,ka,y[2*ta],y[2*ta+1],y[2*wa],y[2*wa+1]);)La=this._addTriangle(ta,S,wa,t[S],-1,t[ta]),t[S]=this._legalize(La+2),r[ta]=ta,E--,ta=wa;if(v===u)for(;wa=C[v],Gf(da,ka,y[2*wa],y[2*wa+1],y[2*v],y[2*v+1]);)La=this._addTriangle(wa,S,v,-1,t[v],t[wa]),this._legalize(La+2),t[wa]=La,r[v]=v,E--,v=wa;this._hullStart=C[S]=v;r[v]=C[ta]=S;r[S]=ta;z[this._hashKey(da,ka)]=S;z[this._hashKey(y[2*
...
y[u],E=u-u%3;t=E+(u+2)%3;if(-1===z){if(0===r)break;u=Jg[--r]}else{var G=z-z%3,M=G+(z+2)%3,S=v[t],W=v[u],da=v[E+(u+1)%3];E=v[M];var ka=C[2*E],Y=C[2*E+1],Z=C[2*S]-ka,qa=C[2*S+1]-Y,oa=C[2*W]-ka;W=C[2*W+1]-Y;ka=C[2*da]-ka;da=C[2*da+1]-Y;Y=oa*oa+W*W;var wa=ka*ka+da*da;if(0>Z*(W*wa-Y*da)-qa*(oa*wa-Y*ka)+(Z*Z+qa*qa)*(oa*da-W*ka)){v[u]=E;v[z]=S;S=y[M];if(-1===S){E=this._hullStart;do{if(this._hullTri[E]===M){this._hullTri[E]=u;break}E=this._hullPrev[E]}while(E!==this._hullStart)}this._link(u,S);this._link(z,
...
function(){var u=this.delaunay,v=u.points,y=u.hull,C=u.triangles;u=this.vectors;for(var r=this.circumcenters=this._circumcenters.subarray(0,C.length/3*2),t=0,z=0,E=C.length,G,M;t<E;t+=3,z+=2){M=2*C[t];var S=2*C[t+1],W=2*C[t+2];G=v[M];M=v[M+1];var da=v[W],ka=v[W+1];W=v[S]-G;var Y=v[S+1]-M;S=da-G;var Z=ka-M,qa=W*W+Y*Y,oa=S*S+Z*Z,wa=2*(W*Z-Y*S);wa?1E-8>Math.abs(wa)?(G=(G+da)/2,M=(M+ka)/2):(da=1/wa,G+=(Z*qa-Y*oa)*da,M+=(W*oa-S*qa)*da):(G=(G+da)/2-1E8*Z,M=(M+ka)/2+1E8*S);r[z]=G;r[z+1]=M}C=y[y.length-1];
t=4*C;E=v[2*C];M=v[2*C+1];u.fill(0);for(W=0;W<y.length;++W)C=y[W],r=t,z=E,G=M,t=4*C,E=v[2*C],M=v[2*C+1],u[r+2]=u[t]=G-M,u[r+3]=u[t+1]=E-z};zb.prototype.render=function(u){var v=null==u?u=new ec:void 0,y=this.delaunay,C=y.halfedges,r=y.inedges;y=y.hull;var t=this.circumcenters,z=this.vectors;if(1>=y.length)return null;for(var E=0,G=C.length;E<G;++E){var M=C[E];if(!(M<E)){var S=2*Math.floor(E/3);M=2*Math.floor(M/3);this._renderSegment(t[S],t[S+1],t[M],t[M+1],u)}}C=y[y.length-1];for(E=0;E<y.length;++E)M=
C,C=y[E],S=2*Math.floor(r[C]/3),G=t[S],S=t[S+1],M*=4,(M=this._project(G,S,z[M+2],z[M+3]))&&this._renderSegment(G,S,M[0],M[1],u);return v&&v.value()};zb.prototype.renderBounds=function(u){var v=null==u?u=new ec:void 0;u.rect(this.xmin,this.ymin,this.xmax-this.xmin,this.ymax-this.ymin);return v&&v.value()};zb.prototype.renderCell=function(u,v){var y=null==v?v=new ec:void 0;u=this._clip(u);if(null!==u&&u.length){v.moveTo(u[0],u[1]);for(var C=u.length;u[0]===u[C-2]&&u[1]===u[C-1]&&1<C;)C-=2;for(var r=
...
y);return y.value()};zb.prototype._renderSegment=function(v,y,C,r,t){var z=this._regioncode(v,y),E=this._regioncode(C,r);if(0===z&&0===E)t.moveTo(v,y),t.lineTo(C,r);else if(v=this._clipSegment(v,y,C,r,z,E))t.moveTo(v[0],v[1]),t.lineTo(v[2],v[3])};zb.prototype.contains=function(v,y,C){return(y=+y,y!==y)||(C=+C,C!==C)?!1:this.delaunay._step(v,y,C)===v};zb.prototype.neighbors=function C(y){var r=this,t,z,E,G,M,S,W,da,ka;return $jscomp.generator.createGenerator(C,function(Y){switch(Y.nextAddress){case 1:t=
r._clip(y);if(!t){Y.jumpTo(0);break}z=$jscomp.makeIterator(r.delaunay.neighbors(y));E=z.next();case 3:if(E.done){Y.jumpTo(0);break}G=E.value;M=r._clip(G);if(!M){Y.jumpTo(4);break}S=0;W=t.length;case 9:if(!(S<W)){Y.jumpTo(4);break}da=0;ka=M.length;case 10:if(!(da<ka)){S+=2;Y.jumpTo(9);break}if(t[S]!=M[da]||t[S+1]!=M[da+1]||t[(S+2)%W]!=M[(da+ka-2)%ka]||t[(S+3)%W]!=M[(da+ka-1)%ka]){Y.jumpTo(11);break}return Y.yield(G,14);case 14:Y.jumpTo(4);break;case 11:da+=2;Y.jumpTo(10);break;case 4:E=z.next(),Y.jumpTo(3)}})};
...
return r[t]||r[t+1]?this._clipInfinite(y,C,r[t],r[t+1],r[t+2],r[t+3]):this._clipFinite(y,C)};zb.prototype._clipFinite=function(y,C){for(var r=C.length,t=null,z,E,G=C[r-2],M=C[r-1],S,W=this._regioncode(G,M),da,ka,Y=0;Y<r;Y+=2)if(z=G,E=M,G=C[Y],M=C[Y+1],S=W,W=this._regioncode(G,M),0===S&&0===W)ka=0,t?t.push(G,M):t=[G,M];else{if(0===S){if(null===(z=this._clipSegment(z,E,G,M,S,W)))continue;E=$jscomp.makeIterator(z);E.next();E.next();z=E.next().value;S=E.next().value}else{if(null===(z=this._clipSegment(G,
M,z,E,W,S)))continue;da=$jscomp.makeIterator(z);z=da.next().value;S=da.next().value;E=da.next().value;var Z=da.next().value;da=ka;ka=this._edgecode(E,Z);da&&ka&&this._edge(y,da,ka,t,t.length);t?t.push(E,Z):t=[E,Z]}da=ka;ka=this._edgecode(z,S);da&&ka&&this._edge(y,da,ka,t,t.length);t?t.push(z,S):t=[z,S]}if(t)da=ka,ka=this._edgecode(t[0],t[1]),da&&ka&&this._edge(y,da,ka,t,t.length);else if(this.contains(y,(this.xmin+this.xmax)/2,(this.ymin+this.ymax)/2))return[this.xmax,this.ymin,this.xmax,this.ymax,
...
y],C[2*y+1],C[2*r],C[2*r+1]];y=1E-8*Math.hypot(y[3]-y[1],y[2]-y[0]);r=0;for(var t=C.length/2;r<t;++r){var z=Zr(C[2*r],C[2*r+1],y);C[2*r]=z[0];C[2*r+1]=z[1]}this._delaunator=new Oc(C)}else delete this.collinear;z=this.halfedges=this._delaunator.halfedges;y=this.hull=this._delaunator.hull;var E=this.triangles=this._delaunator.triangles;r=this.inedges.fill(-1);t=this._hullIndex.fill(-1);for(var G=0,M=z.length;G<M;++G){var S=E[2===G%3?G-2:G+1];if(-1===z[G]||-1===r[S])r[S]=G}z=0;for(E=y.length;z<E;++z)t[y[z]]=
z;2>=y.length&&0<y.length&&(this.triangles=(new Int32Array(3)).fill(-1),this.halfedges=(new Int32Array(3)).fill(-1),this.triangles[0]=y[0],this.triangles[1]=y[1],this.triangles[2]=y[1],r[y[0]]=1,2===y.length&&(r[y[1]]=0))};Ob.prototype.voronoi=function(y){return new zb(this,y)};Ob.prototype.neighbors=function r(C){var t=this,z,E,G,M,S,W,da,ka,Y,Z,qa,oa;return $jscomp.generator.createGenerator(r,function(wa){switch(wa.nextAddress){case 1:z=t;E=z.inedges;G=z.hull;M=z._hullIndex;S=z.halfedges;W=z.triangles;
da=z.collinear;if(!da){wa.jumpTo(2);break}ka=da.indexOf(C);if(!(0<ka)){wa.jumpTo(3);break}return wa.yield(da[ka-1],3);case 3:if(!(ka<da.length-1)){wa.jumpTo(5);break}return wa.yield(da[ka+1],5);case 5:return wa.return();case 2:Y=E[C];if(-1===Y)return wa.return();Z=Y;qa=-1;case 7:return wa.yield(qa=W[Z],10);case 10:Z=2===Z%3?Z-2:Z+1;if(W[Z]!==C)return wa.return();Z=S[Z];if(-1!==Z){wa.jumpTo(9);break}oa=G[(M[C]+1)%G.length];if(oa===qa){wa.jumpTo(12);break}return wa.yield(oa,12);case 12:return wa.return();
case 9:Z!==Y?wa.jumpTo(7):wa.jumpToEnd()}})};Ob.prototype.find=function(C,r,t){t=void 0===t?0:t;if((C=+C,C!==C)||(r=+r,r!==r))return-1;for(var z=t,E;0<=(E=this._step(t,C,r))&&E!==t&&E!==z;)t=E;return E};Ob.prototype._step=function(C,r,t){var z=this.inedges,E=this.hull,G=this._hullIndex,M=this.halfedges,S=this.triangles,W=this.points;if(-1===z[C]||!W.length)return(C+1)%(W.length>>1);var da=C,ka=me(r-W[2*C],2)+me(t-W[2*C+1],2),Y=z=z[C];do{var Z=S[Y],qa=me(r-W[2*Z],2)+me(t-W[2*Z+1],2);qa<ka&&(ka=qa,
da=Z);Y=2===Y%3?Y-2:Y+1;if(S[Y]!==C)break;Y=M[Y];if(-1===Y){Y=E[(G[C]+1)%E.length];if(Y!==Z&&me(r-W[2*Y],2)+me(t-W[2*Y+1],2)<ka)return Y;break}}while(Y!==z);return da};Ob.prototype.render=function(C){for(var r=null==C?C=new ec:void 0,t=this.points,z=this.halfedges,E=this.triangles,G=0,M=z.length;G<M;++G){var S=z[G];if(!(S<G)){var W=2*E[G];S=2*E[S];C.moveTo(t[W],t[W+1]);C.lineTo(t[S],t[S+1])}}this.renderHull(C);return r&&r.value()};Ob.prototype.renderPoints=function(C,r){r=void 0===r?2:r;for(var t=
null==C?C=new ec:void 0,z=this.points,E=0,G=z.length;E<G;E+=2){var M=z[E],S=z[E+1];C.moveTo(M+r,S);C.arc(M,S,r,0,sv)}return t&&t.value()};Ob.prototype.renderHull=function(C){var r=null==C?C=new ec:void 0,t=this.hull,z=this.points,E=2*t[0],G=t.length;C.moveTo(z[E],z[E+1]);for(E=1;E<G;++E){var M=2*t[E];C.lineTo(z[M],z[M+1])}C.closePath();return r&&r.value()};Ob.prototype.hullPolygon=function(){var C=new yd;this.renderHull(C);return C.value()};Ob.prototype.renderTriangle=function(C,r){var t=null==r?
r=new ec:void 0,z=this.points,E=this.triangles,G=2*E[C*=3],M=2*E[C+1];C=2*E[C+2];r.moveTo(z[G],z[G+1]);r.lineTo(z[M],z[M+1]);r.lineTo(z[C],z[C+1]);r.closePath();return t&&t.value()};Ob.prototype.trianglePolygons=function r(){var t=this,z,E,G,M;return $jscomp.generator.createGenerator(r,function(S){1==S.nextAddress&&(z=t,E=z.triangles,G=0,M=E.length/3);if(3!=S.nextAddress)return G<M?S.yield(t.trianglePolygon(G),3):S.jumpTo(0);++G;return S.jumpTo(2)})};Ob.prototype.trianglePolygon=function(r){var t=
...
Infinity,ka=Infinity,Y=-Infinity,Z=-Infinity;for(z=0;z<E;++z)isNaN(G=+this._x.call(null,t=r[z]))||isNaN(M=+this._y.call(null,t))||(S[z]=G,W[z]=M,G<da&&(da=G),G>Y&&(Y=G),M<ka&&(ka=M),M>Z&&(Z=M));if(da>Y||ka>Z)return this;this.cover(da,ka).cover(Y,Z);for(z=0;z<E;++z)Tk(this,S[z],W[z],r[z]);return this};Yb.cover=function(r,t){if(isNaN(r=+r)||isNaN(t=+t))return this;var z=this._x0,E=this._y0,G=this._x1,M=this._y1;if(isNaN(z))G=(z=Math.floor(r))+1,M=(E=Math.floor(t))+1;else{for(var S=G-z||1,W=this._root,
da,ka;z>r||r>=G||E>t||t>=M;)switch(ka=(t<E)<<1|r<z,da=Array(4),da[ka]=W,W=da,S*=2,ka){case 0:G=z+S;M=E+S;break;case 1:z=G-S;M=E+S;break;case 2:G=z+S;E=M-S;break;case 3:z=G-S,E=M-S}this._root&&this._root.length&&(this._root=W)}this._x0=z;this._y0=E;this._x1=G;this._y1=M;return this};Yb.data=function(){var r=[];this.visit(function(t){if(!t.length){do r.push(t.data);while(t=t.next)}});return r};Yb.extent=function(r){return arguments.length?this.cover(+r[0][0],+r[0][1]).cover(+r[1][0],+r[1][1]):isNaN(this._x0)?
void 0:[[this._x0,this._y0],[this._x1,this._y1]]};Yb.find=function(r,t,z){var E=this._x0,G=this._y0,M,S,W,da,ka=this._x1,Y=this._y1,Z=[],qa=this._root,oa;qa&&Z.push(new Rb(qa,E,G,ka,Y));null==z?z=Infinity:(E=r-z,G=t-z,ka=r+z,Y=t+z,z*=z);for(;oa=Z.pop();)if(!(!(qa=oa.node)||(M=oa.x0)>ka||(S=oa.y0)>Y||(W=oa.x1)<E||(da=oa.y1)<G))if(qa.length){oa=(M+W)/2;var wa=(S+da)/2;Z.push(new Rb(qa[3],oa,wa,W,da),new Rb(qa[2],M,wa,oa,da),new Rb(qa[1],oa,S,W,wa),new Rb(qa[0],M,S,oa,wa));if(qa=(t>=wa)<<1|r>=oa)oa=
Z[Z.length-1],Z[Z.length-1]=Z[Z.length-1-qa],Z[Z.length-1-qa]=oa}else if(oa=r-+this._x.call(null,qa.data),wa=t-+this._y.call(null,qa.data),oa=oa*oa+wa*wa,oa<z){var La=Math.sqrt(z=oa);E=r-La;G=t-La;ka=r+La;Y=t+La;La=qa.data}return La};Yb.remove=function(r){if(isNaN(da=+this._x.call(null,r))||isNaN(ka=+this._y.call(null,r)))return this;var t,z=this._root,E,G=this._x0,M=this._y0,S=this._x1,W=this._y1,da,ka,Y,Z,qa,oa;if(!z)return this;if(z.length)for(;;){(qa=da>=(Y=(G+S)/2))?G=Y:S=Y;(oa=ka>=(Z=(M+W)/
2))?M=Z:W=Z;if(!(t=z,z=z[qa|=oa<<1]))return this;if(!z.length)break;if(t[qa+1&3]||t[qa+2&3]||t[qa+3&3]){var wa=t;var La=qa}}for(;z.data!==r;)if(!(E=z,z=z.next))return this;(r=z.next)&&delete z.next;if(E)return r?E.next=r:delete E.next,this;if(!t)return this._root=r,this;r?t[qa]=r:delete t[qa];(z=t[0]||t[1]||t[2]||t[3])&&z===(t[3]||t[2]||t[1]||t[0])&&!z.length&&(wa?wa[La]=z:this._root=z);return this};Yb.removeAll=function(r){for(var t=0,z=r.length;t<z;++t)this.remove(r[t]);return this};Yb.root=function(){return this._root};
Yb.size=function(){var r=0;this.visit(function(t){if(!t.length){do++r;while(t=t.next)}});return r};Yb.visit=function(r){var t=[],z,E=this._root,G,M,S,W;for(E&&t.push(new Rb(E,this._x0,this._y0,this._x1,this._y1));z=t.pop();)if(!r(E=z.node,M=z.x0,S=z.y0,W=z.x1,z=z.y1)&&E.length){var da=(M+W)/2,ka=(S+z)/2;(G=E[3])&&t.push(new Rb(G,da,ka,W,z));(G=E[2])&&t.push(new Rb(G,M,ka,da,z));(G=E[1])&&t.push(new Rb(G,da,S,W,ka));(G=E[0])&&t.push(new Rb(G,M,S,da,ka))}return this};Yb.visitAfter=function(r){var t=
[],z=[],E;for(this._root&&t.push(new Rb(this._root,this._x0,this._y0,this._x1,this._y1));E=t.pop();){var G=E.node;if(G.length){var M,S=E.x0,W=E.y0,da=E.x1,ka=E.y1,Y=(S+da)/2,Z=(W+ka)/2;(M=G[0])&&t.push(new Rb(M,S,W,Y,Z));(M=G[1])&&t.push(new Rb(M,Y,W,da,Z));(M=G[2])&&t.push(new Rb(M,S,Z,Y,ka));(M=G[3])&&t.push(new Rb(M,Y,Z,da,ka))}z.push(E)}for(;E=z.pop();)r(E.node,E.x0,E.y0,E.x1,E.y1);return this};Yb.x=function(r){return arguments.length?(this._x=r,this):this._x};Yb.y=function(r){return arguments.length?
...
ci,zl,Al,Ub,Vb,Wb,pc={sphere:tb,point:Zh,lineStart:wl,lineEnd:xl,polygonStart:function(){pc.lineStart=ys;pc.lineEnd=As},polygonEnd:function(){pc.lineStart=wl;pc.lineEnd=xl}};ei.invert=ei;var xi=Ll(function(){return!0},function(r){var t=NaN,z=NaN,E=NaN,G;return{lineStart:function(){r.lineStart();G=1},point:function(M,S){var W=0<M?gb:-gb,da=ib(M-t);if(1E-6>ib(da-gb))r.point(t,z=0<(z+S)/2?qb:-qb),r.point(E,z),r.lineEnd(),r.lineStart(),r.point(W,z),r.point(M,z),G=0;else if(E!==W&&da>=gb){1E-6>ib(t-E)&&
(t-=1E-6*E);1E-6>ib(M-W)&&(M-=1E-6*W);da=t;var ka=z,Y=M,Z,qa,oa=Ra(da-Y);z=1E-6<ib(oa)?Yd((Ra(ka)*(qa=Ua(S))*Ra(Y)-Ra(S)*(Z=Ua(ka))*Ra(da))/(Z*qa*oa)):(ka+S)/2;r.point(E,z);r.lineEnd();r.lineStart();r.point(W,z);G=0}r.point(t=M,z=S);E=W},lineEnd:function(){r.lineEnd();t=z=NaN},clean:function(){return 2-G}}},function(r,t,z,E){null==r?(z*=qb,E.point(-gb,z),E.point(0,z),E.point(gb,z),E.point(gb,0),E.point(gb,-z),E.point(0,-z),E.point(-gb,-z),E.point(-gb,0),E.point(-gb,z)):1E-6<ib(r[0]-t[0])?(r=r[0]<
...
polygonEnd:function(){this.stream.polygonEnd()}};var Ss=Ua(30*Xa),Vs=Me({point:function(r,t){this.stream.point(r*Xa,t*Xa)}}),rj=nm(function(r){return Gb(2/(1+r))});rj.invert=Oe(function(r){return 2*Sb(r/2)});var sj=nm(function(r){return(r=gl(r))&&r/Ra(r)});sj.invert=Oe(function(r){return r});Pe.invert=function(r,t){return[r,2*Yd(ko(t))-qb]};Qe.invert=Qe;var mg=Gb(3)/2;Ai.invert=function(r,t){for(var z=t,E=z*z,G=E*E*E,M=0,S;12>M&&!(S=z*(1.340264+-.081106*E+G*(8.93E-4+.003796*E))-t,E=1.340264+3*-.081106*
E+G*(7*8.93E-4+.034164*E),z-=S/=E,E=z*z,G=E*E*E,1E-12>ib(S));++M);return[mg*r*(1.340264+3*-.081106*E+G*(7*8.93E-4+.034164*E))/Ua(z),Sb(Ra(z)/mg)]};Bi.invert=Oe(Yd);Ci.invert=function(r,t){var z=t,E=25;do{var G=z*z;var M=G*G;z-=M=(z*(1.007226+G*(.015085+M*(-.044475+.028874*G-.005916*M)))-t)/(1.007226+G*(.045255+M*(-.311325+.259866*G-.005916*11*M)))}while(1E-6<ib(M)&&0<--E);return[r/(.8707+(G=z*z)*(-.131979+G*(-.013791+G*G*G*(.003971-.001529*G)))),z]};Di.invert=Oe(Sb);Ei.invert=Oe(function(r){return 2*
Yd(r)});Fi.invert=function(r,t){return[-t,2*Yd(ko(r))-qb]};var Pb={};Zd.prototype=Gi.prototype=(Pb.constructor=Zd,Pb.count=function(){return this.eachAfter(ct)},Pb.each=function(r,t){for(var z=-1,E=$jscomp.makeIterator(this),G=E.next();!G.done;G=E.next())r.call(t,G.value,++z,this);return this},Pb.eachAfter=function(r,t){for(var z,E=[this],G=[],M,S,W=-1;z=E.pop();)if(G.push(z),z=z.children)for(M=0,S=z.length;M<S;++M)E.push(z[M]);for(;z=G.pop();)r.call(t,z,++W,this);return this},Pb.eachBefore=function(r,
...
function(r){var t=this;var z=t;var E=r;if(z!==E){var G=z.ancestors(),M=E.ancestors(),S=null;z=G.pop();for(E=M.pop();z===E;)S=z,z=G.pop(),E=M.pop();z=S}for(E=[t];t!==z;)t=t.parent,E.push(t);for(t=E.length;r!==z;)E.splice(t,0,r),r=r.parent;return E},Pb.ancestors=function(){for(var r=this,t=[r];r=r.parent;)t.push(r);return t},Pb.descendants=function(){return Array.from(this)},Pb.leaves=function(){var r=[];this.eachBefore(function(t){t.children||r.push(t)});return r},Pb.links=function(){var r=this,t=
[];r.each(function(z){z!==r&&t.push({source:z.parent,target:z})});return t},Pb.copy=function(){return Gi(this).eachBefore(ft)},Pb[Symbol.iterator]=rm,Pb);var Mv={depth:-1},mo={};qg.prototype=Object.create(Zd.prototype);var no=(1+Math.sqrt(5))/2,oo=function z(t){function E(G,M,S,W,da){Dm(t,G,M,S,W,da)}E.ratio=function(G){return z(1<(G=+G)?G:1)};return E}(no),Nv=function E(z){function G(M,S,W,da,ka){if((Y=M._squarify)&&Y.ratio===z)for(var Y,Z,qa,oa=-1,wa,La=Y.length,ta=M.value;++oa<La;){M=Y[oa];Z=M.children;
qa=M.value=0;for(wa=Z.length;qa<wa;++qa)M.value+=Z[qa].value;M.dice?Se(M,S,W,da,ta?W+=(ka-W)*M.value/ta:ka):rg(M,S,W,ta?S+=(da-S)*M.value/ta:da,ka);ta-=M.value}else M._squarify=Y=Dm(z,M,S,W,da,ka),Y.ratio=z}G.ratio=function(M){return E(1<(M=+M)?M:1)};return G}(no),Jb=Math.random,Ov=function G(E){function M(S,W){S=null==S?0:+S;W=null==W?1:+W;1===arguments.length?(W=S,S=0):W-=S;return function(){return E()*W+S}}M.source=G;return M}(Jb),Pv=function M(G){function S(W,da){2>arguments.length&&(da=W,W=0);
W=Math.floor(W);da=Math.floor(da)-W;return function(){return Math.floor(G()*da+W)}}S.source=M;return S}(Jb),tj=function S(M){function W(da,ka){var Y,Z;da=null==da?0:+da;ka=null==ka?1:+ka;return function(){if(null!=Y){var qa=Y;Y=null}else{do Y=2*M()-1,qa=2*M()-1,Z=Y*Y+qa*qa;while(!Z||1<Z)}return da+ka*qa*Math.sqrt(-2*Math.log(Z)/Z)}}W.source=S;return W}(Jb),Qv=function W(S){function da(){var Y=ka.apply(this,arguments);return function(){return Math.exp(Y())}}var ka=tj.source(S);da.source=W;return da}(Jb),
...
if(ja)return ha=null,ja+""||null}var D=Cu,J=Du,H=cb(0),K=null,N=Eu,aa=Fu,X=Gu,ha=null;l.centroid=function(){var ja=(+D.apply(this,arguments)+ +J.apply(this,arguments))/2,ra=(+N.apply(this,arguments)+ +aa.apply(this,arguments))/2-bd/2;return[Bd(ra)*ja,Cc(ra)*ja]};l.innerRadius=function(ja){return arguments.length?(D="function"===typeof ja?ja:cb(+ja),l):D};l.outerRadius=function(ja){return arguments.length?(J="function"===typeof ja?ja:cb(+ja),l):J};l.cornerRadius=function(ja){return arguments.length?
(H="function"===typeof ja?ja:cb(+ja),l):H};l.padRadius=function(ja){return arguments.length?(K=null==ja?null:"function"===typeof ja?ja:cb(+ja),l):K};l.startAngle=function(ja){return arguments.length?(N="function"===typeof ja?ja:cb(+ja),l):N};l.endAngle=function(ja){return arguments.length?(aa="function"===typeof ja?ja:cb(+ja),l):aa};l.padAngle=function(ja){return arguments.length?(X="function"===typeof ja?ja:cb(+ja),l):X};l.context=function(ja){return arguments.length?(ha=null==ja?null:ja,l):ha};
...
function(){return Kh(!0,!1)};c.chordTranspose=function(){return Kh(!1,!0)};c.cluster=function(){function l(N){var aa,X=0;N.eachAfter(function(V){var ea=V.children;if(ea){var sa=ea.reduce(Zs,0)/ea.length;V.x=sa;V.y=1+ea.reduce($s,0)}else V.x=aa?X+=D(V,aa):0,V.y=0,aa=V});var ha=at(N),ja=bt(N),ra=ha.x-D(ha,ja)/2,xa=ja.x+D(ja,ha)/2;return N.eachAfter(K?function(V){V.x=(V.x-N.x)*J;V.y=(N.y-V.y)*H}:function(V){V.x=(V.x-ra)/(xa-ra)*J;V.y=(1-(N.y?V.y/N.y:1))*H})}var D=Ys,J=1,H=1,K=!1;l.separation=function(N){return arguments.length?
(D=N,l):D};l.size=function(N){return arguments.length?(K=!1,J=+N[0],H=+N[1],l):K?null:[J,H]};l.nodeSize=function(N){return arguments.length?(K=!0,J=+N[0],H=+N[1],l):K?[J,H]:null};return l};c.color=Tc;c.contourDensity=function(){function l(na){var Aa=new Float32Array(sa*fa),Ba=new Float32Array(sa*fa);na.forEach(function(pa,Ga,Qa){var Wa=+aa(pa,Ga,Qa)+ea>>V,fb=+X(pa,Ga,Qa)+ea>>V;pa=+ha(pa,Ga,Qa);0<=Wa&&Wa<sa&&0<=fb&&fb<fa&&(Aa[Wa+fb*sa]+=pa)});Mh({width:sa,height:fa,data:Aa},{width:sa,height:fa,data:Ba},
...
Math.pow(2,-2*V);na.coordinates.forEach(J);return na}function J(na){na.forEach(H)}function H(na){na.forEach(K)}function K(na){na[0]=na[0]*Math.pow(2,V)-ea;na[1]=na[1]*Math.pow(2,V)-ea}function N(){ea=3*xa;sa=ja+2*ea>>V;fa=ra+2*ea>>V;return l}var aa=Rr,X=Sr,ha=Tr,ja=960,ra=500,xa=20,V=2,ea=3*xa,sa=ja+2*ea>>V,fa=ra+2*ea>>V,za=Xc(20);l.x=function(na){return arguments.length?(aa="function"===typeof na?na:Xc(+na),l):aa};l.y=function(na){return arguments.length?(X="function"===typeof na?na:Xc(+na),l):X};
...
ja.r&&(ja.r=ja[ra].r)}function H(){if(K){var ja,ra=K.length;N=Array(ra);for(ja=0;ja<ra;++ja){var xa=K[ja];N[xa.index]=+l(xa,ja,K)}}}var K,N,aa,X=1,ha=1;"function"!==typeof l&&(l=Bb(null==l?1:+l));D.initialize=function(ja,ra){K=ja;aa=ra;H()};D.iterations=function(ja){return arguments.length?(ha=+ja,D):ha};D.strength=function(ja){return arguments.length?(X=+ja,D):X};D.radius=function(ja){return arguments.length?(l="function"===typeof ja?ja:Bb(+ja),H(),D):l};return D};c.forceLink=function(l){function D(fa){for(var za=
...
(fa.source=Vk(na,fa.source)),"object"!==typeof fa.target&&(fa.target=Vk(na,fa.target)),xa[fa.source.index]=(xa[fa.source.index]||0)+1,xa[fa.target.index]=(xa[fa.target.index]||0)+1;Aa=0;for(V=Array(za);Aa<za;++Aa)fa=l[Aa],V[Aa]=xa[fa.source.index]/(xa[fa.source.index]+xa[fa.target.index]);X=Array(za);H();ja=Array(za);K()}}function H(){if(ra)for(var fa=0,za=l.length;fa<za;++fa)X[fa]=+aa(l[fa],fa,l)}function K(){if(ra)for(var fa=0,za=l.length;fa<za;++fa)ja[fa]=+ha(l[fa],fa,l)}var N=is,aa=function(fa){return 1/
...
function(l,D,J){function H(ja){for(var ra=0,xa=N.length;ra<xa;++ra){var V=N[ra],ea=V.x-D||1E-6,sa=V.y-J||1E-6,fa=Math.sqrt(ea*ea+sa*sa);fa=(ha[ra]-fa)*X[ra]*ja/fa;V.vx+=ea*fa;V.vy+=sa*fa}}function K(){if(N){var ja,ra=N.length;X=Array(ra);ha=Array(ra);for(ja=0;ja<ra;++ja)ha[ja]=+l(N[ja],ja,N),X[ja]=isNaN(ha[ja])?0:+aa(N[ja],ja,N)}}var N,aa=Bb(.1),X,ha;"function"!==typeof l&&(l=Bb(+l));null==D&&(D=0);null==J&&(J=0);H.initialize=function(ja){N=ja;K()};H.strength=function(ja){return arguments.length?
(aa="function"===typeof ja?ja:Bb(+ja),K(),H):aa};H.radius=function(ja){return arguments.length?(l="function"===typeof ja?ja:Bb(+ja),K(),H):l};H.x=function(ja){return arguments.length?(D=+ja,H):D};H.y=function(ja){return arguments.length?(J=+ja,H):J};return H};c.forceSimulation=function(l){function D(){J();ea.call("tick",N);aa<X&&(V.stop(),ea.call("end",N))}function J(fa){var za,na=l.length;void 0===fa&&(fa=1);for(var Aa=0;Aa<fa;++Aa)for(aa+=(ja-aa)*ha,xa.forEach(function(pa){pa(aa)}),za=0;za<na;++za){var Ba=
...
xa=new Map,V=yf(D),ea=id("tick","end"),sa=ks();null==l&&(l=[]);H();return N={tick:J,restart:function(){return V.restart(D),N},stop:function(){return V.stop(),N},nodes:function(fa){return arguments.length?(l=fa,H(),xa.forEach(K),N):l},alpha:function(fa){return arguments.length?(aa=+fa,N):aa},alphaMin:function(fa){return arguments.length?(X=+fa,N):X},alphaDecay:function(fa){return arguments.length?(ha=+fa,N):+ha},alphaTarget:function(fa){return arguments.length?(ja=+fa,N):ja},velocityDecay:function(fa){return arguments.length?
...
Ic=null;return Infinity===ub||Infinity===ac?[[NaN,NaN],[NaN,NaN]]:[[ub,ac],[wb,cc]]};c.geoCentroid=function(l){Fe=Xf=Uf=Vf=Wf=Yf=Zf=$f=0;ai=new yb;bi=new yb;ci=new yb;oc(l,pc);l=+ai;var D=+bi,J=+ci,H=$h(l,D,J);return 1E-12>H&&(l=Yf,D=Zf,J=$f,1E-6>Xf&&(l=Uf,D=Vf,J=Wf),H=$h(l,D,J),1E-12>H)?[NaN,NaN]:[Tb(D,l)*nb,Sb(J/H)*nb]};c.geoCircle=function(){function l(){var X=D.apply(this,arguments),ha=J.apply(this,arguments)*Xa,ja=H.apply(this,arguments)*Xa;K=[];N=fi(-X[0]*Xa,-X[1]*Xa,0).invert;Fl(aa,ha,ja,1);
...
$jscomp.makeIterator(H);H=N.next().value;N=N.next().value;var aa=$jscomp.makeIterator(K);K=aa.next().value;aa=aa.next().value;return D(N,aa)||n(H,K)})).map(function(H){return $jscomp.makeIterator(H).next().value})};c.groups=function(l,D){for(var J=[],H=1;H<arguments.length;++H)J[H-1]=arguments[H];return Va(l,Array.from,va,J)};c.hcl=tf;c.hierarchy=Gi;c.histogram=ed;c.hsl=rf;c.html=Jv;c.image=function(l,D){return new Promise(function(J,H){var K=new Image,N;for(N in D)K[N]=D[N];K.onerror=H;K.onload=
function(){J(K)};K.src=l})};c.index=function(l,D){for(var J=[],H=1;H<arguments.length;++H)J[H-1]=arguments[H];return Va(l,va,Ka,J)};c.indexes=function(l,D){for(var J=[],H=1;H<arguments.length;++H)J[H-1]=arguments[H];return Va(l,Array.from,Ka,J)};c.interpolate=Uc;c.interpolateArray=function(l,D){return(fk(D)?uh:gk)(l,D)};c.interpolateBasis=bk;c.interpolateBasisClosed=ck;c.interpolateBlues=ax;c.interpolateBrBG=Gw;c.interpolateBuGn=Pw;c.interpolateBuPu=Qw;c.interpolateCividis=function(l){l=Math.max(0,
...
+X;H._restart(function ra(ja){ja+=K;H._restart(ra,K+=aa,X);N(ja)},aa,X)};H.restart(l,D,J);return H};c.isoFormat=uw;c.isoParse=vw;c.json=function(l,D){return fetch(l,D).then(ds)};c.lab=sf;c.lch=function(l,D,J,H){return 1===arguments.length?Wj(l):new tc(J,D,l,null==H?1:H)};c.least=function(l,D){D=void 0===D?n:D;var J=!1;if(1===D.length){l=$jscomp.makeIterator(l);for(var H=l.next();!H.done;H=l.next()){H=H.value;var K=D(H);if(J?0>n(K,aa):0===n(K,K)){var N=H;var aa=K;J=!0}}}else for(aa=$jscomp.makeIterator(l),
...
tm;c.packSiblings=function(l){zm(l);return l};c.pairs=function(l,D){D=void 0===D?oe:D;var J=[],H=!1;l=$jscomp.makeIterator(l);for(var K=l.next();!K.done;K=l.next()){K=K.value;H&&J.push(D(N,K));var N=K;H=!0}return J};c.partition=function(){function l(aa){var X=aa.height+1;aa.x0=aa.y0=K;aa.x1=J;aa.y1=H/X;aa.eachBefore(D(H,X));N&&aa.eachBefore(Cm);return aa}function D(aa,X){return function(ha){ha.children&&Se(ha,ha.x0,aa*(ha.depth+1)/X,ha.x1,aa*(ha.depth+2)/X);var ja=ha.x0,ra=ha.y0,xa=ha.x1-K,V=ha.y1-
K;xa<ja&&(ja=xa=(ja+xa)/2);V<ra&&(ra=V=(ra+V)/2);ha.x0=ja;ha.y0=ra;ha.x1=xa;ha.y1=V}}var J=1,H=1,K=0,N=!1;l.round=function(aa){return arguments.length?(N=!!aa,l):N};l.size=function(aa){return arguments.length?(J=+aa[0],H=+aa[1],l):[J,H]};l.padding=function(aa){return arguments.length?(K=+aa,l):K};return l};c.path=Wc;c.permute=Ya;c.pie=function(){function l(X){var ha,ja=(X=yg(X)).length;var ra=0;var xa=Array(ja),V=Array(ja),ea=+K.apply(this,arguments);var sa=Math.min(cd,Math.max(-cd,N.apply(this,arguments)-
ea));var fa=Math.min(Math.abs(sa)/ja,aa.apply(this,arguments)),za=fa*(0>sa?-1:1),na;for(ha=0;ha<ja;++ha)0<(na=V[xa[ha]=ha]=+D(X[ha],ha,X))&&(ra+=na);null!=J?xa.sort(function(Ba,pa){return J(V[Ba],V[pa])}):null!=H&&xa.sort(function(Ba,pa){return H(X[Ba],X[pa])});ha=0;for(sa=ra?(sa-ja*za)/ra:0;ha<ja;++ha,ea=Aa){ra=xa[ha];na=V[ra];var Aa=ea+(0<na?na*sa:0)+za;V[ra]={data:X[ra],index:ha,value:na,startAngle:ea,endAngle:Aa,padAngle:fa}}return V}var D=Ju,J=Iu,H=null,K=cb(0),N=cb(cd),aa=cb(0);l.value=function(X){return arguments.length?
...
for(var J=-1,H=$jscomp.makeIterator(l),K=H.next();!K.done;K=H.next())if(D(K.value,++J,l))return!0;return!1};c.sort=ab;c.stack=function(){function l(N){var aa=Array.from(D.apply(this,arguments),Ru),X,ha=aa.length,ja=-1,ra=$jscomp.makeIterator(N);for(X=ra.next();!X.done;X=ra.next()){var xa=X.value;X=0;for(++ja;X<ha;++X)(aa[X][ja]=[0,+K(xa,aa[X].key,ja,N)]).data=xa}X=0;for(ja=yg(J(aa));X<ha;++X)aa[ja[X]].index=X;H(aa,ja);return aa}var D=cb([]),J=je,H=ie,K=Qu;l.keys=function(N){return arguments.length?
(D="function"===typeof N?N:cb(Array.from(N)),l):D};l.value=function(N){return arguments.length?(K="function"===typeof N?N:cb(+N),l):K};l.order=function(N){return arguments.length?(J=null==N?je:"function"===typeof N?N:cb(Array.from(N)),l):J};l.offset=function(N){return arguments.length?(H=null==N?ie:N,l):H};return l};c.stackOffsetDiverging=function(l,D){if(0<(ha=l.length))for(var J,H=0,K,N,aa,X,ha,ja=l[D[0]].length;H<ja;++H)for(J=aa=X=0;J<ha;++J)0<(N=(K=l[D[J]][H])[1]-K[0])?(K[0]=aa,K[1]=aa+=N):0>
...
0,H=1,K,N,aa;H<N;++H){for(var X=0,ha=0,ja=0;X<aa;++X){var ra=l[D[X]],xa=ra[H][1]||0;ra=(xa-(ra[H-1][1]||0))/2;for(var V=0;V<X;++V){var ea=l[D[V]];ra+=(ea[H][1]||0)-(ea[H-1][1]||0)}ha+=xa;ja+=ra*xa}K[H-1][1]+=K[H-1][0]=J;ha&&(J-=ja/ha)}K[H-1][1]+=K[H-1][0]=J;ie(l,D)}};c.stackOrderAppearance=Rn;c.stackOrderAscending=Sn;c.stackOrderDescending=function(l){return Sn(l).reverse()};c.stackOrderInsideOut=function(l){var D=l.length,J=l.map(Tn),H=Rn(l),K=0,N=0,aa=[],X=[];for(l=0;l<D;++l){var ha=H[l];K<N?(K+=
J[ha],aa.push(ha)):(N+=J[ha],X.push(ha))}return X.reverse().concat(aa)};c.stackOrderNone=je;c.stackOrderReverse=function(l){return je(l).reverse()};c.stratify=function(){function l(H){var K=Array.from(H),N=K.length,aa,X,ha=new Map;for(aa=0;aa<N;++aa){var ja=K[aa];var ra=K[aa]=new Zd(ja);if(null!=(X=D(ja,aa,H))&&(X+="")){var xa=ra.id=X;ha.set(xa,ha.has(xa)?mo:ra)}null!=(X=J(ja,aa,H))&&(X+="")&&(ra.parent=X)}for(aa=0;aa<N;++aa)if(ra=K[aa],X=ra.parent){H=ha.get(X);if(!H)throw Error("missing: "+X);if(H===
...
za=V.x1-ea,na=V.y1-ea;za<sa&&(sa=za=(sa+za)/2);na<fa&&(fa=na=(fa+na)/2);V.x0=sa;V.y0=fa;V.x1=za;V.y1=na;V.children&&(ea=aa[V.depth+1]=X(V)/2,sa+=xa(V)-ea,fa+=ha(V)-ea,za-=ja(V)-ea,na-=ra(V)-ea,za<sa&&(sa=za=(sa+za)/2),na<fa&&(fa=na=(fa+na)/2),J(V,sa,fa,za,na))}var J=oo,H=!1,K=1,N=1,aa=[0],X=sd,ha=sd,ja=sd,ra=sd,xa=sd;l.round=function(V){return arguments.length?(H=!!V,l):H};l.size=function(V){return arguments.length?(K=+V[0],N=+V[1],l):[K,N]};l.tile=function(V){return arguments.length?(J=pg(V),l):
...
tddjs=function(c,n){var w=!0,x=[];x.set=!1;var A=[],Q,L=0,P=function(U){var T,O,ba,ia,la,ma,ua,Da,va;return $jscomp.asyncExecutePromiseGeneratorProgram(function(Fa){console.log("TAC",Q);ba=0==A.length?"":document.getElementById("info").innerHTML;document.getElementById("info").innerHTML=ba;if(0==w)return Fa.return();x.x=U.x;x.y=U.y;x.set=!0;T=n.getLatLongFromPixelCoord({x:U.x,y:U.y});O=n.getLayers();if(!isDefined(O))return $("#info").html("No valid data received:<br/>"+data),Fa.return();info=n.getLayers().getFeatureInfoUrl;
ba="";0==n.layers.length&&(ba="No layer: Load a valid layer.",document.getElementById("info").innerHTML=ba);ia=[];for(la=0;la<n.layers.length;la++)ma=n.layers[n.layers.length-la-1].service,ua=n.layers[n.layers.length-la-1].name,ma.includes("TEMP")||ma.includes("KRR")||ma.includes("KRF")||"sond_station"==ua?ia.push(n.layers[n.layers.length-la-1]):(ma.includes("ECMWF")||ma.includes("HARMONIE"))&&ia.push(n.layers[n.layers.length-la-1]);0==ia.length&&(ba="No Sounding valid Layer: Load a valid layer.",
document.getElementById("info").innerHTML=ba);Da={};for(va in ia){console.log(va,ia.length);if(ia[va].service.includes("HARMONIE")||ia[va].service.includes("ECMWF")||ia[va].service.includes("TEMP")||ia[va].service.includes("KRR")||ia[va].service.includes("KRF")||"sond_station"==ia[va].name)console.log("MYLAYER_TEXT",ia[va].name),Da.$jscomp$loop$prop$myLayer$341=ia[va],getJSONdata(Da.$jscomp$loop$prop$myLayer$341,n,x.x,x.y,"text/plain",function(Ma){return function(Ka){if(null!=Ka){if(console.log(Ka),
null!=Ka.data){document.getElementById("load").innerHTML="";var Va=Ka.meta;if(Ma.$jscomp$loop$prop$myLayer$341.service.includes("TEMP")||"sond_station"==Ma.$jscomp$loop$prop$myLayer$341.name)Va="Station";else if(Ma.$jscomp$loop$prop$myLayer$341.service.includes("ECMWF")||Ma.$jscomp$loop$prop$myLayer$341.service.includes("HARMONIE")){var Ya=Ma.$jscomp$loop$prop$myLayer$341.service.split("=")[1];Ya=Ya.replace("&","");Va.model=Ya;Va.name=Ya;Va="MODEL"}else Va="SAT-PROFILE";var ab=L;L++;Ya=window.open(ab,
"SOND"+ab,'itemId="sonda'+ab+'",toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=1040,height=600');Ya.myvar=Ka;var mb=Ya.document;mb.write(js);mb.close();A.push([Ya,"SOND"+ab]);mb=Va+" : "+Ka.meta.name;mb+="Profile for location ["+Math.round(100*T.x)/100+","+Math.round(100*T.y)/100+"]";ab='<div id="SOND'+ab+'"class="sonding">Profile for location ['+Math.round(100*T.x)/100+","+Math.round(100*T.y)/100+"]";ab+=" - "+Va+" : "+Ka.meta.name+"</div>";Ya.document.title=mb;document.getElementById("info").innerHTML+=
ab}}else document.getElementById("load").innerHTML="",window.alert("SOND: No valid data")}}(Da));Da={$jscomp$loop$prop$myLayer$341:Da.$jscomp$loop$prop$myLayer$341}}Fa.jumpToEnd()})};n.addListener("mouseclicked",P,!0);var I=function(){c.html('<div id="load"></div><div id="info"></div><div id="table"></div>');$("#info").html("Click on the map to load a profile.<br/> A Sounding,ECMWF Model or IASI-KRR/F layer loaded is necessary");document.getElementById("info").addEventListener("click",function(U){U=
U.target.getAttribute("id");console.log(U);for(var T=0;T<A.length;T++)if(A[T][1]==U&&!A[T][0].closed){A[T][0].focus();break}},!1);isDefined(Q)&&null!=Q||(Q=window.setInterval(function(){for(var U=0;U<A.length;U++)if(A[U][0].closed){var T=document.getElementById(A[U][1]);console.log(T);A.splice(U,1);T.remove();0==A.length&&$("#info").html("Click on the map to load a profile.<br/> A Sounding,ECMWF Model or IASI-KRR/F layer loaded is necessary")}},1E3),console.log(Q));n.enableInlineGetFeatureInfo(!1)};
this.enable=function(){I();w=!0};this.disable=function(){w=!1;n.enableInlineGetFeatureInfo(!0);x.set=!1;for(var U=0;U<A.length;U++)console.log("CLOSE"),A[U].close();window.clearInterval(Q);A=[];L=0};this.resize=function(U,T){$("#mitdd").width(U);x.set&&P(x)};this.enable()};try{WMJSExtApplications.Sondeo=tddjs,WMJSExtApplications.VertProfiles=tddjs}catch(c){}
...
function MakeHTTPRequest_s(c,n,w,x){function A(L){errorfunction?errorfunction(L,pointer):n(void 0,pointer)}c=-1===c.indexOf("?")?c+"?":c+"&";c+="rand="+Math.random();w||(w=!1);try{var Q=createXHR();Q.open("GET",c,!0);Q.onreadystatechange=function(){if(4===Q.readyState)if(200===Q.status){try{var L=Q.responseText}catch(P){A("Exception occured:"+P);return}void 0===L||""===L?A("request returned no data"):n(null,Q.response)}else console.log("ERROR",c),n(null,Q.response)};Q.send(null)}catch(L){window.alert("AQUI"),
!1===w?(c=x+"REQUEST="+URLEncode(c),MakeHTTPRequest_s(c,n,errorfunction,pointer,!0,x)):A("status("+Q.status+") to "+c)}}
function getJSONdata(c,n,w,x,A,Q){var L=c.service.split("=")[1];L=L.replace("&","");document.getElementById("load").innerHTML+="Procesando<br>";document.getElementById("load").innerHTML+='<img src="./img/ajax-loader.gif" alt="Loading..."/>';document.getElementById("table").innerHTML="";var P=WMJScheckURL(c.service);P+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;P+="&LAYERS="+URLEncode(c.name);c.name.split(",");var I=P;A="";L.includes("ECMWF")&&(I+="&QUERY_LAYERS=mean_sea_level_pressure&INFO_FORMAT=application/json",
P+="&QUERY_LAYERS=geopotential_height,temperature,relative_humidity,wind_barbs_vectors&INFO_FORMAT=application/json");L.includes("TEMP")&&(P+="&QUERY_LAYERS=p,z,t,td,windSpd,windDir,eVSS&INFO_FORMAT=application/json",I+="&QUERY_LAYERS=station_name,ps,alt,station_cname&INFO_FORMAT=application/json");if(L.includes("KRR")||L.includes("KRF"))P+="&QUERY_LAYERS=air_temperature,dew_point_temperature&INFO_FORMAT=application/json",I+="&QUERY_LAYERS=surface_air_pressure,surface_air_temperature,surface_dew_point_temperature&INFO_FORMAT=application/json";
L.includes("HARMONIE")&&(I+="&QUERY_LAYERS=medium_sea_level_pressure&INFO_FORMAT=application/json",P+="&QUERY_LAYERS=geopotential_height,air_temperature,relative_humidity,wind_barbs_vectors&INFO_FORMAT=application/json");A+="&"+getBBOXandProjString(c,n);A+="WIDTH="+n.width;A+="&HEIGHT="+n.height;if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)A=A+("&X="+w)+("&Y="+x);c.version===WMSVersion.version130&&(A=A+("&I="+w)+("&J="+x));A+="&FORMAT=image/gif&STYLES=";try{A+="&"+n._getMapDimURL(c),
P+=A,I+=A}catch(T){Q(null,void 0)}debug('<a target="_blank" href="'+P+'">'+P+"</a>",!1);var U=c.service+"&SERVICE=WMS&REQUEST=getCapabilities&VERSION="+c.version;getMeta(I,function(T){if(null!=T)if(console.log("META",T),I.includes("TEMP"))getData(U,T,P,function(O){null!=O?Q({meta:T,data:O}):Q(null)});else if(I.includes("KRR")||I.includes("KRF"))getData_IASI(U,T,P,function(O){null!=O?Q({meta:T,data:O}):Q(null)});else{if(I.includes("ECMWF")||I.includes("HARMONIE"))req_list=[],getAllLevels(U,function(O){if(null==
O)window.errorMessage("No hay niveles!"),Q(null);else{O=O.split(",");for(var ba=0;ba<O.length;ba++)req_list.push(P+"&elevation="+O[ba]);req_list.reverse();T.model=L;getDataN_Model(req_list,[],0,function(ia){null!=ia?Q({meta:T,data:ia}):Q(null)})}})}else Q(null)})}function WMJScheckURL(c){if(!isDefined(c))return"?";c=c.trim();-1===c.indexOf("?")&&(c+="?");return c}function isDefined(c){return"undefined"===typeof c?!1:!0}
...
return w}function getLevels(c,n){var w=new ol.format.WMSCapabilities;fetch(c).then(function(x){return x.text()}).then(function(x){x=w.read(x).Capability.Layer.Layer;x=$jscomp.makeIterator(x);for(var A=x.next();!A.done;A=x.next())if(A=A.value,"t"==A.Name||"temperature"==A.Name||"air_temperature_profile"==A.Name||"air_temperature"==A.Name){A=$jscomp.makeIterator(A.Dimension);for(var Q=A.next();!Q.done;Q=A.next())Q=Q.value,"elevation"==Q.name&&n(Q.default)}})}
function getAllLevels(c,n){var w=new ol.format.WMSCapabilities;fetch(c).then(function(x){return x.text()}).then(function(x){x=w.read(x).Capability.Layer.Layer;x=$jscomp.makeIterator(x);for(var A=x.next();!A.done;A=x.next())if(A=A.value,"t"==A.Name||"temperature"==A.Name||"air_temperature"==A.Name||"air_temperature_profile"==A.Name){A=$jscomp.makeIterator(A.Dimension);for(var Q=A.next();!Q.done;Q=A.next())Q=Q.value,"elevation"==Q.name&&n(Q.values)}})}
function getMeta(c,n){console.log("REQ META",c);MakeHTTPRequest_s(c,function(w,x){if(null!=w)console.error(w);else{w=[];try{var A=JSON.parse(x),Q=A[0].point.coords;Q=Q.split(",");var L=parseFloat(Q[0]),P=parseFloat(Q[1]);for(x=0;x<A.length;x++){var I=Object.keys(A[x].data).toString();if(I.includes("T")&&I.includes("-")&&I.includes(":"))break}if(c.includes("ECMWF")||c.includes("HARMONIE")){var U=I;var T=(new Date(U)).getTime();var O=A[0].data[I];I=Object.keys(O).toString();ff=(new Date(I)).getTime();
var ba=(ff-T)/36E5;I=Object.keys(O).toString()}var ia=c.includes("ECMWF")||c.includes("HARMONIE")?U.toString():I.toString();ia=ia.split("T");var la=ia[0].replaceAll("-","");la=parseInt(la);var ma=parseInt(ia[1].substring(0,2));U="OBSERVACION";if(c.includes("KRR")||c.includes("KRF")){ma=ia[1].substring(0,5);var ua="IASI-KRR/F";var Da="";U="SAT-PROFILE"}c.includes("ECMWF")&&(ua="ECMWF",Da="",U="MODEL");c.includes("HARMONIE")&&(ua="HARMONIE",Da="",U="MODEL");for(ia=0;ia<A.length;ia++){console.log(A[ia].standard_name);
if("station_name_backup"==A[ia].name){if(isDefined(ua))continue;ua=A[ia].data[I]}if("ps"==A[ia].name){if(isDefined(va))continue;var va=A[ia].data[I]/100;isNaN(va)&&(va=A[ia].data[0]/100)}if("air_pressure_at_mean_sea_level"==A[ia].standard_name||"medium_sea_level_pressure"==A[ia].standard_name){if(isDefined(va))continue;va=parseFloat(O[I]);isNaN(va)&&(va=parseFloat(O[I]))}if("surface_air_pressure"==A[ia].name){if(isDefined(va))continue;va=A[ia].data[I]/100;isNaN(va)&&(va=A[ia].data[0]/100)}if("surface_air_temperature"==
A[ia].standard_name){if(isDefined(Fa))continue;var Fa=isDefined(A[ia].data[2])?A[ia].data[2][I]-273.15:A[ia].data[I]-273.15;isNaN(Fa)&&(Fa=A[ia].data[2][I]-273.15)}if("surface_dew_point_temperature"==A[ia].standard_name){if(isDefined(Ma))continue;var Ma=isDefined(A[ia].data[2])?A[ia].data[2][I]-273.15:A[ia].data[I]-273.15;isNaN(Ma)&&(Ma=A[ia].data[2][I]-273.15)}if("alt"==A[ia].name){if(isDefined(Ka))continue;var Ka=parseFloat(A[ia].data[I]);isNaN(Ka)&&(Ka=parseFloat(A[ia].data[0]))}"station_cname_backup"!=
A[ia].name||isDefined(Da)||(Da=A[ia].data[I])}if(isDefined(ua)&&"nodata"!=ua){isNaN(Ka)&&(Ka=0);w={model:U,index:ua,date:la,run:ma,step:0,lon:L,lat:P,ps:va,zs:Ka,name:ua+" "+Da,ts:Fa,tds:Ma};if(c.includes("ECMWF")||c.includes("HARMONIE"))w={model:"ECMWF",index:"MODEL",date:la,run:ma,step:ba,lon:L,lat:P,ps:va,zs:0,name:"MODEL"};n(w)}else n(null)}catch(Va){n(null)}}})}
function getDataN_Model(c,n,w,x){0<c.length?(rml=c.pop(),$("#tableinfo").html(""),$("#table").html(""),$("#tableM").html(""),$("#tableS").html(""),MakeHTTPRequest_s(rml,function(A,Q){if(null!=A)console.error(A);else{var L=JSON.parse(Q),P=Object.keys(L[0].data)[0],I=Object.keys(L[0].data[P])[0],U=Object.keys(L[0].data[P][I])[0];A=parseFloat(L[0].data[P][I][U]);Q=parseFloat(L[1].data[P][I][U]);var T=parseFloat(L[2].data[P][I][U]),O=-1*parseFloat(L[3].data[P][I][U]);L=-1*parseFloat(L[4].data[P][I][U]);
I=parseFloat(I);n.push({n:w,p:I,z:A,t:Q,RH:T,u:L,v:O});n.sort(function(ba,ia){return ba.p-ia.p})}w++;getDataN_Model(c,n,w,x)})):x(n)}
function getData_IASI(c,n,w,x){getAllLevels(c,function(A){A=A.split(",");for(var Q=[],L=0;L<A.length;L++){var P=parseFloat(A[L])/100;100<=P&&P<=parseFloat(n.ps)&&Q.push(A[L])}A=w+"&elevation="+Q[0]+"/"+Q[Q.length-1];var I=[],U={n:0,p:n.ps,z:0,t:n.ts,td:n.tds,wD:NaN,wS:NaN};I.push(U);$("#tableinfo").html("");$("#table").html("");$("#tableM").html("");$("#tableS").html("");MakeHTTPRequest_s(A,function(T,O){if(null!=T)console.error(T);else{if(!O.includes("ServiceException")){T=JSON.parse(O);T=$jscomp.makeIterator(T);
for(O=T.next();!O.done;O=T.next()){U=O.value;console.log(U);if("air_temperature"==U.standard_name)var ba=U.data;if("dew_point_temperature"==U.standard_name)var ia=U.data}for(var la in Q){ind=Q[la];T=parseFloat(ind)/100;var ma=Object.keys(ba[ind]);O=parseFloat(ba[ind][ma]);O-=273.15;ma=parseFloat(ia[ind][ma]);ma-=273.15;I.push({n:la,p:T,z:NaN,t:O,td:ma,wD:NaN,wS:NaN})}}x(I)}})})}
function getData(c,n,w,x){getLevels(c,function(A){console.log("LEV",A);null==A&&(window.errorMessage("No hay niveles!"),x(null));var Q=parseInt(A);console.log("LEVEL",Q);var L=Math.floor(Q/100);Q%=100;for(var P=0,I=0,U=[],T=0;T<L;T++)I=P+99,U.push(w+"&elevation="+P+"/"+I),P=I+1;U.push(w+"&elevation="+P+"/"+(P+Q));U=U.reverse();var O=[];getDataN(U,A,n,O,function(ba){null==ba&&(window.errorMessage("No hay niveles!"),x(null));if(0==O.length)window.alert("El sondeo no tiene datos validos para este diagrama"),
x(null);else{ba=parseFloat(O[O.length-1].p);var ia=parseFloat(O[0].p);850>=ia?(window.alert("El primer nivel esta demasiado alto! - P0: "+ia+"hpa\n\n El primer nivel debe ser mayor de 850hPa"),x(null)):300<ba?(window.alert("Ultimo nivel demasiado bajo! - Pn: "+ba+"hpa\n\n El ultimo nivel debe ser menor de 300hPa"),x(null)):x(O)}})})}
function getDataN(c,n,w,x,A){if(0!=c.length){var Q=c.pop(),L=Q.indexOf("elevation");L=Q.slice(L);var P=L.indexOf("=")+1,I=L.indexOf("/"),U=L.slice(P,I);console.log("Procesando nivles",U,"a",parseInt(U)+99,"de",n);$("#tableinfo").html("");$("#table").html("");$("#tableM").html("");$("#tableS").html("");MakeHTTPRequest_s(Q,function(T,O){if(null!=T)console.error(T);else if(!O.includes("ServiceException")){T=w.zs;var ba=100;150>w.ps&&(ba=100);O=JSON.parse(O);O=$jscomp.makeIterator(O);for(var ia=O.next();!ia.done;ia=
O.next()){dat=ia.value;if("p"==dat.name)var la=dat.data;if("z"==dat.name)var ma=dat.data;if("t"==dat.name)var ua=dat.data;if("td"==dat.name)var Da=dat.data;if("windSpd"==dat.name)var va=dat.data;if("windDir"==dat.name)var Fa=dat.data;if("eVSS"==dat.name)var Ma=dat.data}O=parseInt(U);isDefined(la[O])||(O+=1);O=Object.keys(la[O]);ia=x.length;for(var Ka in la){var Va=la[Ka],Ya=ma[Ka],ab=ua[Ka],mb=Da[Ka],Eb=va[Ka],vb=Fa[Ka],sb=Ma[Ka];sb=sb[O];parseFloat(sb);Va=Va[O];Va=parseFloat(Va);Va/=ba;999999999<
Va||0>Va||(Ya=parseFloat(Ya[O]),ab=parseFloat(ab[O]),ab-=273.15,mb=parseFloat(mb[O])-273.15,Eb=parseFloat(Eb[O]),sb=vb=parseFloat(vb[O]),vb*=Math.PI/180,vb%=2*Math.PI,Ya<T||isNaN(ab)||isNaN(mb)||0>sb||(Va={n:ia,p:Va,z:Ya,t:ab,td:mb,wD:vb,wS:Eb},ia+=1,x.push(Va)))}}getDataN(c,n,w,x,A)})}else A(x)}var wsond=function(c){};var table="",wmjsond,yradar=function(c,n){function w(ba,ia){if(ba.length!=ia.length)return!1;for(var la=0;la<ba.length;la++)if(!ia.includes(ba[la]))return!1;for(la=0;la<ia.length;la++)if(!ba.includes(ia[la]))return!1;return!0}function x(){for(var ba=[],ia=0;ia<n.layers.length;ia++)n.layers[n.layers.length-ia-1].service.includes("YRAD")&&ba.push(n.layers[n.layers.length-ia-1].name);return ba}wmjsond=n;var A=!0,Q="",L=[],P=!1,I=[];L.set=!1;var U=null,T=function(ba){P&&(U.close(),P=!1);var ia=[];la=
"";document.getElementById("info").innerHTML=la;if(0!=A)if(L.x=ba.x,L.y=ba.y,L.set=!0,n.getLatLongFromPixelCoord({x:ba.x,y:ba.y}),ba=n.getLayers(),isDefined(ba)){info=n.getLayers().getFeatureInfoUrl;var la="";0==n.layers.length&&(la="No layer: Load a valid YRADAR layer.",document.getElementById("info").innerHTML=la);ba=[];for(la=0;la<n.layers.length;la++)n.layers[n.layers.length-la-1].service.includes("YRAD")&&ba.push(n.layers[n.layers.length-la-1]);la=null;for(var ma in ba)la=ba[ma],null!=la&&""!==
la.getFeatureInfoUrl?!1===la.queryable?n.featureInfoRequestReady("Layer is not queryable.",la):(document.getElementById("table").innerHTML="",la.name.includes("2D")?ia.push(la):la.name.includes("3D")&&ia.push(la)):(la="Wrong layer: Load a valid yradar layer.",document.getElementById("info").innerHTML=la,P&&U.close());console.log("YR",ia);if(0<ia.length){U=window.open("YRADAR.html","YRADAR",'itemId="sond",toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=800,height=600');for(ma=
0;ma<ia.length;ma++)la=ia[ma],getCells(la,n,L.x,L.y,function(ua){null!=ua&&(U.document.getElementById("info").insertAdjacentHTML("afterbegin",ua),U.focus())});P=!0}}else $("#info").html("No valid data received:<br/>"+data)};n.addListener("mouseclicked",T,!0);n.addListener("ondimchange",function(ba){return $jscomp.asyncExecutePromiseGeneratorProgram(function(ia){if(1==ia.nextAddress)return P&&U.close(),$("#tableinfo").html(""),$("#info").html(""),$("#table").html(""),document.getElementById("info").innerHTML=
"",document.getElementById("info").innerHTML='<img src="./img/ajax-loader.gif" alt="Loading..."/>',ia.yield(new Promise(function(la){return setTimeout(la,500)}),2);console.log("DIM REFRESH!!!");O();ia.jumpToEnd()})},!0);n.addListener("onimageload",function(ba){var ia;return $jscomp.asyncExecutePromiseGeneratorProgram(function(la){ia=x();w(ia,I)||(console.log("IMG REFRESH!!!"),O());la.jumpToEnd()})},!0);var O=function(){I=x();c.html('<div id="tableinfo"></div><div id="info"></div><div id="table"></div>');
...
ma.queryable)n.featureInfoRequestReady("Layer is not queryable.",ma);else if(ma.name.includes("2D")||ma.name.includes("3D")){var ua=ia[la];ba.$jscomp$loop$prop$path$344="";ba.$jscomp$loop$prop$rad$345=ua.name.substr(-3,3);ba.$jscomp$loop$prop$dim$343="2D";ua.name.includes("3D")&&(ba.$jscomp$loop$prop$dim$343="3D");ma=WMJScheckURL(ua.service).split("/");var Da=ma[0];ma=ma[2];ba.$jscomp$loop$prop$path$344=Da+"//"+ma+"/";getJSONdate(ua,n,"text/plain",function(va){return function(Fa){var Ma=Fa.substring(0,
Fa.indexOf("T"));Fa=Fa.substring(Fa.indexOf("T")+1,Fa.indexOf("Z")-2);Q!=Ma+Fa&&(Q=Ma+Fa);"3D"==va.$jscomp$loop$prop$dim$343?va.$jscomp$loop$prop$path$344+="yradar/"+Ma+Fa+"REG3D":ua.name.includes("NAC")?va.$jscomp$loop$prop$path$344+="yradar/"+Ma+Fa+"NAC2D":va.$jscomp$loop$prop$path$344+="yradar/"+Ma+Fa+"REG2D";$.ajax({url:va.$jscomp$loop$prop$path$344,dataType:"text",success:function(Ka){document.getElementById("info").innerHTML="";var Va=Ka.split(/\r?\n|\r/);Ka="<b> RADAR: "+va.$jscomp$loop$prop$rad$345+
"</b><br>";table="3D"==va.$jscomp$loop$prop$dim$343?"<b>YRADAR3D</b><br>":"<b>YRADAR2D</b><br>";if("COM"!=va.$jscomp$loop$prop$rad$345&&"NAC"!=va.$jscomp$loop$prop$rad$345){for(var Ya=[],ab=0;ab<Va.length;ab++)0===ab&&Ya.push(Va[ab]),Va[ab].includes(va.$jscomp$loop$prop$rad$345)&&Ya.push(Va[ab]);Va=Ya}Va=getTable(Va,va.$jscomp$loop$prop$rad$345,va.$jscomp$loop$prop$dim$343,n);$("#tableinfo").append(table+Ka+Va);$("#info").html("Click on cell num to zoom it.<br>")},error:function(Ka,Va,Ya){console.log(Ka,
Va,Ya);"No encontrado"==Ya||"Not find"==Ya?window.alert("No esta disponible el fichero: "+va.$jscomp$loop$prop$path$344):window.alert("Se ha producido un error al cargar"+va.$jscomp$loop$prop$path$344);document.getElementById("info").innerHTML="Error al cargar las caracteristicas de las celulas."}})}}(ba))}ba={$jscomp$loop$prop$dim$343:ba.$jscomp$loop$prop$dim$343,$jscomp$loop$prop$path$344:ba.$jscomp$loop$prop$path$344,$jscomp$loop$prop$rad$345:ba.$jscomp$loop$prop$rad$345}}n.enableInlineGetFeatureInfo(!1)};
this.enable=function(){O();A=!0};this.disable=function(){A=!1;n.enableInlineGetFeatureInfo(!0);L.set=!1;P&&(U.close(),P=!1)};this.resize=function(ba,ia){$("#mitdd").width(ba);L.set&&T(L)}};try{WMJSExtApplications.Yradar=yradar}catch(c){}
function createXHR(){try{return new XMLHttpRequest}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(c){}try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(c){}return!1}
function MakeHTTPRequest(c,n,w,x){function A(P){errorfunction?errorfunction(P,pointer):n(void 0,pointer)}function Q(){!1===w?(c=x+"REQUEST="+URLEncode(c),MakeHTTPRequest(c,n,errorfunction,pointer,!0,x)):A("status("+L.status+") to "+c)}c=-1===c.indexOf("?")?c+"?":c+"&";c+="rand="+Math.random();w||(w=!1);try{var L=createXHR();L.open("GET",c,!0);L.onreadystatechange=function(){if(4===L.readyState)if(200===L.status){try{var P=L.responseText}catch(I){A("Exception occured:"+I);return}void 0===P||""===P?
A("request returned no data"):n(null,L.response)}else Q()};L.send(null)}catch(P){Q()}}
function getCells(c,n,w,x,A){var Q=c.name;Q.includes("2D")&&getJSONdata2D(c,n,w,x,"text/plain",function(L){document.getElementById("info").innerHTML="";if(null!=L){var P=L.ANA,I=L.RAYOS,U=L.MOV;L="<br>CENTROIDE 2D <b>"+(P.ID+"</b> : ["+P.LATCEN+","+P.LONCEN+"]");var T="<TABLE BORDER><TR> <TD>ID</TD> <TD>NUPIX</TD> <TD>ZMAX</TD> <TD>ZMED</TD> <TD>RADIOE</TD> <TD>ECTOP</TD> <TD>VIL</TD> </TR><TR><TD><b>"+(P.ID+"</b></TD> <TD>"+P.NUPIX+"</TD> <TD>"+P.ZMAX+"</TD> <TD>"+P.ZMED+"</TD> <TD>"+P.RADIOE+"</TD> <TD>"+
P.ECTOP+"</TD> <TD>"+P.VIL+"</TD></TR>");T+="</TABLE>";var O="<div><p><b>RAYOS TOTALES:</b>"+I.RAY+"<br>";O+="<b>POSITIVOS:</b>"+I.POS+"<br>";O+="<b>NEGATIVOS:</b>"+I.NEG+"<br>";O+="<b>INTRANUBE:</b>"+I.INT+"<br>";O+="<b>LATCENR:</b>"+I.LATCENR+"<b> LONCENR:</b>"+I.LONCENR+"<br>";O+="<b>DISTMAX:</b>"+I.DISTMAX+"<b> DISTMED:</b>"+I.DISTMED+"<b> RAYOS/KM2:</b>"+I["RY/KM"]+"<br></p>";O+="</div>";I="<div><p><b>MOVIMIENTO:</b> V(Km/h):"+U.VKMH+" DIRN:"+U.DIRN+"</p></div>";U="";isDefined(P.ADV)&&(U="<div><p><b>ADVERSIDAD: </b>"+
P.ADV+"</p></div>");A(L+(T+O+I+U))}else L="<br>"+(Q+" Wrong point!!! <b>"),A(L)});Q.includes("3D")&&getJSONdata3D(c,n,w,x,"text/plain",function(L){document.getElementById("info").innerHTML="";if(null!=L){var P=L.ANA,I=L.GRANIZO;L=L.MOV;var U="CENTROIDE 3D <b>"+P.ID+"</b> : ["+P.LATCEN+","+P.LONCEN+"]";var T="<TABLE BORDER><TR> <TD>ID</TD> <TD>ZMAX</TD> <TD>ESPE</TD> <TD>ECTOP</TD> <TD>DVIL</TD> <TD>DVGR</TD> <TD>HB45</TD> <TD>HBAS</TD> <TD>DVCE</TD> </TR><TR><TD><b>"+(P.ID+"</b></TD> <TD>"+P.ZMAX+
"</TD> <TD>"+P.ESPE+"</TD> <TD>"+P.ECTOP+"</TD> <TD>"+P.DVIL+"</TD> <TD>"+P.DVGR+"</TD> <TD>"+P.HB45+"</TD> <TD>"+P.HBAS+"</TD> <TD>"+P.DVCE+"</TD></TR>");T+="</TABLE>";var O=I.GRA,ba="color:#00FF00";"g"==O&&(ba="color:#AAAA00");"G"==O&&(ba="color:#FF0000");O="<div><p><b>GRANIZO:</b><b style="+ba+">"+O+"</b><br><b>ORG-PER:</b>"+(I.ORG+"<br>");O+="<b>PGR:</b>"+I.PGR+"<br>";O+="<b>TAM(mm):</b>"+I.TAM+"<br>";O+="</p></div>";I=parseInt(P.ADV);ba="color:#00FF00";var ia="Sin Pot. Adv.";1==I&&(ba="color:#AAAA00",
ia="Alto Pot. Adv.");2==I&&(ba="color:#FF0000",ia="Muy alto Pot. Adv");P="<div><p><b>ADVERSIDAD: </b><b style="+ba+">"+ia+"</b><br><b>CELULA 2D: </b>"+(parseInt(P.N2D)+"<br>");U+=T+("<div><p><b>MOVIMIENTO:</b></br><b>V(Km/h):</b>"+(L.VKMH+"<b> DIRN:</b>"+L.DIRN+"</p></div>"))+O+(P+"</p></div></br>")}else U="<br>"+(Q+" wrong point!!!<b>");A(U)})}
function getJSONdate(c,n,w,x){w=WMJScheckURL(c.service);w+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;w+="&LAYERs="+URLEncode(c.name);w+="&QUERY_LAYERS="+URLEncode(c.name)+"&INFO_FORMAT=application/json&FORMAT=application/json";w+="&"+getBBOXandProjString(c,n)+"&WIDTH=400";w+="&"+n._getMapDimURL(c);MakeHTTPRequest(w,function(A,Q){null!=A?(console.error(A),x(null)):(A=JSON.parse(Q),A=Object.keys(A[0].data)[0],A=A.replaceAll(":",""),A=A.replaceAll("-",""),x(A))})}
function getJSONdata2D(c,n,w,x,A,Q){document.getElementById("info").innerHTML="Procesando<br>";document.getElementById("table").innerHTML="";A=WMJScheckURL(c.service);A+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;A+="&LAYERS="+URLEncode(c.name);c.name.split(",");var L="";A+="&QUERY_LAYERS="+URLEncode(c.name)+"&INFO_FORMAT=application/json";L+="&"+getBBOXandProjString(c,n);L+="WIDTH="+n.width;L+="&HEIGHT="+n.height;if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)L=
L+("&X="+w)+("&Y="+x);c.version===WMSVersion.version130&&(L=L+("&I="+w)+("&J="+x));L+="&FORMAT=image/gif&STYLES=";try{L+="&"+n._getMapDimURL(c),A+=L}catch(P){Q(null)}MakeHTTPRequest(A,function(P,I){if(null!=P)console.error(P),Q(null);else{P=JSON.parse(I);var U;for(U in P){I=P[U];if("RADIOE"==I.name&&(!isDefined(T)||"nodata"==T[Object.keys(T)]))var T=I.data;if("NUPIX"==I.name)var O=I.data;if("LATCEN"==I.name)var ba=I.data;if("LONCEN"==I.name)var ia=I.data;if("ECTOP"==I.name)var la=I.data;if("VIL"==
I.name)var ma=I.data;if("id"==I.name&&(!isDefined(ua)||"nodata"==ua[Object.keys(ua)]||"nan"==ua[Object.keys(ua)]))var ua=I.data;if("ZMAX"==I.name&&(!isDefined(Da)||"nodata"==Da[Object.keys(Da)]||isNaN(parseFloat(Da[Object.keys(Da)]))))var Da=I.data;if("ZMED"==I.name)var va=I.data;if("ADV"==I.name)var Fa=I.data;if("RAY"==I.name)var Ma=I.data;if("POS"==I.name)var Ka=I.data;if("NEG"==I.name)var Va=I.data;if("RAYo"==I.name)var Ya=I.data;if("DISTMAX"==I.name)var ab=I.data;if("DISTME"==I.name)var mb=I.data;
if("RY/K"==I.name)var Eb=I.data;if("LATCENR"==I.name)var vb=I.data;if("LONCENR"==I.name)var sb=I.data;if("DIRN"==I.name)var Pc=I.data;if("V(KMH)"==I.name)var Dc=I.data}try{var ed=T[Object.keys(T)],Ec=O[Object.keys(O)];if(isDefined(ba))var Fc=ba[Object.keys(ba)];if(isDefined(ia))var Rc=ia[Object.keys(ia)];if(isDefined(la))var qc=la[Object.keys(la)];if(isDefined(ma))var rc=ma[Object.keys(ma)];var fd=Da[Object.keys(Da)],gd=va[Object.keys(va)],Dd=Ma[Object.keys(Ma)],hd=Ka[Object.keys(Ka)],Ed=Va[Object.keys(Va)],
...
ECTOP:qc,VIL:rc};Q({ANA:hf,RAYOS:{RAY:Dd,POS:hd,NEG:Ed,INT:oe,DISTMAX:Zb,DISTMED:Fd,"RY/KM":pe,LATCENR:df,LONCENR:$g},MOV:{DIRN:ah,VKMH:ef}})}catch(ch){console.log(ch),Q(null)}}});debug('<a target="_blank" href="'+A+'">'+A+"</a>",!1)}
function getJSONdata3D(c,n,w,x,A,Q){document.getElementById("info").innerHTML="Procesando<br>";document.getElementById("table").innerHTML="";A=WMJScheckURL(c.service);A+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;A+="&LAYERS="+URLEncode(c.name);c.name.split(",");var L="";A+="&QUERY_LAYERS="+URLEncode(c.name)+"&INFO_FORMAT=application/json";L+="&"+getBBOXandProjString(c,n);L+="WIDTH="+n.width;L+="&HEIGHT="+n.height;if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)L=
L+("&X="+w)+("&Y="+x);c.version===WMSVersion.version130&&(L=L+("&I="+w)+("&J="+x));L+="&FORMAT=image/gif&STYLES=";try{L+="&"+n._getMapDimURL(c),A+=L}catch(P){Q(null)}MakeHTTPRequest(A,function(P,I){if(null!=P)console.error(P),Q(null);else{P=JSON.parse(I);var U;for(U in P){I=P[U];if("ID_backup"==I.name)var T=I.data;if("LATCEN"==I.name)var O=I.data;if("LONCEN"==I.name)var ba=I.data;if("DVCE"==I.name)var ia=I.data;if("DVGR"==I.name)var la=I.data;if("ECTOP"==I.name)var ma=I.data;if("ESPE"==I.name&&(!isDefined(ua)||
"nodata"==ua[Object.keys(ua)]))var ua=I.data;if("GRA"==I.name)var Da=I.data;if("HB45"==I.name)var va=I.data;if("HBAS"==I.name)var Fa=I.data;if("DVIL"==I.name&&(!isDefined(Ma)||"nodata"==Ma[Object.keys(Ma)]))var Ma=I.data;if("ZMAX"==I.name&&(!isDefined(Ka)||"nodata"==Ka[Object.keys(Ka)]||Ka[Object.keys(Ka)]==T[Object.keys(T)]))var Ka=I.data;if("ADV"==I.name)var Va=I.data;if("NUM2D"==I.name)var Ya=I.data;if("ORG-PER"==I.name)var ab=I.data;if("PGR"==I.name)var mb=I.data;if("TAM(mm)"==I.name)var Eb=I.data;
if("DIRN"==I.name)var vb=I.data;if("V(KMH)"==I.name)var sb=I.data}try{var Pc=O[Object.keys(O)],Dc=ba[Object.keys(ba)],ed=ia[Object.keys(ia)],Ec=la[Object.keys(la)],Fc=ma[Object.keys(ma)],Rc=ua[Object.keys(ua)];ia="0";isDefined(Da)&&(ia=Da[Object.keys(Da)]);var qc=va[Object.keys(va)],rc=Fa[Object.keys(Fa)],fd=Ma[Object.keys(Ma)],gd=Ka[Object.keys(Ka)];Ma="0";isDefined(Ya)&&(Ma=Ya[Object.keys(Ya)]);Ya="0";isDefined(ab)&&(Ya=ab[Object.keys(ab)]);var Dd=mb[Object.keys(mb)],hd=Eb[Object.keys(Eb)],Ed=vb[Object.keys(vb)],
oe=sb[Object.keys(sb)],Zb=T[Object.keys(T)];T="0";isDefined(Va)&&(T=Va[Object.keys(Va)]);var Fd={LATCEN:Pc,LONCEN:Dc,ID:Zb,DVCE:ed,DVGR:Ec,ESPE:Rc,HB45:qc,HBAS:rc,ECTOP:Fc,DVIL:fd,ZMAX:gd,N2D:Ma,ADV:T};granizo={GRA:ia,ORG:Ya,PGR:Dd,TAM:hd};Q({ANA:Fd,GRANIZO:granizo,MOV:{DIRN:Ed,VKMH:oe}})}catch(pe){Q(null)}}});debug('<a target="_blank" href="'+A+'">'+A+"</a>",!1)}function WMJScheckURL(c){if(!isDefined(c))return"?";c=c.trim();-1===c.indexOf("?")&&(c+="?");return c}
function isDefined(c){return"undefined"===typeof c?!1:!0}
function URLEncode(c){if(!c||void 0===c||""===c||"string"!==typeof c)return c;var n="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz%-_.!~*'()",w="0123456789ABCDEF";c=c.replace(/%/g,"%25");c=c.replace(/\+/g,"%2B");c=c.replace(/ /g,"%20");c=c.replace(/\^/g,"%5E");c=c.replace(/&/g,"%26");c=c.replace(/\?/g,"%3F");c=c.replace(/>/g,"%3E");c=c.replace(/</g,"%3C");c=c.replace(/\\/g,"%5C");for(var x="",A=0;A<c.length;A++){var Q=c.charAt(A);if(" "===Q)x+="%20";else if(-1!==n.indexOf(Q))x+=Q;
...
function getTable(c,n,w,x){var A="NUM RAD NUPIX ZMAX ZMED VIL ZMXV DIRN V(KMH) NEG POS RAYo RAY ADV".split(" "),Q="NUM NUPIX ZMAX ZMED VIL DIRN V(KMH) NEG POS RAYo RAY".split(" "),L="NUM RAD ZMAX ESPE ECTOP DVIL ADV GRA".split(" ");x=["LATCEN","LONCEN"];Q="2D"==w?"NAC"==n?Q:A:L;n=c[0].split(",");w=[];for(A=0;A<Q.length;A++)n.includes(Q[A])&&w.push(n.indexOf(Q[A]));Q=[];for(A=0;A<x.length;A++)n.includes(x[A])&&Q.push(n.indexOf(x[A]));x=[];n=[];for(A=0;A<c.length;A++){L=c[A].split(",");var P=[];n.push([L[Q[0]],
L[Q[1]]]);for(var I=0;I<w.length;I++)P.push(L[w[I]]);isDefined(P[1])&&x.push(P)}c='<table id="my-table">';for(w=0;w<x.length;w++){0===w&&(c+="<thead>");c+="<tr>";A=x[w];Q=n[w];for(L=0;L<A.length;L++)0===w?(c+="<th>",c+=A[L],c+="</th>"):(c=0===L?c+('<td style="cursor:pointer;color:#00f" onclick="getnum('+Q[0]+","+Q[1]+')">'):c+"<td>",c+=A[L],c+="</td>");0===w?(c+="</tr>",c+="</thead>",c+="<tbody>"):c+="</tr>"}c+="</tbody></table>";1==x.length&&(c="<b>NO CELLS</b></br>");return c};var gfiapp_point_interest=function(c,n){var w=this,x=[],A=!0,Q=function(L,P){var I=null,U=null,T=null;setflags=function(){I&&U&&T?(lon=I,lat=U,name=T,fullUrl=knmiFlagURL+"file="+pointInterestFileName+"&location="+lon+","+lat+"&name="+name,$.ajax({type:"GET",url:fullUrl,success:function(ba){"OK"===ba.status?(ba=Ext.getCmp("webmapjs_add_point_interest"),ba.getEl().dom.style.background="#BCED91",n.getImageStore().clear(),n.draw("draw")):(ba=Ext.getCmp("webmapjs_add_point_interest"),ba.getEl().dom.style.background=
"#FF4040")},dataType:"jsonp",contentType:"application/jsonp",jsonpCallback:"resultSetFlag",crossDomain:!0})):(T||$("#webmapjs_point_interest_name").css("border","2px solid red"),I||$("#webmapjs_point_interest_lon").css("border","2px solid red"),U||$("#webmapjs_point_interest_lat").css("border","2px solid red"))};delete_flag=function(){Ext.MessageBox.show({title:I18n.delete_title_confirm.text,msg:I18n.are_you_sure.text,buttons:Ext.MessageBox.YESNO,icon:Ext.MessageBox.WARNING,fn:function(ba){"yes"==
...
ba.append(ua);ua.html("LAYER "+ma.service)}w.resize(L,P)};O();n.addListener("onlayeradd",O,!0);n.addListener("mouseclicked",function(ba){if(0!=A){var ia=n.getLatLongFromPixelCoord({x:ba.x,y:ba.y});I=ia.x;U=ia.y;$("#webmapjs_point_interest_lon").val(ia.x.toFixed(5));$("#webmapjs_point_interest_lat").val(ia.y.toFixed(5));$("#webmapjs_point_interest_lon, #webmapjs_point_interest_lat").css("border","1px solid grey");ia=n.getLayers();ba=n.getWMSGetFeatureInfoRequestURL(ia[0],ba.x,ba.y).replace("&INFO_FORMAT=text/html",
...
"";switch(ba){case "name":T=ia.target.value;break;case "lon":I=ia.target.value;break;case "lat":U=ia.target.value}$("#webmapjs_point_interest_"+ba).css("border","1px solid grey")};this.changeMapPin=function(){n.positionMapPinByLatLon({x:I,y:U})};n.enableInlineGetFeatureInfo(!1)};this.enable=function(L,P){Q(L,P);A=!0};this.disable=function(){A=!1;n.enableInlineGetFeatureInfo(!0)};this.resize=function(L,P){for(var I=0;I<x.length;I++)x[I].setSize(L,P/x.length);for(I=0;I<x.length;I++);};w.enable()};
WMJSExtApplications["Points of interest"]=gfiapp_point_interest;var gfiapp_eprofile=function(c,n){var w=this,x=[],A=function(Q,L){c.html('<div id="info"></div><div class="gfiapp_eprofile">bla</div>');var P=function(T,O){O=O.id;for(var ba=0;ba<x.length;ba++){var ia=x[ba].getWebMapJS();ia.suspendEvent("onupdatebbox");ba!=O&&0==T.equals(x[ba].getWebMapJS().getProjection().bbox)&&(ia.zoomTo(T),x[ba].updateBBOX(T));ia.resumeEvent("onupdatebbox")}},I=function(T,O){T=O.id;for(O=0;O<x.length;O++){var ba=x[O].getWebMapJS();ba.suspendEvent("onupdatebbox");ba.suspendEvent("onloadingcomplete");
O!=T&&ba.draw();ba.resumeEvent("onloadingcomplete");ba.resumeEvent("onupdatebbox")}},U=function(){var T=c.find(".gfiapp_eprofile");T.empty();for(var O=n.getLayers(),ba=0;ba<O.length;ba++){var ia=O[ba],la=jQuery("<div />",{css:{margin:8}});T.append(la);x[ba]=new GFITimeElevationWindow(la);x[ba].getWebMapJS().addLayer(ia);x[ba].getWebMapJS().getListener().id=ba;x[ba].getWebMapJS().addListener("onupdatebbox",P,!0);x[ba].getWebMapJS().addListener("onloadingcomplete",I,!0)}w.resize(Q,L)};U();n.addListener("ondimchange",
function(){var T=x[0].getWebMapJS(),O=T.getProjection().bbox.clone();T=T.getProjection().bbox.right-T.getProjection().bbox.left;var ba=(new Date(n.getDimension("time").currentValue)).getTime();O.left=ba;O.right=ba+T;for(T=0;T<x.length;T++)x[T].getWebMapJS().zoomTo(O)},!0);n.addListener("onlayeradd",U,!0);console.log(x[0]);x[0].getWebMapJS().addListener("onloadingcomplete",function(){var T=x[0].getWebMapJS().getProjection().bbox.clone();$("#info").html("Displaying dates "+n.dateToISO8601(new Date(T.left))+
" till "+n.dateToISO8601(new Date(T.right)))},!0);n.enableInlineGetFeatureInfo(!1)};this.enable=function(Q,L){A(Q,L)};this.disable=function(){n.enableInlineGetFeatureInfo(!0)};this.resize=function(Q,L){for(var P=0;P<x.length;P++)x[P].setSize(Q,L/x.length);for(P=0;P<x.length;P++);};w.enable()};WMJSExtApplications.EProfile=gfiapp_eprofile;var autowms_app=function(c,n){initWMJS();c.addClass("autowms_app_container");var w="https://geoservices.knmi.nl/autowms?";try{w=autowmsURL}catch(O){}var x={},A=[],Q=function(O){var ba=I();c.html(ba+JSON.stringify(O));$(".autowms_app_fileitem_return").attr("onclick","").click(function(ia){A=[];T("")});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(ia){var la=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){T(la)},
...
(ba+'">&#8635;&nbsp;<b>Refresh</b></span></span>')},U=function(O,ba){c.html("... working ... ");var ia=WMJSGetServiceFromStore(ba,xml2jsonrequestURL);ia.getLayerObjectsFlat(function(la){var ma=""+I(O,ba);ma+="<span class='autowms_app_serviceabstract'><b>"+ia.title.replace(/!/g,"<br/>")+"</b><hr/>"+ia.abstract.replace(/!/g,"<br/>");if(ba&&(ma+='<hr/>WMS: <a target="_blank" href="'+ba+'&service=WMS&request=GetCapabilities">'+ba+"</a>",1<ba.split("?").length)){var ua=new WMJSKVP(ba.split("?")[1]),Da=
ba.split("?")[0].replace("adagucserver","adagucopendap/");Da=Da.replace(/([^:]\/)\/+/g,"$1");ua.source&&(Da+=ua.source);ua.dataset&&(Da+=ua.dataset+"/");ma=ma+('<hr/>OpenDAP: <span class=\'autowms_app_opendaplinks\'><a target="_blank" href="'+Da+'">'+Da+'</a><a target="_blank" href="')+(Da+'.das">DAS</a><a target="_blank" href="')+(Da+'.dds">DDS</a></span>')}ma+="</span>";c.html("... working ... ");x={};for(ua=0;ua<la.length;ua++)ma+=P(la[ua],ba),x[la[ua].name]=la[ua];c.html(ma);$(".autowms_app_layeritem").attr("onclick",
"").click(function(va){va=x[$(this).attr("name")];window.location.hash="addlayer('"+ba+"','"+va.name+"')"});$(".autowms_app_fileitem_return").attr("onclick","").click(function(va){T(A.pop())});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(va){var Fa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){U(O,Fa)},100)});$(".autowms_app_request_button").attr("onclick","").click(function(va){T("")});$(".autowms_app_request_input").keyup(function(va){13==
va.keyCode&&T("")})},function(la){la=I();la=la+"<span class='autowms_app_error_container'><span class='autowms_app_error_container_header'>Unable to get WMS GetCapabilities</span><a target='_blank' href=\""+(ba+'service=WMS&request=GetCapabilities">'+ba+"</a>");c.html(la+"</span>");$(".autowms_app_fileitem_return").attr("onclick","").click(function(ma){A=[];T("")})},!0)},T=function(O){O&&"undefined"!==O||(O="");var ba=$(".autowms_app_request_input").first().val();ba&&0<ba.length&&(w=ba.trim().split("?")[0],
w.endsWith("?")||(w+="?"));var ia=function(ma){if(ma.error)c.html("Error from server: "+ma.error);else{x={};A[A.length-1]!==O&&A.push(O);var ua=I(ma,O);c.html("... working ... ");ma.result.sort(function(va,Fa){if(va.name<=Fa.name)return-1;if(va.name>Fa.name)return 1;if(va.name==Fa.name)return 0});for(var Da=0;Da<ma.result.length;Da++)ua+=L(ma.result[Da]),x[ma.result[Da].name]=ma.result[Da];c.html(ua);$(".autowms_app_fileitem_return").attr("onclick","").click(function(va){A.pop();T(A[A.length-1])});
$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(va){var Fa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){T(Fa)},100)});$(".autowms_app_fileitem").attr("onclick","").click(function(va){va=x[$(this).attr("name")];!1===va.leaf?T(va.path):U(ma,va.adaguc)});$(".autowms_app_request_button").attr("onclick","").click(function(va){T("")});$(".autowms_app_request_input").keyup(function(va){13==va.keyCode&&T("")})}},la=
w+"request=getfiles&path="+O;c.html('... Reading <a href="'+la+'">'+la+"</a> ... ");try{$.ajax({contentType:"application/json",crossDomain:!0,type:"GET",url:la,success:ia,error:function(ma){console.error("Request failed without jsonp, trying jsonp");ia({result:[]});$.ajax({dataType:"jsonp",contentType:"application/jsonp",crossDomain:!0,type:"GET",url:la,success:ia,error:function(ua){Q("Unable to do ajax call")}})}})}catch(ma){console.error(ma),Q(ma)}};this.enable=function(){c.html("<div>Initializing...</div>");
T("")};this.disable=function(){};this.resize=function(O,ba){}};try{WMJSExtApplications.AutoWMS=autowms_app}catch(c){};var hipatia_app=function(c,n){function w(la){$.ajax({url:"./hipatia/project.ls",type:"GET",dataType:"text",success:function(ma){datalist=ma.split("\n");for(ma=0;ma<datalist.length;ma++)""!=datalist[ma]&&L.push(datalist[ma].trim());hipatiaURL&&""!==hipatiaURL||(hipatiaURL=L[0]);ia("")},error:function(ma,ua,Da){console.log(Da)},cache:!1})}initWMJS();c.addClass("autowms_app_container");var x="https://geoservices.knmi.nl/autowms?";try{x=autowmsURL,serverURL=autowmsURL.replace("autowms","adaguc-server")}catch(la){}var A=
{},Q=[],L=[],P=function(la){var ma=O();c.html(ma+JSON.stringify(la));$(".autowms_app_fileitem_return").attr("onclick","").click(function(ua){ia("")})},I=function(la,ma,ua){console.log("FOLD",ma);$.ajax({url:la,dataType:"text",success:function(Da){lines=Da.split("\n");for(var va=Da=!1,Fa=0;Fa<lines.length;Fa++)line=lines[Fa],line.includes("BEGIN "+ma)&&(Da=!0),line.includes("END")&&(Da=!1),line.includes("<Layer")&&(va=!0),line.includes("</Layer")&&(va=!1),Da&&va&&line.includes("<Name>")&&(nombre=line.substring(line.indexOf(">")+
1,line.indexOf("</")),ua.push(nombre))},error:function(Da,va,Fa){},cache:!1})},U=function(la){return"<span class='autowms_app_fileitem' name='"+la+"'>&#128451;&nbsp;"+la+"</span>"},T=function(la,ma){console.log("WMS",ma);var ua="<span class='autowms_app_layeritem' title='Click to add to viewer' name='"+la.name+"'><span class='autowms_app_layeritem_text'>Layer "+la.text+" - ("+la.name+")</span>";return ua+="<span class='autowms_app_layeritem_image'><img src=\""+(ma+"&service=WMS&request=getmap&format=image/png&layers="+
...
var ua=WMJSGetServiceFromStore(ma,xml2jsonrequestURL),Da=[];I("hipatia/"+hipatiaURL+".xml",la,Da);ua.getLayerObjectsFlat(function(va){var Fa=""+O(hipatiaURL+"/"+la);Fa+="</span>";c.html("... working ... ");A={};for(var Ma=0;Ma<va.length;Ma++)Da.includes(va[Ma].name)&&(console.log(va[Ma].name),Fa+=T(va[Ma],ma),A[va[Ma].name]=va[Ma]);console.log("LAYER",A);c.html(Fa);$(".autowms_app_layeritem").attr("onclick","").click(function(Ka){Ka=A[$(this).attr("name")];window.location.hash="addlayer('"+ma+"','"+
...
ma+"</a>");c.html(va+"</span>");$(".autowms_app_fileitem_return").attr("onclick","").click(function(Fa){ia("")})},!0)},ia=function(la){la&&"undefined"!==la||(la=hipatiaURL&&"undefined"!==hipatiaURL?hipatiaURL:L[0]);var ma=$(".autowms_app_request_input").first().val();ma&&0<ma.length&&(hipatiaURL=ma);ma=function(va){if(va.error)c.html("Error from server: "+va.error);else{A={};Q=[];lines=va.split("\n");for(va=0;va<lines.length;va++)line=lines[va],line.includes("BEGIN ")&&(folder=line.substring(line.indexOf("BEGIN ")+
6,line.indexOf("--\x3e")),Q.push(folder));var Fa=O(la);c.html("... working ... ");Q.sort(function(Ma,Ka){if(Ma.name<=Ka.name)return-1;if(Ma.name>Ka.name)return 1;if(Ma.name==Ka.name)return 0});for(va=0;va<Q.length;va++)Fa+=U(Q[va]),A[Q[va]]=Q[va];c.html(Fa);$(".autowms_app_fileitem_return").attr("onclick","").click(function(Ma){ia("")});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(Ma){var Ka=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();
setTimeout(function(){ia(Ka)},100)});$(".autowms_app_fileitem").attr("onclick","").click(function(Ma){Ma=A[$(this).attr("name")];console.log("FILEOBJ",Ma);ba(Ma)});$(".autowms_app_request_button").attr("onclick","").click(function(Ma){ia(hipatiaURL)});$(".autowms_app_request_input").keyup(function(Ma){13==Ma.keyCode&&ia(hipatiaURL)})}};var ua=x+"request=getfiles&path="+la,Da="hipatia/"+hipatiaURL+".xml";c.html('... Reading <a href="'+ua+'">'+ua+"</a> ... ");try{$.ajax({url:Da,dataType:"text",success:ma,
error:function(va,Fa,Ma){console.error("Request failed without jsonp, trying jsonp");P("Unable extract data list")},cache:!1})}catch(va){console.error(va),P(va)}};this.enable=function(){c.html("<div>Initializing...</div>");w("./hipatia")};this.disable=function(){};this.resize=function(la,ma){}};try{WMJSExtApplications.Hipatia=hipatia_app}catch(c){};
