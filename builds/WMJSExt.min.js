...
$jscomp.polyfill("WeakMap",function(e){function p(){if(!e||!Object.seal)return!1;try{var da=Object.seal({}),ea=Object.seal({}),Z=new e([[da,2],[ea,3]]);if(2!=Z.get(da)||3!=Z.get(ea))return!1;Z.delete(da);Z.set(ea,4);return!Z.has(da)&&4==Z.get(ea)}catch(ka){return!1}}function z(){}function F(da){var ea=typeof da;return"object"===ea&&null!==da||"function"===ea}function I(da){if(!$jscomp.owns(da,N)){var ea=new z;$jscomp.defineProperty(da,N,{value:ea})}}function ja(da){if(!$jscomp.ISOLATE_POLYFILLS){var ea=
Object[da];ea&&(Object[da]=function(Z){if(Z instanceof z)return Z;Object.isExtensible(Z)&&I(Z);return ea(Z)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(e&&$jscomp.ES6_CONFORMANCE)return e}else if(p())return e;var N="$jscomp_hidden_"+Math.random();ja("freeze");ja("preventExtensions");ja("seal");var V=0,aa=function(da){this.id_=(V+=Math.random()+1).toString();if(da){da=$jscomp.makeIterator(da);for(var ea;!(ea=da.next()).done;)ea=ea.value,this.set(ea[0],ea[1])}};aa.prototype.set=function(da,
ea){if(!F(da))throw Error("Invalid WeakMap key");I(da);if(!$jscomp.owns(da,N))throw Error("WeakMap key fail: "+da);da[N][this.id_]=ea;return this};aa.prototype.get=function(da){return F(da)&&$jscomp.owns(da,N)?da[N][this.id_]:void 0};aa.prototype.has=function(da){return F(da)&&$jscomp.owns(da,N)&&$jscomp.owns(da[N],this.id_)};aa.prototype.delete=function(da){return F(da)&&$jscomp.owns(da,N)&&$jscomp.owns(da[N],this.id_)?delete da[N][this.id_]:!1};return aa},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(e){function p(){if($jscomp.ASSUME_NO_NATIVE_MAP||!e||"function"!=typeof e||!e.prototype.entries||"function"!=typeof Object.seal)return!1;try{var aa=Object.seal({x:4}),da=new e($jscomp.makeIterator([[aa,"s"]]));if("s"!=da.get(aa)||1!=da.size||da.get({x:4})||da.set({x:4},"t")!=da||2!=da.size)return!1;var ea=da.entries(),Z=ea.next();if(Z.done||Z.value[0]!=aa||"s"!=Z.value[1])return!1;Z=ea.next();return Z.done||4!=Z.value[0].x||"t"!=Z.value[1]||!ea.next().done?!1:!0}catch(ka){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(e&&$jscomp.ES6_CONFORMANCE)return e}else if(p())return e;var z=new WeakMap,F=function(aa){this.data_={};this.head_=N();this.size=0;if(aa){aa=$jscomp.makeIterator(aa);for(var da;!(da=aa.next()).done;)da=da.value,this.set(da[0],da[1])}};F.prototype.set=function(aa,da){aa=0===aa?0:aa;var ea=I(this,aa);ea.list||(ea.list=this.data_[ea.id]=[]);ea.entry?ea.entry.value=da:(ea.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:aa,value:da},
...
aa).entry};F.prototype.get=function(aa){return(aa=I(this,aa).entry)&&aa.value};F.prototype.entries=function(){return ja(this,function(aa){return[aa.key,aa.value]})};F.prototype.keys=function(){return ja(this,function(aa){return aa.key})};F.prototype.values=function(){return ja(this,function(aa){return aa.value})};F.prototype.forEach=function(aa,da){for(var ea=this.entries(),Z;!(Z=ea.next()).done;)Z=Z.value,aa.call(da,Z[1],Z[0],this)};F.prototype[Symbol.iterator]=F.prototype.entries;var I=function(aa,
da){var ea=da&&typeof da;"object"==ea||"function"==ea?z.has(da)?ea=z.get(da):(ea=""+ ++V,z.set(da,ea)):ea="p_"+da;var Z=aa.data_[ea];if(Z&&$jscomp.owns(aa.data_,ea))for(aa=0;aa<Z.length;aa++){var ka=Z[aa];if(da!==da&&ka.key!==ka.key||da===ka.key)return{id:ea,list:Z,index:aa,entry:ka}}return{id:ea,list:Z,index:-1,entry:void 0}},ja=function(aa,da){var ea=aa.head_;return $jscomp.iteratorPrototype(function(){if(ea){for(;ea.head!=aa.head_;)ea=ea.previous;for(;ea.next!=ea.head;)return ea=ea.next,{done:!1,
value:da(ea)};ea=null}return{done:!0,value:void 0}})},N=function(){var aa={};return aa.previous=aa.next=aa.head=aa},V=0;return F},"es6","es3");
...
var F=$jscomp.global.setTimeout;p.prototype.asyncExecuteFunction=function(N){F(N,0)};p.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var N=this.batch_;this.batch_=[];for(var V=0;V<N.length;++V){var aa=N[V];N[V]=null;try{aa()}catch(da){this.asyncThrow_(da)}}}this.batch_=null};p.prototype.asyncThrow_=function(N){this.asyncExecuteFunction(function(){throw N;})};var I=function(N){this.state_=0;this.result_=void 0;this.onSettledCallbacks_=[];this.isRejectionHandled_=!1;var V=
this.createResolveAndReject_();try{N(V.resolve,V.reject)}catch(aa){V.reject(aa)}};I.prototype.createResolveAndReject_=function(){function N(da){return function(ea){aa||(aa=!0,da.call(V,ea))}}var V=this,aa=!1;return{resolve:N(this.resolveTo_),reject:N(this.reject_)}};I.prototype.resolveTo_=function(N){if(N===this)this.reject_(new TypeError("A Promise cannot resolve to itself"));else if(N instanceof I)this.settleSameAsPromise_(N);else{a:switch(typeof N){case "object":var V=null!=N;break a;case "function":V=
...
var ja=new p;I.prototype.settleSameAsPromise_=function(N){var V=this.createResolveAndReject_();N.callWhenSettled_(V.resolve,V.reject)};I.prototype.settleSameAsThenable_=function(N,V){var aa=this.createResolveAndReject_();try{N.call(V,aa.resolve,aa.reject)}catch(da){aa.reject(da)}};I.prototype.then=function(N,V){function aa(ka,za){return"function"==typeof ka?function(xa){try{da(ka(xa))}catch(ua){ea(ua)}}:za}var da,ea,Z=new I(function(ka,za){da=ka;ea=za});this.callWhenSettled_(aa(N,da),aa(V,ea));return Z};
I.prototype.catch=function(N){return this.then(void 0,N)};I.prototype.callWhenSettled_=function(N,V){function aa(){switch(da.state_){case 1:N(da.result_);break;case 2:V(da.result_);break;default:throw Error("Unexpected state: "+da.state_);}}var da=this;null==this.onSettledCallbacks_?ja.asyncExecute(aa):this.onSettledCallbacks_.push(aa);this.isRejectionHandled_=!0};I.resolve=z;I.reject=function(N){return new I(function(V,aa){aa(N)})};I.race=function(N){return new I(function(V,aa){for(var da=$jscomp.makeIterator(N),
ea=da.next();!ea.done;ea=da.next())z(ea.value).callWhenSettled_(V,aa)})};I.all=function(N){var V=$jscomp.makeIterator(N),aa=V.next();return aa.done?z([]):new I(function(da,ea){function Z(xa){return function(ua){ka[xa]=ua;za--;0==za&&da(ka)}}var ka=[],za=0;do ka.push(void 0),za++,z(aa.value).callWhenSettled_(Z(ka.length-1),ea),aa=V.next();while(!aa.done)})};return I},"es6","es3");
...
ka,za){e.productButton.setText("("+(ka+1)+"/"+za+") "+e.WMJSLayer.title)},function(Z){e.productButton.setText(e.WMJSLayer.path+e.WMJSLayer.title)});e.setStyleText(e.WMJSLayer.getStyleObject(e.WMJSLayer.currentStyle));e.dimensionPanels=[];e.dimensionPanelContainer.removeAll();var aa="";for(N=0;N<e.WMJSLayer.dimensions.length;N++){for(var da=0;da<F.length;da++)F[da].name==e.WMJSLayer.dimensions[N].name&&(e.WMJSLayer.dimensions[N].currentValue=F[da].currentValue);da=Ext.create("WMJSExtDimensionPanel",
{dimension:e.WMJSLayer.dimensions[N],layer:e.WMJSLayer,dimensionPanels:e.dimensionPanels});e.dimensionPanels.push(da);e.dimensionPanelContainer.add(da);0<aa.length&&(aa+=", ");aa+=e.WMJSLayer.dimensions[N].name}e.afterlayerready&&(z&&z(e),e.afterlayerready(e));e.setLoading(!1);for(N=0;N<e.WMJSLayer.dimensions.length;N++)aa=e.WMJSLayer.parentMaps[0].getDimension(e.WMJSLayer.dimensions[N].name),isDefined(aa)&&e.WMJSLayer.dimensions[N].setClosestValue(aa.currentValue);for(N=0;N<e.WMJSLayer.dimensions.length;N++)e.dimensionPanels[N].setValue(e.WMJSLayer.dimensions[N].currentValue);
...
F=function(I,ja){var N=function(da){da=aa.getComponent("AddCustomWMSPanel").getComponent("customwmsurltextarea").getValue();da=WMJScheckURL(da);if(5>da.length)alert("Invalid url given.");else{try{Ext.state.Manager.set("formFieldValues",da)}catch(ea){console.log(ea)}e.layerPanel=I({service:da,ready:function(ea,Z){isDefined(ea)?ea.WMJSLayer.hasError?(new WMJSTimer).init(10,function(){Ext.Msg.alert(I18n.unable_to_connect_server.text,I18n.unable_to_connect_server.text+"<br/><br/>"+layerPanel.WMJSLayer.lastError)}):
aa.hide():aa.hide()}})}},V=Ext.create("Ext.form.field.Text",{itemId:"customwmsurltextarea",emptyText:I18n.enter_wms_version_url.text,height:25,margin:10,stateful:!0,listeners:{specialkey:function(da,ea){ea.getKey()==ea.ENTER&&N(ja)},afterrender:function(da){if(da=Ext.state.Manager.get("formFieldValues"))console.log(da),V.setValue(da)}}});var aa=Ext.create("Ext.window.Window",{title:I18n.add_custom_service.text,width:620,height:200,autoDestroy:!0,autoScroll:!1,modal:!0,layout:"border",items:[{xtype:"panel",
...
e.mappanel.webMapJS.getLayers();p.removeAll();for(var aa=0;aa<V.length;aa++)p.add({name:V[aa].service+V[aa].name,title:V[aa].title,wmjslayer:V[aa]})},I=function(V){if(isDefined(V)){e.selectedLayer=V;var aa=e.getComponent("dimensionpanel").getComponent("dimensioncombobox");aa.disable();z.removeAll();for(var da=0;da<V.dimensions.length;da++)z.add({name:V.dimensions[da].name,wmjsdimension:V.dimensions[da]});0<z.getCount()&&(aa.setValue(z.getAt(0).get("name")),ja(z.getAt(0).get("wmjsdimension")),aa.enable())}},
...
var z=location.href.split("?")[0];z=z.split("#")[0];-1!=z.indexOf("/index.html")&&(z=z.substring(0,z.indexOf("/index.html")),z+="/");-1!=z.indexOf("/index.jsp")&&(z=z.substring(0,z.indexOf("/index.jsp")),z+="/");-1!=z.indexOf("/index.php")&&(z=z.substring(0,z.indexOf("/index.php")),z+="/");var F=e.mappanel.webMapJS,I=0,ja=F.getActiveLayer(),N=F.getLayers();isDefined(void 0)&&(N=[],N.push(void 0));var V=F.getProjection();var aa="?srs="+URLEncode(V.srs);aa+="&bbox="+URLEncode(V.bbox);if(0<N.length){var da=
[],ea=[];for(V=0;V<N.length;V++)if(N[V].name&&N[V].title!=WMJSEmptyLayerName){var Z=da.indexOf(N[V].service);-1==Z&&(da.push(N[V].service),Z=da.length-1);ea.push(N[V].name.replace(/,/g,".")+"$"+N[V].format+"$"+N[V].enabled+"$"+N[V].getStyle()+"$"+N[V].opacity+"$"+Z);ja==N[V]&&(I=V)}ja=URLEncode(da[0]);for(V=1;V<da.length;V++)ja+=","+URLEncode(da[V]);aa+="&service="+ja;ja=URLEncode(ea[0]);for(V=1;V<ea.length;V++)ja+=","+URLEncode(ea[V]);aa=aa+("&layer="+ja)+("&selected="+I);I=F.getDimensionList();
...
ja=Ext.create("Ext.data.Store",{fields:["title","srs","bbox"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),N=Ext.create("Ext.grid.Panel",{border:!1,store:ja,columns:[{text:"Title",dataIndex:"title",flex:1},{text:"ESPG Code",dataIndex:"srs"}],listeners:{select:{fn:function(ua,Ba){ua=Ba.get("bbox");z=Ba.get("srs");I=ua;da.getComponent("column2").getComponent("areaPanel").getComponent("bboxtop").setValue(ua.split(",")[3]);da.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxwest").setValue(ua.split(",")[0]);
da.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxeast").setValue(ua.split(",")[2]);da.getComponent("column2").getComponent("areaPanel").getComponent("bboxbottom").setValue(ua.split(",")[1]);Ba=Math.abs(I.split(",")[2]-I.split(",")[0]);ua=Math.abs(I.split(",")[3]-I.split(",")[1]);var Na=e.coverages[0];da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").setValue(Ba/Na.width);da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").setValue(ua/
Na.height);xa()}}}}),V=Ext.create("Ext.data.Store",{fields:["title","format"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),aa=Ext.create("Ext.grid.Panel",{border:!1,store:V,columns:[{text:I18n.format.text,dataIndex:"format"},{text:I18n.title.text,dataIndex:"title",flex:1}],listeners:{select:{fn:function(ua,Ba){F=Ba.get("format");xa()}}}});e.onReady=function(){N.setLoading(!1);for(var ua=this.coverages[0],Ba=0;Ba<ua.supportedProjections.length;Ba++){var Na=ua.supportedProjections[Ba].srs;
try{Na=epsgDescriptionLookup[ua.supportedProjections[Ba].srs]}catch(Sa){}isDefined(Na)||(Na=ua.supportedProjections[Ba].srs);ja.add({title:Na,srs:ua.supportedProjections[Ba].srs,bbox:ua.supportedProjections[Ba].bbox})}Ba=ja.find("srs",ua.nativeCRS);-1==Ba&&(Ba=ja.find("srs","EPSG:4326"));-1==Ba&&(Ba=0);N.getView().select(Ba);ja.add({title:"Viewer window projection and area",srs:this.srs,bbox:this.bbox});da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").setValue(ua.width);
da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").setValue(ua.height);Na=da.getComponent("column3").getComponent("dimensionPanel");for(Ba=0;Ba<ua.dimensions.length;Ba++)Na.add({xtype:"textfield",fieldLabel:ua.dimensions[Ba].name,value:ua.dimensions[Ba].currentValue,labelWidth:40,padding:"30",width:200,itemId:"dimtextfield_"+ua.dimensions[Ba].name,listeners:{change:{fn:function(){xa()}}}});for(Ba=0;Ba<ua.formats.length;Ba++){Na=ua.formats[Ba];
var Ga=ua.formats[Ba].toUpperCase();try{Na=formatDescriptionLookup[Ga]}catch(Sa){}isDefined(Na)||(Na=ua.formats[Ba]);V.add({title:Na,format:ua.formats[Ba]});"AAIGRID"==Ga&&aa.getView().select(Ba)}xa();za.update('<table style="margin:5px;"><tr><td><b>Coverage:</b></td><td>'+ua.name+"</td></tr><tr><td><b>Title:</b></td><td>"+ua.title+"</td></tr><tr><td><b>Description:</b></td><td>"+ua["abstract"]+"</td></tr></table>")};Ext.create("Ext.panel.Panel",{region:"west",border:!0,width:100});var da=Ext.create("Ext.panel.Panel",
...
itemId:"bboxtop",labelWidth:20,padding:"30 5 5 130",width:180,listeners:{change:{fn:function(){xa()}}}},{xtype:"panel",itemId:"bbox",border:!1,layout:"hbox",items:[{xtype:"textfield",fieldLabel:I18n.west.text,itemId:"bboxwest",labelWidth:30,padding:"15 0 0 15",width:180,listeners:{change:{fn:function(){xa()}}}},{xtype:"textfield",fieldLabel:I18n.east.text,itemId:"bboxeast",labelWidth:30,padding:"15 0 0 15",width:180,listeners:{change:{fn:function(){xa()}}}}]},{xtype:"textfield",fieldLabel:I18n.south.text,
itemId:"bboxbottom",labelWidth:40,padding:"15 5 5 110",width:200,listeners:{change:{fn:function(){xa()}}}}]},{xtype:"panel",region:"south",height:"50%",title:"Grid properties",split:!0,autoScroll:!0,itemId:"gridproperties",items:{xtype:"fieldcontainer",itemId:"field",items:[{xtype:"radiofield",boxLabel:"Cell size",name:"resolution",checked:!0,itemId:"radioselectcellsize",padding:"15 15 15 15",handler:function(ua,Ba){!0===Ba&&(da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").disable(),
da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").disable(),da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").enable(),da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").enable());xa()}},{xtype:"textfield",fieldLabel:"X resolution",padding:"0 0 0 40",itemId:"xresolution",width:170,listeners:{change:{fn:function(){xa()}}}},{xtype:"textfield",
fieldLabel:"Y resolution",padding:"0 0 0 40",itemId:"yresolution",width:170,listeners:{change:{fn:function(){xa()}}}},{xtype:"radiofield",boxLabel:"Raster size",name:"resolution",padding:15,handler:function(ua,Ba){!0===Ba&&(da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").enable(),da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").enable(),da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").disable(),
da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").disable())}},{xtype:"textfield",fieldLabel:"Raster Width",padding:"0 0 0 40",disabled:!0,itemId:"rasterwidth",width:170,listeners:{change:{fn:function(){xa()}}}},{xtype:"textfield",fieldLabel:"Raster Height",padding:"0 0 0 40",disabled:!0,itemId:"rasterheight",width:170,listeners:{change:{fn:function(){xa()}}}}]}}]},{itemId:"column3",xtype:"panel",layout:"border",border:!1,split:!0,flex:1,items:[{xtype:"panel",
region:"center",height:"50%",itemId:"dimensionPanel",title:I18n.dimensions.text,autoScroll:!0},{xtype:"panel",split:!0,autoScroll:!0,region:"south",height:"50%",title:I18n.formats.text,items:[aa]}]}]}),ea=Ext.create("Ext.panel.Panel",{layout:"border",region:"center",border:!0,width:300,items:[da]}),Z=Ext.create("Ext.panel.Panel",{border:!1,padding:20}),ka=Ext.create("Ext.panel.Panel",{title:"GetCoverage request link",region:"south",border:!0,height:100,layout:"fit",items:[Z]}),za=Ext.create("Ext.panel.Panel",
{region:"north",border:!1,height:80,frame:!1});Ext.apply(this,{layout:"border",padding:0,frame:!1,border:!0,items:[ea,za,ka]});N.setLoading(!0);var xa=function(){var ua=e.coverages[0].service;ua=WMJScheckURL(ua);var Ba=e.coverages[0].name,Na=da.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxwest").getValue()+","+da.getComponent("column2").getComponent("areaPanel").getComponent("bboxbottom").getValue()+","+da.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxeast").getValue()+
","+da.getComponent("column2").getComponent("areaPanel").getComponent("bboxtop").getValue();-1==ua.indexOf("?")?ua+="?":"&"!=ua.charAt(ua.length-1)&&(ua+="&");ua=ua+"SERVICE=WCS&REQUEST=GetCoverage&COVERAGE="+Ba+"&CRS="+URLEncode(z)+"&FORMAT="+F+"&BBOX="+Na;1==da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("radioselectcellsize").getValue()?(ua+="&RESX="+da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("xresolution").getValue(),
ua+="&RESY="+da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("yresolution").getValue()):(ua+="&WIDTH="+da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").getValue(),ua+="&HEIGHT="+da.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterheight").getValue());for(Ba=0;Ba<e.coverages[0].dimensions.length;Ba++)try{var Ga=da.getComponent("column3").getComponent("dimensionPanel").getComponent("dimtextfield_"+
e.coverages[0].dimensions[Ba].name).getValue(),Sa=e.coverages[0].dimensions[Ba].name;Sa=Sa.toUpperCase();"ELEVATION"!=Sa&&"TIME"!=Sa&&(Sa="DIM_"+Sa);ua+="&"+Sa+"="+Ga}catch(db){}Z.update('<a target="_blank" href="'+ua+'">'+ua+"</a>");return z};WCJSRequest(e.coverages[0].service,e.coverages[0].name,function(ua){e.coverages[0]=parseDescribeCoverage(ua,p);e.onReady()},function(ua){alert("failed:\n "+ua)});webmapjsext.WMJSExt.WCSPanel.superclass.initComponent.apply(this,arguments)}});Ext.define("webmapjsext.WMJSExt.WindowFader",{extend:"Ext.window.Window",alias:"WMJSExtWindowFader",requires:[],initComponent:function(){var e=this;e.timer=new WMJSTimer;e.fadeOut=function(){100!=e.opacity&&(0<e.opacity?(e.timer.init(50,e.fadeOut),e.opacity-=(100-e.opacity)/10+.5,e.getEl().dom.style.opacity=e.opacity/100):e.close())};Ext.apply(this,{listeners:{render:{fn:function(){e.el.on("mouseenter",function(){e.getEl().dom.style.opacity="1";e.opacity=100});e.el.on("mouseleave",function(){e.opacity=
...
(V=p.autoChooseLayer);isDefined(N)||(N=!0);var aa=Ext.getCmp("layerlistpanel");aa.removeLayer=removeLayer;z=Ext.create("webmapjsext.WMJSExt.LayerPanel",{parentPanelList:aa,title:F,service:z,name:F,style:I,opacity:ja,enabled:N,autoChooseLayer:V,parentWebMapJS:e,afterlayerready:function(da){1!=da.layerAddedToWebMapJS&&(da.WMJSLayer.enabled=this.enabled,da.layerAddedToWebMapJS=!0);p.ready?(p.ready(da,e),p.ready=void 0):(1==p.zoomtolayer&&(p.zoomtolayer=!1,e.setProjection(da.WMJSLayer.getProjection("EPSG:4326"))),
...
resize:{fn:function(){p.applicationSettings.app&&p.applicationSettings.app.resize(p.width,mainWebmapJS.webMapJS.getHeight())}}},setApplication:function(Z){p.applicationSettings=Z}});e=Ext.create("Ext.panel.Panel",{region:"center",layout:"border",split:!0,frame:!1,border:!1,margin:0,items:[mainWebmapJS,p]});var z=function(Z){console.log(Z.slot);var ka=createNewLayerPanel(mainWebmapJS.webMapJS,{service:Z.service,name:Z.layer,style:Z.style,opacity:Z.opacity,ready:function(za,xa){var ua=Z.srs,Ba=Z.bbox,
Na=Z.baselayername,Ga=Z.baselayerservice;ua&&!Ba?xa.setProjection(za.getProjection(ua)):ua&&Ba&&xa.setProjection({srs:ua,bbox:Ba});Na&&Ga?(mainWebmapJS.baseLayer.setService(Ga),mainWebmapJS.baseLayer.name=Na,mainWebmapJS.baseLayer.parseLayer(function(){xa.draw("dataPanelClicked::parseLayer")},void 0,"WMJSExtMain::dataPanelClicked")):xa.draw("dataPanelClicked");isDefined(ka)&&isDefined(Z.ready)&&(Z.ready(ka,xa),1==ka.WMJSLayer.hasError&&ka.close())}});return ka},F,I=new Console;Ext.create("Ext.panel.Panel",
...
handler:function(){var Z=getSelectedLayer();isDefined(Z)&&Z.duplicateLayer()}},{xtype:"button",tooltip:I18n.remove_this_layer.tooltip,iconCls:"button_layerlist_layerdelete",handler:function(Z,ka){removeLayer()}},{xtype:"button",tooltip:I18n.move_layer_up.tooltip,iconCls:"button_layerlist_layerup",handler:function(Z,ka){Z=getSelectedLayer();isDefined(Z)&&Z.moveUp()}},{xtype:"button",tooltip:I18n.move_layer_down.tooltip,iconCls:"button_layerlist_layerdown",handler:function(Z,ka){Z=getSelectedLayer();
...
folderChooser[this.ind].dataChooserConfigurationFolder;Ext.create("webmapjsext.WMJSExt.FolderPanel",{dataPanelClicked:z,webMapJS:mainWebmapJS.webMapJS}).show()}}),N.width+=30);N.tbar.push({iconCls:"button_settings32",tooltip:I18n.settings_and_options.tooltip,scale:"large",menu:{xtype:"menu",items:ja}});var da=Ext.create("Ext.Viewport",{layout:"border",items:[N,e],renderTo:Ext.getBody(),listeners:{resize:{fn:function(){try{var Z=viewportwestpanelwindow.y+viewportwestpanelwindow.height;Z>da.height&&
(Z=da.height-70,70>Z&&(Z=70));viewportwestpanelwindow.setSize(viewportwestpanelwindow.width,Z)}catch(ka){}}}}}),ea=function(Z){var ka=!0,za=!1;isDefined(Z.collapse)&&"1"==Z.collapse&&Ext.getCmp("viewportwestpanel").collapse();isDefined(Z.zoomtolayer)&&"1"==Z.zoomtolayer&&(ka=!0);isDefined(Z.srs)&&isDefined(Z.bbox)&&mainWebmapJS.webMapJS.setProjection({srs:Z.srs,bbox:Z.bbox});if(isDefined(Z.service)){clearLayers(mainWebmapJS.webMapJS);var xa=URLDecode(Z.service).split(","),ua=[""];isDefined(Z.layer)?
ua=URLDecode(Z.layer).split(","):1==ka&&(za=!0);isDefined(Z.selected);for(var Ba=ua.length,Na=0;Na<ua.length;Na++)try{var Ga=ua[ua.length-1-Na].split("$"),Sa=Ga+"",db=!0,ab="",ib=1,lb=xa[0]+"";6==Ga.length&&(Sa=Ga[0],db=Ga[2],ab=Ga[3],ib=Ga[4],isDefined(db)&&("true"===db&&(db=!0),"false"===db&&(db=!1)),lb=xa[Ga[5]]);createNewLayerPanel(mainWebmapJS.webMapJS,{service:lb,name:Sa,style:ab,enabled:db,opacity:ib,ready:function(tb,Gb){Ba--;if(0==Ba){if(isDefined(Z.dims))for(var Wb=Z.dims.split(","),Ab=
0;Ab<Wb.length;Ab++){var nc=Wb[Ab].split("$");2==nc.length&&mainWebmapJS.webMapJS.setDimension(nc[0],nc[1])}1==ka&&tb.WMJSLayer.zoomToLayer();Gb.draw("index.html::numlayers=0")}},autoChooseLayer:za})}catch(tb){error("Unable to parse layer nr "+Na)}if(isDefined(Z.baselayers)){xa=Z.baselayers.split("$");za=[];for(Na=ua=0;Na<xa.length;Na++){Ga=!1;for(Sa=0;Sa<mapTypeConfiguration.length;Sa++)if(mapTypeConfiguration[Sa].baselayer.name==xa[Na]){mapTypeConfiguration[Sa].baselayer.enabled=!0;za.push(mapTypeConfiguration[Sa].baselayer);
Ga=!0;ua++;break}if(!Ga)for(Sa=0;Sa<baseLayerConfiguration.length;Sa++)if(baseLayerConfiguration[Sa].name==xa[Na]){baseLayerConfiguration[Sa].enabled=!0;za.push(baseLayerConfiguration[Sa]);Ga=!0;ua++;break}Ga||error("Warning: unable to find baselayer "+xa[Na])}for(Na=0;Na<baseLayerConfiguration.length;Na++)0==baseLayerConfiguration[Na].enabled?za.push(baseLayerConfiguration[Na]):0==ua&&za.push(baseLayerConfiguration[Na]);baseLayers=[];for(Na=0;Na<za.length;Na++)xa=new WMJSLayer(za[Na]),0==Na&&(mainWebmapJS.baseLayer=
xa),baseLayers.push(xa);0<baseLayers.length&&mainWebmapJS.webMapJS.setBaseLayers(baseLayers)}}Z&&Z.autowms&&(autowmsURL=Z.autowms+"",-1===autowmsURL.indexOf("?")&&(autowmsURL+="?"),window.setTimeout(function(){p.setApplication(getFeatureInfoApplications.filter(function(tb){return"AutoWMS"===tb.name})[0]);p.hide();p.show()},100));Z&&Z.wms&&(console.log("wms found",Z.wms),createNewLayerPanel(mainWebmapJS.webMapJS,{service:Z.wms}))};0==window.location.hash.length&&ea(getUrlVars());checkIfHashTagChanged(function(Z,
ka){if(0<=Z.indexOf("addlayer('")){if(ka=Z.substring(Z.indexOf("addlayer('")+10,Z.indexOf("',")),Z=Z.substring(Z.indexOf(",'")+2,Z.indexOf("')")),ka&&Z){for(var za=!1,xa=mainWebmapJS.webMapJS.getLayers(),ua=0;ua<xa.length;ua++)if(xa[ua].service==ka&&xa[ua].name==Z){za=!0;break}0==za&&(isDefined(hashLocationNotfiyAddLayer),firstTimeOpening=!0,createNewLayerPanel(mainWebmapJS.webMapJS,{service:ka,name:Z,zoomtolayer:!1,notifyadded:!0}))}}else 0<=Z.indexOf("positionmappinbylatlon(")?(debug(Z),ka=Z.substring(23,
Z.indexOf(")")),debug(ka),ka=ka.split(","),debug(ka[0]+" "+ka[1]),mainWebmapJS.webMapJS.positionMapPinByLatLon({x:parseFloat(ka[0]),y:parseFloat(ka[1])})):0<=Z.indexOf("refreshlayers")?updateLayers():ea(ka)});getFeatureInfoApplications.open&&p.show()});var gfiapp_d3c3=function(e,p){var z=function(ea,Z){$("#"+Z).empty();$("#"+Z).append("<div style='height=240px;border=2px solid blue;' class='chart'>a</div>");$("#"+Z).append("<div style='height=40px;border=2px solid red;' class='controls gfiapp_d3c3_export_to_csv_button'>b</div>");var ka=$("#"+Z).find(".chart");Z=$("#"+Z).find(".controls");ka.html("graph");Z.button({label:"Export to CSV"}).click(function(){console.log("Export to CSV");for(var za="",xa=ea.datatoplot,ua=0;ua<xa[0].length;ua++){for(var Ba=
0;Ba<xa.length;Ba++)0<Ba&&(za+=";"),za+=JSON.stringify(xa[Ba][ua]);za+="\n\r"}xa=document.createElement("a");xa.setAttribute("download","export.csv");xa.setAttribute("href",encodeURI("data:text/csv;charset=utf-8,"+za));console.log("Clicking link");document.body.appendChild(xa);xa.click();xa.remove()});c3.generate({bindto:ka.get(0),data:{x:"x",x_format:"%Y%m%d",columns:ea.datatoplot,types:{x:"area"}},axis:{x:{type:"timeseries",tick:{format:ea.timeFormat}},y:{label:ea.ylabel}},zoom:{enabled:!0},subchart:{show:!1}})},
F=function(ea,Z){return ea>Z?1:ea<Z?-1:0},I=function(ea,Z){var ka;for(ka=0;ka<Z.length;ka++)try{if(Z[ka].getTime()===ea.getTime())return ka}catch(za){}return-1},ja=function(ea,Z){var ka=1;"string"!=typeof ea[0].dims&&(ka=ea[0].dims.length);for(var za=[],xa=function(Ga,Sa,db){var ab=["x"];Ga=[Sa.name+" "+Ga];for(var ib in db){Sa=d3.time.format("%Y-%m-%dT%H:%M:%SZ").parse(ib);var lb=parseFloat(db[ib]);ab.push(Sa);Ga.push(lb)}za.push({date:ab,value:Ga})},ua=function(Ga,Sa,db,ab){if(1==ka)xa("",Sa,db);
else if(Ga+2<ka)for(d in db)ua(Ga+1,Sa,db[d],ab+"["+d+"]");else for(d in db)xa("["+d+"]",Sa,db[d])},Ba=0;Ba<ea.length;Ba++)ua(0,ea[Ba],ea[Ba].data,"");Ba=function(Ga){for(var Sa=[],db=Ga.length,ab=0;ab<db;ab++)for(var ib=Ga[ab].date,lb=1;lb<ib.length;lb++){var tb=ib[lb],Gb=I(tb,Sa);-1==Gb&&Sa.push(tb)}Sa.sort(F);Sa.unshift("x");ib=[];for(lb=0;lb<db;lb++)ib.push([]);for(ab=0;ab<db;ab++)for(ib[ab].push(Ga[ab].value[0]),lb=1;lb<Sa.length;lb++)Gb=I(Sa[lb],Ga[ab].date),Gb==lb?(tb=Ga[ab].value[Gb],"nodata"==
tb&&(tb=NaN),ib[ab].push(parseFloat(tb))):ib[ab].push(NaN);Ga=[];Ga.push(Sa);for(ab=0;ab<db;ab++)Ga.push(ib[ab]);return Ga}(za);var Na=ea[0].name;ea[0].units&&(Na+=" in "+ea[0].units);z({datatoplot:Ba,ylabel:Na,timeFormat:"%Y-%m-%d %H:%M"},Z)},N=function(ea,Z){console.log(ea);ea.includes("time=")&&(i=ea.indexOf("time="),mURL0=ea.slice(0,i+5),mURLF=ea.slice(i+5,ea.length),ea=mURL0+"/"+mURLF);$.ajax({type:"GET",url:ea+"&JSONP=?",dataType:"jsonp",cache:!1,success:function(ka){try{ja(ka,Z)}catch(za){$("#"+
Z).html("Sorry! An error occurred while parsing JSON data: ["+za+"]")}},error:function(ka,za,xa){$("#"+Z).html("Sorry! An error occurred while receiving JSON data from the server: ["+xa+"]");console.log("Error "+xa)}})},V=!0,aa=[];aa.set=!1;var da=function(ea){if(0!=V){aa.x=ea.x;aa.y=ea.y;aa.set=!0;var Z=p.getLatLongFromPixelCoord({x:ea.x,y:ea.y});$("#chart").html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');var ka=p.getLayers();if(isDefined(ka)){Z="timeseries graph for location ["+Math.round(100*
Z.x)/100+","+Math.round(100*Z.y)/100+"]<br/>";$("#chart").empty();for(var za=0;za<ka.length;za++){var xa=p.getWMSGetFeatureInfoRequestURL(ka[za],ea.x,ea.y);xa=composeUrlObjectFromURL(xa);var ua=xa.location+"?";for(key in xa.kvp){var Ba=xa.kvp[key];"info_format"==key&&(Ba="application/json");"time"==key&&(Ba="1000-01-01T00:00:00Z/3000-01-01T00:00:00Z");"dim_member"==key&&(Ba="*");"dim_ensemble_member"==key&&(Ba="*");"dim_percentile"==key&&(Ba="*");ua+=key+"="+URLEncode(Ba)+"&"}$("#chart").append("<div class='chartstyle' id='chart"+
za+"'></div>");$("#chart"+za).html('<img src="./img/ajax-loader.gif" alt="Loading..."/>');N(ua,"chart"+za)}$("#info").html(Z)}else $("#info").html("No valid data received:<br/>"+data)}};p.addListener("mouseclicked",da,!0);this.enable=function(){e.html('<div id="info"></div><div id="chart" class="gfiapp_d3c3"></div>');$("#info").html("Click on the map to create a timeseries graph.");console.log("init");p.enableInlineGetFeatureInfo(!1);V=!0};this.disable=function(){V=!1;p.enableInlineGetFeatureInfo(!0);
aa.set=!1};this.resize=function(ea,Z){console.log("w="+ea);$("#chart").width(ea);aa.set&&da(aa)};this.enable()};try{WMJSExtApplications["Time series mode"]=gfiapp_d3c3}catch(e){};(function(e,p){"object"===typeof exports&&"undefined"!==typeof module?p(exports):"function"===typeof define&&define.amd?define(["exports"],p):(e="undefined"!==typeof globalThis?globalThis:e||self,p(e.s3=e.s3||{}))})(this,function(e){function p(a,b){return a<b?-1:a>b?1:a>=b?0:NaN}function z(a){function b(g,h,m,l){null==m&&(m=0);null==l&&(l=g.length);for(;m<l;){var n=m+l>>>1;0>f(g[n],h)?m=n+1:l=n}return m}var c=a,f=a;1===a.length&&(c=function(g,h){return a(g)-h},f=F(a));return{left:b,center:function(g,
...
$jscomp.makeIterator(a);for(f=h.next();!f.done;f=h.next())f=f.value,null!=(f=b(f,++g,a))&&(f=+f)>=f&&++c}return c}function V(a){return a.length|0}function aa(a){return!(0<a)}function da(a){return"object"!==typeof a||"length"in a?a:Array.from(a)}function ea(a){return function(b){return a.apply(null,$jscomp.arrayFromIterable(b))}}function Z(a,b){var c=0,f,g=0,h=0;if(void 0===b)for(a=$jscomp.makeIterator(a),f=a.next();!f.done;f=a.next())b=f.value,null!=b&&(b=+b)>=b&&(f=b-g,g+=f/++c,h+=f*(b-g));else{var m=
-1,l=$jscomp.makeIterator(a);for(f=l.next();!f.done;f=l.next()){var n=f.value;null!=(n=b(n,++m,a))&&(n=+n)>=n&&(f=n-g,g+=f/++c,h+=f*(n-g))}}if(1<c)return h/(c-1)}function ka(a,b){return(a=Z(a,b))?Math.sqrt(a):a}function za(a,b){var c,f;if(void 0===b){a=$jscomp.makeIterator(a);for(var g=a.next();!g.done;g=a.next())b=g.value,null!=b&&(void 0===c?b>=b&&(c=f=b):(c>b&&(c=b),f<b&&(f=b)))}else{var h=-1,m=$jscomp.makeIterator(a);for(g=m.next();!g.done;g=m.next())g=g.value,null!=(g=b(g,++h,a))&&(void 0===
c?g>=g&&(c=f=g):(c>g&&(c=g),f<g&&(f=g)))}return[c,f]}function xa(a,b){var c=a._intern;a=a._key;a=a(b);return c.has(a)?c.get(a):b}function ua(a,b){var c=a._intern;a=a._key;a=a(b);if(c.has(a))return c.get(a);c.set(a,b);return b}function Ba(a,b){var c=a._intern;a=a._key;a=a(b);c.has(a)&&(b=c.get(b),c.delete(a));return b}function Na(a){return null!==a&&"object"===typeof a?a.valueOf():a}function Ga(a){return a}function Sa(a,b){for(var c=[],f=1;f<arguments.length;++f)c[f-1]=arguments[f];return ib(a,Ga,
...
D.clean?new g(r,w,B):D}function g(r,w,B){this.that=r;this.args=w;this.state=r.__brush;this.active=0;this.clean=B}function h(r){function w(O){for(var X=$jscomp.makeIterator(O.changedTouches||[O]),oa=X.next();!oa.done;oa=X.next()){oa=oa.value;for(var Y=$jscomp.makeIterator(E),ta=Y.next();!ta.done;ta=Y.next())ta=ta.value,ta.identifier===oa.identifier&&(ta.cur=Zb(oa,P))}!k||A||G||1!==E.length||(X=E[0],uk(X.cur[0]-X[0])>uk(X.cur[1]-X[1])?G=!0:A=!0);X=$jscomp.makeIterator(E);for(oa=X.next();!oa.done;oa=
X.next())oa=oa.value,oa.cur&&(oa[0]=oa.cur[0],oa[1]=oa.cur[1]);Ua=!0;O.preventDefault();O.stopImmediatePropagation();B(O)}function B(O){var X=E[0],oa=X.point0;Da=X[0]-oa[0];Ka=X[1]-oa[1];switch(fa){case oh:case vk:R&&(Da=Jb(Ha-pa,Kb(L-U,Da)),H=pa+Da,T=U+Da);S&&(Ka=Jb(Ea-Pa,Kb(Aa-Ia,Ka)),K=Pa+Ka,Q=Ia+Ka);break;case wd:E[1]?(R&&(H=Jb(Ha,Kb(L,E[0][0])),T=Jb(Ha,Kb(L,E[1][0])),R=1),S&&(K=Jb(Ea,Kb(Aa,E[0][1])),Q=Jb(Ea,Kb(Aa,E[1][1])),S=1)):(0>R?(Da=Jb(Ha-pa,Kb(L-pa,Da)),H=pa+Da,T=U):0<R&&(Da=Jb(Ha-U,Kb(L-
U,Da)),H=pa,T=U+Da),0>S?(Ka=Jb(Ea-Pa,Kb(Aa-Pa,Ka)),K=Pa+Ka,Q=Ia):0<S&&(Ka=Jb(Ea-Ia,Kb(Aa-Ia,Ka)),K=Pa,Q=Ia+Ka));break;case xd:R&&(H=Jb(Ha,Kb(L,pa-Da*R)),T=Jb(Ha,Kb(L,U+Da*R))),S&&(K=Jb(Ea,Kb(Aa,Pa-Ka*S)),Q=Jb(Ea,Kb(Aa,Ia+Ka*S)))}T<H&&(R*=-1,X=pa,pa=U,U=X,X=H,H=T,T=X,W in wk&&ca.attr("cursor",Ac[W=wk[W]]));Q<K&&(S*=-1,X=Pa,Pa=Ia,Ia=X,X=K,K=Q,Q=X,W in xk&&ca.attr("cursor",Ac[W=xk[W]]));ma.selection&&(qa=ma.selection);A&&(H=qa[0][0],T=qa[1][0]);G&&(K=qa[0][1],Q=qa[1][1]);if(qa[0][0]!==H||qa[0][1]!==
K||qa[1][0]!==T||qa[1][1]!==Q)ma.selection=[[H,K],[T,Q]],c.call(P),na.brush(O,fa.name)}function D(O){O.stopImmediatePropagation();if(O.touches){if(O.touches.length)return;q&&clearTimeout(q);q=setTimeout(function(){q=null},500)}else Xe(O.view,Ua),ra.on("keydown.brush keyup.brush mousemove.brush mouseup.brush",null);ba.attr("pointer-events","all");ca.attr("cursor",Ac.overlay);ma.selection&&(qa=ma.selection);if(qa[0][0]===qa[1][0]||qa[0][1]===qa[1][1])ma.selection=null,c.call(P);na.end(O,fa.name)}function J(O){switch(O.keyCode){case 16:k=
R&&S;break;case 18:fa===wd&&(R&&(U=T-Da*R,pa=H+Da*R),S&&(Ia=Q-Ka*S,Pa=K+Ka*S),fa=xd,B());break;case 32:if(fa===wd||fa===xd)0>R?U=T-Da:0<R&&(pa=H-Da),0>S?Ia=Q-Ka:0<S&&(Pa=K-Ka),fa=oh,ca.attr("cursor",Ac.selection),B();break;default:return}O.preventDefault();O.stopImmediatePropagation()}function M(O){switch(O.keyCode){case 16:k&&(A=G=k=!1,B());break;case 18:fa===xd&&(0>R?U=T:0<R&&(pa=H),0>S?Ia=Q:0<S&&(Pa=K),fa=wd,B());break;case 32:fa===oh&&(O.altKey?(R&&(U=T-Da*R,pa=H+Da*R),S&&(Ia=Q-Ka*S,Pa=K+Ka*S),
fa=xd):(0>R?U=T:0<R&&(pa=H),0>S?Ia=Q:0<S&&(Pa=K),fa=wd),ca.attr("cursor",Ac[W]),B());break;default:return}O.preventDefault();O.stopImmediatePropagation()}if((!q||r.touches)&&C.apply(this,arguments)){var P=this,W=r.target.__data__.type,fa="selection"===(u&&r.metaKey?W="overlay":W)?vk:u&&r.altKey?xd:wd,R=a===lf?null:Cr[W],S=a===mf?null:Dr[W],ma=mh(P),ia=ma.extent,qa=ma.selection,Ha=ia[0][0],pa,Ea=ia[0][1],Pa,L=ia[1][0],U,Aa=ia[1][1],Ia,Da=0,Ka=0,Ua,k=R&&S&&u&&r.shiftKey,A,G,E=Array.from(r.touches||
[r],function(O){var X=O.identifier;O=Zb(O,P);O.point0=O.slice();O.identifier=X;return O});"overlay"===W?(qa&&(Ua=!0),ia=[E[0],E[1]||E[0]],ma.selection=qa=[[pa=a===lf?Ha:Kb(ia[0][0],ia[1][0]),Pa=a===mf?Ea:Kb(ia[0][1],ia[1][1])],[U=a===lf?L:Jb(ia[0][0],ia[1][0]),Ia=a===mf?Aa:Jb(ia[0][1],ia[1][1])]],1<E.length&&B()):(pa=qa[0][0],Pa=qa[0][1],U=qa[1][0],Ia=qa[1][1]);var H=pa;var K=Pa;var T=U;var Q=Ia;var ba=Ib(P).attr("pointer-events","none"),ca=ba.selectAll(".overlay").attr("cursor",Ac[W]);bd(P);var na=
...
xa(this,a))};Wc.prototype.has=function(a){return Map.prototype.has.call(this,xa(this,a))};Wc.prototype.set=function(a,b){return Map.prototype.set.call(this,ua(this,a),b)};Wc.prototype.delete=function(a){return Map.prototype.delete.call(this,Ba(this,a))};var Ne=function(a,b){b=void 0===b?Na:b;var c=$jscomp.construct(Set,[],this.constructor);Object.defineProperties(c,{_intern:{value:new Map},_key:{value:b}});if(null!=a)for(a=$jscomp.makeIterator(a),b=a.next();!b.done;b=a.next())c.add(b.value);return c};
$jscomp.inherits(Ne,Set);Ne.prototype.has=function(a){return Set.prototype.has.call(this,xa(this,a))};Ne.prototype.add=function(a){return Set.prototype.add.call(this,ua(this,a))};Ne.prototype.delete=function(a){return Set.prototype.delete.call(this,Ba(this,a))};var lp=Array.prototype.slice,Fg=Math.sqrt(50),Gg=Math.sqrt(10),Hg=Math.sqrt(2),Xu=oj(Math.random),Lg=Array.prototype.slice,wp={value:function(){}};Se.prototype=Xc.prototype={constructor:Se,on:function(a,b){var c=this._,f=vp(a+"",c),g,h=-1,
...
Ha=Math.log1p(-Ha);return function(){return 1+Math.floor(Math.log1p(-ma())/Ha)}}qa.source=ia;return qa}(Fb),bj=function qa(ia){function Ha(Ea,Pa){if(0>(Ea=+Ea))throw new RangeError("invalid k");if(0===Ea)return function(){return 0};Pa=null==Pa?1:+Pa;if(1===Ea)return function(){return-Math.log1p(-ia())*Pa};var L=(1>Ea?Ea+1:Ea)-1/3,U=1/(3*Math.sqrt(L)),Aa=1>Ea?function(){return Math.pow(ia(),1/Ea)}:function(){return 1};return function(){do{do var Ia=pa(),Da=1+U*Ia;while(0>=Da);Da*=Da*Da;var Ka=1-ia()}while(Ka>=
1-.0331*Ia*Ia*Ia*Ia&&Math.log(Ka)>=.5*Ia*Ia+L*(1-Da+Math.log(Da)));return L*Da*Aa()*Pa}}var pa=aj.source(ia)();Ha.source=qa;return Ha}(Fb),ho=function Ha(qa){function pa(Pa,L){var U=Ea(Pa),Aa=Ea(L);return function(){var Ia=U();return 0===Ia?0:Ia/(Ia+Aa())}}var Ea=bj.source(qa);pa.source=Ha;return pa}(Fb),io=function pa(Ha){function Ea(U,Aa){U=+U;return 1<=(Aa=+Aa)?function(){return U}:0>=Aa?function(){return 0}:function(){for(var Ia=0,Da=U,Ka=Aa;16<Da*Ka&&16<Da*(1-Ka);){var Ua=Math.floor((Da+1)*Ka),
k=L(Ua,Da-Ua+1)();k<=Ka?(Ia+=Ua,Da-=Ua,Ka=(Ka-k)/(1-k)):(Da=Ua-1,Ka/=k)}Ua=.5>Ka;Ka=Pa(Ua?Ka:1-Ka);k=Ka();for(var A=0;k<=Da;++A)k+=Ka();return Ia+(Ua?A:Da-A)}}var Pa=go.source(Ha),L=ho.source(Ha);Ea.source=pa;return Ea}(Fb),Rv=function Ea(pa){function Pa(L,U,Aa){if(0===(L=+L))var Ia=function(Da){return-Math.log(Da)};else L=1/L,Ia=function(Da){return Math.pow(Da,L)};U=null==U?0:+U;Aa=null==Aa?1:+Aa;return function(){return U+Aa*Ia(-Math.log1p(-pa()))}}Pa.source=Ea;return Pa}(Fb),Sv=function Pa(Ea){function L(U,
Aa){U=null==U?0:+U;Aa=null==Aa?1:+Aa;return function(){return U+Aa*Math.tan(Math.PI*Ea())}}L.source=Pa;return L}(Fb),Tv=function L(Pa){function U(Aa,Ia){Aa=null==Aa?0:+Aa;Ia=null==Ia?1:+Ia;return function(){var Da=Pa();return Aa+Ia*Math.log(Da/(1-Da))}}U.source=L;return U}(Fb),Uv=function U(L){function Aa(Ka){return function(){for(var Ua=0,k=Ka;16<k;){var A=Math.floor(.875*k),G=Ia(A)();if(G>k)return Ua+Da(A-1,k/G)();Ua+=A;k-=G}A=-Math.log1p(-L());for(G=0;A<=k;++G)A-=Math.log1p(-L());return Ua+G}}
var Ia=bj.source(L),Da=io.source(L);Aa.source=U;return Aa}(Fb),jo=1/4294967296,ti=Symbol("implicit"),wm=[0,1],Ai=new Date,Bi=new Date,Nd=zb(function(){},function(L,U){L.setTime(+L+U)},function(L,U){return U-L});Nd.every=function(L){L=Math.floor(L);return isFinite(L)&&0<L?1<L?zb(function(U){U.setTime(Math.floor(U/L)*L)},function(U,Aa){U.setTime(+U+Aa*L)},function(U,Aa){return(Aa-U)/L}):Nd:null};var ko=Nd.range,Ci=6048E5,Pm=2592E6,Di=31536E6,Gc=zb(function(L){L.setTime(L-L.getMilliseconds())},function(L,
...
this._x1=this._y0=this._y1=NaN;this._point=0},lineEnd:function(){(this._line||0!==this._line&&3===this._point)&&this._context.closePath();this._line=1-this._line},point:function(L,U){L=+L;U=+U;switch(this._point){case 0:this._point=1;break;case 1:this._point=2;break;case 2:this._point=3;var Aa=(this._x0+4*this._x1+L)/6,Ia=(this._y0+4*this._y1+U)/6;this._line?this._context.lineTo(Aa,Ia):this._context.moveTo(Aa,Ia);break;case 3:this._point=4;default:ig(this,L,U)}this._x0=this._x1;this._x1=L;this._y0=
...
2;default:this._x?this._context.bezierCurveTo(this._x0=(this._x0+L)/2,this._y0,this._x0,U,L,U):this._context.bezierCurveTo(this._x0,this._y0=(this._y0+U)/2,L,this._y0,L,U)}this._x0=L;this._y0=U};wn.prototype={lineStart:function(){this._x=[];this._y=[];this._basis.lineStart()},lineEnd:function(){var L=this._x,U=this._y,Aa=L.length-1;if(0<Aa)for(var Ia=L[0],Da=U[0],Ka=L[Aa]-Ia,Ua=U[Aa]-Da,k=-1,A;++k<=Aa;)A=k/Aa,this._basis.point(this._beta*L[k]+(1-this._beta)*(Ia+A*Ka),this._beta*U[k]+(1-this._beta)*
(Da+A*Ua));this._x=this._y=null;this._basis.lineEnd()},point:function(L,U){this._x.push(+L);this._y.push(+U)}};var qx=function Aa(U){function Ia(Da){return 1===U?new jg(Da):new wn(Da,U)}Ia.beta=function(Da){return Aa(+Da)};return Ia}(.85);Oi.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN;this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x2,this._y2);
...
this.x+","+this.y+") scale("+this.k+")"}};var ng=new Hc(1,0,0);Kn.prototype=Hc.prototype;e.Adder=ub;e.Delaunay=Lb;e.FormatSpecifier=tf;e.InternMap=Wc;e.InternSet=Ne;e.Voronoi=vb;e.active=function(k,A){var G=k.__transition,E,H;if(G)for(H in A=null==A?null:A+"",G)if(1<(E=G[H]).state&&E.name===A)return new sc([[k]],lv,A,+H);return null};e.arc=function(){function k(){var ca,na=+A.apply(this,arguments),ra=+G.apply(this,arguments),O=K.apply(this,arguments)-eg,X=T.apply(this,arguments)-eg,oa=cp(X-O),Y=X>
O;ba||(ba=ca=Oc());if(ra<na){var ta=ra;ra=na;na=ta}if(1E-12<ra)if(oa>Vc-1E-12)ba.moveTo(ra*pd(O),ra*zc(O)),ba.arc(0,0,ra,O,X,!Y),1E-12<na&&(ba.moveTo(na*pd(X),na*zc(X)),ba.arc(0,0,na,X,O,Y));else{var ha=O,va=X;ta=O;var wa=X,la=oa,Ca=oa,La=Q.apply(this,arguments)/2,Ra=1E-12<La&&(H?+H.apply(this,arguments):Td(na*na+ra*ra)),$a=cj(cp(ra-na)/2,+E.apply(this,arguments)),Wa=$a,mb=$a;if(1E-12<Ra){var ob=nn(Ra/na*zc(La));La=nn(Ra/ra*zc(La));1E-12<(la-=2*ob)?(ob*=Y?1:-1,ta+=ob,wa-=ob):(la=0,ta=wa=(O+X)/2);
1E-12<(Ca-=2*La)?(La*=Y?1:-1,ha+=La,va-=La):(Ca=0,ha=va=(O+X)/2)}O=ra*pd(ha);X=ra*zc(ha);ob=na*pd(wa);La=na*zc(wa);if(1E-12<$a){var sa=ra*pd(va),Oa=ra*zc(va),ya=na*pd(ta),Ja=na*zc(ta);if(oa=oa<Uc){var Fa=ya-O;oa=Ja-X;Ra=ob-sa;var Ya=La-Oa,Va=Ya*Fa-Ra*oa;1E-12>Va*Va?Fa=void 0:(Va=(Ra*(X-Oa)-Ya*(O-sa))/Va,Fa=[O+Va*Fa,X+Va*oa]);oa=Fa}oa&&(Wa=O-Fa[0],mb=X-Fa[1],oa=sa-Fa[0],Ra=Oa-Fa[1],Wa=(Wa*oa+mb*Ra)/(Td(Wa*Wa+mb*mb)*Td(oa*oa+Ra*Ra)),mb=1/zc((1<Wa?0:-1>Wa?Uc:Math.acos(Wa))/2),Fa=Td(Fa[0]*Fa[0]+Fa[1]*
Fa[1]),Wa=cj($a,(na-Fa)/(mb-1)),mb=cj($a,(ra-Fa)/(mb+1)))}1E-12<Ca?1E-12<mb?(ha=fg(ya,Ja,O,X,ra,mb,Y),va=fg(sa,Oa,ob,La,ra,mb,Y),ba.moveTo(ha.cx+ha.x01,ha.cy+ha.y01),mb<$a?ba.arc(ha.cx,ha.cy,mb,Nb(ha.y01,ha.x01),Nb(va.y01,va.x01),!Y):(ba.arc(ha.cx,ha.cy,mb,Nb(ha.y01,ha.x01),Nb(ha.y11,ha.x11),!Y),ba.arc(0,0,ra,Nb(ha.cy+ha.y11,ha.cx+ha.x11),Nb(va.cy+va.y11,va.cx+va.x11),!Y),ba.arc(va.cx,va.cy,mb,Nb(va.y11,va.x11),Nb(va.y01,va.x01),!Y))):(ba.moveTo(O,X),ba.arc(0,0,ra,ha,va,!Y)):ba.moveTo(O,X);1E-12<
na&&1E-12<la?1E-12<Wa?(ha=fg(ob,La,sa,Oa,na,-Wa,Y),va=fg(O,X,ya,Ja,na,-Wa,Y),ba.lineTo(ha.cx+ha.x01,ha.cy+ha.y01),Wa<$a?ba.arc(ha.cx,ha.cy,Wa,Nb(ha.y01,ha.x01),Nb(va.y01,va.x01),!Y):(ba.arc(ha.cx,ha.cy,Wa,Nb(ha.y01,ha.x01),Nb(ha.y11,ha.x11),!Y),ba.arc(0,0,na,Nb(ha.cy+ha.y11,ha.cx+ha.x11),Nb(va.cy+va.y11,va.cx+va.x11),Y),ba.arc(va.cx,va.cy,Wa,Nb(va.y11,va.x11),Nb(va.y01,va.x01),!Y))):ba.arc(0,0,na,wa,ta,Y):ba.lineTo(ob,La)}else ba.moveTo(0,0);ba.closePath();if(ca)return ba=null,ca+""||null}var A=yu,
G=zu,E=Xa(0),H=null,K=Au,T=Bu,Q=Cu,ba=null;k.centroid=function(){var ca=(+A.apply(this,arguments)+ +G.apply(this,arguments))/2,na=(+K.apply(this,arguments)+ +T.apply(this,arguments))/2-Uc/2;return[pd(na)*ca,zc(na)*ca]};k.innerRadius=function(ca){return arguments.length?(A="function"===typeof ca?ca:Xa(+ca),k):A};k.outerRadius=function(ca){return arguments.length?(G="function"===typeof ca?ca:Xa(+ca),k):G};k.cornerRadius=function(ca){return arguments.length?(E="function"===typeof ca?ca:Xa(+ca),k):E};
...
function(){return rh(!1,!0)};e.cluster=function(){function k(K){var T,Q=0;K.eachAfter(function(O){var X=O.children;if(X){var oa=X.reduce(Vs,0)/X.length;O.x=oa;O.y=1+X.reduce(Ws,0)}else O.x=T?Q+=A(O,T):0,O.y=0,T=O});var ba=Xs(K),ca=Ys(K),na=ba.x-A(ba,ca)/2,ra=ca.x+A(ca,ba)/2;return K.eachAfter(H?function(O){O.x=(O.x-K.x)*G;O.y=(K.y-O.y)*E}:function(O){O.x=(O.x-na)/(ra-na)*G;O.y=(1-(K.y?O.y/K.y:1))*E})}var A=Us,G=1,E=1,H=!1;k.separation=function(K){return arguments.length?(A=K,k):A};k.size=function(K){return arguments.length?
(H=!1,G=+K[0],E=+K[1],k):H?null:[G,E]};k.nodeSize=function(K){return arguments.length?(H=!0,G=+K[0],E=+K[1],k):H?[G,E]:null};return k};e.color=Lc;e.contourDensity=function(){function k(ha){var va=new Float32Array(oa*Y),wa=new Float32Array(oa*Y);ha.forEach(function(la,Ca,La){var Ra=+T(la,Ca,La)+X>>O,$a=+Q(la,Ca,La)+X>>O;la=+ba(la,Ca,La);0<=Ra&&Ra<oa&&0<=$a&&$a<Y&&(va[Ra+$a*oa]+=la)});th({width:oa,height:Y,data:va},{width:oa,height:Y,data:wa},ra>>O);uh({width:oa,height:Y,data:wa},{width:oa,height:Y,
data:va},ra>>O);th({width:oa,height:Y,data:va},{width:oa,height:Y,data:wa},ra>>O);uh({width:oa,height:Y,data:wa},{width:oa,height:Y,data:va},ra>>O);th({width:oa,height:Y,data:va},{width:oa,height:Y,data:wa},ra>>O);uh({width:oa,height:Y,data:wa},{width:oa,height:Y,data:va},ra>>O);ha=ta(va);Array.isArray(ha)||(wa=Pe(va),ha=nc(0,wa,ha),ha=oc(0,Math.floor(wa/ha)*ha,ha),ha.shift());return Dk().thresholds(ha).size([oa,Y])(va).map(A)}function A(ha){ha.value*=Math.pow(2,-2*O);ha.coordinates.forEach(G);return ha}
function G(ha){ha.forEach(E)}function E(ha){ha.forEach(H)}function H(ha){ha[0]=ha[0]*Math.pow(2,O)-X;ha[1]=ha[1]*Math.pow(2,O)-X}function K(){X=3*ra;oa=ca+2*X>>O;Y=na+2*X>>O;return k}var T=Or,Q=Pr,ba=Qr,ca=960,na=500,ra=20,O=2,X=3*ra,oa=ca+2*X>>O,Y=na+2*X>>O,ta=Pc(20);k.x=function(ha){return arguments.length?(T="function"===typeof ha?ha:Pc(+ha),k):T};k.y=function(ha){return arguments.length?(Q="function"===typeof ha?ha:Pc(+ha),k):Q};k.weight=function(ha){return arguments.length?(ba="function"===typeof ha?
ha:Pc(+ha),k):ba};k.size=function(ha){if(!arguments.length)return[ca,na];var va=+ha[0],wa=+ha[1];if(!(0<=va&&0<=wa))throw Error("invalid size");return ca=va,na=wa,K()};k.cellSize=function(ha){if(!arguments.length)return 1<<O;if(!(1<=(ha=+ha)))throw Error("invalid cell size");return O=Math.floor(Math.log(ha)/Math.LN2),K()};k.thresholds=function(ha){return arguments.length?(ta="function"===typeof ha?ha:Array.isArray(ha)?Pc(Ek.call(ha)):Pc(ha),k):ta};k.bandwidth=function(ha){if(!arguments.length)return Math.sqrt(ra*
(ra+1));if(!(0<=(ha=+ha)))throw Error("invalid bandwidth");return ra=Math.round((Math.sqrt(4*ha*ha+1)-1)/2),K()};return k};e.contours=Dk;e.count=N;e.create=function(k){return Ib(Te(k).call(document.documentElement))};e.creator=Te;e.cross=function(k){for(var A=[],G=0;G<arguments.length;++G)A[G-0]=arguments[G];var E=A;A="function"===typeof E[E.length-1]&&ea(E.pop());E=E.map(da);G=E.map(V);var H=E.length-1,K=Array(H+1).fill(0),T=[];if(0>H||G.some(aa))return T;for(;;){T.push(K.map(function(ba,ca){return E[ca][ba]}));
...
e.dispatch=Xc;e.drag=function(){function k(la){la.on("mousedown.drag",A).filter(ra).on("touchstart.drag",H).on("touchmove.drag",K).on("touchend.drag touchcancel.drag",T).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function A(la,Ca){!va&&ba.call(this,la,Ca)&&(Ca=Q(this,ca.call(this,la,Ca),la,Ca,"mouse"))&&(Ib(la.view).on("mousemove.drag",G,!0).on("mouseup.drag",E,!0),We(la.view),la.stopImmediatePropagation(),ha=!1,Y=la.clientX,ta=la.clientY,Ca("start",la))}function G(la){rd(la);
if(!ha){var Ca=la.clientX-Y,La=la.clientY-ta;ha=Ca*Ca+La*La>wa}O.mouse("drag",la)}function E(la){Ib(la.view).on("mousemove.drag mouseup.drag",null);Xe(la.view,ha);rd(la);O.mouse("end",la)}function H(la,Ca){if(ba.call(this,la,Ca)){var La=la.changedTouches,Ra=ca.call(this,la,Ca),$a=La.length,Wa,mb;for(Wa=0;Wa<$a;++Wa)if(mb=Q(this,Ra,la,Ca,La[Wa].identifier,La[Wa]))la.stopImmediatePropagation(),mb("start",la,La[Wa])}}function K(la){var Ca=la.changedTouches,La=Ca.length,Ra,$a;for(Ra=0;Ra<La;++Ra)if($a=
O[Ca[Ra].identifier])rd(la),$a("drag",la,Ca[Ra])}function T(la){var Ca=la.changedTouches,La=Ca.length,Ra,$a;va&&clearTimeout(va);va=setTimeout(function(){va=null},500);for(Ra=0;Ra<La;++Ra)if($a=O[Ca[Ra].identifier])la.stopImmediatePropagation(),$a("end",la,Ca[Ra])}function Q(la,Ca,La,Ra,$a,Wa){var mb=X.copy(),ob=Zb(Wa||La,Ca),sa;if(null!=(sa=na.call(la,new Ug("beforestart",{sourceEvent:La,target:k,identifier:$a,active:oa,x:ob[0],y:ob[1],dx:0,dy:0,dispatch:mb}),Ra))){var Oa=sa.x-ob[0]||0;var ya=sa.y-
ob[1]||0;return function gb(Fa,Ya,Va){var wb=ob;switch(Fa){case "start":O[$a]=gb;var sb=oa++;break;case "end":delete O[$a],--oa;case "drag":ob=Zb(Va||Ya,Ca),sb=oa}mb.call(Fa,la,new Ug(Fa,{sourceEvent:Ya,subject:sa,target:k,identifier:$a,active:sb,x:ob[0]+Oa,y:ob[1]+ya,dx:ob[0]-wb[0],dy:ob[1]-wb[1],dispatch:mb}),Ra)}}}var ba=uq,ca=vq,na=wq,ra=xq,O={},X=Xc("start","drag","end"),oa=0,Y,ta,ha,va,wa=0;k.filter=function(la){return arguments.length?(ba="function"===typeof la?la:og(!!la),k):ba};k.container=
function(la){return arguments.length?(ca="function"===typeof la?la:og(la),k):ca};k.subject=function(la){return arguments.length?(na="function"===typeof la?la:og(la),k):na};k.touchable=function(la){return arguments.length?(ra="function"===typeof la?la:og(!!la),k):ra};k.on=function(){var la=X.on.apply(X,arguments);return la===X?k:la};k.clickDistance=function(la){return arguments.length?(wa=(la=+la)*la,k):Math.sqrt(wa)};return k};e.dragDisable=We;e.dragEnable=Xe;e.dsv=function(k,A,G,E){3===arguments.length&&
...
G.y=function(K){return arguments.length?(A=+K,G):A};G.strength=function(K){return arguments.length?(H=+K,G):H};return G};e.forceCollide=function(k){function A(){function ca(wa,la,Ca,La,Ra){var $a=wa.data;wa=wa.r;var Wa=ta+wa;if($a)$a.index>X.index&&(la=oa-$a.x-$a.vx,Ca=Y-$a.y-$a.vy,La=la*la+Ca*Ca,La<Wa*Wa&&(0===la&&(la=1E-6*(T()-.5),La+=la*la),0===Ca&&(Ca=1E-6*(T()-.5),La+=Ca*Ca),La=(Wa-(La=Math.sqrt(La)))/La*Q,X.vx+=(la*=La)*(Wa=(wa*=wa)/(ha+wa)),X.vy+=(Ca*=La)*Wa,$a.vx-=la*(Wa=1-Wa),$a.vy-=Ca*Wa));
else return la>oa+Wa||La<oa-Wa||Ca>Y+Wa||Ra<Y-Wa}for(var na,ra=H.length,O,X,oa,Y,ta,ha,va=0;va<ba;++va)for(O=rf(H,ds,es).visitAfter(G),na=0;na<ra;++na)X=H[na],ta=K[X.index],ha=ta*ta,oa=X.x+X.vx,Y=X.y+X.vy,O.visit(ca)}function G(ca){if(ca.data)return ca.r=K[ca.data.index];for(var na=ca.r=0;4>na;++na)ca[na]&&ca[na].r>ca.r&&(ca.r=ca[na].r)}function E(){if(H){var ca,na=H.length;K=Array(na);for(ca=0;ca<na;++ca){var ra=H[ca];K[ra.index]=+k(ra,ca,H)}}}var H,K,T,Q=1,ba=1;"function"!==typeof k&&(k=xb(null==
k?1:+k));A.initialize=function(ca,na){H=ca;T=na;E()};A.iterations=function(ca){return arguments.length?(ba=+ca,A):ba};A.strength=function(ca){return arguments.length?(Q=+ca,A):Q};A.radius=function(ca){return arguments.length?(k="function"===typeof ca?ca:xb(+ca),E(),A):k};return A};e.forceLink=function(k){function A(Y){for(var ta=0,ha=k.length;ta<oa;++ta)for(var va=0,wa,la,Ca,La,Ra;va<ha;++va)wa=k[va],la=wa.source,wa=wa.target,Ca=wa.x+wa.vx-la.x-la.vx||1E-6*(X()-.5),La=wa.y+wa.vy-la.y-la.vy||1E-6*
(X()-.5),Ra=Math.sqrt(Ca*Ca+La*La),Ra=(Ra-ca[va])/Ra*Y*Q[va],Ca*=Ra,La*=Ra,wa.vx-=Ca*(Ra=O[va]),wa.vy-=La*Ra,la.vx+=Ca*(Ra=1-Ra),la.vy+=La*Ra}function G(){if(na){var Y=na.length,ta=k.length,ha=new Map(na.map(function(wa,la){return[K(wa,la,na),wa]}));var va=0;for(ra=Array(Y);va<ta;++va)Y=k[va],Y.index=va,"object"!==typeof Y.source&&(Y.source=Mk(ha,Y.source)),"object"!==typeof Y.target&&(Y.target=Mk(ha,Y.target)),ra[Y.source.index]=(ra[Y.source.index]||0)+1,ra[Y.target.index]=(ra[Y.target.index]||0)+
1;va=0;for(O=Array(ta);va<ta;++va)Y=k[va],O[va]=ra[Y.source.index]/(ra[Y.source.index]+ra[Y.target.index]);Q=Array(ta);E();ca=Array(ta);H()}}function E(){if(na)for(var Y=0,ta=k.length;Y<ta;++Y)Q[Y]=+T(k[Y],Y,k)}function H(){if(na)for(var Y=0,ta=k.length;Y<ta;++Y)ca[Y]=+ba(k[Y],Y,k)}var K=fs,T=function(Y){return 1/Math.min(ra[Y.source.index],ra[Y.target.index])},Q,ba=xb(30),ca,na,ra,O,X,oa=1;null==k&&(k=[]);A.initialize=function(Y,ta){na=Y;X=ta;G()};A.links=function(Y){return arguments.length?(k=Y,
...
oa;++X){var Y=H[X];ca[Y.index]=+ba(Y,X,H)}}}function G(X){var oa=0,Y,ta,ha=0,va,wa,la;if(X.length){for(va=wa=la=0;4>la;++la)(Y=X[la])&&(ta=Math.abs(Y.value))&&(oa+=Y.value,ha+=ta,va+=ta*Y.x,wa+=ta*Y.y);X.x=va/ha;X.y=wa/ha}else{Y=X;Y.x=Y.data.x;Y.y=Y.data.y;do oa+=ca[Y.data.index];while(Y=Y.next)}X.value=oa}function E(X,oa,Y,ta){if(!X.value)return!0;Y=X.x-K.x;var ha=X.y-K.y;oa=ta-oa;ta=Y*Y+ha*ha;if(oa*oa/O<ta)return ta<ra&&(0===Y&&(Y=1E-6*(T()-.5),ta+=Y*Y),0===ha&&(ha=1E-6*(T()-.5),ta+=ha*ha),ta<na&&
(ta=Math.sqrt(na*ta)),K.vx+=Y*X.value*Q/ta,K.vy+=ha*X.value*Q/ta),!0;if(!(X.length||ta>=ra)){if(X.data!==K||X.next)0===Y&&(Y=1E-6*(T()-.5),ta+=Y*Y),0===ha&&(ha=1E-6*(T()-.5),ta+=ha*ha),ta<na&&(ta=Math.sqrt(na*ta));do X.data!==K&&(oa=ca[X.data.index]*Q/ta,K.vx+=Y*oa,K.vy+=ha*oa);while(X=X.next)}}var H,K,T,Q,ba=xb(-30),ca,na=1,ra=Infinity,O=.81;k.initialize=function(X,oa){H=X;T=oa;A()};k.strength=function(X){return arguments.length?(ba="function"===typeof X?X:xb(+X),A(),k):ba};k.distanceMin=function(X){return arguments.length?
(na=X*X,k):Math.sqrt(na)};k.distanceMax=function(X){return arguments.length?(ra=X*X,k):Math.sqrt(ra)};k.theta=function(X){return arguments.length?(O=X*X,k):Math.sqrt(O)};return k};e.forceRadial=function(k,A,G){function E(ca){for(var na=0,ra=K.length;na<ra;++na){var O=K[na],X=O.x-A||1E-6,oa=O.y-G||1E-6,Y=Math.sqrt(X*X+oa*oa);Y=(ba[na]-Y)*Q[na]*ca/Y;O.vx+=X*Y;O.vy+=oa*Y}}function H(){if(K){var ca,na=K.length;Q=Array(na);ba=Array(na);for(ca=0;ca<na;++ca)ba[ca]=+k(K[ca],ca,K),Q[ca]=isNaN(ba[ca])?0:+T(K[ca],
ca,K)}}var K,T=xb(.1),Q,ba;"function"!==typeof k&&(k=xb(+k));null==A&&(A=0);null==G&&(G=0);E.initialize=function(ca){K=ca;H()};E.strength=function(ca){return arguments.length?(T="function"===typeof ca?ca:xb(+ca),H(),E):T};E.radius=function(ca){return arguments.length?(k="function"===typeof ca?ca:xb(+ca),H(),E):k};E.x=function(ca){return arguments.length?(A=+ca,E):A};E.y=function(ca){return arguments.length?(G=+ca,E):G};return E};e.forceSimulation=function(k){function A(){G();X.call("tick",K);T<Q&&
(O.stop(),X.call("end",K))}function G(Y){var ta,ha=k.length;void 0===Y&&(Y=1);for(var va=0;va<Y;++va)for(T+=(ca-T)*ba,ra.forEach(function(la){la(T)}),ta=0;ta<ha;++ta){var wa=k[ta];null==wa.fx?wa.x+=wa.vx*=na:(wa.x=wa.fx,wa.vx=0);null==wa.fy?wa.y+=wa.vy*=na:(wa.y=wa.fy,wa.vy=0)}return K}function E(){for(var Y=0,ta=k.length,ha;Y<ta;++Y){ha=k[Y];ha.index=Y;null!=ha.fx&&(ha.x=ha.fx);null!=ha.fy&&(ha.y=ha.fy);if(isNaN(ha.x)||isNaN(ha.y)){var va=10*Math.sqrt(.5+Y),wa=Y*Hv;ha.x=va*Math.cos(wa);ha.y=va*Math.sin(wa)}if(isNaN(ha.vx)||
isNaN(ha.vy))ha.vx=ha.vy=0}}function H(Y){Y.initialize&&Y.initialize(k,oa);return Y}var K,T=1,Q=.001,ba=1-Math.pow(Q,1/300),ca=0,na=.6,ra=new Map,O=ff(A),X=Xc("tick","end"),oa=gs();null==k&&(k=[]);E();return K={tick:G,restart:function(){return O.restart(A),K},stop:function(){return O.stop(),K},nodes:function(Y){return arguments.length?(k=Y,E(),ra.forEach(H),K):k},alpha:function(Y){return arguments.length?(T=+Y,K):T},alphaMin:function(Y){return arguments.length?(Q=+Y,K):Q},alphaDecay:function(Y){return arguments.length?
(ba=+Y,K):+ba},alphaTarget:function(Y){return arguments.length?(ca=+Y,K):ca},velocityDecay:function(Y){return arguments.length?(na=1-Y,K):1-na},randomSource:function(Y){return arguments.length?(oa=Y,ra.forEach(H),K):oa},force:function(Y,ta){return 1<arguments.length?(null==ta?ra.delete(Y):ra.set(Y,H(ta)),K):ra.get(Y)},find:function(Y,ta,ha){var va,wa=k.length;ha=null==ha?Infinity:ha*ha;for(va=0;va<wa;++va){var la=k[va];var Ca=Y-la.x;var La=ta-la.y;Ca=Ca*Ca+La*La;if(Ca<ha){var Ra=la;ha=Ca}}return Ra},
on:function(Y,ta){return 1<arguments.length?(X.on(Y,ta),K):X.on(Y)}}};e.forceX=function(k){function A(Q){for(var ba=0,ca=H.length,na;ba<ca;++ba)na=H[ba],na.vx+=(T[ba]-na.x)*K[ba]*Q}function G(){if(H){var Q,ba=H.length;K=Array(ba);T=Array(ba);for(Q=0;Q<ba;++Q)K[Q]=isNaN(T[Q]=+k(H[Q],Q,H))?0:+E(H[Q],Q,H)}}var E=xb(.1),H,K,T;"function"!==typeof k&&(k=xb(null==k?0:+k));A.initialize=function(Q){H=Q;G()};A.strength=function(Q){return arguments.length?(E="function"===typeof Q?Q:xb(+Q),G(),A):E};A.x=function(Q){return arguments.length?
(k="function"===typeof Q?Q:xb(+Q),G(),A):k};return A};e.forceY=function(k){function A(Q){for(var ba=0,ca=H.length,na;ba<ca;++ba)na=H[ba],na.vy+=(T[ba]-na.y)*K[ba]*Q}function G(){if(H){var Q,ba=H.length;K=Array(ba);T=Array(ba);for(Q=0;Q<ba;++Q)K[Q]=isNaN(T[Q]=+k(H[Q],Q,H))?0:+E(H[Q],Q,H)}}var E=xb(.1),H,K,T;"function"!==typeof k&&(k=xb(null==k?0:+k));A.initialize=function(Q){H=Q;G()};A.strength=function(Q){return arguments.length?(E="function"===typeof Q?Q:xb(+Q),G(),A):E};A.y=function(Q){return arguments.length?
...
(ca.point(X,O),na)}function A(){G=E=null;return k}var G,E,H=cm(),K,T=Tf().rotate([154,0]).center([-2,58.5]).parallels([55,65]),Q,ba=Tf().rotate([157,0]).center([-3,19.9]).parallels([8,18]),ca,na,ra={point:function(O,X){na=[O,X]}};k.invert=function(O){var X=H.scale(),oa=H.translate(),Y=(O[0]-oa[0])/X;X=(O[1]-oa[1])/X;return(.12<=X&&.234>X&&-.425<=Y&&-.214>Y?T:.166<=X&&.234>X&&-.214<=Y&&-.115>Y?ba:H).invert(O)};k.stream=function(O){return G&&E===O?G:G=Ts([H.stream(E=O),T.stream(O),ba.stream(O)])};k.precision=
...
E,qb=K[0],rb=H[1])}Qc=Cc=null;return Infinity===qb||Infinity===Yb?[[NaN,NaN],[NaN,NaN]]:[[qb,Yb],[rb,$b]]};e.geoCentroid=function(k){qe=Ff=Cf=Df=Ef=Gf=Hf=If=0;Ih=new ub;Jh=new ub;Kh=new ub;lc(k,mc);k=+Ih;var A=+Jh,G=+Kh,E=Hh(k,A,G);return 1E-12>E&&(k=Gf,A=Hf,G=If,1E-6>Ff&&(k=Cf,A=Df,G=Ef),E=Hh(k,A,G),1E-12>E)?[NaN,NaN]:[Qb(A,k)*jb,Pb(G/E)*jb]};e.geoCircle=function(){function k(){var Q=A.apply(this,arguments),ba=G.apply(this,arguments)*Ta,ca=E.apply(this,arguments)*Ta;H=[];K=Nh(-Q[0]*Ta,-Q[1]*Ta,0).invert;
vl(T,ba,ca,1);Q={type:"Polygon",coordinates:[H]};H=K=null;return Q}var A=Ed([0,0]),G=Ed(90),E=Ed(6),H,K,T={point:function(Q,ba){H.push(Q=K(Q,ba));Q[0]*=jb;Q[1]*=jb}};k.center=function(Q){return arguments.length?(A="function"===typeof Q?Q:Ed([+Q[0],+Q[1]]),k):A};k.radius=function(Q){return arguments.length?(G="function"===typeof Q?Q:Ed(+Q),k):G};k.precision=function(Q){return arguments.length?(E="function"===typeof Q?Q:Ed(+Q),k):E};return k};e.geoClipAntimeridian=ei;e.geoClipCircle=Cl;e.geoClipExtent=
...
gm;e.geoContains=function(k,A){return(k&&ao.hasOwnProperty(k.type)?ao[k.type]:Of)(k,A)};e.geoDistance=re;e.geoEqualEarth=function(){return wc(hi).scale(177.158)};e.geoEqualEarthRaw=hi;e.geoEquirectangular=function(){return wc(Be).scale(152.63)};e.geoEquirectangularRaw=Be;e.geoGnomonic=function(){return wc(ii).scale(144.049).clipAngle(60)};e.geoGnomonicRaw=ii;e.geoGraticule=Kl;e.geoGraticule10=function(){return Kl()()};e.geoIdentity=function(){function k(){oa=G*K;Y=G*T;va=wa=null;return A}function A(la){var Ca=
la[0]*oa;la=la[1]*Y;if(Q){var La=la*ba-Ca*ca;Ca=Ca*ba+la*ca;la=La}return[Ca+E,la+H]}var G=1,E=0,H=0,K=1,T=1,Q=0,ba,ca,na=null,ra,O,X,oa=1,Y=1,ta=xe({point:function(la,Ca){la=A([la,Ca]);this.stream.point(la[0],la[1])}}),ha=ye,va,wa;A.invert=function(la){var Ca=la[0]-E;la=la[1]-H;if(Q){var La=la*ba+Ca*ca;Ca=Ca*ba-la*ca;la=La}return[Ca/oa,la/Y]};A.stream=function(la){return va&&wa===la?va:va=ta(ha(wa=la))};A.postclip=function(la){return arguments.length?(ha=la,na=ra=O=X=null,k()):ha};A.clipExtent=function(la){return arguments.length?
(ha=null==la?(na=ra=O=X=null,ye):Lf(na=+la[0][0],ra=+la[0][1],O=+la[1][0],X=+la[1][1]),k()):null==na?null:[[na,ra],[O,X]]};A.scale=function(la){return arguments.length?(G=+la,k()):G};A.translate=function(la){return arguments.length?(E=+la[0],H=+la[1],k()):[E,H]};A.angle=function(la){return arguments.length?(Q=la%360*Ta,ca=Ma(Q),ba=Qa(Q),k()):Q*jb};A.reflectX=function(la){return arguments.length?(K=la?-1:1,k()):0>K};A.reflectY=function(la){return arguments.length?(T=la?-1:1,k()):0>T};A.fitExtent=function(la,
Ca){return Hd(A,la,Ca)};A.fitSize=function(la,Ca){return Hd(A,[[0,0],la],Ca)};A.fitWidth=function(la,Ca){return bi(A,la,Ca)};A.fitHeight=function(la,Ca){return ci(A,la,Ca)};return A};e.geoInterpolate=function(k,A){var G=k[0]*Ta,E=k[1]*Ta;k=A[0]*Ta;A=A[1]*Ta;var H=Qa(E),K=Ma(E),T=Qa(A),Q=Ma(A),ba=H*Qa(G),ca=H*Ma(G),na=T*Qa(k),ra=T*Ma(k),O=2*Pb(Cb(Zk(A-E)+H*T*Zk(k-G))),X=Ma(O);k=O?function(oa){var Y=Ma(oa*=O)/X,ta=Ma(O-oa)/X;oa=ta*ba+Y*na;var ha=ta*ca+Y*ra;Y=ta*K+Y*Q;return[Qb(ha,oa)*jb,Qb(Y,Cb(oa*
...
e.pairs=function(k,A){A=void 0===A?mp:A;var G=[],E=!1;k=$jscomp.makeIterator(k);for(var H=k.next();!H.done;H=k.next()){H=H.value;E&&G.push(A(K,H));var K=H;E=!0}return G};e.partition=function(){function k(T){var Q=T.height+1;T.x0=T.y0=H;T.x1=G;T.y1=E/Q;T.eachBefore(A(E,Q));K&&T.eachBefore(sm);return T}function A(T,Q){return function(ba){ba.children&&De(ba,ba.x0,T*(ba.depth+1)/Q,ba.x1,T*(ba.depth+2)/Q);var ca=ba.x0,na=ba.y0,ra=ba.x1-H,O=ba.y1-H;ra<ca&&(ca=ra=(ca+ra)/2);O<na&&(na=O=(na+O)/2);ba.x0=ca;
ba.y0=na;ba.x1=ra;ba.y1=O}}var G=1,E=1,H=0,K=!1;k.round=function(T){return arguments.length?(K=!!T,k):K};k.size=function(T){return arguments.length?(G=+T[0],E=+T[1],k):[G,E]};k.padding=function(T){return arguments.length?(H=+T,k):H};return k};e.path=Oc;e.permute=lb;e.pie=function(){function k(Q){var ba,ca=(Q=gg(Q)).length;var na=0;var ra=Array(ca),O=Array(ca),X=+H.apply(this,arguments);var oa=Math.min(Vc,Math.max(-Vc,K.apply(this,arguments)-X));var Y=Math.min(Math.abs(oa)/ca,T.apply(this,arguments)),
ta=Y*(0>oa?-1:1),ha;for(ba=0;ba<ca;++ba)0<(ha=O[ra[ba]=ba]=+A(Q[ba],ba,Q))&&(na+=ha);null!=G?ra.sort(function(wa,la){return G(O[wa],O[la])}):null!=E&&ra.sort(function(wa,la){return E(Q[wa],Q[la])});ba=0;for(oa=na?(oa-ca*ta)/na:0;ba<ca;++ba,X=va){na=ra[ba];ha=O[na];var va=X+(0<ha?ha*oa:0)+ta;O[na]={data:Q[na],index:ba,value:ha,startAngle:X,endAngle:va,padAngle:Y}}return O}var A=Fu,G=Eu,E=null,H=Xa(0),K=Xa(Vc),T=Xa(0);k.value=function(Q){return arguments.length?(A="function"===typeof Q?Q:Xa(+Q),k):
...
e.timeTuesday=mo;e.timeTuesdays=Zv;e.timeWednesday=no;e.timeWednesdays=$v;e.timeWeek=Qd;e.timeWeeks=qo;e.timeYear=xc;e.timeYears=ew;e.timeout=gh;e.timer=ff;e.timerFlush=jk;e.transition=nk;e.transpose=pj;e.tree=function(){function k(ba){var ca=gt(ba);ca.eachAfter(A);ca.parent.m=-ca.z;ca.eachBefore(G);if(Q)ba.eachBefore(E);else{var na=ba,ra=ba,O=ba;ba.eachBefore(function(ta){ta.x<na.x&&(na=ta);ta.x>ra.x&&(ra=ta);ta.depth>O.depth&&(O=ta)});ca=na===ra?1:H(na,ra)/2;var X=ca-na.x,oa=K/(ra.x+ca+X),Y=T/(O.depth||
1);ba.eachBefore(function(ta){ta.x=(ta.x+X)*oa;ta.y=ta.depth*Y})}return ba}function A(ba){var ca=ba.children,na=ba.parent.children,ra=ba.i?na[ba.i-1]:null;if(ca){for(var O=0,X=0,oa=ba.children,Y=oa.length,ta;0<=--Y;)ta=oa[Y],ta.z+=O,ta.m+=O,O+=ta.s+(X+=ta.c);ca=(ca[0].z+ca[ca.length-1].z)/2;ra?(ba.z=ra.z+H(ba._,ra._),ba.m=ba.z-ca):ba.z=ca}else ra&&(ba.z=ra.z+H(ba._,ra._));ca=ba.parent;na=ba.parent.A||na[0];if(ra){X=O=ba;oa=O.parent.children[0];Y=O.m;ta=X.m;for(var ha=ra.m,va=oa.m,wa;ra=ri(ra),O=qi(O),
ra&&O;){oa=qi(oa);X=ri(X);X.a=ba;wa=ra.z+ha-O.z-Y+H(ra._,O._);if(0<wa){var la=ra.a.parent===ba.parent?ra.a:na,Ca=ba,La=wa,Ra=La/(Ca.i-la.i);Ca.c-=Ra;Ca.s+=La;la.c+=Ra;Ca.z+=La;Ca.m+=La;Y+=wa;ta+=wa}ha+=ra.m;Y+=O.m;va+=oa.m;ta+=X.m}ra&&!ri(X)&&(X.t=ra,X.m+=ha-ta);O&&!qi(oa)&&(oa.t=O,oa.m+=Y-va,na=ba)}ca.A=na}function G(ba){ba._.x=ba.z+ba.parent.m;ba.m+=ba.parent.m}function E(ba){ba.x*=K;ba.y=ba.depth*T}var H=ft,K=1,T=1,Q=null;k.separation=function(ba){return arguments.length?(H=ba,k):H};k.size=function(ba){return arguments.length?
(Q=!1,K=+ba[0],T=+ba[1],k):Q?null:[K,T]};k.nodeSize=function(ba){return arguments.length?(Q=!0,K=+ba[0],T=+ba[1],k):Q?[K,T]:null};return k};e.treemap=function(){function k(O){O.x0=O.y0=0;O.x1=H;O.y1=K;O.eachBefore(A);T=[0];E&&O.eachBefore(sm);return O}function A(O){var X=T[O.depth],oa=O.x0+X,Y=O.y0+X,ta=O.x1-X,ha=O.y1-X;ta<oa&&(oa=ta=(oa+ta)/2);ha<Y&&(Y=ha=(Y+ha)/2);O.x0=oa;O.y0=Y;O.x1=ta;O.y1=ha;O.children&&(X=T[O.depth+1]=Q(O)/2,oa+=ra(O)-X,Y+=ba(O)-X,ta-=ca(O)-X,ha-=na(O)-X,ta<oa&&(oa=ta=(oa+ta)/
2),ha<Y&&(Y=ha=(Y+ha)/2),G(O,oa,Y,ta,ha))}var G=eo,E=!1,H=1,K=1,T=[0],Q=gd,ba=gd,ca=gd,na=gd,ra=gd;k.round=function(O){return arguments.length?(E=!!O,k):E};k.size=function(O){return arguments.length?(H=+O[0],K=+O[1],k):[H,K]};k.tile=function(O){return arguments.length?(G=Yf(O),k):G};k.padding=function(O){return arguments.length?k.paddingInner(O).paddingOuter(O):k.paddingInner()};k.paddingInner=function(O){return arguments.length?(Q="function"===typeof O?O:Ld(+O),k):Q};k.paddingOuter=function(O){return arguments.length?
...
O,X,oa,Y,ta,ha){if(ra>=O-1)ra=T[ra],ra.x0=oa,ra.y0=Y,ra.x1=ta,ra.y1=ha;else{for(var va=na[ra],wa=X/2+va,la=ra+1,Ca=O-1;la<Ca;){var La=la+Ca>>>1;na[La]<wa?la=La+1:Ca=La}wa-na[la-1]<na[la]-wa&&ra+1<la&&--la;va=na[la]-va;wa=X-va;ta-oa>ha-Y?(X=X?(oa*wa+ta*va)/X:ta,K(ra,la,va,oa,Y,X,ha),K(la,O,wa,X,Y,ta,ha)):(X=X?(Y*wa+ha*va)/X:ha,K(ra,la,va,oa,Y,ta,X),K(la,O,wa,oa,X,ta,ha))}}var T=k.children,Q,ba=T.length,ca,na=Array(ba+1);for(na[0]=ca=Q=0;Q<ba;++Q)na[Q+1]=ca+=T[Q].value;K(0,ba,k.value,A,G,E,H)};e.treemapDice=
...
pw;e.variance=Z;e.version="6.7.0";e.window=Qg;e.xml=Ev;e.zip=function(){return pj(arguments)};e.zoom=function(){function k(sa){sa.property("__zoom",Ln).on("wheel.zoom",Q).on("mousedown.zoom",ba).on("dblclick.zoom",ca).filter(ha).on("touchstart.zoom",na).on("touchmove.zoom",ra).on("touchend.zoom touchcancel.zoom",O).style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function A(sa,Oa){Oa=Math.max(va[0],Math.min(va[1],Oa));return Oa===sa.k?sa:new Hc(Oa,sa.x,sa.y)}function G(sa,Oa,ya){var Ja=Oa[0]-
ya[0]*sa.k;Oa=Oa[1]-ya[1]*sa.k;return Ja===sa.x&&Oa===sa.y?sa:new Hc(sa.k,Ja,Oa)}function E(sa){return[(+sa[0][0]+ +sa[1][0])/2,(+sa[0][1]+ +sa[1][1])/2]}function H(sa,Oa,ya,Ja){sa.on("start.zoom",function(){K(this,arguments).event(Ja).start()}).on("interrupt.zoom end.zoom",function(){K(this,arguments).event(Ja).end()}).tween("zoom",function(){var Fa=arguments,Ya=K(this,Fa).event(Ja),Va=oa.apply(this,Fa),gb=null==ya?E(Va):"function"===typeof ya?ya.apply(this,Fa):ya,wb=Math.max(Va[1][0]-Va[0][0],Va[1][1]-
Va[0][1]);Va=this.__zoom;var sb="function"===typeof Oa?Oa.apply(this,Fa):Oa,Eg=Ca(Va.invert(gb).concat(wb/Va.k),sb.invert(gb).concat(wb/sb.k));return function(hc){if(1===hc)hc=sb;else{hc=Eg(hc);var gj=wb/hc[2];hc=new Hc(gj,gb[0]-hc[0]*gj,gb[1]-hc[1]*gj)}Ya.zoom(null,hc)}})}function K(sa,Oa,ya){return!ya&&sa.__zooming||new T(sa,Oa)}function T(sa,Oa){this.that=sa;this.args=Oa;this.active=0;this.sourceEvent=null;this.extent=oa.apply(sa,Oa);this.taps=0}function Q(sa,Oa){for(var ya=[],Ja=1;Ja<arguments.length;++Ja)ya[Ja-
1]=arguments[Ja];if(X.apply(this,arguments)){var Fa=K(this,ya).event(sa);ya=this.__zoom;Ja=Math.max(va[0],Math.min(va[1],ya.k*Math.pow(2,ta.apply(this,arguments))));var Ya=Zb(sa);if(Fa.wheel){if(Fa.mouse[0][0]!==Ya[0]||Fa.mouse[0][1]!==Ya[1])Fa.mouse[1]=ya.invert(Fa.mouse[0]=Ya);clearTimeout(Fa.wheel)}else{if(ya.k===Ja)return;Fa.mouse=[Ya,ya.invert(Ya)];bd(this);Fa.start()}Me(sa);Fa.wheel=setTimeout(function(){Fa.wheel=null;Fa.end()},150);Fa.zoom("mouse",Y(G(A(ya,Ja),Fa.mouse[0],Fa.mouse[1]),Fa.extent,
wa))}}function ba(sa,Oa){for(var ya=[],Ja=1;Ja<arguments.length;++Ja)ya[Ja-1]=arguments[Ja];if(!Wa&&X.apply(this,arguments)){var Fa=K(this,ya,!0).event(sa),Ya=Ib(sa.view).on("mousemove.zoom",function(sb){Me(sb);if(!Fa.moved){var Eg=sb.clientX-gb,hc=sb.clientY-wb;Fa.moved=Eg*Eg+hc*hc>mb}Fa.event(sb).zoom("mouse",Y(G(Fa.that.__zoom,Fa.mouse[0]=Zb(sb,Va),Fa.mouse[1]),Fa.extent,wa))},!0).on("mouseup.zoom",function(sb){Ya.on("mousemove.zoom mouseup.zoom",null);Xe(sb.view,Fa.moved);Me(sb);Fa.event(sb).end()},
!0);ya=Zb(sa,Va);var Va=sa.currentTarget,gb=sa.clientX,wb=sa.clientY;We(sa.view);sa.stopImmediatePropagation();Fa.mouse=[ya,this.__zoom.invert(ya)];bd(this);Fa.start()}}function ca(sa,Oa){for(var ya=[],Ja=1;Ja<arguments.length;++Ja)ya[Ja-1]=arguments[Ja];if(X.apply(this,arguments)){var Fa=this.__zoom;Ja=Zb(sa.changedTouches?sa.changedTouches[0]:sa,this);var Ya=Fa.invert(Ja);ya=Y(G(A(Fa,Fa.k*(sa.shiftKey?.5:2)),Ja,Ya),oa.apply(this,ya),wa);Me(sa);0<la?Ib(this).transition().duration(la).call(H,ya,Ja,
sa):Ib(this).call(k.transform,ya,Ja,sa)}}function na(sa,Oa){for(var ya=[],Ja=1;Ja<arguments.length;++Ja)ya[Ja-1]=arguments[Ja];if(X.apply(this,arguments)){Ja=sa.touches;var Fa=Ja.length;ya=K(this,ya,sa.changedTouches.length===Fa).event(sa);var Ya;sa.stopImmediatePropagation();for(Ya=0;Ya<Fa;++Ya){var Va=Ja[Ya];var gb=Zb(Va,this);gb=[gb,this.__zoom.invert(gb),Va.identifier];if(ya.touch0)ya.touch1||ya.touch0[2]===gb[2]||(ya.touch1=gb,ya.taps=0);else{ya.touch0=gb;var wb=!0;ya.taps=1+!!Ra}}Ra&&(Ra=clearTimeout(Ra));
wb&&(2>ya.taps&&($a=gb[0],Ra=setTimeout(function(){Ra=null},500)),bd(this),ya.start())}}function ra(sa,Oa){for(var ya=[],Ja=1;Ja<arguments.length;++Ja)ya[Ja-1]=arguments[Ja];if(this.__zooming){ya=K(this,ya).event(sa);var Fa=sa.changedTouches,Ya=Fa.length,Va;Me(sa);for(Va=0;Va<Ya;++Va){Ja=Fa[Va];var gb=Zb(Ja,this);ya.touch0&&ya.touch0[2]===Ja.identifier?ya.touch0[0]=gb:ya.touch1&&ya.touch1[2]===Ja.identifier&&(ya.touch1[0]=gb)}Ja=ya.that.__zoom;if(ya.touch1){gb=ya.touch0[0];Fa=ya.touch0[1];Va=ya.touch1[0];
Ya=ya.touch1[1];var wb=(wb=Va[0]-gb[0])*wb+(wb=Va[1]-gb[1])*wb;var sb=(sb=Ya[0]-Fa[0])*sb+(sb=Ya[1]-Fa[1])*sb;Ja=A(Ja,Math.sqrt(wb/sb));gb=[(gb[0]+Va[0])/2,(gb[1]+Va[1])/2];wb=[(Fa[0]+Ya[0])/2,(Fa[1]+Ya[1])/2]}else if(ya.touch0)gb=ya.touch0[0],wb=ya.touch0[1];else return;ya.zoom("touch",Y(G(Ja,gb,wb),ya.extent,wa))}}function O(sa,Oa){for(var ya=[],Ja=1;Ja<arguments.length;++Ja)ya[Ja-1]=arguments[Ja];if(this.__zooming){ya=K(this,ya).event(sa);Ja=sa.changedTouches;var Fa=Ja.length,Ya;sa.stopImmediatePropagation();
Wa&&clearTimeout(Wa);Wa=setTimeout(function(){Wa=null},500);for(Ya=0;Ya<Fa;++Ya){var Va=Ja[Ya];ya.touch0&&ya.touch0[2]===Va.identifier?delete ya.touch0:ya.touch1&&ya.touch1[2]===Va.identifier&&delete ya.touch1}ya.touch1&&!ya.touch0&&(ya.touch0=ya.touch1,delete ya.touch1);ya.touch0?ya.touch0[1]=this.__zoom.invert(ya.touch0[0]):(ya.end(),2===ya.taps&&(Va=Zb(Va,this),Math.hypot($a[0]-Va[0],$a[1]-Va[1])<ob&&(Va=Ib(this).on("dblclick.zoom"))&&Va.apply(this,arguments)))}}var X=Qu,oa=Ru,Y=Uu,ta=Su,ha=Tu,
va=[0,Infinity],wa=[[-Infinity,-Infinity],[Infinity,Infinity]],la=250,Ca=Qn,La=Xc("start","zoom","end"),Ra,$a,Wa,mb=0,ob=10;k.transform=function(sa,Oa,ya,Ja){var Fa=sa.selection?sa.selection():sa;Fa.property("__zoom",Ln);sa!==Fa?H(sa,Oa,ya,Ja):Fa.interrupt().each(function(){K(this,arguments).event(Ja).start().zoom(null,"function"===typeof Oa?Oa.apply(this,arguments):Oa).end()})};k.scaleBy=function(sa,Oa,ya,Ja){k.scaleTo(sa,function(){var Fa=this.__zoom.k,Ya="function"===typeof Oa?Oa.apply(this,arguments):
Oa;return Fa*Ya},ya,Ja)};k.scaleTo=function(sa,Oa,ya,Ja){k.transform(sa,function(){var Fa=oa.apply(this,arguments),Ya=this.__zoom,Va=null==ya?E(Fa):"function"===typeof ya?ya.apply(this,arguments):ya,gb=Ya.invert(Va),wb="function"===typeof Oa?Oa.apply(this,arguments):Oa;return Y(G(A(Ya,wb),Va,gb),Fa,wa)},ya,Ja)};k.translateBy=function(sa,Oa,ya,Ja){k.transform(sa,function(){return Y(this.__zoom.translate("function"===typeof Oa?Oa.apply(this,arguments):Oa,"function"===typeof ya?ya.apply(this,arguments):
ya),oa.apply(this,arguments),wa)},null,Ja)};k.translateTo=function(sa,Oa,ya,Ja,Fa){k.transform(sa,function(){var Ya=oa.apply(this,arguments),Va=this.__zoom,gb=null==Ja?E(Ya):"function"===typeof Ja?Ja.apply(this,arguments):Ja;return Y(ng.translate(gb[0],gb[1]).scale(Va.k).translate("function"===typeof Oa?-Oa.apply(this,arguments):-Oa,"function"===typeof ya?-ya.apply(this,arguments):-ya),Ya,wa)},Ja,Fa)};T.prototype={event:function(sa){sa&&(this.sourceEvent=sa);return this},start:function(){1===++this.active&&
...
oa};k.scaleExtent=function(sa){return arguments.length?(va[0]=+sa[0],va[1]=+sa[1],k):[va[0],va[1]]};k.translateExtent=function(sa){return arguments.length?(wa[0][0]=+sa[0][0],wa[1][0]=+sa[1][0],wa[0][1]=+sa[0][1],wa[1][1]=+sa[1][1],k):[[wa[0][0],wa[0][1]],[wa[1][0],wa[1][1]]]};k.constrain=function(sa){return arguments.length?(Y=sa,k):Y};k.duration=function(sa){return arguments.length?(la=+sa,k):la};k.interpolate=function(sa){return arguments.length?(Ca=sa,k):Ca};k.on=function(){var sa=La.on.apply(La,
arguments);return sa===La?k:sa};k.clickDistance=function(sa){return arguments.length?(mb=(sa=+sa)*sa,k):Math.sqrt(mb)};k.tapDistance=function(sa){return arguments.length?(ob=+sa,k):ob};return k};e.zoomIdentity=ng;e.zoomTransform=Kn;Object.defineProperty(e,"__esModule",{value:!0})});var WMSVersion={version100:"1.0.0",version111:"1.1.1",version130:"1.3.0"},htmlTab="",tddjs=function(e,p){var z=!0,F=[],I=F.set=!1,ja=null,N=function(V){da="";I&&(ja.close(),I=!1);document.getElementById("info").innerHTML=da;if(0!=z){F.x=V.x;F.y=V.y;F.set=!0;var aa=p.getLatLongFromPixelCoord({x:V.x,y:V.y});V=p.getLayers();if(isDefined(V)){info=p.getLayers().getFeatureInfoUrl;var da="";0==p.layers.length&&(da="No layer: Load a valid sounding layer.",document.getElementById("info").innerHTML=da);V=[];
for(var ea=0;ea<p.layers.length;ea++)p.layers[p.layers.length-ea-1].service.includes("TEMP")&&V.push(p.layers[p.layers.length-ea-1]);ea=null;for(var Z in V)ea=V[Z],null!=ea&&""!==ea.getFeatureInfoUrl?!1===ea.queryable?p.featureInfoRequestReady("Layer is not queryable.",ea):(da='<img src="./img/ajax-loader.gif" alt="Loading..."/>',document.getElementById("info").innerHTML=da,getJSONdata(ea,p,F.x,F.y,"text/plain",function(ka){null!=ka?null!=ka.data?(ja=window.open("sondTemp.html","Sondeo",'itemId="sond",toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=1040,height=600'),
ja.myvar=ka,I=!0,da="Profile for location ["+Math.round(100*aa.x)/100+","+Math.round(100*aa.y)/100+"]",da+=" - Station:"+ka.meta.name+"<br/>",document.getElementById("info").innerHTML="",document.getElementById("info").innerHTML=da,document.getElementById("table").innerHTML="",document.getElementById("table").innerHTML=htmlTab):(da="Profile for location ["+Math.round(100*aa.x)/100+","+Math.round(100*aa.y)/100+"]",da+=" - Station:"+ka.meta.name+"<br/>",document.getElementById("info").innerHTML="",
document.getElementById("info").innerHTML=da,document.getElementById("table").innerHTML="",htmlTab+="</TABLE>",document.getElementById("table").innerHTML=htmlTab,console.log(htmlTab)):(da="No valid data",document.getElementById("info").innerHTML=da)})):(da="Wrong layer: Load a valid sounding layer.",document.getElementById("info").innerHTML=da)}else $("#info").html("No valid data received:<br/>"+data)}};p.addListener("mouseclicked",N,!0);this.enable=function(){e.html('<div id="info"></div><div id="table"></div>');
$("#info").html("Click on the map to load a profile.");p.enableInlineGetFeatureInfo(!1);z=!0};this.disable=function(){z=!1;p.enableInlineGetFeatureInfo(!0);F.set=!1;I&&(ja.close(),I=!1)};this.resize=function(V,aa){$("#mitdd").width(V);F.set&&N(F)};this.enable()};try{WMJSExtApplications.Sondeo=tddjs}catch(e){}
...
V?I("request returned no data"):p(null,N.response)}else window.alert("ALLI"),console.log(e),ja()};N.send(null)}catch(V){window.alert("AQUI"),ja()}}
...
"&HEIGHT="+p.height;if(e.version===WMSVersion.version100||e.version===WMSVersion.version111)V=V+("&X="+z)+("&Y="+F);e.version===WMSVersion.version130&&(V=V+("&I="+z)+("&J="+F));V+="&FORMAT=image/gif&STYLES=";try{V+="&"+p._getMapDimURL(e),N+=V,I+=V}catch(da){callback(null,void 0)}debug('<a target="_blank" href="'+N+'">'+N+"</a>",!1);var aa=e.service+"&SERVICE=WMS&REQUEST=GetMetaData&VERSION="+e.version;aa+="&LAYERS="+URLEncode(e.name);aa+="&LAYER=station_name";aa+="&FORMAT=application/json";getMeta(I,
function(da){null!=da?getData(aa,da,N,function(ea){ja({meta:da,data:ea})}):(console.log("no valid data"),ja(null))})}function WMJScheckURL(e){if(!isDefined(e))return"?";e=e.trim();-1===e.indexOf("?")&&(e+="?");return e}function isDefined(e){return"undefined"===typeof e?!1:!0}
...
function getMeta(e,p){MakeHTTPRequest(e,function(z,F){if(null!=z)console.error(z);else{z=[];try{var I=JSON.parse(F),ja=I[0].point.coords;ja=ja.split(",");var N=parseFloat(ja[0]),V=parseFloat(ja[1]),aa=Object.keys(I[1].data),da=aa.toString();da=da.split("T");var ea=da[0].replaceAll("-","");ea=parseInt(ea);var Z=parseInt(da[1].substring(0,2)),ka=I[1].data[aa];if("nodata"!=ka){ka+=" "+I[5].data[aa];aa=Object.keys(I[2].data);var za=I[2].data[aa];za/=100;aa=Object.keys(I[3].data);var xa=I[3].data[aa];
xa=parseFloat(xa);isNaN(xa)&&(xa=0);z={model:"OBSERVACION",index:ka,date:ea,run:Z,step:0,lon:N,lat:V,ps:za,zs:xa,name:ka};p(z)}else p(null)}catch(ua){console.log(ua),p(null)}}})}
function getData(e,p,z,F){var I="&DIM_lev=";z.includes("files")&&(I="&elevation=");htmlTab="<TABLE BORDER>";htmlTab+="<TR> <TD>Nivel</TD> <TD>P</TD> <TD>Z</TD> <TD>T</TD> <TD>TD</TD> <TD>WD</TD> <TD>WS</TD> </TR>";getLevels(e,p,function(ja){null==ja&&(window.errorMessage("No hay niveles!"),F(null));var N=parseInt(ja),V=Math.floor(N/100);N%=100;for(var aa=0,da=0,ea=[],Z=0;Z<V;Z++)da=aa+99,ea.push(z+I+aa+"/"+da),aa=da+1;ea.push(z+I+aa+"/"+(aa+N));ea=ea.reverse();var ka=[];getDataN(ea,ja,p,ka,function(za){null==
za&&(window.errorMessage("No hay niveles!"),F(null));if(0==ka.length)window.alert("El sondeo no tiene datos validos para este diagrama"),F(null);else{za=parseFloat(ka[ka.length-1].p);var xa=parseFloat(ka[0].p);850>=xa?(window.alert("El primer nivel esta demasiado alto! - P0: "+xa+"hpa\n\n El primer nivel debe ser mayor de 850hPa"),F(null)):300<za?(window.alert("Ultimo nivel demasiado bajo! - Pn: "+za+"hpa\n\n El ultimo nivel debe ser menor de 300hPa"),F(null)):(htmlTab+="</TABLE>",F(ka))}})})}
function getDataN(e,p,z,F,I){if(0!=e.length){var ja=e.pop(),N=ja.indexOf("lev");N=ja.slice(N);var V=N.indexOf("=")+1,aa=N.indexOf("/"),da=N.slice(V,aa);document.getElementById("info").innerHTML+="Procesando niviles "+da+" a "+(parseInt(da)+99)+" de "+p+"<br>";MakeHTTPRequest(ja,function(ea,Z){if(null!=ea)console.error(ea);else if(console.log("REQ",ja,"DATA",Z),!Z.includes("ServiceException")){ea=z.zs;var ka=JSON.parse(Z);Object.keys(ka[0].data);Z=ka[0].data;var za=ka[1].data,xa=ka[2].data,ua=ka[3].data,
Ba=ka[4].data,Na=ka[5].data;ka=ka[6].data;var Ga=parseInt(da);isDefined(Z[Ga])||(Ga+=1);Ga=Object.keys(Z[Ga]);var Sa=F.length,db;for(db in Z){var ab=Z[db],ib=za[db],lb=xa[db],tb=ua[db],Gb=Ba[db],Wb=Na[db],Ab=ka[db];Ab=Ab[Ga];Ab=parseFloat(Ab);ab=ab[Ga];ab=parseFloat(ab);if(99999999999<ab||1E4>ab){e=[];break}ab/=100;1E3<p&2E4>Ab||(ib=parseFloat(ib[Ga]),isNaN(ib)||ib<ea||(lb=parseFloat(lb[Ga]),isNaN(lb)?console.log(db,"NIVEL SIGW"):(lb-=273.15,tb=parseFloat(tb[Ga])-273.15,isNaN(tb)||(Gb=parseFloat(Gb[Ga]),
Ab=Wb=parseFloat(Wb[Ga]),0>Ab||(Wb*=Math.PI/180,Wb%=2*Math.PI,htmlTab+="<TR><TD>"+Sa+"</TD> <TD>"+ab+"</TD> <TD>"+ib+"</TD> <TD>"+lb.toFixed(2)+"</TD> <TD>"+tb.toFixed(2)+"</TD> <TD>"+Ab.toFixed(0)+"</TD> <TD>"+Gb.toFixed(2)+"</TD></TR>",ab={n:Sa,p:ab,z:ib,t:lb,td:tb,wD:Wb,wS:Gb},Sa+=1,F.push(ab))))))}}getDataN(e,p,z,F,I)})}else I(F)}var wsond=function(e){};var gfiapp_point_interest=function(e,p){var z=this,F=[],I=!0,ja=function(N,V){var aa=null,da=null,ea=null;setflags=function(){aa&&da&&ea?(lon=aa,lat=da,name=ea,fullUrl=knmiFlagURL+"file="+pointInterestFileName+"&location="+lon+","+lat+"&name="+name,$.ajax({type:"GET",url:fullUrl,success:function(ka){"OK"===ka.status?(ka=Ext.getCmp("webmapjs_add_point_interest"),ka.getEl().dom.style.background="#BCED91",p.getImageStore().clear(),p.draw("draw")):(ka=Ext.getCmp("webmapjs_add_point_interest"),ka.getEl().dom.style.background=
"#FF4040")},dataType:"jsonp",contentType:"application/jsonp",jsonpCallback:"resultSetFlag",crossDomain:!0})):(ea||$("#webmapjs_point_interest_name").css("border","2px solid red"),aa||$("#webmapjs_point_interest_lon").css("border","2px solid red"),da||$("#webmapjs_point_interest_lat").css("border","2px solid red"))};delete_flag=function(){Ext.MessageBox.show({title:I18n.delete_title_confirm.text,msg:I18n.are_you_sure.text,buttons:Ext.MessageBox.YESNO,icon:Ext.MessageBox.WARNING,fn:function(ka){"yes"==
...
tooltip:I18n.delete_selected_flag_tooltip.tooltip,renderTo:"webmapjs_div_selected_point_interest",cls:"webmapjs_button_delete_point_interest",handler:function(){delete_flag()}});$("#webmapjs_point_interest_name, #webmapjs_point_interest_lon, #webmapjs_point_interest_lat").keypress(function(ka){if(13==ka.which)return setflags(),!1});var Z=function(){var ka=e.find(".gfiapp_point_interest");ka.empty();for(var za=p.getLayers(),xa=0;xa<za.length;xa++){var ua=za[xa],Ba=jQuery("<div />",{css:{margin:8}});
ka.append(Ba);Ba.html("LAYER "+ua.service)}z.resize(N,V)};Z();p.addListener("onlayeradd",Z,!0);p.addListener("mouseclicked",function(ka){if(0!=I){var za=p.getLatLongFromPixelCoord({x:ka.x,y:ka.y});aa=za.x;da=za.y;$("#webmapjs_point_interest_lon").val(za.x.toFixed(5));$("#webmapjs_point_interest_lat").val(za.y.toFixed(5));$("#webmapjs_point_interest_lon, #webmapjs_point_interest_lat").css("border","1px solid grey");za=p.getLayers();ka=p.getWMSGetFeatureInfoRequestURL(za[0],ka.x,ka.y).replace("&INFO_FORMAT=text/html",
"&INFO_FORMAT=application/json")+"&JSONP=featureInfoCallback";$.ajax({dataType:"jsonp",jsonpCallback:"featureInfoCallback",type:"GET",cache:!1,url:ka,success:function(xa){xa[1]&&"nodata"!==xa[1].data?($(".webmapjs_label_selected_point_interest").text(xa[1].data),$(".webmapjs_button_delete_point_interest").css("display","inline")):($(".webmapjs_label_selected_point_interest").text(I18n.default_selected_flag.text),$(".webmapjs_button_delete_point_interest").css("display","none"))},error:function(xa,
ua,Ba){debug(ua+", "+Ba)}})}},!0);$("#webmapjs_point_interest_name").on("input",function(ka){onChangeEvents("name",ka)});$("#webmapjs_point_interest_lon").on("input",function(ka){onChangeEvents("lon",ka);changeMapPin()});$("#webmapjs_point_interest_lat").on("input",function(ka){onChangeEvents("lat",ka);changeMapPin()});this.onChangeEvents=function(ka,za){var xa=Ext.getCmp("webmapjs_add_point_interest");xa.getEl().dom.style.background="";xa=Ext.getCmp("webmapjs_delete_point_interest");xa.getEl().dom.style.background=
"";switch(ka){case "name":ea=za.target.value;break;case "lon":aa=za.target.value;break;case "lat":da=za.target.value}$("#webmapjs_point_interest_"+ka).css("border","1px solid grey")};this.changeMapPin=function(){p.positionMapPinByLatLon({x:aa,y:da})};p.enableInlineGetFeatureInfo(!1)};this.enable=function(N,V){ja(N,V);I=!0};this.disable=function(){I=!1;p.enableInlineGetFeatureInfo(!0)};this.resize=function(N,V){for(var aa=0;aa<F.length;aa++)F[aa].setSize(N,V/F.length);for(aa=0;aa<F.length;aa++);};
z.enable()};WMJSExtApplications["Points of interest"]=gfiapp_point_interest;var gfiapp_eprofile=function(e,p){var z=this,F=[],I=function(ja,N){e.html('<div id="info"></div><div class="gfiapp_eprofile">bla</div>');var V=function(ea,Z){Z=Z.id;for(var ka=0;ka<F.length;ka++){var za=F[ka].getWebMapJS();za.suspendEvent("onupdatebbox");ka!=Z&&0==ea.equals(F[ka].getWebMapJS().getProjection().bbox)&&(za.zoomTo(ea),F[ka].updateBBOX(ea));za.resumeEvent("onupdatebbox")}},aa=function(ea,Z){ea=Z.id;for(Z=0;Z<F.length;Z++){var ka=F[Z].getWebMapJS();ka.suspendEvent("onupdatebbox");ka.suspendEvent("onloadingcomplete");
Z!=ea&&ka.draw();ka.resumeEvent("onloadingcomplete");ka.resumeEvent("onupdatebbox")}},da=function(){var ea=e.find(".gfiapp_eprofile");ea.empty();for(var Z=p.getLayers(),ka=0;ka<Z.length;ka++){var za=Z[ka],xa=jQuery("<div />",{css:{margin:8}});ea.append(xa);F[ka]=new GFITimeElevationWindow(xa);F[ka].getWebMapJS().addLayer(za);F[ka].getWebMapJS().getListener().id=ka;F[ka].getWebMapJS().addListener("onupdatebbox",V,!0);F[ka].getWebMapJS().addListener("onloadingcomplete",aa,!0)}z.resize(ja,N)};da();p.addListener("ondimchange",
function(){var ea=F[0].getWebMapJS(),Z=ea.getProjection().bbox.clone();ea=ea.getProjection().bbox.right-ea.getProjection().bbox.left;var ka=(new Date(p.getDimension("time").currentValue)).getTime();Z.left=ka;Z.right=ka+ea;for(ea=0;ea<F.length;ea++)F[ea].getWebMapJS().zoomTo(Z)},!0);p.addListener("onlayeradd",da,!0);console.log(F[0]);F[0].getWebMapJS().addListener("onloadingcomplete",function(){var ea=F[0].getWebMapJS().getProjection().bbox.clone();$("#info").html("Displaying dates "+p.dateToISO8601(new Date(ea.left))+
" till "+p.dateToISO8601(new Date(ea.right)))},!0);p.enableInlineGetFeatureInfo(!1)};this.enable=function(ja,N){I(ja,N)};this.disable=function(){p.enableInlineGetFeatureInfo(!0)};this.resize=function(ja,N){for(var V=0;V<F.length;V++)F[V].setSize(ja,N/F.length);for(V=0;V<F.length;V++);};z.enable()};WMJSExtApplications.EProfile=gfiapp_eprofile;var autowms_app=function(e,p){initWMJS();e.addClass("autowms_app_container");var z="https://geoservices.knmi.nl/autowms?";try{z=autowmsURL}catch(Z){}var F={},I=[],ja=function(Z){var ka=aa();e.html(ka+JSON.stringify(Z));$(".autowms_app_fileitem_return").attr("onclick","").click(function(za){I=[];ea("")});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(za){var xa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){ea(xa)},
100)})},N=function(Z){var ka=Z.name;return Z.leaf?"<span class='autowms_app_fileitem' name='"+Z.name+"'>&#128451;&nbsp;"+ka+"</span>":"<span class='autowms_app_fileitem autowms_app_diritem' name='"+Z.name+"'>&#128448;&nbsp;"+ka+"</span>"},V=function(Z,ka){var za="<span class='autowms_app_layeritem' title='Click to add to viewer' name='"+Z.name+"'><span class='autowms_app_layeritem_text'>Layer "+Z.text+" - ("+Z.name+")</span>";return za+="<span class='autowms_app_layeritem_image'><img src=\""+(ka+
"&service=WMS&request=getmap&format=image/png&layers="+Z.name+"&width=400&CRS=EPSG:4326&STYLES=&EXCEPTIONS=INIMAGE&showlegend=true&"+Math.random())+'" /></span></span>'},aa=function(Z,ka){return"<span class='autowms_app_currentpath'>AutoWMS link: <span class='autowms_app_request_container'><input class='autowms_app_request_input' type=\"text\" value=\""+z+"\"></input>  <span class='autowms_app_request_button'>-></span></span><hr/><span class='autowms_app_currentpath'>Current folder: ./"+(ka+'</span><span class="autowms_app_fileitem_header"><span class="autowms_app_fileitem_return">&#128193;&nbsp;<b>../ (&#8679;)</b></span><span class="autowms_app_fileitem_refresh" name="')+
(ka+'">&#8635;&nbsp;<b>Refresh</b></span></span>')},da=function(Z,ka){e.html("... working ... ");var za=WMJSGetServiceFromStore(ka,xml2jsonrequestURL);za.getLayerObjectsFlat(function(xa){var ua=""+aa(Z,ka);ua+="<span class='autowms_app_serviceabstract'><b>"+za.title.replace(/!/g,"<br/>")+"</b><hr/>"+za.abstract.replace(/!/g,"<br/>");if(ka&&(ua+='<hr/>WMS: <a target="_blank" href="'+ka+'&service=WMS&request=GetCapabilities">'+ka+"</a>",1<ka.split("?").length)){var Ba=new WMJSKVP(ka.split("?")[1]),
Na=ka.split("?")[0].replace("adagucserver","adagucopendap/");Na=Na.replace(/([^:]\/)\/+/g,"$1");Ba.source&&(Na+=Ba.source);Ba.dataset&&(Na+=Ba.dataset+"/");ua=ua+('<hr/>OpenDAP: <span class=\'autowms_app_opendaplinks\'><a target="_blank" href="'+Na+'">'+Na+'</a><a target="_blank" href="')+(Na+'.das">DAS</a><a target="_blank" href="')+(Na+'.dds">DDS</a></span>')}ua+="</span>";e.html("... working ... ");F={};for(Ba=0;Ba<xa.length;Ba++)ua+=V(xa[Ba],ka),F[xa[Ba].name]=xa[Ba];e.html(ua);$(".autowms_app_layeritem").attr("onclick",
"").click(function(Ga){Ga=F[$(this).attr("name")];window.location.hash="addlayer('"+ka+"','"+Ga.name+"')"});$(".autowms_app_fileitem_return").attr("onclick","").click(function(Ga){ea(I.pop())});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(Ga){var Sa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){da(Z,Sa)},100)});$(".autowms_app_request_button").attr("onclick","").click(function(Ga){ea("")});$(".autowms_app_request_input").keyup(function(Ga){13==
Ga.keyCode&&ea("")})},function(xa){xa=aa();xa=xa+"<span class='autowms_app_error_container'><span class='autowms_app_error_container_header'>Unable to get WMS GetCapabilities</span><a target='_blank' href=\""+(ka+'service=WMS&request=GetCapabilities">'+ka+"</a>");e.html(xa+"</span>");$(".autowms_app_fileitem_return").attr("onclick","").click(function(ua){I=[];ea("")})},!0)},ea=function(Z){Z&&"undefined"!==Z||(Z="");var ka=$(".autowms_app_request_input").first().val();ka&&0<ka.length&&(z=ka.trim().split("?")[0],
z.endsWith("?")||(z+="?"));var za=function(ua){if(ua.error)e.html("Error from server: "+ua.error);else{F={};I[I.length-1]!==Z&&I.push(Z);var Ba=aa(ua,Z);e.html("... working ... ");ua.result.sort(function(Ga,Sa){if(Ga.name<=Sa.name)return-1;if(Ga.name>Sa.name)return 1;if(Ga.name==Sa.name)return 0});for(var Na=0;Na<ua.result.length;Na++)Ba+=N(ua.result[Na]),F[ua.result[Na].name]=ua.result[Na];e.html(Ba);$(".autowms_app_fileitem_return").attr("onclick","").click(function(Ga){I.pop();ea(I[I.length-1])});
$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(Ga){var Sa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){ea(Sa)},100)});$(".autowms_app_fileitem").attr("onclick","").click(function(Ga){Ga=F[$(this).attr("name")];!1===Ga.leaf?ea(Ga.path):da(ua,Ga.adaguc)});$(".autowms_app_request_button").attr("onclick","").click(function(Ga){ea("")});$(".autowms_app_request_input").keyup(function(Ga){13==Ga.keyCode&&ea("")})}},
xa=z+"request=getfiles&path="+Z;e.html('... Reading <a href="'+xa+'">'+xa+"</a> ... ");try{$.ajax({contentType:"application/json",crossDomain:!0,type:"GET",url:xa,success:za,error:function(ua){console.error("Request failed without jsonp, trying jsonp");za({result:[]});$.ajax({dataType:"jsonp",contentType:"application/jsonp",crossDomain:!0,type:"GET",url:xa,success:za,error:function(Ba){ja("Unable to do ajax call")}})}})}catch(ua){console.error(ua),ja(ua)}};this.enable=function(){e.html("<div>Initializing...</div>");
ea("")};this.disable=function(){};this.resize=function(Z,ka){}};try{WMJSExtApplications.AutoWMS=autowms_app}catch(e){};
