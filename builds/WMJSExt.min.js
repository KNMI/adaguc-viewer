...
{text:I18n.title.text,dataIndex:"title",flex:2},{text:I18n.layer.text,dataIndex:"name",flex:1},{text:I18n.type.text,dataIndex:"type"}],columnLines:!0,iconCls:"icon-grid"}),listeners:{show:{fn:function(){for(var c=[],e=a.webMapJS.getBaseLayers(),f=0;f<e.length;f++){var p=e[f].title;0==f&&(p="Default base layer");c.push({title:p,layer:e[f],name:e[f].name,enabled:e[f].enabled,type:1==e[f].keepOnTop?"overlay":"baselayer"})}b.loadRawData(c)}}}});this.superclass.initComponent.apply(this,arguments)}});defaultBaselayer={service:"https://testgeoservices.knmi.nl/wms?DATASET=baselayers&",name:"countryborders"};
