...
$jscomp.polyfillIsolated=function(c,l,v,D){var E=c.split(".");c=1===E.length;D=E[0];D=!c&&D in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var X=0;X<E.length-1;X++){var H=E[X];if(!(H in D))return;D=D[H]}E=E[E.length-1];v=$jscomp.IS_SYMBOL_NATIVE&&"es6"===v?D[E]:null;l=l(v);null!=l&&(c?$jscomp.defineProperty($jscomp.polyfills,E,{configurable:!0,writable:!0,value:l}):l!==v&&(void 0===$jscomp.propertyToPolyfillSymbol[E]&&(v=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[E]=$jscomp.IS_SYMBOL_NATIVE?
...
$jscomp.polyfill("Symbol",function(c){if(c)return c;var l=function(X,H){this.$jscomp$symbol$id_=X;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:H})};l.prototype.toString=function(){return this.$jscomp$symbol$id_};var v="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",D=0,E=function(X){if(this instanceof E)throw new TypeError("Symbol is not a constructor");return new l(v+(X||"")+"_"+D++,X)};return E},"es6","es3");
...
$jscomp.asyncExecutePromiseGenerator=function(c){function l(D){return c.next(D)}function v(D){return c.throw(D)}return new Promise(function(D,E){function X(H){H.done?D(H.value):Promise.resolve(H.value).then(l,v).then(X,E)}X(c.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(c){return $jscomp.asyncExecutePromiseGenerator(c())};$jscomp.asyncExecutePromiseGeneratorProgram=function(c){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(c)))};
...
"function"===typeof H?H=new H("unhandledrejection",{cancelable:!0}):"function"===typeof N?H=new N("unhandledrejection",{cancelable:!0}):(H=$jscomp.global.document.createEvent("CustomEvent"),H.initCustomEvent("unhandledrejection",!1,!0,H));H.promise=this;H.reason=this.result_;return K(H)};E.prototype.executeOnSettledCallbacks_=function(){if(null!=this.onSettledCallbacks_){for(var H=0;H<this.onSettledCallbacks_.length;++H)X.asyncExecute(this.onSettledCallbacks_[H]);this.onSettledCallbacks_=null}};var X=
new l;E.prototype.settleSameAsPromise_=function(H){var N=this.createResolveAndReject_();H.callWhenSettled_(N.resolve,N.reject)};E.prototype.settleSameAsThenable_=function(H,N){var K=this.createResolveAndReject_();try{H.call(N,K.resolve,K.reject)}catch(ba){K.reject(ba)}};E.prototype.then=function(H,N){function K(Y,oa){return"function"==typeof Y?function(qa){try{ba(Y(qa))}catch(sa){Z(sa)}}:oa}var ba,Z,P=new E(function(Y,oa){ba=Y;Z=oa});this.callWhenSettled_(K(H,ba),K(N,Z));return P};E.prototype.catch=
...
ba.next())v(Z.value).callWhenSettled_(N,K)})};E.all=function(H){var N=$jscomp.makeIterator(H),K=N.next();return K.done?v([]):new E(function(ba,Z){function P(qa){return function(sa){Y[qa]=sa;oa--;0==oa&&ba(Y)}}var Y=[],oa=0;do Y.push(void 0),oa++,v(K.value).callWhenSettled_(P(Y.length-1),Z),K=N.next();while(!K.done)})};return E},"es6","es3");
$jscomp.findInternal=function(c,l,v){c instanceof String&&(c=String(c));for(var D=c.length,E=0;E<D;E++){var X=c[E];if(l.call(v,X,E,c))return{i:E,v:X}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(c){return c?c:function(l,v){return $jscomp.findInternal(this,l,v).v}},"es6","es3");
...
$jscomp.polyfill("Array.from",function(c){return c?c:function(l,v,D){v=null!=v?v:function(N){return N};var E=[],X="undefined"!=typeof Symbol&&Symbol.iterator&&l[Symbol.iterator];if("function"==typeof X){l=X.call(l);for(var H=0;!(X=l.next()).done;)E.push(v.call(D,X.value,H++))}else for(X=l.length,H=0;H<X;H++)E.push(v.call(D,l[H],H));return E}},"es6","es3");
...
$jscomp.polyfill("WeakMap",function(c){function l(){if(!c||!Object.seal)return!1;try{var ba=Object.seal({}),Z=Object.seal({}),P=new c([[ba,2],[Z,3]]);if(2!=P.get(ba)||3!=P.get(Z))return!1;P.delete(ba);P.set(Z,4);return!P.has(ba)&&4==P.get(Z)}catch(Y){return!1}}function v(){}function D(ba){var Z=typeof ba;return"object"===Z&&null!==ba||"function"===Z}function E(ba){if(!$jscomp.owns(ba,H)){var Z=new v;$jscomp.defineProperty(ba,H,{value:Z})}}function X(ba){if(!$jscomp.ISOLATE_POLYFILLS){var Z=Object[ba];
Z&&(Object[ba]=function(P){if(P instanceof v)return P;Object.isExtensible(P)&&E(P);return Z(P)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(c&&$jscomp.ES6_CONFORMANCE)return c}else if(l())return c;var H="$jscomp_hidden_"+Math.random();X("freeze");X("preventExtensions");X("seal");var N=0,K=function(ba){this.id_=(N+=Math.random()+1).toString();if(ba){ba=$jscomp.makeIterator(ba);for(var Z;!(Z=ba.next()).done;)Z=Z.value,this.set(Z[0],Z[1])}};K.prototype.set=function(ba,Z){if(!D(ba))throw Error("Invalid WeakMap key");
...
E(this,K).entry)&&K.value};D.prototype.entries=function(){return X(this,function(K){return[K.key,K.value]})};D.prototype.keys=function(){return X(this,function(K){return K.key})};D.prototype.values=function(){return X(this,function(K){return K.value})};D.prototype.forEach=function(K,ba){for(var Z=this.entries(),P;!(P=Z.next()).done;)P=P.value,K.call(ba,P[1],P[0],this)};D.prototype[Symbol.iterator]=D.prototype.entries;var E=function(K,ba){var Z=ba&&typeof ba;"object"==Z||"function"==Z?v.has(ba)?Z=
v.get(ba):(Z=""+ ++N,v.set(ba,Z)):Z="p_"+ba;var P=K.data_[Z];if(P&&$jscomp.owns(K.data_,Z))for(K=0;K<P.length;K++){var Y=P[K];if(ba!==ba&&Y.key!==Y.key||ba===Y.key)return{id:Z,list:P,index:K,entry:Y}}return{id:Z,list:P,index:-1,entry:void 0}},X=function(K,ba){var Z=K.head_;return $jscomp.iteratorPrototype(function(){if(Z){for(;Z.head!=K.head_;)Z=Z.previous;for(;Z.next!=Z.head;)return Z=Z.next,{done:!1,value:ba(Z)};Z=null}return{done:!0,value:void 0}})},H=function(){var K={};return K.previous=K.next=
K.head=K},N=0;return D},"es6","es3");
$jscomp.polyfill("Set",function(c){function l(){if($jscomp.ASSUME_NO_NATIVE_SET||!c||"function"!=typeof c||!c.prototype.entries||"function"!=typeof Object.seal)return!1;try{var D=Object.seal({x:4}),E=new c($jscomp.makeIterator([D]));if(!E.has(D)||1!=E.size||E.add(D)!=E||1!=E.size||E.add({x:4})!=E||2!=E.size)return!1;var X=E.entries(),H=X.next();if(H.done||H.value[0]!=D||H.value[1]!=D)return!1;H=X.next();return H.done||H.value[0]==D||4!=H.value[0].x||H.value[1]!=H.value[0]?!1:X.next().done}catch(N){return!1}}
...
function(D){return this.map_.has(D)};v.prototype.entries=function(){return this.map_.entries()};v.prototype.values=function(){return this.map_.values()};v.prototype.keys=v.prototype.values;v.prototype[Symbol.iterator]=v.prototype.values;v.prototype.forEach=function(D,E){var X=this;this.map_.forEach(function(H){return D.call(E,H,H,X)})};return v},"es6","es3");
...
$jscomp.polyfill("Math.hypot",function(c){return c?c:function(l){if(2>arguments.length)return arguments.length?Math.abs(arguments[0]):0;var v,D,E;for(v=E=0;v<arguments.length;v++)E=Math.max(E,Math.abs(arguments[v]));if(1E100<E||1E-100>E){if(!E)return E;for(v=D=0;v<arguments.length;v++){var X=Number(arguments[v])/E;D+=X*X}return Math.sqrt(D)*E}for(v=D=0;v<arguments.length;v++)X=Number(arguments[v]),D+=X*X;return Math.sqrt(D)}},"es6","es3");
$jscomp.polyfill("Math.sign",function(c){return c?c:function(l){l=Number(l);return 0===l||isNaN(l)?l:0<l?1:-1}},"es6","es3");$jscomp.polyfill("Math.log1p",function(c){return c?c:function(l){l=Number(l);if(.25>l&&-.25<l){for(var v=l,D=1,E=l,X=0,H=1;X!=E;)v*=l,H*=-1,E=(X=E)+H*v/++D;return E}return Math.log(1+l)}},"es6","es3");$jscomp.polyfill("Math.log10",function(c){return c?c:function(l){return Math.log(l)/Math.LN10}},"es6","es3");
$jscomp.polyfill("Math.log2",function(c){return c?c:function(l){return Math.log(l)/Math.LN2}},"es6","es3");$jscomp.polyfill("Math.expm1",function(c){return c?c:function(l){l=Number(l);if(.25>l&&-.25<l){for(var v=l,D=1,E=l,X=0;X!=E;)v*=l/++D,E=(X=E)+v;return E}return Math.exp(l)-1}},"es6","es3");
$jscomp.iteratorFromArray=function(c,l){c instanceof String&&(c+="");var v=0,D=!1,E={next:function(){if(!D&&v<c.length){var X=v++;return{value:l(X,c[X]),done:!1}}D=!0;return{done:!0,value:void 0}}};E[Symbol.iterator]=function(){return E};return E};$jscomp.polyfill("Array.prototype.keys",function(c){return c?c:function(){return $jscomp.iteratorFromArray(this,function(l){return l})}},"es6","es3");
...
0,l.dimensionValueLabel.setValueText(WMJSDateTooEarlyString);else if(E==WMJSDateTooLateString)l.currentIndex=l.dimension.size()-1,l.dimensionValueLabel.setValueText(WMJSDateTooLateString);else if(l.currentIndex=this.dimension.getIndexForValue(E),-1!=l.currentIndex)l.dimensionValueLabel.setValueText(l.getValue());else{var X=parseISO8601DateToDate(E),H=parseISO8601DateToDate(l.dimension.get(0)),N=parseISO8601DateToDate(l.dimension.get(l.dimension.size()-1));X.getTime()<H.getTime()?(l.dimensionValueLabel.setValueText(WMJSDateTooEarlyString),
l.layer.setDimension(l.dimension.name,WMJSDateTooEarlyString),l.currentIndex=0):X.getTime()>N.getTime()?(l.dimensionValueLabel.setValueText(WMJSDateTooLateString),l.layer.setDimension(l.dimension.name,WMJSDateTooLateString),l.currentIndex=l.dimension.size()-1):(l.dimensionValueLabel.setValueText(WMJSDateOutSideRange),l.layer.setDimension(l.dimension.name,WMJSDateOutSideRange))}}catch(K){l.dimensionValueLabel.setValueText(WMJSDateOutSideRange),l.layer.setDimension(l.dimension.name,WMJSDateOutSideRange),
l.currentIndex=0}l.dimSlider.suspendEvents();l.dimSlider.setValue(l.currentIndex,!1);l.dimSlider.resumeEvents()};l.checkReferenceTime=function(E){for(var X=-1,H=-1,N=0;N<l.dimensionPanels.length;N++){var K=l.layer.getDimension(l.dimensionPanels[N].dimension.name);"time"==K.name&&"ISO8601"==K.units&&(H=N);"reference_time"==K.name&&"ISO8601"==K.units&&(X=N)}l.dimSlider.suspendEvents();if(-1!=H&&-1!=X&&(N=l.layer.getDimension(l.dimensionPanels[H].dimension.name),K=l.layer.getDimension(l.dimensionPanels[X].dimension.name),
N.getValue()<K.getValue()))if(l.dimensionPanels[X].dimension.name==E.name){E=N.getValue();do E=N.get(N.getIndexForValue(E)+1);while(E<K.getValue());l.dimensionPanels[H].dimSlider.setValue(N.getIndexForValue(E),!1)}else if(l.dimensionPanels[H].dimension.name==E.name){E=K.getValue();do E=K.get(K.getIndexForValue(E)-1);while(E>K.getValue());l.dimensionPanels[X].dimSlider.setValue(K.getIndexForValue(E),!1)}l.dimSlider.resumeEvents()};l.sliderChanged=function(E){try{l.layer.parentMaps[0].stopAnimating()}catch(X){}l.currentIndex=
...
{title:"180 Minutes",name:"PT3H"},{title:"360 Minutes",name:"PT6H"},{title:"Daily",name:"P1D"}]}),D=Ext.create("Ext.form.ComboBox",{fieldLabel:"Choose duration",store:D,queryMode:"local",displayField:"title",valueField:"name",region:"center",listeners:{select:function(E,X){l.timeRangeDuration=X[0].get("name");E=l.dimension.getValue();try{E=l.layer.parentMaps[0].getDimension(l.dimension.name).currentValue}catch(H){}-1!=E.indexOf("/")&&(E=E.split("/")[0]);l.dimension.setTimeRangeDuration(l.timeRangeDuration);
...
c;D.servicePanel=Ext.create("webmapjsext.WMJSExt.ServicePanel",{header:!1,constrain:!0,autoDestroy:!1,height:400,service:D.layerpanel.WMJSLayer.service,name:D.layerpanel.WMJSLayer.name,border:0,itemclick:function(E,X){D.layerpanel.setLayer(X)}});D.window=Ext.create("webmapjsext.WMJSExt.WindowFader",{title:I18n.layers.text,autoDestroy:!1,closeAction:"hide",autoScroll:!0,floating:!0,animate:!0,constrain:!0,width:500,items:[D.servicePanel],bbar:[{iconCls:"button_refresh",handler:function(){D.window.refresh()}},
{text:I18n.embed.text,tooltip:"Embed layer view",handler:function(){D.window.hide();D.layerpanel.add(Ext.create("webmapjsext.WMJSExt.ServicePanel",{title:I18n.layers.text,header:!0,collapsible:!0,service:D.layerpanel.WMJSLayer.service,name:D.layerpanel.WMJSLayer.name,border:2,itemclick:function(E,X,H){D.layerpanel.setLayer(X,H)}}))}},{scale:"small",tooltip:I18n.add_new_layer.tooltip,iconCls:"layer_logos button_layerlist_layernew",handler:function(){Ext.create("webmapjsext.WMJSExt.DataPanel",{dataPanelClicked:function(E){D.layerpanel.service=
E.service;D.layerpanel.name=E.layer;D.layerpanel.WMJSLayer.service=D.layerpanel.service;D.layerpanel.WMJSLayer.name=D.layerpanel.name;D.layerpanel.parseLayer(!0,function(X,H){isDefined(E.ready)&&E.ready(l,D.layerpanel.parentWebMapJS)});return l},webMapJS:D.layerpanel.parentWebMapJS}).show()}}]});D.window.refresh=function(){D.servicePanel.buildTreeFromNodes(!0)};return D.window}}});var webmapjsext_WMJSExt_LayerPanel_ServicePanelManager,getServicePanelManager=function(){webmapjsext_WMJSExt_LayerPanel_ServicePanelManager||(webmapjsext_WMJSExt_LayerPanel_ServicePanelManager=Ext.create("webmapjsext.WMJSExt.ServicePanelManager",{}));return webmapjsext_WMJSExt_LayerPanel_ServicePanelManager};
...
(c.WMJSLayer.setDimension(H,N),K.setValue(N)):error("WMJSExtLayerPanel::Dimension "+H+" not found")};c.getDimensionPanel=function(H){for(var N=0;N<c.dimensionPanels.length;N++)if(c.dimensionPanels[N].dimension.name===H)return c.dimensionPanels[N]};var X=function(H){var N=H;H.message&&(N=H.message);c.setLoading(!1);H="Unable to parse layer "+c.WMJSLayer.name+"\n"+N;c.WMJSLayer.hasError=!0;error(H)};E=function(H){if(void 0!=c.WMJSLayer.parentMaps[0])if(c.WMJSLayer!=H)isDefined(H)&&X("WMJSExtLayerPanel internal error:\n"+
...
I18n.title.text+"</i></td><td> "+c.WMJSLayer.WMJSService.title+"</td></tr><tr><td><i>"+I18n.service.text+"</i></td><td>"+c.WMJSLayer.WMJSService.onlineresource+"</td></tr><tr><td><i>"+I18n.abstract.text+"</i></td><td>"+c.WMJSLayer.WMJSService.abstract+"</td></tr></table></span>"):c.layerAbstractPanel.update("...");H=function(){var P=c.WMJSLayer.parentMaps[0].getLegendGraphicURLForLayer(c.WMJSLayer),Y=c.WMJSLayer.parentMaps[0].getLegendStore();if(c.layerLegendPanel.getEl()){var oa=$(c.layerLegendPanel.getEl().dom).find("canvas")[0].getContext("2d");
(P=Y.getImageForSrc(P))?(oa.rect(0,0,90,250),oa.fillStyle="white",oa.fill(),oa.drawImage(P.getElement()[0],0,0)):(oa.rect(0,0,90,250),oa.fillStyle="gray",oa.fill())}};c.WMJSLayer.parentMaps[0].getListener().addToCallback("onlegendready",H,!0);H()}};try{if(c.WMJSLayer.parseLayer(E,l,"LayerPanel::parseLayer",xml2jsonrequestURL),!0===l)try{console.log("clearing cache"),c.WMJSLayer&&c.WMJSLayer.parentMaps&&0<c.WMJSLayer.parentMaps.length&&(c.WMJSLayer.parentMaps[0].clearImageStore(),c.WMJSLayer.parentMaps[0].loadLegendInline(!0))}catch(H){console.error(H)}}catch(H){X(H)}}};
...
l.setIconCls("button_play_animation");else if(l.setIconCls("button_stop_animation"),l=c.WMJSLayer.getDimension("time"),void 0==l)alert(I18n.no_time_dimension_in_layer.text);else{var v=[],D=l.size(),E=D-24,X=D,H=l.getIndexForValue(l.currentValue);H=X-1-H;E-=H;X-=H;0>E&&(X+=-E,E=0);0>X&&(X=0);E>D-1&&(E=D-1);X>D&&(X=D);for(D=E;D<X;D++)v.push({name:l.name,value:l.getValueForIndex(D)});c.WMJSLayer.parentMaps[0].draw(v)}}};c.moveUp=function(){var l=c.up("panel"),v=l.items.indexOf(c);0<v&&(l.move(v,v-1),
...
trackOver:!0,overItemCls:"x-item-over",itemSelector:"div.thumb-wrap",emptyText:"No images to display",listeners:{itemclick:function(E,X){c.dataPanelClicked({title:X.get("title"),thumbnail:X.get("thumbnail"),service:X.get("service"),layer:X.get("layer"),srs:X.get("srs"),bbox:X.get("bbox"),style:X.get("style"),baselayerservice:X.get("baselayerservice"),baselayername:X.get("baselayername"),opacity:X.get("opacity")});c.close()}}})});webmapjsext.WMJSExt.DataPanel.superclass.initComponent.apply(this,arguments)}});var defaultBaselayer={service:"https://geoservices.knmi.nl/cgi-bin/worldmaps.cgi?",name:"world_line"};
...
{text:I18n.title.text,dataIndex:"title",flex:2},{text:I18n.layer.text,dataIndex:"name",flex:1},{text:I18n.type.text,dataIndex:"type"}],columnLines:!0,iconCls:"icon-grid"}),listeners:{show:{fn:function(){for(var v=[],D=c.webMapJS.getBaseLayers(),E=0;E<D.length;E++){var X=D[E].title;0==E&&(X="Default base layer");v.push({title:X,layer:D[E],name:D[E].name,enabled:D[E].enabled,type:1==D[E].keepOnTop?"overlay":"baselayer"})}l.loadRawData(v)}}}});this.superclass.initComponent.apply(this,arguments)}});defaultBaselayer={service:"https://geoservices.knmi.nl/wms?DATASET=baselayers&",name:"countryborders"};
...
labelWidth:110,disabled:!0,store:v,displayField:"name",valuefield:"name",queryMode:"local",listeners:{select:{fn:function(N,K){X(K[0].get("wmjsdimension"))}}}}]},{xtype:"panel",itemId:"dimensionvaluespanel",frame:!0,border:!1,margin:3,layout:"border",height:36,items:[{xtype:"label",text:I18n.start_at.text+":",width:110,region:"west",margin:3},{itemId:"dimensioncurrentvalue",xtype:"textfield",region:"center",frame:!1,border:!1,margin:3},{xtype:"button",region:"east",width:23,iconCls:"button_refresh",
...
X=Ext.create("Ext.data.Store",{fields:["title","srs","bbox"],data:{items:[]},proxy:{type:"memory",reader:{type:"json",root:"items"}}}),H=Ext.create("Ext.grid.Panel",{border:!1,store:X,columns:[{text:"Title",dataIndex:"title",flex:1},{text:"ESPG Code",dataIndex:"srs"}],listeners:{select:{fn:function(sa,xa){sa=xa.get("bbox");v=xa.get("srs");E=sa;ba.getComponent("column2").getComponent("areaPanel").getComponent("bboxtop").setValue(sa.split(",")[3]);ba.getComponent("column2").getComponent("areaPanel").getComponent("bbox").getComponent("bboxwest").setValue(sa.split(",")[0]);
...
try{Ea=epsgDescriptionLookup[sa.supportedProjections[xa].srs]}catch(La){}isDefined(Ea)||(Ea=sa.supportedProjections[xa].srs);X.add({title:Ea,srs:sa.supportedProjections[xa].srs,bbox:sa.supportedProjections[xa].bbox})}xa=X.find("srs",sa.nativeCRS);-1==xa&&(xa=X.find("srs","EPSG:4326"));-1==xa&&(xa=0);H.getView().select(xa);X.add({title:"Viewer window projection and area",srs:this.srs,bbox:this.bbox});ba.getComponent("column2").getComponent("gridproperties").getComponent("field").getComponent("rasterwidth").setValue(sa.width);
...
function Console(c){function l(E){E=(E+"").replace(/&/g,"&amp;");E=E.replace(/</g,"&lt;");E=E.replace(/>/g,"&gt;");E=E.replace(/"/g,"&quot;");return E=E.replace(/\n/g,"<br>")}var v=c,D="";this.println=function(E,X){D=0==X?D+("<p class='stdoutmessage'>"+E+"</p>"):D+("<p class='stdoutmessage'>"+l(E)+"</p>");isDefined(v)&&(v.innerHTML=D,v.scrollTop=v.scrollHeight);17824<D.length&&(D=D.substring(D.length-13368))};this.errprintln=function(E,X){D=0==X?D+("<p class='stderrmessage'>"+E+"</p>"):D+("<p class='stderrmessage'>"+
l(E)+"</p>");isDefined(v)&&(v.innerHTML=D,v.scrollTop=v.scrollHeight)};this.cls=function(){D="";isDefined(v)&&(v.innerHTML=D)};this.setSize=function(E,X){isDefined(v)&&(v.scrollTop=v.scrollHeight,v.style.width=E+"px",v.style.height=X+"px",v.width=E+"px",v.height=X+"px")};this.setElement=function(E){v=E;initWMJS();isDefined(v)&&(v.style.overflow="scroll",v.style.display="inline-block",v.style.position="absolute",v.style.width="100%",v.style.height="100%",v.style.font="normal 12px courier",v.noWrap=
...
l=-2,v=0;v<c.length;v++)if(1==c[v].selected){l=v-1;c[v].close();break}c=getLayerObjects();0<c.length&&-2!=l&&(0>l&&(l=0),l>c.length-1&&(l=c.length-1),c[l].select())},createNewLayerPanel=function(c,l){0==isDefined(l)&&(l=[]);var v=void 0;isDefined(l.service)&&(v=l.service);var D=void 0;isDefined(l.name)&&(D=l.name);var E=void 0;isDefined(l.style)&&(E=l.style);var X=void 0;isDefined(l.opacity)&&0<(""+l.opacity).length&&(X=l.opacity);var H=void 0;isDefined(l.enabled)&&(H=l.enabled);var N=void 0;isDefined(l.autoChooseLayer)&&
(N=l.autoChooseLayer);isDefined(H)||(H=!0);var K=Ext.getCmp("layerlistpanel");K.removeLayer=removeLayer;v=Ext.create("webmapjsext.WMJSExt.LayerPanel",{parentPanelList:K,title:D,service:v,name:D,style:E,opacity:X,enabled:H,autoChooseLayer:N,parentWebMapJS:c,afterlayerready:function(ba){1!=ba.layerAddedToWebMapJS&&(ba.WMJSLayer.enabled=this.enabled,ba.layerAddedToWebMapJS=!0);l.ready?(l.ready(ba,c),l.ready=void 0):(1==l.zoomtolayer&&(l.zoomtolayer=!1,c.setProjection(ba.WMJSLayer.getProjection("EPSG:4326"))),
...
resize:{fn:function(){l.applicationSettings.app&&l.applicationSettings.app.resize(l.width,mainWebmapJS.webMapJS.getHeight())}}},setApplication:function(P){l.applicationSettings=P}});c=Ext.create("Ext.panel.Panel",{region:"center",layout:"border",split:!0,frame:!1,border:!1,margin:0,items:[mainWebmapJS,l]});var v=function(P){console.log(P.slot);var Y=createNewLayerPanel(mainWebmapJS.webMapJS,{service:P.service,name:P.layer,style:P.style,opacity:P.opacity,ready:function(oa,qa){var sa=P.srs,xa=P.bbox,
Ea=P.baselayername,Ca=P.baselayerservice;sa&&!xa?qa.setProjection(oa.getProjection(sa)):sa&&xa&&qa.setProjection({srs:sa,bbox:xa});Ea&&Ca?(mainWebmapJS.baseLayer.setService(Ca),mainWebmapJS.baseLayer.name=Ea,mainWebmapJS.baseLayer.parseLayer(function(){qa.draw("dataPanelClicked::parseLayer")},void 0,"WMJSExtMain::dataPanelClicked")):qa.draw("dataPanelClicked");isDefined(Y)&&isDefined(P.ready)&&(P.ready(Y,qa),1==Y.WMJSLayer.hasError&&Y.close())}});return Y},D,E=new Console;Ext.create("Ext.panel.Panel",
{html:'<div id="debuginfodiv"></div>',layout:"fit",listeners:{afterrender:{fn:function(){E.setElement(document.getElementById("debuginfodiv"))}}}});var X=[{text:I18n.show_time_selection_window.text,iconCls:"button_settings_icon",handler:function(){timeselectorWindow.show()}},{text:I18n.create_animation.text+"&hellip;",iconCls:"button_settings_icon",handler:function(){Ext.create("Ext.window.Window",{title:I18n.create_animation.text,width:460,height:300,layout:"form",autoDestroy:!0,closeAction:"destroy",
...
[]}for(var H={},N=0;N<getFeatureInfoApplications.length;H={$jscomp$loop$prop$location$80$289:H.$jscomp$loop$prop$location$80$289},N++)H.$jscomp$loop$prop$location$80$289=getFeatureInfoApplications[N],X.push({text:getFeatureInfoApplications[N].name,iconCls:getFeatureInfoApplications[N].iconCls,location:getFeatureInfoApplications[N].location,handler:function(P){return function(){console.log(P.$jscomp$loop$prop$location$80$289);l.setApplication(P.$jscomp$loop$prop$location$80$289);l.hide();l.show()}}(H)}),
getFeatureInfoApplications.open&&H.$jscomp$loop$prop$location$80$289.name===getFeatureInfoApplications.open&&l.setApplication(H.$jscomp$loop$prop$location$80$289);X.push({text:I18n.about_the_adaguc_viewer.text,iconCls:"button_info",tooltip:I18n.about_the_adaguc_viewer.tooltip,handler:function(){Ext.create("Ext.window.Window",{title:I18n.about_adaguc.text,height:200,width:400,modal:!0,layout:"fit",items:{xtype:"panel",html:'<div class="about_adaguc" style="position:absolute;top:0px;left:0px;height:100px;width:520px;"/><div style="position:absolute;top:100px;padding:10px;margin:10px;">'+
...
handler:function(){var P=getSelectedLayer();isDefined(P)&&P.duplicateLayer()}},{xtype:"button",tooltip:I18n.remove_this_layer.tooltip,iconCls:"button_layerlist_layerdelete",handler:function(P,Y){removeLayer()}},{xtype:"button",tooltip:I18n.move_layer_up.tooltip,iconCls:"button_layerlist_layerup",handler:function(P,Y){P=getSelectedLayer();isDefined(P)&&P.moveUp()}},{xtype:"button",tooltip:I18n.move_layer_down.tooltip,iconCls:"button_layerlist_layerdown",handler:function(P,Y){P=getSelectedLayer();isDefined(P)&&
P.moveDown()}},{xtype:"tbfill"},{iconCls:"button_settings_icon",tooltip:I18n.settings_and_options.tooltip,menu:{xtype:"menu",items:X}}]});H=Ext.create("webmapjsext.WMJSExt.MapTypeSelector",{maptypeclicked:function(P){mainWebmapJS.webMapJS.setProjection({bbox:P.get("bbox"),srs:P.get("srs")});(P=P.get("baselayer"))&&P.service&&P.name&&(P.enabled=!0,mainWebmapJS.baseLayer.setService(P.service),mainWebmapJS.baseLayer.name=P.name,mainWebmapJS.baseLayer.enabled=!0,isDefined(P.transparent)&&(mainWebmapJS.baseLayer.transparent=
...
Ext.create("webmapjsext.WMJSExt.FolderPanel",{dataPanelClicked:v,webMapJS:mainWebmapJS.webMapJS}).show()}}),H.width+=30);H.tbar.push({iconCls:"button_settings32",tooltip:I18n.settings_and_options.tooltip,scale:"large",menu:{xtype:"menu",items:X}});var ba=Ext.create("Ext.Viewport",{layout:"border",items:[H,c],renderTo:Ext.getBody(),listeners:{resize:{fn:function(){try{var P=viewportwestpanelwindow.y+viewportwestpanelwindow.height;P>ba.height&&(P=ba.height-70,70>P&&(P=70));viewportwestpanelwindow.setSize(viewportwestpanelwindow.width,
P)}catch(Y){}}}}}),Z=function(P){var Y=!0,oa=!1;isDefined(P.collapse)&&"1"==P.collapse&&Ext.getCmp("viewportwestpanel").collapse();isDefined(P.zoomtolayer)&&"1"==P.zoomtolayer&&(Y=!0);isDefined(P.srs)&&isDefined(P.bbox)&&mainWebmapJS.webMapJS.setProjection({srs:P.srs,bbox:P.bbox});if(isDefined(P.service)){clearLayers(mainWebmapJS.webMapJS);var qa=URLDecode(P.service).split(","),sa=[""];isDefined(P.layer)?sa=URLDecode(P.layer).split(","):1==Y&&(oa=!0);isDefined(P.selected);for(var xa=sa.length,Ea=
...
P.autowms&&(autowmsURL=P.autowms+"",-1===autowmsURL.indexOf("?")&&(autowmsURL+="?"),window.setTimeout(function(){l.setApplication(getFeatureInfoApplications.filter(function(gb){return"AutoWMS"===gb.name})[0]);l.hide();l.show()},100));P&&P.wms&&(console.log("wms found",P.wms),createNewLayerPanel(mainWebmapJS.webMapJS,{service:P.wms}))};0==window.location.hash.length&&Z(getUrlVars());checkIfHashTagChanged(function(P,Y){if(0<=P.indexOf("addlayer('")){if(Y=P.substring(P.indexOf("addlayer('")+10,P.indexOf("',")),
P=P.substring(P.indexOf(",'")+2,P.indexOf("')")),Y&&P){for(var oa=!1,qa=mainWebmapJS.webMapJS.getLayers(),sa=0;sa<qa.length;sa++)if(qa[sa].service==Y&&qa[sa].name==P){oa=!0;break}0==oa&&(isDefined(hashLocationNotfiyAddLayer),firstTimeOpening=!0,createNewLayerPanel(mainWebmapJS.webMapJS,{service:Y,name:P,zoomtolayer:!1,notifyadded:!0}))}}else 0<=P.indexOf("positionmappinbylatlon(")?(debug(P),Y=P.substring(23,P.indexOf(")")),debug(Y),Y=Y.split(","),debug(Y[0]+" "+Y[1]),mainWebmapJS.webMapJS.positionMapPinByLatLon({x:parseFloat(Y[0]),
y:parseFloat(Y[1])})):0<=P.indexOf("refreshlayers")?updateLayers():Z(Y)});getFeatureInfoApplications.open&&l.show()});var gfiapp_d3c3=function(c,l){var v=function(Z,P){$("#"+P).empty();$("#"+P).append("<div style='height=240px;border=2px solid blue;' class='chart'>a</div>");$("#"+P).append("<div style='height=40px;border=2px solid red;' class='controls gfiapp_d3c3_export_to_csv_button'>b</div>");var Y=$("#"+P).find(".chart");P=$("#"+P).find(".controls");Y.html("graph");P.button({label:"Export to CSV"}).click(function(){console.log("Export to CSV");for(var oa="",qa=Z.datatoplot,sa=0;sa<qa[0].length;sa++){for(var xa=
0;xa<qa.length;xa++)0<xa&&(oa+=";"),oa+=JSON.stringify(qa[xa][sa]);oa+="\n\r"}qa=document.createElement("a");qa.setAttribute("download","export.csv");qa.setAttribute("href",encodeURI("data:text/csv;charset=utf-8,"+oa));console.log("Clicking link");document.body.appendChild(qa);qa.click();qa.remove()});c3.generate({bindto:Y.get(0),data:{x:"x",x_format:"%Y%m%d",columns:Z.datatoplot,types:{x:"area"}},axis:{x:{type:"timeseries",tick:{format:Z.timeFormat}},y:{label:Z.ylabel}},zoom:{enabled:!0},subchart:{show:!1}})},
D=function(Z,P){return Z>P?1:Z<P?-1:0},E=function(Z,P){var Y;for(Y=0;Y<P.length;Y++)try{if(P[Y].getTime()===Z.getTime())return Y}catch(oa){}return-1},X=function(Z,P){var Y=1;"string"!=typeof Z[0].dims&&(Y=Z[0].dims.length);for(var oa=[],qa=function(Ca,La,Qa){var Ua=["x"];Ca=[La.name+" "+Ca];for(var Xa in Qa){La=d3.time.format("%Y-%m-%dT%H:%M:%SZ").parse(Xa);var db=parseFloat(Qa[Xa]);Ua.push(La);Ca.push(db)}oa.push({date:Ua,value:Ca})},sa=function(Ca,La,Qa,Ua){if(1==Y)qa("",La,Qa);else if(Ca+2<Y)for(d in Qa)sa(Ca+
...
h,n,m){null==n&&(n=0);null==m&&(m=g.length);m=b(g,h,n,m-1);return m>n&&e(g[m-1],h)>-e(g[m],h)?m-1:m},right:function(g,h,n,m){null==n&&(n=0);null==m&&(m=g.length);for(;n<m;){var p=n+m>>>1;0<f(g[p],h)?m=p:n=p+1}return n}}}function D(a){return function(b,e){return l(a(b),e)}}function E(a){return null===a?NaN:+a}function X(a,b){var e,f,g,h,n,m;return $jscomp.generator.createGenerator(X,function(p){switch(p.nextAddress){case 1:if(void 0===b){p.jumpTo(2);break}e=-1;f=$jscomp.makeIterator(a);g=f.next();
...
-1,m=$jscomp.makeIterator(a);for(f=m.next();!f.done;f=m.next()){var p=f.value;null!=(p=b(p,++n,a))&&(p=+p)>=p&&(f=p-g,g+=f/++e,h+=f*(p-g))}}if(1<e)return h/(e-1)}function Y(a,b){return(a=P(a,b))?Math.sqrt(a):a}function oa(a,b){var e,f;if(void 0===b){a=$jscomp.makeIterator(a);for(var g=a.next();!g.done;g=a.next())b=g.value,null!=b&&(void 0===e?b>=b&&(e=f=b):(e>b&&(e=b),f<b&&(f=b)))}else{var h=-1,n=$jscomp.makeIterator(a);for(g=n.next();!g.done;g=n.next())g=g.value,null!=(g=b(g,++h,a))&&(void 0===e?
...
(h-n)*p/h+m)),g)}h=a[b];n=e;p=f;pc(a,e,b);for(0<g(a[f],h)&&pc(a,e,f);n<p;){pc(a,n,p);++n;for(--p;0>g(a[n],h);)++n;for(;0<g(a[p],h);)--p}0===g(a[e],h)?pc(a,e,p):(++p,pc(a,p,f));p<=b&&(e=p+1);b<=p&&(f=p-1)}return a}function pc(a,b,e){var f=a[b];a[b]=a[e];a[e]=f}function qc(a,b,e){a=Float64Array.from(X(a,e));if(e=a.length){if(0>=(b=+b)||2>e)return Ec(a);if(1<=b)return Dc(a);b*=e-1;e=Math.floor(b);var f=Dc(Qc(a,e).subarray(0,e+1));a=Ec(a.subarray(e+1));return f+(a-f)*(b-e)}}function ed(a,b,e){e=void 0===
...
function(k){return new On(k)};c.curveStep=function(k){return new Cg(k,.5)};c.curveStepAfter=function(k){return new Cg(k,1)};c.curveStepBefore=function(k){return new Cg(k,0)};c.descending=function(k,A){return A<k?-1:A>k?1:A>=k?0:NaN};c.deviation=Y;c.difference=function(k,A){for(var I=[],G=1;G<arguments.length;++G)I[G-1]=arguments[G];k=new Set(k);I=$jscomp.makeIterator(I);for(G=I.next();!G.done;G=I.next()){G=$jscomp.makeIterator(G.value);for(var J=G.next();!J.done;J=G.next())k.delete(J.value)}return k};
...
vj;c.symbolCross=mp;c.symbolDiamond=op;c.symbolSquare=rp;c.symbolStar=qp;c.symbolTriangle=sp;c.symbolWye=tp;c.symbols=rx;c.text=Gf;c.thresholdFreedmanDiaconis=function(k,A,I){return Math.ceil((I-A)/(2*(qc(k,.75)-qc(k,.25))*Math.pow(H(k),-1/3)))};c.thresholdScott=function(k,A,I){return Math.ceil((I-A)/(3.5*Y(k)*Math.pow(H(k),-1/3)))};c.thresholdSturges=Cc;c.tickFormat=Gm;c.tickIncrement=ub;c.tickStep=pb;c.ticks=Ab;c.timeDay=ce;c.timeDays=Zv;c.timeFormatDefaultLocale=on;c.timeFormatLocale=Zm;c.timeFriday=
...
function(){var va=Na.on.apply(Na,arguments);return va===Na?k:va};k.clickDistance=function(va){return arguments.length?(nb=(va=+va)*va,k):Math.sqrt(nb)};k.tapDistance=function(va){return arguments.length?(qb=+va,k):qb};return k};c.zoomIdentity=Dg;c.zoomTransform=Tn;Object.defineProperty(c,"__esModule",{value:!0})});var WMSVersion={version100:"1.0.0",version111:"1.1.1",version130:"1.3.0"},htmlTabS="",htmlTabM="",tddjs=function(c,l){var v=!0,D=[],E=D.set=!1,X=!1,H=null,N=null,K=function(ba){var Z,P,Y,oa,qa,sa,xa,Ea,Ca;return $jscomp.asyncExecutePromiseGeneratorProgram(function(La){Y="";E&&(H.close(),E=!1);X&&(N.close(),X=!1);document.getElementById("info").innerHTML=Y;if(0==v)return La.return();D.x=ba.x;D.y=ba.y;D.set=!0;Z=l.getLatLongFromPixelCoord({x:ba.x,y:ba.y});P=l.getLayers();if(!isDefined(P))return $("#info").html("No valid data received:<br/>"+
data),La.return();info=l.getLayers().getFeatureInfoUrl;Y="";0==l.layers.length?(Y="No layer: Load a valid layer.",document.getElementById("info").innerHTML=Y):document.getElementById("info").innerHTML="";oa=[];for(qa=0;qa<l.layers.length;qa++)sa=l.layers[l.layers.length-qa-1].service,sa.includes("TEMP")?oa.push(l.layers[l.layers.length-qa-1]):sa.includes("ECMWF")&&oa.push(l.layers[l.layers.length-qa-1]);0==oa.length?(Y="No Sounding or Model Layer: Load a valid layer.",document.getElementById("info").innerHTML=
...
Y+="Profile for location ["+Math.round(100*Z.x)/100+","+Math.round(100*Z.y)/100+"]";Y+=" - Model:"+Qa.meta.model+"<br/>";document.getElementById("info").innerHTML=Y;document.getElementById("table").innerHTML=""}else Y+="Profile for location ["+Math.round(100*Z.x)/100+","+Math.round(100*Z.y)/100+"]",Y+=" - Station:"+Qa.meta.name+"<br/>",document.getElementById("info").innerHTML=Y,document.getElementById("table").innerHTML="",htmlTabM+="</TABLE>";document.getElementById("table").innerHTML=htmlTabM}else Y+=
"MOD:No valid data<br/>",document.getElementById("info").innerHTML=Y})):oa[xa].service.includes("TEMP")&&(Ca=oa[xa],getJSONdata(Ca,l,D.x,D.y,"text/plain",function(Qa){null!=Qa?(console.log(Qa),null!=Qa.data?(N=window.open("sondTemp.html","Sondeo",'itemId="sond",toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=1040,height=600'),N.myvar=Qa,X=!0,Y="",Y+="Profile for location ["+Math.round(100*Z.x)/100+","+Math.round(100*Z.y)/100+"]",Y+=" - Station:"+Qa.meta.name+"<br/>",document.getElementById("info").innerHTML=
Y,document.getElementById("table").innerHTML=""):(Y+="Profile for location ["+Math.round(100*Z.x)/100+","+Math.round(100*Z.y)/100+"]",Y+=" - Station:"+Qa.meta.name+"<br/>",document.getElementById("info").innerHTML=Y,document.getElementById("table").innerHTML="",htmlTabS+="</TABLE>"),document.getElementById("table").innerHTML=htmlTabS):(Y+="OBS: No valid data<br/>",document.getElementById("info").innerHTML=Y)}));La.jumpToEnd()})};l.addListener("mouseclicked",K,!0);this.enable=function(){c.html('<div id="info"></div><div id="table"></div>');
$("#info").html("Click on the map to load a profile.<br/> A Sounding or ECMWF Model layer loaded is necessary");l.enableInlineGetFeatureInfo(!1);v=!0};this.disable=function(){v=!1;l.enableInlineGetFeatureInfo(!0);D.set=!1;E&&(H.close(),E=!1);X&&(N.close(),X=!1)};this.resize=function(ba,Z){$("#mitdd").width(ba);D.set&&K(D)};this.enable()};try{WMJSExtApplications.Sondeo=tddjs}catch(c){}
...
function MakeHTTPRequest_s(c,l,v,D){function E(H){errorfunction?errorfunction(H,pointer):l(void 0,pointer)}c=-1===c.indexOf("?")?c+"?":c+"&";c+="rand="+Math.random();v||(v=!1);try{var X=createXHR();X.open("GET",c,!0);X.onreadystatechange=function(){if(4===X.readyState)if(200===X.status){try{var H=X.responseText}catch(N){E("Exception occured:"+N);return}void 0===H||""===H?E("request returned no data"):l(null,X.response)}else console.log("ERROR",c),l(null,X.response)};X.send(null)}catch(H){window.alert("AQUI"),
!1===v?(c=D+"REQUEST="+URLEncode(c),MakeHTTPRequest_s(c,l,errorfunction,pointer,!0,D)):E("status("+X.status+") to "+c)}}
function getJSONModel(c,l,v,D,E,X){var H,N,K,ba,Z,P,Y,oa,qa;return $jscomp.asyncExecutePromiseGeneratorProgram(function(sa){H=c.service.split("=")[1];H=H.replace("&","");N=[];"ECMWF"==H&&(N=[1E3,925,850,700,500,400,300,250,200,150,100]);"ECMWF-HRES"==H&&(N=[1E3,925,900,850,800,700,600,500,400,300,250,200,150,100]);document.getElementById("info").innerHTML="Procesando<br>";document.getElementById("table").innerHTML="";K=WMJScheckURL(c.service);K+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;
...
H);try{Z+="&"+l._getMapDimURL(c),K+=Z,ba+=Z}catch(xa){X(null,void 0)}req_list=[];for(P=0;P<N.length;P++)Y=N[P],oa=ba+"&elevation="+Y,req_list.push(oa);req_list.reverse();htmlTabM="<TABLE BORDER>";htmlTabM+="<TR> <TD>Nivel</TD> <TD>P</TD> <TD>Z</TD> <TD>T</TD> <TD>RH</TD> <TD>U</TD> <TD>V</TD> </TR>";qa=[];getMeta_Model(K,function(xa){null!=xa?(xa.model=H,getDataN_Model(req_list,qa,0,function(Ea){X({meta:xa,data:Ea})})):X(null)});sa.jumpToEnd()})}
function getJSONdata(c,l,v,D,E,X){document.getElementById("info").innerHTML="Procesando<br>";document.getElementById("table").innerHTML="";var H=WMJScheckURL(c.service);H+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;H+="&LAYERS="+URLEncode(c.name);c.name.split(",");E=H;H+="&QUERY_LAYERS=p,z,t,td,windSpd,windDir,eVSS&INFO_FORMAT=application/json";E+="&QUERY_LAYERS=station_name,ps,alt,station_cname&INFO_FORMAT=application/json";var N="&"+getBBOXandProjString(c,l);N+="WIDTH="+l.width;N+=
"&HEIGHT="+l.height;if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)N=N+("&X="+v)+("&Y="+D);c.version===WMSVersion.version130&&(N=N+("&I="+v)+("&J="+D));N+="&FORMAT=image/gif&STYLES=";try{N+="&"+l._getMapDimURL(c),H+=N,E+=N}catch(ba){callback(null,void 0)}debug('<a target="_blank" href="'+H+'">'+H+"</a>",!1);var K=c.service+"&SERVICE=WMS&REQUEST=getCapabilities&VERSION="+c.version;getMeta(E,function(ba){null!=ba?(console.log("META",ba),getData(K,ba,H,function(Z){X({meta:ba,
data:Z})})):X(null)})}function WMJScheckURL(c){if(!isDefined(c))return"?";c=c.trim();-1===c.indexOf("?")&&(c+="?");return c}function isDefined(c){return"undefined"===typeof c?!1:!0}
...
return v}function getLevels(c,l){var v=new ol.format.WMSCapabilities;fetch(c).then(function(D){return D.text()}).then(function(D){D=v.read(D).Capability.Layer.Layer;D=$jscomp.makeIterator(D);for(var E=D.next();!E.done;E=D.next())if(E=E.value,"t"==E.Name){E=$jscomp.makeIterator(E.Dimension);for(var X=E.next();!X.done;X=E.next())X=X.value,"elevation"==X.name&&l(X.default)}})}
function getMeta(c,l){console.log("REQ META",c);MakeHTTPRequest_s(c,function(v,D){if(null!=v)console.error(v);else{v=[];try{var E=JSON.parse(D),X=E[0].point.coords;X=X.split(",");var H=parseFloat(X[0]),N=parseFloat(X[1]),K=Object.keys(E[0].data),ba=K.toString();ba=ba.split("T");var Z=ba[0].replaceAll("-","");Z=parseInt(Z);var P=parseInt(ba[1].substring(0,2)),Y;for(D=0;D<E.length;D++){if("station_name_backup"==E[D].name){if(isDefined(oa))continue;var oa=E[D].data[K]}if("ps"==E[D].name){if(isDefined(qa))continue;
var qa=E[D].data[K]/100;isNaN(qa)&&(qa=E[D].data[0]/100)}if("alt"==E[D].name){if(isDefined(sa))continue;var sa=parseFloat(E[D].data[K]);isNaN(sa)&&(sa=parseFloat(E[D].data[0]))}"station_cname_backup"!=E[D].name||isDefined(Y)||(Y=E[D].data[K])}isDefined(oa)&&"nodata"!=oa?(isNaN(sa)&&(sa=0),v={model:"OBSERVACION",index:oa,date:Z,run:P,step:0,lon:H,lat:N,ps:qa,zs:sa,name:oa+" "+Y},l(v)):l(null)}catch(xa){l(null)}}})}
function getData(c,l,v,D){htmlTabS="<TABLE BORDER>";htmlTabS+="<TR> <TD>Nivel</TD> <TD>P</TD> <TD>Z</TD> <TD>T</TD> <TD>TD</TD> <TD>WD</TD> <TD>WS</TD> </TR>";getLevels(c,function(E){null==E&&(window.errorMessage("No hay niveles!"),D(null));var X=parseInt(E),H=Math.floor(X/100);X%=100;for(var N=0,K=0,ba=[],Z=0;Z<H;Z++)K=N+99,ba.push(v+"&elevation="+N+"/"+K),N=K+1;ba.push(v+"&elevation="+N+"/"+(N+X));ba=ba.reverse();var P=[];getDataN(ba,E,l,P,function(Y){null==Y&&(window.errorMessage("No hay niveles!"),
D(null));if(0==P.length)window.alert("El sondeo no tiene datos validos para este diagrama"),D(null);else{Y=parseFloat(P[P.length-1].p);var oa=parseFloat(P[0].p);850>=oa?(window.alert("El primer nivel esta demasiado alto! - P0: "+oa+"hpa\n\n El primer nivel debe ser mayor de 850hPa"),D(null)):300<Y?(window.alert("Ultimo nivel demasiado bajo! - Pn: "+Y+"hpa\n\n El ultimo nivel debe ser menor de 300hPa"),D(null)):(htmlTabS+="</TABLE>",D(P))}})})}
function getDataN(c,l,v,D,E){if(0!=c.length){var X=c.pop(),H=X.indexOf("elevation");H=X.slice(H);var N=H.indexOf("=")+1,K=H.indexOf("/"),ba=H.slice(N,K);console.log("Procesando nivles",ba,"a",parseInt(ba)+99,"de",l);$("#tableinfo").html("");$("#info").html("");$("#table").html("");$("#tableM").html("");$("#tableS").html("");document.getElementById("info").innerHTML="";document.getElementById("info").innerHTML='<img src="./img/ajax-loader.gif" alt="Loading..."/>';MakeHTTPRequest_s(X,function(Z,P){if(null!=
Z)console.error(Z);else if(!P.includes("ServiceException")){Z=v.zs;var Y=100;150>v.ps&&(Y=100);P=JSON.parse(P);P=$jscomp.makeIterator(P);for(var oa=P.next();!oa.done;oa=P.next()){dat=oa.value;if("p"==dat.name)var qa=dat.data;if("z"==dat.name)var sa=dat.data;if("t"==dat.name)var xa=dat.data;if("td"==dat.name)var Ea=dat.data;if("windSpd"==dat.name)var Ca=dat.data;if("windDir"==dat.name)var La=dat.data;if("eVSS"==dat.name)var Qa=dat.data}P=parseInt(ba);isDefined(qa[P])||(P+=1);P=Object.keys(qa[P]);oa=
D.length;for(var Ua in qa){var Xa=qa[Ua],db=sa[Ua],gb=xa[Ua],rb=Ea[Ua],Ab=Ca[Ua],ub=La[Ua],pb=Qa[Ua];pb=pb[P];parseFloat(pb);Xa=Xa[P];Xa=parseFloat(Xa);Xa/=Y;999999999<Xa||0>Xa||(db=parseFloat(db[P]),gb=parseFloat(gb[P]),gb-=273.15,rb=parseFloat(rb[P])-273.15,Ab=parseFloat(Ab[P]),pb=ub=parseFloat(ub[P]),ub*=Math.PI/180,ub%=2*Math.PI,htmlTabS+="<TR><TD>"+oa+"</TD> <TD>"+Xa+"</TD> <TD>"+db+"</TD> <TD>"+gb.toFixed(2)+"</TD> <TD>"+rb.toFixed(2)+"</TD> <TD>"+pb.toFixed(0)+"</TD> <TD>"+Ab.toFixed(2)+"</TD></TR>",
db<Z||isNaN(gb)||isNaN(rb)||0>pb||(Xa={n:oa,p:Xa,z:db,t:gb,td:rb,wD:ub,wS:Ab},oa+=1,D.push(Xa)))}}getDataN(c,l,v,D,E)})}else E(D)}
function getMeta_Model(c,l){console.log(c);MakeHTTPRequest_s(c,function(v,D){if(null!=v)console.error(v);else try{var E=JSON.parse(D),X=Object.keys(E[0].data)[0];fi=(new Date(X)).getTime();date=X.split("T");var H=date[0].replaceAll("-","");H=parseInt(H);var N=parseInt(date[1].substring(0,2)),K=Object.keys(E[0].data[X])[0],ba=((new Date(K)).getTime()-fi)/36E5,Z=E[0].data[X][K];Z=parseFloat(Z);meta={model:"ECMWF",index:"MODEL",date:H,run:N,step:ba,lon:0,lat:0,ps:Z,zs:0,name:"MODEL"};l(meta)}catch(P){l(null)}})}
function getDataN_Model(c,l,v,D){0<c.length?(rml=c.pop(),$("#tableinfo").html(""),$("#info").html(""),$("#table").html(""),$("#tableM").html(""),$("#tableS").html(""),document.getElementById("info").innerHTML="",document.getElementById("info").innerHTML='<img src="./img/ajax-loader.gif" alt="Loading..."/>',MakeHTTPRequest_s(rml,function(E,X){if(null!=E)console.error(E);else{var H=JSON.parse(X),N=Object.keys(H[0].data)[0],K=Object.keys(H[0].data[N])[0],ba=Object.keys(H[0].data[N][K])[0];E=parseFloat(H[0].data[N][K][ba]);
X=parseFloat(H[1].data[N][K][ba]);var Z=parseFloat(H[2].data[N][K][ba]),P=-1*parseFloat(H[3].data[N][K][ba]);H=-1*parseFloat(H[4].data[N][K][ba]);K=parseFloat(K);htmlTabM+="<TR><TD>"+v+"</TD> <TD>"+K+"</TD> <TD>"+E+"</TD> <TD>"+X.toFixed(2)+"</TD> <TD>"+Z.toFixed(2)+"</TD> <TD>"+H.toFixed(2)+"</TD> <TD>"+P.toFixed(2)+"</TD></TR>";l.push({n:v,p:K,z:E,t:X,RH:Z,u:H,v:P});l.sort(function(Y,oa){return Y.p-oa.p})}v++;getDataN_Model(c,l,v,D)})):(htmlTabM+="</TABLE>",D(l))}var wsond=function(c){};var table="",wmjsond,yradar=function(c,l){function v(Y,oa){if(Y.length!=oa.length)return!1;for(var qa=0;qa<Y.length;qa++)if(!oa.includes(Y[qa]))return!1;for(qa=0;qa<oa.length;qa++)if(!Y.includes(oa[qa]))return!1;return!0}function D(){for(var Y=[],oa=0;oa<l.layers.length;oa++)l.layers[l.layers.length-oa-1].service.includes("YRAD")&&Y.push(l.layers[l.layers.length-oa-1].name);return Y}wmjsond=l;var E=!0,X="",H=[],N=!1,K=[];H.set=!1;var ba=null,Z=function(Y){N&&(ba.close(),N=!1);var oa=[];qa="";document.getElementById("info").innerHTML=
qa;if(0!=E)if(H.x=Y.x,H.y=Y.y,H.set=!0,l.getLatLongFromPixelCoord({x:Y.x,y:Y.y}),Y=l.getLayers(),isDefined(Y)){info=l.getLayers().getFeatureInfoUrl;var qa="";0==l.layers.length&&(qa="No layer: Load a valid YRADAR layer.",document.getElementById("info").innerHTML=qa);Y=[];for(qa=0;qa<l.layers.length;qa++)l.layers[l.layers.length-qa-1].service.includes("YRAD")&&Y.push(l.layers[l.layers.length-qa-1]);qa=null;for(var sa in Y)qa=Y[sa],null!=qa&&""!==qa.getFeatureInfoUrl?!1===qa.queryable?l.featureInfoRequestReady("Layer is not queryable.",
...
xa),ba.focus())});N=!0}}else $("#info").html("No valid data received:<br/>"+data)};l.addListener("mouseclicked",Z,!0);l.addListener("ondimchange",function(Y){return $jscomp.asyncExecutePromiseGeneratorProgram(function(oa){if(1==oa.nextAddress)return N&&ba.close(),$("#tableinfo").html(""),$("#info").html(""),$("#table").html(""),document.getElementById("info").innerHTML="",document.getElementById("info").innerHTML='<img src="./img/ajax-loader.gif" alt="Loading..."/>',oa.yield(new Promise(function(qa){return setTimeout(qa,
500)}),2);console.log("DIM REFRESH!!!");P();oa.jumpToEnd()})},!0);l.addListener("onimageload",function(Y){var oa;return $jscomp.asyncExecutePromiseGeneratorProgram(function(qa){oa=D();v(oa,K)||(console.log("IMG REFRESH!!!"),P());qa.jumpToEnd()})},!0);var P=function(){K=D();c.html('<div id="tableinfo"></div><div id="info"></div><div id="table"></div>');$("#tableinfo").html("");$("#info").html("");$("#table").html("");var Y='<img src="./img/ajax-loader.gif" alt="Loading..."/>';document.getElementById("info").innerHTML=
Y;var oa=[];for(Y=0;Y<l.layers.length;Y++)l.layers[l.layers.length-Y-1].service.includes("YRAD")&&oa.push(l.layers[l.layers.length-Y-1]);0==oa.length&&(Y="No YRADAR Layer: Load a valid YRADAR layer.",document.getElementById("info").innerHTML=Y);Y={};for(var qa in oa){var sa=oa[qa];if(null!=sa&&""!==sa.getFeatureInfoUrl)if(!1===sa.queryable)l.featureInfoRequestReady("Layer is not queryable.",sa);else if(sa.name.includes("2D")||sa.name.includes("3D")){var xa=oa[qa];Y.$jscomp$loop$prop$path$303="";Y.$jscomp$loop$prop$rad$304=
xa.name.substr(-3,3);Y.$jscomp$loop$prop$dim$302="2D";xa.name.includes("3D")&&(Y.$jscomp$loop$prop$dim$302="3D");sa=WMJScheckURL(xa.service).split("/");var Ea=sa[0];sa=sa[2];Y.$jscomp$loop$prop$path$303=Ea+"//"+sa+"/";getJSONdate(xa,l,"text/plain",function(Ca){return function(La){var Qa=La.substring(0,La.indexOf("T"));La=La.substring(La.indexOf("T")+1,La.indexOf("Z")-2);X!=Qa+La&&(X=Qa+La);"3D"==Ca.$jscomp$loop$prop$dim$302?Ca.$jscomp$loop$prop$path$303+="yradar/"+Qa+La+"REG3D":xa.name.includes("NAC")?
...
Xa.length;gb++)0===gb&&db.push(Xa[gb]),Xa[gb].includes(Ca.$jscomp$loop$prop$rad$304)&&db.push(Xa[gb]);Xa=db}Xa=getTable(Xa,Ca.$jscomp$loop$prop$rad$304,Ca.$jscomp$loop$prop$dim$302,l);$("#tableinfo").append(table+Ua+Xa);$("#info").html("Click on the map to load a profile.<br>")}})}}(Y))}Y={$jscomp$loop$prop$dim$302:Y.$jscomp$loop$prop$dim$302,$jscomp$loop$prop$path$303:Y.$jscomp$loop$prop$path$303,$jscomp$loop$prop$rad$304:Y.$jscomp$loop$prop$rad$304}}l.enableInlineGetFeatureInfo(!1)};this.enable=
function(){P();E=!0};this.disable=function(){E=!1;l.enableInlineGetFeatureInfo(!0);H.set=!1;N&&(ba.close(),N=!1)};this.resize=function(Y,oa){$("#mitdd").width(Y);H.set&&Z(H)}};try{WMJSExtApplications.Yradar=yradar}catch(c){}
function createXHR(){try{return new XMLHttpRequest}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(c){}try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(c){}try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(c){}return!1}
...
E("request returned no data"):l(null,H.response)}else X()};H.send(null)}catch(N){X()}}
function getCells(c,l,v,D,E){var X=c.name;X.includes("2D")&&getJSONdata2D(c,l,v,D,"text/plain",function(H){document.getElementById("info").innerHTML="";if(null!=H){var N=H.ANA,K=H.RAYOS,ba=H.MOV;H="<br>CENTROIDE 2D <b>"+(N.ID+"</b> : ["+N.LATCEN+","+N.LONCEN+"]");var Z="<TABLE BORDER><TR> <TD>ID</TD> <TD>NUPIX</TD> <TD>ZMAX</TD> <TD>ZMED</TD> <TD>RADIOE</TD> <TD>ECTOP</TD> <TD>VIL</TD> </TR><TR><TD><b>"+(N.ID+"</b></TD> <TD>"+N.NUPIX+"</TD> <TD>"+N.ZMAX+"</TD> <TD>"+N.ZMED+"</TD> <TD>"+N.RADIOE+"</TD> <TD>"+
...
"<div><p><b>ADVERSIDAD: </b>"+N.ADV+"</p></div>");E(H+(Z+P+K+ba))}else H="<br>"+(X+" Wrong point!!! <b>"),E(H)});X.includes("3D")&&getJSONdata3D(c,l,v,D,"text/plain",function(H){document.getElementById("info").innerHTML="";if(null!=H){var N=H.ANA,K=H.GRANIZO;H=H.MOV;var ba="CENTROIDE 3D <b>"+N.ID+"</b> : ["+N.LATCEN+","+N.LONCEN+"]";var Z="<TABLE BORDER><TR> <TD>ID</TD> <TD>ZMAX</TD> <TD>ESPE</TD> <TD>ECTOP</TD> <TD>DVIL</TD> <TD>DVGR</TD> <TD>HB45</TD> <TD>HBAS</TD> <TD>DVCE</TD> </TR><TR><TD><b>"+
(N.ID+"</b></TD> <TD>"+N.ZMAX+"</TD> <TD>"+N.ESPE+"</TD> <TD>"+N.ECTOP+"</TD> <TD>"+N.DVIL+"</TD> <TD>"+N.DVGR+"</TD> <TD>"+N.HB45+"</TD> <TD>"+N.HBAS+"</TD> <TD>"+N.DVCE+"</TD></TR>");Z+="</TABLE>";var P=K.GRA,Y="color:#00FF00";"g"==P&&(Y="color:#AAAA00");"G"==P&&(Y="color:#FF0000");P="<div><p><b>GRANIZO:</b><b style="+Y+">"+P+"</b><br><b>ORG-PER:</b>"+(K.ORG+"<br>");P+="<b>PGR:</b>"+K.PGR+"<br>";P+="<b>TAM(mm):</b>"+K.TAM+"<br>";P+="</p></div>";K=parseInt(N.ADV);Y="color:#00FF00";var oa="Sin Pot. Adv.";
1==K&&(Y="color:#AAAA00",oa="Alto Pot. Adv.");2==K&&(Y="color:#FF0000",oa="Muy alto Pot. Adv");N="<div><p><b>ADVERSIDAD: </b><b style="+Y+">"+oa+"</b><br><b>CELULA 2D: </b>"+(parseInt(N.N2D)+"<br>");ba+=Z+("<div><p><b>MOVIMIENTO:</b></br><b>V(Km/h):</b>"+(H.VKMH+"<b> DIRN:</b>"+H.DIRN+"</p></div>"))+P+(N+"</p></div></br>")}else ba="<br>"+(X+" wrong point!!!<b>");E(ba)})}
function getJSONdate(c,l,v,D){v=WMJScheckURL(c.service);v+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;v+="&LAYERs="+URLEncode(c.name);v+="&QUERY_LAYERS="+URLEncode(c.name)+"&INFO_FORMAT=application/json&FORMAT=application/json";v+="&"+getBBOXandProjString(c,l)+"&WIDTH=400";v+="&"+l._getMapDimURL(c);MakeHTTPRequest(v,function(E,X){null!=E?(console.error(E),D(null)):(E=JSON.parse(X),E=Object.keys(E[0].data)[0],E=E.replaceAll(":",""),E=E.replaceAll("-",""),D(E))})}
function getJSONdata2D(c,l,v,D,E,X){document.getElementById("info").innerHTML="Procesando<br>";document.getElementById("table").innerHTML="";E=WMJScheckURL(c.service);E+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;E+="&LAYERS="+URLEncode(c.name);c.name.split(",");var H="";E+="&QUERY_LAYERS="+URLEncode(c.name)+"&INFO_FORMAT=application/json";H+="&"+getBBOXandProjString(c,l);H+="WIDTH="+l.width;H+="&HEIGHT="+l.height;if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)H=
H+("&X="+v)+("&Y="+D);c.version===WMSVersion.version130&&(H=H+("&I="+v)+("&J="+D));H+="&FORMAT=image/gif&STYLES=";try{H+="&"+l._getMapDimURL(c),E+=H}catch(N){X(null)}MakeHTTPRequest(E,function(N,K){if(null!=N)console.error(N),X(null);else{N=JSON.parse(K);var ba;for(ba in N){K=N[ba];if("RADIOE"==K.name&&(!isDefined(Z)||"nodata"==Z[Object.keys(Z)]))var Z=K.data;if("NUPIX"==K.name)var P=K.data;if("LATCEN"==K.name)var Y=K.data;if("LONCEN"==K.name)var oa=K.data;if("ECTOP"==K.name)var qa=K.data;if("VIL"==
...
if("RY/K"==K.name)var Ab=K.data;if("LATCENR"==K.name)var ub=K.data;if("LONCENR"==K.name)var pb=K.data;if("DIRN"==K.name)var Oc=K.data;if("V(KMH)"==K.name)var Cc=K.data}try{var dd=Z[Object.keys(Z)],Dc=P[Object.keys(P)];if(isDefined(Y))var Ec=Y[Object.keys(Y)];if(isDefined(oa))var Qc=oa[Object.keys(oa)];if(isDefined(qa))var pc=qa[Object.keys(qa)];if(isDefined(sa))var qc=sa[Object.keys(sa)];var ed=Ea[Object.keys(Ea)],fd=Ca[Object.keys(Ca)],Cd=Qa[Object.keys(Qa)],gd=Ua[Object.keys(Ua)],Dd=Xa[Object.keys(Xa)],
...
ECTOP:pc,VIL:qc};X({ANA:ff,RAYOS:{RAY:Cd,POS:gd,NEG:Dd,INT:ne,DISTMAX:Yb,DISTMED:Ed,"RY/KM":oe,LATCENR:cf,LONCENR:Yg},MOV:{DIRN:Zg,VKMH:df}})}catch(ah){console.log(ah),X(null)}}});debug('<a target="_blank" href="'+E+'">'+E+"</a>",!1)}
function getJSONdata3D(c,l,v,D,E,X){document.getElementById("info").innerHTML="Procesando<br>";document.getElementById("table").innerHTML="";E=WMJScheckURL(c.service);E+="&SERVICE=WMS&REQUEST=GetFeatureInfo&VERSION="+c.version;E+="&LAYERS="+URLEncode(c.name);c.name.split(",");var H="";E+="&QUERY_LAYERS="+URLEncode(c.name)+"&INFO_FORMAT=application/json";H+="&"+getBBOXandProjString(c,l);H+="WIDTH="+l.width;H+="&HEIGHT="+l.height;if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)H=
H+("&X="+v)+("&Y="+D);c.version===WMSVersion.version130&&(H=H+("&I="+v)+("&J="+D));H+="&FORMAT=image/gif&STYLES=";try{H+="&"+l._getMapDimURL(c),E+=H}catch(N){X(null)}MakeHTTPRequest(E,function(N,K){if(null!=N)console.error(N),X(null);else{N=JSON.parse(K);var ba;for(ba in N){K=N[ba];if("ID_backup"==K.name)var Z=K.data;if("LATCEN"==K.name)var P=K.data;if("LONCEN"==K.name)var Y=K.data;if("DVCE"==K.name)var oa=K.data;if("DVGR"==K.name)var qa=K.data;if("ECTOP"==K.name)var sa=K.data;if("ESPE"==K.name&&
...
K.name)var Ab=K.data;if("DIRN"==K.name)var ub=K.data;if("V(KMH)"==K.name)var pb=K.data}try{var Oc=P[Object.keys(P)],Cc=Y[Object.keys(Y)],dd=oa[Object.keys(oa)],Dc=qa[Object.keys(qa)],Ec=sa[Object.keys(sa)],Qc=xa[Object.keys(xa)];oa="0";isDefined(Ea)&&(oa=Ea[Object.keys(Ea)]);var pc=Ca[Object.keys(Ca)],qc=La[Object.keys(La)],ed=Qa[Object.keys(Qa)],fd=Ua[Object.keys(Ua)];Qa="0";isDefined(db)&&(Qa=db[Object.keys(db)]);db="0";isDefined(gb)&&(db=gb[Object.keys(gb)]);var Cd=rb[Object.keys(rb)],gd=Ab[Object.keys(Ab)],
Dd=ub[Object.keys(ub)],ne=pb[Object.keys(pb)],Yb=Z[Object.keys(Z)];Z="0";isDefined(Xa)&&(Z=Xa[Object.keys(Xa)]);var Ed={LATCEN:Oc,LONCEN:Cc,ID:Yb,DVCE:dd,DVGR:Dc,ESPE:Qc,HB45:pc,HBAS:qc,ECTOP:Ec,DVIL:ed,ZMAX:fd,N2D:Qa,ADV:Z};granizo={GRA:oa,ORG:db,PGR:Cd,TAM:gd};X({ANA:Ed,GRANIZO:granizo,MOV:{DIRN:Dd,VKMH:ne}})}catch(oe){X(null)}}});debug('<a target="_blank" href="'+E+'">'+E+"</a>",!1)}function WMJScheckURL(c){if(!isDefined(c))return"?";c=c.trim();-1===c.indexOf("?")&&(c+="?");return c}
function isDefined(c){return"undefined"===typeof c?!1:!0}
function URLEncode(c){if(!c||void 0===c||""===c||"string"!==typeof c)return c;var l="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz%-_.!~*'()",v="0123456789ABCDEF";c=c.replace(/%/g,"%25");c=c.replace(/\+/g,"%2B");c=c.replace(/ /g,"%20");c=c.replace(/\^/g,"%5E");c=c.replace(/&/g,"%26");c=c.replace(/\?/g,"%3F");c=c.replace(/>/g,"%3E");c=c.replace(/</g,"%3C");c=c.replace(/\\/g,"%5C");for(var D="",E=0;E<c.length;E++){var X=c.charAt(E);if(" "===X)D+="%20";else if(-1!==l.indexOf(X))D+=X;
else{var H=X.charCodeAt(0);255<H?(alert("Unicode Character '"+X+"' cannot be encoded using standard URL encoding.\n(URL encoding only supports 8-bit characters.)\nA space (+) will be substituted."),D+="+"):(D+="%",D+=v.charAt(H>>4&15),D+=v.charAt(H&15))}}return D}
function getBBOXandProjString(c,l){var v="";if(c.version===WMSVersion.version100||c.version===WMSVersion.version111)v+="SRS="+URLEncode(l.srs)+"&",v+="BBOX="+l.bbox.left+","+l.bbox.bottom+","+l.bbox.right+","+l.bbox.top+"&";c.version===WMSVersion.version130&&(v+="CRS="+URLEncode(l.srs)+"&",v="EPSG:4326"===l.srs&&!1===c.wms130bboxcompatibilitymode?v+("BBOX="+l.bbox.bottom+","+l.bbox.left+","+l.bbox.top+","+l.bbox.right+"&"):v+("BBOX="+l.bbox.left+","+l.bbox.bottom+","+l.bbox.right+","+l.bbox.top+"&"));
return v}function getnum(c,l){console.log(wmjsond);console.log("PULSE!!",c,l,5E4);wmjsond.calculateBoundingBoxAndZoom(c,-1*l,1E5)}
function getTable(c,l,v,D){var E="NUM RAD NUPIX ZMAX ZMED VIL ZMXV DIRN V(KMH) NEG POS RAYo RAY ADV".split(" "),X="NUM NUPIX ZMAX ZMED VIL DIRN V(KMH) NEG POS RAYo RAY".split(" "),H="NUM RAD ZMAX ESPE ECTOP DVIL ADV GRA".split(" ");D=["LATCEN","LONCEN"];X="2D"==v?"NAC"==l?X:E:H;l=c[0].split(",");v=[];for(E=0;E<X.length;E++)l.includes(X[E])&&v.push(l.indexOf(X[E]));X=[];for(E=0;E<D.length;E++)l.includes(D[E])&&X.push(l.indexOf(D[E]));D=[];l=[];for(E=0;E<c.length;E++){H=c[E].split(",");var N=[];l.push([H[X[0]],
H[X[1]]]);for(var K=0;K<v.length;K++)N.push(H[v[K]]);isDefined(N[1])&&D.push(N)}c='<table id="my-table">';for(v=0;v<D.length;v++){0===v&&(c+="<thead>");c+="<tr>";E=D[v];X=l[v];for(H=0;H<E.length;H++)0===v?(c+="<th>",c+=E[H],c+="</th>"):(c=0===H?c+('<td style="cursor:pointer;color:#00f" onclick="getnum('+X[0]+","+X[1]+')">'):c+"<td>",c+=E[H],c+="</td>");0===v?(c+="</tr>",c+="</thead>",c+="<tbody>"):c+="</tr>"}c+="</tbody></table>";1==D.length&&(c="<b>NO CELLS</b></br>");return c};var gfiapp_point_interest=function(c,l){var v=this,D=[],E=!0,X=function(H,N){var K=null,ba=null,Z=null;setflags=function(){K&&ba&&Z?(lon=K,lat=ba,name=Z,fullUrl=knmiFlagURL+"file="+pointInterestFileName+"&location="+lon+","+lat+"&name="+name,$.ajax({type:"GET",url:fullUrl,success:function(Y){"OK"===Y.status?(Y=Ext.getCmp("webmapjs_add_point_interest"),Y.getEl().dom.style.background="#BCED91",l.getImageStore().clear(),l.draw("draw")):(Y=Ext.getCmp("webmapjs_add_point_interest"),Y.getEl().dom.style.background=
"#FF4040")},dataType:"jsonp",contentType:"application/jsonp",jsonpCallback:"resultSetFlag",crossDomain:!0})):(Z||$("#webmapjs_point_interest_name").css("border","2px solid red"),K||$("#webmapjs_point_interest_lon").css("border","2px solid red"),ba||$("#webmapjs_point_interest_lat").css("border","2px solid red"))};delete_flag=function(){Ext.MessageBox.show({title:I18n.delete_title_confirm.text,msg:I18n.are_you_sure.text,buttons:Ext.MessageBox.YESNO,icon:Ext.MessageBox.WARNING,fn:function(Y){"yes"==
...
$("#webmapjs_point_interest_name").on("input",function(Y){onChangeEvents("name",Y)});$("#webmapjs_point_interest_lon").on("input",function(Y){onChangeEvents("lon",Y);changeMapPin()});$("#webmapjs_point_interest_lat").on("input",function(Y){onChangeEvents("lat",Y);changeMapPin()});this.onChangeEvents=function(Y,oa){var qa=Ext.getCmp("webmapjs_add_point_interest");qa.getEl().dom.style.background="";qa=Ext.getCmp("webmapjs_delete_point_interest");qa.getEl().dom.style.background="";switch(Y){case "name":Z=
oa.target.value;break;case "lon":K=oa.target.value;break;case "lat":ba=oa.target.value}$("#webmapjs_point_interest_"+Y).css("border","1px solid grey")};this.changeMapPin=function(){l.positionMapPinByLatLon({x:K,y:ba})};l.enableInlineGetFeatureInfo(!1)};this.enable=function(H,N){X(H,N);E=!0};this.disable=function(){E=!1;l.enableInlineGetFeatureInfo(!0)};this.resize=function(H,N){for(var K=0;K<D.length;K++)D[K].setSize(H,N/D.length);for(K=0;K<D.length;K++);};v.enable()};
WMJSExtApplications["Points of interest"]=gfiapp_point_interest;var gfiapp_eprofile=function(c,l){var v=this,D=[],E=function(X,H){c.html('<div id="info"></div><div class="gfiapp_eprofile">bla</div>');var N=function(Z,P){P=P.id;for(var Y=0;Y<D.length;Y++){var oa=D[Y].getWebMapJS();oa.suspendEvent("onupdatebbox");Y!=P&&0==Z.equals(D[Y].getWebMapJS().getProjection().bbox)&&(oa.zoomTo(Z),D[Y].updateBBOX(Z));oa.resumeEvent("onupdatebbox")}},K=function(Z,P){Z=P.id;for(P=0;P<D.length;P++){var Y=D[P].getWebMapJS();Y.suspendEvent("onupdatebbox");Y.suspendEvent("onloadingcomplete");
P!=Z&&Y.draw();Y.resumeEvent("onloadingcomplete");Y.resumeEvent("onupdatebbox")}},ba=function(){var Z=c.find(".gfiapp_eprofile");Z.empty();for(var P=l.getLayers(),Y=0;Y<P.length;Y++){var oa=P[Y],qa=jQuery("<div />",{css:{margin:8}});Z.append(qa);D[Y]=new GFITimeElevationWindow(qa);D[Y].getWebMapJS().addLayer(oa);D[Y].getWebMapJS().getListener().id=Y;D[Y].getWebMapJS().addListener("onupdatebbox",N,!0);D[Y].getWebMapJS().addListener("onloadingcomplete",K,!0)}v.resize(X,H)};ba();l.addListener("ondimchange",
function(){var Z=D[0].getWebMapJS(),P=Z.getProjection().bbox.clone();Z=Z.getProjection().bbox.right-Z.getProjection().bbox.left;var Y=(new Date(l.getDimension("time").currentValue)).getTime();P.left=Y;P.right=Y+Z;for(Z=0;Z<D.length;Z++)D[Z].getWebMapJS().zoomTo(P)},!0);l.addListener("onlayeradd",ba,!0);console.log(D[0]);D[0].getWebMapJS().addListener("onloadingcomplete",function(){var Z=D[0].getWebMapJS().getProjection().bbox.clone();$("#info").html("Displaying dates "+l.dateToISO8601(new Date(Z.left))+
" till "+l.dateToISO8601(new Date(Z.right)))},!0);l.enableInlineGetFeatureInfo(!1)};this.enable=function(X,H){E(X,H)};this.disable=function(){l.enableInlineGetFeatureInfo(!0)};this.resize=function(X,H){for(var N=0;N<D.length;N++)D[N].setSize(X,H/D.length);for(N=0;N<D.length;N++);};v.enable()};WMJSExtApplications.EProfile=gfiapp_eprofile;var autowms_app=function(c,l){initWMJS();c.addClass("autowms_app_container");var v="https://geoservices.knmi.nl/autowms?";try{v=autowmsURL}catch(P){}var D={},E=[],X=function(P){var Y=K();c.html(Y+JSON.stringify(P));$(".autowms_app_fileitem_return").attr("onclick","").click(function(oa){E=[];Z("")});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(oa){var qa=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){Z(qa)},
100)})},H=function(P){var Y=P.name;return P.leaf?"<span class='autowms_app_fileitem' name='"+P.name+"'>&#128451;&nbsp;"+Y+"</span>":"<span class='autowms_app_fileitem autowms_app_diritem' name='"+P.name+"'>&#128448;&nbsp;"+Y+"</span>"},N=function(P,Y){var oa="<span class='autowms_app_layeritem' title='Click to add to viewer' name='"+P.name+"'><span class='autowms_app_layeritem_text'>Layer "+P.text+" - ("+P.name+")</span>";return oa+="<span class='autowms_app_layeritem_image'><img src=\""+(Y+"&service=WMS&request=getmap&format=image/png&layers="+
P.name+"&width=400&CRS=EPSG:4326&STYLES=&EXCEPTIONS=INIMAGE&showlegend=true&"+Math.random())+'" /></span></span>'},K=function(P,Y){return"<span class='autowms_app_currentpath'>AutoWMS link: <span class='autowms_app_request_container'><input class='autowms_app_request_input' type=\"text\" value=\""+v+"\"></input>  <span class='autowms_app_request_button'>-></span></span><hr/><span class='autowms_app_currentpath'>Current folder: ./"+(Y+'</span><span class="autowms_app_fileitem_header"><span class="autowms_app_fileitem_return">&#128193;&nbsp;<b>../ (&#8679;)</b></span><span class="autowms_app_fileitem_refresh" name="')+
(Y+'">&#8635;&nbsp;<b>Refresh</b></span></span>')},ba=function(P,Y){c.html("... working ... ");var oa=WMJSGetServiceFromStore(Y,xml2jsonrequestURL);oa.getLayerObjectsFlat(function(qa){var sa=""+K(P,Y);sa+="<span class='autowms_app_serviceabstract'><b>"+oa.title.replace(/!/g,"<br/>")+"</b><hr/>"+oa.abstract.replace(/!/g,"<br/>");if(Y&&(sa+='<hr/>WMS: <a target="_blank" href="'+Y+'&service=WMS&request=GetCapabilities">'+Y+"</a>",1<Y.split("?").length)){var xa=new WMJSKVP(Y.split("?")[1]),Ea=Y.split("?")[0].replace("adagucserver",
"adagucopendap/");Ea=Ea.replace(/([^:]\/)\/+/g,"$1");console.log("dapURL",Ea);xa.source&&(Ea+=xa.source);xa.dataset&&(Ea+=xa.dataset+"/");sa=sa+('<hr/>OpenDAP: <span class=\'autowms_app_opendaplinks\'><a target="_blank" href="'+Ea+'">'+Ea+'</a><a target="_blank" href="')+(Ea+'.das">DAS</a><a target="_blank" href="')+(Ea+'.dds">DDS</a></span>')}sa+="</span>";c.html("... working ... ");D={};for(xa=0;xa<qa.length;xa++)sa+=N(qa[xa],Y),D[qa[xa].name]=qa[xa];c.html(sa);$(".autowms_app_layeritem").attr("onclick",
"").click(function(Ca){Ca=D[$(this).attr("name")];window.location.hash="addlayer('"+Y+"','"+Ca.name+"')"});$(".autowms_app_fileitem_return").attr("onclick","").click(function(Ca){Z(E.pop())});$(".autowms_app_fileitem_refresh").attr("onclick","").click(function(Ca){var La=$(this).attr("name");$(".autowms_app_fileitem").remove();$(".autowms_app_layeritem").remove();setTimeout(function(){ba(P,La)},100)});$(".autowms_app_request_button").attr("onclick","").click(function(Ca){Z("")});$(".autowms_app_request_input").keyup(function(Ca){13==
Ca.keyCode&&Z("")})},function(qa){qa=K();qa=qa+"<span class='autowms_app_error_container'><span class='autowms_app_error_container_header'>Unable to get WMS GetCapabilities</span><a target='_blank' href=\""+(Y+'service=WMS&request=GetCapabilities">'+Y+"</a>");c.html(qa+"</span>");$(".autowms_app_fileitem_return").attr("onclick","").click(function(sa){E=[];Z("")})},!0)},Z=function(P){P&&"undefined"!==P||(P="");var Y=$(".autowms_app_request_input").first().val();Y&&0<Y.length&&(v=Y.trim().split("?")[0],
...
qa=v+"request=getfiles&path="+P;c.html('... Reading <a href="'+qa+'">'+qa+"</a> ... ");try{$.ajax({contentType:"application/json",crossDomain:!0,type:"GET",url:qa,success:oa,error:function(sa){console.error("Request failed without jsonp, trying jsonp");oa({result:[]});$.ajax({dataType:"jsonp",contentType:"application/jsonp",crossDomain:!0,type:"GET",url:qa,success:oa,error:function(xa){X("Unable to do ajax call")}})}})}catch(sa){console.error(sa),X(sa)}};this.enable=function(){c.html("<div>Initializing...</div>");
Z("")};this.disable=function(){};this.resize=function(P,Y){}};try{WMJSExtApplications.AutoWMS=autowms_app}catch(c){};
