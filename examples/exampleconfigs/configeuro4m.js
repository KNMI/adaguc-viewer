...
var mapTypeConfiguration = [ 
 { 
    ...
    bbox: [-20,40,50,65], 
    srs: 'EPSG:4326',
    baselayer:{service:'http://cib-dev.knmi.nl/cgi-bin/worldmaps_e4m.cgi?',name:'world_polygons',format:'image/gif',transparent:false}
  }, { 
    title: 'World Latitude/Longitude WGS84', 
    bbox: [-180,-90,180,90], 
    srs: 'EPSG:4326',
    baselayer:{service:'http://geoservices.knmi.nl/cgi-bin/worldmaps.cgi?',name:'world_raster'}
  },{ 
    title: 'World Mercator', 
    bbox: [-19000000,-10000000,19000000,10000000], srs: 'EPSG:3857',
    baselayer:{service:'http://geoservices.knmi.nl/cgi-bin/worldmaps.cgi?',name:'world_raster'}
  },
  /*,{ 
