...
import {
  ...
  WMJSEmptyLayerName,
  WMJSEmptyLayerTitle,
} from "../webmapjs/WMJSConstants.js";
...
window.wmjs = {
  ...
  WMJSBBOX: WMJSBBOX,
  toArray: toArray,
  WMJSCoverage: WMJSCoverage,
  WCJSRequest: WCJSRequest,
  parseDescribeCoverage: parseDescribeCoverage,
};
