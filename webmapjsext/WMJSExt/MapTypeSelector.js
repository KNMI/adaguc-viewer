...
Ext.define("webmapjsext.WMJSExt.MapTypeSelector", {
  ...
  initComponent: function () {
    ...
    Ext.apply(this, {
      id: "maptypeselector",
      title: " ",
      tooltip: I18n.predefined_areas.tooltip,
      iconCls: "button_maptype32",
      autoScroll: true,
      plain: true,
      frame: false,
      border: false,
      ...
      items: [
        Ext.create("Ext.view.View", {
          ...
          prepareData: function (item) {
            ...
            item.url =
              service +
              "service=WMS&request=GetMap&styles=&width=160&height=120&format=image/png";
            (item.url += "&layers=" + name), (item.url += "&version=1.1.1");
            item.url +=
              "&bbox=" +
              bbox[0] +
              "," +
